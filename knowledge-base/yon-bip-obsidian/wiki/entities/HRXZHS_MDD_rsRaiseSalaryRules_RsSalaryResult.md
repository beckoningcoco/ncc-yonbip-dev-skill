---
tags: [BIP, metadata, HRXZHS_MDD, RsSalaryResult]
created: 2026-06-03
updated: 2026-06-03
...
# 规则结果 (HRXZHS_MDD.rsRaiseSalaryRules.RsSalaryResult)

> Platform: BIP V5 | Table: rs_salary_result | Schema: yonbip-hr-budget
...
|----------|-------|
| displayName | 规则结果 |
| uri | HRXZHS_MDD.rsRaiseSalaryRules.RsSalaryResult |
| tableName | rs_salary_result |
...
| 6 | interval | 是否区间(0-否、1-是) | interval | int | Integer |  |  | nullable |
| 7 | defaultValue | 默认取值(0-区间上限、1-中间值、2-区间下限) | default_value | int | Integer |  |  | nullable |
| 8 | currencyId | 币种主键 | currency_id | quote | bd.currencytenant.CurrencyTenantVO |  |  | nullable |
| 9 | currencyName | 币种名称 | currency_name | text | String |  |  | nullable |
| 10 | showOrder | 排序号 | show_order | int | Integer |  |  | nullable |
| 11 | refType | 档案 | ref_type | text | String |  |  | nullable |
| 12 | refTypeName | 档案名称 | ref_type_name | text | String |  |  | nullable |
...
| 16 | dr | 逻辑删除标记 | dr | short | Short |  | Y | notGenerate,nullable,uiHide |
...
| 23 | rsSalaryResultValues | 规则结果值 | - | - | HRXZHS_MDD.rsRaiseSalaryRules.RsSalaryResultValue |  |  |  |
...
|---|------|-------------|---------|
| 1 | rsSalaryResultValues | 规则结果值 | HRXZHS_MDD.rsRaiseSalaryRules.RsSalaryResultValue |
