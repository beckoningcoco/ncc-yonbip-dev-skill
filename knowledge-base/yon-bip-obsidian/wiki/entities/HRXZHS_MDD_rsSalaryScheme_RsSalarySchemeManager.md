---
tags: [BIP, metadata, HRXZHS_MDD, RsSalarySchemeManager]
created: 2026-06-03
updated: 2026-06-03
...
# 方案关联管理员 (HRXZHS_MDD.rsSalaryScheme.RsSalarySchemeManager)

> Platform: BIP V5 | Table: rs_salary_scheme_manager | Schema: yonbip-hr-budget
...
|----------|-------|
| displayName | 方案关联管理员 |
| uri | HRXZHS_MDD.rsSalaryScheme.RsSalarySchemeManager |
| tableName | rs_salary_scheme_manager |
