---
tags: [BIP, metadata, hrjx, EvaObjectTypeRelationForAgentScheme]
created: 2026-06-03
updated: 2026-06-03
...
# 业务代理人与考核对象类型关联表 (hrjx.pmCore.EvaObjectTypeRelationForAgentScheme)
...
| Property | Value |
|----------|-------|
| displayName | 业务代理人与考核对象类型关联表 |
| uri | hrjx.pmCore.EvaObjectTypeRelationForAgentScheme |
...
|---|------|-------------|------------|---------|---------|----------|-----------|-------|
| 1 | bizid | 业务id | bizid | quote | hrjx.pmCore.pmAgentScheme |  |  | nullable |
...
|---|------|-------------|------------|---------|
| 1 | bizid | 业务id | bizid | hrjx.pmCore.pmAgentScheme |
