---
tags: [BIP, metadata, hrjx, PhaseFlowAppealStep]
created: 2026-06-03
updated: 2026-06-03
...
# 申诉流程步骤明细子表 (hrjx.pmPhaseFlow.PhaseFlowAppealStep)
...
| Property | Value |
|----------|-------|
| displayName | 申诉流程步骤明细子表 |
| uri | hrjx.pmPhaseFlow.PhaseFlowAppealStep |
...
| 21 | pmWorkFlowAppealRoleList | 申诉步骤执行角色 | - | - | hrjx.pmPhaseFlow.PhaseFlowAppealRole |  |  |  |
| 22 | publishScope | 发布范围 | publish_scope | text | String |  |  | nullable |
| 23 | publishType | 结束前结果发布方式 | publish_type | short | Short |  |  | nullable |
| 24 | pubts | 时间戳 | pubts | timestamp | Timestamp |  |  | isSyncKey,nullable |
| 25 | scoreRatio | 默认评分比例 | score_ratio | text | String |  |  | nullable |
| 26 | showOrder | 显示顺序 | show_order | int | Integer |  |  | nullable |
| 27 | tplid | UI模板id | tplid | text | String |  |  | nullable |
| 28 | transferType | 流转类型 | transfer_type | text | String |  |  | nullable |
| 29 | type | 阶段类型 | type | text | String |  |  | nullable |
| 30 | weight | 权重 | weight | number | Decimal |  |  | nullable |
| 31 | weightShareType | 权重分配方式 | weight_share_type | int | Integer |  |  | nullable |
| 32 | weightassigntype | 评估时角色无执行人时权重分配方式 | weightassigntype | int | Integer |  |  | nullable |
| 33 | ytenant | 租户id | ytenant_id | quote | yht.tenant.YhtTenant | Y | Y | notGenerate,nullable,uiHide |
...
|---|------|-------------|---------|
| 1 | pmWorkFlowAppealRoleList | 申诉步骤执行角色 | hrjx.pmPhaseFlow.PhaseFlowAppealRole |
