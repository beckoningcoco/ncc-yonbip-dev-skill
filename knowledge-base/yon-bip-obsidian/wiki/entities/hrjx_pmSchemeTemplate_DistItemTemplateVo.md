---
tags: [BIP, metadata, hrjx, DistItemTemplateVo]
created: 2026-06-03
updated: 2026-06-03
...
# 强分设置模板子表 (hrjx.pmSchemeTemplate.DistItemTemplateVo)

> Platform: BIP V5 | Table: pm_dist_item_template | Schema: yonbip-hr-pmcore
...
| uri | hrjx.pmSchemeTemplate.DistItemTemplateVo |
| tableName | pm_dist_item_template |
...
|---|------|-------------|------------|---------|---------|----------|-----------|-------|
| 1 | distTemplateId | 强分主表id | disttemplateid | quote | hrjx.pmSchemeTemplate.DistTemplateVo |  |  | nullable |
...
|---|------|-------------|------------|---------|
| 1 | distTemplateId | 强分主表id | disttemplateid | hrjx.pmSchemeTemplate.DistTemplateVo |
