---
tags: [BIP, metadata, hrjx, EvaObjectTypeRelationForSchemeTemplate]
created: 2026-06-03
updated: 2026-06-03
...
# 考核模板与考核对象类型关联表 (hrjx.pmSchemeTemplate.EvaObjectTypeRelationForSchemeTemplate)
...
| Property | Value |
|----------|-------|
| displayName | 考核模板与考核对象类型关联表 |
| uri | hrjx.pmSchemeTemplate.EvaObjectTypeRelationForSchemeTemplate |
...
|---|------|-------------|------------|---------|---------|----------|-----------|-------|
| 1 | bizid | 业务id | bizid | quote | hrjx.pmSchemeTemplate.SchemeTemplateVO |  |  | nullable |
...
|---|------|-------------|------------|---------|
| 1 | bizid | 业务id | bizid | hrjx.pmSchemeTemplate.SchemeTemplateVO |
