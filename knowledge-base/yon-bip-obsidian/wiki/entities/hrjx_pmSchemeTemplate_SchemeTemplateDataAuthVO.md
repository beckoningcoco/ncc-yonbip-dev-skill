---
tags: [BIP, metadata, hrjx, SchemeTemplateDataAuthVO]
created: 2026-06-03
updated: 2026-06-03
...
# 考核模板数据权限 (hrjx.pmSchemeTemplate.SchemeTemplateDataAuthVO)
...
| Property | Value |
|----------|-------|
| displayName | 考核模板数据权限 |
| uri | hrjx.pmSchemeTemplate.SchemeTemplateDataAuthVO |
...
| 2 | orgid | 部门 | orgid | quote | org.func.AdminOrg |  |  | dataAuth,data_auth,nullable |
...
|---|------|-------------|------------|---------|
| 1 | orgid | 部门 | orgid | org.func.AdminOrg |
