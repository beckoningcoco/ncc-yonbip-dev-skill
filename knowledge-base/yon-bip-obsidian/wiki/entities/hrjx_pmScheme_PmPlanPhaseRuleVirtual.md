---
tags: [BIP, metadata, hrjx, PmPlanPhaseRuleVirtual]
created: 2026-06-03
updated: 2026-06-03
...
# 试用考核时间规则设置虚拟实体 (hrjx.pmScheme.PmPlanPhaseRuleVirtual)
...
| Property | Value |
|----------|-------|
| displayName | 试用考核时间规则设置虚拟实体 |
| uri | hrjx.pmScheme.PmPlanPhaseRuleVirtual |
| tableName | pm_plan_phase_rule |
| domain | yonbip-hr-pmcore |
| applicationCode | HRJX-MDD |
| superUri | hrjx.pmPlan.PmPlanPhaseRule |
...
| 10 | ytenant | 租户id | ytenant_id | quote | yht.tenant.YhtTenant | Y | Y | nullable,uiHide,notGenerate |
