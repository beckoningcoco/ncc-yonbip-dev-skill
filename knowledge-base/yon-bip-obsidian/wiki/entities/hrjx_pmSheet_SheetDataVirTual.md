---
tags: [BIP, metadata, hrjx, SheetDataVirTual]
created: 2026-06-03
updated: 2026-06-03
...
# 量表结构数据实体(虚拟) (hrjx.pmSheet.SheetDataVirTual)
...
| Property | Value |
|----------|-------|
| displayName | 量表结构数据实体(虚拟) |
| uri | hrjx.pmSheet.SheetDataVirTual |
| tableName | pm_sheet_data |
| domain | yonbip-hr-pmcore |
| applicationCode | HRJX-MDD |
| superUri | hrjx.pmSheet.SheetData |
