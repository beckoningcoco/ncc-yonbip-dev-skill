---
tags: [BIP, metadata, hrjx, TemplateCoachingPart]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模板沟通与辅导区块表 (hrjx.pmSheet.TemplateCoachingPart)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模板沟通与辅导区块表 |
| uri | hrjx.pmSheet.TemplateCoachingPart |
...
| 19 | mtrSettingList | 绩效模版-中期回顾沟通与辅导区块流转步骤设置 | - | - | hrjx.pmSheet.TemplateMtrCoachingSetting |  |  |  |
...
| 31 | settingList | 绩效模版-沟通与辅导区块流转步骤设置 | - | - | hrjx.pmSheet.TemplateCoachingSetting |  |  |  |
...
|---|------|-------------|---------|
| 1 | mtrSettingList | 绩效模版-中期回顾沟通与辅导区块流转步骤设置 | hrjx.pmSheet.TemplateMtrCoachingSetting |
| 2 | settingList | 绩效模版-沟通与辅导区块流转步骤设置 | hrjx.pmSheet.TemplateCoachingSetting |
