---
tags: [BIP, metadata, hrjx, TemplateCoachingSetting]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版-沟通与辅导区块流转步骤设置 (hrjx.pmSheet.TemplateCoachingSetting)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版-沟通与辅导区块流转步骤设置 |
| uri | hrjx.pmSheet.TemplateCoachingSetting |
...
| 19 | roleList | 绩效模版-沟通与辅导区块执行角色 | - | - | hrjx.pmSheet.TemplateCoachingSettingRole |  |  |  |
...
|---|------|-------------|---------|
| 1 | roleList | 绩效模版-沟通与辅导区块执行角色 | hrjx.pmSheet.TemplateCoachingSettingRole |
