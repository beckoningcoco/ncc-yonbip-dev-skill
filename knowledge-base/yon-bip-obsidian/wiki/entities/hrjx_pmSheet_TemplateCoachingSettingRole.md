---
tags: [BIP, metadata, hrjx, TemplateCoachingSettingRole]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版-沟通与辅导区块执行角色 (hrjx.pmSheet.TemplateCoachingSettingRole)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版-沟通与辅导区块执行角色 |
| uri | hrjx.pmSheet.TemplateCoachingSettingRole |
...
| 43 | templatesetid | 流转设置id | templatesetid | quote | hrjx.pmSheet.TemplateCoachingSetting |  |  | nullable |
...
| 16 | templatesetid | 流转设置id | templatesetid | hrjx.pmSheet.TemplateCoachingSetting |
