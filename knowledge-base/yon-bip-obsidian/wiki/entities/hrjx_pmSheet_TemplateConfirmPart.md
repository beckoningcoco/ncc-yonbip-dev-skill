---
tags: [BIP, metadata, hrjx, TemplateConfirmPart]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模板结果确认区块表 (hrjx.pmSheet.TemplateConfirmPart)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模板结果确认区块表 |
| uri | hrjx.pmSheet.TemplateConfirmPart |
...
| 30 | settingList | 绩效模版结果确认区块流转步骤设置 | - | - | hrjx.pmSheet.TemplateConfirmSetting |  |  |  |
| 31 | showParentorg | 查看所属组织 | show_parentorg | int | Integer |  |  | nullable |
| 32 | subScoreway | 下级指标算分方式 | sub_scoreway | int | Integer |  |  | nullable |
| 33 | templateid | 绩效模板id | templateid | quote | hrjx.pmSheet.Template |  |  | nullable |
| 34 | tenant | 租户ID | tenant_id | text | String |  | Y | nullable,uiHide |
| 35 | unitremark | 计划描述 | unitremark | int | Integer |  |  | nullable |
| 36 | viewrule | 查看等级规则 | viewrule | int | Integer |  |  | nullable |
| 37 | weight | 区块权重 | weight | number | Decimal |  |  | nullable |
| 38 | weightSettingType | 权重设置 | weight_setting_type | int | Integer |  |  | nullable |
| 39 | weightType | 区块权重类型 | weight_type | int | Integer |  |  | nullable |
| 40 | ytenant | 租户id | ytenant_id | quote | yht.tenant.YhtTenant | Y | Y | notGenerate,nullable,uiHide |
...
|---|------|-------------|---------|
| 1 | settingList | 绩效模版结果确认区块流转步骤设置 | hrjx.pmSheet.TemplateConfirmSetting |
