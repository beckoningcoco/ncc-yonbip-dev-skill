---
tags: [BIP, metadata, hrjx, TemplateConfirmSetting]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版结果确认区块流转步骤设置 (hrjx.pmSheet.TemplateConfirmSetting)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版结果确认区块流转步骤设置 |
| uri | hrjx.pmSheet.TemplateConfirmSetting |
...
| 17 | partid | 模板区块id | partid | quote | hrjx.pmSheet.TemplateConfirmPart |  |  | nullable |
| 18 | pubts | 时间戳 | pubts | timestamp | Timestamp |  |  | isSyncKey,nullable |
| 19 | roleList | 绩效模板结果确认区块执行角色 | - | - | hrjx.pmSheet.TemplateConfirmSettingRole |  |  |  |
...
| 7 | partid | 模板区块id | partid | hrjx.pmSheet.TemplateConfirmPart |
...
|---|------|-------------|---------|
| 1 | roleList | 绩效模板结果确认区块执行角色 | hrjx.pmSheet.TemplateConfirmSettingRole |
