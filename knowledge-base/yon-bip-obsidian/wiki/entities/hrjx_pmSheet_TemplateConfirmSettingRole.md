---
tags: [BIP, metadata, hrjx, TemplateConfirmSettingRole]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模板结果确认区块执行角色 (hrjx.pmSheet.TemplateConfirmSettingRole)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模板结果确认区块执行角色 |
| uri | hrjx.pmSheet.TemplateConfirmSettingRole |
...
| 43 | templatesetid | 流转设置id | templatesetid | quote | hrjx.pmSheet.TemplateConfirmSetting |  |  | nullable |
...
| 16 | templatesetid | 流转设置id | templatesetid | hrjx.pmSheet.TemplateConfirmSetting |
