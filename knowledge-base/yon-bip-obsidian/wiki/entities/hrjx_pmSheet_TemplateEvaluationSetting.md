---
tags: [BIP, metadata, hrjx, TemplateEvaluationSetting]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版-综合评价区块流转步骤设置 (hrjx.pmSheet.TemplateEvaluationSetting)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版-综合评价区块流转步骤设置 |
| uri | hrjx.pmSheet.TemplateEvaluationSetting |
...
| 19 | roleList | 绩效模版-综合评价区块执行角色 | - | - | hrjx.pmSheet.TemplateEvaluationSettingRole |  |  |  |
...
|---|------|-------------|---------|
| 1 | roleList | 绩效模版-综合评价区块执行角色 | hrjx.pmSheet.TemplateEvaluationSettingRole |
