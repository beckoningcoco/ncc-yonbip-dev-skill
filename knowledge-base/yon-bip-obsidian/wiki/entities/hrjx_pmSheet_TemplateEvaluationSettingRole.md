---
tags: [BIP, metadata, hrjx, TemplateEvaluationSettingRole]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版-综合评价区块执行角色 (hrjx.pmSheet.TemplateEvaluationSettingRole)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版-综合评价区块执行角色 |
| uri | hrjx.pmSheet.TemplateEvaluationSettingRole |
...
| 43 | templatesetid | 流转设置id | templatesetid | quote | hrjx.pmSheet.TemplateEvaluationSetting |  |  | nullable |
...
| 16 | templatesetid | 流转设置id | templatesetid | hrjx.pmSheet.TemplateEvaluationSetting |
