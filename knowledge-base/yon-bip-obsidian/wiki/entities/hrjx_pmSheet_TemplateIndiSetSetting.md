---
tags: [BIP, metadata, hrjx, TemplateIndiSetSetting]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版-指标模板流转步骤设置 (hrjx.pmSheet.TemplateIndiSetSetting)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版-指标模板流转步骤设置 |
| uri | hrjx.pmSheet.TemplateIndiSetSetting |
...
| 19 | roleList | 绩效模版-指标模板执行角色 | - | - | hrjx.pmSheet.TemplateIndiSetSettingRole |  |  |  |
...
|---|------|-------------|---------|
| 1 | roleList | 绩效模版-指标模板执行角色 | hrjx.pmSheet.TemplateIndiSetSettingRole |
