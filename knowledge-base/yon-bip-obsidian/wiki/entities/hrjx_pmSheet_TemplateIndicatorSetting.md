---
tags: [BIP, metadata, hrjx, TemplateIndicatorSetting]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版-指标模板指标流转步骤设置 (hrjx.pmSheet.TemplateIndicatorSetting)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版-指标模板指标流转步骤设置 |
| uri | hrjx.pmSheet.TemplateIndicatorSetting |
...
| 19 | roleList | 绩效模版-指标模板指标执行角色 | - | - | hrjx.pmSheet.TemplateIndicatorSettingRole |  |  |  |
...
|---|------|-------------|---------|
| 1 | roleList | 绩效模版-指标模板指标执行角色 | hrjx.pmSheet.TemplateIndicatorSettingRole |
