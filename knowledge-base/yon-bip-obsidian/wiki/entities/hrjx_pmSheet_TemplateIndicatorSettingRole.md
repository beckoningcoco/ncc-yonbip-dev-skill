---
tags: [BIP, metadata, hrjx, TemplateIndicatorSettingRole]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版-指标模板指标执行角色 (hrjx.pmSheet.TemplateIndicatorSettingRole)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版-指标模板指标执行角色 |
| uri | hrjx.pmSheet.TemplateIndicatorSettingRole |
...
| 43 | templatesetid | 流转设置id | templatesetid | quote | hrjx.pmSheet.TemplateIndicatorSetting |  |  | nullable |
...
| 16 | templatesetid | 流转设置id | templatesetid | hrjx.pmSheet.TemplateIndicatorSetting |
