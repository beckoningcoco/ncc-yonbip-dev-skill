---
tags: [BIP, metadata, hrjx, TemplateInterviewPart]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模板面谈区块表 (hrjx.pmSheet.TemplateInterviewPart)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模板面谈区块表 |
| uri | hrjx.pmSheet.TemplateInterviewPart |
...
| 19 | mtrSettingList | 绩效模版-中期回顾面谈区块流转步骤设置 | - | - | hrjx.pmSheet.TemplateMtrInterviewSetting |  |  |  |
...
| 31 | settingList | 绩效模版-面谈区块流转步骤设置 | - | - | hrjx.pmSheet.TemplateInterviewSetting |  |  |  |
...
|---|------|-------------|---------|
| 1 | mtrSettingList | 绩效模版-中期回顾面谈区块流转步骤设置 | hrjx.pmSheet.TemplateMtrInterviewSetting |
| 2 | settingList | 绩效模版-面谈区块流转步骤设置 | hrjx.pmSheet.TemplateInterviewSetting |
