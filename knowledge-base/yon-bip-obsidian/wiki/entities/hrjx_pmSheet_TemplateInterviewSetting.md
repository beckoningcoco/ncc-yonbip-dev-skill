---
tags: [BIP, metadata, hrjx, TemplateInterviewSetting]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版-面谈区块流转步骤设置 (hrjx.pmSheet.TemplateInterviewSetting)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版-面谈区块流转步骤设置 |
| uri | hrjx.pmSheet.TemplateInterviewSetting |
...
| 19 | roleList | 绩效模版-面谈区块执行角色 | - | - | hrjx.pmSheet.TemplateInterviewSettingRole |  |  |  |
...
|---|------|-------------|---------|
| 1 | roleList | 绩效模版-面谈区块执行角色 | hrjx.pmSheet.TemplateInterviewSettingRole |
