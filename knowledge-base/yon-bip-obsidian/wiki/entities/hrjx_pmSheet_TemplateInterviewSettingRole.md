---
tags: [BIP, metadata, hrjx, TemplateInterviewSettingRole]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版-面谈区块执行角色 (hrjx.pmSheet.TemplateInterviewSettingRole)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版-面谈区块执行角色 |
| uri | hrjx.pmSheet.TemplateInterviewSettingRole |
...
| 43 | templatesetid | 流转设置id | templatesetid | quote | hrjx.pmSheet.TemplateInterviewSetting |  |  | nullable |
...
| 16 | templatesetid | 流转设置id | templatesetid | hrjx.pmSheet.TemplateInterviewSetting |
