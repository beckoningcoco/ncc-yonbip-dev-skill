---
tags: [BIP, metadata, hrjx, TemplateMtrCoachingSetting]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版-中期回顾沟通与辅导区块流转步骤设置 (hrjx.pmSheet.TemplateMtrCoachingSetting)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版-中期回顾沟通与辅导区块流转步骤设置 |
| uri | hrjx.pmSheet.TemplateMtrCoachingSetting |
...
| 17 | partid | 模板区块id | partid | quote | hrjx.pmSheet.TemplateCoachingPart |  |  | nullable |
| 18 | pubts | 时间戳 | pubts | timestamp | Timestamp |  |  | isSyncKey,nullable |
| 19 | roleList | 绩效模版-中期回顾沟通与辅导区块执行角色 | - | - | hrjx.pmSheet.TemplateMtrCoachingSettingRole |  |  |  |
...
| 7 | partid | 模板区块id | partid | hrjx.pmSheet.TemplateCoachingPart |
...
|---|------|-------------|---------|
| 1 | roleList | 绩效模版-中期回顾沟通与辅导区块执行角色 | hrjx.pmSheet.TemplateMtrCoachingSettingRole |
