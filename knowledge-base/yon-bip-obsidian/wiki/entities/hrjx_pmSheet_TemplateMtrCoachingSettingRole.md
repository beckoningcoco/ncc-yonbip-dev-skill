---
tags: [BIP, metadata, hrjx, TemplateMtrCoachingSettingRole]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版-中期回顾沟通与辅导区块执行角色 (hrjx.pmSheet.TemplateMtrCoachingSettingRole)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版-中期回顾沟通与辅导区块执行角色 |
| uri | hrjx.pmSheet.TemplateMtrCoachingSettingRole |
...
| 43 | templatesetid | 流转设置id | templatesetid | quote | hrjx.pmSheet.TemplateMtrCoachingSetting |  |  | nullable |
...
| 16 | templatesetid | 流转设置id | templatesetid | hrjx.pmSheet.TemplateMtrCoachingSetting |
