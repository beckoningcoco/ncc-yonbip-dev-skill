---
tags: [BIP, metadata, hrjx, TemplateMtrEvaluationSetting]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版-中期回顾综合评价区块流转步骤设置 (hrjx.pmSheet.TemplateMtrEvaluationSetting)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版-中期回顾综合评价区块流转步骤设置 |
| uri | hrjx.pmSheet.TemplateMtrEvaluationSetting |
| tableName | pm_template_setting |
| domain | yonbip-hr-pmcore |
| applicationCode | HRJX-MDD |
| superUri | hrjx.pmSheet.TemplateSetting |
...
| 17 | partid | 模板区块id | partid | quote | hrjx.pmSheet.TemplateEvaluationPart |  |  | nullable |
| 18 | pubts | 时间戳 | pubts | timestamp | Timestamp |  |  | isSyncKey,nullable |
| 19 | roleList | 绩效模版-中期回顾综合评价区块执行角色 | - | - | hrjx.pmSheet.TemplateMtrEvaluationSettingRole |  |  |  |
...
| 7 | partid | 模板区块id | partid | hrjx.pmSheet.TemplateEvaluationPart |
...
|---|------|-------------|---------|
| 1 | roleList | 绩效模版-中期回顾综合评价区块执行角色 | hrjx.pmSheet.TemplateMtrEvaluationSettingRole |
