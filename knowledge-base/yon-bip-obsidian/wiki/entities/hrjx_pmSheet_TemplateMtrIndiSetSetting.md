---
tags: [BIP, metadata, hrjx, TemplateMtrIndiSetSetting]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版-中期回顾指标模板流转步骤设置 (hrjx.pmSheet.TemplateMtrIndiSetSetting)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版-中期回顾指标模板流转步骤设置 |
| uri | hrjx.pmSheet.TemplateMtrIndiSetSetting |
...
| 19 | roleList | 绩效模版-中期回顾指标模板执行角色 | - | - | hrjx.pmSheet.TemplateMtrIndiSetSettingRole |  |  |  |
...
|---|------|-------------|---------|
| 1 | roleList | 绩效模版-中期回顾指标模板执行角色 | hrjx.pmSheet.TemplateMtrIndiSetSettingRole |
