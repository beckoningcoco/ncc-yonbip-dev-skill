---
tags: [BIP, metadata, hrjx, TemplateMtrIndiSetSettingRole]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版-中期回顾指标模板执行角色 (hrjx.pmSheet.TemplateMtrIndiSetSettingRole)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版-中期回顾指标模板执行角色 |
| uri | hrjx.pmSheet.TemplateMtrIndiSetSettingRole |
...
| 43 | templatesetid | 流转设置id | templatesetid | quote | hrjx.pmSheet.TemplateMtrIndiSetSetting |  |  | nullable |
...
| 16 | templatesetid | 流转设置id | templatesetid | hrjx.pmSheet.TemplateMtrIndiSetSetting |
