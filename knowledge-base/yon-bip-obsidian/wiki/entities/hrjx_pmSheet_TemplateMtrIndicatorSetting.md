---
tags: [BIP, metadata, hrjx, TemplateMtrIndicatorSetting]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版-中期回顾指标模板指标流转步骤设置 (hrjx.pmSheet.TemplateMtrIndicatorSetting)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版-中期回顾指标模板指标流转步骤设置 |
| uri | hrjx.pmSheet.TemplateMtrIndicatorSetting |
...
| 19 | roleList | 绩效模版-中期回顾指标模板指标执行角色 | - | - | hrjx.pmSheet.TemplateMtrIndicatorSettingRole |  |  |  |
...
|---|------|-------------|---------|
| 1 | roleList | 绩效模版-中期回顾指标模板指标执行角色 | hrjx.pmSheet.TemplateMtrIndicatorSettingRole |
