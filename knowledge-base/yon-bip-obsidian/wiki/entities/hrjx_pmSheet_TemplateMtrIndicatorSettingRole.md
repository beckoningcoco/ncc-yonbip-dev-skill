---
tags: [BIP, metadata, hrjx, TemplateMtrIndicatorSettingRole]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版-中期回顾指标模板指标执行角色 (hrjx.pmSheet.TemplateMtrIndicatorSettingRole)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版-中期回顾指标模板指标执行角色 |
| uri | hrjx.pmSheet.TemplateMtrIndicatorSettingRole |
...
| 43 | templatesetid | 流转设置id | templatesetid | quote | hrjx.pmSheet.TemplateMtrIndicatorSetting |  |  | nullable |
...
| 16 | templatesetid | 流转设置id | templatesetid | hrjx.pmSheet.TemplateMtrIndicatorSetting |
