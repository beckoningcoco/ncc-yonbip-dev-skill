---
tags: [BIP, metadata, hrjx, TemplateMtrInterviewSetting]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版-中期回顾面谈区块流转步骤设置 (hrjx.pmSheet.TemplateMtrInterviewSetting)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版-中期回顾面谈区块流转步骤设置 |
| uri | hrjx.pmSheet.TemplateMtrInterviewSetting |
...
| 17 | partid | 模板区块id | partid | quote | hrjx.pmSheet.TemplateInterviewPart |  |  | nullable |
| 18 | pubts | 时间戳 | pubts | timestamp | Timestamp |  |  | isSyncKey,nullable |
| 19 | roleList | 绩效模版-中期回顾面谈区块执行角色 | - | - | hrjx.pmSheet.TemplateMtrInterviewSettingRole |  |  |  |
...
| 7 | partid | 模板区块id | partid | hrjx.pmSheet.TemplateInterviewPart |
...
|---|------|-------------|---------|
| 1 | roleList | 绩效模版-中期回顾面谈区块执行角色 | hrjx.pmSheet.TemplateMtrInterviewSettingRole |
