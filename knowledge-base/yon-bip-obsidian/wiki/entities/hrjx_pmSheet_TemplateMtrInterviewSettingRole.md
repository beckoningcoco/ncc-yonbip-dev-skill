---
tags: [BIP, metadata, hrjx, TemplateMtrInterviewSettingRole]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版-中期回顾面谈区块执行角色 (hrjx.pmSheet.TemplateMtrInterviewSettingRole)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版-中期回顾面谈区块执行角色 |
| uri | hrjx.pmSheet.TemplateMtrInterviewSettingRole |
...
| 43 | templatesetid | 流转设置id | templatesetid | quote | hrjx.pmSheet.TemplateMtrInterviewSetting |  |  | nullable |
...
| 16 | templatesetid | 流转设置id | templatesetid | hrjx.pmSheet.TemplateMtrInterviewSetting |
