---
tags: [BIP, metadata, hrjx, TemplatePart]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模板区块表 (hrjx.pmSheet.TemplatePart)
...
|---|------|-------------|------------|---------|---------|----------|-----------|-------|
| 1 | blockList | 绩效模板考核部分 | - | - | hrjx.pmSheet.TemplateBlock |  |  |  |
| 2 | blockMobileTplid | 手机区域字段模板id | block_mobile_tplid | quote | hrjx.pmCore.BilltemplateNewModelBase |  |  | nullable |
| 3 | blockPcTplid | 电脑区域字段模板id | block_pc_tplid | quote | hrjx.pmCore.BilltemplateNewModelBase |  |  | nullable |
...
| 7 | distributionRange | 分布范围 | distribution_range | text | String |  |  | nullable |
| 8 | id | ID | id | long | Long |  |  | nullable,REF.ID |
| 9 | indiScoreway | 指标算分方式 | indi_scoreway | int | Integer |  |  | nullable |
| 10 | indiauthority | 指标权限设置 | indiauthority | int | Integer |  |  | nullable |
| 11 | indiweightType | 指标权重类型 | indiweight_type | int | Integer |  |  | nullable |
| 12 | isMultiLevel | 是否考核部分多层级 | is_multi_level | int | Integer |  |  | nullable |
| 13 | isannex | 是否附件说明 | isannex | int | Integer |  |  | nullable |
| 14 | isshowperiod | 是否显示绩效期间 | isshowperiod | int | Integer |  |  | nullable |
| 15 | isshowschemename | 是否显示方案名称 | isshowschemename | int | Integer |  |  | nullable |
| 16 | isshowschemeremark | 是否显示方案说明 | isshowschemeremark | int | Integer |  |  | nullable |
| 17 | mantissaType | 尾数处理 | mantissa_type | text | String |  |  | nullable |
...
| 31 | settingList | 绩效模版-流转步骤设置 | - | - | hrjx.pmSheet.TemplateSetting |  |  |  |
...
|---|------|-------------|---------|
| 1 | blockList | 绩效模板考核部分 | hrjx.pmSheet.TemplateBlock |
| 2 | settingList | 绩效模版-流转步骤设置 | hrjx.pmSheet.TemplateSetting |
