---
tags: [BIP, metadata, hrjx, TemplateSettingRole]
created: 2026-06-03
updated: 2026-06-03
...
# 绩效模版-执行角色 (hrjx.pmSheet.TemplateSettingRole)
...
| Property | Value |
|----------|-------|
| displayName | 绩效模版-执行角色 |
| uri | hrjx.pmSheet.TemplateSettingRole |
...
| 33 | permissionList | 模板按钮高级设置权限 | - | - | hrjx.pmSheet.TemplateSettingRolePermission |  |  |  |
| 34 | postid | 指定人员岗位 | postid | text | String |  |  | nullable |
| 35 | psnMobileTplid | 个人移动端UI模版id | psn_mobile_tplid | quote | hrjx.pmCore.BilltemplateNewModelBase |  |  | nullable |
| 36 | psnPcTplid | 个人PC端UI模版id | psn_pc_tplid | quote | hrjx.pmCore.BilltemplateNewModelBase |  |  | nullable |
| 37 | psnweight | 轮次内权重占比 | psnweight | number | Decimal |  |  | nullable |
| 38 | pubts | 时间戳 | pubts | timestamp | Timestamp |  |  | isSyncKey,nullable |
| 39 | roleType | 角色类型 | role_type | int | Integer |  |  | nullable |
| 40 | roleid | 角色id | roleid | quote | hrjx.pmExecutionRole.PmExecutionRole |  |  | nullable |
| 41 | scoreType | 打分设置 | score_type | int | Integer |  |  | nullable |
| 42 | staffid | 指定人员id | staffid | quote | hred.staff.Staff |  |  | nullable |
| 43 | templateid | 绩效模板id | templateid | quote | hrjx.pmSheet.Template |  |  | nullable |
| 44 | templatesetid | 流转设置id | templatesetid | quote | hrjx.pmSheet.TemplateSetting |  |  | nullable |
| 45 | tenant | 租户ID | tenant_id | text | String |  | Y | nullable,uiHide |
| 46 | turn | 轮次 | turn | int | Integer |  |  | nullable |
| 47 | turnweight | 轮次权重 | turnweight | number | Decimal |  |  | nullable |
| 48 | weight | 权重 | weight | number | Decimal |  |  | nullable |
| 49 | ytenant | 租户id | ytenant_id | quote | yht.tenant.YhtTenant | Y | Y | notGenerate,nullable,uiHide |
...
| 16 | templatesetid | 流转设置id | templatesetid | hrjx.pmSheet.TemplateSetting |
...
|---|------|-------------|---------|
| 1 | permissionList | 模板按钮高级设置权限 | hrjx.pmSheet.TemplateSettingRolePermission |
