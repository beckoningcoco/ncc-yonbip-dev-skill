---
tags: [BIP, metadata, hrjx, SummarySchemetemplateRelation]
created: 2026-06-03
updated: 2026-06-03
...
# 汇总方案模板与方案关联表 (hrjx.pmSummarySchemeTemplate.SummarySchemetemplateRelation)

> Platform: BIP V5 | Table: pm_summary_schemetemplate_relation | Schema: yonbip-hr-pmcore

## Basic Info

| Property | Value |
|----------|-------|
| displayName | 汇总方案模板与方案关联表 |
| uri | hrjx.pmSummarySchemeTemplate.SummarySchemetemplateRelation |
| tableName | pm_summary_schemetemplate_relation |
...
| 3 | schemeId | 子方案id | schemeid | quote | hrjx.pmScheme.Scheme |  |  | nullable |
| 4 | orgId | 所属组织id | orgid | quote | org.func.AdminOrg |  |  | dataAuth,data_auth,nullable |
| 5 | vid | 所属组织时间轴id | vid | quote | org.func.AdminOrgTimeline |  |  | dataAuth,data_auth,nullable |
| 6 | applyState | 子方案状态 | applystate | int | Integer |  |  | nullable |
| 7 | userId | 用户id | userid | text | String |  |  | nullable |
| 8 | staffId | 负责人id | staffid | quote | hred.staff.Staff |  |  | nullable |
| 9 | isModifyAssessTurn | 允许修改考核人轮次 | ismodifyassessturn | int | Integer |  |  | nullable |
| 10 | dr | 逻辑删除标记 | dr | short | Short |  | Y | notGenerate,nullable,uiHide |
| 11 | enable | 启用 | enable | singleOption | bd.systemEnum.sys_intboolean |  |  | nullable,uiDesign |
...
| 3 | orgId | 所属组织id | orgid | org.func.AdminOrg |
| 4 | vid | 所属组织时间轴id | vid | org.func.AdminOrgTimeline |
| 5 | staffId | 负责人id | staffid | hred.staff.Staff |
