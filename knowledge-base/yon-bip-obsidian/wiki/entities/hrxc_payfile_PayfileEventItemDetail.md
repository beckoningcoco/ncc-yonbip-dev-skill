---
tags: [BIP, metadata, hrxc, PayfileEventItemDetail]
created: 2026-06-03
updated: 2026-06-03
...
# 发放单追溯事件明细 (hrxc.payfile.PayfileEventItemDetail)

> Platform: BIP V5 | Table: wa_payfile_backtrack_event_item_detail | Schema: yonbip-hr-paybiz

## Basic Info

| Property | Value |
|----------|-------|
| displayName | 发放单追溯事件明细 |
| uri | hrxc.payfile.PayfileEventItemDetail |
| tableName | wa_payfile_backtrack_event_item_detail |
...
|---|------|-------------|------------|---------|---------|----------|-----------|-------|
| 1 | event | 追溯事件明细主键 | event_id | quote | hrxc.backtrack.Event |  |  | nullable |
| 2 | payfile | 薪资发放单主键 | pk_wa_payfile | quote | hrxc.payfile.WaPayfile |  |  | nullable |
| 3 | staffId | 追溯事件明细主键 | staff_id | quote | hred.staff.Staff |  |  | nullable |
...
| 17 | pkPayFileDoc | 薪资发放单人员档案id | pk_payfile_doc | text | String |  |  | nullable |
...
|---|------|-------------|------------|---------|
| 1 | event | 追溯事件明细主键 | event_id | hrxc.backtrack.Event |
| 2 | payfile | 薪资发放单主键 | pk_wa_payfile | hrxc.payfile.WaPayfile |
| 3 | staffId | 追溯事件明细主键 | staff_id | hred.staff.Staff |
| 4 | backtrackPeriod | 追溯期间 | backtrack_period | hrxc.period.PeriodDetail |
| 5 | waItem | 发薪项目 | waitem_id | hrxc.publicItem.WaItem |
