---
tags: [BIP, metadata, sn, SNCustomItemReport]
created: 2026-06-03
updated: 2026-06-03
...
# 序列号属性 (sn.serialnumber.SNCustomItemReport)

> Platform: BIP V5 | Module: sn | Table: sn_customitem | Schema: ustock
...
|----------|-------|
| displayName | 序列号属性 |
| uri | sn.serialnumber.SNCustomItemReport |
| tableName | sn_customitem |
| domain | ustock |
| applicationCode | ST |
| superUri | ? |
...
| # | Name | URI |
|---|------|-----|
| 1 | 固定自定义项（序列号） (UserdefItemSerial) | base.itf.UserdefItemSerial |
...
| 31 | id | 序列号id | id | quote | sn.serialnumber.SNstateReport |  |  | nullable,REF.ID |
...
|---|------|-------------|------------|---------|
| 1 | id | 序列号id | id | sn.serialnumber.SNstateReport |
