---
tags: [BIP, metadata, st, ReturnApplyCustomItem]
created: 2026-06-03
updated: 2026-06-03
...
# 退货申请单主表自定义项 (st.returnapply.ReturnApplyCustomItem)

> Platform: BIP V5 | Module: st | Table: st_returnapply_customitem | Schema: ustock

## Basic Info

| Property | Value |
|----------|-------|
| displayName | 退货申请单主表自定义项 |
| uri | st.returnapply.ReturnApplyCustomItem |
| tableName | st_returnapply_customitem |
| domain | ustock |
| applicationCode | ST |
| superUri | ? |
...
| 31 | id | 退货申请单主表id | id | quote | st.returnapply.ReturnApply |  |  | nullable,REF.ID |
...
|---|------|-------------|------------|---------|
| 1 | id | 退货申请单主表id | id | st.returnapply.ReturnApply |
