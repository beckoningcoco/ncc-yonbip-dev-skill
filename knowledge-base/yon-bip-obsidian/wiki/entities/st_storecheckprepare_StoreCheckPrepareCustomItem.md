---
tags: [BIP, metadata, st, StoreCheckPrepareCustomItem]
created: 2026-06-03
updated: 2026-06-03
...
# 盘点准备单主表自定义项 (st.storecheckprepare.StoreCheckPrepareCustomItem)

> Platform: BIP V5 | Module: st | Table: st_storecheckprepare_customitem | Schema: ustock

## Basic Info

| Property | Value |
|----------|-------|
| displayName | 盘点准备单主表自定义项 |
| uri | st.storecheckprepare.StoreCheckPrepareCustomItem |
| tableName | st_storecheckprepare_customitem |
| domain | ustock |
| schema | `ustock` |
| applicationCode | ST |
| superUri | ? |
...
| 31 | id | 盘点准备单主表id | id | quote | st.storecheckprepare.StoreCheckPrepare |  |  | nullable,REF.ID |
...
|---|------|-------------|------------|---------|
| 1 | id | 盘点准备单主表id | id | st.storecheckprepare.StoreCheckPrepare |
