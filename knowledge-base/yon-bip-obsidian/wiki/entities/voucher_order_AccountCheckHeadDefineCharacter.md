---
tags: [BIP, metadata, voucher, AccountCheckHeadDefineCharacter]
created: 2026-06-03
updated: 2026-06-03
...
# 客户往来对账表表头自定义项特征实体 (voucher.order.AccountCheckHeadDefineCharacter)

> Platform: BIP V5 | Module: voucher | Table: ac_h_character_define | Schema: udinghuo

## Basic Info

| Property | Value |
|----------|-------|
| displayName | 客户往来对账表表头自定义项特征实体 |
| uri | voucher.order.AccountCheckHeadDefineCharacter |
| tableName | ac_h_character_define |
| domain | udinghuo |
