---
tags: ["BIP", "元数据", "数据字典", "ycPriceCenter", "aa.ct.BizScene"]
created: 2026-06-04
updated: 2026-06-04
...
> 物理表：`cpu_pub_biz_scene` | 所属应用：`ycPriceCenter`
> 来源：元数据API `queryByUri` 返回的 `aa.ct.BizScene` 实体完整定义。
...
| 所属应用 | `ycPriceCenter` |
| 业务对象ID | `fe2c4795-c631-4cc5-b67a-b8b0189ba6f3` |
| 元数据类型 | `Class` |
| 元数据层级 | `0` |
| 是否业务对象 | `true` |
| 构建时间 | `2026-06-04 16:18:39.8690` |
...
| 20 | `partitions` | 业务隔离属性 | `` | 1a77f605-9db5-414e-8f81-cc348b285dee | `` |  |  |
...
|---|--------|--------|---------|---------|------|--------|------|--------|--------|
| 1 | `partitions` | 业务隔离属性 | `aa.ct.BizPartition` | `` | partitions → bizScene | 0..n | true | None |  |
...
- **partitions**: `partitions` → `aa.ct.BizPartition` | 0..n
