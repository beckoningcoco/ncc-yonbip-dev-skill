---
tags: ["BIP", "元数据", "数据字典", "ycBase", "ewallet.transapply.TransApplyDetailFreeDefine"]
created: 2026-06-04
updated: 2026-06-04
...
# 交易单管理明细自由自定义项 (`ewallet.transapply.TransApplyDetailFreeDefine`)

> ⚡ **平台版本：BIP 旗舰版 V5** — 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。

> YonBIP ycBase 模块实体元数据字典。
> 物理表：`cpu_ew_trans_apply_detail_freedefine` | 所属应用：`ycBase`
> 来源：元数据API `queryByUri` 返回的 `ewallet.transapply.TransApplyDetailFreeDefine` 实体完整定义。
...
|------|-----|
| 显示名 | 交易单管理明细自由自定义项 |
| 物理表 | `cpu_ew_trans_apply_detail_freedefine` |
...
| 元数据层级 | `0` |
| 是否业务对象 | `true` |
| 构建时间 | `2026-06-04 15:31:23.2080` |

## 主键与编码

| 角色 | 字段名 | 数据库列 | 类型 | 说明 |
|------|--------|---------|------|------|
| 主键 | `id` | `id` | 63cadd3d-d65a-4295-9c09-e1c816b82328 | 交易申请单明细 |

## 部署信息

- **部署时间**: 2026-01-23 23:56:29:000
- **安装来源**: `/app/data_scripts/yonbip-cpu-lawbid/scripts/db/patch/mongodb/V5_R0_2507/0001_yonbip-cpu-lawbid/0010_iuap_common/DML/0270_iuap_metadata/202512169999/0000-public-only/202512121102_metadata_ewallet-transapply_delta.zip`
- **安装人**: mongoTools
- **安装排名**: `2570f474-bc27-4212-bfb8-c2ea72f111a5`
...
- **migration_id** (MetaClassPrimary): 交易申请单明细 — 唯一字段: `['id']`
...
| 62 | `id` | 交易申请单明细 | `id` | 63cadd3d-d65a-4295-9c09-e1c816b82328 | `quote` |  | ✓ |
| 63 | `ytenant` | 租户id | `ytenant_id` | e4933a03-9dea-472b-a644-cdd654222f45 | `quote` | ✓ | ✓ |
...
| 2 | `id` | 交易申请单明细 | `ewallet.transapply.TransApplyDetail` | `id` | define → id | 1 | true | None |  |

### Composition（子表）

- **id**: `define` → `ewallet.transapply.TransApplyDetail` | 1
