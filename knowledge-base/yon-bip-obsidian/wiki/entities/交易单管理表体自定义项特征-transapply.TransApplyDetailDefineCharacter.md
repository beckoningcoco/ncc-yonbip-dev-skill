---
tags: ["BIP", "元数据", "数据字典", "ycBase", "ewallet.transapply.TransApplyDetailDefineCharacter"]
created: 2026-06-04
updated: 2026-06-04
...
# 交易单管理表体自定义项特征 (`ewallet.transapply.TransApplyDetailDefineCharacter`)

> ⚡ **平台版本：BIP 旗舰版 V5** — 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。

> YonBIP ycBase 模块实体元数据字典。
> 物理表：`cpu_ew_trans_apply_detail_define_character` | 所属应用：`ycBase`
> 来源：元数据API `queryByUri` 返回的 `ewallet.transapply.TransApplyDetailDefineCharacter` 实体完整定义。
