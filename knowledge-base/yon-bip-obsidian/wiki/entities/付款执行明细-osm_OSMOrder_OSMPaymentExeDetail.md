---
tags: ["BIP", "元数据", "数据字典", "OSM", "osm.OSMOrder.OSMPaymentExeDetail"]
created: 2026-06-05
updated: 2026-06-05
...
# 付款执行明细 (`osm.OSMOrder.OSMPaymentExeDetail`)

> OSM | 物理表：`osm_paymentexedetail`
...
| 15 | `orderId` | 委外订单id | `orderId` | 823b74a3-0ec8-440f-91a3-fdf94ae2f1bd |
...
| 4 | `orderId` | 委外订单id | `osm.OSMOrder.OSMOrder` | None | true |
| 5 | `ytenant` | 租户id | `yht.tenant.YhtTenant` | Service |  |
| 6 | `orderproductid` | 订单产品id | `osm.OSMOrder.OSMOrderProduct` | None |  |
