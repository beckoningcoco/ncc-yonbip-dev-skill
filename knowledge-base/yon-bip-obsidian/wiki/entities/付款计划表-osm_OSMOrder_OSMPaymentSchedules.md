---
tags: ["BIP", "元数据", "数据字典", "OSM", "osm.OSMOrder.OSMPaymentSchedules"]
created: 2026-06-05
updated: 2026-06-05
...
# 付款计划表 (`osm.OSMOrder.OSMPaymentSchedules`)

> OSM | 物理表：`osm_paymentschedules`
...
| 25 | `orderId` | 委外订单id | `orderId` | 823b74a3-0ec8-440f-91a3-fdf94ae2f1bd |
