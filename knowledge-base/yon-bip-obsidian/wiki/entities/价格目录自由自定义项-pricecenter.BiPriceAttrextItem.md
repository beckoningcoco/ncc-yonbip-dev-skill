---
tags: ["BIP", "元数据", "数据字典", "ycPriceCenter", "aa.pricecenter.BiPriceAttrextItem"]
created: 2026-06-04
updated: 2026-06-04
...
# 价格目录自由自定义项 (`aa.pricecenter.BiPriceAttrextItem`)

> ⚡ **平台版本：BIP 旗舰版 V5** — 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。

> YonBIP ycPriceCenter 模块实体元数据字典。
> 物理表：`cpu_biprice_attrextitem` | 所属应用：`ycPriceCenter`
> 来源：元数据API `queryByUri` 返回的 `aa.pricecenter.BiPriceAttrextItem` 实体完整定义。
...
| 元数据层级 | `0` |
| 是否业务对象 | `true` |
| 构建时间 | `2026-06-04 16:24:40.4820` |

## 主键与编码

| 角色 | 字段名 | 数据库列 | 类型 | 说明 |
|------|--------|---------|------|------|
| 主键 | `id` | `id` | eb9690f1-b4ed-4223-8ce3-06710f2c6242 | 价格目录自由自定义项id |

## 部署信息

- **部署时间**: 2026-01-23 23:37:55:000
- **安装来源**: `/app/data_scripts/yonbip-cpu-bcprice/scripts/db/patch/mongodb/V5_R0_2507/0001_yonbip-cpu-bcprice/0010_iuap_common/DML/0270_iuap_metadata/0000-public-only/202512041410_metadata_aa-pricecenter_delta.zip`
- **安装人**: mongoTools
- **安装排名**: `5fb19e28-b603-4bb0-9fa8-6502a2722fb8`
...
- **migration_id** (MetaClassPrimary): 价格目录自由自定义项id — 唯一字段: `['id']`
...
| 61 | `id` | 价格目录自由自定义项id | `id` | eb9690f1-b4ed-4223-8ce3-06710f2c6242 | `quote` |  | ✓ |
...
| 2 | `id` | 价格目录自由自定义项id | `aa.pricecenter.BiPriceEntity` | `id` | defines → id | 1 | true | None |  |

### Composition（子表）

- **id**: `defines` → `aa.pricecenter.BiPriceEntity` | 1
