---
tags: ["BIP", "元数据", "数据字典", "ycBusinessCenter", "saleauction.talkResponse.ClarifyMaterialOfferVO"]
created: 2026-06-04
updated: 2026-06-04
...
# 价格谈判回复表体 (`saleauction.talkResponse.ClarifyMaterialOfferVO`)
...
|---|--------|--------|---------|------|
| 1 | `id` | 报价明细 | `id` | Long |
| 2 | `clarifyMaterialId` | 物料表主键 | `clarify_material_id` | b144fb7a-9fe6-4184-b386-7880c871337a |
| 3 | `bidClarifyBidderId` | 谈判供应商 | `bid_clarify_bidder_id` | 44831f35-0e0d-4376-a233-1852aedccd3a |
| 4 | `enterpriseId` | 委托单 | `enterprise_id` | Long |
| 5 | `enterpriseName` | 租户名称 | `enterprise_name` | String |
| 6 | `bidClarifyId` | 谈判单 | `bid_clarify_id` | 006ef228-db7d-4d3b-a5b8-bacc392affce |
...
| 16 | `priceHigh` | 最高限价 | `price_high` | Integer |
| 17 | `deliveryAddress` | 交货地址 | `delivery_address` | String |
| 18 | `startTime` | 供货开始时间 | `start_time` | Date |
| 19 | `endTime` | 结束时间 | `end_time` | Date |
| 20 | `whithUnit` | 需用单位 | `whith_unit` | String |
| 21 | `brand` | 商标品牌 | `brand` | String |
| 22 | `supEnterpriseName` | 供应商企业名称 | `bidder_name` | String |
| 23 | `maximumPrice` | 最高限价 | `maximum_price` | Decimal |
...
| 45 | `bidAmount` | 投标数量 | `bid_amount` | Decimal |
| 46 | `cpuClarifyMaterialDefineCharacter` | 谈判磋商表体自定义项特征 | `define_character_id` | 1938e7d0-0ace-4a2e-909b-cd7a85b94c75 |
...
| 53 | `materialDetailId` | 标包物料 | `material_detail_id` | a3dc80cd-0178-4f4f-95e2-5c450aa4e945 |
| 54 | `tax` | 税额 | `tax` | Decimal |
| 55 | `totalPrices` | 投标无税总价 | `total_prices` | Decimal |
| 56 | `cpuClarifyMaterialFreeCharacteristics` | 谈判磋商表体自由项特征组 | `free_characters_id` | c41fba1a-97c4-4f0e-be2c-861a3eeb79ea |
...
| 69 | `bodydefine` | 谈判磋商价格谈判回复表体自定义项 | `` | a9ab6395-091d-4b6d-bfdc-a3f2cfa08e98 |
...
| # | 字段名 | 显示名 | 目标实体 | 隔离级 | 组合 |
|---|--------|--------|---------|--------|------|
| 1 | `cpuClarifyMaterialFreeCharacteristics` | 谈判磋商表体自由项特征组 | `saleauction.talkResponse.CpuClarifyMaterialFreeCharacteristics` | None |  |
| 2 | `bidClarifyId` | 谈判单 | `saleauction.talks.BidClarifyVO` | None |  |
| 3 | `clarifyMaterialId` | 物料表主键 | `saleauction.talks.ClarifyMaterialVO` | None |  |
| 4 | `ytenant` | 租户id | `yht.tenant.YhtTenant` | Service |  |
| 5 | `purUnitId` | 采购单位主键 | `pc.unit.Unit` | Service |  |
| 6 | `bodydefine` | 谈判磋商价格谈判回复表体自定义项 | `saleauction.talkResponse.ClarifyMaterialOfferDefine` | None | true |
| 7 | `bidClarifyBidderId` | 谈判供应商 | `saleauction.talkResponse.ClarifyBidderVO` | None | true |
| 8 | `materialId` | 物料档案 | `pc.product.Product` | Service |  |
| 9 | `cpuClarifyMaterialDefineCharacter` | 谈判磋商表体自定义项特征 | `saleauction.talkResponse.CpuClarifyMaterialDefineCharacter` | None |  |
| 10 | `materialDetailId` | 标包物料 | `saleauction.project.AuctionSectionMaterial` | None |  |
| 11 | `currencyId` | 报价币种 | `bd.currencytenant.CurrencyTenantVO` | Service |  |
