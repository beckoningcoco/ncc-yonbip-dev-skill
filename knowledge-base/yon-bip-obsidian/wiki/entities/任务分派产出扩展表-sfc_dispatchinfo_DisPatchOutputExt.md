---
tags: ["BIP", "元数据", "数据字典", "IMPSFC", "sfc.dispatchinfo.DisPatchOutputExt"]
created: 2026-06-05
updated: 2026-06-05
...
# 任务分派产出扩展表 (`sfc.dispatchinfo.DisPatchOutputExt`)
...
| 所属应用 | `IMPSFC` |
| 构建时间 | `2026-06-05 09:25:58.4660` |

## 主键与编码

| 角色 | 字段名 | 类型 | 说明 |
|------|--------|------|------|
| 主键 | `id` | d73fe026-9d13-472d-84bf-8342af4d8d87 | 作业计划产出ID |
...
| # | 字段名 | 显示名 | 数据库列 | 类型 |
|---|--------|--------|---------|------|
| 1 | `id` | 作业计划产出ID | `id` | d73fe026-9d13-472d-84bf-8342af4d8d87 |
...
| 2 | `id` | 作业计划产出ID | `sfc.dispatchinfo.DisPatchOutput` | None | true |
