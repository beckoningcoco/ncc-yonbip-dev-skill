---
tags: ["BIP", "元数据", "数据字典", "IMPSFC", "sfc.dispatch.DisPatchExt"]
created: 2026-06-05
updated: 2026-06-05
...
# 任务分派拓展 (`sfc.dispatch.DisPatchExt`)
...
| 所属应用 | `IMPSFC` |
| 构建时间 | `2026-06-05 09:21:32.5090` |

## 主键与编码

| 角色 | 字段名 | 类型 | 说明 |
|------|--------|------|------|
| 主键 | `id` | 651c34e4-a23e-4bfd-89a7-f53f5d51e14e | 任务分派ID |
...
| # | 字段名 | 显示名 | 数据库列 | 类型 |
|---|--------|--------|---------|------|
| 1 | `id` | 任务分派ID | `id` | 651c34e4-a23e-4bfd-89a7-f53f5d51e14e |
...
| 2 | `id` | 任务分派ID | `sfc.dispatch.DisPatch` | None | true |
