---
tags: ["BIP", "元数据", "数据字典", "IMPSFC", "sfc.dispatch.DisPatchDetailDeviceAndStaff"]
created: 2026-06-05
updated: 2026-06-05
...
# 任务分派明细设备人员 (`sfc.dispatch.DisPatchDetailDeviceAndStaff`)
...
| 5 | `procPlanDetailId` | 任务分派明细ID | `proc_plan_detail_id` | db43487c-74bf-448e-a97c-8e4246938f6c |
...
| # | 字段名 | 显示名 | 目标实体 | 隔离级 | 组合 |
|---|--------|--------|---------|--------|------|
| 1 | `procPlanId` | 工序作业计划id | `sfc.procPlan.ProcPlan` | None |  |
| 2 | `ytenant` | 租户id | `yht.tenant.YhtTenant` | Service |  |
| 3 | `procPlanDetailId` | 任务分派明细ID | `sfc.dispatch.DisPatchDetail` | None | true |
| 4 | `deviceId` | 设备id | `aim.equip.EquipHeadVO` | Service |  |
