---
tags: ["BIP", "元数据", "数据字典", "ycBusinessCenter", "auction.bidnotice.NoticeApproveVO"]
created: 2026-06-04
updated: 2026-06-04
...
# 供应商报名审核记录表 (`auction.bidnotice.NoticeApproveVO`)
...
| 6 | `bidNoticeId` | 供应商报名主表 | `bid_notice_id` | 46ff8154-5b89-4faf-9361-0e81207b9ac4 |
...
| 5 | `bidNoticeId` | 供应商报名主表 | `auction.bidnotice.NoticeVO` | None | true |
