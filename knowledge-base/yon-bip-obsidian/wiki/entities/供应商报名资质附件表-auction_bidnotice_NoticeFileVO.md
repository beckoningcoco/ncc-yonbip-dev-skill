---
tags: ["BIP", "元数据", "数据字典", "ycBusinessCenter", "auction.bidnotice.NoticeFileVO"]
created: 2026-06-04
updated: 2026-06-04
...
# 供应商报名资质附件表 (`auction.bidnotice.NoticeFileVO`)
...
|---|--------|--------|---------|------|
| 1 | `id` | id | `id` | Long |
| 2 | `qualifyNo` | 证件编码 | `qualify_no` | String |
| 3 | `qualifyName` | 证件名称 | `qualify_name` | String |
| 4 | `qualifyExplain` | 证件描述 | `qualify_explain` | String |
| 5 | `isMustUpload` | 是否必须上传 | `is_must_upload` | Short |
| 6 | `fileID` | 附件 | `file_id` | String |
| 7 | `supQualifyNotes` | 供应商资质说明 | `sup_qualify_notes` | String |
| 8 | `bidNoticeId` | 供应商报名主表 | `bid_notice_id` | 46ff8154-5b89-4faf-9361-0e81207b9ac4 |
...
| 6 | `bidNoticeId` | 供应商报名主表 | `auction.bidnotice.NoticeVO` | None | true |
