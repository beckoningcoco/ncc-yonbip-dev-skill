---
tags: ["BIP", "元数据", "数据字典", "ycBusinessCenter", "saleauction.bid.InvitationVO"]
created: 2026-06-04
updated: 2026-06-04
...
# 供应商标段关系 (`saleauction.bid.InvitationVO`)
...
| # | 字段名 | 显示名 | 数据库列 | 类型 |
|---|--------|--------|---------|------|
| 1 | `biddingId` | 投标主表ID | `bidding_id` | af94c771-f926-452b-8760-f06c22b53d8f |
| 2 | `bidProjectId` | 采购项目id | `bid_project_id` | 9f8b9356-4cd6-4ae7-8dc0-c84dfecdda07 |
| 3 | `bidSectionId` | 标段包id | `bid_section_id` | 052621d8-fde7-4ab0-94bf-b179c720ce6d |
| 4 | `bidNoticeId` | 供应商报名主表 | `bid_notice_id` | 9f3db86b-e723-4fde-a245-f09c2e59bab1 |
| 5 | `announcementSectionId` | 公告标包标段信息 | `announcement_section_id` | 26f7d286-a241-415b-9be1-935fb4d87fd2 |
...
| 5 | `bidProjectId` | 采购项目id | `saleauction.project.AuctionProject` | None |  |
| 6 | `agencyOrgId` | 招标代理机构组织 | `org.func.BaseOrg` | Service |  |
| 7 | `bidNoticeId` | 供应商报名主表 | `saleauction.bidnotice.NoticeVO` | None |  |
| 8 | `bidSectionId` | 标段包id | `saleauction.project.AuctionSection` | None |  |
