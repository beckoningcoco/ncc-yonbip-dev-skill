---
tags: ["BIP", "元数据", "数据字典", "MR", "mr.erm.SDStateInfoDCT"]
created: 2026-06-05
updated: 2026-06-05
...
# 供需状态明细自定义项 (`mr.erm.SDStateInfoDCT`)

> MR | 物理表：`mr_sd_state_info_dct`
...
|------|-----|
| 显示名 | 供需状态明细自定义项 |
| 物理表 | `mr_sd_state_info_dct` |
| domain/服务域 | `yonbip-mm-plan` |
| schema | `requirements_planning` |
| 所属应用 | `MR` |
| 构建时间 | `2026-06-05 15:15:46.8180` |
