---
tags: ["BIP", "元数据", "数据字典", "ycSouringBid", "lawbid.calldocument.CallDepositPaymentMethod"]
created: 2026-06-04
updated: 2026-06-04
...
# 保证金缴纳方式 (`lawbid.calldocument.CallDepositPaymentMethod`)

> **平台版本：BIP 旗舰版 V5**

> ycSouringBid 模块 | 物理表：`cpu_deposit_payment_method`
...
|------|-----|
| 显示名 | 保证金缴纳方式 |
| 物理表 | `cpu_deposit_payment_method` |
| 数据库 schema | `yonbip-cpu-lawbid` |
| 所属应用 | `ycSouringBid` |
| 构建时间 | `2026-06-04 20:14:34.9180` |
...
| # | 字段名 | 显示名 | 数据库列 | 类型 |
|---|--------|--------|---------|------|
| 1 | `depositPaymentId` | 保证金缴纳方式 | `deposit_payment_id` | c88936ac-b4d4-4f31-b90e-eca5f8037e4b |
| 2 | `depositPaymentCode` | 保证金缴纳方式 | `deposit_payment_code` | String |
