---
tags: ["BIP", "元数据", "数据字典", "ycSouringBid", "lawbid.tenderAnnouncement.CallDepositPaymentMethodTender"]
created: 2026-06-04
updated: 2026-06-04
...
# 保证金缴纳方式 (`lawbid.tenderAnnouncement.CallDepositPaymentMethodTender`)

> **平台版本：BIP 旗舰版 V5**

> ycSouringBid 模块 | 物理表：`cpu_deposit_payment_method_tender`
...
|------|-----|
| 显示名 | 保证金缴纳方式 |
| 物理表 | `cpu_deposit_payment_method_tender` |
| domain/服务域 | `yonbip-cpu-lawbid` |
| schema | `cpu_lawbid` |
| 所属应用 | `ycSouringBid` |
| 构建时间 | `2026-06-04 20:17:01.1460` |
...
| # | 字段名 | 显示名 | 数据库列 | 类型 |
|---|--------|--------|---------|------|
| 1 | `depositPaymentCode` | 保证金缴纳方式 | `deposit_payment_code` | String |
| 2 | `depositPaymentId` | 保证金缴纳方式 | `deposit_payment_id` | c88936ac-b4d4-4f31-b90e-eca5f8037e4b |
| 3 | `bidSectionId` | 标段ID | `bid_section_id` | 0409e7d6-ed4c-4c0d-bc0d-dde79bdbf461 |
| 4 | `buyerTenant` | 采购商租户 | `buyer_tenant_id` | String |
| 5 | `callBidDocumentSectionId` | 招标文件子表 | `call_bid_document_section_id` | cabadb1e-5c64-4035-bbba-d79c9db61370 |
...
| 4 | `depositPaymentId` | 保证金缴纳方式 | `ewallet.config.PayType` | Service |  |
