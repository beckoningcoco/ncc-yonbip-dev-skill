---
tags: [BIP, 元数据, 数据字典, BGDM.milestones.MilepostDefineCharacter]
created: 2026-06-03
updated: 2026-06-03
...
# 里程碑自定义项特征 (`BGDM.milestones.MilepostDefineCharacter`)

> **平台版本：BIP 旗舰版 V5** -- 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。
> 物理表: `bgdm_milepost_character` | 应用: `BGDM` | 类型: `Class`
