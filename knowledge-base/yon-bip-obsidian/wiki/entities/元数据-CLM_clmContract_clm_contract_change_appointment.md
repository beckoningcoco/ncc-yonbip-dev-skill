---
tags: [BIP, 元数据, 数据字典, CLM.clmContract.clm_contract_change_appointment]
created: 2026-06-03
updated: 2026-06-03
...
# 合同变更履约事项 (`CLM.clmContract.clm_contract_change_appointment`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`clm_contract_change_appointment` | domain：`yonbip-ec-contract` | 应用：`CLM` | 业务对象ID：`18dc7fea-15f6-41e0-9ab9-b14c3e510b5f`
...
|------|-----|
| 显示名 | 合同变更履约事项 |
| 物理表 | `clm_contract_change_appointment` |
