---
tags: [BIP, 元数据, 数据字典, CLM.clmContract.clm_contract_counterpart]
created: 2026-06-03
updated: 2026-06-03
...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`clm_contract_counterpart` | domain：`yonbip-ec-contract` | 应用：`CLM` | 业务对象ID：`fc155a0a-e12b-41cd-bc03-5a1b7af2ae3a`
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `feature` | `feature` | `feature` | 合同信息相对方特征 |
