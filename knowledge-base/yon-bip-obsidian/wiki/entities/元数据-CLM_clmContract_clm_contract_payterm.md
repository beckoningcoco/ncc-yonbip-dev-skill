---
tags: [BIP, 元数据, 数据字典, CLM.clmContract.clm_contract_payterm]
created: 2026-06-03
updated: 2026-06-03
...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`clm_contract_payterm` | domain：`yonbip-ec-contract` | 应用：`CLM` | 业务对象ID：`fc155a0a-e12b-41cd-bc03-5a1b7af2ae3a`
