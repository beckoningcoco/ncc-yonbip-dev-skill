---
tags: [BIP, 元数据, 数据字典, EAP.apBillPushcheck.apBillPushcheck]
created: 2026-06-03
updated: 2026-06-03
...
# 应付推单校验表 (`EAP.apBillPushcheck.apBillPushcheck`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ap_bill_pushcheck` | domain：`yonbip-fi-earapbill` | 应用：`EAR` | 业务对象ID：`d7d386b2-4c13-45b8-b258-daa154e409b8`
