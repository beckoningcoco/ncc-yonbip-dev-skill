---
tags: [BIP, 元数据, 数据字典, EAP.apCarryover.ApPeriodSettleTask]
created: 2026-06-03
updated: 2026-06-03
...
# 应付结转任务 (`EAP.apCarryover.ApPeriodSettleTask`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_period_settle_task` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`1b71250b-e090-4c5a-ae3a-057a626af9f7`
