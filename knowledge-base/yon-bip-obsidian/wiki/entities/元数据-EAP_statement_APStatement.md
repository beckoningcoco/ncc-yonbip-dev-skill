---
tags: [BIP, 元数据, 数据字典, EAP.statement.APStatement]
created: 2026-06-03
updated: 2026-06-03
...
# 应付对账单 (`EAP.statement.APStatement`)
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `APStatementBody` | `EAP.statement.APStatementBody` | composition |
