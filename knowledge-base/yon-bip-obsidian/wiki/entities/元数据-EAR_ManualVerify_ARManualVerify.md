---
tags: [BIP, 元数据, 数据字典, EAR.ManualVerify.ARManualVerify]
created: 2026-06-03
updated: 2026-06-03
...
# 应收手工核销 (`EAR.ManualVerify.ARManualVerify`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`6f7c6350-093b-48be-9565-f46125321c36`
