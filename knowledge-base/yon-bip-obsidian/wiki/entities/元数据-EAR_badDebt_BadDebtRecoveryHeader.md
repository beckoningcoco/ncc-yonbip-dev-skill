---
tags: [BIP, 元数据, 数据字典, EAR.badDebt.BadDebtRecoveryHeader]
created: 2026-06-03
updated: 2026-06-03
...
# 坏账收回基本信息 (`EAR.badDebt.BadDebtRecoveryHeader`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`78ead09b-eb99-422c-ad91-f50af3946cf4`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `EAR.badDebt.BadDebtRecoveryBody` | composition |
