---
tags: [BIP, 元数据, 数据字典, EAR.earap.ARReportQuery]
created: 2026-06-03
updated: 2026-06-03
...
# 应收账表查询 (`EAR.earap.ARReportQuery`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`2ef545a3-37c0-4bb1-8d23-971fd9e62aef`
