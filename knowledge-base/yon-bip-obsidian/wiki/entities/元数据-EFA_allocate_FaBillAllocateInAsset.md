---
tags: [BIP, 元数据, 数据字典, EFA.allocate.FaBillAllocateInAsset]
created: 2026-06-03
updated: 2026-06-03
...
# 调入固定资产信息 (`EFA.allocate.FaBillAllocateInAsset`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_bill_allocate_in_asset` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`f110b003-9df9-45e8-b3ed-621aad532394`
...
| `allocate_out_asset_line_id` | `allocate_out_asset_line_id` | `allocateOutAssetLineId` | 调出单资产明细行id |
