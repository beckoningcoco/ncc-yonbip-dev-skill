---
tags: [BIP, 元数据, 数据字典, EFA.closeaccount.FaCloseCheckItemCondition]
created: 2026-06-03
updated: 2026-06-03
...
# 固定资产关账检查条件 (`EFA.closeaccount.FaCloseCheckItemCondition`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_close_account_check_set` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`2375db30-e6c8-4a3b-94ae-f0230d0ee2e4`
...
|------|-----|
| 显示名 | 固定资产关账检查条件 |
| 物理表 | `fa_close_account_check_set` |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `check_item_id` | `check_item_id` | `checkItemId` | 固定资产关账检查项 |
