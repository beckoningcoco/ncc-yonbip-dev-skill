---
tags: [BIP, 元数据, 数据字典, EFA.fabalance.FaBalanceBO]
created: 2026-06-03
updated: 2026-06-03
...
# 固定资产余额表 (`EFA.fabalance.FaBalanceBO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_balance` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`8fd1a2f0-1157-49f8-a8c6-120473ba2cc0`
