---
tags: [BIP, 元数据, 数据字典, EFA.inventory.FaInventoryAfAsgmt]
created: 2026-06-03
updated: 2026-06-03
...
# 固定资产盘点后分配信息 (`EFA.inventory.FaInventoryAfAsgmt`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_bill_inventory_af_asgmt` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`ed522121-30a8-437e-ad5d-815180f16dae`
...
|------|-----|
| 显示名 | 固定资产盘点后分配信息 |
| 物理表 | `fa_bill_inventory_af_asgmt` |
