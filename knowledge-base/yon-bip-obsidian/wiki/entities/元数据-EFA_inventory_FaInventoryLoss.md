---
tags: [BIP, 元数据, 数据字典, EFA.inventory.FaInventoryLoss]
created: 2026-06-03
updated: 2026-06-03
...
# 固定资产盘亏 (`EFA.inventory.FaInventoryLoss`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_bill_inventory_loss` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`9a470a14-e6ed-41b3-9cdf-ce49ab5d79e3`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `FaInventoryLossDetailList` | `EFA.inventory.FaInventoryLossDetail` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `` | `` | `FaInventoryLossDetailList` | 固定资产盘亏明细 |
