---
tags: [BIP, 元数据, 数据字典, EFA.inventory.FaInventoryLossAfAsgmt]
created: 2026-06-03
updated: 2026-06-03
...
# 固定资产盘亏变动后分配信息 (`EFA.inventory.FaInventoryLossAfAsgmt`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_bill_inventory_loss_af_asgmt` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`9a470a14-e6ed-41b3-9cdf-ce49ab5d79e3`
...
|------|-----|
| 显示名 | 固定资产盘亏变动后分配信息 |
| 物理表 | `fa_bill_inventory_loss_af_asgmt` |
