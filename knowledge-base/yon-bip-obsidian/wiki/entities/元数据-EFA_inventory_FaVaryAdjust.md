---
tags: [BIP, 元数据, 数据字典, EFA.inventory.FaVaryAdjust]
created: 2026-06-03
updated: 2026-06-03
...
# 固定资产差异调整 (`EFA.inventory.FaVaryAdjust`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_bill_vary_adjust` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`0e2b4e52-d1f7-4d01-821a-9223106ea401`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `FaVaryAdjustDetailList` | `EFA.inventory.FaVaryAdjustDetail` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `` | `` | `FaVaryAdjustDetailList` | 盘点差异调整子表 |
