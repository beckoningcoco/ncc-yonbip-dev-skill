---
tags: [BIP, 元数据, 数据字典, EFA.inventory.FaVaryAdjustBeAsgmt]
created: 2026-06-03
updated: 2026-06-03
...
# 盘点差异调整单变动前分配信息 (`EFA.inventory.FaVaryAdjustBeAsgmt`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_bill_vary_adjust_be_asgmt` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`0e2b4e52-d1f7-4d01-821a-9223106ea401`
...
|------|-----|
| 显示名 | 盘点差异调整单变动前分配信息 |
| 物理表 | `fa_bill_vary_adjust_be_asgmt` |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `free_ch_id` | `free_ch_id` | `freeChId` | 特征自定义项组 |
