---
tags: [BIP, 元数据, 数据字典, EFA.lease.FaLeaseChangeInterest]
created: 2026-06-03
updated: 2026-06-03
...
# 使用权资产变更利息明细 (`EFA.lease.FaLeaseChangeInterest`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_interest_detail` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`5cf2bdef-2e5e-496c-9c42-9dd2af7ee31e`
