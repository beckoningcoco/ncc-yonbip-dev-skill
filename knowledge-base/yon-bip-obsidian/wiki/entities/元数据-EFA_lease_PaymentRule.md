---
tags: [BIP, 元数据, 数据字典, EFA.lease.PaymentRule]
created: 2026-06-03
updated: 2026-06-03
...
# 付款规则 (`EFA.lease.PaymentRule`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_payment_rule` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`cfa82fdb-9603-46dd-bb61-26392313398f`
