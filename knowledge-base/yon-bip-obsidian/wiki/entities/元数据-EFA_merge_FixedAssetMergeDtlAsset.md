---
tags: [BIP, 元数据, 数据字典, EFA.merge.FixedAssetMergeDtlAsset]
created: 2026-06-03
updated: 2026-06-03
...
# 固定资产合并卡片明细表 (`EFA.merge.FixedAssetMergeDtlAsset`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_bill_merge_dtl_asset` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`afefa915-7e8e-4281-b822-4de51cd16ddc`
