---
tags: [BIP, 元数据, 数据字典, EFA.tofixed.FaPullMateriaOut]
created: 2026-06-03
updated: 2026-06-03
...
# 采购材料出库转固 (`EFA.tofixed.FaPullMateriaOut`)
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `FaPullMateriaOutDetailList` | `EFA.tofixed.FaPullMateriaOutDetail` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `` | `` | `FaPullMateriaOutDetailList` | 采购材料出库转固明细 |
