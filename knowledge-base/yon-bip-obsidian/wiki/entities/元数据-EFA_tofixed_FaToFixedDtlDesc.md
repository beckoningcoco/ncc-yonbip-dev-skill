---
tags: [BIP, 元数据, 数据字典, EFA.tofixed.FaToFixedDtlDesc]
created: 2026-06-03
updated: 2026-06-03
...
# 转固单孙表 (`EFA.tofixed.FaToFixedDtlDesc`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_to_fixed_dtl_desc` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`58054ba0-e961-405a-b29e-d5ac6bb8617b`
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `fa_to_fixed_dtl_id` | `fa_to_fixed_dtl_id` | `FaToFixedDtl_id` | 固定资产转固单表体 |
