---
tags: [BIP, 元数据, 数据字典, EIA.COSTADJUST.CostAdjustCostElementVO]
created: 2026-06-03
updated: 2026-06-03
...
# 费用调整分项信息 (`EIA.COSTADJUST.CostAdjustCostElementVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger_b_x_account_b` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`27784744-ff71-45d6-8ef8-73b92d0730d0`
...
| `detail_id` | `detail_id` | `detail` | 费用调整综合信息 |
