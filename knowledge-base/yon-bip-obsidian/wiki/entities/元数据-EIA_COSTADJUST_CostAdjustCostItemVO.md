---
tags: [BIP, 元数据, 数据字典, EIA.COSTADJUST.CostAdjustCostItemVO]
created: 2026-06-03
updated: 2026-06-03
...
# 费用调整费用项目 (`EIA.COSTADJUST.CostAdjustCostItemVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger_g` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`27784744-ff71-45d6-8ef8-73b92d0730d0`
