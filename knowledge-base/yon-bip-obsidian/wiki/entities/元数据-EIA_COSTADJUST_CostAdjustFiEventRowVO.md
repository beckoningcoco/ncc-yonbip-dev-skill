---
tags: [BIP, 元数据, 数据字典, EIA.COSTADJUST.CostAdjustFiEventRowVO]
created: 2026-06-03
updated: 2026-06-03
...
# 费用调整综合信息 (`EIA.COSTADJUST.CostAdjustFiEventRowVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger_b` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`27784744-ff71-45d6-8ef8-73b92d0730d0`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `costItems` | `EIA.COSTADJUST.CostAdjustCostItemVO` | composition |
| `costElements` | `EIA.COSTADJUST.CostAdjustCostElementVO` | composition |
...
| `header_id` | `header_id` | `header` | 费用调整 |
