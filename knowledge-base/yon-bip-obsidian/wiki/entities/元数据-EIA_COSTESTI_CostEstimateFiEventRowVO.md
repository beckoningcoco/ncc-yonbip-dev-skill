---
tags: [BIP, 元数据, 数据字典, EIA.COSTESTI.CostEstimateFiEventRowVO]
created: 2026-06-03
updated: 2026-06-03
...
# 费用暂估综合信息 (`EIA.COSTESTI.CostEstimateFiEventRowVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger_b` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`1829e1d4-037b-41c2-9d56-127ff95282de`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `costItems` | `EIA.COSTESTI.CostEstimateCostItemVO` | composition |
| `costElements` | `EIA.COSTESTI.CostEstimateCostElementVO` | composition |
...
| `header_id` | `header_id` | `header` | 费用暂估 |
