---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.APEstiEvent]
created: 2026-06-03
updated: 2026-06-03
...
# 暂估应付基本信息 (`FIAP.FIAP.APEstiEvent`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`feff8b5b-2371-4395-b4b6-c35eba18662d`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `FIAP.FIAP.APEstiEventBody` | composition |
