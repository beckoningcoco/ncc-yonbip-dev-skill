---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.APEstiEventGrandson]
created: 2026-06-03
updated: 2026-06-03
...
# 暂估应付计划信息 (`FIAP.FIAP.APEstiEventGrandson`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`feff8b5b-2371-4395-b4b6-c35eba18662d`
