---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.APEventBase]
created: 2026-06-03
updated: 2026-06-03
...
# 应付事务主表基类 (`FIAP.FIAP.APEventBase`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`b81e600e-9f79-427f-b504-391777a4889f`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `FIAP.FIAP.APEventBodyBase` | composition |
