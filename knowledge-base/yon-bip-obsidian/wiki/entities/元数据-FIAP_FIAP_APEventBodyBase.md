---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.APEventBodyBase]
created: 2026-06-03
updated: 2026-06-03
...
# 应付事务明细基类 (`FIAP.FIAP.APEventBodyBase`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_b` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`b81e600e-9f79-427f-b504-391777a4889f`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `grandsonItem` | `FIAP.FIAP.APEventGrandsonBase` | composition |
| `withHoldingTax` | `FIAP.FIAP.APEventWithHoldingTaxBase` | composition |
...
| `event_id` | `event_id` | `event` | 应付事务主表基类 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `` | `` | `grandsonItem` | 应付事务计划基类 |
| `` | `` | `withHoldingTax` | 应付事务代扣税基类 |
