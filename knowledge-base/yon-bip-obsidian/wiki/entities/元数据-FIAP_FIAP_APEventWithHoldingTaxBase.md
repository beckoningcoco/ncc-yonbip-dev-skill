---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.APEventWithHoldingTaxBase]
created: 2026-06-03
updated: 2026-06-03
...
# 应付事务代扣税基类 (`FIAP.FIAP.APEventWithHoldingTaxBase`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_wht` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`b81e600e-9f79-427f-b504-391777a4889f`
