...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_taxcalc` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`6f3a826c-6d66-48f5-a6ac-9f0f605b3c2a`
...
| `event_id` | `event_id` | `event` | 应付公共基本信息(租户) |
