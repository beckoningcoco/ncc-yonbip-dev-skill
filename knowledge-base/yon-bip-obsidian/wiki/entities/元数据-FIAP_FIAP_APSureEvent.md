---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.APSureEvent]
created: 2026-06-03
updated: 2026-06-03
...
# 确认应付基本信息  (`FIAP.FIAP.APSureEvent`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`c85ee8fd-6c38-4ed3-a31c-de29142b00a0`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `FIAP.FIAP.APSureEventBody` | composition |
...
| `eeac_fi_event_busi_id` | `eeac_fi_event_busi_id` | `fiEventBusiId` | 会计事务幂等性标识 |
