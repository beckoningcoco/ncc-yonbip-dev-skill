---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.APVerifyEventGrandson]
created: 2026-06-03
updated: 2026-06-03
...
# 应付核销详情 (`FIAP.FIAP.APVerifyEventGrandson`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`8a9f25d2-edb3-47c5-ab2d-afc9445199ec`
