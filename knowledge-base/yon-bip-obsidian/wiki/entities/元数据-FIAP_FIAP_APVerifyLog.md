---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.APVerifyLog]
created: 2026-06-03
updated: 2026-06-03
...
# 应付自动核销异常日志 (`FIAP.FIAP.APVerifyLog`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_verify_log` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`ea50468f-ba8e-4b18-8499-87c08a472fa6`
...
| `verify_plan_id` | `yonbip-fi-earap.ap_verify_plan_ref` |
...
| `event_code` | `event_code` | `eventCode` | 会计事务记录号 |
