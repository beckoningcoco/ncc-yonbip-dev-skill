---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.ApLossEarnEventHeaderBO]
created: 2026-06-03
updated: 2026-06-03
...
# 应付汇兑损益基本信息 (`FIAP.FIAP.ApLossEarnEventHeaderBO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`3a6844be-d2df-48ce-a45d-3308a5f8f2d4`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `FIAP.FIAP.ApLossEarnEventBodyBO` | composition |
