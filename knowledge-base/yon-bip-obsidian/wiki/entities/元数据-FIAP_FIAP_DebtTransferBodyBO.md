---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.DebtTransferBodyBO]
created: 2026-06-03
updated: 2026-06-03
...
# 债务转移明细信息 (`FIAP.FIAP.DebtTransferBodyBO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_b` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`653eb41c-e968-432d-8b6f-e6db556c6d73`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `grandsonItem` | `FIAP.FIAP.DebtTransferGrandBO` | composition |
