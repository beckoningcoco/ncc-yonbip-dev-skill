---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.OpeningPaymentEventBOTaxCalculationResult]
created: 2026-06-03
updated: 2026-06-03
...
# 计税单 (`FIAP.FIAP.OpeningPaymentEventBOTaxCalculationResult`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_taxcalc` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`f9070991-93a9-4e31-bfc0-d5e9b390df06`
...
| `event_id` | `event_id` | `event` | 期初付款基本信息 |
