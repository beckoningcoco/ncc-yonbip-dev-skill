---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.OpeningPaymentRefundEvent]
created: 2026-06-03
updated: 2026-06-03
...
# 期初付款退款基本信息 (`FIAP.FIAP.OpeningPaymentRefundEvent`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`4205f958-e456-49bc-bd85-7db2f8e8e135`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `FIAP.FIAP.OpeningPaymentRefundEventBody` | composition |
