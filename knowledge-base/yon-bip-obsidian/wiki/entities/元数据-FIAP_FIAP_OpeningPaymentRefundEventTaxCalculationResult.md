---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.OpeningPaymentRefundEventTaxCalculationResult]
created: 2026-06-03
updated: 2026-06-03
...
# 计税单 (`FIAP.FIAP.OpeningPaymentRefundEventTaxCalculationResult`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_taxcalc` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`4205f958-e456-49bc-bd85-7db2f8e8e135`
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `body_id` | `body_id` | `body` | 期初付款退款明细信息 |
...
| `event_id` | `event_id` | `event` | 期初付款退款基本信息 |
