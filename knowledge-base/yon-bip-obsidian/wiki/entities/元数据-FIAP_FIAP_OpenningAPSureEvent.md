---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.OpenningAPSureEvent]
created: 2026-06-03
updated: 2026-06-03
...
# 期初确认应付基本信息 (`FIAP.FIAP.OpenningAPSureEvent`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`ebf9a75f-1124-41eb-aff2-eb159ef1f809`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `FIAP.FIAP.OpenningAPSureEventBody` | composition |
