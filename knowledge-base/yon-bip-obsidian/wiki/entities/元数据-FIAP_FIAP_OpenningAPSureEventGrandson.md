---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.OpenningAPSureEventGrandson]
created: 2026-06-03
updated: 2026-06-03
...
# 期初确认应付计划信息 (`FIAP.FIAP.OpenningAPSureEventGrandson`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`ebf9a75f-1124-41eb-aff2-eb159ef1f809`
