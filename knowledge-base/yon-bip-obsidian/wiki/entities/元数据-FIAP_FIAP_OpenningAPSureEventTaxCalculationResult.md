---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.OpenningAPSureEventTaxCalculationResult]
created: 2026-06-03
updated: 2026-06-03
...
# 计税单 (`FIAP.FIAP.OpenningAPSureEventTaxCalculationResult`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_taxcalc` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`ebf9a75f-1124-41eb-aff2-eb159ef1f809`
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `body_id` | `body_id` | `body` | 期初确认应付明细信息 |
...
| `event_id` | `event_id` | `event` | 期初确认应付基本信息 |
