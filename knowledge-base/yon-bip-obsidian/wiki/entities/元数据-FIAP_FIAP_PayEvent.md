---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.PayEvent]
created: 2026-06-03
updated: 2026-06-03
...
# 付款基本信息 (`FIAP.FIAP.PayEvent`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`2f308a80-2be8-411f-bc54-1f5bb826cb53`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `FIAP.FIAP.PayEventBody` | composition |
