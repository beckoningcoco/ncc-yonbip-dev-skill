---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.PayEventBody]
created: 2026-06-03
updated: 2026-06-03
...
# 付款明细信息 (`FIAP.FIAP.PayEventBody`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_b` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`2f308a80-2be8-411f-bc54-1f5bb826cb53`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `taxGrandsonItem` | `FIAP.FIAP.PayEventTaxCalculationResult` | composition |
| `withHoldingTax` | `FIAP.FIAP.PayEventWithHoldingTax` | composition |
