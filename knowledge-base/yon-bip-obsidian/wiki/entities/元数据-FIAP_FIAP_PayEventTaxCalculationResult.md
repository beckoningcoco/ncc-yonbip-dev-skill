---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.PayEventTaxCalculationResult]
created: 2026-06-03
updated: 2026-06-03
...
# 计税单 (`FIAP.FIAP.PayEventTaxCalculationResult`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_taxcalc` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`2f308a80-2be8-411f-bc54-1f5bb826cb53`
...
| `event_id` | `event_id` | `event` | 付款单基本信息(租户) |
