---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.PayEventWithHoldingTax]
created: 2026-06-03
updated: 2026-06-03
...
# 付款代扣税信息 (`FIAP.FIAP.PayEventWithHoldingTax`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_wht` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`2f308a80-2be8-411f-bc54-1f5bb826cb53`
...
| `event_id` | `event_id` | `event` | 付款基本信息 |
