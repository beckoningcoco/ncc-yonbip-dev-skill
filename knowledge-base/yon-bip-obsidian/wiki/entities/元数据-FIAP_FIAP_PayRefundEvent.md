---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.PayRefundEvent]
created: 2026-06-03
updated: 2026-06-03
...
# 付款退款基本信息 (`FIAP.FIAP.PayRefundEvent`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`05498a34-5ac3-45b6-89d7-06b68d1cc54d`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `FIAP.FIAP.PayRefundEventBody` | composition |
