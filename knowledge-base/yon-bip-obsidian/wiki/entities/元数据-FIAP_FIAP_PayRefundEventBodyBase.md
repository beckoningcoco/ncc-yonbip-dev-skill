---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.PayRefundEventBodyBase]
created: 2026-06-03
updated: 2026-06-03
...
# 付款退款明细基类 (`FIAP.FIAP.PayRefundEventBodyBase`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_b` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`76192ea5-5dac-4385-aa96-e8845efbbfc3`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `withHoldingTax` | `FIAP.FIAP.PayRefundEventWithHoldingTaxBase` | composition |
...
| `event_id` | `event_id` | `event` | 付款退款事务基类 |
