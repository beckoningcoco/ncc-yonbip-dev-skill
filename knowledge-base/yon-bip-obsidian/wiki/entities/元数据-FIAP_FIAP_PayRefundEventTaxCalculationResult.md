---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.PayRefundEventTaxCalculationResult]
created: 2026-06-03
updated: 2026-06-03
...
# 计税单 (`FIAP.FIAP.PayRefundEventTaxCalculationResult`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_taxcalc` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`05498a34-5ac3-45b6-89d7-06b68d1cc54d`
