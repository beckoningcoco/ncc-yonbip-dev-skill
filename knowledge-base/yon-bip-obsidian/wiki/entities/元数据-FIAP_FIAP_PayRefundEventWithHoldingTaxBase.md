---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.PayRefundEventWithHoldingTaxBase]
created: 2026-06-03
updated: 2026-06-03
...
# 付款退款代扣税信息基类 (`FIAP.FIAP.PayRefundEventWithHoldingTaxBase`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_wht` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`76192ea5-5dac-4385-aa96-e8845efbbfc3`
