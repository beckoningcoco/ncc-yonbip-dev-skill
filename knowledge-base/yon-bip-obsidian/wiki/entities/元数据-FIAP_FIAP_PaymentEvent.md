---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.PaymentEvent]
created: 2026-06-03
updated: 2026-06-03
...
# 日常付款基本信息 (`FIAP.FIAP.PaymentEvent`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`df3b9ddf-31a8-4254-b23c-8ea4d99b0a99`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `FIAP.FIAP.PaymentEventBodyBO` | composition |
