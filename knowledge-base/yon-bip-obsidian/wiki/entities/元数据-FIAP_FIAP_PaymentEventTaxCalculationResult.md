---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.PaymentEventTaxCalculationResult]
created: 2026-06-03
updated: 2026-06-03
...
# 计税单 (`FIAP.FIAP.PaymentEventTaxCalculationResult`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_taxcalc` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`df3b9ddf-31a8-4254-b23c-8ea4d99b0a99`
...
| `event_id` | `event_id` | `event` | 日常付款基本信息 |
