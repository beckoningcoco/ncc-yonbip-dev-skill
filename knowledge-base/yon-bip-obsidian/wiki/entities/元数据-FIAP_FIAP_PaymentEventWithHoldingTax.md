---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.PaymentEventWithHoldingTax]
created: 2026-06-03
updated: 2026-06-03
...
# 日常付款代扣税信息 (`FIAP.FIAP.PaymentEventWithHoldingTax`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_wht` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`df3b9ddf-31a8-4254-b23c-8ea4d99b0a99`
