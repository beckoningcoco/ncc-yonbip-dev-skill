---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.TaxCalculationResultARAP]
created: 2026-06-03
updated: 2026-06-03
...
# 计税单基类新 (`FIAP.FIAP.TaxCalculationResultARAP`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_taxcalc` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`04790a42-effc-42a6-9cf5-2665d6f2c6ea`
