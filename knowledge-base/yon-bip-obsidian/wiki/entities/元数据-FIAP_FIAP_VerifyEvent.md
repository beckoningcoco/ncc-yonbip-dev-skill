---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.VerifyEvent]
created: 2026-06-03
updated: 2026-06-03
...
# 核销基本信息 (`FIAP.FIAP.VerifyEvent`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`e43663ab-47b1-4644-b1ec-8d3f78e53d87`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `FIAP.FIAP.VerifyEventBody` | composition |
