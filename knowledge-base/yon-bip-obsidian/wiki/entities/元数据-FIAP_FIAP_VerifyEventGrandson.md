---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.VerifyEventGrandson]
created: 2026-06-03
updated: 2026-06-03
...
# 核销详情信息 (`FIAP.FIAP.VerifyEventGrandson`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`e43663ab-47b1-4644-b1ec-8d3f78e53d87`
...
| `acc_gain_loss_flag` | `acc_gain_loss_flag` | `gainLossFlag` | 本币损益标识(枚举值 1:收益; -1:损失) |
