---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.VerifyOrder]
created: 2026-06-03
updated: 2026-06-03
...
# 应付核销分类 (`FIAP.FIAP.VerifyOrder`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_verify_plan_b_order` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`afff1c3a-bd85-4cb1-b855-fd1d4665800c`
