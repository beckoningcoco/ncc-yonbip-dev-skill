---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.VerifyPlan]
created: 2026-06-03
updated: 2026-06-03
...
# 应付核销方案 (`FIAP.FIAP.VerifyPlan`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_verify_plan_h` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`afff1c3a-bd85-4cb1-b855-fd1d4665800c`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `VerifyRangeList` | `FIAP.FIAP.VerifyRange` | composition |
| `VerifyMatchList` | `FIAP.FIAP.VerifyMatch` | composition |
| `VerifyOrderList` | `FIAP.FIAP.VerifyOrder` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `` | `` | `VerifyMatchList` | 应付匹配规则 |
| `` | `` | `VerifyOrderList` | 应付核销分类 |
| `` | `` | `VerifyRangeList` | 应付核销范围 |
