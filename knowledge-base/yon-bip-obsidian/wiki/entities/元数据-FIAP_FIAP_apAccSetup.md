---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.apAccSetup]
created: 2026-06-03
updated: 2026-06-03
...
# 应付期初建账 (`FIAP.FIAP.apAccSetup`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_acc_setup` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`8503c636-70a7-4c13-b5e8-8a3552f9bf4b`
