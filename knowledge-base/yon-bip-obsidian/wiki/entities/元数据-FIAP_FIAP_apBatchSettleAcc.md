---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.apBatchSettleAcc]
created: 2026-06-03
updated: 2026-06-03
...
# 应付批量结账 (`FIAP.FIAP.apBatchSettleAcc`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_period_close_account` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`2f0fad09-a87e-4fe3-b938-21fec600f0d7`
