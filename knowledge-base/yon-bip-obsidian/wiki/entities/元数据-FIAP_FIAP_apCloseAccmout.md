---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.apCloseAccmout]
created: 2026-06-03
updated: 2026-06-03
...
# 应付关账 (`FIAP.FIAP.apCloseAccmout`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_period_close_account` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`a95cadaf-0f5a-4b18-a04b-5fa669bd7d0a`
