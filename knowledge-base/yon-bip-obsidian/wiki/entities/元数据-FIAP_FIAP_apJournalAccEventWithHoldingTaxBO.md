---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.apJournalAccEventWithHoldingTaxBO]
created: 2026-06-03
updated: 2026-06-03
...
# 应付流水账事务代扣税信息 (`FIAP.FIAP.apJournalAccEventWithHoldingTaxBO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_wht` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`b5381420-aa2d-498f-9ca0-eb3187bfe577`
