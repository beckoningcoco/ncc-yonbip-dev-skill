---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.apVerify]
created: 2026-06-03
updated: 2026-06-03
...
# 应付手工核销查询基本信息 (`FIAP.FIAP.apVerify`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`a6d5bc0b-27fb-44e4-91aa-b4606e625495`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `FIAP.FIAP.apVerifyBody` | composition |
