---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.apVerifyBody]
created: 2026-06-03
updated: 2026-06-03
...
# 应付手工核销分组信息 (`FIAP.FIAP.apVerifyBody`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_b` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`a6d5bc0b-27fb-44e4-91aa-b4606e625495`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `grandsonItem` | `FIAP.FIAP.apVerifyPlan` | composition |
...
| `acc_exchange_rate_type_id` | `acc_exchange_rate_type_id` | `orgExchangeRateType` | 组织币汇率类型(来源全球化汇率类型档案) |
