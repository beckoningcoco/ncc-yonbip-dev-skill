---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.arapAccSetup]
created: 2026-06-03
updated: 2026-06-03
...
# 期初建账 (`FIAP.FIAP.arapAccSetup`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_acc_setup` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`ef840601-7405-478c-8f9f-c2b63fc16fe9`
