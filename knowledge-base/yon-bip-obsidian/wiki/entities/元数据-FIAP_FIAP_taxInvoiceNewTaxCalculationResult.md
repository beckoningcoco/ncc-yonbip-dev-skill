---
tags: [BIP, 元数据, 数据字典, FIAP.FIAP.taxInvoiceNewTaxCalculationResult]
created: 2026-06-03
updated: 2026-06-03
...
# 计税单 (`FIAP.FIAP.taxInvoiceNewTaxCalculationResult`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_taxcalc` | domain：`yonbip-fi-earap` | 应用：`EAP` | 业务对象ID：`c85ee8fd-6c38-4ed3-a31c-de29142b00a0`
...
| `event_id` | `event_id` | `event` | 确认应付基本信息 (租户) |
