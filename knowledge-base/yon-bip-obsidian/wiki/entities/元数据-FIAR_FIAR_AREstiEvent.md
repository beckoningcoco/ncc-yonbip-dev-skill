---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.AREstiEvent]
created: 2026-06-03
updated: 2026-06-03
...
# 暂估应收基本信息 (`FIAR.FIAR.AREstiEvent`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`456dbb8a-e8bb-4269-90a2-863e7a29e046`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `FIAR.FIAR.AREstiEventBody` | composition |
...
| `eeac_fi_event_busi_id` | `eeac_fi_event_busi_id` | `fiEventBusiId` | 幂等性标识 |
