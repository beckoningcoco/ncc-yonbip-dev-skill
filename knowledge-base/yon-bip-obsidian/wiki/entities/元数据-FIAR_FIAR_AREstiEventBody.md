---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.AREstiEventBody]
created: 2026-06-03
updated: 2026-06-03
...
# 暂估应收明细信息 (`FIAR.FIAR.AREstiEventBody`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_b` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`456dbb8a-e8bb-4269-90a2-863e7a29e046`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `grandsonItem` | `FIAR.FIAR.AREstiEventGrandson` | composition |
| `taxGrandsonItem` | `FIAR.FIAR.AREstiEventTaxCalculationResult` | composition |
...
| `event_id` | `event_id` | `event` | 暂估应收事务主表 |
