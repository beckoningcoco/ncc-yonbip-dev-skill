---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.AREventBase]
created: 2026-06-03
updated: 2026-06-03
...
# 应收事务主表基类 (`FIAR.FIAR.AREventBase`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`15796d11-c64c-4d48-baae-97ce067258e3`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `FIAR.FIAR.AREventBodyBase` | composition |
