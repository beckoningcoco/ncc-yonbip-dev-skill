---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.AREventWithHoldingTaxBase]
created: 2026-06-03
updated: 2026-06-03
...
# 应收事务代扣税基类 (`FIAR.FIAR.AREventWithHoldingTaxBase`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_wht` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`15796d11-c64c-4d48-baae-97ce067258e3`
...
| `event_id` | `event_id` | `event` | 应收事务基本信息基类 |
