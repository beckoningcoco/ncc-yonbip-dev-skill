---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.ARStatementBody]
created: 2026-06-03
updated: 2026-06-03
...
# 应收对账明细表 (`FIAR.FIAR.ARStatementBody`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：``
