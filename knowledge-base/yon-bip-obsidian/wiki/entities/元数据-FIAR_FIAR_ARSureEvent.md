---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.ARSureEvent]
created: 2026-06-03
updated: 2026-06-03
...
# 确认应收基本信息 (`FIAR.FIAR.ARSureEvent`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`f243b293-8b9d-496f-9b3c-c0b8cad1d0ee`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `FIAR.FIAR.ARSureEventBody` | composition |
