---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.ARSureEventBody]
created: 2026-06-03
updated: 2026-06-03
...
# 确认应收明细信息 (`FIAR.FIAR.ARSureEventBody`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_b` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`f243b293-8b9d-496f-9b3c-c0b8cad1d0ee`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `grandsonItem` | `FIAR.FIAR.ARSureEventGrandson` | composition |
| `taxGrandsonItem` | `FIAR.FIAR.ArSureEventTaxCalculationResult` | composition |
...
| `fa_asset_id` | `fa_asset_id` | `faAssetId` | 资产ID |
...
| `event_id` | `event_id` | `event` | 确认应收事务主表基类 |
...
| `acc_invoice_tax_amount` | `acc_invoice_tax_amount` | `accInvoiceTaxAmount` | 开票本币税额(应收补差用) |
| `acc_invoice_tax_exc_amount` | `acc_invoice_tax_exc_amount` | `accInvoiceTaxExcludedAmount` | 开票本币无税金额(应收补差用) |
| `acc_invoice_tax_inc_amount` | `acc_invoice_tax_inc_amount` | `accInvoiceTaxIncludedAmount` | 开票本币含税金额(应收补差用) |
...
| `ori_invoice_tax_amount` | `ori_invoice_tax_amount` | `oriInvoiceTaxAmount` | 开票税额(应收补差用) |
| `ori_invoice_tax_exc_amount` | `ori_invoice_tax_exc_amount` | `oriInvoiceTaxExcludedAmount` | 开票无税金额(应收补差用) |
| `ori_invoice_tax_inc_amount` | `ori_invoice_tax_inc_amount` | `oriInvoiceTaxIncludedAmount` | 开票含税金额(应收补差用) |
