---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.ARSureEventGrandson]
created: 2026-06-03
updated: 2026-06-03
...
# 确认应收计划信息 (`FIAR.FIAR.ARSureEventGrandson`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`f243b293-8b9d-496f-9b3c-c0b8cad1d0ee`
...
| `body_id` | `body_id` | `body` | 确认应收事务明细基类 |
