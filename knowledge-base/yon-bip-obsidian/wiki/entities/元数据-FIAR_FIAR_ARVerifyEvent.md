---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.ARVerifyEvent]
created: 2026-06-03
updated: 2026-06-03
...
# 应收核销基本信息 (`FIAR.FIAR.ARVerifyEvent`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`ad337392-5663-46cb-871b-706e07a6f6d8`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `FIAR.FIAR.ARVerifyEventBody` | composition |
