---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.ArLossEarnEventBodyBO]
created: 2026-06-03
updated: 2026-06-03
...
# 应收汇兑损益明细信息 (`FIAR.FIAR.ArLossEarnEventBodyBO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_b` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`dec9ad5b-0499-41f1-86a7-0ceda1d2cc91`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `grandsonItem` | `FIAR.FIAR.ArLossEarnEventGrandsonBO` | composition |
...
| `event_id` | `event_id` | `event` | 应收汇兑损益事务 |
