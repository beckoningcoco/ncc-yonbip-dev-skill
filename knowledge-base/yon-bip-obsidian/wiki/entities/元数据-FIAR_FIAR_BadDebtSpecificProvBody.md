---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.BadDebtSpecificProvBody]
created: 2026-06-03
updated: 2026-06-03
...
# 坏账个别计提明细信息 (`FIAR.FIAR.BadDebtSpecificProvBody`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_baddebt_provision_b` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`a6b78f32-d867-4b51-9a6b-2ea2d22383ed`
...
| `header_id` | `header_id` | `headerId` | 坏账个别计提基本信息 |
