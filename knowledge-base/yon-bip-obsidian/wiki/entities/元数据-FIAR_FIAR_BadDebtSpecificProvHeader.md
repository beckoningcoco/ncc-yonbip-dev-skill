---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.BadDebtSpecificProvHeader]
created: 2026-06-03
updated: 2026-06-03
...
# 坏账个别计提基本信息 (`FIAR.FIAR.BadDebtSpecificProvHeader`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_baddebt_provision_h` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`a6b78f32-d867-4b51-9a6b-2ea2d22383ed`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `FIAR.FIAR.BadDebtSpecificProvBody` | composition |
