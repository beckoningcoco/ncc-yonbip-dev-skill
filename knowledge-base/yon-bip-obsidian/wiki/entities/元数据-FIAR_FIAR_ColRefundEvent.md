---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.ColRefundEvent]
created: 2026-06-03
updated: 2026-06-03
...
# 收款退款基本信息 (`FIAR.FIAR.ColRefundEvent`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`8fadc641-5abf-4eed-9f06-99c607cb4536`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `FIAR.FIAR.ColRefundEventBody` | composition |
| `TEST25101001List` | `FIAR.FIAR.TEST25101001` | composition |
