---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.ColRefundEventBody]
created: 2026-06-03
updated: 2026-06-03
...
# 收款退款明细信息 (`FIAR.FIAR.ColRefundEventBody`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_b` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`8fadc641-5abf-4eed-9f06-99c607cb4536`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `taxGrandsonItem` | `FIAR.FIAR.ColRefundEventTaxCalculationResult` | composition |
...
| `event_id` | `event_id` | `event` | 收款退款事务 |
...
| `local_clear_time` | `local_clear_time` | `localClearTime` | 清账时间 |
