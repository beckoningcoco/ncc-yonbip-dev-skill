---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.ColRefundEventBodyBase]
created: 2026-06-03
updated: 2026-06-03
...
# 收款退款明细基类 (`FIAR.FIAR.ColRefundEventBodyBase`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_b` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`16f9c9d3-2336-47b4-9ec6-a5c0213a9365`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `withHoldingTax` | `FIAR.FIAR.ColRefundEventWithHoldingTaxBase` | composition |
...
| `event_id` | `event_id` | `event` | 收款退款事务基类 |
