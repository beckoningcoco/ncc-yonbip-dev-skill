---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.CollectionEventBody]
created: 2026-06-03
updated: 2026-06-03
...
# 收款明细信息 (`FIAR.FIAR.CollectionEventBody`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_b` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`d0834add-256b-436e-adad-04ff7ce723a8`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `taxGrandsonItem` | `FIAR.FIAR.CollectionEventTaxCalculationResult` | composition |
