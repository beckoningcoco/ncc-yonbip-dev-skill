---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.CollectionEventTaxCalculationResult]
created: 2026-06-03
updated: 2026-06-03
...
# 计税单 (`FIAR.FIAR.CollectionEventTaxCalculationResult`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_taxcalc` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`d0834add-256b-436e-adad-04ff7ce723a8`
...
| `event_id` | `event_id` | `event` | 收款基本信息(租户) |
