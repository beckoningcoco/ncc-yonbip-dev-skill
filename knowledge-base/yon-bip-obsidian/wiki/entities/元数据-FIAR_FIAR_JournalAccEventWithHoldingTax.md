---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.JournalAccEventWithHoldingTax]
created: 2026-06-03
updated: 2026-06-03
...
# 流水账事务代扣税信息 (`FIAR.FIAR.JournalAccEventWithHoldingTax`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_wht` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`8da54fe3-2f7d-49f3-817f-41202416baa7`
