---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.LossEarnEventHeaderBaseBO]
created: 2026-06-03
updated: 2026-06-03
...
# 汇兑损益事务基本信息基类 (`FIAR.FIAR.LossEarnEventHeaderBaseBO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`94ab4b71-8269-4d87-860d-63fecc1c41aa`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `FIAR.FIAR.LossEarnEventBodyBaseBO` | composition |
