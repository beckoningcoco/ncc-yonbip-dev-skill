---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.VerifyMatchReceive]
created: 2026-06-03
updated: 2026-06-03
...
# 匹配规则 (`FIAR.FIAR.VerifyMatchReceive`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_verify_plan_b_match` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`5a66d4d4-0775-4b29-b908-20c5c6952821`
