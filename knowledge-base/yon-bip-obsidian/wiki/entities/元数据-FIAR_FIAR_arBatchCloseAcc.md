---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.arBatchCloseAcc]
created: 2026-06-03
updated: 2026-06-03
...
# 应收批量关账 (`FIAR.FIAR.arBatchCloseAcc`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_period_close_account` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`f67faa9f-b5d8-45eb-978f-45d3ee024308`
