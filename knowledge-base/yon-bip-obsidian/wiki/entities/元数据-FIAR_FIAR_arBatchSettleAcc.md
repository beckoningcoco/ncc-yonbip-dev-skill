---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.arBatchSettleAcc]
created: 2026-06-03
updated: 2026-06-03
...
# 应收批量结账 (`FIAR.FIAR.arBatchSettleAcc`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_period_close_account` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`1d45c2f4-55f8-48f8-9483-3a19e6315ac4`
