---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.arCloseAcc]
created: 2026-06-03
updated: 2026-06-03
...
# 应收关账 (`FIAR.FIAR.arCloseAcc`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_period_close_account` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`f18cb8a5-6825-4ce3-86c4-b2ca1f4e44e6`
