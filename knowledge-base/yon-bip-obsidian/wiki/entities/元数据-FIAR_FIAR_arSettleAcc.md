---
tags: [BIP, 元数据, 数据字典, FIAR.FIAR.arSettleAcc]
created: 2026-06-03
updated: 2026-06-03
...
# 应收结账 (`FIAR.FIAR.arSettleAcc`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_period_close_account` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`db3a3543-999e-482a-8a2b-ce390a4dee34`
