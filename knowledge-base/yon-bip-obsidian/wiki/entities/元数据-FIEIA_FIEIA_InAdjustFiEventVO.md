---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.InAdjustFiEventVO]
created: 2026-06-03
updated: 2026-06-03
...
# 损益入库调整 (`FIEIA.FIEIA.InAdjustFiEventVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`a96f1bc5-307b-4cc3-bd0d-473e023785ce`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodies` | `FIEIA.FIEIA.InAdjustBodyFiEventVO` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `free_ch_id` | `free_ch_id` | `freeChId` | 损益入库调整自定义项特征 |
