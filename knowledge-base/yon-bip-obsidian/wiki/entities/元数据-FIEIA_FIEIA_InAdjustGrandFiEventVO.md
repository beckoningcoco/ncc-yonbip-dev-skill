---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.InAdjustGrandFiEventVO]
created: 2026-06-03
updated: 2026-06-03
...
# 损益入库调整分项明细 (`FIEIA.FIEIA.InAdjustGrandFiEventVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger_b_x_account_b` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`a96f1bc5-307b-4cc3-bd0d-473e023785ce`
...
| `detail_id` | `detail_id` | `detail` | 损益入库调整综合信息 |
