---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.InnerTransferInConfirmEleVO]
created: 2026-06-03
updated: 2026-06-03
...
# 内部交易入库确认分项信息 (`FIEIA.FIEIA.InnerTransferInConfirmEleVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger_b_x_account_b` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`06435280-5fe8-441b-a6c1-666922cdbcb6`
