---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.InnerTransferInConfirmVO]
created: 2026-06-03
updated: 2026-06-03
...
# 内部交易入库确认 (`FIEIA.FIEIA.InnerTransferInConfirmVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`06435280-5fe8-441b-a6c1-666922cdbcb6`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodies` | `FIEIA.FIEIA.InnerTransferInConfirmRowVO` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `free_ch_id` | `free_ch_id` | `freeChId` | 内部交易入库确认自定义项特征 |
