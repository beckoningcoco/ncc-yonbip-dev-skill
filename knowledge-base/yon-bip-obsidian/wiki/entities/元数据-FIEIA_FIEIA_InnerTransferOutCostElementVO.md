---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.InnerTransferOutCostElementVO]
created: 2026-06-03
updated: 2026-06-03
...
# 内部交易出库核算分项信息 (`FIEIA.FIEIA.InnerTransferOutCostElementVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger_b_x_account_b` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`f1d5f851-e93a-4d6d-97eb-229a015d4b49`
...
| `detail_id` | `detail_id` | `detail` | 内部交易销售出库核算综合信息 |
| `creator` | `creator` | `creator` | 创建人 |
| `modifier` | `modifier` | `modifier` | 修改人 |
| `ytenant_id` | `ytenant_id` | `ytenantId` | 租户id |
| `accbook_trade_rate_type` | `accbook_trade_rate_type` | `accbookTradeRateType` | 本币交易汇率类型 |
| `global_trade_rate_type` | `global_trade_rate_type` | `globalTradeRateType` | 全局币交易汇率类型 |
| `group_trade_rate_type` | `group_trade_rate_type` | `groupTradeRateType` | 集团币交易汇率类型 |
...
|--------|---------|---------|--------|
| `num` | `num` | `num` | 要素数量 |
| `balance_num` | `balance_num` | `balanceNum` | 要素结余数量 |
...
| `accbook_ipv_rate_dif` | `accbook_ipv_rate_dif` | `accbookIpvRateDif` | 账簿本币结算汇率差异 |
...
| `org_ipv_rate_dif` | `org_ipv_rate_dif` | `orgIpvRateDif` | 组织本币结算汇率差异 |
...
| `group_ipv_rate_dif` | `group_ipv_rate_dif` | `groupIpvRateDif` | 集团本币结算汇率差异 |
...
| `global_ipv_rate_dif` | `global_ipv_rate_dif` | `globalIpvRateDif` | 全局本币结算汇率差异 |
...
| `control_ipv_rate_dif` | `control_ipv_rate_dif` | `controlIpvRateDif` | 管控范围本币结算汇率差异 |
...
| `accbook_currency_rate` | `accbook_currency_rate` | `accbookCurrencyRate` | 本币折算汇率 |
| `global_currency_rate` | `global_currency_rate` | `globalCurrencyRate` | 全局币折算汇率 |
| `group_currency_rate` | `group_currency_rate` | `groupCurrencyRate` | 集团币折算汇率 |
| `org_currency_rate` | `org_currency_rate` | `orgCurrencyRate` | 组织币折算汇率 |
