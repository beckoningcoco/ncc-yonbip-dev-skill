---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.InnerTransferOutVO]
created: 2026-06-03
updated: 2026-06-03
...
# 内部交易出库核算 (`FIEIA.FIEIA.InnerTransferOutVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`f1d5f851-e93a-4d6d-97eb-229a015d4b49`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodies` | `FIEIA.FIEIA.InnerTransferOutRowVO` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `free_ch_id` | `free_ch_id` | `freeChId` | 内部交易出库自定义项特征 |
