---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.InventoryLossOutCostElemVO]
created: 2026-06-03
updated: 2026-06-03
...
# 盘亏出库核算分项信息 (`FIEIA.FIEIA.InventoryLossOutCostElemVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger_b_x_account_b` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`4876a9ae-c7da-43c8-bc61-a8cd78016a42`
...
| `detail_id` | `detail_id` | `detail` | 盘亏出库核算综合信息 |
