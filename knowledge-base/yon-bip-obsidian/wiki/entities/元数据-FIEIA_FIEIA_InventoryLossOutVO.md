---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.InventoryLossOutVO]
created: 2026-06-03
updated: 2026-06-03
...
# 盘亏出库核算 (`FIEIA.FIEIA.InventoryLossOutVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`4876a9ae-c7da-43c8-bc61-a8cd78016a42`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodies` | `FIEIA.FIEIA.InventoryLossOutRowVO` | composition |
...
| `sterilisation_finance_code` | `sterilisation_finance_code` | `sterilisationFinanceCode` | sterilisationFinanceCode |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `free_ch_id` | `free_ch_id` | `freeChId` | 盘亏出库自定义项特征 |
