---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.LedgerAccountBodyVO]
created: 2026-06-03
updated: 2026-06-03
...
# 核算子表 (`FIEIA.FIEIA.LedgerAccountBodyVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger_b_x_account_b` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`1555141c-9307-4a84-a70d-bd186c4ae607`
...
| `struct_source` | `struct_source` | `structSource` | 结构来源 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `detail_id` | `detail_id` | `detail` | 核算主表 |
...
| `balance_num` | `balance_num` | `balanceNum` | 结存组件数量 |
