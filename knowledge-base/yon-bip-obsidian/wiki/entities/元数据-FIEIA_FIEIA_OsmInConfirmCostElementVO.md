---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.OsmInConfirmCostElementVO]
created: 2026-06-03
updated: 2026-06-03
...
# 委外入库确认分项信息 (`FIEIA.FIEIA.OsmInConfirmCostElementVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger_b_x_account_b` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`35398192-b208-4bce-8f51-6581daee09a4`
...
| `detail_id` | `detail_id` | `detail` | 委外入库确认综合信息 |
