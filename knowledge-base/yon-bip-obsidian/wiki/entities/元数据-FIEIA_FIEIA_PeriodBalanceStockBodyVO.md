---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.PeriodBalanceStockBodyVO]
created: 2026-06-03
updated: 2026-06-03
...
# 组件期间结存明细表 (`FIEIA.FIEIA.PeriodBalanceStockBodyVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_period_balance_stock_b` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`c8bd9870-a201-4086-bc9f-631a9a8b0e78`
...
|--------|---------|------|--------|
| `id` | `id` | String | id |
| `cost_element_id` | `cost_element_id` | String | 成本要素 |
| `acc_year_code` | `acc_year_code` | String | 会计年编码 |
| `period_code` | `period_code` | String |  记账会计期间 |

### 引用字段 (15个)

| 字段名 | 数据库列 | 类型 | 显示名 |
|--------|---------|------|--------|
| `header_id` | `header_id` | 023222da-3219-4421-ace6-3fbc83e52348 | 期间结存明细 |
...
| `component_id` | `component_id` | 9ca79507-a571-4739-b43b-6813863c523c | 组件 |
...
| `period_id` | `period_id` | 0028813f-135a-485e-a5c3-c15a3d18168b | 记账会计期间id |
