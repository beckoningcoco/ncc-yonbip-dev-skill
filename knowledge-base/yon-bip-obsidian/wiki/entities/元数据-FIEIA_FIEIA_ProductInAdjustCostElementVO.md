---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.ProductInAdjustCostElementVO]
created: 2026-06-03
updated: 2026-06-03
...
# 生产入库调整分项信息 (`FIEIA.FIEIA.ProductInAdjustCostElementVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger_b_x_account_b` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`ba01eb83-bf88-4ecd-926c-b739aaee5de1`
...
| `detail_id` | `detail_id` | `detail` | 产品入库调整综合信息 |
