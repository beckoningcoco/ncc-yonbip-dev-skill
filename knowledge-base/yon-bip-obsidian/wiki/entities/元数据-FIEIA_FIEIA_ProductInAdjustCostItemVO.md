---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.ProductInAdjustCostItemVO]
created: 2026-06-03
updated: 2026-06-03
...
# 生产入库调整费用项目 (`FIEIA.FIEIA.ProductInAdjustCostItemVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger_g` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`ba01eb83-bf88-4ecd-926c-b739aaee5de1`
...
| `product_acc_id` | `fiepub.epub_accsubjectversion_treecard_ref` |
