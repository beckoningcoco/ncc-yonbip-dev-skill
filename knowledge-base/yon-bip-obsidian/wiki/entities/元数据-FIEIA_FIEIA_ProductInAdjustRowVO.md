---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.ProductInAdjustRowVO]
created: 2026-06-03
updated: 2026-06-03
...
# 生产入库调整综合信息 (`FIEIA.FIEIA.ProductInAdjustRowVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger_b` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`ba01eb83-bf88-4ecd-926c-b739aaee5de1`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `costItems` | `FIEIA.FIEIA.ProductInAdjustCostItemVO` | composition |
| `costElements` | `FIEIA.FIEIA.ProductInAdjustCostElementVO` | composition |
...
| `header_id` | `header_id` | `header` | 产品入库调整 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `free_ch_id` | `free_ch_id` | `freeChId` | 生产入库调整综合信息自定义项特征 |

### other (2个)

| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `` | `` | `costElements` | 生产入库调整分项信息 |
| `` | `` | `costItems` | 生产入库调整费用项目 |
