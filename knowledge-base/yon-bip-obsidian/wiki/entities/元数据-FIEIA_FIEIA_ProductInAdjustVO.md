---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.ProductInAdjustVO]
created: 2026-06-03
updated: 2026-06-03
...
# 生产入库调整 (`FIEIA.FIEIA.ProductInAdjustVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`ba01eb83-bf88-4ecd-926c-b739aaee5de1`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodies` | `FIEIA.FIEIA.ProductInAdjustRowVO` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `free_ch_id` | `free_ch_id` | `freeChId` | 生产入库调整自定义项特征 |
