---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.ProductInCostElementVO]
created: 2026-06-03
updated: 2026-06-03
...
# 生产入库核算分项信息 (`FIEIA.FIEIA.ProductInCostElementVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger_b_x_account_b` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`5c733fd1-dbf9-4579-879f-9adf9e468f36`
...
| `detail_id` | `detail_id` | `detail` | 产品入库核算综合信息 |
