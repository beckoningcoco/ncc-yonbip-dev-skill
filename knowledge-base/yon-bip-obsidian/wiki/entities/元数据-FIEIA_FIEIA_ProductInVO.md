---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.ProductInVO]
created: 2026-06-03
updated: 2026-06-03
...
# 生产入库核算 (`FIEIA.FIEIA.ProductInVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`5c733fd1-dbf9-4579-879f-9adf9e468f36`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodies` | `FIEIA.FIEIA.ProductInRowVO` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `free_ch_id` | `free_ch_id` | `freeChId` | 生产入库自定义项特征 |
