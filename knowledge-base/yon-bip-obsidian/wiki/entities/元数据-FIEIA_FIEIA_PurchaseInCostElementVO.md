---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.PurchaseInCostElementVO]
created: 2026-06-03
updated: 2026-06-03
...
# 采购入库暂估分项信息 (`FIEIA.FIEIA.PurchaseInCostElementVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger_b_x_account_b` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`3ea30f00-cabd-4e1b-b299-6f71e652cea9`
...
| `detail_id` | `detail_id` | `detail` | 采购入库暂估综合信息 |
