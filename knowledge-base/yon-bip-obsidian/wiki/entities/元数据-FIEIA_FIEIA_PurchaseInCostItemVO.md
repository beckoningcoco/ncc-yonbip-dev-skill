---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.PurchaseInCostItemVO]
created: 2026-06-03
updated: 2026-06-03
...
# 采购入库暂估费用项目 (`FIEIA.FIEIA.PurchaseInCostItemVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger_g` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`3ea30f00-cabd-4e1b-b299-6f71e652cea9`
