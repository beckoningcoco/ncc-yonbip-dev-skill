---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.PurchaseInFiEventVO]
created: 2026-06-03
updated: 2026-06-03
...
# 采购入库暂估 (`FIEIA.FIEIA.PurchaseInFiEventVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`3ea30f00-cabd-4e1b-b299-6f71e652cea9`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodies` | `FIEIA.FIEIA.PurchaseInFiEventRowVO` | composition |
...
| `req_org_id` | `req_org_id` | `reqOrg` | 组织单元(系统) |
...
| `bln_inner_settle` | `bln_inner_settle` | `blnInnerSettle` | 内部交易标识 |
