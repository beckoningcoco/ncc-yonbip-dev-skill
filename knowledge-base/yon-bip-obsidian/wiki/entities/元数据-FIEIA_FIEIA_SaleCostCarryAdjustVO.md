---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.SaleCostCarryAdjustVO]
created: 2026-06-03
updated: 2026-06-03
...
# 销售成本结转调整 (`FIEIA.FIEIA.SaleCostCarryAdjustVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`6e9d25f2-68a0-40c2-a824-8aac441a8b16`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodies` | `FIEIA.FIEIA.SaleCostCarryAdjustRowVO` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `free_ch_id` | `free_ch_id` | `freeChId` | 销售成本结转调整自定义项特征 |
