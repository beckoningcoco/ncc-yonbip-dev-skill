---
tags: [BIP, 元数据, 数据字典, FIEIA.FIEIA.SgInnerTransferOutCostElemVO]
created: 2026-06-03
updated: 2026-06-03
...
# 内部交易发出商品核算分项信息 (`FIEIA.FIEIA.SgInnerTransferOutCostElemVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger_b_x_account_b` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`ea0105d3-4722-4995-8610-4695726ec1ef`
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `detail_id` | `detail_id` | `detail` | 内部交易发出商品综合信息 |
