...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`tax_deduction_type` | domain：`yonbip-fi-taxpubdoc` | 应用：`DPMTAX` | 业务对象ID：`94b743a1-b4b7-4d8e-83f3-85c89892be0c`
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `classification` | `classification` | `classification` | 抵扣分类 |
