---
tags: [BIP, 元数据, 数据字典, RCL.RCL.rclContractBaseInfo]
created: 2026-06-03
updated: 2026-06-03
...
# 基本信息 (`RCL.RCL.rclContractBaseInfo`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`rcl_contract_b` | domain：`yonbip-fi-ercl` | 应用：`RVN` | 业务对象ID：`29a1c8eb-18f3-4f82-b4a8-2d20ae258702`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `rclContractBaseInfo_tradeConfirmRuleList` | `RCL.RCL.rclContractBaseInfo_tradeConfirmRule` | composition |
| `rclContractBaseInfo_incomeConfirmRuleList` | `RCL.RCL.rclContractBaseInfo_incomeConfirmRule` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `` | `` | `rclContractBaseInfo_incomeConfirmRuleList` | 收入确认规则多选引用子实体 |
| `` | `` | `rclContractBaseInfo_tradeConfirmRuleList` | rclContractBaseInfo_tradeConfirmRule |
