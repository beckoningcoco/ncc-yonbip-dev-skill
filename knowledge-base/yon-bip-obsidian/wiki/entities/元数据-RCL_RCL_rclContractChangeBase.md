---
tags: [BIP, 元数据, 数据字典, RCL.RCL.rclContractChangeBase]
created: 2026-06-03
updated: 2026-06-03
...
# 变更历史父实体 (`RCL.RCL.rclContractChangeBase`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`rcl_change` | domain：`yonbip-fi-ercl` | 应用：`RVN` | 业务对象ID：`bac05af3-16cf-4b3b-97c1-208a96ae37f2`
