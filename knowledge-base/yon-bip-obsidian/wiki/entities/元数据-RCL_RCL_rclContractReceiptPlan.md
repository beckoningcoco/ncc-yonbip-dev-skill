---
tags: [BIP, 元数据, 数据字典, RCL.RCL.rclContractReceiptPlan]
created: 2026-06-03
updated: 2026-06-03
...
# 收款计划 (`RCL.RCL.rclContractReceiptPlan`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`rcl_contractreceiptplan` | domain：`yonbip-fi-ercl` | 应用：`RVN` | 业务对象ID：`29a1c8eb-18f3-4f82-b4a8-2d20ae258702`
