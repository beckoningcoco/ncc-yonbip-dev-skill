---
tags: [BIP, 元数据, 数据字典, RCL.RCL.rclOpenExecuteSituation]
created: 2026-06-03
updated: 2026-06-03
...
# 期初执行情况 (`RCL.RCL.rclOpenExecuteSituation`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`rcl_execsituation` | domain：`yonbip-fi-ercl` | 应用：`RVN` | 业务对象ID：`0dcdcca0-a433-419f-8e06-38e109b5ba50`
