---
tags: [BIP, 元数据, 数据字典, RCL.RCL.rclPeriodExecuteSituationBase]
created: 2026-06-03
updated: 2026-06-03
...
# 分期执行情况父实体 (`RCL.RCL.rclPeriodExecuteSituationBase`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`rcl_periodexec` | domain：`yonbip-fi-ercl` | 应用：`RVN` | 业务对象ID：`bac05af3-16cf-4b3b-97c1-208a96ae37f2`
