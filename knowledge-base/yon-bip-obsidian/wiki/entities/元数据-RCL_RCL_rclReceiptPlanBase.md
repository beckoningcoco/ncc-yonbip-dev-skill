---
tags: [BIP, 元数据, 数据字典, RCL.RCL.rclReceiptPlanBase]
created: 2026-06-03
updated: 2026-06-03
...
# 收款计划父实体 (`RCL.RCL.rclReceiptPlanBase`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`rcl_receiptplan` | domain：`yonbip-fi-ercl` | 应用：`RVN` | 业务对象ID：`bac05af3-16cf-4b3b-97c1-208a96ae37f2`
