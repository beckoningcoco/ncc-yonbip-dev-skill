---
tags: [BIP, 元数据, 数据字典, RVN.RVN.costLossDetail]
created: 2026-06-03
updated: 2026-06-03
...
# 成本及损失明细 (`RVN.RVN.costLossDetail`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`cost_loss_detail` | domain：`yonbip-fi-ercl` | 应用：`RVN` | 业务对象ID：`25063173-63c6-4559-acc7-1a47b0509bc2`
...
| `current_carry_forward_cost` | `current_carry_forward_cost` | `curCarryForwardCost` | 本次结转成本 |
