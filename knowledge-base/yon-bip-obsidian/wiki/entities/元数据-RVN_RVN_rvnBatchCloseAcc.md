---
tags: [BIP, 元数据, 数据字典, RVN.RVN.rvnBatchCloseAcc]
created: 2026-06-03
updated: 2026-06-03
...
# 收入管理批量关账 (`RVN.RVN.rvnBatchCloseAcc`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`rvn_period_close_account` | domain：`yonbip-fi-ercl` | 应用：`RVN` | 业务对象ID：`a29da92d-5bef-4e5e-9d28-4b71966177e5`
