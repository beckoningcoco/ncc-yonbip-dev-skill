---
tags: [BIP, 元数据, 数据字典, RVN.RVN.rvnCloseAccount]
created: 2026-06-03
updated: 2026-06-03
...
# 收入管理关账 (`RVN.RVN.rvnCloseAccount`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`rvn_period_close_account` | domain：`yonbip-fi-ercl` | 应用：`RVN` | 业务对象ID：`eb77ae3b-79e9-4293-9bdb-704996cfb177`
