---
tags: [BIP, 元数据, 数据字典, RVN.RVN.rvnDeferredRevenue]
created: 2026-06-03
updated: 2026-06-03
...
# 递延收入确认 (`RVN.RVN.rvnDeferredRevenue`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`rvn_deferred_revenue_h` | domain：`yonbip-fi-ercl` | 应用：`RVN` | 业务对象ID：`b4ab65d6-360a-4b51-bc85-e8f9366e34c9`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `rvnDeferredRevenueBodyList` | `RVN.RVN.rvnDeferredRevenueBody` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `` | `` | `rvnDeferredRevenueBodyList` | 递延收入确认明细 |
