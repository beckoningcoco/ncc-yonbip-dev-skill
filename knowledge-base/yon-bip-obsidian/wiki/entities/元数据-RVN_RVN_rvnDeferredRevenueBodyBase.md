---
tags: [BIP, 元数据, 数据字典, RVN.RVN.rvnDeferredRevenueBodyBase]
created: 2026-06-03
updated: 2026-06-03
...
# 递延收入确认明细基类 (`RVN.RVN.rvnDeferredRevenueBodyBase`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`rvn_deferred_revenue_b` | domain：`yonbip-fi-ercl` | 应用：`RVN` | 业务对象ID：`6d0de398-7c0b-4ea4-a7f8-b1bfd7e324bb`
...
| `rvn_deferred_revenue_base_id` | `rvn_deferred_revenue_base_id` | `rvnDeferredRevenueBaseId` | 递延收入确认基类 |
