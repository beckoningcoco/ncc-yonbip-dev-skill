---
tags: [BIP, 元数据, 数据字典, RVN.RVN.rvnOpenRevenueBody]
created: 2026-06-03
updated: 2026-06-03
...
# 期初收入确认子表 (`RVN.RVN.rvnOpenRevenueBody`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`rvn_revenue_b` | domain：`yonbip-fi-ercl` | 应用：`RVN` | 业务对象ID：`44999035-238c-49b5-ac1f-8404e174deaa`
...
| `rvn_revenue_base_id` | `rvn_revenue_base_id` | `rvnRevenueBaseId` | 期初收入确认主表 |
