---
tags: [BIP, 元数据, 数据字典, RVN.RVN.rvnRevenue]
created: 2026-06-03
updated: 2026-06-03
...
# 收入确认主表 (`RVN.RVN.rvnRevenue`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`rvn_revenue_h` | domain：`yonbip-fi-ercl` | 应用：`RVN` | 业务对象ID：`970aec86-accd-400b-9270-08da6b0726af`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `costAndLossDtList` | `RVN.RVN.costAndLossDt` | composition |
| `rvnRevenueBodyList` | `RVN.RVN.rvnRevenueBody` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `` | `` | `rvnRevenueBodyList` | 收入确认子表 |
| `` | `` | `costAndLossDtList` | 成本及损失明细 |
