---
tags: [BIP, 元数据, 数据字典, RVN.RVN.rvnRevenueBase]
created: 2026-06-03
updated: 2026-06-03
...
# 收入确认主表基类 (`RVN.RVN.rvnRevenueBase`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`rvn_revenue_h` | domain：`yonbip-fi-ercl` | 应用：`RVN` | 业务对象ID：`2216db26-87ec-412e-8567-482c738c3e97`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `rvnRevenueBodyBaseList` | `RVN.RVN.rvnRevenueBodyBase` | composition |
| `costAndLossDList` | `RVN.RVN.costAndLossD` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `` | `` | `costAndLossDList` | 成本及损失明细 |
| `` | `` | `rvnRevenueBodyBaseList` | 收入确认子表基类 |
