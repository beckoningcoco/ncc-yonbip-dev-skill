---
tags: [BIP, 元数据, 数据字典, RVN.RVN.rvnRevenueBodyBase]
created: 2026-06-03
updated: 2026-06-03
...
# 收入确认子表基类 (`RVN.RVN.rvnRevenueBodyBase`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`rvn_revenue_b` | domain：`yonbip-fi-ercl` | 应用：`RVN` | 业务对象ID：`2216db26-87ec-412e-8567-482c738c3e97`
...
| `rvn_revenue_base_id` | `rvn_revenue_base_id` | `rvnRevenueBaseId` | 收入确认主表基类 |
