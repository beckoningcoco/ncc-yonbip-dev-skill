---
tags: [BIP, 元数据, 数据字典, RVN.RVN.rvnSettleAccount]
created: 2026-06-03
updated: 2026-06-03
...
# 收入管理结账 (`RVN.RVN.rvnSettleAccount`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`rvn_period_close_account` | domain：`yonbip-fi-ercl` | 应用：`RVN` | 业务对象ID：`42a28d39-3d10-4d83-803f-422fda999693`
