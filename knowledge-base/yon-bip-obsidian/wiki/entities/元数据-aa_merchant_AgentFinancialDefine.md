---
tags: [BIP, 元数据, 数据字典, aa.merchant.AgentFinancialDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 客户档案银行信息自定义项(废弃) (`aa.merchant.AgentFinancialDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`agentfinancial_define` | domain：`productcenter` | 应用：`DPMCUS` | 业务对象ID：``
