...
> 物理表: `invoicingcustomers` | 应用: `DPMCUS` | 类型: `Class`
...
| 4 | `invoicingCustomersId` | invoicingCustomersID | `cinvoicingcustomersid` | 94b3280a-27a4-485a-b90b-b7bce57c6df2 | `quote` |
| 5 | `isDefault` | 是否Default | `bdefaultinvoicingcustomers` | Boolean | `switch` |
...
- `invoicingCustomersId` -> `aa.merchant.Merchant` ()
