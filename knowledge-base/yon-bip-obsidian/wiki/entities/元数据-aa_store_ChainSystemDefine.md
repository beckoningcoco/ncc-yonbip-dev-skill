---
tags: [BIP, 元数据, 数据字典, aa.store.ChainSystemDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 连锁系统自定义项 (`aa.store.ChainSystemDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`mp_chainsystem_define` | domain：`yxybase` | 应用：`Marketingpublic` | 业务对象ID：``
