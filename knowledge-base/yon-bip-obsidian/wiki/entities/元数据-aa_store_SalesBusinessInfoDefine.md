---
tags: [BIP, 元数据, 数据字典, aa.store.SalesBusinessInfoDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 销售业务信息自定义项 (`aa.store.SalesBusinessInfoDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`mp_salessbusinessinfo_define` | domain：`yxybase` | 应用：`Marketingpublic` | 业务对象ID：``
...
|------|-----|
| 显示名 | 销售业务信息自定义项 |
| 物理表 | `mp_salessbusinessinfo_define` |
| domain/服务域 | `yxybase` |
| schema | `pricecenter` |
