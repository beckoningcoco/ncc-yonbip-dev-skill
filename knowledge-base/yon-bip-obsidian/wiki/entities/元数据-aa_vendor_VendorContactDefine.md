---
tags: [BIP, 元数据, 数据字典, aa.vendor.VendorContactDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 供应商联系人自定义项 (`aa.vendor.VendorContactDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`aa_vendorcontact_define` | domain：`yssupplier` | 应用：`DPMSPL` | 业务对象ID：``
