---
tags: [BIP, 元数据, 数据字典, aa.vendor.VendorDetail]
created: 2026-06-03
updated: 2026-06-03
...
# 供应商业务属性(使用组织)-弃用 (`aa.vendor.VendorDetail`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`aa_vendordetail` | domain：`yssupplier` | 应用：`DPMSPL` | 业务对象ID：``
...
| `freeze_step` | `freeze_step` | `freezeStep` | 冻结环节(多选) |
