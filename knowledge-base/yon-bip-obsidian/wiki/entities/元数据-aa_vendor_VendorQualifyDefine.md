---
tags: [BIP, 元数据, 数据字典, aa.vendor.VendorQualifyDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 供应商资质自定义项 (`aa.vendor.VendorQualifyDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`aa_vendorqualify_define` | domain：`yssupplier` | 应用：`DPMSPL` | 业务对象ID：``
