---
tags: [BIP, 元数据, 数据字典, aa.vendorclass.VendorClassDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 项目(自定义项)表1 (`aa.vendorclass.VendorClassDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`aa_vendorclass_define` | domain：`yssupplier` | 应用：`DPMSPL` | 业务对象ID：``
