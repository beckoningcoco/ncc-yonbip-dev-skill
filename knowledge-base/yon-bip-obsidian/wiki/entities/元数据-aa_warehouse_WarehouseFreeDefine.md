---
tags: [BIP, 元数据, 数据字典, aa.warehouse.WarehouseFreeDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 仓库自由自定义项 (`aa.warehouse.WarehouseFreeDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`pc_warehouse_freedefine` | domain：`productcenter` | 应用：`DPMSI` | 业务对象ID：``
