---
tags: [BIP, 元数据, 数据字典, act.followrecord.AuthBusiobjectDimensionFollowRecord]
created: 2026-06-03
updated: 2026-06-03
...
# 相关管理维度-跟进记录关联数据表 (`act.followrecord.AuthBusiobjectDimensionFollowRecord`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`crmc_auth_busiobject_dimension_followrecord` | domain：`yycrm` | 应用：`ACT` | 业务对象ID：``

## 基本信息

| 属性 | 值 |
|------|-----|
| 显示名 | 相关管理维度-跟进记录关联数据表 |
| 物理表 | `crmc_auth_busiobject_dimension_followrecord` |
| 数据库 schema | `yycrm` |
| 所属应用 | `ACT` |
| 直连字段 | 31 个 |
| 子表 | 0 个 |
