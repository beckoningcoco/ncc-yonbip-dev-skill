---
tags: [BIP, 元数据, 数据字典, act.followrecord.FollowRecordDef]
created: 2026-06-03
updated: 2026-06-03
...
# 跟进记录主表自定义项 (`act.followrecord.FollowRecordDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`act_followrecord_def` | domain：`yycrm` | 应用：`ACT` | 业务对象ID：``
