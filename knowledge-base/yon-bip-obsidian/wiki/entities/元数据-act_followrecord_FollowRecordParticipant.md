---
tags: [BIP, 元数据, 数据字典, act.followrecord.FollowRecordParticipant]
created: 2026-06-03
updated: 2026-06-03
...
# 跟进记录参与人 (`act.followrecord.FollowRecordParticipant`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`cust_relateperson` | domain：`yycrm` | 应用：`ACT` | 业务对象ID：``
...
| `relate_object_id` | `relate_object_id` | `relateObject` | 相关对象(跟进记录)ID |
