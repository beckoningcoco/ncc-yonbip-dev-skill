---
tags: [BIP, 元数据, 数据字典, act.followrecord.FollowRecordRemarkDef]
created: 2026-06-03
updated: 2026-06-03
...
# 跟进记录备注表自定义项 (`act.followrecord.FollowRecordRemarkDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`act_followrecord_remark_def` | domain：`yycrm` | 应用：`ACT` | 业务对象ID：``
...
|------|-----|
| 显示名 | 跟进记录备注表自定义项 |
| 物理表 | `act_followrecord_remark_def` |
| 数据库 schema | `yycrm` |
| 所属应用 | `ACT` |
| 直连字段 | 64 个 |
| 子表 | 0 个 |
