---
tags: [BIP, 元数据, 数据字典, act.task.TaskExecutorDef]
created: 2026-06-03
updated: 2026-06-03
...
# 执行人固定自定义项 (`act.task.TaskExecutorDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`act_task_executor_def` | domain：`yycrm` | 应用：`ACT` | 业务对象ID：``
