---
tags: [BIP, 元数据, 数据字典, act.task.TaskExecutorFreedef]
created: 2026-06-03
updated: 2026-06-03
...
# 执行人自由自定义项 (`act.task.TaskExecutorFreedef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`act_task_executor_freedef` | domain：`yycrm` | 应用：`ACT` | 业务对象ID：``
