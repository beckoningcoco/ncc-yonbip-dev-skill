---
tags: [BIP, 元数据, 数据字典, act.visitroute.VisitRouteDef]
created: 2026-06-03
updated: 2026-06-03
...
# 拜访路线自定义项 (`act.visitroute.VisitRouteDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`dsfa_visit_route_def` | domain：`yycrm` | 应用：`ACT` | 业务对象ID：``
