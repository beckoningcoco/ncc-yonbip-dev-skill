---
tags: [BIP, 元数据, 数据字典, aim.equip.EquipCoordinateVO]
created: 2026-06-03
updated: 2026-06-03
...
# 资产坐标 (`aim.equip.EquipCoordinateVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`pam_equip_coordinate` | domain：`ucf-amc-ambd` | 应用：`AIM` | 业务对象ID：``
