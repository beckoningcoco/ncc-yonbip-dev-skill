---
tags: [BIP, 元数据, 数据字典, aim.equip.EquipLineParamVODefine]
created: 2026-06-03
updated: 2026-06-03
...
# 线性参数自定义项 (`aim.equip.EquipLineParamVODefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`pam_equip_line_param_define` | domain：`ucf-amc-ambd` | 应用：`AIM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 线性参数自定义项 |
| 物理表 | `pam_equip_line_param_define` |
