---
tags: [BIP, 元数据, 数据字典, aim.equip.SparePartVODefine]
created: 2026-06-03
updated: 2026-06-03
...
# 零部件自定义项 (`aim.equip.SparePartVODefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`pam_spare_part_define` | domain：`ucf-amc-ambd` | 应用：`AIM` | 业务对象ID：``
