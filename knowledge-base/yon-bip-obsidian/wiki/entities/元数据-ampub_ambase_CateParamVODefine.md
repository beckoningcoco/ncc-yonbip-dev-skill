---
tags: [BIP, 元数据, 数据字典, ampub.ambase.CateParamVODefine]
created: 2026-06-03
updated: 2026-06-03
...
# 技术参数自定义项 (`ampub.ambase.CateParamVODefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`pam_cate_param_define` | domain：`ucf-amc-ambd` | 应用：`AMBD` | 业务对象ID：``
