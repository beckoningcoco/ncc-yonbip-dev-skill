---
tags: [BIP, 元数据, 数据字典, ampub.ambase.KeyPartsVODefine]
created: 2026-06-03
updated: 2026-06-03
...
# 资产部位自定义项 (`ampub.ambase.KeyPartsVODefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`pam_key_parts_define` | domain：`ucf-amc-ambd` | 应用：`AMBD` | 业务对象ID：``
