---
tags: [BIP, 元数据, 数据字典, ampub.assertbase.CapitalSourceVODefine]
created: 2026-06-03
updated: 2026-06-03
...
# 资金来源自定义项 (`ampub.assertbase.CapitalSourceVODefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`pam_capital_source_define` | domain：`ucf-amc-aim` | 应用：`AMPUB` | 业务对象ID：``
