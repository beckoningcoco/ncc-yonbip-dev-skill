---
tags: [BIP, 元数据, 数据字典, ampub.equipbase.PriorityVODefine]
created: 2026-06-03
updated: 2026-06-03
...
# 关键程度自定义项 (`ampub.equipbase.PriorityVODefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`pam_priority_define` | domain：`ucf-amc-ambd` | 应用：`AMBD` | 业务对象ID：``
