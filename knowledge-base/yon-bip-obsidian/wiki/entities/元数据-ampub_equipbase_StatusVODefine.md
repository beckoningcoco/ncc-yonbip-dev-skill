---
tags: [BIP, 元数据, 数据字典, ampub.equipbase.StatusVODefine]
created: 2026-06-03
updated: 2026-06-03
...
# 资产使用状态自定义项 (`ampub.equipbase.StatusVODefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`pam_status_define` | domain：`ucf-amc-ambd` | 应用：`AMBD` | 业务对象ID：``
