---
tags: [BIP, 元数据, 数据字典, ampub.housetype.HouseTypeVO]
created: 2026-06-03
updated: 2026-06-03
...
# 户型 (`ampub.housetype.HouseTypeVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`pam_house_type` | domain：`ucf-amc-aim` | 应用：`AMPUB` | 业务对象ID：`c940b5f6-41bd-4334-970c-b389f59a4637`
