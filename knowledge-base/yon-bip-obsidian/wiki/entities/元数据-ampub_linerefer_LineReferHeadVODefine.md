---
tags: [BIP, 元数据, 数据字典, ampub.linerefer.LineReferHeadVODefine]
created: 2026-06-03
updated: 2026-06-03
...
# 参考点类型主表自定义项 (`ampub.linerefer.LineReferHeadVODefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`pam_line_refer_define` | domain：`ucf-amc-aim` | 应用：`AMPUB` | 业务对象ID：``
