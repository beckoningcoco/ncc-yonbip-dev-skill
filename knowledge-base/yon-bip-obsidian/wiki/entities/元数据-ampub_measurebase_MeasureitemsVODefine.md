---
tags: [BIP, 元数据, 数据字典, ampub.measurebase.MeasureitemsVODefine]
created: 2026-06-03
updated: 2026-06-03
...
# 测量项目自定义项 (`ampub.measurebase.MeasureitemsVODefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`pam_meas_items_define` | domain：`ucf-amc-aim` | 应用：`AMPUB` | 业务对象ID：``
