---
tags: [BIP, 元数据, 数据字典, ams.assettag.AssetTagHeadVODefine]
created: 2026-06-03
updated: 2026-06-03
...
# 资产标签自定义项 (`ams.assettag.AssetTagHeadVODefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`pam_assettag_define` | domain：`ucf-amc-aim` | 应用：`AMS` | 业务对象ID：``
