---
tags: [BIP, 元数据, 数据字典, apct.changeBill.ApctChangeBillIBpmStep]
created: 2026-06-03
updated: 2026-06-03
...
# 变更单审批业务阶段 (`apct.changeBill.ApctChangeBillIBpmStep`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`apct_apct_change_ibpmstep` | domain：`apct` | 应用：`APCT` | 业务对象ID：``
