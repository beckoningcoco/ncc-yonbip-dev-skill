---
tags: [BIP, 元数据, 数据字典, apct.changeBill.ApctChangeCounterparty]
created: 2026-06-03
updated: 2026-06-03
...
# 合同变更单相对方 (`apct.changeBill.ApctChangeCounterparty`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`apct_apct_change_counterparty` | domain：`apct` | 应用：`APCT` | 业务对象ID：``
...
|------|-----|
| 显示名 | 合同变更单相对方 |
| 物理表 | `apct_apct_change_counterparty` |
| domain/服务域 | `apct` |
| schema | `apct` |
| 所属应用 | `APCT` |
| 直连字段 | 22 个 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `apctChangeCounterpartyDcs` | `apctChangeCounterpartyDcs` | `apctChangeCounterpartyDcs` | 合同变更单相对方自定义项 |
