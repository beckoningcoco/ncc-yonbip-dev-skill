---
tags: [BIP, 元数据, 数据字典, apct.changeBill.ApctChangeReceiptBillPlan]
created: 2026-06-03
updated: 2026-06-03
...
# 合同变更单收款计划 (`apct.changeBill.ApctChangeReceiptBillPlan`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`apct_apct_change_receiptplan` | domain：`apct` | 应用：`APCT` | 业务对象ID：``
...
|------|-----|
| 显示名 | 合同变更单收款计划 |
| 物理表 | `apct_apct_change_receiptplan` |
| 数据库 schema | `apct` |
| 所属应用 | `APCT` |
| 直连字段 | 77 个 |
| 子表 | 0 个 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `apctChangeReceiptBillPlanDcs` | `apctChangeReceiptBillPlanDcs` | `apctChangeReceiptBillPlanDcs` | 付款计划自定义项 |
