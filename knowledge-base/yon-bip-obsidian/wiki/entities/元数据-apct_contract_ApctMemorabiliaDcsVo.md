---
tags: [BIP, 元数据, 数据字典, apct.contract.ApctMemorabiliaDcsVo]
created: 2026-06-03
updated: 2026-06-03
...
# 合同大事记自定义项 (`apct.contract.ApctMemorabiliaDcsVo`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`apct_apct_memorabilia_dcs` | domain：`apct` | 应用：`APCT` | 业务对象ID：`77ec772f-bffd-4b92-ab2c-f8d2c1bfcfb4`
