...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`apct_apct_plan` | domain：`apct` | 应用：`APCT` | 业务对象ID：``
...
| `local_invoice_total_bak` | `local_invoice_total_bak` | `localInvoiceTotalBak` | 累计本币收票金额备份 |
| `original_invoice_total_bak` | `original_invoice_total_bak` | `originalInvoiceTotalBak` | 累计原币收票金额备份 |
| `verified_subject_original_amt_bak` | `verified_subject_original_amt_bak` | `verifiedSubjectOriginalAmtBak` | 已核销原币应付金额备份 |
...
| `available_amt` | `available_amt` | `availableAmt` | 原币付款计划可用金额 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `apctApctPlanDcs` | `apctApctPlanDcs` | `apctApctPlanDcs` | 付款计划自定义项 |
