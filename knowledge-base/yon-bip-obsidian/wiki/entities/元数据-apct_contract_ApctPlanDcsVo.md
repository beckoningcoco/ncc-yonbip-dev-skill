---
tags: [BIP, 元数据, 数据字典, apct.contract.ApctPlanDcsVo]
created: 2026-06-03
updated: 2026-06-03
...
# 付款计划自定义项 (`apct.contract.ApctPlanDcsVo`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`apct_apct_plan_dcs` | domain：`apct` | 应用：`APCT` | 业务对象ID：`81de5f23-4464-4efc-8087-3f97a360613e`
