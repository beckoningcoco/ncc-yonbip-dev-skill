---
tags: [BIP, 元数据, 数据字典, areaFormat.model.areaFormatDateRecord]
created: 2026-06-03
updated: 2026-06-03
...
# 日期格式 (`areaFormat.model.areaFormatDateRecord`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`area_format_date` | domain：`ucfbasedoc` | 应用：`FRMT` | 业务对象ID：`e05d4a87-0d8f-4143-b2d0-ee5af085ea3f`
