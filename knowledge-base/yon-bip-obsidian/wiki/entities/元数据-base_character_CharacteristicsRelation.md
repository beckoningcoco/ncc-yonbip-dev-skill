---
tags: [BIP, 元数据, 数据字典, base.character.CharacteristicsRelation]
created: 2026-06-03
updated: 2026-06-03
...
# 特征组关联特征 (`base.character.CharacteristicsRelation`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`base_characteristics_relation` | domain：`u8c-userdefine` | 应用：`CHARACTER` | 业务对象ID：`c7210069-229b-45cd-8eee-25f753bf0138`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `characteristicsValueRelations` | `base.character.CharacteristicsValueRelation` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `character_domain_type` | `character_domain_type` | `characterDomainType` | 特征域类型 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `` | `` | `characteristicsValueRelations` | 特征组特征值关联表 |
