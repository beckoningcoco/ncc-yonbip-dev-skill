---
tags: [BIP, 元数据, 数据字典, bd.assets.ReduceWay]
created: 2026-06-03
updated: 2026-06-03
...
# 减少方式 (`bd.assets.ReduceWay`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`bd_reduceway` | domain：`finbd` | 应用：`FP` | 业务对象ID：`193a7de7-7d3c-4f60-90c1-bca1c8a19129`
...
| 字段名 | 数据库列 | 类型 | 显示名 |
|--------|---------|------|--------|
| `presetdate` | `presetdate` | Boolean | 是否为预置数据 |
