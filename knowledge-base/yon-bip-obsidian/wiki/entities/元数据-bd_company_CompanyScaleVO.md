---
tags: [BIP, 元数据, 数据字典, bd.company.CompanyScaleVO]
created: 2026-06-03
updated: 2026-06-03
...
# 企业规模 (`bd.company.CompanyScaleVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`bd_company_scale` | domain：`ucfbasedoc` | 应用：`DPMPI` | 业务对象ID：`160bcb4e-5a00-4e8e-aa13-4a1cab28a41f`
