---
tags: [BIP, 元数据, 数据字典, bd.customerdoc_ydzbl.ydzbl]
created: 2026-06-03
updated: 2026-06-03
...
# 溢短装比例 (`bd.customerdoc_ydzbl.ydzbl`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`bd_cust_doc` | domain：`ucfbasedoc` | 应用：`DPMPI` | 业务对象ID：`3d821375-fb90-4671-bd43-a02721870e23`
