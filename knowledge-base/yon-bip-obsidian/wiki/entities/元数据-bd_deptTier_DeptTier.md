---
tags: [BIP, 元数据, 数据字典, bd.deptTier.DeptTier]
created: 2026-06-03
updated: 2026-06-03
...
# 部门层级 (`bd.deptTier.DeptTier`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`bd_dept_tier` | domain：`ucf-staff-center` | 应用：`HRORG` | 业务对象ID：`6a50cf8b-4086-4723-bd7f-fdf9b3dc6e2a`
