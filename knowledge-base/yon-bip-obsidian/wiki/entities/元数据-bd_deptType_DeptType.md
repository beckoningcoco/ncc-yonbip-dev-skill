---
tags: [BIP, 元数据, 数据字典, bd.deptType.DeptType]
created: 2026-06-03
updated: 2026-06-03
...
# 部门分类 (`bd.deptType.DeptType`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`bd_dept_type` | domain：`ucf-staff-center` | 应用：`HRORG` | 业务对象ID：`b0f52483-8e7e-48e0-88a3-fca2694558f4`
