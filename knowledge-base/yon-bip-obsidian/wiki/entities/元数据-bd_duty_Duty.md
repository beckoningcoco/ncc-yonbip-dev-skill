...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`bd_duty` | domain：`ucf-staff-center` | 应用：`DPMSTF` | 业务对象ID：`8cce8e51-66a0-4a88-b7c9-77d887d73241`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `defines` | `bd.duty.DutyDefine` | composition |
...
| `org_id` | `orgcenter_admin_tree_ref` |
| `modifier` | `` |
