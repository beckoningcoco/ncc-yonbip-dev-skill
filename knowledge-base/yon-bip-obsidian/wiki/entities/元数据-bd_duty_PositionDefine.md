---
tags: [BIP, 元数据, 数据字典, bd.duty.PositionDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 岗位自定义项 (`bd.duty.PositionDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`bd_position_define` | domain：`ucf-staff-center` | 应用：`DPMSTF` | 业务对象ID：``
