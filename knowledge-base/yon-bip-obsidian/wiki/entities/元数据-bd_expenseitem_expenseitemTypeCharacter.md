---
tags: [BIP, 元数据, 数据字典, bd.expenseitem.expenseitemTypeCharacter]
created: 2026-06-03
updated: 2026-06-03
...
# 费用项目类型特征 (`bd.expenseitem.expenseitemTypeCharacter`)

> **平台版本：BIP 旗舰版 V5** -- 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。
> 物理表: `bd_expenseitemtype_ch` | 应用: `DPMACCT` | 类型: `Class`
