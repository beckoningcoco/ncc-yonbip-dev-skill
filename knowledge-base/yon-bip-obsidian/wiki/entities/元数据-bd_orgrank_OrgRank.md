---
tags: [BIP, 元数据, 数据字典, bd.orgrank.OrgRank]
created: 2026-06-03
updated: 2026-06-03
...
# 组织层级 (`bd.orgrank.OrgRank`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`bd_org_rank` | domain：`ucf-staff-center` | 应用：`HRORG` | 业务对象ID：`45e6db0f-41ca-401d-a250-c76ea759bdff`
