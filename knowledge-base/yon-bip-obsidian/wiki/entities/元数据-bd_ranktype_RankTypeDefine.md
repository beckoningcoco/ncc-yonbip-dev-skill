---
tags: [BIP, 元数据, 数据字典, bd.ranktype.RankTypeDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 职级类别自定义项 (`bd.ranktype.RankTypeDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`bd_rank_type_define` | domain：`ucf-staff-center` | 应用：`DPMSTF` | 业务对象ID：``
