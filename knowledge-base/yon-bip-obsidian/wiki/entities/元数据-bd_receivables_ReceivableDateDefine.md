---
tags: [BIP, 元数据, 数据字典, bd.receivables.ReceivableDateDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 收款账期扩展表(自定义项扩展表) (`bd.receivables.ReceivableDateDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`bd_receivabledate_define` | domain：`ucfbasedoc` | 应用：`DPMSETL` | 业务对象ID：``
