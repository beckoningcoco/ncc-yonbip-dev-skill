---
tags: [BIP, 元数据, 数据字典, bd.staff.StaffBankAcctDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 员工银行账户自定义项 (`bd.staff.StaffBankAcctDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`bd_staff_bankacct_define` | domain：`ucf-staff-center` | 应用：`DPMSTF` | 业务对象ID：``
