---
tags: [BIP, 元数据, 数据字典, bd.staff.StaffMainJobDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 员工任职自定义项 (`bd.staff.StaffMainJobDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`bd_staff_mainjob_define` | domain：`ucf-staff-center` | 应用：`DPMSTF` | 业务对象ID：``
