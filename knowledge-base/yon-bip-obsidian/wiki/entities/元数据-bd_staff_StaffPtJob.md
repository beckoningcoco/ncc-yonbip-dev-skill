...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`bd_staff_ptjob` | domain：`ucf-staff-center` | 应用：`DPMSTF` | 业务对象ID：`f38679b1-213d-44f5-ae3d-946f4a7dc562`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `ptjobdefines` | `bd.staff.StaffPtJobDefine` | composition |
...
| `ytenant_id` | `` |
| `director` | `hrcloud-staff-mgr.hred_staff_ref` |
| `modifier` | `` |
| `` | `` |
