---
tags: [BIP, 元数据, 数据字典, bd.staff.StaffPtJobDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 员工兼职自定义项 (`bd.staff.StaffPtJobDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`bd_staff_ptjob_define` | domain：`ucf-staff-center` | 应用：`DPMSTF` | 业务对象ID：``
