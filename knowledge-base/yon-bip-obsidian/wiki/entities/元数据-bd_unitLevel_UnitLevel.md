---
tags: [BIP, 元数据, 数据字典, bd.unitLevel.UnitLevel]
created: 2026-06-03
updated: 2026-06-03
...
# 单位级别 (`bd.unitLevel.UnitLevel`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`bd_unit_level` | domain：`ucf-staff-center` | 应用：`HRORG` | 业务对象ID：`2d0ae4f6-9e00-4b44-be2a-17c2f65319f2`
