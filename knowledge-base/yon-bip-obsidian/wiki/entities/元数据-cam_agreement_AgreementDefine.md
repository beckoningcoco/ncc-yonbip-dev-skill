---
tags: [BIP, 元数据, 数据字典, cam.agreement.AgreementDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 授信合同自定义项 (`cam.agreement.AgreementDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`cam_agreement_define` | domain：`yonbip-fi-ctmcam` | 应用：`CAM` | 业务对象ID：``
