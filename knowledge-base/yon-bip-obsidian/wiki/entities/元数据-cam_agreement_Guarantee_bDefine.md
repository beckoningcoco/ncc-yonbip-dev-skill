---
tags: [BIP, 元数据, 数据字典, cam.agreement.Guarantee_bDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 担保明细自定义项 (`cam.agreement.Guarantee_bDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`cam_guarantee_b_define` | domain：`yonbip-fi-ctmcam` | 应用：`CAM` | 业务对象ID：``
