---
tags: [BIP, 元数据, 数据字典, cam.applicationcredit.ApplicationCreditDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 自由自定义项 (`cam.applicationcredit.ApplicationCreditDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`cam_application_credit_define` | domain：`yonbip-fi-ctmcam` | 应用：`CAM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 自由自定义项 |
| 物理表 | `cam_application_credit_define` |
