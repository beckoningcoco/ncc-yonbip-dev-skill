---
tags: [BIP, 元数据, 数据字典, cam.creditapply.CreditApplyDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 授信申请自由自定义项 (`cam.creditapply.CreditApplyDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`cam_creditapply_define` | domain：`yonbip-fi-ctmcam` | 应用：`CAM` | 业务对象ID：``
