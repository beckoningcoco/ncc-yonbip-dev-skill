---
tags: [BIP, 元数据, 数据字典, cam.syndicated.CostScheme]
created: 2026-06-03
updated: 2026-06-03
...
# 费用方案 (`cam.syndicated.CostScheme`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`cam_syndicated_cost_scheme` | domain：`yonbip-fi-ctmcam` | 应用：`CAM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 费用方案 |
| 物理表 | `cam_syndicated_cost_scheme` |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `cam_define_character_def` | `cam_define_character_def` | `camDefineCharacterDef` | 银团授信费用方案特征 |
