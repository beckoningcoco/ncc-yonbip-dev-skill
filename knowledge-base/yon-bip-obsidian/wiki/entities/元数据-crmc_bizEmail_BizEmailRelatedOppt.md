---
tags: [BIP, 元数据, 数据字典, crmc.bizEmail.BizEmailRelatedOppt]
created: 2026-06-03
updated: 2026-06-03
...
# 业务邮件关联商机 (`crmc.bizEmail.BizEmailRelatedOppt`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`crmc_biz_email_related_oppt` | domain：`yycrm` | 应用：`ACT` | 业务对象ID：``
...
|------|-----|
| 显示名 | 业务邮件关联商机 |
| 物理表 | `crmc_biz_email_related_oppt` |
| 数据库 schema | `yycrm` |
| 所属应用 | `ACT` |
| 直连字段 | 7 个 |
| 子表 | 0 个 |
