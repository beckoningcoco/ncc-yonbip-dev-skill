---
tags: [BIP, 元数据, 数据字典, crmc.display.DisplayReward]
created: 2026-06-03
updated: 2026-06-03
...
# 奖励商品子表 (`crmc.display.DisplayReward`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`mka_display_reward` | domain：`yycrm` | 应用：`CRMC` | 业务对象ID：``
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `quantity` | `quantity` | `quantity` | 奖励数量 |
