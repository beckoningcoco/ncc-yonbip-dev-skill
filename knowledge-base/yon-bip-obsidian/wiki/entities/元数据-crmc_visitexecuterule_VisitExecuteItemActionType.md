---
tags: [BIP, 元数据, 数据字典, crmc.visitexecuterule.VisitExecuteItemActionType]
created: 2026-06-03
updated: 2026-06-03
...
# 执行规则行动事项行动分类 (`crmc.visitexecuterule.VisitExecuteItemActionType`)
...
| `condition_id` | `yycrm.act_actiontypesettingref` |
| `ytenant_id` | `` |
