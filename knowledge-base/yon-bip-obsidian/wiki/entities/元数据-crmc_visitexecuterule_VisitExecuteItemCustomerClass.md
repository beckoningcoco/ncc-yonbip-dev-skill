---
tags: [BIP, 元数据, 数据字典, crmc.visitexecuterule.VisitExecuteItemCustomerClass]
created: 2026-06-03
updated: 2026-06-03
...
# 执行规则行动事项客户分类 (`crmc.visitexecuterule.VisitExecuteItemCustomerClass`)
...
| `condition_id` | `productcenter.aa_custcategoryref` |
| `ytenant_id` | `` |
