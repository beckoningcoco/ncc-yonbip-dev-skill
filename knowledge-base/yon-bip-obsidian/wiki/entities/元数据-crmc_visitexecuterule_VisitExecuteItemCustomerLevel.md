---
tags: [BIP, 元数据, 数据字典, crmc.visitexecuterule.VisitExecuteItemCustomerLevel]
created: 2026-06-03
updated: 2026-06-03
...
# 执行规则行动事项客户等级 (`crmc.visitexecuterule.VisitExecuteItemCustomerLevel`)
...
| `condition_id` | `productcenter.aa_customerlevelref` |
| `ytenant_id` | `` |
