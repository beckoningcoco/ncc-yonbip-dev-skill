---
tags: [BIP, 元数据, 数据字典, crmc.visitexecuterule.VisitExecuteItemTerminalLevel]
created: 2026-06-03
updated: 2026-06-03
...
# 执行规则行动事项终端等级 (`crmc.visitexecuterule.VisitExecuteItemTerminalLevel`)
...
| `condition_id` | `yxybase.aa_storelevel` |
| `ytenant_id` | `` |
