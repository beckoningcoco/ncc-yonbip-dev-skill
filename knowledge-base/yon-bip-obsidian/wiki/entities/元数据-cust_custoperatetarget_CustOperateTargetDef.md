---
tags: [BIP, 元数据, 数据字典, cust.custoperatetarget.CustOperateTargetDef]
created: 2026-06-03
updated: 2026-06-03
...
# 客户经营目标自定义项 (`cust.custoperatetarget.CustOperateTargetDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`cust_cust_operate_target_def` | domain：`yycrm` | 应用：`CUST` | 业务对象ID：``
...
|------|-----|
| 显示名 | 客户经营目标自定义项 |
| 物理表 | `cust_cust_operate_target_def` |
| domain/服务域 | `yycrm` |
| schema | `crm` |
| 所属应用 | `CUST` |
| 直连字段 | 64 个 |
