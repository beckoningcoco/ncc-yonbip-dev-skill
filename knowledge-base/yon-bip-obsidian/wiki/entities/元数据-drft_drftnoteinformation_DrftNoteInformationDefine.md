---
tags: [BIP, 元数据, 数据字典, drft.drftnoteinformation.DrftNoteInformationDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 票据信息自由自定义项 (`drft.drftnoteinformation.DrftNoteInformationDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`drft_noteinformation_define` | domain：`drft` | 应用：`DRFT` | 业务对象ID：``
...
|------|-----|
| 显示名 | 票据信息自由自定义项 |
| 物理表 | `drft_noteinformation_define` |
| 数据库 schema | `drft` |
| 所属应用 | `DRFT` |
| 直连字段 | 62 个 |
| 子表 | 0 个 |
