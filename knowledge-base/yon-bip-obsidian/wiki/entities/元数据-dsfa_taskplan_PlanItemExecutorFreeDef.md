---
tags: [BIP, 元数据, 数据字典, dsfa.taskplan.PlanItemExecutorFreeDef]
created: 2026-06-03
updated: 2026-06-03
...
# 明细执行人自由自定义项 (`dsfa.taskplan.PlanItemExecutorFreeDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`dsfa_taskplan_item_executor_freedef` | domain：`yycrm` | 应用：`DSFA` | 业务对象ID：``
...
|------|-----|
| 显示名 | 明细执行人自由自定义项 |
| 物理表 | `dsfa_taskplan_item_executor_freedef` |
| domain/服务域 | `yycrm` |
| schema | `crm` |
| 所属应用 | `DSFA` |
| 直连字段 | 64 个 |
