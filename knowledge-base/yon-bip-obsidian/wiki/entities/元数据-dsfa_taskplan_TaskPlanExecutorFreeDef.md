---
tags: [BIP, 元数据, 数据字典, dsfa.taskplan.TaskPlanExecutorFreeDef]
created: 2026-06-03
updated: 2026-06-03
...
# 执行人自由自定义项 (`dsfa.taskplan.TaskPlanExecutorFreeDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`dsfa_taskplan_executor_freedef` | domain：`yycrm` | 应用：`DSFA` | 业务对象ID：``
