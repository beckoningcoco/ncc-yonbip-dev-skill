---
tags: [BIP, 元数据, 数据字典, dsfa.taskplan.TaskPlanFreeDef]
created: 2026-06-03
updated: 2026-06-03
...
# 任务主表自定义项 (`dsfa.taskplan.TaskPlanFreeDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`dsfa_taskplan_freedef` | domain：`yycrm` | 应用：`DSFA` | 业务对象ID：``
