---
tags: [BIP, 元数据, 数据字典, dsfa.visitsummary.VisitSummaryDef]
created: 2026-06-03
updated: 2026-06-03
...
# 拜访小结主表自定义项 (`dsfa.visitsummary.VisitSummaryDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`dsfa_visitsummary_def` | domain：`yycrm` | 应用：`DSFA` | 业务对象ID：``
