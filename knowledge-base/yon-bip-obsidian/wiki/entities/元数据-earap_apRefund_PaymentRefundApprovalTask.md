---
tags: [BIP, 元数据, 数据字典, earap.apRefund.PaymentRefundApprovalTask]
created: 2026-06-03
updated: 2026-06-03
...
# 付款退款单审批任务信息 (`earap.apRefund.PaymentRefundApprovalTask`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ap_payment_b_approvaltask` | domain：`yonbip-fi-earapbill` | 应用：`EAP` | 业务对象ID：`e9c36855-30e0-4d2b-a38e-441b985193e7`
