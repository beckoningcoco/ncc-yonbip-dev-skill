---
tags: [BIP, 元数据, 数据字典, earap.arCooperation.ARCooperation]
created: 2026-06-03
updated: 2026-06-03
...
# 应收单据协同设置 (`earap.arCooperation.ARCooperation`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_cooperation` | domain：`yonbip-fi-earapbill` | 应用：`EAR` | 业务对象ID：`515fb9d6-a00f-4776-9c90-3773df7ad342`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `ackRoleList` | `earap.arCooperation.ARCooperation_ackRole` | composition |
| `recOrgList` | `earap.arCooperation.ARCooperation_recOrg` | composition |
| `recRoleList` | `earap.arCooperation.ARCooperation_recRole` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `` | `` | `ackRoleList` | ARCooperation_ackRole |
| `` | `` | `recOrgList` | ARCooperation_recOrg |
| `` | `` | `recRoleList` | ARCooperation_recRole |
