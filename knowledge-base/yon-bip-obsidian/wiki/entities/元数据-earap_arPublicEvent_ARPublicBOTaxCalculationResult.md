---
tags: [BIP, 元数据, 数据字典, earap.arPublicEvent.ARPublicBOTaxCalculationResult]
created: 2026-06-03
updated: 2026-06-03
...
# 计税单 (`earap.arPublicEvent.ARPublicBOTaxCalculationResult`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_taxcalc` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`27906f1b-359e-44fb-932f-ce3a9b5444e0`
...
| `event_id` | `event_id` | `event` | 日常应收基本信息(租户) |
