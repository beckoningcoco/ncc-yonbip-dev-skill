---
tags: [BIP, 元数据, 数据字典, earap.arPublicEvent.ARPublicBodyBO]
created: 2026-06-03
updated: 2026-06-03
...
# 日常应收明细信息 (`earap.arPublicEvent.ARPublicBodyBO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_b` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`27906f1b-359e-44fb-932f-ce3a9b5444e0`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `grandsonItem` | `earap.arPublicEvent.ARPublicGrandsonBO` | composition |
| `taxGrandsonItem` | `earap.arPublicEvent.ARPublicBOTaxCalculationResult` | composition |
...
| `event_id` | `yonbip-fi-earap.arPublicEventRef` |
