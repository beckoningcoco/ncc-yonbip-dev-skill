---
tags: [BIP, 元数据, 数据字典, earap.arRefund.ReceiveRefundHeader]
created: 2026-06-03
updated: 2026-06-03
...
# 收款退款单基本信息 (`earap.arRefund.ReceiveRefundHeader`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ar_collection_h` | domain：`yonbip-fi-earapbill` | 应用：`EAR` | 业务对象ID：`1a1432e9-3fcd-4097-9d89-0c3ac684f87e`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `earap.arRefund.ReceiveRefundBody` | composition |
| `approvalTasks` | `earap.arRefund.ReceiveRefundApprovalTask` | composition |
| `bpmSteps` | `earap.arRefund.ReceiveRefundBpmStep` | composition |
...
| `settle_stop_type` | `settle_stop_type` | `settleStopType` | 变更类型 |
