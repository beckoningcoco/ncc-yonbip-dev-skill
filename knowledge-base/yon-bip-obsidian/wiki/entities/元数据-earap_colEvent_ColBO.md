---
tags: [BIP, 元数据, 数据字典, earap.colEvent.ColBO]
created: 2026-06-03
updated: 2026-06-03
...
# 日常收款基本信息 (`earap.colEvent.ColBO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`d79a1403-5415-484f-b394-8cc7f7b558e4`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `earap.colEvent.ColBodyBO` | composition |
