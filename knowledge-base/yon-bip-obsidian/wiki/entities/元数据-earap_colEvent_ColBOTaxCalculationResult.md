---
tags: [BIP, 元数据, 数据字典, earap.colEvent.ColBOTaxCalculationResult]
created: 2026-06-03
updated: 2026-06-03
...
# 计税单 (`earap.colEvent.ColBOTaxCalculationResult`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_taxcalc` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`d79a1403-5415-484f-b394-8cc7f7b558e4`
...
| `event_id` | `event_id` | `event` | 日常收款基本信息(租户) |
