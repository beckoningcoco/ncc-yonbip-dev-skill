---
tags: [BIP, 元数据, 数据字典, earap.colEvent.ColBodyBO]
created: 2026-06-03
updated: 2026-06-03
...
# 日常收款明细信息 (`earap.colEvent.ColBodyBO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_b` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`d79a1403-5415-484f-b394-8cc7f7b558e4`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `taxGrandsonItem` | `earap.colEvent.ColBOTaxCalculationResult` | composition |
| `withHoldingTax` | `earap.colEvent.ColWithHoldingTaxBO` | composition |
