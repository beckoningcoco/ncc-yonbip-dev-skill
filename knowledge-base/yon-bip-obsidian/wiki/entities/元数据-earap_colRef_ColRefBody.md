---
tags: [BIP, 元数据, 数据字典, earap.colRef.ColRefBody]
created: 2026-06-03
updated: 2026-06-03
...
# 收款/退款单明细信息 (`earap.colRef.ColRefBody`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ar_collection_b` | domain：`yonbip-fi-earapbill` | 应用：`EAR` | 业务对象ID：`befd8cbb-87c4-489b-bcf5-bfc83f8c7ac5`
...
| `header_id` | `header_id` | `headerId` | 收款/退款单基本信息 |
