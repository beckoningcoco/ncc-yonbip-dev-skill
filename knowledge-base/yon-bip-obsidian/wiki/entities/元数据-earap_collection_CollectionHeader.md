---
tags: [BIP, 元数据, 数据字典, earap.collection.CollectionHeader]
created: 2026-06-03
updated: 2026-06-03
...
# 收款单基本信息 (`earap.collection.CollectionHeader`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ar_collection_h` | domain：`yonbip-fi-earapbill` | 应用：`EAR` | 业务对象ID：`032d3a15-07c4-4713-83ec-173cac7a6449`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `earap.collection.CollectionBody` | composition |
| `approvalTasks` | `earap.collection.CollectionApprovalTask` | composition |
| `bpmSteps` | `earap.collection.CollectionBpmStep` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `bank_serial_no` | `bank_serial_no` | `bankSerialNo` | 银行流水号 |
...
| `order_serial_no` | `order_serial_no` | `orderSerialNo` | 订货流水号 |
| `pay_channel` | `pay_channel` | `payChannel` | 支付通道 |
...
| `finance_org_id` | `finance_org_id` | `financeOrg` | 应收会计主体 |
...
| `pay_type` | `pay_type` | `payType` | 支付方式 |
