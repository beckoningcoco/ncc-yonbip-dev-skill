---
tags: [BIP, 元数据, 数据字典, earap.collection.TaxCalculationResult]
created: 2026-06-03
updated: 2026-06-03
...
# 计税结果 (`earap.collection.TaxCalculationResult`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`stwb_tax_calc_result` | domain：`yonbip-fi-earapbill` | 应用：`EAR` | 业务对象ID：`032d3a15-07c4-4713-83ec-173cac7a6449`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `TaxCalculationResultDetailList` | `earap.collection.TaxCalculationResultDetail` | composition |
