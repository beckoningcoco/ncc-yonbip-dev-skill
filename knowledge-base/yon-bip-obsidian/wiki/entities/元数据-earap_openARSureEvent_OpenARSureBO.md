---
tags: [BIP, 元数据, 数据字典, earap.openARSureEvent.OpenARSureBO]
created: 2026-06-03
updated: 2026-06-03
...
# 期初确认应收基本信息 (`earap.openARSureEvent.OpenARSureBO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`2e8c718b-8bc9-42a9-9516-db36307440ab`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `earap.openARSureEvent.OpenARSureBodyBO` | composition |
