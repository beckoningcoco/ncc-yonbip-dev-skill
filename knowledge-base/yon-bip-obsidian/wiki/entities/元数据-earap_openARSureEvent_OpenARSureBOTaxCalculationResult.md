---
tags: [BIP, 元数据, 数据字典, earap.openARSureEvent.OpenARSureBOTaxCalculationResult]
created: 2026-06-03
updated: 2026-06-03
...
# 计税单 (`earap.openARSureEvent.OpenARSureBOTaxCalculationResult`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_taxcalc` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`2e8c718b-8bc9-42a9-9516-db36307440ab`
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `body_id` | `body_id` | `body` | 期初确认应收明细信息 |
...
| `event_id` | `event_id` | `event` | 期初确认应收基本信息(租户) |
