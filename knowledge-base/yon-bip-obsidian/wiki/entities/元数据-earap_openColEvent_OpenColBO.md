---
tags: [BIP, 元数据, 数据字典, earap.openColEvent.OpenColBO]
created: 2026-06-03
updated: 2026-06-03
...
# 期初收款基本信息 (`earap.openColEvent.OpenColBO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`a3f2fe0b-477e-44fe-8df5-4da6086e533f`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `earap.openColEvent.OpenColBodyBO` | composition |
