---
tags: [BIP, 元数据, 数据字典, earap.openColEvent.OpenColBOTaxCalculationResult]
created: 2026-06-03
updated: 2026-06-03
...
# 计税单 (`earap.openColEvent.OpenColBOTaxCalculationResult`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_g_taxcalc` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`a3f2fe0b-477e-44fe-8df5-4da6086e533f`
...
| `event_id` | `event_id` | `event` | 期初收款基本信息(租户) |
