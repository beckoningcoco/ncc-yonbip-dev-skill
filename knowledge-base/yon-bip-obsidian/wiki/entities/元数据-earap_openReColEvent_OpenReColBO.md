---
tags: [BIP, 元数据, 数据字典, earap.openReColEvent.OpenReColBO]
created: 2026-06-03
updated: 2026-06-03
...
# 期初收款退款基本信息 (`earap.openReColEvent.OpenReColBO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`arap_ledger_h` | domain：`yonbip-fi-earap` | 应用：`EAR` | 业务对象ID：`9c6f19cd-c0b6-454d-85c0-3f0fdc5cc8ec`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `earap.openReColEvent.OpenReColBodyBO` | composition |
