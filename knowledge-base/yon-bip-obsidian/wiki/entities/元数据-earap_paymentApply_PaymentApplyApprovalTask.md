---
tags: [BIP, 元数据, 数据字典, earap.paymentApply.PaymentApplyApprovalTask]
created: 2026-06-03
updated: 2026-06-03
...
# 付款申请单审批任务信息 (`earap.paymentApply.PaymentApplyApprovalTask`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ap_payment_apply_b_approvaltask` | domain：`yonbip-fi-earapbill` | 应用：`EAP` | 业务对象ID：`c6214341-20d3-4b76-b47e-2a47995c20a5`
...
|------|-----|
| 显示名 | 付款申请单审批任务信息 |
| 物理表 | `ap_payment_apply_b_approvaltask` |
