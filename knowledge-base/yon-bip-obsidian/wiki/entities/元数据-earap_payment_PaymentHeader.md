---
tags: [BIP, 元数据, 数据字典, earap.payment.PaymentHeader]
created: 2026-06-03
updated: 2026-06-03
...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`ap_payment_h` | domain：`yonbip-fi-earapbill` | 应用：`EAP` | 业务对象ID：`548e9989-20b1-473c-ba02-9284b575a695`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodyItem` | `earap.payment.PaymentBody` | composition |
| `approvalTasks` | `earap.payment.PaymentApprovalTask` | composition |
| `bpmSteps` | `earap.payment.PaymentBpmStep` | composition |
...
| `direct_print_count` | `direct_print_count` | `directPrintCount` | 直接打印次 |
