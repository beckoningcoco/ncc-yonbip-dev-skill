...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`ap_payment_g_wht` | domain：`yonbip-fi-earapbill` | 应用：`EAP` | 业务对象ID：`548e9989-20b1-473c-ba02-9284b575a695`
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `body_id` | `body_id` | `bodyId` | 付款单明细信息 |
| `creator` | `creator` | `creator` | 创建人 |
| `header_id` | `header_id` | `headerId` | 应付发票基本信息ID |
