---
tags: [BIP, 元数据, 数据字典, ec.express.ExpressUnAddress]
created: 2026-06-03
updated: 2026-06-03
...
# 不到地址改用物流 (`ec.express.ExpressUnAddress`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ec_express_unaddress` | domain：`dst` | 应用：`SDOC` | 业务对象ID：`ad09eb3d-f34b-421d-b1b4-9a3345556aaa`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `expressUnAddressSub` | `ec.express.ExpressUnAddressSub` | composition |
...
| 字段名 | 数据库列 | 类型 | 显示名 |
|--------|---------|------|--------|
| `` | `` | d4d3bd78-0fef-40a4-bb19-02d1beab3f6d | 不到地址关键字 |
