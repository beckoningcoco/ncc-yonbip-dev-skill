---
tags: [BIP, 元数据, 数据字典, ec.express.ExpressWeight]
created: 2026-06-03
updated: 2026-06-03
...
# 物流配送重量 (`ec.express.ExpressWeight`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ec_express_weight` | domain：`dst` | 应用：`SDOC` | 业务对象ID：`06dd4b19-22a1-4f51-8110-6c9e28f79a9e`
...
| 字段名 | 数据库列 | 类型 | 显示名 |
|--------|---------|------|--------|
| `maxWeight` | `maxWeight` | Decimal | 至 |
| `minWeight` | `minWeight` | Decimal | 重量 |
