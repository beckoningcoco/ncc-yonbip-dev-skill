---
tags: [BIP, 元数据, 数据字典, ed.bom.BomAlternateUserdefItem]
created: 2026-06-03
updated: 2026-06-03
...
# 替代料表固定自定义项 (`ed.bom.BomAlternateUserdefItem`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ed_bom_alternate_userdefItem` | domain：`engineeringdata` | 应用：`ED` | 业务对象ID：``
...
|------|-----|
| 显示名 | 替代料表固定自定义项 |
| 物理表 | `ed_bom_alternate_userdefItem` |
