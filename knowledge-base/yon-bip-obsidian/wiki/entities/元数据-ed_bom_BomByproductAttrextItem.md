---
tags: [BIP, 元数据, 数据字典, ed.bom.BomByproductAttrextItem]
created: 2026-06-03
updated: 2026-06-03
...
# 产出品表自由自定义项 (`ed.bom.BomByproductAttrextItem`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ed_bom_byproduct_attrextitem` | domain：`engineeringdata` | 应用：`ED` | 业务对象ID：``
...
|------|-----|
| 显示名 | 产出品表自由自定义项 |
| 物理表 | `ed_bom_byproduct_attrextitem` |
