---
tags: [BIP, 元数据, 数据字典, ed.bom.BomComponentUserdefItem]
created: 2026-06-03
updated: 2026-06-03
...
# 子件表固定自定义项 (`ed.bom.BomComponentUserdefItem`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ed_bom_component_userdefItem` | domain：`engineeringdata` | 应用：`ED` | 业务对象ID：``
...
|------|-----|
| 显示名 | 子件表固定自定义项 |
| 物理表 | `ed_bom_component_userdefItem` |
