---
tags: [BIP, 元数据, 数据字典, ed.operation.OperationUserDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 标准工序(固定自定义项)表 (`ed.operation.OperationUserDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ed_operation_defitem` | domain：`engineeringdata` | 应用：`ED` | 业务对象ID：``
