---
tags: [BIP, 元数据, 数据字典, ed.workcenter.WorkCenterAttrextItem]
created: 2026-06-03
updated: 2026-06-03
...
# 工作中心(自由自定义项) (`ed.workcenter.WorkCenterAttrextItem`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ed_workcenter_attrextitem` | domain：`engineeringdata` | 应用：`ED` | 业务对象ID：``
