---
tags: [BIP, 元数据, 数据字典, ed.workcenter.WorkCenterDetailAttrextItem]
created: 2026-06-03
updated: 2026-06-03
...
# 工作中心明细(自由自定义项) (`ed.workcenter.WorkCenterDetailAttrextItem`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ed_workcenter_detail_attitem` | domain：`engineeringdata` | 应用：`ED` | 业务对象ID：``
...
|------|-----|
| 显示名 | 工作中心明细(自由自定义项) |
| 物理表 | `ed_workcenter_detail_attitem` |
