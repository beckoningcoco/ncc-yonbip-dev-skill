---
tags: [BIP, 元数据, 数据字典, ed.workcenter.WorkCenterDetailUserDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 工作中心明细(固定自定义项)表 (`ed.workcenter.WorkCenterDetailUserDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ed_workcenter_detail_defitem` | domain：`engineeringdata` | 应用：`ED` | 业务对象ID：``
...
|------|-----|
| 显示名 | 工作中心明细(固定自定义项)表 |
| 物理表 | `ed_workcenter_detail_defitem` |
