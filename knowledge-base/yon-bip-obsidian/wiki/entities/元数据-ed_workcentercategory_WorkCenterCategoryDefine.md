---
tags: [BIP, 元数据, 数据字典, ed.workcentercategory.WorkCenterCategoryDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 工作中心分类(自定义项)表 (`ed.workcentercategory.WorkCenterCategoryDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ed_workcenter_category_define` | domain：`engineeringdata` | 应用：`ED` | 业务对象ID：``
...
|------|-----|
| 显示名 | 工作中心分类(自定义项)表 |
| 物理表 | `ed_workcenter_category_define` |
