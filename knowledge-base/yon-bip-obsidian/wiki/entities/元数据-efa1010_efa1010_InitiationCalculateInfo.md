---
tags: [BIP, 元数据, 数据字典, efa1010.efa1010.InitiationCalculateInfo]
created: 2026-06-03
updated: 2026-06-03
...
# 期初单核算信息 (`efa1010.efa1010.InitiationCalculateInfo`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_bill_add_calc` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`3262b35f-d7e9-4450-85b9-0dd49a812c06`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `subjects` | `efa1010.efa1010.InitiationSubjectAssignment` | composition |
