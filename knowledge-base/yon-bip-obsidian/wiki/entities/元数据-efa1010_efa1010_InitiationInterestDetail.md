---
tags: [BIP, 元数据, 数据字典, efa1010.efa1010.InitiationInterestDetail]
created: 2026-06-03
updated: 2026-06-03
...
# 期初单利息明细 (`efa1010.efa1010.InitiationInterestDetail`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_interest_detail` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`3262b35f-d7e9-4450-85b9-0dd49a812c06`
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `src_bill_id` | `src_bill_id` | `additionBillId` | 期初单基本信息 |
