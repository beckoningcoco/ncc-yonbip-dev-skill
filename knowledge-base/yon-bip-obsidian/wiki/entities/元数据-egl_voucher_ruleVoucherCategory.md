---
tags: [BIP, 元数据, 数据字典, egl.voucher.ruleVoucherCategory]
created: 2026-06-03
updated: 2026-06-03
...
# 规则凭证分类 (`egl.voucher.ruleVoucherCategory`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fi_rulevoucher_sort` | domain：`yonbip-fi-egl` | 应用：`GL` | 业务对象ID：`190a0641-137c-4b04-8c28-a30ded34b07a`
