---
tags: [BIP, 元数据, 数据字典, eia.estiopeningfievent.EstiOpeningFiEventBodyVO]
created: 2026-06-03
updated: 2026-06-03
...
# 暂估期初综合信息 (`eia.estiopeningfievent.EstiOpeningFiEventBodyVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ia_ledger_b` | domain：`yonbip-fi-eia` | 应用：`EIA` | 业务对象ID：`5bb48654-c664-4ef5-85e2-2549df94844f`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `grands` | `eia.estiopeningfievent.EstiOpeningFiEventGrandVO` | composition |
...
| `req_dept_id` | `req_dept_id` | `reqDept` | 部门 |
| `req_cost_center_id` | `req_cost_center_id` | `reqCostCenter` | 部门成本中心 |
...
| `group_trade_rate_type` | `group_trade_rate_type` | `groupTradeRateType` | 集团本币汇率类型 |
| `global_currtype_id` | `global_currtype_id` | `globalCurrtypeId` | 全局本币 |
| `global_trade_rate_type` | `global_trade_rate_type` | `globalTradeRateType` | 全局本币汇率类型 |
...
| `control_trade_rate_type` | `control_trade_rate_type` | `controlTradeRateType` | 管控范围本币汇率类型 |
...
| `accbook_ipv_rate_dif` | `accbook_ipv_rate_dif` | `accbookIpvRateDif` | 账簿本币结算汇差 |
...
| `accbook_ipv_dif` | `accbook_ipv_dif` | `accbookIpvDif` | 账簿本币结算价差 |
...
| `org_ipv_dif` | `org_ipv_dif` | `orgIpvDif` | 组织本币结算价差 |
| `org_ipv_rate_dif` | `org_ipv_rate_dif` | `orgIpvRateDif` | 组织本币结算汇差 |
...
| `group_ipv_rate_dif` | `group_ipv_rate_dif` | `groupIpvRateDif` | 集团本币结算汇差 |
| `group_ipv_dif` | `group_ipv_dif` | `groupIpvDif` | 集团本币结算价差 |
...
| `global_ipv_rate_dif` | `global_ipv_rate_dif` | `globalIpvRateDif` | 全局本币结算汇差 |
| `global_ipv_dif` | `global_ipv_dif` | `globalIpvDif` | 全局本币结算价差 |
...
| `control_ipv_dif` | `control_ipv_dif` | `controlIpvDif` | 管控范围本币结算价差 |
| `control_ipv_rate_dif` | `control_ipv_rate_dif` | `controlIpvRateDif` | 管控范围本币结算汇差 |
