---
tags: [BIP, 元数据, 数据字典, epub.basic.Accstandard]
created: 2026-06-03
updated: 2026-06-03
...
# 会计准则 (`epub.basic.Accstandard`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`epub_accstandard` | domain：`fiepub` | 应用：`FP` | 业务对象ID：`c3e7fe9b-26b5-41cb-9ae9-4d7a7d22cee2`
