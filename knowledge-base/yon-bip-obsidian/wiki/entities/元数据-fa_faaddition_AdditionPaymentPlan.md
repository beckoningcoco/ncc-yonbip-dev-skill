---
tags: [BIP, 元数据, 数据字典, fa.faaddition.AdditionPaymentPlan]
created: 2026-06-03
updated: 2026-06-03
...
# 新增单付款计划 (`fa.faaddition.AdditionPaymentPlan`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_payment_plan` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`26f6782d-c405-466f-8424-c393cad9c921`
