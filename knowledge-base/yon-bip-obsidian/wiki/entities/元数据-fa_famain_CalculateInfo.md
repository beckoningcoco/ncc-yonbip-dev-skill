---
tags: [BIP, 元数据, 数据字典, fa.famain.CalculateInfo]
created: 2026-06-03
updated: 2026-06-03
...
# 核算信息 (`fa.famain.CalculateInfo`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_asset_calc` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`f54930fa-f5c7-4f3a-9e76-823c78ba4871`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `subjects` | `fa.famain.SubjectAssignment` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `stop_depr_period` | `stop_depr_period` | `stopDeprPeriod` | 停提期间 |
...
| `aprn_start_date` | `aprn_start_date` | `deprStartDate` | 开始分摊日期 |
| `first_amortized_adjust_date` | `first_amortized_adjust_date` | `firstAmortiAdjustDate` | 摊销起始日期 |
| `amortized_adjust_date` | `amortized_adjust_date` | `amortiAdjustDate` | 摊销调整日期 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `int_accrued_period` | `int_accrued_period` | `intAccruedPeriod` | 利息已计提期数 |
...
| `acc_total_adjust_depr_amount` | `acc_total_adjust_depr_amount` | `accTotalAdjustDeprAmount` | 本币累计追溯调整折旧 |
| `gbl_accum_int_accrued_amount` | `gbl_accum_int_accrued_amount` | `gblAccumIntAccruedAmount` | 全局币累计计提利息 |
| `gbl_total_adjust_depr_amount` | `gbl_total_adjust_depr_amount` | `gblTotalAdjustDeprAmount` | 全局币累计追溯调整折旧 |
| `grp_accum_int_accrued_amount` | `grp_accum_int_accrued_amount` | `grpAccumIntAccruedAmount` | 集团币累计计提利息 |
| `grp_total_adjust_depr_amount` | `grp_total_adjust_depr_amount` | `grpTotalAdjustDeprAmount` | 集团币累计追溯调整折旧 |
| `org_accum_int_accrued_amount` | `org_accum_int_accrued_amount` | `orgAccumIntAccruedAmount` | 组织币累计计提利息 |
| `org_total_adjust_depr_amount` | `org_total_adjust_depr_amount` | `orgTotalAdjustDeprAmount` | 组织币累计追溯调整折旧 |
