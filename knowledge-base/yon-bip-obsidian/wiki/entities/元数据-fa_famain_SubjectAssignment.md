---
tags: [BIP, 元数据, 数据字典, fa.famain.SubjectAssignment]
created: 2026-06-03
updated: 2026-06-03
...
# 科目分配 (`fa.famain.SubjectAssignment`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_asset_calc_subject` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`f54930fa-f5c7-4f3a-9e76-823c78ba4871`
