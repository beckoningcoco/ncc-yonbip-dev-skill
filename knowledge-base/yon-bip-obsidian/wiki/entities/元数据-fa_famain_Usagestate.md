---
tags: [BIP, 元数据, 数据字典, fa.famain.Usagestate]
created: 2026-06-03
updated: 2026-06-03
...
# 使用状态 (`fa.famain.Usagestate`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_usage_state` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`5002cc10-e15c-4f88-a3ba-779dfb521ef0`
...
| 字段名 | 引用类型 |
|--------|---------|
| `equip_usage_state_id` | `ucf-amc-ambd.ampub_status_ref` |
...
| 字段名 | 数据库列 | 类型 | 显示名 |
|--------|---------|------|--------|
| `equip_usage_state_id` | `equip_usage_state_id` | 6c5e29e8-10de-4a61-88cd-7f97ca7608d0 | 对应实物资产状态 |
...
| 字段名 | 数据库列 | 类型 | 显示名 |
|--------|---------|------|--------|
| `bln_depr` | `bln_depr` | Boolean | 是否折旧 |
