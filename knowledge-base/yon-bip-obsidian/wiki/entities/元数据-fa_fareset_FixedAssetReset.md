---
tags: [BIP, 元数据, 数据字典, fa.fareset.FixedAssetReset]
created: 2026-06-03
updated: 2026-06-03
...
# 资产重启单 (`fa.fareset.FixedAssetReset`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_bill_restart` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`b5459cd9-7f7f-44b2-b2a0-7f8f40cf71f3`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodies` | `fa.fareset.FixedAssetResetDetail` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `accbook_id` | `accbook_id` | `accbook` | 账簿主表 |
