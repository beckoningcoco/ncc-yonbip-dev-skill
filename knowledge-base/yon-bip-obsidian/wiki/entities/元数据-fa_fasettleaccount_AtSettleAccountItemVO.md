---
tags: [BIP, 元数据, 数据字典, fa.fasettleaccount.AtSettleAccountItemVO]
created: 2026-06-03
updated: 2026-06-03
...
# 固定资产结账检查项 (`fa.fasettleaccount.AtSettleAccountItemVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_settle_account_check_item` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`e2096533-4310-413d-aedf-f5635d6eb454`
...
|------|-----|
| 显示名 | 固定资产结账检查项 |
| 物理表 | `fa_settle_account_check_item` |
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodies` | `fa.fasettleaccount.AtCheckItemConditionVO` | composition |
