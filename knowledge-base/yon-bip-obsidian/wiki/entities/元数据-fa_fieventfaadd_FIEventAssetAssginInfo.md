---
tags: [BIP, 元数据, 数据字典, fa.fieventfaadd.FIEventAssetAssginInfo]
created: 2026-06-03
updated: 2026-06-03
...
# 卡片分配信息 (`fa.fieventfaadd.FIEventAssetAssginInfo`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_ledger_b_asgmt` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`2d7ac6c6-fb0a-40f2-a698-265f837e1637`
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `event_calc_id` | `event_calc_id` | `eventAssetCalcInfoId` | 卡片核算信息ID |
