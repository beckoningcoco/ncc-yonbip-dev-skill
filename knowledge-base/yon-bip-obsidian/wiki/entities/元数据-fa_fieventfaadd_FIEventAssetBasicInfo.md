---
tags: [BIP, 元数据, 数据字典, fa.fieventfaadd.FIEventAssetBasicInfo]
created: 2026-06-03
updated: 2026-06-03
...
# 卡片基本信息 (`fa.fieventfaadd.FIEventAssetBasicInfo`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_ledger_b_base` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`2d7ac6c6-fb0a-40f2-a698-265f837e1637`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `eventAssetCalcInfoBodies` | `fa.fieventfaadd.FIEventAssetCalcInfo` | composition |
| `FIEventAssetLeaseInfoList` | `fa.fieventfaadd.FIEventAssetLeaseInfo` | composition |
