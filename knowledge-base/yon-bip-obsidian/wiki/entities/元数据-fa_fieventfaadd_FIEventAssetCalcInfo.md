---
tags: [BIP, 元数据, 数据字典, fa.fieventfaadd.FIEventAssetCalcInfo]
created: 2026-06-03
updated: 2026-06-03
...
# 卡片核算信息 (`fa.fieventfaadd.FIEventAssetCalcInfo`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_ledger_b_calc` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`2d7ac6c6-fb0a-40f2-a698-265f837e1637`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `eventAssetAssginInfoBodies` | `fa.fieventfaadd.FIEventAssetAssginInfo` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `event_basic_id` | `event_basic_id` | `eventAssetBasicInfoId` | 卡片基本信息ID |
...
| `added_tax_amount` | `added_tax_amount` | `addedTaxAmount` | 税额 |
