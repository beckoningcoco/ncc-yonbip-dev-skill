---
tags: [BIP, 元数据, 数据字典, fa.fieventfaimparementback.FAImparementBackFIEventBO]
created: 2026-06-03
updated: 2026-06-03
...
# 固定资产减值转回 (`fa.fieventfaimparementback.FAImparementBackFIEventBO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_ledger_h` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`780d61dd-2c96-42b8-a6d6-9a2aa9affa6c`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `eventAssetBasicInfoBodies` | `fa.fieventfaimparementback.FIEventAssetBasicInfo` | composition |
