---
tags: [BIP, 元数据, 数据字典, fa.fieventfaimparementback.FIEventAssetBasicInfo]
created: 2026-06-03
updated: 2026-06-03
...
# 卡片基本信息 (`fa.fieventfaimparementback.FIEventAssetBasicInfo`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_ledger_b_base` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`780d61dd-2c96-42b8-a6d6-9a2aa9affa6c`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `eventAssetCalcInfoBodies` | `fa.fieventfaimparementback.FIEventAssetCalcInfo` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `eventMaster_id` | `eventMaster_id` | `eventMasterId` | 财务事务主表ID |
