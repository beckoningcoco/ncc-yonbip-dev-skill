---
tags: [BIP, 元数据, 数据字典, fa.fieventfaimparementback.FIEventAssetCalcInfo]
created: 2026-06-03
updated: 2026-06-03
...
# 卡片核算信息 (`fa.fieventfaimparementback.FIEventAssetCalcInfo`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_ledger_b_calc` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`780d61dd-2c96-42b8-a6d6-9a2aa9affa6c`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `eventAssetAssginInfoBodies` | `fa.fieventfaimparementback.FIEventAssetAssginInfo` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `eventassetbasicinfoid` | `eventassetbasicinfoid` | `eventAssetBasicInfoId` | 基本信息Id |
...
| `accum_imp_balance` | `accum_imp_balance` | `accumImpBalance` | 累计减值差额 |
...
| `acc_adjust_depr_amount` | `acc_adjust_depr_amount` | `accAdjustDeprAmount` | 账簿币处置影响折旧额 |
