---
tags: [BIP, 元数据, 数据字典, fa.filedger.FALedgerAsgmt]
created: 2026-06-03
updated: 2026-06-03
...
# 流水账分配信息 (`fa.filedger.FALedgerAsgmt`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_ledger_b_asgmt` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`6ba5b0da-49c5-4bf0-873f-bb5fab0277cf`
...
| `re_value_oppo_subject_vid` | `fiepub.epub_accsubjectversion_treecard_ref` |
| `depr_subject_id` | `fiepub.fiepub_accsubjectref` |
...
| `tax_subject_id` | `fiepub.fiepub_accsubjectref` |
| `pre_liability_subject_vid` | `fiepub.epub_accsubjectversion_treecard_ref` |
| `orivalue_subject_id` | `fiepub.fiepub_accsubjectref` |
...
| `imp_loss_subject_vid` | `fiepub.epub_accsubjectversion_treecard_ref` |
...
| `free_ch_id` | `` |
| `ytenant_id` | `` |
| `re_value_oppo_subject_id` | `fiepub.fiepub_accsubjectref` |
| `disposal_loss_subject_id` | `fiepub.fiepub_accsubjectref` |
| `init_direct_cost_subject_id` | `fiepub.fiepub_accsubjectref` |
| `disposal_loss_subject_vid` | `fiepub.epub_accsubjectversion_treecard_ref` |
...
| `disposal_gain_subject_vid` | `fiepub.epub_accsubjectversion_treecard_ref` |
| `project_id` | `ucfbasedoc.bd_projectcardref` |
| `accbook_currtype_id` | `ucfbasedoc.bd_currencytenantref` |
| `fair_value_subject_id` | `fiepub.fiepub_accsubjectref` |
| `imp_subject_id` | `fiepub.fiepub_accsubjectref` |
...
| `disposal_subject_vid` | `fiepub.epub_accsubjectversion_treecard_ref` |
| `disposal_subject_id` | `fiepub.fiepub_accsubjectref` |
| `imp_loss_subject_id` | `fiepub.fiepub_accsubjectref` |
| `tax_subject_vid` | `fiepub.epub_accsubjectversion_treecard_ref` |
...
| `clean_income_subject_vid` | `fiepub.epub_accsubjectversion_treecard_ref` |
...
| `clean_cost_subject_vid` | `fiepub.epub_accsubjectversion_treecard_ref` |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `clean_cost_subject_id` | `clean_cost_subject_id` | `cleanCostSubjectId` | 清理费用科目-原始版本 |
| `clean_cost_subject_vid` | `clean_cost_subject_vid` | `cleanCostSubjectVid` | 清理费用科目 |
| `clean_income_subject_id` | `clean_income_subject_id` | `cleanIncomeSubjectId` | 清理收入科目-原始版本 |
| `clean_income_subject_vid` | `clean_income_subject_vid` | `cleanIncomeSubjectVid` | 清理收入科目 |
| `depr_subject_id` | `depr_subject_id` | `deprSubjectId` | 累计折旧科目-原始版本 |
| `depr_subject_vid` | `depr_subject_vid` | `deprSubjectVid` | 累计折旧科目 |
| `disposal_gain_subject_id` | `disposal_gain_subject_id` | `disposalGainSubjectId` | 处置收益科目-原始版本 |
| `disposal_gain_subject_vid` | `disposal_gain_subject_vid` | `disposalGainSubjectVid` | 处置收益科目 |
| `disposal_loss_subject_id` | `disposal_loss_subject_id` | `disposalLossSubjectId` | 处置损失科目-原始版本 |
| `disposal_loss_subject_vid` | `disposal_loss_subject_vid` | `disposalLossSubjectVid` | 处置损失科目 |
| `disposal_subject_id` | `disposal_subject_id` | `disposalSubjectId` | 固定资产清理科目-原始版本 |
| `disposal_subject_vid` | `disposal_subject_vid` | `disposalSubjectVid` | 固定资产清理科目 |
| `header_id` | `header_id` | `headerId` | 流水账主表ID |
| `imp_loss_subject_id` | `imp_loss_subject_id` | `impLossSubjectId` | 减值损失科目-原始版本 |
| `imp_loss_subject_vid` | `imp_loss_subject_vid` | `impLossSubjectVid` | 减值损失科目 |
...
| `re_value_oppo_subject_id` | `re_value_oppo_subject_id` | `reValueOppoSubjectId` | 重估对方科目-原始版本	 |
| `re_value_oppo_subject_vid` | `re_value_oppo_subject_vid` | `reValueOppoSubjectVid` | 重估对方科目	 |
| `subject_id` | `subject_id` | `subjectId` | 折旧费科目-原始版本 |
| `subject_vid` | `subject_vid` | `subjectVid` | 折旧费用科目 |
| `tax_subject_id` | `tax_subject_id` | `taxSubjectId` | 增值税科目-原始版本 |
| `tax_subject_vid` | `tax_subject_vid` | `taxSubjectVid` | 增值税科目 |
...
| `acc_re_value_incurred_amount` | `acc_re_value_incurred_amount` | `accReValueIncurredAmount` | 本币重估发生金额 |
| `addition_depr_amount` | `addition_depr_amount` | `additionDeprAmount` | 附加折旧费用金额 |
| `af_proportion` | `af_proportion` | `afProportion` | 比例 |
| `clean_cost_amount` | `clean_cost_amount` | `cleanCostAmount` | 本币清理费用金额 |
| `clean_income_amount` | `clean_income_amount` | `cleanIncomeAmount` | 本币清理收入金额 |
| `curr_period_depr_amount` | `curr_period_depr_amount` | `currPeriodDeprAmount` | 本币折旧费用金额 |
| `disposal_amount` | `disposal_amount` | `disposalAmount` | 本币固定资产清理金额 |
| `disposal_gain_amount` | `disposal_gain_amount` | `disposalGainAmount` | 本币处置收益金额 |
| `disposal_loss_amount` | `disposal_loss_amount` | `disposalLossAmount` | 本币处置损失金额 |
| `gbl_re_value_incurred_amount` | `gbl_re_value_incurred_amount` | `gblReValueIncurredAmount` | 全局币重估发生金额 |
| `grp_re_value_incurred_amount` | `grp_re_value_incurred_amount` | `grpReValueIncurredAmount` | 集团币重估发生金额 |
| `imp_loss_amount` | `imp_loss_amount` | `impLossAmount` | 本币减值损失金额 |
| `org_re_value_incurred_amount` | `org_re_value_incurred_amount` | `orgReValueIncurredAmount` | 组织币重估发生金额 |
| `tax_amount` | `tax_amount` | `taxAmount` | 税额 |
| `be_proportion` | `be_proportion` | `beProportion` | 变动前分配比例 |
