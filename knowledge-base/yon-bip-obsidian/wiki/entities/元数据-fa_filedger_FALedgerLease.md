---
tags: [BIP, 元数据, 数据字典, fa.filedger.FALedgerLease]
created: 2026-06-03
updated: 2026-06-03
...
# 流水账使用权信息 (`fa.filedger.FALedgerLease`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_ledger_b_lease` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`6ba5b0da-49c5-4bf0-873f-bb5fab0277cf`
