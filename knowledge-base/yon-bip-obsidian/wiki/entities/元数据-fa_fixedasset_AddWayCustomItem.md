---
tags: [BIP, 元数据, 数据字典, fa.fixedasset.AddWayCustomItem]
created: 2026-06-03
updated: 2026-06-03
...
# 增加方式自定义项 (`fa.fixedasset.AddWayCustomItem`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`at_addway_customitem` | domain：`yonyoufi` | 应用：`FA` | 业务对象ID：``
