---
tags: [BIP, 元数据, 数据字典, fa.fixedasset.CalculateInfoCustomItem]
created: 2026-06-03
updated: 2026-06-03
...
# 核算信息自定义项 (`fa.fixedasset.CalculateInfoCustomItem`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`at_calculate_info_customitem` | domain：`yonyoufi` | 应用：`FA` | 业务对象ID：``
...
|------|-----|
| 显示名 | 核算信息自定义项 |
| 物理表 | `at_calculate_info_customitem` |
| 数据库 schema | `yonyoufi` |
| 所属应用 | `FA` |
| 直连字段 | 61 个 |
| 子表 | 0 个 |
