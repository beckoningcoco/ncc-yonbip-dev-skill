---
tags: [BIP, 元数据, 数据字典, fa.fixedasset.CalculateInfoDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 核算信息自由自定义项 (`fa.fixedasset.CalculateInfoDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`at_calculate_info_define` | domain：`yonyoufi` | 应用：`FA` | 业务对象ID：``
