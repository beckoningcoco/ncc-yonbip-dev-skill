---
tags: [BIP, 元数据, 数据字典, fa.fixedasset.DepreciationRecordCustomItem]
created: 2026-06-03
updated: 2026-06-03
...
# 折旧清单固定自定义项 (`fa.fixedasset.DepreciationRecordCustomItem`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`at_depreciation_record_customitem` | domain：`yonyoufi` | 应用：`FA` | 业务对象ID：``
...
|------|-----|
| 显示名 | 折旧清单固定自定义项 |
| 物理表 | `at_depreciation_record_customitem` |
| 数据库 schema | `yonyoufi` |
| 所属应用 | `FA` |
| 直连字段 | 61 个 |
| 子表 | 0 个 |
