---
tags: [BIP, 元数据, 数据字典, fa.fixedasset.FixedAssetsInfoCustomItem]
created: 2026-06-03
updated: 2026-06-03
...
# 基本信息自定义项 (`fa.fixedasset.FixedAssetsInfoCustomItem`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`at_fixedassets_info_customitem` | domain：`yonyoufi` | 应用：`FA` | 业务对象ID：``
