---
tags: [BIP, 元数据, 数据字典, fa.fixedasset.FixedAssetsInfoDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 基本信息自由自定义项表 (`fa.fixedasset.FixedAssetsInfoDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`at_fixedassets_info_define` | domain：`yonyoufi` | 应用：`FA` | 业务对象ID：``
...
|------|-----|
| 显示名 | 基本信息自由自定义项表 |
| 物理表 | `at_fixedassets_info_define` |
| domain/服务域 | `yonyoufi` |
| schema | `figl` |
| 所属应用 | `FA` |
| 直连字段 | 61 个 |
