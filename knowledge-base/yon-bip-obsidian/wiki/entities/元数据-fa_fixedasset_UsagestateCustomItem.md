---
tags: [BIP, 元数据, 数据字典, fa.fixedasset.UsagestateCustomItem]
created: 2026-06-03
updated: 2026-06-03
...
# 使用状况自定义项 (`fa.fixedasset.UsagestateCustomItem`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`at_usagestate_customitem` | domain：`yonyoufi` | 应用：`FA` | 业务对象ID：``
