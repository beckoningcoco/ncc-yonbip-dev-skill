---
tags: [BIP, 元数据, 数据字典, fa.reclass.ReclassBillDetailB]
created: 2026-06-03
updated: 2026-06-03
...
# 固定资产重分类明细表 (`fa.reclass.ReclassBillDetailB`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_bill_reclass_dtl_accbook` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`bae936f9-f70a-4569-82a1-2f9a1eff8d73`
...
|------|-----|
| 显示名 | 固定资产重分类明细表 |
| 物理表 | `fa_bill_reclass_dtl_accbook` |
...
| `be_category_id` | `be_category_id` | `beCategoryId` | 重分类前资产类别ID |
| `be_accbook_category_id` | `be_accbook_category_id` | `beBookCategoryId` | 重分类前资产账簿类别 |
| `be_sub_category_id` | `be_sub_category_id` | `beSubCategoryId` | 重分类前子类别编码 |
...
| `af_category_id` | `af_category_id` | `afCategoryId` | 重分类后资产类别 |
| `af_accbook_category_id` | `af_accbook_category_id` | `afBookCategoryId` | 重分类后资产账簿类别 |
| `af_sub_category_id` | `af_sub_category_id` | `afSubCategoryId` | 重分类后子类别编码 |
...
| `reclass_bill_id` | `reclass_bill_id` | `reclassId` | 外键 |
