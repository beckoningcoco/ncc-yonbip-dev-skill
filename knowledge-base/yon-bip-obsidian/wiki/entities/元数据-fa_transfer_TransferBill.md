---
tags: [BIP, 元数据, 数据字典, fa.transfer.TransferBill]
created: 2026-06-03
updated: 2026-06-03
...
# 固定资产转移 (`fa.transfer.TransferBill`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_bill_transfer` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`afa3bc37-a2cc-4ba1-95b7-d9beead8765e`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `details` | `fa.transfer.TransferBillDetail` | composition |
...
| `source_type` | `source_type` | `sourceType` | 单据来源类型 |
