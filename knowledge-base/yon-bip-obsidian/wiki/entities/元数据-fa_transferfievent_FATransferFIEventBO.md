---
tags: [BIP, 元数据, 数据字典, fa.transferfievent.FATransferFIEventBO]
created: 2026-06-03
updated: 2026-06-03
...
# 资产转移 (`fa.transferfievent.FATransferFIEventBO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_ledger_h` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`9a9f8733-e495-4106-af7d-06e5ff48af94`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `eventAssetBasicInfoBodies` | `fa.transferfievent.FIEventAssetBasicInfo` | composition |
