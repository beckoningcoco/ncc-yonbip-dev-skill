---
tags: [BIP, 元数据, 数据字典, fa.unplandepr.AssetUnplanDepr]
created: 2026-06-03
updated: 2026-06-03
...
# 计划外折旧主表 (`fa.unplandepr.AssetUnplanDepr`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`fa_bill_depr_unplan` | domain：`yonbip-fi-efa` | 应用：`EFA` | 业务对象ID：`c58a032e-abe9-4cb9-a88c-d74ab9912514`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `bodies` | `fa.unplandepr.AssetUnplanDeprDtl` | composition |
