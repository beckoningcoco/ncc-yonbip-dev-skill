---
tags: [BIP, 元数据, 数据字典, grm.grmpropertyright.GrmPropertyRightDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 担保物权自定义项 (`grm.grmpropertyright.GrmPropertyRightDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`grm_propertyright_define` | domain：`yonbip-fi-ctmgrm` | 应用：`GRM` | 业务对象ID：``
