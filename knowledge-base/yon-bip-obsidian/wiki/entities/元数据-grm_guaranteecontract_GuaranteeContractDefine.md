---
tags: [BIP, 元数据, 数据字典, grm.guaranteecontract.GuaranteeContractDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 自由自定义项 (`grm.guaranteecontract.GuaranteeContractDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`grm_guarantee_contract_define` | domain：`yonbip-fi-ctmgrm` | 应用：`GRM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 自由自定义项 |
| 物理表 | `grm_guarantee_contract_define` |
