---
tags: [BIP, 元数据, 数据字典, grm.guaranteecontract.GuaranteeContractItemThirdPledge]
created: 2026-06-03
updated: 2026-06-03
...
# 第三方质押担保 (`grm.guaranteecontract.GuaranteeContractItemThirdPledge`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`grm_guarantee_contract_item_third_pledge` | domain：`yonbip-fi-ctmgrm` | 应用：`GRM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 第三方质押担保 |
| 物理表 | `grm_guarantee_contract_item_third_pledge` |
...
| `mortgage_rate` | `mortgage_rate` | `mortgageRate` | 质押率（%） |
| `mortgageable_value` | `mortgageable_value` | `mortgageableValue` | 可质押价值 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `thirdPledgeCharacterDef` | `thirdPledgeCharacterDef` | `thirdPledgeCharacterDef` | 第三方质押担保自定义项 |
