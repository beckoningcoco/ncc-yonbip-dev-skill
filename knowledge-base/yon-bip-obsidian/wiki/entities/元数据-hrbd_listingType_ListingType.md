---
tags: [BIP, 元数据, 数据字典, hrbd.listingType.ListingType]
created: 2026-06-03
updated: 2026-06-03
...
# 上市类型 (`hrbd.listingType.ListingType`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`hrbd_listing_type` | domain：`ucf-staff-center` | 应用：`HRORG` | 业务对象ID：`fba6e9f1-9ee6-478f-922b-0413c9615b1d`
