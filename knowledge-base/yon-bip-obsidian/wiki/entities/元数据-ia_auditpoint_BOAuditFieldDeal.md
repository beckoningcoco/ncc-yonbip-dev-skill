---
tags: [BIP, 元数据, 数据字典, ia.auditpoint.BOAuditFieldDeal]
created: 2026-06-03
updated: 2026-06-03
...
# 字段处理 (`ia.auditpoint.BOAuditFieldDeal`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ssc_ia_bo_audit_field_deal` | domain：`yonbip-mid-sscia` | 应用：`ZNSH` | 业务对象ID：``
...
|------|-----|
| 显示名 | 字段处理 |
| 物理表 | `ssc_ia_bo_audit_field_deal` |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `deal_name` | `deal_name` | `dealName` | 处理后字段名 |
