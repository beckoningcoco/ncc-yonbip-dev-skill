---
tags: [BIP, 元数据, 数据字典, ia.auditpoint.BOAuditGroupField]
created: 2026-06-03
updated: 2026-06-03
...
# 设置分组字段 (`ia.auditpoint.BOAuditGroupField`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ssc_ia_bo_audit_group_field` | domain：`yonbip-mid-sscia` | 应用：`ZNSH` | 业务对象ID：``
...
|------|-----|
| 显示名 | 设置分组字段 |
| 物理表 | `ssc_ia_bo_audit_group_field` |
