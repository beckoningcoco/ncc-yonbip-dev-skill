---
tags: [BIP, 元数据, 数据字典, ia.auditpoint.CustomAuditAuxInfo]
created: 2026-06-03
updated: 2026-06-03
...
# 自定义检查辅助信息 (`ia.auditpoint.CustomAuditAuxInfo`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ssc_ia_custom_audit_aux_info` | domain：`yonbip-mid-sscia` | 应用：`ZNSH` | 业务对象ID：``
...
|------|-----|
| 显示名 | 自定义检查辅助信息 |
| 物理表 | `ssc_ia_custom_audit_aux_info` |
...
| `field_display_name` | `field_display_name` | `fieldDisplayName` | 字段显示名 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `alias_name` | `alias_name` | `aliasName` | 字段别名 |
