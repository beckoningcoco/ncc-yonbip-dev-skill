---
tags: [BIP, 元数据, 数据字典, ia.auditpoint.GptAuditDetail]
created: 2026-06-03
updated: 2026-06-03
...
# 大模型检查项 (`ia.auditpoint.GptAuditDetail`)
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `gptAuditFields` | `ia.auditpoint.GptAuditField` | composition |
...
| `gpt_audit_id` | `gpt_audit_id` | `gptAudit` | 大模型检查 |
