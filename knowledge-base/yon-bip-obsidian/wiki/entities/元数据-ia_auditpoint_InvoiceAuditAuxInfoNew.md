---
tags: [BIP, 元数据, 数据字典, ia.auditpoint.InvoiceAuditAuxInfoNew]
created: 2026-06-03
updated: 2026-06-03
...
# 票单新辅助信息 (`ia.auditpoint.InvoiceAuditAuxInfoNew`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ssc_ia_invoice_audit_aux_info_new` | domain：`yonbip-mid-sscia` | 应用：`ZNSH` | 业务对象ID：``
...
|------|-----|
| 显示名 | 票单新辅助信息 |
| 物理表 | `ssc_ia_invoice_audit_aux_info_new` |
...
| `field_display_name` | `field_display_name` | `fieldDisplayName` | 字段名称 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `invoice_audit_detail_id` | `invoice_audit_detail_id` | `invoiceAuditDetail` | 票单检查内容id |
