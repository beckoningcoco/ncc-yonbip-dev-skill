---
tags: [BIP, 元数据, 数据字典, ia.auditpoint.MultimodalAuditField]
created: 2026-06-03
updated: 2026-06-03
...
# 多模态附件检查相关字段 (`ia.auditpoint.MultimodalAuditField`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ssc_ia_multimodal_audit_field` | domain：`yonbip-mid-sscia` | 应用：`ZNSH` | 业务对象ID：``
...
|------|-----|
| 显示名 | 多模态附件检查相关字段 |
| 物理表 | `ssc_ia_multimodal_audit_field` |
...
| `multimodal_audit_detail_id` | `multimodal_audit_detail_id` | `multimodalAuditDetail` | 多模态附件检查项 |
