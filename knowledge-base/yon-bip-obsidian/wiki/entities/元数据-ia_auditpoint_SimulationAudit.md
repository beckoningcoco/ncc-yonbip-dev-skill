---
tags: [BIP, 元数据, 数据字典, ia.auditpoint.SimulationAudit]
created: 2026-06-03
updated: 2026-06-03
...
# 模拟事项分录检查 (`ia.auditpoint.SimulationAudit`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ssc_ia_simulation_audit` | domain：`yonbip-mid-sscia` | 应用：`ZNSH` | 业务对象ID：``
