---
tags: [BIP, 元数据, 数据字典, ia.auditpoint.VoucherAuditAuxInfo]
created: 2026-06-03
updated: 2026-06-03
...
# 单据检查辅助信息 (`ia.auditpoint.VoucherAuditAuxInfo`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ssc_ia_voucher_audit_aux_info` | domain：`yonbip-mid-sscia` | 应用：`ZNSH` | 业务对象ID：``
...
|------|-----|
| 显示名 | 单据检查辅助信息 |
| 物理表 | `ssc_ia_voucher_audit_aux_info` |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `voucher_audit_detail_id` | `voucher_audit_detail_id` | `voucherAuditDetail` | 单据检查内容id |
