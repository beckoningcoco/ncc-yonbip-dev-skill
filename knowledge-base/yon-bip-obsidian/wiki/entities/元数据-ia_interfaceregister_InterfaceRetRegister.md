---
tags: [BIP, 元数据, 数据字典, ia.interfaceregister.InterfaceRetRegister]
created: 2026-06-03
updated: 2026-06-03
...
# 接口返回值 (`ia.interfaceregister.InterfaceRetRegister`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ssc_ia_interface_ret_register` | domain：`yonbip-mid-sscia` | 应用：`ZNSH` | 业务对象ID：``
...
|------|-----|
| 显示名 | 接口返回值 |
| 物理表 | `ssc_ia_interface_ret_register` |
