---
tags: [BIP, 元数据, 数据字典, iuap-apcom-contract.iuap-apcom-contract.billContractTermsRecord]
created: 2026-06-03
updated: 2026-06-03
...
# 表单条款绑定表 (`iuap-apcom-contract.iuap-apcom-contract.billContractTermsRecord`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`bill_contract_terms_record` | domain：`iuap-apcom-contract` | 应用：`iuap-apcom-contract` | 业务对象ID：``
...
|------|-----|
| 显示名 | 表单条款绑定表 |
| 物理表 | `bill_contract_terms_record` |
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `billContractTermsContentRecordList` | `iuap-apcom-contract.iuap-apcom-contract.billContractTermsContentRecord` | composition |
| `billContractTermVariableList` | `iuap-apcom-contract.iuap-apcom-contract.billContractTermVariable` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `` | `` | `billContractTermVariableList` | 单据条款变量表 |
| `` | `` | `billContractTermsContentRecordList` | 单据条款内容表 |
