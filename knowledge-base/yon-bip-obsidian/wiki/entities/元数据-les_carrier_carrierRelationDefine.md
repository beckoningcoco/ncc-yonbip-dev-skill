---
tags: [BIP, 元数据, 数据字典, les.carrier.carrierRelationDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 承运关系自定义项 (`les.carrier.carrierRelationDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`ils_les_c_relation_define` | domain：`IMP-ILSBD` | 应用：`DPMSI` | 业务对象ID：``
