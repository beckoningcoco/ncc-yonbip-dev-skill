---
tags: [BIP, 元数据, 数据字典, lgm.guaranteeregister.GuaranteeRegisterDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 开函登记自由自定义项 (`lgm.guaranteeregister.GuaranteeRegisterDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`lgm_guaranteeregister_define` | domain：`yonbip-fi-ctmlgm` | 应用：`LGM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 开函登记自由自定义项 |
| 物理表 | `lgm_guaranteeregister_define` |
