---
tags: [BIP, 元数据, 数据字典, mim.measure.MeasureHeadVODefine]
created: 2026-06-03
updated: 2026-06-03
...
# 计量器具目录自定义项 (`mim.measure.MeasureHeadVODefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`pam_measure_define` | domain：`ucf-amc-aum` | 应用：`MIM` | 业务对象ID：``
