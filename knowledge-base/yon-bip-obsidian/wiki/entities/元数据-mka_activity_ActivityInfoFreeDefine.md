---
tags: [BIP, 元数据, 数据字典, mka.activity.ActivityInfoFreeDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 营销活动子表自由自定义项 (`mka.activity.ActivityInfoFreeDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`mka_activity_info_freedefine` | domain：`yycrm` | 应用：`MKA` | 业务对象ID：``
...
|------|-----|
| 显示名 | 营销活动子表自由自定义项 |
| 物理表 | `mka_activity_info_freedefine` |
| 数据库 schema | `yycrm` |
| 所属应用 | `MKA` |
| 直连字段 | 64 个 |
| 子表 | 0 个 |
