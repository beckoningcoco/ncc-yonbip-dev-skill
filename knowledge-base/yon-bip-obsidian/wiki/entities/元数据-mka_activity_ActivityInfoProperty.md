---
tags: [BIP, 元数据, 数据字典, mka.activity.ActivityInfoProperty]
created: 2026-06-03
updated: 2026-06-03
...
# 实际费用子表填报明细 (`mka.activity.ActivityInfoProperty`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`mka_activity_info_property` | domain：`yycrm` | 应用：`MKA` | 业务对象ID：``
...
|------|-----|
| 显示名 | 实际费用子表填报明细 |
| 物理表 | `mka_activity_info_property` |
| 数据库 schema | `yycrm` |
| 所属应用 | `MKA` |
| 直连字段 | 184 个 |
| 子表 | 0 个 |
