---
tags: [BIP, 元数据, 数据字典, mka.activity.ActivityMaterialDef]
created: 2026-06-03
updated: 2026-06-03
...
# 活动物料自定义项 (`mka.activity.ActivityMaterialDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`mka_activity_material_def` | domain：`yycrm` | 应用：`MKA` | 业务对象ID：``
