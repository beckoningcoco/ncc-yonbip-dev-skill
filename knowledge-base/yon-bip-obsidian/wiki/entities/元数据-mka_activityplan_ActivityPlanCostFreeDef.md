---
tags: [BIP, 元数据, 数据字典, mka.activityplan.ActivityPlanCostFreeDef]
created: 2026-06-03
updated: 2026-06-03
...
# 活动计划费用自由自定义项扩展 (`mka.activityplan.ActivityPlanCostFreeDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`mka_activityplan_cost_freedef` | domain：`yycrm` | 应用：`MKA` | 业务对象ID：``
...
|------|-----|
| 显示名 | 活动计划费用自由自定义项扩展 |
| 物理表 | `mka_activityplan_cost_freedef` |
| domain/服务域 | `yycrm` |
| schema | `crm` |
| 所属应用 | `MKA` |
| 直连字段 | 64 个 |
