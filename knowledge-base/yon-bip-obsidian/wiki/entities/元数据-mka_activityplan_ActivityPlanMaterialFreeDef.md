---
tags: [BIP, 元数据, 数据字典, mka.activityplan.ActivityPlanMaterialFreeDef]
created: 2026-06-03
updated: 2026-06-03
...
# 活动计划物料自由自定义项扩展 (`mka.activityplan.ActivityPlanMaterialFreeDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`mka_activityplan_material_freedef` | domain：`yycrm` | 应用：`MKA` | 业务对象ID：``
