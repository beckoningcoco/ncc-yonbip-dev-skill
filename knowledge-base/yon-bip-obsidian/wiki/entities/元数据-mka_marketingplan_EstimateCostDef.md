---
tags: [BIP, 元数据, 数据字典, mka.marketingplan.EstimateCostDef]
created: 2026-06-03
updated: 2026-06-03
...
# 预计费用自定义项 (`mka.marketingplan.EstimateCostDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`mka_estimate_cost_def` | domain：`yycrm` | 应用：`MKA` | 业务对象ID：``
