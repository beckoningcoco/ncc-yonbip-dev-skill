---
tags: [BIP, 元数据, 数据字典, mka.marketingplan.MarketingPlanDef]
created: 2026-06-03
updated: 2026-06-03
...
# 营销方案自定义项 (`mka.marketingplan.MarketingPlanDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`mka_marketing_plan_def` | domain：`yycrm` | 应用：`MKA` | 业务对象ID：``
