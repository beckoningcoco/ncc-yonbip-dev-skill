---
tags: [BIP, 元数据, 数据字典, mka.summary.ActualCostDef]
created: 2026-06-03
updated: 2026-06-03
...
# 实际费用自定义项 (`mka.summary.ActualCostDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`mka_actual_cost_def` | domain：`yycrm` | 应用：`MKA` | 业务对象ID：``
