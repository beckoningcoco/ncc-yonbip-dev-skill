---
tags: [BIP, 元数据, 数据字典, mka.summary.SummaryMaterialDef]
created: 2026-06-03
updated: 2026-06-03
...
# 小结物料自定义项 (`mka.summary.SummaryMaterialDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`mka_summary_material_def` | domain：`yycrm` | 应用：`MKA` | 业务对象ID：``
