---
tags: [BIP, 元数据, 数据字典, org.func.AssetsOrg]
created: 2026-06-03
updated: 2026-06-03
...
# 资产组织 (`org.func.AssetsOrg`)

> **平台版本：BIP 旗舰版 V5** -- 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。
> 物理表: `org_assets` | 应用: `GZTORG` | 类型: `Class`
...
| 16 | `parent` | parent | `parentid` | 23108f32-b0af-425a-83cc-d10c0af18cc3 | `quote` |
| 17 | `parentid` | parentid | `parentid` | 23108f32-b0af-425a-83cc-d10c0af18cc3 | `quote` |
...
| 50 | `finorgid` | finorgid | `finorgid` | 4928db62-a46d-4829-a26a-1de4bb3bf98c | `quote` |
...
| 78 | `assetsdefines` | assetsdefines | `` | f50f33e2-31b7-491d-99c3-c9a34b12c242 | `` |

## 关联（15 个）

- `parent` -> `org.func.AssetsOrg` ()
- `ytenant` -> `yht.tenant.YhtTenant` ()
- `exchangerate` -> `bd.exchangeRate.ExchangeRateTypeVO` ()
- `language` -> `bd.timezonelanguage.LanguageVO` ()
- `orgid` -> `org.func.BaseOrg` ()
- `parentid` -> `org.func.AssetsOrg` ()
...
- `assetsdefines` -> `org.func.AssetsOrgDefine` (1)
