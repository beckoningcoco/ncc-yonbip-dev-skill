...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_assets` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：`8eba344f-a948-4f21-b109-517acca2700b`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `assetsdefines` | `org.func.AssetsOrgDefine` | composition |
...
| `parentid` | `parentid` | `parent` | 上级资产组织 |
| `parentid` | `parentid` | `parentid` | 上级资产组织 |
