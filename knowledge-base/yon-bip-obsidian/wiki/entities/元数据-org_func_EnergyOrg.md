...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_energy` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：``
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `energydefines` | `org.func.EnergyOrgDefine` | composition |
...
| `parentid` | `parentid` | `parent` | 上级能源组织 |
| `parentid` | `parentid` | `parentid` | 上级能源组织 |
