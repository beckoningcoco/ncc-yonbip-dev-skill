---
tags: [BIP, 元数据, 数据字典, org.func.Ext1OrgDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 扩展职能组织1自定义 (`org.func.Ext1OrgDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_ext1_define` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：``
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `define1` | `define1` | `define1` | 469分销商 |
