---
tags: [BIP, 元数据, 数据字典, org.func.Ext2OrgDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 扩展职能组织2自定义 (`org.func.Ext2OrgDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_ext2_define` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：``
