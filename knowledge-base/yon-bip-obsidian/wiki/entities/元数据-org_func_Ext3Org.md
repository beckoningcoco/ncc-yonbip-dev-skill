---
tags: [BIP, 元数据, 数据字典, org.func.Ext3Org]
created: 2026-06-03
updated: 2026-06-03
...
# 扩展职能组织3 (`org.func.Ext3Org`)

> **平台版本：BIP 旗舰版 V5** -- 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。
> 物理表: `org_ext3` | 应用: `GZTORG` | 类型: `Class`
...
| 6 | `parent` | parent | `parentid` | 277eeaa5-6b85-4eb4-b97a-62cd276653da | `quote` |
| 7 | `parentid` | parentid | `parentid` | 277eeaa5-6b85-4eb4-b97a-62cd276653da | `quote` |
...
| 54 | `orgid` | orgid | `orgid` | String | `text` |
...
| 62 | `defines` | defines | `` | 03b35305-fdb8-4541-9675-52f1778908ec | `` |

## 关联（15 个）

- `parent` -> `org.func.Ext3Org` ()
...
- `parentid` -> `org.func.Ext3Org` ()
- `defines` -> `org.func.Ext3OrgDefine` (1)
