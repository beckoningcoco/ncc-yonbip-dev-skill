...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_factory` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：`fe788817-3551-43ec-9cdc-f41a430b177d`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `factorydefines` | `org.func.FactoryOrgDefine` | composition |
...
| `parentid` | `parentid` | `parent` | 上级工厂组织 |
| `parentid` | `parentid` | `parentid` | 上级工厂组织 |
