---
tags: [BIP, 元数据, 数据字典, org.func.FactoryOrg]
created: 2026-06-03
updated: 2026-06-03
...
# 工厂组织 (`org.func.FactoryOrg`)

> **平台版本：BIP 旗舰版 V5** -- 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。
> 物理表: `org_factory` | 应用: `GZTORG` | 类型: `Class`
...
| 16 | `parent` | parent | `parentid` | dcff4710-92a6-4b3a-85c0-553ad21aabc3 | `quote` |
| 17 | `parentid` | parentid | `parentid` | dcff4710-92a6-4b3a-85c0-553ad21aabc3 | `quote` |
...
| 77 | `factorydefines` | factorydefines | `` | f2194876-0448-4de1-a84e-3001f699d6ab | `` |

## 关联（14 个）

- `factorydefines` -> `org.func.FactoryOrgDefine` (1)
- `parent` -> `org.func.FactoryOrg` ()
- `ytenant` -> `yht.tenant.YhtTenant` ()
- `exchangerate` -> `bd.exchangeRate.ExchangeRateTypeVO` ()
- `language` -> `bd.timezonelanguage.LanguageVO` ()
- `orgid` -> `org.func.BaseOrg` ()
- `parentid` -> `org.func.FactoryOrg` ()
