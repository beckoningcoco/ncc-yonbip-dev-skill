---
tags: [BIP, 元数据, 数据字典, org.func.FactoryOrgDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 工厂组织自定义 (`org.func.FactoryOrgDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_factory_define` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：``
