---
tags: [BIP, 元数据, 数据字典, org.func.FinanceOrg]
created: 2026-06-03
updated: 2026-06-03
...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_fin` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：`60839078-b8fc-4fc2-b6f0-b4348ab914e2`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `financedefines` | `org.func.FinanceOrgDefine` | composition |

## 关联引用 (15个)

| 字段名 | 引用类型 |
|--------|---------|
| `parentid` | `ucf-org-center.bd_financeorgtreeref_na` |
| `ytenant_id` | `` |
| `exchangerate` | `ucfbasedoc.bd_enclouddef_exchangerateref` |
| `periodschema` | `finbd.bd_accperiodscheme` |
...
| `statetaxregnum` | `statetaxregnum` | `statetaxregnum` | 国税登记号(废弃) |
| `accountingcalendar` | `accountingcalendar` | `accountingcalendar` | 会计日历(废弃) |
| `localtaxregnum` | `localtaxregnum` | `localtaxregnum` | 地税登记号(废弃) |
...
| `parentid` | `parentid` | `parent` | 上级会计主体 |
