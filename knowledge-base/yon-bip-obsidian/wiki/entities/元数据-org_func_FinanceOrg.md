---
tags: [BIP, 元数据, 数据字典, org, org.func.FinanceOrg]
created: 2026-06-03
updated: 2026-06-03
...
| 16 | `parent` | parent | `parentid` | 5d4c5590-da40-4b50-80a1-8d04da2f79e0 | `quote` |  | true |
| 17 | `parentid` | parentid | `parentid` | 5d4c5590-da40-4b50-80a1-8d04da2f79e0 | `quote` |  | true |
...
| 54 | `periodschema` | periodschema | `periodschema` | e7bb3d2b-b288-4696-b5f0-a9b0626cded8 | `quote` |  | true |
| 55 | `currency` | urrency | `currency` | 02b45339-eb4a-4a31-a8b5-d32f494f4e8e | `quote` |  | true |
| 56 | `isinternalaccounting` | 是否internalaccounting | `is_internal_accounting` | Integer | `int` |  | true |
| 57 | `isexternalaccounting` | 是否externalaccounting | `is_external_accounting` | Integer | `int` |  | true |
| 58 | `enable` | enable | `enable` | Integer | `int` |  | true |
| 59 | `effectivedate` | effectivedate | `effectivedate` | DateTime | `timestamp` |  | true |
| 60 | `expirationdate` | expirationdate | `expirationdate` | DateTime | `timestamp` |  | true |
| 61 | `creator` | 创建人 | `creator` | String | `text` |  | false |
| 62 | `creationtime` | reationtime | `creationtime` | DateTime | `timestamp` |  | false |
| 63 | `modifier` | 修改人 | `modifier` | String | `text` |  | false |
| 64 | `modifiedtime` | modifiedtime | `modifiedtime` | DateTime | `timestamp` |  | false |
| 65 | `sourceid` | sourceid | `sourceid` | String | `text` |  | true |
| 66 | `sourcetype` | sourcetype | `source_type` | Integer | `int` |  | true |
| 67 | `externalorg` | externalorg | `external_org` | Integer | `int` |  | true |
| 68 | `tenant` | tenant | `tenantid` | e4933a03-9dea-472b-a644-cdd654222f45 | `quote` | true | true |
| 69 | `tenantid` | tenantid | `tenantid` | String | `text` |  | false |
| 70 | `ytenant` | ytenant | `ytenant_id` | e4933a03-9dea-472b-a644-cdd654222f45 | `quote` | true | true |
| 71 | `sysid` | sysid | `sysid` | String | `text` |  | false |
| 72 | `pubts` | 时间戳 | `pubts` | DateTime | `timestamp` |  | true |
| 73 | `ts` | ts | `ts` | DateTime | `timestamp` |  | false |
| 74 | `synchts` | synchts | `synchts` | DateTime | `timestamp` |  | true |
| 75 | `dr` | 逻辑删除 | `dr` | Integer | `int` |  | true |
| 76 | `orgid` | orgid | `orgid` | 14302233-1394-4a70-94e1-bed51636f312 | `quote` |  | true |
| 77 | `region` | region | `region` | String | `text` |  | true |
| 78 | `orglevel` | orglevel | `orglevel` | String | `text` |  | true |
| 79 | `path` | path | `path` | String | `text` |  | true |
| 80 | `businessid` | businessid | `businessid` | String | `text` |  | true |
| 81 | `log` | log | `log` | String | `text` |  | true |
| 82 | `jsonextattr` | jsonextattr | `jsonextattr` | String | `text` |  | true |
| 83 | `statetaxregnum` | statetaxregnum | `statetaxregnum` | String | `text` |  | true |
| 84 | `accountingcalendar` | accountingcalendar | `accountingcalendar` | String | `text` |  | true |
| 85 | `localtaxregnum` | localtaxregnum | `localtaxregnum` | String | `text` |  | true |
| 86 | `financedefines` | inancedefines(金额) | `` | 6aebcbce-150e-4718-80d5-30ee1de87d90 | `` |  |  |

## 关联属性（15 个）

| # | 字段 | 显示名 | 目标实体 | 列 | 关系 | 多重性 | 组合 | 隔离 | 废弃 |
|---|------|--------|---------|-----|------|--------|------|------|------|
| 1 | `parent` | parent | `org.func.FinanceOrg` | `parentid` | 外键 |  |  | None |  |
...
| 4 | `periodschema` | periodschema | `bd.period.AccPeriodScheme` | `periodschema` | 外键 |  |  | Service |  |
| 5 | `language` | language | `bd.timezonelanguage.LanguageVO` | `language` | 外键 |  |  | Service |  |
| 6 | `orgid` | orgid | `org.func.BaseOrg` | `orgid` | 外键 |  |  | None | true |
| 7 | `parentid` | parentid | `org.func.FinanceOrg` | `parentid` | 外键 |  |  | None |  |
...
| 10 | `financedefines` | inancedefines(金额) | `org.func.FinanceOrgDefine` | `` | financedefines → id | 1 | Y | None |  |
| 11 | `companytype` | ompanytype | `org.doc.CompanyType` | `companytype` | 外键 |  |  | None |  |
| 12 | `currency` | urrency | `bd.currencytenant.CurrencyTenantVO` | `currency` | 外键 |  |  | Service |  |
| 13 | `id` | 主键ID | `org.func.BaseOrg` | `id` | financeOrg → id | 1 | Y | None |  |
