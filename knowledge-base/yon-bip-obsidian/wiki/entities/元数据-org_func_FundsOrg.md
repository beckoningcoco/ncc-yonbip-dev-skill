...
> 物理表: `org_funds` | 应用: `GZTORG` | 类型: `Class`
...
| 16 | `parent` | parent | `parentid` | 4991976e-11ee-406e-bdbb-0f73f9f89ff2 | `quote` |
| 17 | `parentid` | parentid | `parentid` | 60bf293e-5593-454b-be50-5a5fa016e4a6 | `quote` |
...
| 53 | `finorgid` | finorgid | `finorgid` | 5d4c5590-da40-4b50-80a1-8d04da2f79e0 | `quote` |
