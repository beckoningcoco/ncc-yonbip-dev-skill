---
tags: [BIP, 元数据, 数据字典, org.func.HrbizOrg]
created: 2026-06-03
updated: 2026-06-03
...
# 人力业务 (`org.func.HrbizOrg`)

> **平台版本：BIP 旗舰版 V5** -- 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。
> 物理表: `org_hrbiz` | 应用: `GZTORG` | 类型: `Class`
...
| 8 | `iscontrolunit` | 是否controlunit | `is_control_unit` | Integer | `int` |
| 9 | `name6` | name6 | `name6` | String | `text` |
| 10 | `shortname` | shortname | `shortname` | String | `multiLanguage` |
| 11 | `shortname2` | shortname2 | `shortname2` | String | `text` |
| 12 | `shortname3` | shortname3 | `shortname3` | String | `text` |
| 13 | `shortname4` | shortname4 | `shortname4` | String | `text` |
| 14 | `shortname5` | shortname5 | `shortname5` | String | `text` |
| 15 | `shortname6` | shortname6 | `shortname6` | String | `text` |
| 16 | `companytype` | companytype | `companytype` | 45cbc79d-a41a-41e4-af94-b264ce83596a | `quote` |
| 17 | `parent` | parent | `parentid` | f2f4b9e0-5035-4a5a-8b65-6cc17bb9e628 | `quote` |
| 18 | `parentid` | parentid | `parentid` | f2f4b9e0-5035-4a5a-8b65-6cc17bb9e628 | `quote` |
| 19 | `innercode` | innercode | `innercode` | String | `text` |
| 20 | `orgtype` | orgtype | `orgtype` | Integer | `int` |
...
| 49 | `sort` | 排序 | `sort_num` | Integer | `int` |
