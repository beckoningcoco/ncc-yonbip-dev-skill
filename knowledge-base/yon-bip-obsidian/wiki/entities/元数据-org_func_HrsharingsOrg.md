...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_hrsharings` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：``
...
| `parent_id` | `parent_id` | `parent` | 上级人力共享组织 |
...
| `parentid` | `parentid` | `parentid` | 上级人力共享组织 |
...
| `establishtime` | `establishtime` | `establishtime` | 成立日期(废弃) |
