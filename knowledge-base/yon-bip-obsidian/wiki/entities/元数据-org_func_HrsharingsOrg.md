---
tags: [BIP, 元数据, 数据字典, org.func.HrsharingsOrg]
created: 2026-06-03
updated: 2026-06-03
...
# 人力共享 (`org.func.HrsharingsOrg`)

> **平台版本：BIP 旗舰版 V5** -- 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。
> 物理表: `org_hrsharings` | 应用: `GZTORG` | 类型: `Class`
...
| 16 | `parent` | parent | `parent_id` | String | `text` |
| 17 | `parentid` | parentid | `parentid` | 84b9eb13-960d-4147-a961-292820a3bd91 | `quote` |
...
| 77 | `establishtime` | establishtime | `establishtime` | DateTime | `timestamp` |
...
- `parentid` -> `org.func.HrsharingsOrg` ()
