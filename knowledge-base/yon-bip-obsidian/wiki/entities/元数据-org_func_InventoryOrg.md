---
tags: [BIP, 元数据, 数据字典, org.func.InventoryOrg]
created: 2026-06-03
updated: 2026-06-03
...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_inventory` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：`1996171e-8573-4ff5-bdc2-3bbbe8bf7593`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `inventorydefines` | `org.func.InventoryOrgDefine` | composition |
...
| `parentid` | `parentid` | `parent` | 上级库存组织 |
| `parentid` | `parentid` | `parentid` | 上级库存组织 |
