...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_legal` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：``
...
| `parentid` | `parentid` | `parent` | 上级法人组织 |
| `parentid` | `parentid` | `parentid` | 上级法人组织 |
...
| `establishtime` | `establishtime` | `establishtime` | 成立时间 |
