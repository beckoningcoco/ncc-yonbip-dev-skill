---
tags: [BIP, 元数据, 数据字典, org.func.LegalOrg]
created: 2026-06-03
updated: 2026-06-03
...
# 法人 (`org.func.LegalOrg`)

> **平台版本：BIP 旗舰版 V5** -- 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。
> 物理表: `org_legal` | 应用: `GZTORG` | 类型: `Class`
...
| 16 | `parent` | parent | `parentid` | 6e90d23e-1fe8-4951-8e39-1bf7a28e151f | `quote` |
| 17 | `parentid` | parentid | `parentid` | 6e90d23e-1fe8-4951-8e39-1bf7a28e151f | `quote` |
...
| 48 | `sort` | 排序 | `sort_num` | Integer | `int` |
