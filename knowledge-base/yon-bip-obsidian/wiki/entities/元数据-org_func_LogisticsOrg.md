---
tags: [BIP, 元数据, 数据字典, org.func.LogisticsOrg]
created: 2026-06-03
updated: 2026-06-03
...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_logistics` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：``
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `logisticsdefines` | `org.func.LogisticsOrgDefine` | composition |
...
| `parentid` | `parentid` | `parent` | 上级物流组织 |
| `parentid` | `parentid` | `parentid` | 上级物流组织 |
...
| `dr` | `dr` | `dr` | 逻辑删除标识 |
| `logistics_type` | `logistics_type` | `logistictype` | 物流组织类型 |
