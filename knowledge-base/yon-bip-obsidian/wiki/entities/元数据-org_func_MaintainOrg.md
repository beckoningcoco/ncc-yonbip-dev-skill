---
tags: [BIP, 元数据, 数据字典, org.func.MaintainOrg]
created: 2026-06-03
updated: 2026-06-03
...
# 维修组织 (`org.func.MaintainOrg`)

> **平台版本：BIP 旗舰版 V5** -- 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。
> 物理表: `org_maintain` | 应用: `GZTORG` | 类型: `Class`
...
| 16 | `parent` | parent | `parentid` | 118abacd-adc7-412e-9c0c-868f1c3b4110 | `quote` |
| 17 | `parentid` | parentid | `parentid` | 118abacd-adc7-412e-9c0c-868f1c3b4110 | `quote` |
...
| 53 | `finorgid` | finorgid | `finorgid` | 4928db62-a46d-4829-a26a-1de4bb3bf98c | `quote` |
| 54 | `isEnd` | 是否End | `isEnd` | Integer | `int` |
| 55 | `currency` | currency | `currency` | 02b45339-eb4a-4a31-a8b5-d32f494f4e8e | `quote` |
| 56 | `enable` | enable | `enable` | Integer | `int` |
| 57 | `effectivedate` | effectivedate | `effectivedate` | DateTime | `timestamp` |
| 58 | `expirationdate` | expirationdate | `expirationdate` | DateTime | `timestamp` |
| 59 | `creator` | 创建人 | `creator` | String | `text` |
| 60 | `creationtime` | creationtime | `creationtime` | DateTime | `timestamp` |
| 61 | `modifier` | 修改人 | `modifier` | String | `text` |
| 62 | `modifiedtime` | modifiedtime | `modifiedtime` | DateTime | `timestamp` |
| 63 | `sourceid` | sourceid | `sourceid` | String | `text` |
| 64 | `externalorg` | externalorg | `external_org` | Integer | `int` |
| 65 | `tenant` | tenant | `tenantid` | e4933a03-9dea-472b-a644-cdd654222f45 | `quote` |
| 66 | `tenantid` | tenantid | `tenantid` | String | `text` |
| 67 | `ytenant` | ytenant | `ytenant_id` | e4933a03-9dea-472b-a644-cdd654222f45 | `quote` |
| 68 | `sysid` | sysid | `sysid` | String | `text` |
| 69 | `pubts` | 时间戳 | `pubts` | DateTime | `timestamp` |
| 70 | `ts` | ts | `ts` | DateTime | `timestamp` |
| 71 | `synchts` | synchts | `synchts` | DateTime | `timestamp` |
| 72 | `dr` | 逻辑删除 | `dr` | Integer | `int` |
| 73 | `orgid` | orgid | `orgid` | 14302233-1394-4a70-94e1-bed51636f312 | `quote` |
| 74 | `path` | path | `path` | String | `text` |
| 75 | `businessid` | businessid | `businessid` | String | `text` |
| 76 | `log` | log | `log` | String | `text` |
| 77 | `jsonextattr` | jsonextattr | `jsonextattr` | String | `text` |
| 78 | `maintaindefines` | maintaindefines | `` | 494bf3bb-e9fc-4e6f-9c75-b4b7ed1f3311 | `` |

## 关联（15 个）

- `parent` -> `org.func.MaintainOrg` ()
- `ytenant` -> `yht.tenant.YhtTenant` ()
- `exchangerate` -> `bd.exchangeRate.ExchangeRateTypeVO` ()
- `language` -> `bd.timezonelanguage.LanguageVO` ()
- `maintaindefines` -> `org.func.MaintainOrgDefine` (1)
- `orgid` -> `org.func.BaseOrg` ()
- `parentid` -> `org.func.MaintainOrg` ()
