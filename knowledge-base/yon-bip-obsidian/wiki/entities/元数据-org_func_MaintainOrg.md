...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_maintain` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：``
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `maintaindefines` | `org.func.MaintainOrgDefine` | composition |
...
| `parentid` | `parentid` | `parent` | 上级维修组织 |
| `parentid` | `parentid` | `parentid` | 上级维修组织 |
