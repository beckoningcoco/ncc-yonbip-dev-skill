---
tags: [BIP, 元数据, 数据字典, org.func.MaintainOrgDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 维修组织自定义 (`org.func.MaintainOrgDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_maintain_define` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：``
