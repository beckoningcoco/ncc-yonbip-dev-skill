...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_plan` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：``
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `plandefines` | `org.func.PlanOrgDefine` | composition |
...
| `parentid` | `parentid` | `parent` | 上级计划中心 |
| `parentid` | `parentid` | `parentid` | 上级计划中心 |
