---
tags: [BIP, 元数据, 数据字典, org.func.PurchaseOrg]
created: 2026-06-03
updated: 2026-06-03
...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_purchase` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：`7173625f-01de-405a-b8aa-57a583fc1431`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `purchasedefines` | `org.func.PurchaseOrgDefine` | composition |
...
| `contact_org` | `ucf-org-center.org_pure_tree_ref` |
...
| `applyrate` | `applyrate` | `applyrate` | 使用税率(废弃) |
...
| `parentid` | `parentid` | `parent` | 上级采购组织 |
| `parentid` | `parentid` | `parentid` | 上级采购组织 |
...
| `contact_org` | `contact_org` | `contactOrg` | 合同签订主体 |
