---
tags: [BIP, 元数据, 数据字典, org.func.QualityOrg]
created: 2026-06-03
updated: 2026-06-03
...
# 质检组织 (`org.func.QualityOrg`)

> **平台版本：BIP 旗舰版 V5** -- 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。
> 物理表: `org_quality` | 应用: `GZTORG` | 类型: `Class`
...
| 77 | `qualitydefines` | qualitydefines | `` | be224cf4-ac7f-4ab7-bc3e-e92b61025bbf | `` |

## 关联（14 个）

- `parent` -> `org.func.FactoryOrg` ()
- `qualitydefines` -> `org.func.QualityOrgDefine` (1)
