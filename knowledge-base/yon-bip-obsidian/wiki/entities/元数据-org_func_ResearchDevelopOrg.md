---
tags: [BIP, 元数据, 数据字典, org.func.ResearchDevelopOrg]
created: 2026-06-03
updated: 2026-06-03
...
# 研发组织 (`org.func.ResearchDevelopOrg`)

> **平台版本：BIP 旗舰版 V5** -- 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。
> 物理表: `org_rd` | 应用: `GZTORG` | 类型: `Class`
...
| 16 | `parent` | parent | `parentid` | 604f7730-68fd-4fe1-9323-b1b2c9a0360e | `quote` |
| 17 | `parentid` | parentid | `parentid` | 604f7730-68fd-4fe1-9323-b1b2c9a0360e | `quote` |
...
| 68 | `synchts` | synchts | `synchts` | DateTime | `timestamp` |
| 69 | `dr` | 逻辑删除 | `dr` | Integer | `int` |
| 70 | `orgid` | orgid | `orgid` | 14302233-1394-4a70-94e1-bed51636f312 | `quote` |
| 71 | `path` | path | `path` | String | `text` |
| 72 | `businessid` | businessid | `businessid` | String | `text` |
| 73 | `log` | log | `log` | String | `text` |
| 74 | `jsonextattr` | jsonextattr | `jsonextattr` | String | `text` |
| 75 | `researchDevelopdefines` | researchDevelopdefines | `` | 64c3e888-5aaa-4fb7-84e1-9df54a8b8049 | `` |

## 关联（14 个）

- `parent` -> `org.func.ResearchDevelopOrg` ()
- `ytenant` -> `yht.tenant.YhtTenant` ()
- `exchangerate` -> `bd.exchangeRate.ExchangeRateTypeVO` ()
- `language` -> `bd.timezonelanguage.LanguageVO` ()
- `orgid` -> `org.func.BaseOrg` ()
- `parentid` -> `org.func.ResearchDevelopOrg` ()
- `principal` -> `bd.staff.Staff` ()
- `branchleader` -> `bd.staff.Staff` ()
- `researchDevelopdefines` -> `org.func.ResearchDevelopOrgDefine` (1)
