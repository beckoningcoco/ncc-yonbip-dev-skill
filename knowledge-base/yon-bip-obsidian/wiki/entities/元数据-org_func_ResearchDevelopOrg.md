...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_rd` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：``
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `researchDevelopdefines` | `org.func.ResearchDevelopOrgDefine` | composition |
...
| `parentid` | `parentid` | `parent` | 上级研发组织 |
| `parentid` | `parentid` | `parentid` | 上级研发组织 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `` | `` | `researchDevelopdefines` | 研发中心自定义 |
