---
tags: [BIP, 元数据, 数据字典, org.func.SafetyOrg]
created: 2026-06-03
updated: 2026-06-03
...
# 安环组织 (`org.func.SafetyOrg`)

> **平台版本：BIP 旗舰版 V5** -- 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。
> 物理表: `org_safety` | 应用: `GZTORG` | 类型: `Class`
...
| 16 | `parent` | parent | `parentid` | 5228334a-50fb-49af-8829-86dadc6bdf44 | `quote` |
| 17 | `parentid` | parentid | `parentid` | 5228334a-50fb-49af-8829-86dadc6bdf44 | `quote` |
...
| 77 | `safetydefines` | safetydefines | `` | c9e15a38-4743-4611-87a2-e7d79445713a | `` |

## 关联（14 个）

- `parent` -> `org.func.SafetyOrg` ()
- `ytenant` -> `yht.tenant.YhtTenant` ()
- `exchangerate` -> `bd.exchangeRate.ExchangeRateTypeVO` ()
- `language` -> `bd.timezonelanguage.LanguageVO` ()
- `safetydefines` -> `org.func.SafetyOrgDefine` (1)
- `orgid` -> `org.func.BaseOrg` ()
- `parentid` -> `org.func.SafetyOrg` ()
