...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_safety` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：``
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `safetydefines` | `org.func.SafetyOrgDefine` | composition |
...
| `parentid` | `parentid` | `parent` | 上级安环组织 |
| `parentid` | `parentid` | `parentid` | 上级安环组织 |
