---
tags: [BIP, 元数据, 数据字典, org.func.SafetyOrgDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 安环组织自定义 (`org.func.SafetyOrgDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_safety_define` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：``
