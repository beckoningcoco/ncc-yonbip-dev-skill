---
tags: [BIP, 元数据, 数据字典, org.func.SalesOrg]
created: 2026-06-03
updated: 2026-06-03
...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_sales` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：`a5651d18-a575-4a23-8f8d-64f81ab35f70`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `salesdefines` | `org.func.SalesOrgDefine` | composition |

## 关联引用 (14个)

| 字段名 | 引用类型 |
|--------|---------|
| `parentid` | `ucf-org-center.bd_salesorg_na` |
| `` | `` |
| `ytenant_id` | `` |
| `exchangerate` | `` |
| `language` | `` |
...
| `parentid` | `parentid` | `parent` | 上级销售组织 |
| `parentid` | `parentid` | `parentid` | 上级销售组织 |
