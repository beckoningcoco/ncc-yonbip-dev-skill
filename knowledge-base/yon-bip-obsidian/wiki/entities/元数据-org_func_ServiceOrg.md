---
tags: [BIP, 元数据, 数据字典, org.func.ServiceOrg]
created: 2026-06-03
updated: 2026-06-03
...
# 服务组织 (`org.func.ServiceOrg`)

> **平台版本：BIP 旗舰版 V5** -- 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。
> 物理表: `org_service` | 应用: `GZTORG` | 类型: `Class`
...
| 16 | `parent` | parent | `parentid` | 4572acae-3dd7-4f37-bbf9-766fe130a7f1 | `quote` |
| 17 | `parentid` | parentid | `parentid` | 4572acae-3dd7-4f37-bbf9-766fe130a7f1 | `quote` |
...
| 73 | `orglevel` | orglevel | `orglevel` | String | `text` |
...
| 78 | `servicedefines` | servicedefines | `` | a530addf-f86f-41c4-be85-812ad8a33cc9 | `` |

## 关联（14 个）

- `parent` -> `org.func.ServiceOrg` ()
- `ytenant` -> `yht.tenant.YhtTenant` ()
- `exchangerate` -> `bd.exchangeRate.ExchangeRateTypeVO` ()
- `language` -> `bd.timezonelanguage.LanguageVO` ()
- `orgid` -> `org.func.BaseOrg` ()
- `parentid` -> `org.func.ServiceOrg` ()
...
- `servicedefines` -> `org.func.ServiceOrgDefine` (1)
