...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_service` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：``
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `servicedefines` | `org.func.ServiceOrgDefine` | composition |
...
| `parentid` | `parentid` | `parent` | 上级服务组织 |
| `parentid` | `parentid` | `parentid` | 上级服务组织 |
