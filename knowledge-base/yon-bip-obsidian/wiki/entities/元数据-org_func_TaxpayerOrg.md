...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_taxpayer` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：`7a39fd27-4dc9-4fc8-a07d-b5d9c8b4a44b`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `taxpayerdefines` | `org.func.TaxpayerOrgDefine` | composition |

## 关联引用 (14个)

| 字段名 | 引用类型 |
|--------|---------|
| `parentid` | `ucf-org-center.org_taxpayer_tree_ref_na` |
| `ytenant_id` | `` |
...
| `parentid` | `parentid` | `parent` | 上级税务组织 |
| `parentid` | `parentid` | `parentid` | 上级税务组织 |
...
| `dr` | `dr` | `dr` | 逻辑删除标识 |
| `is_taxpayer` | `is_taxpayer` | `isTaxpayer` | 是否纳税主体 |
| `dockplatinform` | `dockplatinform` | `dockplatinform` | 是否对接发票平台 |
