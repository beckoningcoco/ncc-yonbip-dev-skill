---
tags: [BIP, 元数据, 数据字典, org.func.TaxpayerOrg]
created: 2026-06-03
updated: 2026-06-03
...
# 税务组织 (`org.func.TaxpayerOrg`)

> **平台版本：BIP 旗舰版 V5** -- 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。
> 物理表: `org_taxpayer` | 应用: `GZTORG` | 类型: `Class`
...
| 16 | `parent` | parent | `parentid` | 48b572d0-b5ee-469a-a313-4c20d9182f63 | `quote` |
| 17 | `parentid` | parentid | `parentid` | 48b572d0-b5ee-469a-a313-4c20d9182f63 | `quote` |
...
| 77 | `isTaxpayer` | 是否Taxpayer | `is_taxpayer` | Integer | `int` |
| 78 | `dockplatinform` | dockplatinform | `dockplatinform` | Integer | `int` |
| 79 | `taxpayerdefines` | taxpayerdefines | `` | 3f277651-3297-4399-aeae-a05bfb28fca5 | `` |

## 关联（14 个）

- `parent` -> `org.func.TaxpayerOrg` ()
- `ytenant` -> `yht.tenant.YhtTenant` ()
- `exchangerate` -> `bd.exchangeRate.ExchangeRateTypeVO` ()
- `language` -> `bd.timezonelanguage.LanguageVO` ()
- `orgid` -> `org.func.BaseOrg` ()
- `parentid` -> `org.func.TaxpayerOrg` ()
...
- `taxpayerdefines` -> `org.func.TaxpayerOrgDefine` (1)
