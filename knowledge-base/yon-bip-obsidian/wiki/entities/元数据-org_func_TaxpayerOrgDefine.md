---
tags: [BIP, 元数据, 数据字典, org.func.TaxpayerOrgDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 税务组织自定义 (`org.func.TaxpayerOrgDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_taxpayer_define` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：``
