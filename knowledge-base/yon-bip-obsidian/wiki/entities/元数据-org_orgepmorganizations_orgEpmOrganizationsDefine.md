---
tags: [BIP, 元数据, 数据字典, org.orgepmorganizations.orgEpmOrganizationsDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 组织体系自定义项 (`org.orgepmorganizations.orgEpmOrganizationsDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`org_epm_organizations_define` | domain：`ucf-org-center` | 应用：`GZTORG` | 业务对象ID：``
...
|------|-----|
| 显示名 | 组织体系自定义项 |
| 物理表 | `org_epm_organizations_define` |
