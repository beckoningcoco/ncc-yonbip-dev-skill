---
tags: [BIP, 元数据, 数据字典, pc.cls.ManagementClassDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 物料分类自定义项 (`pc.cls.ManagementClassDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`product_management_class_define` | domain：`productcenter` | 应用：`GZTBDM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 物料分类自定义项 |
| 物理表 | `product_management_class_define` |
