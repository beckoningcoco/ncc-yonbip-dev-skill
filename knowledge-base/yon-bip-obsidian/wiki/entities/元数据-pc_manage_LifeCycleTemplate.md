...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`pc_lifecyc_tpl` | domain：`productcenter` | 应用：`GZTBDM` | 业务对象ID：`cf152ba9-e4dc-49af-8afd-7515f55437be`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `lifeCycleDetail` | `pc.manage.LifeCycleDetail` | composition |
