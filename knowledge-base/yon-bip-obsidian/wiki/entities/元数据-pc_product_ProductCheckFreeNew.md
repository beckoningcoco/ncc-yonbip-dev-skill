---
tags: [BIP, 元数据, 数据字典, pc.product.ProductCheckFreeNew]
created: 2026-06-03
updated: 2026-06-03
...
# 指定核算的规格(整合) (`pc.product.ProductCheckFreeNew`)
...
| `productDetailId` | `productDetailId` | `productDetailId` | 物料组织级表ID |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `iFreeType` | `iFreeType` | `freeType` | 规格敏感领域类型 |
