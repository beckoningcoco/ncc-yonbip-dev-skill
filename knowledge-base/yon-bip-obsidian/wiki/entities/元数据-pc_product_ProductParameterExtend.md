---
tags: [BIP, 元数据, 数据字典, pc.product.ProductParameterExtend]
created: 2026-06-03
updated: 2026-06-03
...
# (停用)物料参数表(管理组织) (`pc.product.ProductParameterExtend`)

> **平台版本：BIP 旗舰版 V5** -- 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。
> 物理表: `productparameters` | 应用: `GZTBDM` | 类型: `Class`
...
| 6 | `param` | param | `oParameter_id` | c06be101-c80b-40a1-b607-c41329151c48 | `quote` |
| 7 | `paramValue` | paramValue | `cParamValue` | String | `text` |
| 8 | `pubts` | 时间戳 | `pubts` | DateTime | `timestamp` |
| 9 | `isCreator` | 是否Creator | `isCreator` | Boolean | `switch` |

## 关联（4 个）

- `productApplyRangeId` -> `pc.product.ProductApplyRange` ()
- `productId` -> `pc.product.Product` (0..n)
- `param` -> `pc.tpl.ProductTplParameter` ()
