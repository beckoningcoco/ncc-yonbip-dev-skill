---
tags: [BIP, 元数据, 数据字典, pc.product.ProductTagNew]
created: 2026-06-03
updated: 2026-06-03
...
# 物料标签关联表(整合) (`pc.product.ProductTagNew`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`producttagnew` | domain：`productcenter` | 应用：`GZTBDM` | 业务对象ID：``
