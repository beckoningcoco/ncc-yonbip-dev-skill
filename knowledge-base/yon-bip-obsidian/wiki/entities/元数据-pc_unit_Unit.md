---
tags: [BIP, 元数据, 数据字典, pc.unit.Unit]
created: 2026-06-03
updated: 2026-06-03
...
> **平台版本：BIP 旗舰版 V5**
> 物理表：`unit` | domain：`productcenter` | 应用：`GZTBDM` | 业务对象ID：`9472fbc0-482f-427b-b2be-d591219bb1e9`
...
| `` | `` |
| `unit_character` | `` |
| `unit_group_id` | `productcenter.pc_unitgroupref` |
| `tenant_id` | `` |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `unit_group_id` | `unit_group_id` | `unitGroup` | 分组 |
...
| `baseunit` | `baseunit` | `bBaseUnit` | 是否基本单位 |
| `sourcetype` | `sourcetype` | `sourcetype` | 系统预置 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `truncationType` | `truncationType` | `truncationType` | 舍位方式 |
| `precision` | `precision` | `precision` | 单位精度 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `convert_coefficient` | `convert_coefficient` | `convertCoefficient` | 换算系数 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `unit_character` | `unit_character` | `unitCharacter` | 计量单位特征自定义项 |
