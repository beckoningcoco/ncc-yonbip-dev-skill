---
tags: [BIP, 元数据, 数据字典, pgrm.projectschedule.ProjectScheduleItemCheckitemDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 进度计划检查项自定义项 (`pgrm.projectschedule.ProjectScheduleItemCheckitemDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`pgrm_schedule_item_checkitem_define` | domain：`yonbip-pm-projectme` | 应用：`PGRM` | 业务对象ID：`5ed50b6c-9204-42ec-8910-4b7147d2f488`
...
|------|-----|
| 显示名 | 进度计划检查项自定义项 |
| 物理表 | `pgrm_schedule_item_checkitem_define` |
