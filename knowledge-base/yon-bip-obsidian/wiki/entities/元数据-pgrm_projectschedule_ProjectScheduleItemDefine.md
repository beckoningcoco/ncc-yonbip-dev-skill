---
tags: [BIP, 元数据, 数据字典, pgrm.projectschedule.ProjectScheduleItemDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 项目进度详情自定义项 (`pgrm.projectschedule.ProjectScheduleItemDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`prjc_project_schedule_item_define` | domain：`yonbip-pm-projectme` | 应用：`PGRM` | 业务对象ID：`5ed50b6c-9204-42ec-8910-4b7147d2f488`
...
|------|-----|
| 显示名 | 项目进度详情自定义项 |
| 物理表 | `prjc_project_schedule_item_define` |
