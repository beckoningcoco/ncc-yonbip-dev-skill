---
tags: [BIP, 元数据, 数据字典, pgrm.wbstemplate.WbsTemplateCheckitem]
created: 2026-06-03
updated: 2026-06-03
...
# wbs模版检查项 (`pgrm.wbstemplate.WbsTemplateCheckitem`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`pgrm_template_checkitem` | domain：`yonbip-pm-projectme` | 应用：`PGRM` | 业务对象ID：`5b1fe33b-f5ca-4a2f-96c1-94bf2d130a37`
