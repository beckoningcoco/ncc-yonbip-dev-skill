---
tags: [BIP, 元数据, 数据字典, pgrm.wbstemplate.WbsTemplateDefine]
created: 2026-06-03
updated: 2026-06-03
...
# WBS模板自定义项 (`pgrm.wbstemplate.WbsTemplateDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`pm_pgrm_wbstpl_define` | domain：`yonbip-pm-projectme` | 应用：`PGRM` | 业务对象ID：`5b1fe33b-f5ca-4a2f-96c1-94bf2d130a37`
