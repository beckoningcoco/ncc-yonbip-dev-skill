---
tags: [BIP, 元数据, 数据字典, pgrm.wbstemplate.WbsTemplateMaterialItem]
created: 2026-06-03
updated: 2026-06-03
...
# 项目物资模板明细 (`pgrm.wbstemplate.WbsTemplateMaterialItem`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`pgrm_template_material_item` | domain：`yonbip-pm-projectme` | 应用：`PGRM` | 业务对象ID：`5b1fe33b-f5ca-4a2f-96c1-94bf2d130a37`
...
|------|-----|
| 显示名 | 项目物资模板明细 |
| 物理表 | `pgrm_template_material_item` |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `WbsTemplateMaterial_id` | `WbsTemplateMaterial_id` | `WbsTemplateMaterial_id` | 项目物资清单模板 |
