---
tags: [BIP, 元数据, 数据字典, prm.partnertype.PartnerTypeDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 伙伴类型自定义项 (`prm.partnertype.PartnerTypeDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`prm_partnertype_define` | domain：`yycrm` | 应用：`PRM` | 业务对象ID：``
