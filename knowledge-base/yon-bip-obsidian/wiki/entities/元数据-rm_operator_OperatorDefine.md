---
tags: [BIP, 元数据, 数据字典, rm.operator.OperatorDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 人员自由自定义项 (`rm.operator.OperatorDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`udh_operatordefine` | domain：`yxybase` | 应用：`RM` | 业务对象ID：``
