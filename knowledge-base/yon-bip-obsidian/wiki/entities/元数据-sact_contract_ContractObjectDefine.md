---
tags: [BIP, 元数据, 数据字典, sact.contract.ContractObjectDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 合同标的自定义项 (`sact.contract.ContractObjectDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`sact_contractobject_define` | domain：`sact` | 应用：`SACT` | 业务对象ID：``
...
|------|-----|
| 显示名 | 合同标的自定义项 |
| 物理表 | `sact_contractobject_define` |
| domain/服务域 | `sact` |
| schema | `scmmp` |
| 所属应用 | `SACT` |
| 直连字段 | 64 个 |
