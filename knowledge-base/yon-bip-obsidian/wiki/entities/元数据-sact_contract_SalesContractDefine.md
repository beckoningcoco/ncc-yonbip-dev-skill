---
tags: [BIP, 元数据, 数据字典, sact.contract.SalesContractDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 销售合同自定义项 (`sact.contract.SalesContractDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`sact_salescontract_define` | domain：`sact` | 应用：`SACT` | 业务对象ID：``
