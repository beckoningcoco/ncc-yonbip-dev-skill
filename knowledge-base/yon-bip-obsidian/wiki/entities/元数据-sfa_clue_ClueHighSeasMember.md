---
tags: [BIP, 元数据, 数据字典, sfa.clue.ClueHighSeasMember]
created: 2026-06-03
updated: 2026-06-03
...
# 线索公海成员 (`sfa.clue.ClueHighSeasMember`)
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `member_name` | `member_name` | `memberName` | 线索池成员 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `member_id` | `member_id` | `memberId` | 管理员ID |
