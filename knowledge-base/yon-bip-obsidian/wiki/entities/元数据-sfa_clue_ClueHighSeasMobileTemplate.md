---
tags: [BIP, 元数据, 数据字典, sfa.clue.ClueHighSeasMobileTemplate]
created: 2026-06-03
updated: 2026-06-03
...
# 线索公海模板设置 (`sfa.clue.ClueHighSeasMobileTemplate`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`sfa_clue_high_seas_template` | domain：`yycrm` | 应用：`SFA` | 业务对象ID：``
...
|------|-----|
| 显示名 | 线索公海模板设置 |
| 物理表 | `sfa_clue_high_seas_template` |
| domain/服务域 | `yycrm` |
| schema | `crm` |
| 所属应用 | `SFA` |
| 直连字段 | 24 个 |
...
| `cShowCaption` | `cShowCaption` | `cShowCaption` | 展示名称 |
...
| `iTemplateType` | `iTemplateType` | `iTemplateType` | 模板类型(0:pc端,1:移动端),默认为0 |
