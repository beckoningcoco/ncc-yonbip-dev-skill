---
tags: [BIP, 元数据, 数据字典, sfa.competeopponent.CompeteOpponentDef]
created: 2026-06-03
updated: 2026-06-03
...
# 竞争对手主表自定义项扩展 (`sfa.competeopponent.CompeteOpponentDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`sfa_opponent_def` | domain：`yycrm` | 应用：`SFA` | 业务对象ID：``
