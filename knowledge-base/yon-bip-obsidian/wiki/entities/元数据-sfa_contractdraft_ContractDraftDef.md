---
tags: [BIP, 元数据, 数据字典, sfa.contractdraft.ContractDraftDef]
created: 2026-06-03
updated: 2026-06-03
...
# 合同草案主表自定义项扩展 (`sfa.contractdraft.ContractDraftDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`sfa_contract_draft_def` | domain：`yycrm` | 应用：`SFA` | 业务对象ID：``
