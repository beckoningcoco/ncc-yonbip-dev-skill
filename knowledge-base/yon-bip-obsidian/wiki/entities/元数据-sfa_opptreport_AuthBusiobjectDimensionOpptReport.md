---
tags: [BIP, 元数据, 数据字典, sfa.opptreport.AuthBusiobjectDimensionOpptReport]
created: 2026-06-03
updated: 2026-06-03
...
# 相关管理维度-商机报备关联数据表 (`sfa.opptreport.AuthBusiobjectDimensionOpptReport`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`crmc_auth_busiobject_dimension_opptreport` | domain：`yycrm` | 应用：`SFA` | 业务对象ID：``

## 基本信息

| 属性 | 值 |
|------|-----|
| 显示名 | 相关管理维度-商机报备关联数据表 |
| 物理表 | `crmc_auth_busiobject_dimension_opptreport` |
| 数据库 schema | `yycrm` |
| 所属应用 | `SFA` |
| 直连字段 | 31 个 |
| 子表 | 0 个 |
