---
tags: [BIP, 元数据, 数据字典, sfa.opptreport.OpptReportItemDef]
created: 2026-06-03
updated: 2026-06-03
...
# 商机报备子表自定义项扩展 (`sfa.opptreport.OpptReportItemDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`sfa_opptreport_item_def` | domain：`yycrm` | 应用：`SFA` | 业务对象ID：``
