---
tags: [BIP, 元数据, 数据字典, sfa.tender.TenderReviewDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 投标复盘 (`sfa.tender.TenderReviewDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`sfa_tender_review_define` | domain：`yycrm` | 应用：`SFA` | 业务对象ID：``
