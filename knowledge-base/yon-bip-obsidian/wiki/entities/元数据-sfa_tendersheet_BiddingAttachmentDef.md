---
tags: [BIP, 元数据, 数据字典, sfa.tendersheet.BiddingAttachmentDef]
created: 2026-06-03
updated: 2026-06-03
...
# 招标附件自定义项扩展 (`sfa.tendersheet.BiddingAttachmentDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`sfa_bidding_attachment_def` | domain：`yycrm` | 应用：`SFA` | 业务对象ID：``
...
|------|-----|
| 显示名 | 招标附件自定义项扩展 |
| 物理表 | `sfa_bidding_attachment_def` |
| domain/服务域 | `yycrm` |
| schema | `crm` |
| 所属应用 | `SFA` |
| 直连字段 | 72 个 |
