---
tags: [BIP, 元数据, 数据字典, sfa.tendersheet.TenderSheetDef]
created: 2026-06-03
updated: 2026-06-03
...
# 投标单主表自定义项扩展 (`sfa.tendersheet.TenderSheetDef`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`sfa_tender_sheet_def` | domain：`yycrm` | 应用：`SFA` | 业务对象ID：``
