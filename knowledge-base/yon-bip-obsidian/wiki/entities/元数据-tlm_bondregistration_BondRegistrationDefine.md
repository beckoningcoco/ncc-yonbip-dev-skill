---
tags: [BIP, 元数据, 数据字典, tlm.bondregistration.BondRegistrationDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 自由自定义项 (`tlm.bondregistration.BondRegistrationDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_bondregistration_define` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 自由自定义项 |
| 物理表 | `tlm_bondregistration_define` |
