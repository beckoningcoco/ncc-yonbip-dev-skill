---
tags: [BIP, 元数据, 数据字典, tlm.derivativesregister.DerivativesRegisterInquiry]
created: 2026-06-03
updated: 2026-06-03
...
# 衍生品合约询价信息子表 (`tlm.derivativesregister.DerivativesRegisterInquiry`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_derivativesregister_inquiry` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 衍生品合约询价信息子表 |
| 物理表 | `tlm_derivativesregister_inquiry` |
...
| `quotation_agency` | `quotation_agency` | `quotationAgency` | 报价机构 |
