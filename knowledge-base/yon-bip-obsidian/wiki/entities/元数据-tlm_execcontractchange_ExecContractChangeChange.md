---
tags: [BIP, 元数据, 数据字典, tlm.execcontractchange.ExecContractChangeChange]
created: 2026-06-03
updated: 2026-06-03
...
# 融入变更记录表 (`tlm.execcontractchange.ExecContractChangeChange`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_execcontchange_change` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
