---
tags: [BIP, 元数据, 数据字典, tlm.execcontractchange.ExecContractChangeDebt]
created: 2026-06-03
updated: 2026-06-03
...
# 融入变更关联借据 (`tlm.execcontractchange.ExecContractChangeDebt`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_execcontchange_debt` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `financein_debt_character_def` | `financein_debt_character_def` | `financeInDebtCharacterDef` | 融入变更关联借据特征 |
