---
tags: [BIP, 元数据, 数据字典, tlm.execcontractchange.ExecContractChangeInvestors]
created: 2026-06-03
updated: 2026-06-03
...
# 投资人子表 (`tlm.execcontractchange.ExecContractChangeInvestors`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_execcontchange_investors` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 投资人子表 |
| 物理表 | `tlm_execcontchange_investors` |
