---
tags: [BIP, 元数据, 数据字典, tlm.execcontractchange.ExecContractChangecheckFlow]
created: 2026-06-03
updated: 2026-06-03
...
# 融入核算流 (`tlm.execcontractchange.ExecContractChangecheckFlow`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_execcontchange_checkFlow` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 融入核算流 |
| 物理表 | `tlm_execcontchange_checkFlow` |
