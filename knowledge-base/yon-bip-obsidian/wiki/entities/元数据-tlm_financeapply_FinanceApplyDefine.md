---
tags: [BIP, 元数据, 数据字典, tlm.financeapply.FinanceApplyDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 融入申请自由自定义项 (`tlm.financeapply.FinanceApplyDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_FinanceApply_define` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
