---
tags: [BIP, 元数据, 数据字典, tlm.financein.FinanceInDebtLock]
created: 2026-06-03
updated: 2026-06-03
...
# 融入登记余额锁定记录 (`tlm.financein.FinanceInDebtLock`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_financein_debtlock` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
