---
tags: [BIP, 元数据, 数据字典, tlm.financein.FinanceInLease]
created: 2026-06-03
updated: 2026-06-03
...
# 融入登记租赁物 (`tlm.financein.FinanceInLease`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_financein_lease` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
