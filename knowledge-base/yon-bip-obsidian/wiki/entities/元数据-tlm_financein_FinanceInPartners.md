---
tags: [BIP, 元数据, 数据字典, tlm.financein.FinanceInPartners]
created: 2026-06-03
updated: 2026-06-03
...
# 合作机构子表 (`tlm.financein.FinanceInPartners`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_financein_partners` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|--------|---------|
| `` | `` |
| `partnersrid` | `yonbip-fi-ctmtmsp.tmsp_fundbusinobj_Ref` |
| `partnerstype` | `yonbip-fi-ctmtmsp.tmsp_fundbusinobject_typeRef` |
| `ytenant_id` | `` |
| `mainid` | `` |
...
| `partnerstype` | `partnerstype` | `partnerstype` | 合作机构类型ID |
| `partnersrid` | `partnersrid` | `partnersrid` | 合作机构id |
