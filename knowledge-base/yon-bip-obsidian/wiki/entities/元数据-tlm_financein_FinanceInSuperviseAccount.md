---
tags: [BIP, 元数据, 数据字典, tlm.financein.FinanceInSuperviseAccount]
created: 2026-06-03
updated: 2026-06-03
...
# 承销商子表 (`tlm.financein.FinanceInSuperviseAccount`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_financein_supervise_account` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 承销商子表 |
| 物理表 | `tlm_financein_supervise_account` |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `free_characters_id` | `free_characters_id` | `superviseAccountFreeCharacteristics` | 承销商特征 |
