---
tags: [BIP, 元数据, 数据字典, tlm.financein.FinanceInTransactionFlow]
created: 2026-06-03
updated: 2026-06-03
...
# 交易进度表 (`tlm.financein.FinanceInTransactionFlow`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_financeIn_transaction_flow` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 交易进度表 |
| 物理表 | `tlm_financeIn_transaction_flow` |
