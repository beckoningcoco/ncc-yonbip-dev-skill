---
tags: [BIP, 元数据, 数据字典, tlm.financein.FinanceIn_cashflow_interest]
created: 2026-06-03
updated: 2026-06-03
...
# 融入现金流利息分段 (`tlm.financein.FinanceIn_cashflow_interest`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_financein_cashflow_interest` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 融入现金流利息分段 |
| 物理表 | `tlm_financein_cashflow_interest` |
...
| `` | `` |
| `ytenant_id` | `` |
| `mainid` | `tlm_financein_cashflowRef` |
| `tenant_id` | `` |
