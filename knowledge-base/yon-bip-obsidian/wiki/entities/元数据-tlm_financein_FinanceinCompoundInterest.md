---
tags: [BIP, 元数据, 数据字典, tlm.financein.FinanceinCompoundInterest]
created: 2026-06-03
updated: 2026-06-03
...
# 融入登记复利浮动记录 (`tlm.financein.FinanceinCompoundInterest`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_financein_compound_interest` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 融入登记复利浮动记录 |
| 物理表 | `tlm_financein_compound_interest` |
