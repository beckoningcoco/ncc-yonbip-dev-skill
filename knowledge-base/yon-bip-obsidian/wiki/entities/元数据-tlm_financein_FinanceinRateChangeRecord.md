---
tags: [BIP, 元数据, 数据字典, tlm.financein.FinanceinRateChangeRecord]
created: 2026-06-03
updated: 2026-06-03
...
# 借据利率变更记录 (`tlm.financein.FinanceinRateChangeRecord`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_financein_rate_change_record` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 借据利率变更记录 |
| 物理表 | `tlm_financein_rate_change_record` |
