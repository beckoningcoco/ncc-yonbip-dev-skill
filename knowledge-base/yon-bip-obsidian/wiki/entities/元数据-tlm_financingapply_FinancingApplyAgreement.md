---
tags: [BIP, 元数据, 数据字典, tlm.financingapply.FinancingApplyAgreement]
created: 2026-06-03
updated: 2026-06-03
...
# 融资申请关联授信 (`tlm.financingapply.FinancingApplyAgreement`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_financingapply_agreement` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 融资申请关联授信 |
| 物理表 | `tlm_financingapply_agreement` |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `agreement_define_character` | `agreement_define_character` | `financingApplyAgreementCharacterDef` | 关联授信子表特征 |
