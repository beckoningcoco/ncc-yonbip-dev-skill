---
tags: [BIP, 元数据, 数据字典, tlm.financingapply.FinancingApplyContract]
created: 2026-06-03
updated: 2026-06-03
...
# 融资申请关联担保 (`tlm.financingapply.FinancingApplyContract`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_financingapply_contract` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 融资申请关联担保 |
| 物理表 | `tlm_financingapply_contract` |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `contract_define_character` | `contract_define_character` | `financingApplyContractCharacterDef` | 关联担保子表特征 |
