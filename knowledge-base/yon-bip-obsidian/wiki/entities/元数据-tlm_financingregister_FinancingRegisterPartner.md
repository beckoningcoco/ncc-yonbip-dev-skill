---
tags: [BIP, 元数据, 数据字典, tlm.financingregister.FinancingRegisterPartner]
created: 2026-06-03
updated: 2026-06-03
...
# 金融合同合作机构子表 (`tlm.financingregister.FinancingRegisterPartner`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_financingregister_partner` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 金融合同合作机构子表 |
| 物理表 | `tlm_financingregister_partner` |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `partner_define_character` | `partner_define_character` | `financingRegisterPartnerCharacterDef` | 合作机构子表特征 |
