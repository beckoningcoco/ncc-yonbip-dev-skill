---
tags: [BIP, 元数据, 数据字典, tlm.financingregister.FinancingRegisterReduction]
created: 2026-06-03
updated: 2026-06-03
...
# 金融合同减免信息子表 (`tlm.financingregister.FinancingRegisterReduction`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_financingregister_reduction` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 金融合同减免信息子表 |
| 物理表 | `tlm_financingregister_reduction` |
...
| `purchase_id` | `purchase_id` | `purchaseId` | 申购登记id |
...
| `reduce_interest` | `reduce_interest` | `reduceInterest` | 减免利息(计息币种) |
| `reduce_principal_capital` | `reduce_principal_capital` | `reducePrincipalCapital` | 减免本金(本金币种) |
