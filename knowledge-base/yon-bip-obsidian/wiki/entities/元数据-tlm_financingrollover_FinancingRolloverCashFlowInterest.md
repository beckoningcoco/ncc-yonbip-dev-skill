---
tags: [BIP, 元数据, 数据字典, tlm.financingrollover.FinancingRolloverCashFlowInterest]
created: 2026-06-03
updated: 2026-06-03
...
# 融入展期现金流利息分段 (`tlm.financingrollover.FinancingRolloverCashFlowInterest`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_financingrollover_cashflow_interest` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 融入展期现金流利息分段 |
| 物理表 | `tlm_financingrollover_cashflow_interest` |
