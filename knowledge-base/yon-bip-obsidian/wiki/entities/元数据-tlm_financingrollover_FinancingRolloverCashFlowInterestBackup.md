---
tags: [BIP, 元数据, 数据字典, tlm.financingrollover.FinancingRolloverCashFlowInterestBackup]
created: 2026-06-03
updated: 2026-06-03
...
# 融入展期现金流利息分段历史备份表 (`tlm.financingrollover.FinancingRolloverCashFlowInterestBackup`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_financingrollover_cashflow_interest_backup` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``

## 基本信息

| 属性 | 值 |
|------|-----|
| 显示名 | 融入展期现金流利息分段历史备份表 |
| 物理表 | `tlm_financingrollover_cashflow_interest_backup` |
...
| `mainid` | `mainid` | `mainid` | 融入展期现金流id |
