---
tags: [BIP, 元数据, 数据字典, tlm.financingrollover.FinancingRolloverCustomRate]
created: 2026-06-03
updated: 2026-06-03
...
# 自定义利率 (`tlm.financingrollover.FinancingRolloverCustomRate`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_financingrollover_custom_rate` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 自定义利率 |
| 物理表 | `tlm_financingrollover_custom_rate` |
