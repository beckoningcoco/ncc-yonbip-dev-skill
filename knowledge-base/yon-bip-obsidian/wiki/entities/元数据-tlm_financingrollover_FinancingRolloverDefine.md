---
tags: [BIP, 元数据, 数据字典, tlm.financingrollover.FinancingRolloverDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 融入展期自定义项 (`tlm.financingrollover.FinancingRolloverDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_financingrollover_define` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 融入展期自定义项 |
| 物理表 | `tlm_financingrollover_define` |
