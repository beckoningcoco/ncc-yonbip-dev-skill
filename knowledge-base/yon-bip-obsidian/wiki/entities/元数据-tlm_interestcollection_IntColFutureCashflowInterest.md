---
tags: [BIP, 元数据, 数据字典, tlm.interestcollection.IntColFutureCashflowInterest]
created: 2026-06-03
updated: 2026-06-03
...
# 收息未来现金流利息分段 (`tlm.interestcollection.IntColFutureCashflowInterest`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_intcol_futcashflow_interest` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 收息未来现金流利息分段 |
| 物理表 | `tlm_intcol_futcashflow_interest` |
...
| `mainid` | `mainid` | `mainid` | 收息未来现金流id |
