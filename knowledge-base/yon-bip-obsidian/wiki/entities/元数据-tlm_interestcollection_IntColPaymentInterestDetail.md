---
tags: [BIP, 元数据, 数据字典, tlm.interestcollection.IntColPaymentInterestDetail]
created: 2026-06-03
updated: 2026-06-03
...
# 收款明细利息分段 (`tlm.interestcollection.IntColPaymentInterestDetail`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_intcol_payment_interest_detail` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 收款明细利息分段 |
| 物理表 | `tlm_intcol_payment_interest_detail` |
...
| `mainid` | `mainid` | `mainid` | 收款明细现金流id |
