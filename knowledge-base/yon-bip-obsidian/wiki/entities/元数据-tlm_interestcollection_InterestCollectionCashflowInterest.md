---
tags: [BIP, 元数据, 数据字典, tlm.interestcollection.InterestCollectionCashflowInterest]
created: 2026-06-03
updated: 2026-06-03
...
# 收息现金流利息分段 (`tlm.interestcollection.InterestCollectionCashflowInterest`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_interestcollection_cashflow_interest` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 收息现金流利息分段 |
| 物理表 | `tlm_interestcollection_cashflow_interest` |
