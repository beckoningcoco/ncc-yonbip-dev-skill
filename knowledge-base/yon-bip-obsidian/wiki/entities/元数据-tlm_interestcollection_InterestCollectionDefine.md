---
tags: [BIP, 元数据, 数据字典, tlm.interestcollection.InterestCollectionDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 收息自定义项 (`tlm.interestcollection.InterestCollectionDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_interestcollection_define` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 收息自定义项 |
| 物理表 | `tlm_interestcollection_define` |
