---
tags: [BIP, 元数据, 数据字典, tlm.interestcollection.InterestCollectionTax]
created: 2026-06-03
updated: 2026-06-03
...
# 收息代扣代缴税费子表 (`tlm.interestcollection.InterestCollectionTax`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_interestcollection_tax` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 收息代扣代缴税费子表 |
| 物理表 | `tlm_interestcollection_tax` |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `tlm_define_character_def` | `tlm_define_character_def` | `tlmDefineCharacterDef` | 收息代扣代缴税费自定义项 |
