---
tags: [BIP, 元数据, 数据字典, tlm.investaccrual.InvestAccrualDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 投资预提自定义项 (`tlm.investaccrual.InvestAccrualDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_investaccrual_define` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
