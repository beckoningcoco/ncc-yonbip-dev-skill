---
tags: [BIP, 元数据, 数据字典, tlm.investmentapply.InvestmentApplyDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 投资申请自由自定义项 (`tlm.investmentapply.InvestmentApplyDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_investmentapply_define` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 投资申请自由自定义项 |
| 物理表 | `tlm_investmentapply_define` |
