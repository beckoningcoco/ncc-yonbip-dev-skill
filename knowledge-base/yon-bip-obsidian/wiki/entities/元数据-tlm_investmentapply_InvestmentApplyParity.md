---
tags: [BIP, 元数据, 数据字典, tlm.investmentapply.InvestmentApplyParity]
created: 2026-06-03
updated: 2026-06-03
...
# 比价信息子表 (`tlm.investmentapply.InvestmentApplyParity`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_investmentapply_parity` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 比价信息子表 |
| 物理表 | `tlm_investmentapply_parity` |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `parity_define_character` | `parity_define_character` | `investmentapplyParityCharacterDef` | 比价信息子表特征 |
