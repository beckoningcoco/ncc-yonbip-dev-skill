---
tags: [BIP, 元数据, 数据字典, tlm.investmentextension.InvestmentExtensionCashFlow]
created: 2026-06-03
updated: 2026-06-03
...
# 申购展期关联现金流 (`tlm.investmentextension.InvestmentExtensionCashFlow`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_investmentextension_cashflow` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：`143b506c-2d51-402e-b804-29e391460820`
...
|------|-----|
| 显示名 | 申购展期关联现金流 |
| 物理表 | `tlm_investmentextension_cashflow` |
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `extensionCashFlowInterest` | `tlm.investmentextension.InvestmentExtensionCashFlowInterest` | composition |
...
| `is_from_debt` | `is_from_debt` | `isFromDebt` | 是否来自申购单 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `` | `` | `extensionCashFlowInterest` | 现金流利息 |
