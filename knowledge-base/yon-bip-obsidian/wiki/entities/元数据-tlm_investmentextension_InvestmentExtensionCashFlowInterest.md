---
tags: [BIP, 元数据, 数据字典, tlm.investmentextension.InvestmentExtensionCashFlowInterest]
created: 2026-06-03
updated: 2026-06-03
...
# 现金流利息 (`tlm.investmentextension.InvestmentExtensionCashFlowInterest`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_investment_cashflow_interest` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 现金流利息 |
| 物理表 | `tlm_investment_cashflow_interest` |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `mainid` | `mainid` | `mainid` | 申购展期现金流ID |
