---
tags: [BIP, 元数据, 数据字典, tlm.investmentextension.InvestmentExtensionCashFlowInterestBackup]
created: 2026-06-03
updated: 2026-06-03
...
# 现金流利息备份 (`tlm.investmentextension.InvestmentExtensionCashFlowInterestBackup`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_investment_cashflow_interest_backup` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 现金流利息备份 |
| 物理表 | `tlm_investment_cashflow_interest_backup` |
