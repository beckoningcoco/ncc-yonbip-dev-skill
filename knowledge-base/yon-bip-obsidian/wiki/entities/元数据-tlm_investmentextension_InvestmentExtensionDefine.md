---
tags: [BIP, 元数据, 数据字典, tlm.investmentextension.InvestmentExtensionDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 申购展期自定义项 (`tlm.investmentextension.InvestmentExtensionDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_investmentextension_define` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 申购展期自定义项 |
| 物理表 | `tlm_investmentextension_define` |
