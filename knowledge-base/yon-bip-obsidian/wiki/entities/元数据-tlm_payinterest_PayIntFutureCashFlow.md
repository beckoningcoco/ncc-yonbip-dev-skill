---
tags: [BIP, 元数据, 数据字典, tlm.payinterest.PayIntFutureCashFlow]
created: 2026-06-03
updated: 2026-06-03
...
# 付息未来现金流子表 (`tlm.payinterest.PayIntFutureCashFlow`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_payint_futcashflow` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `payIntFutureCashflowInterest` | `tlm.payinterest.PayIntFutureCashflowInterest` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `` | `` | `payIntFutureCashflowInterest` | 付息未来现金流利息分段 |
