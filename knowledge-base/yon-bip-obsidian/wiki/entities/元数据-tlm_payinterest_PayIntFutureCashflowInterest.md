---
tags: [BIP, 元数据, 数据字典, tlm.payinterest.PayIntFutureCashflowInterest]
created: 2026-06-03
updated: 2026-06-03
...
# 付息未来现金流利息分段 (`tlm.payinterest.PayIntFutureCashflowInterest`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_payint_futcashflow_interest` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 付息未来现金流利息分段 |
| 物理表 | `tlm_payint_futcashflow_interest` |
...
| `mainid` | `mainid` | `mainid` | 付息未来现金流id |
