---
tags: [BIP, 元数据, 数据字典, tlm.payinterest.PayIntPaymentInterestDetail]
created: 2026-06-03
updated: 2026-06-03
...
# 付款明细利息分段 (`tlm.payinterest.PayIntPaymentInterestDetail`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_payint_payment_interest_detail` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 付款明细利息分段 |
| 物理表 | `tlm_payint_payment_interest_detail` |
...
| `mainid` | `mainid` | `mainid` | 付款明细现金流id |
