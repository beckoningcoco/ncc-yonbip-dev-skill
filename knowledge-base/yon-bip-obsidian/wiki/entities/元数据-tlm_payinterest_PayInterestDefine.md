---
tags: [BIP, 元数据, 数据字典, tlm.payinterest.PayInterestDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 付息自定义项 (`tlm.payinterest.PayInterestDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_payinterest_define` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
