---
tags: [BIP, 元数据, 数据字典, tlm.payinterest.PayInterestFinanceInCashFlow]
created: 2026-06-03
updated: 2026-06-03
...
# 付息单据勾选融入现金流子表 (`tlm.payinterest.PayInterestFinanceInCashFlow`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_payinterest_financein_cashflow` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 付息单据勾选融入现金流子表 |
| 物理表 | `tlm_payinterest_financein_cashflow` |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `cash_flow` | `cash_flow` | `payInterestAmountRef` | 付息现金流ID |
