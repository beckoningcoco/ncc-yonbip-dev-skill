---
tags: [BIP, 元数据, 数据字典, tlm.purchaseapply.PurchaseApplyDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 申购申请自由自定义项 (`tlm.purchaseapply.PurchaseApplyDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_purchaseapply_define` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
