---
tags: [BIP, 元数据, 数据字典, tlm.purchaseregister.PurchaseRegisterAccrualPlan]
created: 2026-06-03
updated: 2026-06-03
...
# 预提利息计划 (`tlm.purchaseregister.PurchaseRegisterAccrualPlan`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_purchaseregister_accrual_plan` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 预提利息计划 |
| 物理表 | `tlm_purchaseregister_accrual_plan` |
