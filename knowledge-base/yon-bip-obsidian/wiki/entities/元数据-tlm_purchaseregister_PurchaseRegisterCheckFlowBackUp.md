---
tags: [BIP, 元数据, 数据字典, tlm.purchaseregister.PurchaseRegisterCheckFlowBackUp]
created: 2026-06-03
updated: 2026-06-03
...
# 申购登记核算流备份 (`tlm.purchaseregister.PurchaseRegisterCheckFlowBackUp`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_purchaseregister_check_flowBackUp` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
