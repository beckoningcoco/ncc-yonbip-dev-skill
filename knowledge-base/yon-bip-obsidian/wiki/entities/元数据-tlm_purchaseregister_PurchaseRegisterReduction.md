---
tags: [BIP, 元数据, 数据字典, tlm.purchaseregister.PurchaseRegisterReduction]
created: 2026-06-03
updated: 2026-06-03
...
# 申购登记减免信息子表 (`tlm.purchaseregister.PurchaseRegisterReduction`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_purchasregister_reduction` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 申购登记减免信息子表 |
| 物理表 | `tlm_purchasregister_reduction` |
