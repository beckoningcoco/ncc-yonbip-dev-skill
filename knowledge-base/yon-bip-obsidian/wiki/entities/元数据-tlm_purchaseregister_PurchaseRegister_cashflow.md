---
tags: [BIP, 元数据, 数据字典, tlm.purchaseregister.PurchaseRegister_cashflow]
created: 2026-06-03
updated: 2026-06-03
...
# 申购登记现金流 (`tlm.purchaseregister.PurchaseRegister_cashflow`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_purchasregister_cashflow` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：`6a55c1d2-e502-47d4-9165-d311ebf39cc6`
...
|------|-----|
| 显示名 | 申购登记现金流 |
| 物理表 | `tlm_purchasregister_cashflow` |
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `purchaseRegister_cashflow_interest` | `tlm.purchaseregister.PurchaseRegister_cashflow_interest` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `` | `` | `purchaseRegister_cashflow_interest` | 申购现金流利息分段 |
