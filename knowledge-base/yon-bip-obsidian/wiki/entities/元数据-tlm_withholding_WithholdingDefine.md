---
tags: [BIP, 元数据, 数据字典, tlm.withholding.WithholdingDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 预提自定义项 (`tlm.withholding.WithholdingDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tlm_withholding_define` | domain：`yonbip-fi-ctmtlm` | 应用：`TLM` | 业务对象ID：``
