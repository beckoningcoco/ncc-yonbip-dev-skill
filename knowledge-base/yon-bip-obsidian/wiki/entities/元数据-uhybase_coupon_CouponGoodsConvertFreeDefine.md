---
tags: [BIP, 元数据, 数据字典, uhybase.coupon.CouponGoodsConvertFreeDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 优惠券自由自定义项 (`uhybase.coupon.CouponGoodsConvertFreeDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`mp_coupongoodsconvertrulefreedefine` | domain：`uhy` | 应用：`SDMB` | 业务对象ID：``
...
|------|-----|
| 显示名 | 优惠券自由自定义项 |
| 物理表 | `mp_coupongoodsconvertrulefreedefine` |
| domain/服务域 | `uhy` |
| schema | `yilian` |
| 所属应用 | `SDMB` |
| 直连字段 | 64 个 |
