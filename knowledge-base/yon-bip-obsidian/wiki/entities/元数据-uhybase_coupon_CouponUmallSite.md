---
tags: [BIP, 元数据, 数据字典, uhybase.coupon.CouponUmallSite]
created: 2026-06-03
updated: 2026-06-03
...
# 卡券适用站点关系表 (`uhybase.coupon.CouponUmallSite`)
...
| 3 | `cStoreCode` | cStore编码 | `cStoreCode` | String | `text` |
| 4 | `cAppID` | cAppID | `cAppID` | String | `text` |
| 5 | `cOuterStoreCode` | cOuterStore编码 | `cOuterStoreCode` | String | `text` |
| 6 | `cStoreName` | cStore名称 | `cStoreName` | String | `text` |
| 7 | `iDocID` | iDocID | `iDocID` | 01269572-184b-47c7-ad59-d4125d0f8cce | `quote` |
| 8 | `iScopeType` | iScopeType | `iScopeType` | Integer | `int` |
