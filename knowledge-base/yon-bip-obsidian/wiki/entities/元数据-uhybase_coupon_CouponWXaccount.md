---
tags: [BIP, 元数据, 数据字典, uhybase.coupon.CouponWXaccount]
created: 2026-06-03
updated: 2026-06-03
...
# 卡券公众号关系表 (`uhybase.coupon.CouponWXaccount`)

> **平台版本：BIP 旗舰版 V5** -- 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。
> 物理表: `mp_couponwxaccount` | 应用: `SDMB` | 类型: `Class`
...
| 2 | `cWXAccountID` | cWXAccountID | `cWXAccountID` | f6bd275a-b88b-4a21-82ff-2f8e3fa236bc | `quote` |
...
- `cWXAccountID` -> `uhybase.fan.WxAccount` ()
