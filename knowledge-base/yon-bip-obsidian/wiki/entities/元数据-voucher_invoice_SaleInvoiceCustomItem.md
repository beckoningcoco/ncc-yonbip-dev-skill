---
tags: [BIP, 元数据, 数据字典, voucher.invoice.SaleInvoiceCustomItem]
created: 2026-06-03
updated: 2026-06-03
...
# 销售发票表头自定义项 (`voucher.invoice.SaleInvoiceCustomItem`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`sa_saleinvoice_customitem` | domain：`udinghuo` | 应用：`SCMSA` | 业务对象ID：``
