---
tags: [BIP, 元数据, 数据字典, voucher.invoice.SaleInvoiceDetailCustomItem]
created: 2026-06-03
updated: 2026-06-03
...
# 销售发票表体自定义项 (`voucher.invoice.SaleInvoiceDetailCustomItem`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`sa_saleinvdetail_customitem` | domain：`udinghuo` | 应用：`SCMSA` | 业务对象ID：``
...
|------|-----|
| 显示名 | 销售发票表体自定义项 |
| 物理表 | `sa_saleinvdetail_customitem` |
| 数据库 schema | `udinghuo` |
| 所属应用 | `SCMSA` |
| 直连字段 | 63 个 |
| 子表 | 0 个 |
