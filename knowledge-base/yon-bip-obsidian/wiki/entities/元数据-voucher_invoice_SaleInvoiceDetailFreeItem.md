---
tags: [BIP, 元数据, 数据字典, voucher.invoice.SaleInvoiceDetailFreeItem]
created: 2026-06-03
updated: 2026-06-03
...
# 销售发票表体自由自定义项 (`voucher.invoice.SaleInvoiceDetailFreeItem`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`sa_saleinvdetail_freeitem` | domain：`udinghuo` | 应用：`SCMSA` | 业务对象ID：``
