---
tags: [BIP, 元数据, 数据字典, voucher.invoice.TaxCalculationResultDetail]
created: 2026-06-03
updated: 2026-06-03
...
# 计税结果明细 (`voucher.invoice.TaxCalculationResultDetail`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`tax_calc_result_b` | domain：`udinghuo` | 应用：`SCMSA` | 业务对象ID：``
