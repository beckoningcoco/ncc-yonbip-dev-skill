---
tags: [BIP, 元数据, 数据字典, voucher.rebate.AmountRebate]
created: 2026-06-03
updated: 2026-06-03
...
# 金额返利 (`voucher.rebate.AmountRebate`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`rebate` | domain：`marketingbill` | 应用：`BBSMK` | 业务对象ID：`7125be9a-eb72-461d-971d-280a64953177`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `rebateRecords` | `voucher.rebate.RebateRecord` | composition |
| `headItem` | `voucher.rebate.AmountRebateDefine` | composition |
| `rebateProducts` | `voucher.rebate.RebateProduct` | composition |
...
| `exchangeStatus` | `exchangeStatus` | `exchangeStatus` | 同步状态 |
