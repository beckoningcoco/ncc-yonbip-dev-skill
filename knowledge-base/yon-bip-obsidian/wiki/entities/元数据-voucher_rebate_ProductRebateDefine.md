---
tags: [BIP, 元数据, 数据字典, voucher.rebate.ProductRebateDefine]
created: 2026-06-03
updated: 2026-06-03
...
# 营销费用自由自定义项 (`voucher.rebate.ProductRebateDefine`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`bd_rebate_define` | domain：`marketingbill` | 应用：`BBSMK` | 业务对象ID：``
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `rebate_id` | `rebate_id` | `rebateId` | 营销费用id |
