---
tags: [BIP, 元数据, 数据字典, znbzbx.airline.AirlineVO]
created: 2026-06-03
updated: 2026-06-03
...
# 航空公司档案 (`znbzbx.airline.AirlineVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_airline` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：`0249b566-92ad-4e8b-abf7-27e0731f522b`
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `isverify` | `isverify` | `isverify` | 是否支持查验 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `iattribute` | `iattribute` | `iattribute` | 属性标识 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `name` | `name` | `name` | 航空公司名称 |
| `vshortame` | `vshortame` | `vshortame` | 航空公司简称 |
