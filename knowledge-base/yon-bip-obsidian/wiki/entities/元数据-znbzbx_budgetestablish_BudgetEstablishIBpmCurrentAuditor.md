---
tags: [BIP, 元数据, 数据字典, znbzbx.budgetestablish.BudgetEstablishIBpmCurrentAuditor]
created: 2026-06-03
updated: 2026-06-03
...
# 预算编制审批当前审批人 (`znbzbx.budgetestablish.BudgetEstablishIBpmCurrentAuditor`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_budgetestablish_ibpmcurrentauditor` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 预算编制审批当前审批人 |
| 物理表 | `znbz_budgetestablish_ibpmcurrentauditor` |
| domain/服务域 | `znbzbx` |
| schema | `znbz` |
| 所属应用 | `RBSM` |
| 直连字段 | 16 个 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `pk_budgetestablish` | `pk_budgetestablish` | `pk_budgetestablish` | 预算编制主表主键 |
