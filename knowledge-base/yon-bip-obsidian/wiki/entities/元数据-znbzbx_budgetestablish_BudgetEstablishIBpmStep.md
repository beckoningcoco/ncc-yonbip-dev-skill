---
tags: [BIP, 元数据, 数据字典, znbzbx.budgetestablish.BudgetEstablishIBpmStep]
created: 2026-06-03
updated: 2026-06-03
...
# 预算编制审批业务阶段 (`znbzbx.budgetestablish.BudgetEstablishIBpmStep`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_budgetestablish_ibpmstep` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 预算编制审批业务阶段 |
| 物理表 | `znbz_budgetestablish_ibpmstep` |
| 数据库 schema | `znbzbx` |
| 所属应用 | `RBSM` |
| 直连字段 | 11 个 |
| 子表 | 0 个 |
