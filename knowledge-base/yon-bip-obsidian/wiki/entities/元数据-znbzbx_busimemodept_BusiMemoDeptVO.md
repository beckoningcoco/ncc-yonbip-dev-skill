---
tags: [BIP, 元数据, 数据字典, znbzbx.busimemodept.BusiMemoDeptVO]
created: 2026-06-03
updated: 2026-06-03
...
# 业务事项-部门分配 (`znbzbx.busimemodept.BusiMemoDeptVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_busimemo_dept` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：`4fba2adb-1b66-4e80-836d-2db2b46c3ca9`
...
| 字段名 | 引用类型 |
|--------|---------|
| `vdeptid` | `ucf-org-center.bd_adminorgsharetreeref` |
| `cfinaceorg` | `ucf-org-center.org_pure_tree_ref` |
| `ytenant_id` | `` |
| `` | `` |
| `pk_busimemo` | `finbd.bd_expenseitemref` |
| `pk_busimemotype` | `finbd.bd_expenseitemref` |
| `tenant_id` | `` |
