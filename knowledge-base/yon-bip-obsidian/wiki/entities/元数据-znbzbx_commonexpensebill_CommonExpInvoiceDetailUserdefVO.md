---
tags: [BIP, 元数据, 数据字典, znbzbx.commonexpensebill.CommonExpInvoiceDetailUserdefVO]
created: 2026-06-03
updated: 2026-06-03
...
# 通用报销单发票明细（自定义项）表 (`znbzbx.commonexpensebill.CommonExpInvoiceDetailUserdefVO`)
