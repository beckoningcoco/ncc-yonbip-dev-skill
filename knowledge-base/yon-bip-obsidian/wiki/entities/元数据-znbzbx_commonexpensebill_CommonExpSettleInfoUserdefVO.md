---
tags: [BIP, 元数据, 数据字典, znbzbx.commonexpensebill.CommonExpSettleInfoUserdefVO]
created: 2026-06-03
updated: 2026-06-03
...
# 通用报销单结算信息（自定义项）表 (`znbzbx.commonexpensebill.CommonExpSettleInfoUserdefVO`)
