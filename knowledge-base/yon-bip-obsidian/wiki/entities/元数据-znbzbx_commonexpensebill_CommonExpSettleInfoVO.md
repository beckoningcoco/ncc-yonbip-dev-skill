---
tags: [BIP, 元数据, 数据字典, znbzbx.commonexpensebill.CommonExpSettleInfoVO]
created: 2026-06-03
updated: 2026-06-03
...
# 通用报销单结算信息 (`znbzbx.commonexpensebill.CommonExpSettleInfoVO`)
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `expsettleinfouserdefs` | `znbzbx.commonexpensebill.CommonExpSettleInfoUserdefVO` | composition |
...
| `vsettlecurrency` | `vsettlecurrency` | `vsettlecurrency` | 期望收款币种 |
...
| `nsettlepromptlymny` | `nsettlepromptlymny` | `nsettlepromptlymny` | 本次结算金额 |
| `napplypaymny` | `napplypaymny` | `napplypaymny` | 已申请付款金额 |
| `nnatsettlepromptlymny` | `nnatsettlepromptlymny` | `nnatsettlepromptlymny` | 本次结算金额-本币 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `expsettleinfoDcs` | `expsettleinfoDcs` | `expsettleinfoDcs` | 结算信息自定义项 |
...
| `` | `` | `expsettleinfouserdefs` | 通用报销单结算信息（自定义项）表 |
