---
tags: [BIP, 元数据, 数据字典, znbzbx.commonexpensebill.CommonExpenseBillIBpmCurrentAuditor]
created: 2026-06-03
updated: 2026-06-03
...
# 通用报销单审批当前审批人 (`znbzbx.commonexpensebill.CommonExpenseBillIBpmCurrentAuditor`)
...
| `pk_expensebill` | `pk_expensebill` | `pk_expensebill` | 通用报销单主表主键 |
