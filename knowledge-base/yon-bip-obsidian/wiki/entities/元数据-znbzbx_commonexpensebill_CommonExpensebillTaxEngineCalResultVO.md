---
tags: [BIP, 元数据, 数据字典, znbzbx.commonexpensebill.CommonExpensebillTaxEngineCalResultVO]
created: 2026-06-03
updated: 2026-06-03
...
# 报销单计税税单 (`znbzbx.commonexpensebill.CommonExpensebillTaxEngineCalResultVO`)
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `source_id` | `source_id` | `sourceId` | 通用报销单主表 |
