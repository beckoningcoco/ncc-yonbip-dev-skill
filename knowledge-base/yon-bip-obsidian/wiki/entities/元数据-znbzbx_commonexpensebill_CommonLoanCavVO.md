---
tags: [BIP, 元数据, 数据字典, znbzbx.commonexpensebill.CommonLoanCavVO]
created: 2026-06-03
updated: 2026-06-03
...
# 通用报销单借款核销 (`znbzbx.commonexpensebill.CommonLoanCavVO`)
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `loancavuserdefs` | `znbzbx.commonexpensebill.CommonLoanCavUserdefVO` | composition |
...
| `pk_loanbill` | `pk_loanbill` | `pk_loanbill` | 借款单/预付单id |
| `pk_loanbill_b` | `pk_loanbill_b` | `pk_loanbill_b` | 借款单/预付单子表id |
...
| `nloanmny` | `nloanmny` | `nloanmny` | 借款/预付额 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `loancavDcs` | `loancavDcs` | `loancavDcs` | 借款/预付核销自定义项 |
...
| `` | `` | `loancavuserdefs` | 通用报销单借款核销（自定义项）表 |
