---
tags: [BIP, 元数据, 数据字典, znbzbx.commonexpensebill.CommonWithholdingCavUserdefVO]
created: 2026-06-03
updated: 2026-06-03
...
# 通用报销单预提冲销（自定义项）表 (`znbzbx.commonexpensebill.CommonWithholdingCavUserdefVO`)
