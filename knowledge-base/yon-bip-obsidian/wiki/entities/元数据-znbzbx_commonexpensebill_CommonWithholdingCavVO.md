---
tags: [BIP, 元数据, 数据字典, znbzbx.commonexpensebill.CommonWithholdingCavVO]
created: 2026-06-03
updated: 2026-06-03
...
# 通用报销单预提冲销 (`znbzbx.commonexpensebill.CommonWithholdingCavVO`)
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `withholdingcavuserdefs` | `znbzbx.commonexpensebill.CommonWithholdingCavUserdefVO` | composition |
...
| `vwithholdingchandleorg` | `ucf-org-center.org_pure_tree_ref` |
| `tenant_id` | `` |
...
| `pk_manualwithholding` | `pk_manualwithholding` | `pk_manualwithholding` | 预提单id |
| `pk_manualwithholding_b` | `pk_manualwithholding_b` | `pk_manualwithholding_b` | 预提单子表id |
...
| `` | `` | `withholdingcavuserdefs` | 通用报销单预提冲销（自定义项）表 |
