---
tags: [BIP, 元数据, 数据字典, znbzbx.commonmemoapply.CommonMemoApplyBUserdefVO]
created: 2026-06-03
updated: 2026-06-03
...
# 通用申请单子表（自定义项）表 (`znbzbx.commonmemoapply.CommonMemoApplyBUserdefVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_memoapply_b_userdef` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
