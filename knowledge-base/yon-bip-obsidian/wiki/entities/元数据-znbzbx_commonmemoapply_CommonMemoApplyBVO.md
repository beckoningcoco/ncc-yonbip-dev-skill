---
tags: [BIP, 元数据, 数据字典, znbzbx.commonmemoapply.CommonMemoApplyBVO]
created: 2026-06-03
updated: 2026-06-03
...
# 通用申请单子表 (`znbzbx.commonmemoapply.CommonMemoApplyBVO`)
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `MemoApplyBUserdefVO` | `znbzbx.commonmemoapply.CommonMemoApplyBUserdefVO` | composition |
| `memoapplybfellows` | `znbzbx.commonmemoapply.CommonMemoApplyBFellowVO` | composition |
| `memoapplyblives` | `znbzbx.commonmemoapply.CommonMemoApplyBLiveVO` | composition |
...
| `` | `` | `MemoApplyBUserdefVO` | 通用申请单子表（自定义项）表 |
