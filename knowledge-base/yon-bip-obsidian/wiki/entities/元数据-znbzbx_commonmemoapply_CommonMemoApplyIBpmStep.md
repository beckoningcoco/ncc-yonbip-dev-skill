---
tags: [BIP, 元数据, 数据字典, znbzbx.commonmemoapply.CommonMemoApplyIBpmStep]
created: 2026-06-03
updated: 2026-06-03
...
# 通用申请单审批业务阶段 (`znbzbx.commonmemoapply.CommonMemoApplyIBpmStep`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_memoapply_ibpmstep` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `pk_memoapply` | `pk_memoapply` | `pk_memoapply` | 通用申请单主表主键 |
