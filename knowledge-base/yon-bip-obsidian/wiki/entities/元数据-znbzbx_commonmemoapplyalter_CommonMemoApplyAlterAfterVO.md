---
tags: [BIP, 元数据, 数据字典, znbzbx.commonmemoapplyalter.CommonMemoApplyAlterAfterVO]
created: 2026-06-03
updated: 2026-06-03
...
# 通用申请单子表变更后 (`znbzbx.commonmemoapplyalter.CommonMemoApplyAlterAfterVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_memoapplyalter_after` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `MemoApplyAlterAfterUserdefVO` | `znbzbx.commonmemoapplyalter.CommonMemoApplyAlterAfterUserdefVO` | composition |
| `memoapplybfellows` | `znbzbx.commonmemoapplyalter.CommonMemoApplyAlterAfterFellowVO` | composition |
| `memoapplyblives` | `znbzbx.commonmemoapplyalter.CommonMemoApplyAlterAfterLiveVO` | composition |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `memoapplyalterAfterDcs` | `memoapplyalterAfterDcs` | `memoapplyalterAfterDcs` | 明细变更后自定义项 |
...
| `` | `` | `MemoApplyAlterAfterUserdefVO` | 通用申请单子表变更后（自定义项）表 |
