---
tags: [BIP, 元数据, 数据字典, znbzbx.commonmemoapplyalter.CommonMemoApplyAlterBeforeVO]
created: 2026-06-03
updated: 2026-06-03
...
# 通用申请单子表变更前 (`znbzbx.commonmemoapplyalter.CommonMemoApplyAlterBeforeVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_memoapplyalter_before` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 通用申请单子表变更前 |
| 物理表 | `znbz_memoapplyalter_before` |
| domain/服务域 | `znbzbx` |
| schema | `znbz` |
| 所属应用 | `RBSM` |
| 直连字段 | 244 个 |
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `MemoApplyAlterBeforeUserdefVO` | `znbzbx.commonmemoapplyalter.CommonMemoApplyAlterBeforeUserdefVO` | composition |
| `memoapplybfellows` | `znbzbx.commonmemoapplyalter.CommonMemoApplyAlterBeforeFellowVO` | composition |
| `memoapplyblives` | `znbzbx.commonmemoapplyalter.CommonMemoApplyAlterBeforeLiveVO` | composition |
...
| `wbs` | `wbs` | `wbs` | WBS |
| `pk_projectapply_b` | `pk_projectapply_b` | `pk_projectapply_b` | 立项申请单子表主键 |
...
| `pk_memoapply_b` | `pk_memoapply_b` | `pk_memoapply_b` | 通用申请单子表id |
| `pk_memoapplyalter` | `pk_memoapplyalter` | `pk_memoapplyalter` | 通用申请变更单主表id |
...
| `nfinishmny` | `nfinishmny` | `nfinishmny` | 报销单已参照金额 |
| `nlineno` | `nlineno` | `nlineno` | 行号 |
| `nloanmny` | `nloanmny` | `nloanmny` | 借款单已参照金额 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `memoapplyalterBeforeDcs` | `memoapplyalterBeforeDcs` | `memoapplyalterBeforeDcs` | 明细变更前自定义项 |
...
| `` | `` | `MemoApplyAlterBeforeUserdefVO` | 通用申请单子表变更前(自定义项)表 |
| `` | `` | `memoapplybfellows` | 出差申请变更单明细同行人参照表 |
| `` | `` | `memoapplyblives` | 出差申请变更单明细同住人参照表 |
