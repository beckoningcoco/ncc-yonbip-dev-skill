---
tags: [BIP, 元数据, 数据字典, znbzbx.consumekind.ConsumeKindVO]
created: 2026-06-03
updated: 2026-06-03
...
# 消费类型 (`znbzbx.consumekind.ConsumeKindVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_consumekind` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：`3b4f3c5b-810d-42fa-b4b7-c8a84168a7ca`
...
| `vanalyvalue` | `vanalyvalue` | `vanalyvalue` | 验真匹配内容 |
...
| `customvanalyvalue` | `customvanalyvalue` | `customvanalyvalue` | 自定义验真匹配内容 |
...
| `prefabricated` | `prefabricated` | `prefabricated` | 是否预制 |

### 短整数 (2个)

| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `ipriority` | `ipriority` | `ipriority` | 优先级 |
| `matchtype` | `matchtype` | `matchtype` | 匹配类型 |
