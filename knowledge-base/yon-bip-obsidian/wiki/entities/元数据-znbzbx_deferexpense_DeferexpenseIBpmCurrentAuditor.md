---
tags: [BIP, 元数据, 数据字典, znbzbx.deferexpense.DeferexpenseIBpmCurrentAuditor]
created: 2026-06-03
updated: 2026-06-03
...
# 待摊费用单审批当前审批人 (`znbzbx.deferexpense.DeferexpenseIBpmCurrentAuditor`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_deferexpense_ibpmcurrentauditor` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 待摊费用单审批当前审批人 |
| 物理表 | `znbz_deferexpense_ibpmcurrentauditor` |
| 数据库 schema | `znbzbx` |
| 所属应用 | `RBSM` |
| 直连字段 | 9 个 |
| 子表 | 0 个 |
