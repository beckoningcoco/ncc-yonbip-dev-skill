---
tags: [BIP, 元数据, 数据字典, znbzbx.expapportionrule.ExpSettlementRuleCombVO]
created: 2026-06-03
updated: 2026-06-03
...
# 结算规则 (`znbzbx.expapportionrule.ExpSettlementRuleCombVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_expsettlementrule_comb` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `combappmethod` | `combappmethod` | `combappmethod` | 结算方式 |
| `combcode` | `combcode` | `combcode` | 规则编码 |
| `combdim` | `combdim` | `combdim` | 结算维度 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `combbustype` | `combbustype` | `combbustype` | 交易类型 |
