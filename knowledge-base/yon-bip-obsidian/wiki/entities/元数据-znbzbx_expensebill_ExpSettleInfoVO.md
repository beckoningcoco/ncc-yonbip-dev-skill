---
tags: [BIP, 元数据, 数据字典, znbzbx.expensebill.ExpSettleInfoVO]
created: 2026-06-03
updated: 2026-06-03
...
# 报销单结算信息 (`znbzbx.expensebill.ExpSettleInfoVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_expsettleinfo` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `expsettleinfouserdefs` | `znbzbx.expensebill.ExpSettleInfoUserdefVO` | composition |
...
| `pk_handlepsnbank` | `pk_handlepsnbank` | `pk_handlepsnbank` | 报销人银行账户id |
...
| `vsettlecurrency` | `vsettlecurrency` | `vsettlecurrency` | 期望收款币种id |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `isofficialcard` | `isofficialcard` | `isofficialcard` | 是否公务卡  |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `napplypaymny` | `napplypaymny` | `napplypaymny` | 已申请付款金额 |
...
| `nsettlebaseexchrate` | `nsettlebaseexchrate` | `nsettlebaseexchrate` | 企业汇率 |
| `nsettleexchrate` | `nsettleexchrate` | `nsettleexchrate` | 汇率 |
| `nsettlesummny` | `nsettlesummny` | `nsettlesummny` | 期望收款金额 |
| `nnatbaseexchrate` | `nnatbaseexchrate` | `nnatbaseexchrate` | 本币企业汇率 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `` | `` | `expsettleinfouserdefs` | 报销单结算信息（自定义项）表 |
