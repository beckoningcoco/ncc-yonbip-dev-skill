---
tags: [BIP, 元数据, 数据字典, znbzbx.expensebill.ExpSubsidyDetailVO]
created: 2026-06-03
updated: 2026-06-03
...
# 报销单补贴明细 (`znbzbx.expensebill.ExpSubsidyDetailVO`)
...
| `pk_expensebill` | `pk_expensebill` | `pk_expensebill` | 报销单pk |
