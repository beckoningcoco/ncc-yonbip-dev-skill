---
tags: [BIP, 元数据, 数据字典, znbzbx.expensebill.ExpensebillTaxEngineCalResultVO]
created: 2026-06-03
updated: 2026-06-03
...
# 报销单税单 (`znbzbx.expensebill.ExpensebillTaxEngineCalResultVO`)
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `calc_currency_id` | `calc_currency_id` | `calcCurrencyId` | 计算币种 |
