---
tags: [BIP, 元数据, 数据字典, znbzbx.intransexpwithholding.InTransExpWithHoldingBusiUserdefVO]
created: 2026-06-03
updated: 2026-06-03
...
# 业务数据（自定义项）表 (`znbzbx.intransexpwithholding.InTransExpWithHoldingBusiUserdefVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_intransexpwithholding_busi_userdef` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 业务数据（自定义项）表 |
| 物理表 | `znbz_intransexpwithholding_busi_userdef` |
| 数据库 schema | `znbzbx` |
| 所属应用 | `RBSM` |
| 直连字段 | 64 个 |
| 子表 | 0 个 |
