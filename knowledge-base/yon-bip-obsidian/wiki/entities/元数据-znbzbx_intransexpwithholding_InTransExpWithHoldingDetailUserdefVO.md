---
tags: [BIP, 元数据, 数据字典, znbzbx.intransexpwithholding.InTransExpWithHoldingDetailUserdefVO]
created: 2026-06-03
updated: 2026-06-03
...
# 预提详情（自定义项）表 (`znbzbx.intransexpwithholding.InTransExpWithHoldingDetailUserdefVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_intransexpwithholding_detail_userdef` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 预提详情（自定义项）表 |
| 物理表 | `znbz_intransexpwithholding_detail_userdef` |
| 数据库 schema | `znbzbx` |
| 所属应用 | `RBSM` |
| 直连字段 | 64 个 |
| 子表 | 0 个 |
