---
tags: [BIP, 元数据, 数据字典, znbzbx.loanbill.LoanBillBVO]
created: 2026-06-03
updated: 2026-06-03
...
# 借款/预付单表体 (`znbzbx.loanbill.LoanBillBVO`)
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `loanbillbuserdefs` | `znbzbx.loanbill.LoanBillBUserdefVO` | composition |
...
| `pk_loanbill` | `pk_loanbill` | `pk_loanbill` | 主表主键 |
...
| `chandlecostcenter` | `chandlecostcenter` | `chandlecostcenter` | 经办人成本中心id |
...
| `stoppedamountbody` | `stoppedamountbody` | `stoppedamountbody` | 累计结算止付金额 |
...
| `` | `` | `loanbillbuserdefs` | 借款/预付单子表（自定义项）表 |
