---
tags: [BIP, 元数据, 数据字典, znbzbx.loanbill.LoanBillIBpmCurrentAuditor]
created: 2026-06-03
updated: 2026-06-03
...
# 借款单审批当前审批人 (`znbzbx.loanbill.LoanBillIBpmCurrentAuditor`)
...
| `pk_loanbill` | `pk_loanbill` | `pk_loanbill` | 借款单主表主键 |
