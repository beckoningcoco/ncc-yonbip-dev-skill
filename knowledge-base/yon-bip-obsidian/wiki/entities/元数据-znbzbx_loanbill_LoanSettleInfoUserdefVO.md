---
tags: [BIP, 元数据, 数据字典, znbzbx.loanbill.LoanSettleInfoUserdefVO]
created: 2026-06-03
updated: 2026-06-03
...
# 借款/预付单结算信息（自定义项）表 (`znbzbx.loanbill.LoanSettleInfoUserdefVO`)
