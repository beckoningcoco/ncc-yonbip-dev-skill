---
tags: [BIP, 元数据, 数据字典, znbzbx.loanbill.LoanSettleInfoVO]
created: 2026-06-03
updated: 2026-06-03
...
# 借款/预付单结算信息 (`znbzbx.loanbill.LoanSettleInfoVO`)
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `loansettleinfouserdefs` | `znbzbx.loanbill.LoanSettleInfoUserdefVO` | composition |
...
| `vbankdocname` | `vbankdocname` | `vbankdocname` | 收款方开户行 |
| `vbanktypename` | `vbanktypename` | `vbanktypename` | 银行类别 |
...
| `vbankaccname_opp` | `vbankaccname_opp` | `vbankaccname_opp` | 付款方户名 |
| `vbankaccount_opp` | `vbankaccount_opp` | `vbankaccount_opp` | 付款方账号 |
| `vbankdocname_opp` | `vbankdocname_opp` | `vbankdocname_opp` | 付款方开户行 |
| `vbanktypename_opp` | `vbanktypename_opp` | `vbanktypename_opp` | 付款银行类别 |
...
| `pk_currency` | `pk_currency` | `pk_currency` | 账户币种id |
| `pk_balatype` | `pk_balatype` | `pk_balatype` | 结算方式id |
| `pk_handlepsnbank` | `pk_handlepsnbank` | `pk_handlepsnbank` | 经办人银行账户id |
| `pk_handlepsn` | `pk_handlepsn` | `pk_handlepsn` | 经办人id |
| `pk_cusdocbank` | `pk_cusdocbank` | `pk_cusdocbank` | 供应商银行账户id |
| `pk_cusdoc` | `pk_cusdoc` | `pk_cusdoc` | 供应商id |
| `pk_customerbank` | `pk_customerbank` | `pk_customerbank` | 客户银行账户id |
| `pk_customer` | `pk_customer` | `pk_customer` | 客户id |
| `centerpriseorg` | `centerpriseorg` | `centerpriseorg` | 资金组织id |
...
| `pk_banktype_opp` | `pk_banktype_opp` | `pk_banktype_opp` | 付款银行类别id |
| `currency_opp` | `currency_opp` | `pk_currency_opp` | 付款账户币种id |
| `pk_loanbill` | `pk_loanbill` | `pk_loanbill` | 主表id |
| `pk_enterprisecashacct` | `pk_enterprisecashacct` | `pk_enterprisecashacct` | 企业现金账户PK |
| `vcurrency` | `vcurrency` | `vcurrency` | 预付币种id |
| `vsettlecurrency` | `vsettlecurrency` | `vsettlecurrency` | 结算币种id |
...
| `dexpectpaydate` | `dexpectpaydate` | `dexpectpaydate` | 期望付款日期 |
...
| `nsettlebaseexchrate` | `nsettlebaseexchrate` | `nsettlebaseexchrate` | 基准汇率 |
| `nsettleexchrate` | `nsettleexchrate` | `nsettleexchrate` | 汇率 |
| `nsettlesummny` | `nsettlesummny` | `nsettlesummny` | 期望付款金额 |
| `nnatbaseexchrate` | `nnatbaseexchrate` | `nnatbaseexchrate` | 本币基准汇率 |
| `nnatexchrate` | `nnatexchrate` | `nnatexchrate` | 本币汇率 |
| `nnatsettlesummny` | `nnatsettlesummny` | `nnatsettlesummny` | 期望付款金额-本币 |
...
| `` | `` | `loansettleinfouserdefs` | 借款/预付单结算信息（自定义项）表 |
