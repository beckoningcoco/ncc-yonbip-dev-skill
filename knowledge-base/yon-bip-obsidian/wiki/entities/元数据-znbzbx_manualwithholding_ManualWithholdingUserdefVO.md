---
tags: [BIP, 元数据, 数据字典, znbzbx.manualwithholding.ManualWithholdingUserdefVO]
created: 2026-06-03
updated: 2026-06-03
...
# 手工预提单主表（自定义项）表 (`znbzbx.manualwithholding.ManualWithholdingUserdefVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_manualwithholding_userdef` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 手工预提单主表（自定义项）表 |
| 物理表 | `znbz_manualwithholding_userdef` |
| domain/服务域 | `znbzbx` |
| schema | `znbz` |
| 所属应用 | `RBSM` |
| 直连字段 | 64 个 |
