---
tags: [BIP, 元数据, 数据字典, znbzbx.paymentapply.PaymentApplyIBpmStep]
created: 2026-06-03
updated: 2026-06-03
...
# 付款申请单审批业务阶段 (`znbzbx.paymentapply.PaymentApplyIBpmStep`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_paymentapply_ibpmstep` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 付款申请单审批业务阶段 |
| 物理表 | `znbz_paymentapply_ibpmstep` |
| domain/服务域 | `znbzbx` |
| schema | `znbz` |
| 所属应用 | `RBSM` |
| 直连字段 | 11 个 |
