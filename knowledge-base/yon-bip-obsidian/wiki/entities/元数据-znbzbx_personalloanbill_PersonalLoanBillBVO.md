---
tags: [BIP, 元数据, 数据字典, znbzbx.personalloanbill.PersonalLoanBillBVO]
created: 2026-06-03
updated: 2026-06-03
...
# 个人借款单表体 (`znbzbx.personalloanbill.PersonalLoanBillBVO`)
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `loanbillbuserdefs` | `znbzbx.personalloanbill.PersonalLoanBillBUserdefVO` | composition |
...
| `pk_loanbill` | `pk_loanbill` | `pk_loanbill` | 借款单表头 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `loanBillBDcs` | `loanBillBDcs` | `loanBillBDcs` | 借款明细自定义项 |
...
| `` | `` | `loanbillbuserdefs` | 个人借款单子表（自定义项）表 |
