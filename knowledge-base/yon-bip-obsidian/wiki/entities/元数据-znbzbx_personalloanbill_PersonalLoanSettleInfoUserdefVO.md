---
tags: [BIP, 元数据, 数据字典, znbzbx.personalloanbill.PersonalLoanSettleInfoUserdefVO]
created: 2026-06-03
updated: 2026-06-03
...
# 个人借款单结算信息（自定义项）表 (`znbzbx.personalloanbill.PersonalLoanSettleInfoUserdefVO`)
