---
tags: [BIP, 元数据, 数据字典, znbzbx.personalreturnbill.PersonalRetSettleInfoVO]
created: 2026-06-03
updated: 2026-06-03
...
# 还款单结算信息 (`znbzbx.personalreturnbill.PersonalRetSettleInfoVO`)
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `RetSettleInfoUserdefVO` | `znbzbx.personalreturnbill.PersonalRetSettleInfoUserdefVO` | composition |
...
| `vbankaccount` | `vbankaccount` | `vbankaccount` | 付款方账号 |
...
| `pk_bankdoc` | `pk_bankdoc` | `pk_bankdoc` | 开户行 |
...
| `pk_handlepsnbank` | `pk_handlepsnbank` | `pk_handlepsnbank` | 还款人银行账户 |
...
| `vsettlecurrency` | `vsettlecurrency` | `vsettlecurrency` | 期望还款币种 |
...
| `nnatfinalsummny` | `nnatfinalsummny` | `nnatfinalsummny` | 实际结算金额-本币 |
| `nnatsettlesummny` | `nnatsettlesummny` | `nnatsettlesummny` | 期望还款金额-本币 |
...
| `nsettlesummny` | `nsettlesummny` | `nsettlesummny` | 期望还款金额 |
| `nsummny` | `nsummny` | `nsummny` | 本次还款额 |
...
| `` | `` | `RetSettleInfoUserdefVO` | 还款单结算信息（自定义项）表 |
