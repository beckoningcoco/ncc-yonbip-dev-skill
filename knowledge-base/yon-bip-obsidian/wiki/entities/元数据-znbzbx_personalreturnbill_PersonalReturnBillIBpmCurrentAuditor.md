---
tags: [BIP, 元数据, 数据字典, znbzbx.personalreturnbill.PersonalReturnBillIBpmCurrentAuditor]
created: 2026-06-03
updated: 2026-06-03
...
# 还款单审批当前审批人 (`znbzbx.personalreturnbill.PersonalReturnBillIBpmCurrentAuditor`)
