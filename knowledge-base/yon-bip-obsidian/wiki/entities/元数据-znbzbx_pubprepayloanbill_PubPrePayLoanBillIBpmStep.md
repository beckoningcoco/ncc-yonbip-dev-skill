---
tags: [BIP, 元数据, 数据字典, znbzbx.pubprepayloanbill.PubPrePayLoanBillIBpmStep]
created: 2026-06-03
updated: 2026-06-03
...
# 对公预付单审批业务阶段 (`znbzbx.pubprepayloanbill.PubPrePayLoanBillIBpmStep`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_loanbill_ibpmstep` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
