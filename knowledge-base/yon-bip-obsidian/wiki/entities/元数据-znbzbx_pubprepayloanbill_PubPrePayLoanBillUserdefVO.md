---
tags: [BIP, 元数据, 数据字典, znbzbx.pubprepayloanbill.PubPrePayLoanBillUserdefVO]
created: 2026-06-03
updated: 2026-06-03
...
# 对公预付单主表（自定义项）表 (`znbzbx.pubprepayloanbill.PubPrePayLoanBillUserdefVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_loanbill_userdef` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
