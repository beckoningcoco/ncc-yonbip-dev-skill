---
tags: [BIP, 元数据, 数据字典, znbzbx.pubprepayloanbill.PubPrePayLoanBillVO]
created: 2026-06-03
updated: 2026-06-03
...
# 对公预付单主表id (`znbzbx.pubprepayloanbill.PubPrePayLoanBillVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_loanbill` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：`00ac1742-3d69-4703-bfe5-c4128472f036`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `loanbilluserdefs` | `znbzbx.pubprepayloanbill.PubPrePayLoanBillUserdefVO` | composition |
| `loanBillibpmstep` | `znbzbx.pubprepayloanbill.PubPrePayLoanBillIBpmStep` | composition |
| `taxEngineCalResults` | `znbzbx.pubprepayloanbill.PubPrePayTaxEngineCalResultVO` | composition |
| `loanBillibpmcurrentauditor` | `znbzbx.pubprepayloanbill.PubPrePayLoanBillIBpmCurrentAuditor` | composition |
| `loanbillbvos` | `znbzbx.pubprepayloanbill.PubPrePayLoanBillBVO` | composition |
| `loansettleinfovos` | `znbzbx.pubprepayloanbill.PubPrePayLoanSettleInfoVO` | composition |
...
| `ibudgetexectype` | `ibudgetexectype` | `ibudgetexectype` | 预算占用类型 |
...
| `ibudgetctrltype` | `ibudgetctrltype` | `ibudgetctrltype` | 超控制提示类型 |
...
| `` | `` | `loanBillibpmcurrentauditor` | 对公预付单审批当前审批人 |
| `` | `` | `loanBillibpmstep` | 对公预付单审批业务阶段 |
| `` | `` | `loanbillbvos` | 对公预付单表体 |
| `` | `` | `loanbilluserdefs` | 对公预付单主表（自定义项）表 |
| `` | `` | `loansettleinfovos` | 对公预付单结算信息 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `loanBillDcs` | `loanBillDcs` | `loanBillDcs` | 对公预付单自定义项 |
