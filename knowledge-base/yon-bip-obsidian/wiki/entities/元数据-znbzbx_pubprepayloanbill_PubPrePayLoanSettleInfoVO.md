---
tags: [BIP, 元数据, 数据字典, znbzbx.pubprepayloanbill.PubPrePayLoanSettleInfoVO]
created: 2026-06-03
updated: 2026-06-03
...
# 对公预付单结算信息 (`znbzbx.pubprepayloanbill.PubPrePayLoanSettleInfoVO`)
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `loansettleinfouserdefs` | `znbzbx.pubprepayloanbill.PubPrePayLoanSettleInfoUserdefVO` | composition |
...
| `vbankdocname` | `vbankdocname` | `vbankdocname` | 收款方开户行名称 |
| `vbankdocname_opp` | `vbankdocname_opp` | `vbankdocname_opp` | 付款方开户行名称 |
...
| `` | `` | `loansettleinfouserdefs` | 对公预付单结算信息（自定义项）表 |
