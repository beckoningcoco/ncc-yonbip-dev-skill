---
tags: [BIP, 元数据, 数据字典, znbzbx.pubprepayreturnbill.PubPrePayRetSettleInfoVO]
created: 2026-06-03
updated: 2026-06-03
...
# 退款单结算信息 (`znbzbx.pubprepayreturnbill.PubPrePayRetSettleInfoVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_retsettleinfo` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `RetSettleInfoUserdefVO` | `znbzbx.pubprepayreturnbill.PubPrePayRetSettleInfoUserdefVO` | composition |
...
| `accttype_opp` | `accttype_opp` | `accttype_opp` | 收款账户类型 |
...
| `showoppositebanklineno` | `showoppositebanklineno` | `showoppositebanklineno` | 付款账户联行号 |
| `vbankaccname` | `vbankaccname` | `vbankaccname` | 付款方户名 |
| `vbankaccname_opp` | `vbankaccname_opp` | `vbankaccname_opp` | 收款账户户名 |
| `vbankaccount` | `vbankaccount` | `vbankaccount` | 付款方帐号 |
| `vbankaccount_opp` | `vbankaccount_opp` | `vbankaccount_opp` | 收款银行账号 |
| `vbankdocname` | `vbankdocname` | `vbankdocname` | 开户行名称 |
| `vbankdocname_opp` | `vbankdocname_opp` | `vbankdocname_opp` | 收款开户行名称 |
| `vbanktypename` | `vbanktypename` | `vbanktypename` | 银行类别名称 |
| `vbanktypename_opp` | `vbanktypename_opp` | `vbanktypename_opp` | 收款银行类别名称 |
...
| `vmemo_opp` | `vmemo_opp` | `vmemo_opp` | 收款账户备注 |
...
| `pk_bankdoc_opp` | `pk_bankdoc_opp` | `pk_bankdoc_opp` | 收款开户行PK |
| `pk_banktype` | `pk_banktype` | `pk_banktype` | 银行类别 |
| `pk_banktype_opp` | `pk_banktype_opp` | `pk_banktype_opp` | 收款银行类别 |
| `pk_currency` | `pk_currency` | `pk_currency` | 账户币种 |
| `currency_opp` | `currency_opp` | `pk_currency_opp` | 收款账户币种 |
...
| `pk_handlepsnbank` | `pk_handlepsnbank` | `pk_handlepsnbank` | 经办人银行账户 |
| `pk_returnbill` | `pk_returnbill` | `pk_returnbill` | 退款单主表id |
| `tenant_id` | `tenant_id` | `tenant` | 租户 |
| `vcurrency` | `vcurrency` | `vcurrency` | 退款币种 |
| `vnatcurrency` | `vnatcurrency` | `vnatcurrency` | 组织本币 |
| `vnatexchratetype` | `vnatexchratetype` | `vnatexchratetype` | 汇率类型 |
| `vsettlecurrency` | `vsettlecurrency` | `vsettlecurrency` | 期望退款币种 |
...
| `igathertype` | `igathertype` | `igathertype` | 付款方类型 |
...
| `nnatsettlesummny` | `nnatsettlesummny` | `nnatsettlesummny` | 期望退款金额-本币 |
| `npaymentdays` | `npaymentdays` | `npaymentdays` | 账期天数 |
| `nsettlebaseexchrate` | `nsettlebaseexchrate` | `nsettlebaseexchrate` | 结算币种企业汇率 |
| `nsettleexchrate` | `nsettleexchrate` | `nsettleexchrate` | 结算汇率 |
| `nsettlesummny` | `nsettlesummny` | `nsettlesummny` | 期望退款金额 |
| `nsummny` | `nsummny` | `nsummny` | 本次退款额 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `retSettleInfoDcs` | `retSettleInfoDcs` | `retSettleInfoDcs` | 结算信息自定义项 |

### other (5个)

| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `nsettlebaseexchrateOps` | `nsettlebaseexchrateOps` | `nsettlebaseexchrateOps` | 结算基准汇率折算方式 |
| `nsettleexchrateOps` | `nsettleexchrateOps` | `nsettleexchrateOps` | 结算汇率折算方式 |
...
| `` | `` | `RetSettleInfoUserdefVO` | 退款单结算信息（自定义项）表 |
