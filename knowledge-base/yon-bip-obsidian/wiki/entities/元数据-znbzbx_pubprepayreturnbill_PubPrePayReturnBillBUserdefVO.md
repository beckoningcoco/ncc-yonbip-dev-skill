---
tags: [BIP, 元数据, 数据字典, znbzbx.pubprepayreturnbill.PubPrePayReturnBillBUserdefVO]
created: 2026-06-03
updated: 2026-06-03
...
# 退款单子表（自定义项）表 (`znbzbx.pubprepayreturnbill.PubPrePayReturnBillBUserdefVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_returnbill_b_userdef` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
