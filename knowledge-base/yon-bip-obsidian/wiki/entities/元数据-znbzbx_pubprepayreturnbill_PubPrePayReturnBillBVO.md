---
tags: [BIP, 元数据, 数据字典, znbzbx.pubprepayreturnbill.PubPrePayReturnBillBVO]
created: 2026-06-03
updated: 2026-06-03
...
# 退款单子表 (`znbzbx.pubprepayreturnbill.PubPrePayReturnBillBVO`)
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `ReturnBillBUserdefVO` | `znbzbx.pubprepayreturnbill.PubPrePayReturnBillBUserdefVO` | composition |
...
| `pk_loanbilltype` | `pk_loanbilltype` | `pk_loanbilltype` | 对公预付单据类型 |
...
| `chandlecostcenter` | `chandlecostcenter` | `chandlecostcenter` | 退款人成本中心 |
| `chandleorg` | `chandleorg` | `chandleorg` | 退款经办人组织 |
...
| `cloancostcenter` | `cloancostcenter` | `cloancostcenter` | 对公预付成本中心 |
...
| `pk_handlepsn` | `pk_handlepsn` | `pk_handlepsn` | 退款经办人 |
| `pk_loanbill` | `pk_loanbill` | `pk_loanbill` | 对公预付单主表id |
| `pk_loanbill_b` | `pk_loanbill_b` | `pk_loanbill_b` | 对公预付单子表id |
| `pk_loanpsn` | `pk_loanpsn` | `pk_loanpsn` | 经办人 |
...
| `vhandledeptid` | `vhandledeptid` | `vhandledeptid` | 退款经办人部门 |
| `vloancurrency` | `vloancurrency` | `vloancurrency` | 预付币种 |
| `vloandeptid` | `vloandeptid` | `vloandeptid` | 经办人部门 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `nbaseexchrate` | `nbaseexchrate` | `nbaseexchrate` | 退款币种企业汇率 |
...
| `nexchrate` | `nexchrate` | `nexchrate` | 退款币种汇率 |
...
| `nhistoryreturnmny` | `nhistoryreturnmny` | `nhistoryreturnmny` | 退款额(含未审核) |
| `nlineno` | `nlineno` | `nlineno` | 行号 |
| `nloanmny` | `nloanmny` | `nloanmny` | 预付金额 |
| `nloanreturnmny` | `nloanreturnmny` | `nloanreturnmny` | 本次冲销预付额 |
| `nnatbaseexchrate` | `nnatbaseexchrate` | `nnatbaseexchrate` | 组织本币企业汇率 |
| `nnatexchrate` | `nnatexchrate` | `nnatexchrate` | 组织本币汇率 |
| `nnatreturnmny` | `nnatreturnmny` | `nnatreturnmny` | 本次冲销预付额-本币 |
| `nremainmny` | `nremainmny` | `nremainmny` | 退款后余额 |
| `nreturnmny` | `nreturnmny` | `nreturnmny` | 退款总额 |
| `ntotalremainmny` | `ntotalremainmny` | `ntotalremainmny` | 待退款金额 |

### UserDefine (1个)

| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `returnBillBDcs` | `returnBillBDcs` | `returnBillBDcs` | 退款明细自定义项 |
...
| `` | `` | `ReturnBillBUserdefVO` | 退款单子表（自定义项）表 |
