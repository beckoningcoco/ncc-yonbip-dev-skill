---
tags: [BIP, 元数据, 数据字典, znbzbx.pubprepayreturnbill.PubPrePayReturnBillIBpmCurrentAuditor]
created: 2026-06-03
updated: 2026-06-03
...
# 退款单审批当前审批人 (`znbzbx.pubprepayreturnbill.PubPrePayReturnBillIBpmCurrentAuditor`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_returnbill_ibpmcurrentauditor` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 退款单审批当前审批人 |
| 物理表 | `znbz_returnbill_ibpmcurrentauditor` |
| domain/服务域 | `znbzbx` |
| schema | `znbz` |
| 所属应用 | `RBSM` |
| 直连字段 | 16 个 |
...
| `pk_returnbill` | `pk_returnbill` | `pk_returnbill` | 退款单主表主键 |
