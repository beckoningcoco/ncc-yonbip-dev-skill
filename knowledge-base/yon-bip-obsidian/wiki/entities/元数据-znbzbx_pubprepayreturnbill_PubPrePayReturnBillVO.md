---
tags: [BIP, 元数据, 数据字典, znbzbx.pubprepayreturnbill.PubPrePayReturnBillVO]
created: 2026-06-03
updated: 2026-06-03
...
# 退款单主表 (`znbzbx.pubprepayreturnbill.PubPrePayReturnBillVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_returnbill` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：`44fe70af-7231-4b74-a522-101a4d8ab6d3`
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `returnbillibpmstep` | `znbzbx.pubprepayreturnbill.PubPrePayReturnBillIBpmStep` | composition |
| `ReturnBillBVO` | `znbzbx.pubprepayreturnbill.PubPrePayReturnBillBVO` | composition |
| `RetSettleInfoVO` | `znbzbx.pubprepayreturnbill.PubPrePayRetSettleInfoVO` | composition |
| `returnbillibpmcurrentauditor` | `znbzbx.pubprepayreturnbill.PubPrePayReturnBillIBpmCurrentAuditor` | composition |
| `ReturnBillUserdefVO` | `znbzbx.pubprepayreturnbill.PubPrePayReturnBillUserdefVO` | composition |
...
| `nnatreturnmny` | `nnatreturnmny` | `nnatreturnmny` | 本币还款额 |
| `nreturnmny` | `nreturnmny` | `nreturnmny` | 还款金额 |
...
| `` | `` | `RetSettleInfoVO` | 退款单结算信息 |
| `` | `` | `ReturnBillBVO` | 退款单子表 |
| `` | `` | `ReturnBillUserdefVO` | 退款单主表（自定义项）表 |
| `` | `` | `returnbillibpmcurrentauditor` | 退款单审批当前审批人 |
| `` | `` | `returnbillibpmstep` | 退款单审批业务阶段 |

### UserDefine (1个)

| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `returnBillDcs` | `returnBillDcs` | `returnBillDcs` | 表头自定义项 |
