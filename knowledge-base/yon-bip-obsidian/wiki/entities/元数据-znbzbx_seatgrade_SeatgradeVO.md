---
tags: [BIP, 元数据, 数据字典, znbzbx.seatgrade.SeatgradeVO]
created: 2026-06-03
updated: 2026-06-03
...
# 舱位等级档案 (`znbzbx.seatgrade.SeatgradeVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_seatgrade` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：`34779475-f890-4fa9-8ee5-0d831debda56`
...
|--------|---------|---------|--------|
| `code` | `code` | `code` | 舱位等级 |
| `valiasname` | `valiasname` | `valiasname` | 舱位别名 |
