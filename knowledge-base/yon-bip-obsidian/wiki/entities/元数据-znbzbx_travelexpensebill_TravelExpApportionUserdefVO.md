---
tags: [BIP, 元数据, 数据字典, znbzbx.travelexpensebill.TravelExpApportionUserdefVO]
created: 2026-06-03
updated: 2026-06-03
...
# 差旅费报销单费用分摊（自定义项）表 (`znbzbx.travelexpensebill.TravelExpApportionUserdefVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_expapportion_userdef` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``

## 基本信息

| 属性 | 值 |
|------|-----|
| 显示名 | 差旅费报销单费用分摊（自定义项）表 |
| 物理表 | `znbz_expapportion_userdef` |
| domain/服务域 | `znbzbx` |
| schema | `znbz` |
| 所属应用 | `RBSM` |
| 直连字段 | 64 个 |
