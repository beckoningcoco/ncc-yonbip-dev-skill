---
tags: [BIP, 元数据, 数据字典, znbzbx.travelexpensebill.TravelExpApportionVO]
created: 2026-06-03
updated: 2026-06-03
...
# 差旅费报销单费用分摊 (`znbzbx.travelexpensebill.TravelExpApportionVO`)
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `expapportionuserdefs` | `znbzbx.travelexpensebill.TravelExpApportionUserdefVO` | composition |
...
| `expapportionrulelinkflagb` | `expapportionrulelinkflagb` | `expapportionrulelinkflagb` | 分摊规则联动标识 |
...
| `nnatapportmny` | `nnatapportmny` | `nnatapportmny` | 含税金额-本币 |
...
| `` | `` | `expapportionuserdefs` | 差旅费报销单费用分摊（自定义项）表 |
