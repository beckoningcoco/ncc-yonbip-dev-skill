---
tags: [BIP, 元数据, 数据字典, znbzbx.travelexpensebill.TravelExpInvoiceDetailVO]
created: 2026-06-03
updated: 2026-06-03
...
# 差旅费报销单发票明细 (`znbzbx.travelexpensebill.TravelExpInvoiceDetailVO`)
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `expinvoicedetailuserdefs` | `znbzbx.travelexpensebill.TravelExpInvoiceDetailUserdefVO` | composition |
...
| `vparentsourcesysid` | `vparentsourcesysid` | `vparentsourcesysid` | 父订单号 |
...
| `pk_expensebill` | `pk_expensebill` | `pk_expensebill` | 差旅费报销单id |
| `pk_invoicetype` | `pk_invoicetype` | `pk_invoicetype` | 发票类型 |
| `pk_seatgrade` | `pk_seatgrade` | `pk_seatgrade` | 舱位等级 |
| `pk_startaddr` | `pk_startaddr` | `pk_startaddr` | 出发地id |
| `pk_tallydata` | `pk_tallydata` | `pk_tallydata` | 记账数据pk |
| `pk_taxrate` | `pk_taxrate` | `pk_taxrate` | 税目税率 |
| `tenant_id` | `tenant_id` | `tenant` | 租户 |
| `vinvoicecurrency` | `vinvoicecurrency` | `vinvoicecurrency` | 账单币种 |
...
| `` | `` | `expinvoicedetailuserdefs` | 差旅费报销单发票明细（自定义项）表 |
