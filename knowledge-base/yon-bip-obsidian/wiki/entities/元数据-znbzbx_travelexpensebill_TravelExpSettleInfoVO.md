---
tags: [BIP, 元数据, 数据字典, znbzbx.travelexpensebill.TravelExpSettleInfoVO]
created: 2026-06-03
updated: 2026-06-03
...
# 差旅费报销单结算信息 (`znbzbx.travelexpensebill.TravelExpSettleInfoVO`)
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `expsettleinfouserdefs` | `znbzbx.travelexpensebill.TravelExpSettleInfoUserdefVO` | composition |
...
| `vbanktypename_opp` | `vbanktypename_opp` | `vbanktypename_opp` | 付款开户行名称 |
...
| `pk_bankdoc` | `pk_bankdoc` | `pk_bankdoc` | 开户行id |
...
| `` | `` | `expsettleinfouserdefs` | 差旅费报销单结算信息（自定义项）表 |
