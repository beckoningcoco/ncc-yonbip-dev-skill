---
tags: [BIP, 元数据, 数据字典, znbzbx.travelexpensebill.TravelExpSubsidyDetailVO]
created: 2026-06-03
updated: 2026-06-03
...
# 差旅费报销单补贴明细 (`znbzbx.travelexpensebill.TravelExpSubsidyDetailVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_expsubsidydetail` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `expsubsidydetailDcs` | `expsubsidydetailDcs` | `expsubsidydetailDcs` | 账单明细自定义项 |
