---
tags: [BIP, 元数据, 数据字典, znbzbx.travelexpensebill.TravelExpenseBillBUserdefVO]
created: 2026-06-03
updated: 2026-06-03
...
# 差旅费报销单子表（自定义项）表 (`znbzbx.travelexpensebill.TravelExpenseBillBUserdefVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_expensebill_b_userdef` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 差旅费报销单子表（自定义项）表 |
| 物理表 | `znbz_expensebill_b_userdef` |
| domain/服务域 | `znbzbx` |
| schema | `znbz` |
| 所属应用 | `RBSM` |
| 直连字段 | 64 个 |
