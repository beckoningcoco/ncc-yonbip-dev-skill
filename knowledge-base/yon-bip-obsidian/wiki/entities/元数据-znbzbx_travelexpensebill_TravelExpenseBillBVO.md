---
tags: [BIP, 元数据, 数据字典, znbzbx.travelexpensebill.TravelExpenseBillBVO]
created: 2026-06-03
updated: 2026-06-03
...
# 差旅费报销单子表 (`znbzbx.travelexpensebill.TravelExpenseBillBVO`)
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `invoicerefinfos` | `znbzbx.travelexpensebill.TravelInvoicerefVO` | composition |
| `expensebillbfellows` | `znbzbx.travelexpensebill.TravelExpenseBillBFellowVO` | composition |
| `expensebillblives` | `znbzbx.travelexpensebill.TravelExpenseBillBLiveVO` | composition |
| `expenseOfficial` | `znbzbx.travelexpensebill.TravelExpenseOfficialCardVO` | composition |
| `expensebillbuserdefs` | `znbzbx.travelexpensebill.TravelExpenseBillBUserdefVO` | composition |
...
| `corexchratetype` | `ucfbasedoc.bd_exchangeratetyperef` |
| `whtax_id` | `` |
...
| `pk_calendar` | `pk_calendar` | `pk_calendar` | 差旅日历id |
...
| `pk_memoapply` | `pk_memoapply` | `pk_memoapply` | 事项申请单表头id |
...
| `id` | `id` | `id` | ID |
| `wht_parentid` | `wht_parentid` | `wht_parentid` | 与代扣税孙表关联的报销明细表字段(代扣税孙表也有这个字段) |
...
| `nnatmileagstdmny` | `nnatmileagstdmny` | `nnatmileagstdmny` | 里程补贴标准-本币 |
...
| `nexpensemny` | `nexpensemny` | `nexpensemny` | 发生额 |
...
| `nintranscostmny` | `nintranscostmny` | `nintranscostmny` | 市内交通费账单金额 |
...
| `nnatexpensemny` | `nnatexpensemny` | `nnatexpensemny` | 发生额-本币 |
| `nnathotelinvmny` | `nnathotelinvmny` | `nnathotelinvmny` | 住宿费账单金额-本币 |
...
| `nnatmiscellansexpstd` | `nnatmiscellansexpstd` | `nnatmiscellansexpstd` | 公杂费补贴-本币 |
...
| `notherwelfarebasestdmny5` | `notherwelfarebasestdmny5` | `notherwelfarebasestdmny5` | 其他补贴5每日补贴标准 |
...
| `` | `` | `expensebillbfellows` | 差旅费报销单明细同行人参照表 |
| `` | `` | `expensebillblives` | 差旅费报销单明细同住人参照表 |
| `` | `` | `expensebillbuserdefs` | 差旅费报销单子表（自定义项）表 |
| `` | `` | `invoicerefinfos` | 差旅费报销单明细合同对应发票表 |
