---
tags: [BIP, 元数据, 数据字典, znbzbx.travelexpensebill.TravelExpenseBillIBpmCurrentAuditor]
created: 2026-06-03
updated: 2026-06-03
...
# 差旅费报销单审批当前审批人 (`znbzbx.travelexpensebill.TravelExpenseBillIBpmCurrentAuditor`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_expensebill_ibpmcurrentauditor` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
...
|------|-----|
| 显示名 | 差旅费报销单审批当前审批人 |
| 物理表 | `znbz_expensebill_ibpmcurrentauditor` |
| domain/服务域 | `znbzbx` |
| schema | `znbz` |
| 所属应用 | `RBSM` |
| 直连字段 | 16 个 |
...
| `pk_expensebill` | `pk_expensebill` | `pk_expensebill` | 差旅费报销单主表主键 |
