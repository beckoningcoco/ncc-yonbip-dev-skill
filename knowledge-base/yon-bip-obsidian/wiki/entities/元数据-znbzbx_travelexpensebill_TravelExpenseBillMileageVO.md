---
tags: [BIP, 元数据, 数据字典, znbzbx.travelexpensebill.TravelExpenseBillMileageVO]
created: 2026-06-03
updated: 2026-06-03
...
# 差旅费报销单记事 (`znbzbx.travelexpensebill.TravelExpenseBillMileageVO`)
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `expensebillmileageuserdefs` | `znbzbx.travelexpensebill.TravelExpenseBillMileageUserdefVO` | composition |
...
| `` | `` | `expensebillmileageuserdefs` | 差旅费报销单记事（自定义项）表 |
