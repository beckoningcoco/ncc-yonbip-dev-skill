---
tags: [BIP, 元数据, 数据字典, znbzbx.travelexpensebill.TravelExpenseBillUserdefVO]
created: 2026-06-03
updated: 2026-06-03
...
# 差旅费报销单主表（自定义项）表 (`znbzbx.travelexpensebill.TravelExpenseBillUserdefVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_expensebill_userdef` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
