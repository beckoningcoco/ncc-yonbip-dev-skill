---
tags: [BIP, 元数据, 数据字典, znbzbx.travelmemoapply.TravelMemoApplyBVO]
created: 2026-06-03
updated: 2026-06-03
...
# 出差申请单子表 (`znbzbx.travelmemoapply.TravelMemoApplyBVO`)
...
| 字段名 | URI | 关系 |
|--------|-----|------|
| `MemoApplyBUserdefVO` | `znbzbx.travelmemoapply.TravelMemoApplyBUserdefVO` | composition |
| `memoapplybfellows` | `znbzbx.travelmemoapply.TravelMemoApplyBFellowVO` | composition |
| `memoapplyblives` | `znbzbx.travelmemoapply.TravelMemoApplyBLiveVO` | composition |
...
| `nintransbasestdmny` | `nintransbasestdmny` | `nintransbasestdmny` | 市内交通费每日补贴标准 |
...
| `notherwelfarestdmny5` | `notherwelfarestdmny5` | `notherwelfarestdmny5` | 其他补贴5总补贴标准 |
...
| `nfinishmny` | `nfinishmny` | `nfinishmny` | 报销参照完成金额 |
...
| 字段名 | 数据库列 | 字段编码 | 显示名 |
|--------|---------|---------|--------|
| `memoapplyBDcs` | `memoapplyBDcs` | `memoapplyBDcs` | 申请明细自定义项 |
...
| `` | `` | `MemoApplyBUserdefVO` | 出差申请单子表（自定义项）表 |
