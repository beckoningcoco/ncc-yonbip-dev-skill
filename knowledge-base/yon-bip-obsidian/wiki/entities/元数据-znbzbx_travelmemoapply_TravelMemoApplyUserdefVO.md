---
tags: [BIP, 元数据, 数据字典, znbzbx.travelmemoapply.TravelMemoApplyUserdefVO]
created: 2026-06-03
updated: 2026-06-03
...
# 出差申请单主表（自定义项）表 (`znbzbx.travelmemoapply.TravelMemoApplyUserdefVO`)

> **平台版本：BIP 旗舰版 V5**
> 物理表：`znbz_memoapply_userdef` | domain：`znbzbx` | 应用：`RBSM` | 业务对象ID：``
