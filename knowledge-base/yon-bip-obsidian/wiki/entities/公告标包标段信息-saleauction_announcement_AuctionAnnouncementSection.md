---
tags: ["BIP", "元数据", "数据字典", "ycAuction", "saleauction.announcement.AuctionAnnouncementSection"]
created: 2026-06-04
updated: 2026-06-04
...
# 公告标包标段信息 (`saleauction.announcement.AuctionAnnouncementSection`)

> ycAuction | 物理表：`cpu_bid_announcement_section`
...
| 5 | `announcementId` | 公告主表ID | `announcement_id` | ba0cbbbd-ef81-4f06-9fb0-e40a40cde1fa |
| 6 | `bidSectionId` | 标段ID | `bid_section_id` | 052621d8-fde7-4ab0-94bf-b179c720ce6d |
| 7 | `projectSectionId` | 项目标段子表ID | `project_section_id` | 7c0b1886-d21b-4dc6-b462-391bbee9c79b |
| 8 | `purchaseTypeName` | 采购类型名称 | `purchase_type_name` | String |
| 9 | `purchaseName` | 采购方式名称 | `purchase_name` | String |
| 10 | `AuctionAnnouncementSectionDefineCharacter` | 竞卖公告标包信息自定义项 | `define_character_id` | b115f7dd-2a4f-421f-91cc-92774cfc1395 |
| 11 | `bidSectionCode` | 标段(包)编号 | `bid_section_code` | String |
| 12 | `bidSectionName` | 标段(包)名称 | `bid_section_name` | String |
| 13 | `purchaseType` | 采购类型 | `purchase_type` | String |
| 14 | `purchaseCode` | 采购方式编码 | `purchase_code` | String |
| 15 | `bidBiddocId` | 招标文件id | `bid_biddoc_id` | Long |
| 16 | `bidDocId` | 关联公告id | `bid_notice_id` | Long |
| 17 | `consignorOrgName` | 委托方组织名称 | `consignor_org_name` | String |
| 18 | `saleAmount` | 文件发售金额 | `sale_amount` | Decimal |
| 19 | `issuance` | 选择文件发售 | `issuance` | Integer |
| 20 | `triedStartTime` | 试竞卖开始时间 | `tried_start_time` | DateTime |
| 21 | `triedEndTime` | 试竞卖结束时间 | `tried_end_time` | DateTime |
| 22 | `auctionStartTime` | 竞卖开始时间 | `auction_start_time` | DateTime |
| 23 | `auctionEndTime` | 竞卖结束时间 | `auction_end_time` | DateTime |
| 24 | `triedBidauction` | 是否试竞价 | `tried_bid_auction` | String |
| 25 | `sectionStatus` | 标包状态 | `section_status` | String |
| 26 | `hasFileEncrypt` | 投标文件是否加密 | `has_file_encrypt` | Short |
| 27 | `docReceivePlace` | 文件现场领取地点 | `doc_receive_place` | String |
| 28 | `isBidEnsure` | 选择竞卖保证金 | `is_bid_ensure` | Integer |
| 29 | `bidEnsureMoney` | 竞卖保证金 | `bid_ensure_money` | Decimal |
| 30 | `paymentType` | 保证金缴纳方式 | `payment_type` | String |
| 31 | `bidExplain` | 备注 | `bid_explain` | String |
| 32 | `signupStartTime` | 回复开始时间 | `signup_start_time` | DateTime |
| 33 | `signupEndTime` | 回复结束时间 | `signup_end_time` | DateTime |
| 34 | `tenderDocSubmitMode` | 递交方式 | `tender_doc_submit_mode` | String |
| 35 | `bidDocSaleBegin` | 领取开始时间 | `bid_doc_sale_begin` | DateTime |
| 36 | `tenderDocSubmitPlace` | 递交地点 | `tender_doc_submit_place` | String |
| 37 | `bidDocSaleEnd` | 领取结束时间 | `bid_doc_sale_end` | DateTime |
| 38 | `bidOpenMode` | 开标方式 | `bid_open_mode` | String |
| 39 | `bidDocGetMode` | 文件领取方式 | `bid_doc_get_mode` | String |
| 40 | `bidOpenPlace` | 开标地点 | `bid_open_place` | String |
| 41 | `bidNoticeStatus` | 招标公告状态 | `bid_notice_status` | String |
| 42 | `tenderDocSubmitEnd` | 递交截止时间 | `tender_doc_submit_end` | DateTime |
| 43 | `tenderDocQuestionEnd` | 提问截止时间 | `tender_doc_question_end` | DateTime |
| 44 | `bidOpenTime` | 开标时间 | `bid_open_time` | DateTime |
...
| 52 | `auctionDepositPaymentMethodList` | 保证金缴纳方式 | `` | ff775311-69bf-451f-bc0f-f312d84fd929 |
...
| 67 | `define` | 公告标包标段信息由自定义项 | `` | a5bd1161-4acb-4f9a-9c8f-a2a2427efb9c |
...
| # | 字段名 | 显示名 | 目标实体 | 隔离级 | 组合 |
|---|--------|--------|---------|--------|------|
| 1 | `AuctionAnnouncementSectionDefineCharacter` | 竞卖公告标包信息自定义项 | `saleauction.announcement.AuctionAnnouncementSectionDefineCharacter` | None |  |
...
| 6 | `announcementId` | 公告主表ID | `saleauction.announcement.AuctionAnnouncement` | None | true |
| 7 | `auctionDepositPaymentMethodList` | 保证金缴纳方式 | `saleauction.announcement.AuctionDepositPaymentMethod` | None | true |
| 8 | `define` | 公告标包标段信息由自定义项 | `saleauction.announcement.AuctionAnnouncementSectionFreedefine` | None | true |
| 9 | `projectSectionId` | 项目标段子表ID | `saleauction.project.AuctionProjectSection` | None |  |
| 10 | `enterpriseId` | 租户id | `cpu-privilege.enterprise.EnterprisePOJO` | Service |  |
| 11 | `bidSectionId` | 标段ID | `saleauction.project.AuctionSection` | None |  |
