---
tags: ["BIP", "元数据", "数据字典", "QMSQTS", "QMSQTS.TraceabilityPool.WarehouseTraceabilityPoolSN"]
created: 2026-06-05
updated: 2026-06-05
...
# 出入库追溯池序列号子表 (`QMSQTS.TraceabilityPool.WarehouseTraceabilityPoolSN`)

> QMSQTS | 物理表：`qms_qts_w_tracepool_sn`
...
|------|-----|
| 显示名 | 出入库追溯池序列号子表 |
| 物理表 | `qms_qts_w_tracepool_sn` |
| 数据库 schema | `QMS-DFM` |
| 所属应用 | `QMSQTS` |
| 构建时间 | `2026-06-05 17:01:22.7420` |
...
| 16 | `warehouseTPID` | 出入库追溯池ID | `warehouse_tp_id` | e256b4ec-c4cb-4487-addb-097c186f8023 |
...
| 4 | `warehouseTPID` | 出入库追溯池ID | `QMSQTS.TraceabilityPool.WarehouseTraceabilityPool` | None | true |
