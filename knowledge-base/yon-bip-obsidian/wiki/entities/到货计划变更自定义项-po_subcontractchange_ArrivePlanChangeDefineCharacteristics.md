---
tags: ["BIP", "元数据", "数据字典", "OSM", "po.subcontractchange.ArrivePlanChangeDefineCharacteristics"]
created: 2026-06-05
updated: 2026-06-05
...
# 到货计划变更自定义项 (`po.subcontractchange.ArrivePlanChangeDefineCharacteristics`)

> OSM | 物理表：`osm_arrive_plan_change_dct`
...
|------|-----|
| 显示名 | 到货计划变更自定义项 |
| 物理表 | `osm_arrive_plan_change_dct` |
| domain/服务域 | `productionorder` |
| 所属应用 | `OSM` |
| 构建时间 | `2026-06-05 09:57:15.2240` |
