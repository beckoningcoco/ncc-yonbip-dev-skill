---
tags: ["BIP", "元数据", "数据字典", "ycBusinessCenter", "saleauction.talkResponse.ClarifyProblemResponseVO"]
created: 2026-06-04
updated: 2026-06-04
...
# 商务技术谈判回复表体 (`saleauction.talkResponse.ClarifyProblemResponseVO`)
...
| # | 字段名 | 显示名 | 数据库列 | 类型 |
|---|--------|--------|---------|------|
| 1 | `bidClarifyBidderId` | 谈判供应商 | `bid_clarify_bidder_id` | 44831f35-0e0d-4376-a233-1852aedccd3a |
...
| 8 | `id` | 问题澄清 | `id` | Long |
| 9 | `problemId` | 问题 | `problem_id` | bf8723cc-2bef-4c37-b1b4-c5ef15163ad9 |
...
| 3 | `bidClarifyBidderId` | 谈判供应商 | `saleauction.talkResponse.ClarifyBidderVO` | None | true |
| 4 | `problemId` | 问题 | `saleauction.talks.ClarifyProblemVO` | None |  |
