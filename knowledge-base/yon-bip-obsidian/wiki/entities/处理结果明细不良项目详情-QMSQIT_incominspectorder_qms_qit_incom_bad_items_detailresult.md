---
tags: ["BIP", "元数据", "数据字典", "QMSQIT", "QMSQIT.incominspectorder.qms_qit_incom_bad_items_detailresult"]
created: 2026-06-05
updated: 2026-06-05
...
# 处理结果明细不良项目详情 (`QMSQIT.incominspectorder.qms_qit_incom_bad_items_detailresult`)
...
| 12 | `resultId` | 处理结果id | `result_id` | 4a838116-dc2a-413e-9c87-23ff027cf053 |
...
| # | 字段名 | 显示名 | 目标实体 | 隔离级 | 组合 |
|---|--------|--------|---------|--------|------|
| 1 | `resultId` | 处理结果id | `QMSQIT.incominspectorder.qms_qit_incominspectorder_detailresult` | None | true |
