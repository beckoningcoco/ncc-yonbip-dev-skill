---
tags: ["BIP", "元数据", "数据字典", "MR", "mr.planworkbench.ExtendsOrganizePlanOrder"]
created: 2026-06-05
updated: 2026-06-05
...
# 多工厂计划订单拓展 (`mr.planworkbench.ExtendsOrganizePlanOrder`)
...
| 9 | `id` | 计划订单id | `mr.planworkbench.OrganizePlanOrder` | None | true |
