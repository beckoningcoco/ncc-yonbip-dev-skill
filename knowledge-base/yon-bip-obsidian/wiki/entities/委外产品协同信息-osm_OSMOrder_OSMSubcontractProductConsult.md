---
tags: ["BIP", "元数据", "数据字典", "OSM", "osm.OSMOrder.OSMSubcontractProductConsult"]
created: 2026-06-05
updated: 2026-06-05
...
# 委外产品协同信息 (`osm.OSMOrder.OSMSubcontractProductConsult`)

> OSM | 物理表：`po_order_subcontract_product_consult`
...
| 所属应用 | `OSM` |
| 构建时间 | `2026-06-05 09:57:54.6850` |

## 主键与编码

| 角色 | 字段名 | 类型 | 说明 |
|------|--------|------|------|
| 主键 | `id` | 7d39c327-90bf-4f63-b030-c953035dd99e | 订单产品id |
...
| 6 | `id` | 订单产品id | `id` | 7d39c327-90bf-4f63-b030-c953035dd99e |
...
| 2 | `id` | 订单产品id | `osm.OSMOrder.OSMOrderProduct` | None | true |
