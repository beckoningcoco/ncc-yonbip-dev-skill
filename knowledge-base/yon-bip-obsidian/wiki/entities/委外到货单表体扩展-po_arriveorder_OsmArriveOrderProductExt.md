---
tags: ["BIP", "元数据", "数据字典", "OSM", "po.arriveorder.OsmArriveOrderProductExt"]
created: 2026-06-05
updated: 2026-06-05
...
# 委外到货单表体扩展 (`po.arriveorder.OsmArriveOrderProductExt`)
...
| 所属应用 | `OSM` |
| 构建时间 | `2026-06-05 09:56:59.8740` |

## 主键与编码

| 角色 | 字段名 | 类型 | 说明 |
|------|--------|------|------|
| 主键 | `id` | 858b44be-73af-4087-a285-219c34d67b83 | 委外到货单产品id |
...
| 10 | `id` | 委外到货单产品id | `id` | 858b44be-73af-4087-a285-219c34d67b83 |
...
| 3 | `id` | 委外到货单产品id | `po.arriveorder.OsmArriveOrderProduct` | None | true |
