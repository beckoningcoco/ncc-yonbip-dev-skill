---
tags: ["BIP", "元数据", "数据字典", "OSM", "osm.OSMOrder.OSMSubcontractConsult"]
created: 2026-06-05
updated: 2026-06-05
...
# 委外协同信息 (`osm.OSMOrder.OSMSubcontractConsult`)

> OSM | 物理表：`po_order_subcontract_consult`
...
| 16 | `id` | 委外订单id | `id` | 823b74a3-0ec8-440f-91a3-fdf94ae2f1bd |
...
| 3 | `id` | 委外订单id | `osm.OSMOrder.OSMOrder` | None | true |
