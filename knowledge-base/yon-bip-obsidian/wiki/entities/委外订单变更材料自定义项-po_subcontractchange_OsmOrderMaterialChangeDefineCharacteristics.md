---
tags: ["BIP", "元数据", "数据字典", "OSM", "po.subcontractchange.OsmOrderMaterialChangeDefineCharacteristics"]
created: 2026-06-05
updated: 2026-06-05
...
# 委外订单变更材料自定义项 (`po.subcontractchange.OsmOrderMaterialChangeDefineCharacteristics`)

> OSM | 物理表：`osm_order_material_change_dct`
...
|------|-----|
| 显示名 | 委外订单变更材料自定义项 |
| 物理表 | `osm_order_material_change_dct` |
| domain/服务域 | `productionorder` |
| 所属应用 | `OSM` |
| 构建时间 | `2026-06-05 09:58:11.0750` |
