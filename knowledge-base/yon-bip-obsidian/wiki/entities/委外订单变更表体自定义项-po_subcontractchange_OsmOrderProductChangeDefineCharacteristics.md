---
tags: ["BIP", "元数据", "数据字典", "OSM", "po.subcontractchange.OsmOrderProductChangeDefineCharacteristics"]
created: 2026-06-05
updated: 2026-06-05
...
# 委外订单变更表体自定义项 (`po.subcontractchange.OsmOrderProductChangeDefineCharacteristics`)

> OSM | 物理表：`osm_order_product_change_dct`
...
|------|-----|
| 显示名 | 委外订单变更表体自定义项 |
| 物理表 | `osm_order_product_change_dct` |
| 数据库 schema | `productionorder` |
| 所属应用 | `OSM` |
| 构建时间 | `2026-06-05 09:58:19.4960` |
