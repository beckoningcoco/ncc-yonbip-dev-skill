---
tags: ["BIP", "元数据", "数据字典", "OSM", "po.subcontractchange.OsmOrderMaterialChangeExpinfo"]
created: 2026-06-05
updated: 2026-06-05
...
# 委外订单材料变更表扩展信息 (`po.subcontractchange.OsmOrderMaterialChangeExpinfo`)

> OSM | 物理表：`osm_order_material_change_expinfo`
...
|------|-----|
| 显示名 | 委外订单材料变更表扩展信息 |
| 物理表 | `osm_order_material_change_expinfo` |
| domain/服务域 | `productionorder` |
| 所属应用 | `OSM` |
| 构建时间 | `2026-06-05 09:58:12.3890` |

## 主键与编码

| 角色 | 字段名 | 类型 | 说明 |
|------|--------|------|------|
| 主键 | `id` | bd2bffb9-e476-482e-8840-b1ecff203c73 | 委外订单材料表ID |
...
| 7 | `id` | 委外订单材料表ID | `id` | bd2bffb9-e476-482e-8840-b1ecff203c73 |
...
| 3 | `id` | 委外订单材料表ID | `po.subcontractchange.OsmOrderMaterialChange` | None | true |
