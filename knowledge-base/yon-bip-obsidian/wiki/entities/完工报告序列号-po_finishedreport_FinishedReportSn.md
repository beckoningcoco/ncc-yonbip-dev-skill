---
tags: ["BIP", "元数据", "数据字典", "PO", "po.finishedreport.FinishedReportSn"]
created: 2026-06-05
updated: 2026-06-05
...
# 完工报告序列号 (`po.finishedreport.FinishedReportSn`)
...
| 31 | `detailId` | 产品ID | `detail_id` | d8490919-eda7-40f8-a9a3-9869fc46b507 |
...
| 3 | `detailId` | 产品ID | `po.finishedreport.FinishedReportDetail` | None | true |
