---
tags: ["BIP", "元数据", "数据字典", "MR", "mr.erm.RealtimeSDInfoDCT"]
created: 2026-06-05
updated: 2026-06-05
...
# 实时供需明细自定义项 (`mr.erm.RealtimeSDInfoDCT`)

> MR | 物理表：`mr_realtime_sd_info_dct`
...
|------|-----|
| 显示名 | 实时供需明细自定义项 |
| 物理表 | `mr_realtime_sd_info_dct` |
| domain/服务域 | `yonbip-mm-plan` |
| schema | `requirements_planning` |
| 所属应用 | `MR` |
| 构建时间 | `2026-06-05 15:15:42.6110` |
