---
tags: ["BIP", "元数据", "数据字典", "ycBase", "workhandover.workhandover.ApplyDefineCharacter"]
created: 2026-06-04
updated: 2026-06-04
...
# 工作移交表头自定义项 (`workhandover.workhandover.ApplyDefineCharacter`)

> ⚡ **平台版本：BIP 旗舰版 V5** — 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。

> YonBIP ycBase 模块实体元数据字典。
> 物理表：`cpu_workhandover_apply_define_character` | 所属应用：`ycBase`
> 来源：元数据API `queryByUri` 返回的 `workhandover.workhandover.ApplyDefineCharacter` 实体完整定义。
