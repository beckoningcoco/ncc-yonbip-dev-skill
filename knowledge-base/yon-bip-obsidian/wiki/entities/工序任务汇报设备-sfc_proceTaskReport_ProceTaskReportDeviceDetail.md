---
tags: ["BIP", "元数据", "数据字典", "IMPSFC", "sfc.proceTaskReport.ProceTaskReportDeviceDetail"]
created: 2026-06-05
updated: 2026-06-05
...
# 工序任务汇报设备 (`sfc.proceTaskReport.ProceTaskReportDeviceDetail`)
...
| 4 | `mainId` | 工序任务汇报id | `sfc.proceTaskReport.proceTaskReport` | None | true |
