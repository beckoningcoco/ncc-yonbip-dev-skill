---
tags: ["BIP", "元数据", "数据字典", "ED", "ed.routing.RoutingOperationDrawing"]
created: 2026-06-05
updated: 2026-06-05
...
# 工序图纸 (`ed.routing.RoutingOperationDrawing`)
...
| 4 | `code` | 图纸编号 | `code` | String |
| 5 | `name` | 图纸名称 | `name` | String |
| 6 | `fileId` | 图纸文件 | `file_id` | String |
| 7 | `rowno` | 行号 | `rowno` | Integer |
| 8 | `operationId` | 标准工序 | `operation_id` | 5929debb-7319-44fb-8583-5c7d0d5af701 |
| 9 | `attachmentId` | 附件 | `attachment_id` | String |
...
| 3 | `routingOperationId` | 工序表关联标识 | `ed.routing.RoutingOperation` | None | true |
