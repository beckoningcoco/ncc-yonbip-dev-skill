---
tags: ["BIP", "元数据", "数据字典", "ycBase", "bctask.readedReport.readedReportHistory"]
created: 2026-06-04
updated: 2026-06-04
...
# 已阅历史表 (`bctask.readedReport.readedReportHistory`)

> ⚡ **平台版本：BIP 旗舰版 V5** — 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。

> YonBIP ycBase 模块实体元数据字典。
> 物理表：`cpu_readed_report_history` | 所属应用：`ycBase`
> 来源：元数据API `queryByUri` 返回的 `bctask.readedReport.readedReportHistory` 实体完整定义。
...
|------|--------|---------|------|------|
| 主键 | `id` | `id` | Long | ID |
| 编码 | `readed_report_id` | `readed_report_id` | 4b2761e6-e59e-4602-ba44-d78c8d6e5754 | 已阅状态表主键（必填，isCode）|
...
| 13 | `modifierId` | 修改人 | `modifierId` | 54800425-15da-4742-ae89-059d05e77c9b | `quote` |  | ✓ |
...
| 20 | `readedReportId` | 已阅状态表主键 | `readed_report_id` | 4b2761e6-e59e-4602-ba44-d78c8d6e5754 | `quote` |  | ✓ |
| 21 | `reader` | 查看人名称 | `reader` | String | `text` |  | ✓ |
| 22 | `readerEmil` | 查看人联系邮箱 | `reader_emil` | String | `text` |  | ✓ |
| 23 | `readerId` | 查看人 | `reader_id` | 54800425-15da-4742-ae89-059d05e77c9b | `quote` |  | ✓ |
| 24 | `readerPhone` | 查看人联系电话 | `reader_phone` | String | `text` |  | ✓ |
| 25 | `sourceBillCode` | 来源单据编码 | `source_bill_code` | String | `text` |  | ✓ |
| 26 | `sourceBillId` | 来源单据ID | `source_bill_id` | Long | `long` |  | ✓ |
| 27 | `sourceBillType` | 单据来源类型 | `source_bill_type` | String | `text` |  | ✓ |
| 28 | `supplyContact` | 供应商联系人名称 | `supply_contact` | String | `text` |  | ✓ |
| 29 | `supplyContactEmail` | 联系人邮箱 | `supplyContactEmail` | String | `text` |  | ✓ |
| 30 | `supplyContactId` | 供应商联系人 | `supply_contact_id` | 54800425-15da-4742-ae89-059d05e77c9b | `quote` |  | ✓ |
| 31 | `supplyContactPhone` | 联系人电话 | `supplyContactPhone` | String | `text` |  | ✓ |
| 32 | `supplyDocId` | 供应商档案 | `supply_doc_id` | 89bf026e-cc49-4fe7-9a7b-3e8fdcc77c1e | `quote` |  | ✓ |
| 33 | `supplyTenantId` | 供应商租户 | `supply_tenant_id` | String | `text` |  | ✓ |
| 34 | `supplyTenantName` | 供应商租户名称 | `supply_tenant_name` | String | `text` |  | ✓ |
...
|---|--------|--------|---------|---------|------|--------|------|--------|--------|
| 1 | `readedReportId` | 已阅状态表主键 | `bctask.readedReport.readedReport` | `readed_report_id` |  →  |  |  | None |  |
| 2 | `ytenant` | 租户id | `yht.tenant.YhtTenant` | `ytenant_id` |  →  |  |  | Service |  |
| 3 | `supplyContactId` | 供应商联系人 | `base.user.User` | `supply_contact_id` |  →  |  |  | Service |  |
| 4 | `creatorId` | 创建人 | `base.user.User` | `creator_id` |  →  |  |  | Service |  |
| 5 | `modifierId` | 修改人 | `base.user.User` | `modifierId` |  →  |  |  | Service |  |
| 6 | `supplyDocId` | 供应商档案 | `aa.vendor.Vendor` | `supply_doc_id` |  →  |  |  | Service |  |
| 7 | `readerId` | 查看人 | `base.user.User` | `reader_id` |  →  |  |  | Service |  |
