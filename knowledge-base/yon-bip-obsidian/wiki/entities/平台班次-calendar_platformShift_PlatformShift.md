---
tags: ["BIP", "元数据", "数据字典", "DPMWDC", "calendar.platformShift.PlatformShift"]
created: 2026-06-05
updated: 2026-06-05
...
# 平台班次 (`calendar.platformShift.PlatformShift`)

> DPMWDC | 物理表：`platform_shift`
...
| 16 | `platformShiftPeriodList` | 平台班段 | `` | 29533103-d89e-451e-a0f0-a851f16904e2 |
...
| 5 | `platformShiftPeriodList` | 平台班段 | `calendar.platformShift.PlatformShiftPeriod` | None | true |
