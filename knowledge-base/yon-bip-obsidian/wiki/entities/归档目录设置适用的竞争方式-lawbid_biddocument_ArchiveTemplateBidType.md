---
tags: ["BIP", "元数据", "数据字典", "lawbid.biddocument.ArchiveTemplateBidType"]
created: 2026-06-04
updated: 2026-06-04
...
# 归档目录设置适用的竞争方式 (`lawbid.biddocument.ArchiveTemplateBidType`)

> **平台版本：BIP 旗舰版 V5**

>  模块 | 物理表：`cpu_archive_template_bid_type`
...
| 3 | `bidTypeCode` | 适用竞争方式 | `bid_type_code` | String |
