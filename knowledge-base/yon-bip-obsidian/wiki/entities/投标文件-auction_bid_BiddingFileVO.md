---
tags: ["BIP", "元数据", "数据字典", "auction.bid.BiddingFileVO"]
created: 2026-06-04
updated: 2026-06-04
...
# 投标文件 (`auction.bid.BiddingFileVO`)
...
| 9 | `id` | ID | `id` | Long |
| 10 | `biddingId` | 投标主表ID | `bidding_id` | b1e45acc-57ae-4a37-a971-a848cddafaf1 |
