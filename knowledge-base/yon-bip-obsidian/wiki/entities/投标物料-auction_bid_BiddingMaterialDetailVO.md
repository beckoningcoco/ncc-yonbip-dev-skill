---
tags: ["BIP", "元数据", "数据字典", "auction.bid.BiddingMaterialDetailVO"]
created: 2026-06-04
updated: 2026-06-04
...
# 投标物料 (`auction.bid.BiddingMaterialDetailVO`)
...
|---|--------|--------|---------|------|
| 1 | `id` | ID | `id` | Long |
| 2 | `biddingId` | 投标主表ID | `bidding_id` | b1e45acc-57ae-4a37-a971-a848cddafaf1 |
| 3 | `pubts` | 默认值 | `pubts` | DateTime |
| 4 | `tenantId` | 租户 | `tenant_id` | String |
| 5 | `bidProjectId` | 招标方案主表ID | `bid_project_id` | 94b777ba-4855-4d81-a975-f6ab6b09f9a8 |
| 6 | `bidSectionId` | 招标方案标段包ID | `bid_section_id` | be269c23-7eb6-4029-ac01-781f16c75ec4 |
...
| 43 | `reqTime` | 需求日期 | `req_time` | Date |
| 44 | `purCount` | 采购数量 | `pur_count` | Decimal |
| 45 | `biddingCount` | 投标数量 | `bidding_count` | Decimal |
| 46 | `unitid` | 单位id | `unitid` | 9ea02a0b-3a48-4051-bcbe-59c7bcc7a25b |
| 47 | `bidMainCount` | 投标主数量 | `bid_main_count` | Decimal |
| 48 | `bidCount` | 投标数量 | `bid_count` | Decimal |
| 49 | `mainCount` | 主数量 | `main_count` | Decimal |
| 50 | `purchaseType` | 采购类型 | `purchase_type` | String |
| 51 | `invPurExchRate` | 采购换算率 | `inv_pur_exch_rate` | Decimal |
| 52 | `billStates` | 状态 | `bill_states` | String |
| 53 | `invPriceExchRate` | 计价换算率 | `inv_price_exch_rate` | Decimal |
| 54 | `guaranteedSupply` | 保供量 | `guaranteed_supply` | String |
| 55 | `invPurExchRateType` | 采购换算率类型 | `inv_pur_exch_rate_type` | Short |
...
| 62 | `mainUnitId` | 主单位主键 | `main_unit_id` | 9ea02a0b-3a48-4051-bcbe-59c7bcc7a25b |
| 63 | `rate` | 税率(%) | `rate` | Decimal |
...
| 103 | `referPrice` | 参考单价 | `refer_price` | Decimal |
| 104 | `lastPrice` | 上期价格 | `last_price` | Decimal |
| 105 | `bidBottom` | 标底 | `bid_bottom` | Decimal |
| 106 | `planPrice` | 计划价格 | `plan_price` | Decimal |
| 107 | `startDate` | 开始时间 | `start_date` | Date |
| 108 | `endDate` | 结束时间 | `end_date` | Date |
| 109 | `demandBillId` | 需求明细单ID | `demand_bill_id` | d1c773f8-faee-4714-9ef2-044060d8ee18 |
| 110 | `supplydocId` | 供应商档案ID | `supplydoc_id` | 89bf026e-cc49-4fe7-9a7b-3e8fdcc77c1e |
| 111 | `isNegotiate` | 是否谈判 0否,1是 | `is_negotiate` | Integer |
| 112 | `biddingMaterialDetailAuctionFreeCharacters` | 竞拍报价表体自由项特征组 | `free_characters_id` | 95e9a7ef-bf92-4f52-837d-9dfb3e01e8fe |
...
| 128 | `currencyId` | 币种 | `currency_id` | 02b45339-eb4a-4a31-a8b5-d32f494f4e8e |
| 129 | `taxSinglePriceSecret` | 含税单价加密 | `tax_single_price_secret` | String |
| 130 | `fileId` | 附件 | `file_id` | String |
| 131 | `tax` | 税额 | `tax` | Decimal |
| 132 | `natTax` | 换算后税额 | `nat_tax` | Decimal |
| 133 | `biddingMaterialDetailAuctionDefineCharacters` | 竞拍报价单表体自定义特征 | `define_character_id` | 5ae0f5c8-ce29-4f11-be28-e61ea4ad4af7 |
| 134 | `defines` | 投标物料自定义项表 | `` | d10abee4-3436-4d2c-a34b-7f4b3b7bb172 |
...
| # | 字段名 | 显示名 | 目标实体 | 隔离级 | 组合 |
|---|--------|--------|---------|--------|------|
| 1 | `biddingMaterialDetailAuctionFreeCharacters` | 竞拍报价表体自由项特征组 | `auction.bid.BiddingMaterialDetailAuctionFreeCharacters` | None |  |
| 2 | `ytenant` | 租户id | `yht.tenant.YhtTenant` | Service |  |
| 3 | `purUnitId` | 采购单位主键 | `pc.unit.Unit` | Service |  |
| 4 | `biddingId` | 投标主表ID | `auction.bid.BiddingVO` | None | true |
| 5 | `materialId` | 物料id | `pc.product.Product` | Service |  |
| 6 | `bidProjectId` | 招标方案主表ID | `auction.project.AuctionProject` | None |  |
| 7 | `defines` | 投标物料自定义项表 | `auction.bid.BiddingMaterialDetailAuctionFreeDefine` | None | true |
| 8 | `demandBillId` | 需求明细单ID | `auction.project.AuctionSectionMaterial` | None |  |
| 9 | `supplydocId` | 供应商档案ID | `aa.vendor.Vendor` | Service |  |
| 10 | `unitid` | 单位id | `pc.unit.Unit` | Service |  |
| 11 | `biddingMaterialDetailAuctionDefineCharacters` | 竞拍报价单表体自定义特征 | `auction.bid.BiddingMaterialDetailAuctionDefineCharacters` | None |  |
...
| 15 | `bidSectionId` | 招标方案标段包ID | `auction.project.AuctionSection` | None |  |
