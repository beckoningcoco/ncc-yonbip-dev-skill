---
tags: ["BIP", "元数据", "数据字典", "ycBusinessCenter", "auction.bidnotice.NoticeInvitationVO"]
created: 2026-06-04
updated: 2026-06-04
...
# 报名标段信息 (`auction.bidnotice.NoticeInvitationVO`)
...
| 3 | `bidProjectId` | 采购项目 | `bid_project_id` | 94b777ba-4855-4d81-a975-f6ab6b09f9a8 |
...
| 15 | `bidSectionId` | 标段包 | `bid_section_id` | be269c23-7eb6-4029-ac01-781f16c75ec4 |
...
| 27 | `supPersonName` | 联系人名称 | `sup_person_name` | String |
| 28 | `supPersonTel` | 联系人电话 | `sup_person_tel` | String |
| 29 | `supPersonFax` | 联系人传真 | `sup_person_fax` | String |
| 30 | `supPersonMail` | 联系人邮箱 | `sup_person_mail` | String |
| 31 | `bidNoticeId` | 供应商报名主表 | `bid_notice_id` | 46ff8154-5b89-4faf-9361-0e81207b9ac4 |
...
| 77 | `announcementSectionId` | 公告标包标段信息 | `announcement_section_id` | d046c9cf-68b1-48bb-8686-13a20ae80de7 |
...
| 3 | `biddingId` | 投标主表ID | `auction.bid.BiddingVO` | None |  |
| 4 | `enterpriseId` | 租户主键 | `cpu-privilege.enterprise.EnterprisePOJO` | Service |  |
| 5 | `bidProjectId` | 采购项目 | `auction.project.AuctionProject` | None |  |
| 6 | `agencyOrgId` | 招标代理机构组织ID | `org.func.BaseOrg` | Service |  |
| 7 | `bidNoticeId` | 供应商报名主表 | `auction.bidnotice.NoticeVO` | None | true |
| 8 | `bidSectionId` | 标段包 | `auction.project.AuctionSection` | None |  |
