---
tags: ["BIP", "元数据", "数据字典", "DPMPI", "bd.customerdoc_FK001_yql.FK001_yql"]
created: 2026-06-05
updated: 2026-06-05
...
# 报销类型 (`bd.customerdoc_FK001_yql.FK001_yql`)
...
| 29 | `tenant` | 租户 | `tenantid` | e4933a03-9dea-472b-a644-cdd654222f45 |
...
| 8 | `tenant` | 租户 | `yht.tenant.YhtTenant` | Service |  |
