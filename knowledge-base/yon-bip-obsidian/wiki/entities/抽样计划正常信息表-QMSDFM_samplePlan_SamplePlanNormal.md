---
tags: ["BIP", "元数据", "数据字典", "QIC", "QMSDFM.samplePlan.SamplePlanNormal"]
created: 2026-06-05
updated: 2026-06-05
...
# 抽样计划正常信息表 (`QMSDFM.samplePlan.SamplePlanNormal`)

> QIC | 物理表：`qms_dfm_sampleplannormal`
...
|------|-----|
| 显示名 | 抽样计划正常信息表 |
| 物理表 | `qms_dfm_sampleplannormal` |
| domain/服务域 | `QMS-DFM` |
| schema | `qms_dfm` |
| 所属应用 | `QIC` |
| 构建时间 | `2026-06-05 16:48:14.7290` |
...
| 19 | `definect_d` | 自定义项特征组 | `definect_d` | 5ebf4494-4180-4656-bcb3-4fc3606b7cc5 |
...
| 2 | `definect_d` | 自定义项特征组 | `QMSDFM.samplePlan.SamplePlanNormalDefineCharacter` | None |  |
