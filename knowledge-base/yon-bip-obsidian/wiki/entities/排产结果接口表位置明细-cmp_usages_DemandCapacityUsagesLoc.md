---
tags: ["BIP", "元数据", "数据字典", "DCRP", "cmp.usages.DemandCapacityUsagesLoc"]
created: 2026-06-05
updated: 2026-06-05
...
# 排产结果接口表位置明细 (`cmp.usages.DemandCapacityUsagesLoc`)

> DCRP | 物理表：`cmp_demand_capacity_usages_loc`
...
|------|-----|
| 显示名 | 排产结果接口表位置明细 |
| 物理表 | `cmp_demand_capacity_usages_loc` |
| 数据库 schema | `yonbip-mm-plan` |
| 所属应用 | `DCRP` |
| 构建时间 | `2026-06-05 13:59:46.2180` |
...
| 7 | `demandCapacityUsagesId` | 排产结果接口 | `demand_capacity_usages_id` | c98529d4-3f24-4735-aa1d-c06beaf9e692 |
| 8 | `id` | ID | `id` | Long |
...
| # | 字段名 | 显示名 | 目标实体 | 隔离级 | 组合 |
|---|--------|--------|---------|--------|------|
| 1 | `demandCapacityUsagesId` | 排产结果接口 | `cmp.usages.DemandCapacityUsages` | None | true |
