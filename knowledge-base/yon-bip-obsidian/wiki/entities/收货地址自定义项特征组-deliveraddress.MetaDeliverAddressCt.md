---
tags: ["BIP", "元数据", "数据字典", "ycYuncaiMall", "mall.deliveraddress.MetaDeliverAddressCt"]
created: 2026-06-04
updated: 2026-06-04
...
# 收货地址自定义项特征组 (`mall.deliveraddress.MetaDeliverAddressCt`)

> ⚡ **平台版本：BIP 旗舰版 V5** — 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。

> YonBIP ycYuncaiMall 模块实体元数据字典。
> 物理表：`deliver_address_ct` | 所属应用：`ycYuncaiMall`
> 来源：元数据API `queryByUri` 返回的 `mall.deliveraddress.MetaDeliverAddressCt` 实体完整定义。
