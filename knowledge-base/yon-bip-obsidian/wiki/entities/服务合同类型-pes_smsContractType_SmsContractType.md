---
tags: ["BIP", "元数据", "数据字典", "IMP_PES", "pes.smsContractType.SmsContractType"]
created: 2026-06-05
updated: 2026-06-05
...
# 服务合同类型 (`pes.smsContractType.SmsContractType`)

> IMP_PES | 物理表：`sms_contract_type`
...
|------|-----|
| 显示名 | 服务合同类型 |
| 物理表 | `sms_contract_type` |
| 数据库 schema | `imppes` |
| 所属应用 | `IMP_PES` |
| 构建时间 | `2026-06-05 17:17:31.9370` |
...
| 4 | `isEffective` | 启用状态 | `is_effective` | Boolean |
