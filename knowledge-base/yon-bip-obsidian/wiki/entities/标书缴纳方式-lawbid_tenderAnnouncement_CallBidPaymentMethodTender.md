---
tags: ["BIP", "元数据", "数据字典", "ycSouringBid", "lawbid.tenderAnnouncement.CallBidPaymentMethodTender"]
created: 2026-06-04
updated: 2026-06-04
...
# 标书缴纳方式 (`lawbid.tenderAnnouncement.CallBidPaymentMethodTender`)

> **平台版本：BIP 旗舰版 V5**

> ycSouringBid 模块 | 物理表：`cpu_bid_payment_method_tender`
...
|------|-----|
| 显示名 | 标书缴纳方式 |
| 物理表 | `cpu_bid_payment_method_tender` |
| domain/服务域 | `yonbip-cpu-lawbid` |
| schema | `cpu_lawbid` |
| 所属应用 | `ycSouringBid` |
| 构建时间 | `2026-06-04 20:16:59.7500` |
...
| # | 字段名 | 显示名 | 数据库列 | 类型 |
|---|--------|--------|---------|------|
| 1 | `bidPaymentCode` | 标书费缴纳方式 | `bid_payment_code` | String |
| 2 | `bidPaymentId` | 标书费缴纳方式 | `bid_payment_id` | c88936ac-b4d4-4f31-b90e-eca5f8037e4b |
