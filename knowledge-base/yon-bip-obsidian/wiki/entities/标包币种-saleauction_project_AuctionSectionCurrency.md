---
tags: ["BIP", "元数据", "数据字典", "ycAuction", "saleauction.project.AuctionSectionCurrency"]
created: 2026-06-04
updated: 2026-06-04
...
# 标包币种 (`saleauction.project.AuctionSectionCurrency`)

> ycAuction | 物理表：`cpu_section_currency`
...
| 4 | `bidSectionId` | 标段包 | `bid_section_id` | 052621d8-fde7-4ab0-94bf-b179c720ce6d |
...
| 5 | `bidSectionId` | 标段包 | `saleauction.project.AuctionSection` | None | true |
