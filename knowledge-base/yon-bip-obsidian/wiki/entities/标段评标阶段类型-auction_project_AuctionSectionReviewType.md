---
tags: ["BIP", "元数据", "数据字典", "ycSouringAuction", "auction.project.AuctionSectionReviewType"]
created: 2026-06-04
updated: 2026-06-04
...
# 标段评标阶段类型 (`auction.project.AuctionSectionReviewType`)

> ycSouringAuction | 物理表：`cpu_project_section_reviewtype`
...
| # | 字段名 | 显示名 | 数据库列 | 类型 |
|---|--------|--------|---------|------|
| 1 | `bidStageId` | 阶段id | `bid_stage_id` | a8264d86-da54-48d2-a367-6fdf3ab26bbf |
...
| 3 | `bidStageId` | 阶段id | `auction.project.AuctionSectionStage` | None | true |
