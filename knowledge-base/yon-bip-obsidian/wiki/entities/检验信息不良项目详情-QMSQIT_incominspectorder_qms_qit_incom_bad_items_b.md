---
tags: ["BIP", "元数据", "数据字典", "QMSQIT", "QMSQIT.incominspectorder.qms_qit_incom_bad_items_b"]
created: 2026-06-05
updated: 2026-06-05
...
# 检验信息不良项目详情 (`QMSQIT.incominspectorder.qms_qit_incom_bad_items_b`)
...
| 12 | `resultId` | 处理结果id | `result_id` | b8617523-4895-4d63-9586-3a1ba9eafaeb |
...
| # | 字段名 | 显示名 | 目标实体 | 隔离级 | 组合 |
|---|--------|--------|---------|--------|------|
| 1 | `resultId` | 处理结果id | `QMSQIT.incominspectorder.qms_qit_incominspectorder_result` | None |  |
...
| 5 | `pk_baseinspectorder_b` | 检验信息id | `QMSQIT.incominspectorder.qms_qit_incominspectorder_b` | None | true |
