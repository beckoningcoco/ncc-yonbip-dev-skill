---
tags: ["BIP", "元数据", "数据字典", "IMPSFC", "sfc.proceTaskReport.proceTaskReportLineSn"]
created: 2026-06-05
updated: 2026-06-05
...
# 汇报信息序列号明细 (`sfc.proceTaskReport.proceTaskReportLineSn`)
...
| 4 | `childId` | 工序任务汇报明细id | `sfc.proceTaskReport.ProceTaskReportDetail` | None |  |
