---
tags: ["BIP", "元数据", "数据字典", "ycSouringBid", "lawbid.noticetemplate.NoticeTemplateMaterialCategory"]
created: 2026-06-04
updated: 2026-06-04
...
# 物料分类子表 (`lawbid.noticetemplate.NoticeTemplateMaterialCategory`)

> **平台版本：BIP 旗舰版 V5**

> ycSouringBid 模块 | 物理表：`cpu_notice_template_material_category`
...
|------|-----|
| 显示名 | 物料分类子表 |
| 物理表 | `cpu_notice_template_material_category` |
| domain/服务域 | `yonbip-cpu-lawbid` |
| schema | `cpu_lawbid` |
| 所属应用 | `ycSouringBid` |
| 构建时间 | `2026-06-04 20:16:37.5640` |
...
| 7 | `materialCategoryId` | 适用物料一级分类 | `material_category_id` | b295ef54-c421-4865-aca3-f5a9207a8d50 |
...
| 2 | `materialCategoryId` | 适用物料一级分类 | `pc.cls.ManagementClass` | Service |  |
