---
tags: ["BIP", "元数据", "数据字典", "ycPriceCenter", "cpubase.quota.GoodsStrategyChm"]
created: 2026-06-04
updated: 2026-06-04
...
# 物料自由项特征组 (`cpubase.quota.GoodsStrategyChm`)

> ⚡ **平台版本：BIP 旗舰版 V5** — 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。

> YonBIP ycPriceCenter 模块实体元数据字典。
> 物理表：`cpu_gdstrgy_chm` | 所属应用：`ycPriceCenter`
> 来源：元数据API `queryByUri` 返回的 `cpubase.quota.GoodsStrategyChm` 实体完整定义。
...
| 所属应用 | `ycPriceCenter` |
| 业务对象ID | `6907356c-b8d3-41eb-a59d-ba5a5c610ae0` |
| 元数据类型 | `Class` |
| 元数据层级 | `2` |
| 是否业务对象 | `true` |
| 构建时间 | `2026-06-04 16:18:28.9810` |
