---
tags: ["BIP", "元数据", "数据字典", "ycPriceCenter", "cpubase.supplycategoryapplication.SupplycategoryApplicationCharacteristicsDefine"]
created: 2026-06-04
updated: 2026-06-04
...
# 物料自由项特征组 (`cpubase.supplycategoryapplication.SupplycategoryApplicationCharacteristicsDefine`)

> ⚡ **平台版本：BIP 旗舰版 V5** — 仅适用于用友 BIP 旗舰版（YonBIP），不适用于 NCC / NC Cloud 高级版。

> YonBIP ycPriceCenter 模块实体元数据字典。
> 物理表：`cpu_supply_appli_characterdef` | 所属应用：`ycPriceCenter`
> 来源：元数据API `queryByUri` 返回的 `cpubase.supplycategoryapplication.SupplycategoryApplicationCharacteristicsDefine` 实体完整定义。
...
|------|-----|
| 显示名 | 物料自由项特征组 |
| 物理表 | `cpu_supply_appli_characterdef` |
| domain/服务域 | `cpu-base` |
| schema | `cpu_baseservice` |
| 所属应用 | `ycPriceCenter` |
| 业务对象ID | `001168cf-bc35-46ee-aa36-e137d131ecda` |
| 元数据类型 | `Class` |
| 元数据层级 | `2` |
| 是否业务对象 | `true` |
| 构建时间 | `2026-06-04 16:19:04.4960` |
...
- **安装来源**: `/app/data_scripts/yonbip-cpu-bcprice/scripts/db/patch/mongodb/V5_R0_2507/0001_yonbip-cpu-bcprice/0010_iuap_common/DML/0270_iuap_metadata/202604031341_metadata_cpubase-supplycategoryapplication_delta.zip`
- **安装人**: mongoTools
- **安装排名**: `bd21f3f1-a600-430c-be72-67fb3a322634`

## 术语标记

`BusinessData`, `isAssigned`, `isExtend`, `CG::ctxType::pc.product.Product`
...
| 107 | `dr` | 逻辑删除标记 | `dr` | Short | `short` |  | ✓ |
| 108 | `gjh001` | gjh颜色 | `vcol17` | 95e0e489-251a-4bac-b4e8-9103a3687b5b | `quote` |  |  |
| 109 | `hl01` | 韩磊特征（颜色） | `vcol43` | String | `text` |  |  |
| 110 | `hl02` | 韩磊特征（材质） | `vcol44` | String | `text` |  |  |
| 111 | `hl03` | 韩磊特征客户 | `lcol1` | 94b3280a-27a4-485a-b90b-b7bce57c6df2 | `quote` |  |  |
| 112 | `hl888` | hl测试01 | `lcol2` | 94b3280a-27a4-485a-b90b-b7bce57c6df2 | `quote` |  |  |
| 113 | `hl99` | hl测试02 | `vcol1` | String | `text` |  |  |
| 114 | `hncs15` | 预付款比例 | `ncol47` | Decimal | `number` |  |  |
| 115 | `hncs21` | 质保金比例 | `ncol45` | Decimal | `number` |  |  |
| 116 | `hncs25` | 履约保证金（保函） | `ncol46` | Decimal | `number` |  |  |
| 117 | `hq` | 韩琦2 | `vcol38` | 821ea9e7-d7ee-4a8f-af1c-89faadf18e5f | `quote` |  |  |
| 118 | `hw01` | hw颜色 | `vcol27` | 2a526d09-2ee7-4def-830f-a8671754c449 | `quote` |  |  |
| 119 | `id` | ID | `id` | String | `text` |  | ✓ |
| 120 | `jewellery04` | 珠宝尺寸 | `vcol53` | 9361525d-3def-44d1-8e27-7407f8c6aace | `quote` |  |  |
| 121 | `jhh111` | 1111 | `vcol48` | cbf21359-2e4f-4193-aa3b-954a283264ea | `quote` |  |  |
| 122 | `jhhtz` | 江欢欢颜色 | `vcol45` | String | `text` |  |  |
| 123 | `lang_C` | lang_C——数值 | `ncol1` | Decimal | `number` |  |  |
| 124 | `lang_Cr` | Cr——数值范围 | `bcol1,ncol2,ncol3` | Composite | `decimalRange` |  |  |
| 125 | `lang_S` | S——文本 | `vcol25` | String | `text` |  |  |
| 126 | `lang_Si` | Si——基础档案 | `vcol26` | 0807260c-f881-4419-9dab-a412fad4e530 | `quote` |  |  |
| 127 | `lang_xingtai` | lang_形态 | `vcol42` | 3f217f17-98bb-428b-8a02-baa3bc2a7358 | `quote` |  |  |
| 128 | `ld001` | ld颜色 | `vcol23` | 9cc7f067-79f2-4fb7-8856-393de5f27c43 | `quote` |  |  |
| 129 | `ld001_ps` | 配送方式 | `vcol39` | 7d54cadd-7029-43cf-88f7-bc7215c06fb3 | `quote` |  |  |
| 130 | `ld002` | ld容积 | `vcol24` | bc04edae-28ab-4021-b5bd-2efa001a5995 | `quote` |  |  |
| 131 | `ld002_ys` | 中转 | `vcol36` | String | `text` |  |  |
| 132 | `ld003_ys` | 车号 | `vcol37` | String | `text` |  |  |
| 133 | `ld004_sl` | 供方重量（吨） | `ncol4` | Decimal | `number` |  |  |
| 134 | `ld005_sl` | 到厂重量（吨） | `ncol5` | Decimal | `number` |  |  |
| 135 | `ld006_sl` | 袋数（件） | `ncol6` | Decimal | `number` |  |  |
| 136 | `ld007_sl` | 扣袋重 | `ncol7` | Decimal | `number` |  |  |
| 137 | `ld008_sl` | 供方扣后（吨） | `ncol8` | Decimal | `number` |  |  |
| 138 | `ld009_sl` | 到厂扣后（吨） | `ncol9` | Decimal | `number` |  |  |
| 139 | `ld010_zl` | 厂家Cr | `ncol14` | Decimal | `number` |  |  |
| 140 | `ld011_zl` | 厂家水分 | `ncol15` | Decimal | `number` |  |  |
| 141 | `ld012_zl` | 厂检Cr | `ncol10` | Decimal | `number` |  |  |
| 142 | `ld013_zl` | 厂检Si | `ncol12` | Decimal | `number` |  |  |
| 143 | `ld014_zl` | 厂检水分 | `ncol11` | Decimal | `number` |  |  |
| 144 | `ld015_zl` | 厂检杂质 | `ncol13` | Decimal | `number` |  |  |
| 145 | `ld016_js` | 基价基准 | `vcol38` | ld001_mj | `singleOption` |  |  |
| 146 | `ld019` | Cr含量允差 | `ncol18` | Decimal | `number` |  |  |
| 147 | `ld020` | Cr含量上限 | `ncol19` | Decimal | `number` |  |  |
| 148 | `ld021` | Cr含量下限 | `ncol20` | Decimal | `number` |  |  |
| 149 | `ld022` | 小粒度尺寸 | `vcol45` | 5c76fdab-5726-4d1a-8875-361e54ce35ca | `quote` |  |  |
| 150 | `ld031` | 折算铬含量 | `lcol3` | Long | `long` |  |  |
| 151 | `ld032` | 厂检C | `ncol21` | Decimal | `number` |  |  |
| 152 | `ld033` | 生产粒度 | `vcol46` | 5c76fdab-5726-4d1a-8875-361e54ce35ca | `quote` |  |  |
| 153 | `ld034` | 结算铬含量（作废） | `ncol22` | Decimal | `number` |  |  |
| 154 | `ld040` | 铬含量 | `vcol47` | String | `text` |  |  |
| 155 | `ld041` | 炉号 | `vcol55` | 550a2b87-31d9-4047-b751-4d6965f09b2f | `quote` |  |  |
| 156 | `lh` | lh | `vcol23` | String | `text` |  |  |
| 157 | `lh1` | lh1 | `vcol24` | ba0099c0-4280-47f5-b846-47bc44fd30d4 | `quote` |  |  |
| 158 | `liuyut001` | liuyut颜色 | `vcol36` | f82aa598-cb1c-48b5-bb91-bf9334692c09 | `quote` |  |  |
| 159 | `ljn` | ljn颜色 | `vcol9` | f21507b6-9191-4d2d-aa27-a2b23d0e046d | `quote` |  |  |
| 160 | `lrj001` | lrj颜色 | `vcol11` | c2b547f5-e622-4d56-a053-c5c4533f69ee | `quote` |  |  |
| 161 | `lrj002` | lrj尺码 | `vcol12` | 4460118a-94af-4d65-83c2-c984da504432 | `quote` |  |  |
| 162 | `lzxqfl001` | 绿洲需求分类 | `vcol43` | f48843cb-7ad2-47c8-a0f4-bb451e90022d | `quote` |  |  |
| 163 | `miao` | 喵 | `vcol52` | String | `text` |  |  |
| 164 | `msn01` | msn颜色 | `vcol48` | e3617ad3-89ae-44b9-b305-2491b6a2d01e | `quote` |  |  |
| 165 | `myt01` | myt尺寸 | `vcol15` | a0df3b99-226a-42fc-b70c-cfff49f70e19 | `quote` |  |  |
| 166 | `pubts` | 时间戳 | `pubts` | DateTime | `dateTime` |  | ✓ |
| 167 | `qjq01` | qjq-颜色 | `vcol13` | bc531bc3-ceb1-4c7e-8e07-c570782db2ad | `quote` |  |  |
| 168 | `qjqys01` | 秦俊琪特征-颜色 | `vcol9` | 26913d22-b122-4da0-8c29-46871318e603 | `quote` |  |  |
| 169 | `shin` | 史楠特征 | `vcol55` | bc531bc3-ceb1-4c7e-8e07-c570782db2ad | `quote` |  |  |
| 170 | `smx003` | 颜色smx | `vcol38` | 411ac286-9474-466a-9ba0-c1875dc8b4c2 | `quote` |  |  |
| 171 | `swedrftg` | 李文梁-颜色 | `vcol52` | 4fe1a778-ebb6-479d-986b-eb7c6a7c1693 | `quote` |  |  |
| 172 | `sww01` | 师文文衣服尺码 | `vcol4` | 32545b61-2088-4066-b12a-a28f6c5240a7 | `quote` |  |  |
| 173 | `sxdtzys` | 施学达颜色 | `vcol49` | d42794f5-f5ae-46df-bce3-aba95312866b | `quote` |  |  |
| 174 | `sz03` | 四组03 | `bcol2,ncol28,ncol29` | Composite | `decimalRange` |  |  |
| 175 | `szzlj` | szlj | `vcol48` | String | `text` |  |  |
| 176 | `szzlj01` | szzlj01 | `vcol49` | fe86cb03-0d41-43ad-9c7f-4aca1a1298b0 | `quote` |  |  |
| 177 | `test04` | 车身颜色 | `vcol18` | e46a9525-c982-40bd-870d-1dfceb4609b2 | `quote` |  |  |
| 178 | `tz76` | 76C含量作废 | `vcol16` | String | `text` |  |  |
| 179 | `tz7601` | 76Cr含量作废 | `vcol17` | String | `text` |  |  |
| 180 | `tz7603` | 76C含量 | `vcol18` | b852ade3-74e0-4406-b424-1f0870327bce | `quote` |  |  |
| 181 | `tz7604` | 76Cr含量 | `vcol19` | 1f8f4f1c-11d9-427c-ad88-fbd49105cdd9 | `quote` |  |  |
| 182 | `water` | 水分（bailh） | `ncol35` | Decimal | `number` |  |  |
| 183 | `wh002` | 硝石含铁量1 | `ncol27` | Decimal | `number` |  |  |
| 184 | `wh101` | 吴贺-颜色 | `vcol14` | 08469985-f3f3-4458-ad73-2401d40f67a3 | `quote` |  |  |
| 185 | `wjp001` | 吴洁鹏颜色 | `vcol36` | 7470aafb-ef5b-4e18-97de-f56e2ae2103e | `quote` |  |  |
| 186 | `wjp002` | 吴洁鹏特征2 | `vcol50` | 950c3760-f399-4e96-a1e4-a58e587295f7 | `quote` |  |  |
| 187 | `wtt` | 颜色wtt | `vcol42` | d0b34ccf-7821-489e-924f-dd32f0f44c23 | `quote` |  |  |
| 188 | `ww` | ww颜色 | `vcol18` | String | `text` |  |  |
| 189 | `wwh` | 王伟恒-颜色 | `vcol22` | e3133654-88ee-4c3c-89fe-ca0a0e19966e | `quote` |  |  |
| 190 | `wxc01` | 衣服尺码特征-位雪纯 | `vcol54` | 9fa9692d-c29d-4bbf-822f-24b95a2e5367 | `quote` |  |  |
| 191 | `wxptz` | wxpt颜色特征 | `vcol6` | 84991e7f-8fcf-4c8f-ac7c-b98cd9e80fa4 | `quote` |  |  |
| 192 | `wxwdc01` | wxwdc颜色 | `vcol51` | 821ea9e7-d7ee-4a8f-af1c-89faadf18e5f | `quote` |  |  |
| 193 | `wxwdc02` | 颜色2 | `vcol53` | 3ace5926-d270-41e6-963d-72ecc30a6225 | `quote` |  |  |
| 194 | `xb` | 性别1111 | `vcol31` | 042eb375-2f1e-4721-b473-a14fd2749c49 | `quote` |  |  |
| 195 | `xwl01` | xwl_尺码 | `vcol47` | 4255ccda-3cab-44d6-98ac-7c941ca5d329 | `quote` |  |  |
| 196 | `yd01` | 烨铎颜色 | `vcol17` | b22e8c35-c529-4ca7-8e63-2fc30615f4d0 | `quote` |  |  |
| 197 | `yjxys` | 袁杰西颜色 | `vcol2` | ed507093-1f07-4fdb-99cf-f816565b149f | `quote` |  |  |
| 198 | `yjy001` | yjy特征1 | `vcol54` | String | `text` |  |  |
| 199 | `yjy002` | yjy特征2 | `vcol55` | String | `text` |  |  |
| 200 | `yjy003` | yjy颜色 | `vcol1` | 8b6f59cd-6fb8-4eeb-8ecb-af1c923ff01f | `quote` |  |  |
| 201 | `yswxgqg` | 颜色wxgqg | `vcol24` | 81acc8cf-5200-456a-bba6-c46786d99184 | `quote` |  |  |
| 202 | `ytenant` | 租户id | `ytenant_id` | e4933a03-9dea-472b-a644-cdd654222f45 | `quote` | ✓ | ✓ |
| 203 | `yxh00001` | 余量宽度 | `ncol43` | Decimal | `number` |  |  |
| 204 | `yxh00002` | 余料长度 | `ncol42` | Decimal | `number` |  |  |
| 205 | `zfj` | 颜色zfj | `vcol3` | e80a9509-a699-40e2-b6e4-d5e87294db5e | `quote` |  |  |
| 206 | `zjj01` | zjj档案 | `vcol14` | cf891e2e-0b7a-49aa-acf7-6bd8fed2f3d9 | `quote` |  |  |
| 207 | `zlj01` | 周丽娇特征颜色 | `vcol12` | String | `text` |  |  |
| 208 | `zlj02` | zlj02 | `vcol13` | fe86cb03-0d41-43ad-9c7f-4aca1a1298b0 | `quote` |  |  |
| 209 | `zouj01` | A特征 | `vcol39` | String | `text` |  |  |
| 210 | `zouj02` | B特征 | `vcol40` | String | `text` |  |  |
| 211 | `zoujj` | zouj自定义档案 | `vcol41` | cb7846d8-c684-4a2f-8411-4e7a3798a05c | `quote` |  |  |
| 212 | `zqdyanse` | zqd颜色 | `vcol32` | 12949f86-a911-456b-b6a1-0acc521cc3c7 | `quote` |  |  |
| 213 | `zrt01` | zrt颜色 | `vcol46` | 96b2bb54-11c6-4fed-aa4b-e2f72c6c1d96 | `quote` |  |  |
| 214 | `zx001` | 赵鑫颜色特征 | `vcol51` | String | `text` |  |  |
| 215 | `zxftz01` | zxf颜色 | `vcol51` | 0091e929-53f6-4f63-b14c-1d0f36a6bd17 | `quote` |  |  |
| 216 | `zxw0001` | zxw0001 | `vcol15` | String | `text` |  |  |
| 217 | `zxw0002` | zxw0002 | `vcol16` | bc531bc3-ceb1-4c7e-8e07-c570782db2ad | `quote` |  |  |
| 218 | `zy001` | 朱阳-是否 | `bcol3` | Boolean | `switch` |  |  |
| 219 | `zzx` | 周正旭-颜色 | `vcol12` | String | `text` |  |  |
| 220 | `zzxtz` | 周正旭-颜色1 | `vcol13` | 16050e70-0b6d-473b-aa1c-6f06110bf239 | `quote` |  |  |
| 221 | `zzy` | zzy特征 | `vcol8` | 082aa70f-4ea5-48fa-9654-a5a73d98d2bf | `quote` |  |  |
