---
tags: ["BIP", "元数据", "数据字典", "MR", "mr.matchingRule.CharactorMatchingRuleDetail"]
created: 2026-06-05
updated: 2026-06-05
...
# 特征匹配规则子表 (`mr.matchingRule.CharactorMatchingRuleDetail`)

> MR | 物理表：`mr_charactor_macthing_rule_detail`
...
|------|-----|
| 显示名 | 特征匹配规则子表 |
| 物理表 | `mr_charactor_macthing_rule_detail` |
| domain/服务域 | `yonbip-mm-plan` |
| schema | `requirements_planning` |
| 所属应用 | `MR` |
| 构建时间 | `2026-06-05 15:15:50.8950` |
...
| 3 | `id` | ID | `id` | Long |
| 4 | `charactorMatchingId` | 外键id | `charactor_match_id` | bbd7a4a0-f927-47e1-b81b-103252799180 |
...
| 5 | `charactorMatchingId` | 外键id | `mr.matchingRule.CharactorMatchingRule` | None | true |
