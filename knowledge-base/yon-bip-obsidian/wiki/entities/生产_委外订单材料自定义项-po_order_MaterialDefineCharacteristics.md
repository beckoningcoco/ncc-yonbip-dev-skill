---
tags: ["BIP", "元数据", "数据字典", "PO", "po.order.MaterialDefineCharacteristics"]
created: 2026-06-05
updated: 2026-06-05
...
# 生产/委外订单材料自定义项 (`po.order.MaterialDefineCharacteristics`)

> PO | 物理表：`po_order_material_dct`
...
|------|-----|
| 显示名 | 生产/委外订单材料自定义项 |
| 物理表 | `po_order_material_dct` |
| 数据库 schema | `productionorder` |
| 所属应用 | `PO` |
| 构建时间 | `2026-06-05 09:25:30.6220` |
