---
tags: ["BIP", "元数据", "数据字典", "PO", "po.order.ByProductDefineCharacteristics"]
created: 2026-06-05
updated: 2026-06-05
...
# 生产/委外订单联副自定义项 (`po.order.ByProductDefineCharacteristics`)

> PO | 物理表：`po_order_byproduct_dct`
...
|------|-----|
| 显示名 | 生产/委外订单联副自定义项 |
| 物理表 | `po_order_byproduct_dct` |
| 数据库 schema | `productionorder` |
| 所属应用 | `PO` |
| 构建时间 | `2026-06-05 09:22:52.5600` |
