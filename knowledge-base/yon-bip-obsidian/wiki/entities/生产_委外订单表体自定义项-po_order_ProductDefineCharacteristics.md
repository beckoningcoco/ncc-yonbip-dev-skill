---
tags: ["BIP", "元数据", "数据字典", "PO", "po.order.ProductDefineCharacteristics"]
created: 2026-06-05
updated: 2026-06-05
...
# 生产/委外订单表体自定义项 (`po.order.ProductDefineCharacteristics`)

> PO | 物理表：`po_order_product_dct`
...
|------|-----|
| 显示名 | 生产/委外订单表体自定义项 |
| 物理表 | `po_order_product_dct` |
| domain/服务域 | `productionorder` |
| 所属应用 | `PO` |
| 构建时间 | `2026-06-05 09:25:51.1190` |
