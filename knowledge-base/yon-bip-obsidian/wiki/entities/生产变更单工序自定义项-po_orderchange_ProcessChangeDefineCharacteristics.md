---
tags: ["BIP", "元数据", "数据字典", "PO", "po.orderchange.ProcessChangeDefineCharacteristics"]
created: 2026-06-05
updated: 2026-06-05
...
# 生产变更单工序自定义项 (`po.orderchange.ProcessChangeDefineCharacteristics`)

> PO | 物理表：`po_order_process_change_dct`
...
|------|-----|
| 显示名 | 生产变更单工序自定义项 |
| 物理表 | `po_order_process_change_dct` |
| domain/服务域 | `productionorder` |
| 所属应用 | `PO` |
| 构建时间 | `2026-06-05 09:35:33.3960` |
