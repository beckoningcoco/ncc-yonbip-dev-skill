---
tags: ["BIP", "元数据", "数据字典", "PO", "po.orderchange.ByProductChangeDefineCharacteristics"]
created: 2026-06-05
updated: 2026-06-05
...
# 生产变更单联副产品自定义项 (`po.orderchange.ByProductChangeDefineCharacteristics`)

> PO | 物理表：`po_order_byproduct_change_dct`
...
|------|-----|
| 显示名 | 生产变更单联副产品自定义项 |
| 物理表 | `po_order_byproduct_change_dct` |
| 数据库 schema | `productionorder` |
| 所属应用 | `PO` |
| 构建时间 | `2026-06-05 09:35:10.8220` |
