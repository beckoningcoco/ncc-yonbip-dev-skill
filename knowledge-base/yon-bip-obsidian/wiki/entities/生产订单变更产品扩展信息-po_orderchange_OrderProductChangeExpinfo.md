---
tags: ["BIP", "元数据", "数据字典", "PO", "po.orderchange.OrderProductChangeExpinfo"]
created: 2026-06-05
updated: 2026-06-05
...
# 生产订单变更产品扩展信息 (`po.orderchange.OrderProductChangeExpinfo`)

> PO | 物理表：`po_order_product_change_expinfo`
...
|------|-----|
| 显示名 | 生产订单变更产品扩展信息 |
| 物理表 | `po_order_product_change_expinfo` |
| domain/服务域 | `productionorder` |
| 所属应用 | `PO` |
| 构建时间 | `2026-06-05 09:35:30.5120` |

## 主键与编码

| 角色 | 字段名 | 类型 | 说明 |
|------|--------|------|------|
| 主键 | `id` | fbe0dedd-7f73-4c6b-91f0-6cd861f75f4f | 生产订单变更产品ID |
...
| 3 | `id` | 生产订单变更产品ID | `id` | fbe0dedd-7f73-4c6b-91f0-6cd861f75f4f |
...
| 2 | `id` | 生产订单变更产品ID | `po.orderchange.OrderProductChange` | None | true |
