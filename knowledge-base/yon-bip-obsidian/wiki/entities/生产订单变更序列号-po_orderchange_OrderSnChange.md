---
tags: ["BIP", "元数据", "数据字典", "PO", "po.orderchange.OrderSnChange"]
created: 2026-06-05
updated: 2026-06-05
...
# 生产订单变更序列号 (`po.orderchange.OrderSnChange`)

> PO | 物理表：`po_order_sn_change`
...
|------|-----|
| 显示名 | 生产订单变更序列号 |
| 物理表 | `po_order_sn_change` |
| domain/服务域 | `productionorder` |
| 所属应用 | `PO` |
| 构建时间 | `2026-06-05 09:35:31.9950` |
...
| 34 | `orderId` | 订单id | `order_id` | Long |
| 35 | `orderProductId` | 产品id | `order_product_id` | fbe0dedd-7f73-4c6b-91f0-6cd861f75f4f |
| 36 | `orderProductLineNo` | 产品行号 | `order_product_line_no` | Decimal |
| 37 | `originalOrderId` | 原单id | `original_order_id` | b80026c8-0517-4255-aca1-b7f374771eb6 |
| 38 | `originalOrderProductId` | 原单产品id | `original_order_product_id` | 8eadf170-a715-41e1-b654-51ef707f7e90 |
| 39 | `originalOrderSnId` | 原序列号id | `original_order_sn_id` | Long |
| 40 | `presnstate` | 序列号上一状态 | `creSNstate` | String |
| 41 | `pubts` | 时间戳 | `pubts` | DateTime |
| 42 | `rowno` | 行号(序列号接口) | `rowno` | Decimal |
| 43 | `sn` | 序列号 | `csn_code` | String |
| 44 | `snCharacteristics` | 自由项特征组 | `sn_characteristics` | 481719e7-3845-41ef-a0db-83561314721c |
| 45 | `snstate` | 序列号状态 | `cSNstate` | String |
| 46 | `sourcebillsnid` | 来源序列号行id | `iSourceBillSNId` | Long |
| 47 | `updatecount` | 序列号更新次数 | `iUpdateCount` | Integer |
...
| 3 | `snCharacteristics` | 自由项特征组 | `po.orderchange.SnCharacteristics` | None |  |
| 4 | `ytenant` | 租户id | `yht.tenant.YhtTenant` | Service |  |
| 5 | `orderProductId` | 产品id | `po.orderchange.OrderProductChange` | None | true |
