---
tags: ["BIP", "元数据", "数据字典", "INPAPI", "iuap-api-management.A33_AppMngCompoment.openAppServiceWx"]
created: 2026-06-05
updated: 2026-06-05
...
# 生态应用微信服务信息表 (`iuap-api-management.A33_AppMngCompoment.openAppServiceWx`)

> INPAPI | 物理表：`open_app_service_wx`
...
|------|-----|
| 显示名 | 生态应用微信服务信息表 |
| 物理表 | `open_app_service_wx` |
| domain/服务域 | `iuap-ipaas-base` |
| 所属应用 | `INPAPI` |
| 构建时间 | `2026-06-05 18:03:58.4590` |
