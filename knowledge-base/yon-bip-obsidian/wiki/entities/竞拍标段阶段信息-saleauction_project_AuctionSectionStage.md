---
tags: ["BIP", "元数据", "数据字典", "ycAuction", "saleauction.project.AuctionSectionStage"]
created: 2026-06-04
updated: 2026-06-04
...
# 竞拍标段阶段信息 (`saleauction.project.AuctionSectionStage`)

> ycAuction | 物理表：`cpu_section_stage_info`
...
| 7 | `bidSectionId` | 标段ID | `bid_section_id` | 052621d8-fde7-4ab0-94bf-b179c720ce6d |
...
| 26 | `reviewTypes` | 标段评标阶段类型 | `` | 05168c80-bc13-4f5f-9a94-8840768c1530 |
| 27 | `sectionStatus` | 标包状态 | `section_status` | String |
...
| 2 | `reviewTypes` | 标段评标阶段类型 | `saleauction.project.AuctionSectionReviewType` | None | true |
| 3 | `enterpriseId` | 所属租户id | `cpu-privilege.enterprise.EnterprisePOJO` | Service |  |
| 4 | `bidSectionId` | 标段ID | `saleauction.project.AuctionSection` | None | true |
