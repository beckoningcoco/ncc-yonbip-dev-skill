---
tags: ["BIP", "元数据", "数据字典", "DCRP", "cmp.algorithm.AlgImplParameter"]
created: 2026-06-05
updated: 2026-06-05
...
# 算法实现清单参数 (`cmp.algorithm.AlgImplParameter`)
...
| 4 | `algorithmImplId` | 算法实现ID | `cmp.algorithm.AlgorithmImpl` | None | true |
| 5 | `algorithmId` | 算法清单ID | `cmp.algorithm.Algorithm` | None |  |
