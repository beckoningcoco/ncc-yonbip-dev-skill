---
tags: ["BIP", "元数据", "数据字典", "ycBase", "sourcing.businessRuleSolution.BusinessRuleApplyScopeLawbidPurchase"]
created: 2026-06-04
updated: 2026-06-04
...
# 管控策略-采购方式 (`sourcing.businessRuleSolution.BusinessRuleApplyScopeLawbidPurchase`)

> ycBase | 物理表：`cpu_business_rule_control_strategy_lawbid_purchase`
...
|------|-----|
| 显示名 | 管控策略-采购方式 |
| 物理表 | `cpu_business_rule_control_strategy_lawbid_purchase` |
| domain/服务域 | `cpu-base` |
| schema | `cpu_baseservice` |
| 所属应用 | `ycBase` |
| 构建时间 | `2026-06-04 23:10:23.8210` |
...
| 6 | `purchaseId` | 采购方式id | `purchase_id` | 81c6880b-694a-4667-987f-81b5615f2401 |
