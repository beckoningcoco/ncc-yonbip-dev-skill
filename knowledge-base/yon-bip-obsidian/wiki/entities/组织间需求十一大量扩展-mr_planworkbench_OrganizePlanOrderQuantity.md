---
tags: ["BIP", "元数据", "数据字典", "MR", "mr.planworkbench.OrganizePlanOrderQuantity"]
created: 2026-06-05
updated: 2026-06-05
...
# 组织间需求十一大量扩展 (`mr.planworkbench.OrganizePlanOrderQuantity`)
...
| 所属应用 | `MR` |
| 构建时间 | `2026-06-05 15:16:22.8830` |

## 主键与编码

| 角色 | 字段名 | 类型 | 说明 |
|------|--------|------|------|
| 主键 | `id` | ca87e2f6-7cd1-4afb-99cf-1d2cfbfd0777 | 计划订单id |
...
| 8 | `id` | 计划订单id | `id` | ca87e2f6-7cd1-4afb-99cf-1d2cfbfd0777 |
...
| 20 | `planOrderId` | 计划订单id | `plan_order_id` | ca87e2f6-7cd1-4afb-99cf-1d2cfbfd0777 |
...
| 4 | `id` | 计划订单id | `mr.planworkbench.OrganizePlanOrder` | None |  |
| 5 | `planOrderId` | 计划订单id | `mr.planworkbench.OrganizePlanOrder` | None | true |
