---
tags: ["BIP", "元数据", "数据字典", "IMP_PES", "pes.maintenanceLevel.MaintenanceLevel"]
created: 2026-06-05
updated: 2026-06-05
...
# 维保级别 (`pes.maintenanceLevel.MaintenanceLevel`)

> IMP_PES | 物理表：`sms_maintenance_level`
...
|------|-----|
| 显示名 | 维保级别 |
| 物理表 | `sms_maintenance_level` |
| 数据库 schema | `imppes` |
| 所属应用 | `IMP_PES` |
| 构建时间 | `2026-06-05 17:17:27.5690` |
