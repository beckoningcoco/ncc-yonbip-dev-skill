---
tags: ["BIP", "元数据", "数据字典", "ycSouringInquiry", "sourcing.pricedecision.TaxCalculationResult"]
created: 2026-06-04
updated: 2026-06-04
...
# 计税结果 (`sourcing.pricedecision.TaxCalculationResult`)
...
| # | 字段名 | 显示名 | 数据库列 | 类型 |
|---|--------|--------|---------|------|
| 1 | `TaxResultDetailList` | 计税结果明细 | `` | 84fe9a6e-24cf-49b6-8ef0-2236a18a1c47 |
...
| 32 | `sourcechildId` | 上游单据子表id | `sourcechild_id` | 5ad37a5c-0251-495d-8791-6c08a9d69254 |
...
| 7 | `TaxResultDetailList` | 计税结果明细 | `sourcing.pricedecision.TaxCalculationResultDetail` | None | true |
...
| 11 | `sourcechildId` | 上游单据子表id | `sourcing.pricedecision.PriceDecisionDetail` | None | true |
