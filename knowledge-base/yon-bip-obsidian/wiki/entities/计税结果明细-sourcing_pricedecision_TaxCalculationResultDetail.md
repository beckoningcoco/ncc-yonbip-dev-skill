---
tags: ["BIP", "元数据", "数据字典", "ycSouringInquiry", "sourcing.pricedecision.TaxCalculationResultDetail"]
created: 2026-06-04
updated: 2026-06-04
...
# 计税结果明细 (`sourcing.pricedecision.TaxCalculationResultDetail`)
...
| 9 | `hid` | 计税结果主表id | `hid` | 3efd0d21-9ca2-40c5-908e-0084854d42a0 |
| 10 | `id` | 主键 | `id` | String |
...
| # | 字段名 | 显示名 | 目标实体 | 隔离级 | 组合 |
|---|--------|--------|---------|--------|------|
| 1 | `hid` | 计税结果主表id | `sourcing.pricedecision.TaxCalculationResult` | None | true |
