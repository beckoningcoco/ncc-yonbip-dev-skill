---
tags: ["BIP", "元数据", "数据字典", "IMPSFC", "sfc.orderprocessstatus.OrderProcessStatistics"]
created: 2026-06-05
updated: 2026-06-05
...
# 订单工序按时间统计表 (`sfc.orderprocessstatus.OrderProcessStatistics`)

> IMPSFC | 物理表：`imp_sfc_order_process_stat`
...
|------|-----|
| 显示名 | 订单工序按时间统计表 |
| 物理表 | `imp_sfc_order_process_stat` |
| 数据库 schema | `IMP-SFC` |
| 所属应用 | `IMPSFC` |
| 构建时间 | `2026-06-05 09:20:52.3430` |
...
| 54 | `preId` | 前工序 | `pre_id` | 980e8d68-00ee-467f-bfd6-5fbd69855bd7 |
| 55 | `splitTurninNum` | 分割转入数量 | `split_turnin_num` | Decimal |
| 56 | `totalExecNum2` | 累计执行数量(产出) | `total_exec_num2` | Decimal |
| 57 | `totalExecNum1` | 累计执行件数 | `total_exec_num1` | Decimal |
| 58 | `totalQualifiedNum2` | 累计合格数量(产出) | `total_qualified_num2` | Decimal |
| 59 | `totalQualifiedNum1` | 累计合格件数 | `total_qualified_num1` | Decimal |
| 60 | `totalQualifiedNum` | 累计合格数量 | `total_qualified_num` | Decimal |
| 61 | `totalReworkTurninNum1` | 累计返工转入件数 | `total_rework_turnin_num1` | Decimal |
| 62 | `orgId` | 组织ID | `org_id` | 14302233-1394-4a70-94e1-bed51636f312 |
| 63 | `totalReworkTurninNum2` | 累计返工转入数量(产出) | `total_rework_turnin_num2` | Decimal |
| 64 | `splitTurnoutNum` | 分割转出数量 | `split_turnout_num` | Decimal |
| 65 | `staticDate` | 统计日期 | `static_date` | Date |
| 66 | `operationId` | 标准工序ID | `operation_id` | 5929debb-7319-44fb-8583-5c7d0d5af701 |
| 67 | `processType` | 加工类型 | `process_type` | Short |
| 68 | `totalReworkProcessNum` | 累计返工处理数量 | `total_re_pro_num` | Decimal |
| 69 | `orderLineNo` | 生产订单行号 | `order_line_no` | Decimal |
| 70 | `prodConversionRate` | 生产换算率 | `prod_conversion_rate` | Decimal |
| 71 | `totalReworkNum2` | 累计待返工数量(产出) | `total_rework_num2` | Decimal |
| 72 | `totalCompleteNum1` | 累计完成件数 | `total_complete_num1` | Decimal |
| 73 | `totalReworkNum1` | 累计待返工件数 | `total_rework_num1` | Decimal |
| 74 | `totalCompleteNum2` | 累计完成数量(产出) | `total_complete_num2` | Decimal |
| 75 | `totalTurninNum` | 累计转入数量 | `total_turnin_num` | Decimal |
| 76 | `totalTurninNum1` | 累计转入件数 | `total_turnin_num1` | Decimal |
| 77 | `totalTurninNum2` | 累计转入数量(产出) | `total_turnin_num2` | Decimal |
| 78 | `totalScrapNum2` | 累计报废数量(产出) | `total_scrap_num2` | Decimal |
| 79 | `splitTurnoutNum2` | 分割转出数量(产出) | `split_turnout_num2` | Decimal |
| 80 | `totalScrapNum1` | 累计报废件数 | `total_scrap_num1` | Decimal |
| 81 | `splitTurnoutNum1` | 分割转出件数 | `split_turnout_num1` | Decimal |
| 82 | `totalQualifiedTurnNum` | 累计合格转出数量 | `total_qualified_turn_num` | Decimal |
| 83 | `productionUnitId` | 生产单位 | `production_unit_id` | 9ea02a0b-3a48-4051-bcbe-59c7bcc7a25b |
| 84 | `totalReworkTurninNum` | 累计返工转入数量 | `total_rework_turnin_num` | Decimal |
| 85 | `executeOrgId` | 执行组织ID | `execute_org_id` | 14302233-1394-4a70-94e1-bed51636f312 |
| 86 | `splitTurninNum1` | 分割转入件数 | `split_turnin_num1` | Decimal |
| 87 | `splitTurninNum2` | 分割转入数量(产出) | `split_turnin_num2` | Decimal |
| 88 | `orderCode` | 生产订单号 | `order_code` | String |
