---
tags: ["BIP", "元数据", "数据字典", "ycSouringAuction", "auction.talks.ClarifyBidderVO"]
created: 2026-06-04
updated: 2026-06-04
...
# 谈判供应商表体 (`auction.talks.ClarifyBidderVO`)

> ycSouringAuction | 物理表：`cpu_clarify_bidder_detail`
...
|---|--------|--------|---------|------|
| 1 | `id` | 投标信息 | `id` | Long |
| 2 | `bidClarifyId` | 投标澄清 | `bid_clarify_id` | dffcae36-3871-4d90-9ec5-ed563f559bd9 |
...
| 13 | `sectionId` | 标段（包） | `section_id` | be269c23-7eb6-4029-ac01-781f16c75ec4 |
...
| 32 | `clarifyBidderDetailMaterials` | 供应商谈判物料表体 | `` | e0a9a572-ba78-475e-957b-d2283c3d6a34 |
...
| # | 字段名 | 显示名 | 目标实体 | 隔离级 | 组合 |
|---|--------|--------|---------|--------|------|
| 1 | `bidClarifyId` | 投标澄清 | `auction.talks.BidClarifyVO` | None | true |
| 2 | `ytenant` | 租户id | `yht.tenant.YhtTenant` | Service |  |
| 3 | `clarifyBidderDetailMaterials` | 供应商谈判物料表体 | `auction.talks.ClarifyMaterialVO` | None | true |
