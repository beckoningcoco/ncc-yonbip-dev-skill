---
tags: ["BIP", "元数据", "数据字典", "ycSouringAuction", "auction.talks.BidClarifyVO"]
created: 2026-06-04
updated: 2026-06-04
...
# 谈判单表头 (`auction.talks.BidClarifyVO`)

> ycSouringAuction | 物理表：`cpu_bid_clarify`
...
|---|--------|--------|---------|------|
| 1 | `id` | ID | `id` | Long |
| 2 | `projectId` | 招标项目 | `project_id` | 94b777ba-4855-4d81-a975-f6ab6b09f9a8 |
...
| 6 | `sectionId` | 标段（包） | `section_id` | be269c23-7eb6-4029-ac01-781f16c75ec4 |
...
| 28 | `clarifySetId` | 谈判设置 | `clarify_set_id` | 7923b17b-c6ca-4be3-85ac-6ffbc7326a74 |
...
| 39 | `BidClarifyDefineCharacter` | 谈判单表头自定义项 | `define_character_id` | 15bb7b4b-5fd6-40ed-8f1a-c3057253c7ac |
...
| 45 | `clarifyBidders` | 谈判供应商表体 | `` | 114e7542-f47d-408a-9b62-60eb271e4556 |
| 46 | `clarifyMaterialOffers` | 价格谈判回复表体 | `` | 333f0383-8261-4482-bc77-e85766d5bf1b |
...
| 51 | `headdefine` | 谈判单自定义项 | `` | d20c9ea0-8ba7-4c05-81cf-3e497526a1a5 |
...
| # | 字段名 | 显示名 | 目标实体 | 隔离级 | 组合 |
|---|--------|--------|---------|--------|------|
| 1 | `clarifyBidders` | 谈判供应商表体 | `auction.talks.ClarifyBidderVO` | None | true |
| 2 | `headdefine` | 谈判单自定义项 | `auction.talks.BidClarifyDefine` | None | true |
| 3 | `auditorId` | 审批人 | `base.user.User` | Service |  |
| 4 | `BidClarifyDefineCharacter` | 谈判单表头自定义项 | `auction.talks.BidClarifyDefineCharacter` | None |  |
| 5 | `transType` | 交易类型 | `bd.bill.TransType` | Service |  |
| 6 | `clarifySetId` | 谈判设置 | `auction.clarifySet.ClarifySet` | None |  |
| 7 | `ytenant` | 租户id | `yht.tenant.YhtTenant` | Service |  |
| 8 | `creatorId` | 创建人 | `base.user.User` | Service |  |
| 9 | `modifierId` | 修改人 | `base.user.User` | Service |  |
| 10 | `sectionId` | 标段（包） | `auction.project.AuctionSection` | None |  |
| 11 | `clarifyMaterialOffers` | 价格谈判回复表体 | `auction.talks.ClarifyMaterialOfferVO` | None | true |
