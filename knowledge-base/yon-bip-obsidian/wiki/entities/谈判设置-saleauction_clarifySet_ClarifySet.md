---
tags: ["BIP", "元数据", "数据字典", "saleauction.clarifySet.ClarifySet"]
created: 2026-06-04
updated: 2026-06-04
...
# 谈判设置 (`saleauction.clarifySet.ClarifySet`)
...
| 7 | `id` | id | `id` | Long |
| 8 | `bidSectionId` | 标段id | `bid_section_id` | 052621d8-fde7-4ab0-94bf-b179c720ce6d |
| 9 | `bidSectionCode` | 标段(包)编码 | `bid_section_code` | String |
| 10 | `bidProjectId` | 招标项目 | `bid_project_id` | 9f8b9356-4cd6-4ae7-8dc0-c84dfecdda07 |
...
| 3 | `bidProjectId` | 招标项目 | `saleauction.project.AuctionProject` | None |  |
