---
tags: ["BIP", "元数据", "数据字典", "QMSQTS", "QMSQTS.TraceabilityPool.WorkshopTraceabilityPoolSN"]
created: 2026-06-05
updated: 2026-06-05
...
# 车间作业追溯池序列号子表 (`QMSQTS.TraceabilityPool.WorkshopTraceabilityPoolSN`)

> QMSQTS | 物理表：`qms_qts_c_tracepool_sn`
...
|------|-----|
| 显示名 | 车间作业追溯池序列号子表 |
| 物理表 | `qms_qts_c_tracepool_sn` |
| domain/服务域 | `QMS-DFM` |
| schema | `qms_dfm` |
| 所属应用 | `QMSQTS` |
| 构建时间 | `2026-06-05 17:01:42.6470` |
...
| 2 | `workshopTPID` | 车间作业追溯池ID | `QMSQTS.TraceabilityPool.WorkshopTraceabilityPool` | None | true |
