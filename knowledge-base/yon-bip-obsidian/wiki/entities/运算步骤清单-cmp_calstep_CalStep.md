---
tags: ["BIP", "元数据", "数据字典", "DCRP", "cmp.calstep.CalStep"]
created: 2026-06-05
updated: 2026-06-05
...
# 运算步骤清单 (`cmp.calstep.CalStep`)

> DCRP | 物理表：`cmp_capacity_cal_step`
...
|------|-----|
| 显示名 | 运算步骤清单 |
| 物理表 | `cmp_capacity_cal_step` |
| domain/服务域 | `yonbip-mm-plan` |
| schema | `requirements_planning` |
| 所属应用 | `DCRP` |
| 构建时间 | `2026-06-05 13:58:22.1230` |
...
| 8 | `calProcess` | 过程 | `cal_process` | String |
| 9 | `isSystem` | 是否系统预制 | `is_system` | Short |
| 10 | `algorithmCode` | 算法编码 | `algorithm_code` | String |
| 11 | `isMustSelect` | 是否必选 | `is_must_select` | Short |
| 12 | `isSelect` | 是否选择 | `is_select` | Short |
...
| 21 | `enable` | 启用 | `enable` | sys_intboolean |
| 22 | `enablets` | 启用时间 | `enablets` | DateTime |
| 23 | `disablets` | 停用时间 | `disablets` | DateTime |
