---
tags: ["BIP", "元数据", "数据字典", "ED", "ed.mainformula.FormulaApplicableMaterial"]
created: 2026-06-05
updated: 2026-06-05
...
# 适用物料 (`ed.mainformula.FormulaApplicableMaterial`)
...
| 17 | `routingId` | 工艺路线ID | `routing_id` | fa7b101c-5065-4f13-88d2-e6742dadb164 |
...
| 2 | `routingId` | 工艺路线ID | `ed.mainformula.MainFormula` | None | true |
