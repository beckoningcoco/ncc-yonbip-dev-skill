---
tags: ["BIP", "元数据", "数据字典", "MR", "mr.salesforecastchange.SalesForecastChangeDetailOCT"]
created: 2026-06-05
updated: 2026-06-05
...
# 选配特征组 (`mr.salesforecastchange.SalesForecastChangeDetailOCT`)

> MR | 物理表：`mr_sales_forecast_change_detail_oct`
...
|------|-----|
| 显示名 | 选配特征组 |
| 物理表 | `mr_sales_forecast_change_detail_oct` |
| 数据库 schema | `requirementsplanning` |
| 所属应用 | `MR` |
| 构建时间 | `2026-06-05 15:18:22.6410` |
