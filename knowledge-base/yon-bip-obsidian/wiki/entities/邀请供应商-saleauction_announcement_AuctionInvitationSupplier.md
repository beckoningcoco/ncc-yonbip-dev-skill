---
tags: ["BIP", "元数据", "数据字典", "ycAuction", "saleauction.announcement.AuctionInvitationSupplier"]
created: 2026-06-04
updated: 2026-06-04
...
# 邀请供应商 (`saleauction.announcement.AuctionInvitationSupplier`)

> ycAuction | 物理表：`cpu_bid_invitation_supplier`
...
| 5 | `announcementId` | 公告ID | `announcement_id` | ba0cbbbd-ef81-4f06-9fb0-e40a40cde1fa |
...
| 12 | `supplierClassId` | 供应商分类 | `supplier_class_id` | String |
| 13 | `supplierAddress` | 供应商注册地址 | `supplier_address` | String |
| 14 | `suggestReason` | 供应商推荐理由 | `suggest_reason` | String |
...
| 20 | `supplierStatus` | 供应商状态 | `supplier_status` | String |
| 21 | `invitationStatus` | 邀请状态 | `invitation_status` | String |
| 22 | `sourceType` | 推荐供应商来源类型:抽取、指定 | `source_type` | String |
| 23 | `removeReason` | 移除供应商原因 | `remove_reason` | String |
| 24 | `drawCondition` | 抽取供应商的条件 | `draw_condition` | String |
| 25 | `multipleCurrentStage` | 当前招标阶段 | `multiple_current_stage` | Integer |
| 26 | `buyerTenant` | 采购商租户 | `buyer_tenant_id` | String |
| 27 | `dr` | 逻辑删除标记 | `dr` | Short |
| 28 | `lawbidSystemId` | 原始ID | `lawbid_system_id` | Long |
| 29 | `lawbidSystemType` | 原始表 | `lawbid_system_type` | String |
| 30 | `linkPersonCell` | 联系人电话 | `link_person_cell` | String |
| 31 | `linkPersonId` | 联系人ID | `link_person_id` | b94fa77c-2f2b-464c-96fb-d028543825ee |
| 32 | `linkPersonName` | 联系人名称 | `link_person_name` | String |
| 33 | `linkPersonmail` | 联系人邮箱 | `link_person_email` | String |
| 34 | `tenantId` | tenant租户 | `tenant_id` | String |
...
| 4 | `announcementId` | 公告ID | `saleauction.announcement.AuctionAnnouncement` | None | true |
