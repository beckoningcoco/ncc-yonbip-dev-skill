---
tags: ["BIP", "元数据", "数据字典", "ycContractManagement", "cpu-contract.contract.CTCharacterDefine"]
created: 2026-06-04
updated: 2026-06-04
...
# 采购合同表体物料自定义项 (`cpu-contract.contract.CTCharacterDefine`)

> ycContractManagement | 物理表：`cpu_ct_character_define`
...
|------|-----|
| 显示名 | 采购合同表体物料自定义项 |
| 物理表 | `cpu_ct_character_define` |
| 数据库 schema | `cpu-contract` |
| 所属应用 | `ycContractManagement` |
| 构建时间 | `2026-06-04 23:45:13.2860` |
