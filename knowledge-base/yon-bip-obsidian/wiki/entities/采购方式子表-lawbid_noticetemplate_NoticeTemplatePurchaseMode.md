---
tags: ["BIP", "元数据", "数据字典", "ycSouringBid", "lawbid.noticetemplate.NoticeTemplatePurchaseMode"]
created: 2026-06-04
updated: 2026-06-04
...
# 采购方式子表 (`lawbid.noticetemplate.NoticeTemplatePurchaseMode`)

> **平台版本：BIP 旗舰版 V5**

> ycSouringBid 模块 | 物理表：`cpu_notice_template_purchase_mode`
...
|------|-----|
| 显示名 | 采购方式子表 |
| 物理表 | `cpu_notice_template_purchase_mode` |
| 数据库 schema | `yonbip-cpu-lawbid` |
| 所属应用 | `ycSouringBid` |
| 构建时间 | `2026-06-04 20:16:38.8800` |
...
| 7 | `purchaseModeId` | 适用采购方式 | `purchase_mode_id` | 81c6880b-694a-4667-987f-81b5615f2401 |
