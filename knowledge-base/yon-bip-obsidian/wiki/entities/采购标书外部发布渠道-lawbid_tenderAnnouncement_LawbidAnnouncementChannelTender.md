---
tags: ["BIP", "元数据", "数据字典", "ycSouringBid", "lawbid.tenderAnnouncement.LawbidAnnouncementChannelTender"]
created: 2026-06-04
updated: 2026-06-04
...
# 采购标书外部发布渠道 (`lawbid.tenderAnnouncement.LawbidAnnouncementChannelTender`)

> **平台版本：BIP 旗舰版 V5**

> ycSouringBid 模块 | 物理表：`cpu_bid_announcement_channel_tender`
...
|------|-----|
| 显示名 | 采购标书外部发布渠道 |
| 物理表 | `cpu_bid_announcement_channel_tender` |
| 数据库 schema | `yonbip-cpu-lawbid` |
| 所属应用 | `ycSouringBid` |
| 构建时间 | `2026-06-04 20:03:11.4090` |
...
| # | 字段名 | 显示名 | 数据库列 | 类型 |
|---|--------|--------|---------|------|
| 1 | `announcementId` | 公告ID | `announcement_id` | e764c131-bca2-44d7-a8af-fe17cb0837f8 |
...
| 2 | `announcementId` | 公告ID | `lawbid.tenderAnnouncement.LawbidAnnouncementTender` | None | true |
