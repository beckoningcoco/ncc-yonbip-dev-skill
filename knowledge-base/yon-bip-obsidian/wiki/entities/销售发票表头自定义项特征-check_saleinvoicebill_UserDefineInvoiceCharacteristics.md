---
tags: ["BIP", "元数据", "数据字典", "ycSaleCoor", "check.saleinvoicebill.UserDefineInvoiceCharacteristics"]
created: 2026-06-04
updated: 2026-06-04
...
# 销售发票表头自定义项特征 (`check.saleinvoicebill.UserDefineInvoiceCharacteristics`)

> ycSaleCoor | 物理表：`cpu_saleinvoice_usercharacteristicsdefine`
