---
tags: ["BIP", "元数据", "数据字典", "ycSaleCoor", "cpu-order.saleorder.SaleOrderHeaderDefine"]
created: 2026-06-04
updated: 2026-06-04
...
# 销售订单表头自定义项特征 (`cpu-order.saleorder.SaleOrderHeaderDefine`)

> ycSaleCoor | 物理表：`cpu_sale_order_header_define`
