---
tags: ["BIP", "元数据", "数据字典", "DPMPI", "bd.customerdoc_KS002.KS002"]
created: 2026-06-05
updated: 2026-06-05
...
# 面料颜色_配色面料 (`bd.customerdoc_KS002.KS002`)
...
| 4 | `custdocdefid` | 档案定义 | `custdocdefid` | 4a34c8c2-7819-4c05-a15b-d59fb09f6e75 |
...
| 17 | `orgid` | 组织 | `orgid` | 100943a5-df56-4ec1-8105-c4b448afa02b |
...
| 28 | `sysid` | 应用标识 | `sysid` | String |
| 29 | `tenant` | 租户(废除) | `tenantid` | String |
...
| 6 | `orgid` | 组织 | `org.view.AdminOrgGlobalView` | Service |  |
