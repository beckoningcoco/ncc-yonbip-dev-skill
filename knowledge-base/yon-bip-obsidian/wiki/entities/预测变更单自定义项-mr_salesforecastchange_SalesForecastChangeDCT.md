---
tags: ["BIP", "元数据", "数据字典", "MR", "mr.salesforecastchange.SalesForecastChangeDCT"]
created: 2026-06-05
updated: 2026-06-05
...
# 预测变更单自定义项 (`mr.salesforecastchange.SalesForecastChangeDCT`)

> MR | 物理表：`mr_sales_forecast_change_dct`
...
|------|-----|
| 显示名 | 预测变更单自定义项 |
| 物理表 | `mr_sales_forecast_change_dct` |
| domain/服务域 | `requirementsplanning` |
| 所属应用 | `MR` |
| 构建时间 | `2026-06-05 15:17:06.4400` |
