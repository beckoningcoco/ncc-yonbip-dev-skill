...
请求地址	/yonbip/tax/other-tax/api/tax-no-expenditure-ledger/batch-add
请求方式	POST
...
Url: /yonbip/tax/other-tax/api/tax-no-expenditure-ledger/batch-add?access_token=访问令牌
Body: {
	"data": [
		{
			"orgCode": "",
