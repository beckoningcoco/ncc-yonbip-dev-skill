---
title: "《与收入无关的支出台账》新增接口"
apiId: "2060031740292366345"
apiPath: "请求方式	POST"
...
>  请求方式	POST | Expenditure account (TAX)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/tax/other-tax/api/tax-unrelated-ledger/batch-add
请求方式	POST
...
Url: /yonbip/tax/other-tax/api/tax-unrelated-ledger/batch-add?access_token=访问令牌
Body: {
	"data": [
		{
			"orgCode": "",
