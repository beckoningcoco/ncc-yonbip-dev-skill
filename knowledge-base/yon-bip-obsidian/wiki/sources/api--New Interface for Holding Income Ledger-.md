...
请求地址	/yonbip/tax/yonbip-fi-taxoth/api/hold-income-ledger/batch-save
...
| orgCode | string | 否 | 是 | 组织编码 示例：1234 |
| assetCode | string | 否 | 是 | 资产编码 示例：1111 |
...
Url: /yonbip/tax/yonbip-fi-taxoth/api/hold-income-ledger/batch-save?access_token=访问令牌
Body: {
	"data": [
		{
			"orgCode": "1234",
