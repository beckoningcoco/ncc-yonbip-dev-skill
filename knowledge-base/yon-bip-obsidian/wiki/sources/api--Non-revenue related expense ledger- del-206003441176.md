---
title: "《与收入无关的支出台账》删除接口"
apiId: "2060034411762024448"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/tax/other-tax/api/tax-unrelated-ledger/batch-del
请求方式	POST
...
Url: /yonbip/tax/other-tax/api/tax-unrelated-ledger/batch-del?access_token=访问令牌
Body: {
	"data": [
		""
	]
