...
请求地址	/yonbip/tax/other-tax/api/tax-s-rec-loss/batch-del
请求方式	POST
...
Url: /yonbip/tax/other-tax/api/tax-s-rec-loss/batch-del?access_token=访问令牌
Body: {
	"data": [
		""
	]
