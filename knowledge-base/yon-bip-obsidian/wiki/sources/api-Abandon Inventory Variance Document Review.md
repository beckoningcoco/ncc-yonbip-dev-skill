---
title: "盘点差异单弃审"
apiId: "1c2bf16585ec47ce9479fd17f98ce93d"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/scm/storecheckdifference/batchunaudit
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 是 | 请求体 |
| id | long | 否 | 是 | 盘点差异单主表id 示例：2528880654733824 |

## 3. 请求示例

Url: /yonbip/scm/storecheckdifference/batchunaudit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2528880654733824
