...
请求地址	/yonbip/mfg/capacityAdjust/delete
请求方式	POST
...
名称	类型	数组	必填	描述
ids	number
小数位数:0,最大长度:32	是	是	能力对象调节明细id 示例：[2231996587160109052,2231996587160109065]

## 3. 请求示例

Url: /yonbip/mfg/capacityAdjust/delete?access_token=访问令牌
Body: {
	"ids": [
		2231996587160109052,
		2231996587160109065
