---
title: "账户用途批量删除结果查询-新集成"
apiId: "2217327066214825992"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Account Purpose Details (MD)
...
请求地址	/yonbip/digitalModel/basedoc/accountpurpose/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/basedoc/accountpurpose/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
