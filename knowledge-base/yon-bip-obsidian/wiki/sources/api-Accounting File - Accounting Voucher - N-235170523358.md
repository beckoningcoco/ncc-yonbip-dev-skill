---
title: "会计档案-会计凭证-新增V1"
apiId: "2351705233585864710"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/FCC/v1/api/collection/account/voucher
请求方式	POST
...
title	string	否	是	凭证类型 示例：支出凭证
fileNo	string	否	否	凭证号 示例：001
...
Url: /yonbip/FCC/v1/api/collection/account/voucher?access_token=访问令牌
Body: {
	"orgCode": "ORG001",
	"categoryPrefix": "PZ",
	"accountYear": "2023",
