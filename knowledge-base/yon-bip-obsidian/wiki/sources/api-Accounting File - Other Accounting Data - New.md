---
title: "会计档案-其他会计资料-新增V1"
apiId: "2351713067606212616"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/FCC/v1/api/collection/account/information
...
| categoryPrefix | string | 否 | 是 | 分类标识 "QT": 其它会计资料 "YHYETJB": 银行余额调节表 "YHDZD": 银行电子对账单 "NSSBB": 纳税申报表 "WSZM": 完税证明 "QTSSZL": 其他涉税资料 示例：QT |
| accountYear | string | 否 | 是 | 年度 示例：2023 |
| accountMonth | string | 否 | 是 | 月份 示例：03 |
| mainRecord | object | 否 | 是 | 主记录对象 |
| title | string | 否 | 是 | 题名 示例：支出资料 |
...
| billType | string | 否 | 否 | 单据类型 示例：PZ |
...
Url: /yonbip/FCC/v1/api/collection/account/information?access_token=访问令牌
Body: {
	"orgCode": "ORG001",
	"categoryPrefix": "QT",
	"accountYear": "2023",
