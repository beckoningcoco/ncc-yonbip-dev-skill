---
title: "会计档案-会计账簿-新增V1"
apiId: "2351708489171075078"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/FCC/v1/api/collection/account/book
...
| categoryPrefix | string | 否 | 是 | 分类标识 "KMZZ": 总账 "KMMXZ": 科目明细账 "XJRJZ": 现金日记账 "YHRJZ": 银行日记账 "ZZYEB": 总账余额表 "FZMXZ": 辅助明细账 "FZYEB": 辅助余额表 "GDZCKP": 固定资产卡片 "GDZCTZ": 固定资产台账 "KMFZYEB": 科目辅助余额表 示例：KMZZ |
| accountYear | string | 否 | 是 | 年度 示例：2023 |
| accountMonth | string | 否 | 是 | 月份 示例：03 |
| mainRecord | object | 否 | 是 | 主记录对象 |
| title | string | 否 | 是 | 题名 示例：支出账簿 |
...
| billType | string | 否 | 否 | 单据类型 示例：book |
...
Url: /yonbip/FCC/v1/api/collection/account/book?access_token=访问令牌
Body: {
	"orgCode": "ORG001",
	"categoryPrefix": "KMZZ",
	"accountYear": "2023",
