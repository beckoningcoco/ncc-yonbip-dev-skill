...
请求地址	/finbd.bd_periodlist/finbd.bd_periodlist/fipub/period/api/saveOrUpdate/halfyear
...
| code | string | 否 | 否 | 代码 示例：2024-H1 |
| name | string | 否 | 否 | 名称 示例：2024-H1 |
| codedate | string | 否 | 否 | 季度期间名称 示例：2024-H1 |
| localcode | string | 否 | 否 | 本地季度期间名称 示例：2024-H1 |
| schemeCode | string | 否 | 否 | 期间方案编码 示例：zh11 |
| periodyearCode | string | 否 | 否 | 期间年编码 示例：2024 |
| beginperiodCode | string | 否 | 否 | 开始期间编码 示例：2024-01 |
| endperiodCode | string | 否 | 否 | 结束期间编码 示例：2024-06 |
| objid | string | 否 | 否 | 友企连ID 示例：1 |

## 3. 请求示例

Url: /finbd.bd_periodlist/finbd.bd_periodlist/fipub/period/api/saveOrUpdate/halfyear?access_token=访问令牌
Body: {
	"data": [
		{
			"code": "2024-H1",
		...
		"infos": [
			{
				"data": {
					...
					"objid": "1",
					"objId": "1",
					"segmenttype": 1550096363406491707,
					...
					"endperiod": 2045730950725238790,
					"id": 2045738767565717509,
					"_status": "Update",
					"_key": "id",
