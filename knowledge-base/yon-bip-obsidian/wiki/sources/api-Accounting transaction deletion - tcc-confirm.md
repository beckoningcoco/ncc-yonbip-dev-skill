---
title: "会计事务删除-tcc-confirm"
apiId: "2227769978557300743"
apiPath: "请求方式	POST"
...
> `ContentType	application/json` 请求方式	POST | 分类: Accounting Transaction (AMP)
...
请求地址	/yonbip/AMP/fievent/reverseConfirm
...
Url: /yonbip/AMP/fievent/reverseConfirm?access_token=访问令牌
Body: {
	"fieventInfo": {
...
| message | string | 否 | message 示例：reverseConfirm成功 |

## 5. 正确返回示例

{
	"code": "200",
	"message": "reverseConfirm成功"
}
...
500	reverseConfirm失败	请等待自动重试，或联系集团开发
