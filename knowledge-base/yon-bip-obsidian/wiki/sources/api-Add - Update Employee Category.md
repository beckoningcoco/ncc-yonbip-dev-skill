---
title: "员工类别新增|更新"
apiId: "c17d951165f24b64b6dc2e4f4a54eaab"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/psnlcatg/save
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 否 | 是 | 员工类别[bd.staff.PsnlCatg] |
| code | string | 否 | 是 | 员工类别编码 |
| name | muti_lang | 否 | 是 | 员工类别名称,支持多语 |
| parent | string | 否 | 否 | 员工类别id |
| id | string | 否 | 否 | ID 新增时无需填写，修改时必填 新增时无需填写，修改时必填 |
| sort | int | 否 | 否 | 排序号 |
| enable | int | 否 | 否 | 状态, 1:启用、2:停用 |
| memo | string | 否 | 否 | 备注 |
| _status | string | 否 | 是 | 操作标识, Insert:新增、Update:更新 |

## 3. 请求示例

Url: /yonbip/digitalModel/psnlcatg/save?access_token=访问令牌
Body: {
	"data": {
		"code": "",
		"name": "",
