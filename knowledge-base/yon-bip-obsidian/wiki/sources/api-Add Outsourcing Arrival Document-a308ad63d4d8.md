---
title: "委外到货单新增"
apiId: "a308ad63d4d8412595a894d7ddccbf36"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/mfg/arriveorder/save
请求方式	POST
...
rcvDepartmentId	string	否	否	收货部门id或code 示例：2325510494064566
rcvStaffId	string	否	否	收货人id或code 示例：1866605942198527
sendTransWayId	string	否	否	发运方式id或code 示例：1866605942198523
...
osmArriveOrderProduct	object	是	是	委外到货单产品行数据集合

## 3. 请求示例

Url: /yonbip/mfg/arriveorder/save?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"code": "WWDH202201250001",
		...
		"sendTransWayId": "1866605942198523",
