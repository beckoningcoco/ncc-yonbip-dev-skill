---
title: "地址批量删除结果查询-新集成"
apiId: "2247913315058057221"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Address (MD)
...
请求地址	/yonbip/digitalModel/coredoc/async/regioncorp/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/coredoc/async/regioncorp/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
