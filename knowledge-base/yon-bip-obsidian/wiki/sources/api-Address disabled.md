---
title: "地址停用"
apiId: "0ed697619f4840c2999f5dc0fb252428"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/regioncorp/stop
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 否 | 是 | 地址 |
| id | long | 否 | 否 | 地址id，与地址编码必输其一 示例：2145273881592574 |
| code | string | 否 | 否 | 地址编码，与地址id必输其一 |

## 3. 请求示例

Url: /yonbip/digitalModel/regioncorp/stop?access_token=访问令牌
Body: {
	"data": {
		"id": 2145273881592574,
		"code": ""
