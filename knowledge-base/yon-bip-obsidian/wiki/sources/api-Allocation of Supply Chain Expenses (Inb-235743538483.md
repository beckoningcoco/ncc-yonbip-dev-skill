---
title: "供应链费用单分摊（入库作业无来源）"
apiId: "2357435384834031620"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/SCC/scmmp/expense/divideNoSourceInRecordWork
请求方式	POST
...
expenseDetails	object	是	是	费用子表

## 3. 请求示例

Url: /yonbip/SCC/scmmp/expense/divideNoSourceInRecordWork?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
