---
title: "订单弃审"
apiId: "ada15883b53c44318ff8a79d9703d8ff"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/sd/dst/tradeorder/unapprove
请求方式	POST
...
ids	string	否	是	需要弃审订单id，多张用“,”分隔
externalData	object	否	否	弃审原因 需传参数=cUnApproveReason
cUnApproveReason	string	否	否	弃审原因

## 3. 请求示例

Url: /yonbip/sd/dst/tradeorder/unapprove?access_token=访问令牌
Body: {
	"partParam": {},
	"ids": "",
	"externalData": {
