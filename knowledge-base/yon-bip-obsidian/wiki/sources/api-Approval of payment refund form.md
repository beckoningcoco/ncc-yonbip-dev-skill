...
请求地址	/yonbip/EFI/apRefund/audit
...
Url: /yonbip/EFI/apRefund/audit?access_token=访问令牌
Body: {
	"data": {
...
| data | object | 否 | 返回数据 |
| id | string | 否 | 付款退款单表头主键 示例：1563469671900381185 |
...
999	当前单据已审核, 不允许重复操作!	输入有效且未审核的单据id
