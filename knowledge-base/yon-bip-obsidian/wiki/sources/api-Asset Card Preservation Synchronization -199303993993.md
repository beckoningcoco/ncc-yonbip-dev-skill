...
请求地址	/yonbip/am/sync/aic/equip/save
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
routingkey	string	否	否	路由键 示例：aic 默认值：aic
...
Url: /yonbip/am/sync/aic/equip/save?access_token=访问令牌
Body: {
	"routingkey": "aic",
	"equip_name": "起重机",
	...
	"pk_used_status": "",
	"pk_priority": "",
	"start_used_date": "2026-06-07 13:20:19",
	"pk_mandept": "",
	"pk_usedept": "",
	"pk_user": "",
	"transi_type_src": "",
