...
请求地址	/yonbip/am/aumaltercard/uncommit
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	是	否	资产变动参数项
id	string	否	否	资产变动主键 示例：2055646707442515977

## 3. 请求示例

Url: /yonbip/am/aumaltercard/uncommit?access_token=访问令牌
Body: {
	"data": [
		{
