...
请求地址	/yonbip/am/aumassignapplycard/submit
请求方式	POST
...
id	string	否	是	领用申请主键 示例：1522112313441131

## 3. 请求示例

Url: /yonbip/am/aumassignapplycard/submit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "1522112313441131"
