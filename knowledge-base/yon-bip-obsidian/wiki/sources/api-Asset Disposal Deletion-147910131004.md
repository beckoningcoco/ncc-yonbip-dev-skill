...
请求地址	/yonbip/am/aumsalecard/delete
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	是	是	资产处置对象
id	string	否	是	资产处置单据id 示例：1476611216843472896

## 3. 请求示例

Url: /yonbip/am/aumsalecard/delete?access_token=访问令牌
Body: {
	"data": [
		{
...
infos	object	是	处理成功的单据数据,当前接口返回为空
...
999	报错具体提示信息，例如：服务端逻辑异常	查看日志找对应异常服务定位产生原因并处理
