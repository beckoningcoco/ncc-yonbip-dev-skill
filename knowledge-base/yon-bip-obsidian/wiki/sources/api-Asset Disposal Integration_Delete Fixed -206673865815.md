---
title: "资产处置集成_生成固定资产减少"
apiId: "2066738658158313476"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/am/saleIntegrate/save
请求方式	POST
...
def20	string	否	否	自定义项20
purgerevenue	number
小数位数:8,最大长度:28	否	否	处置收入
purgerevenue_group	number
小数位数:8,最大长度:28	否	否	集团本位币处置收入
purgerevenue_global	number
小数位数:8,最大长度:28	否	否	全局本位币处置收入
purgefee	number
小数位数:8,最大长度:28	否	否	处置支出
purgefee_group	number
小数位数:8,最大长度:28	否	否	集团本位币处置支出
purgefee_global	number
小数位数:8,最大长度:28	否	否	全局本位币处置支出

## 3. 请求示例

Url: /yonbip/am/saleIntegrate/save?access_token=访问令牌
Body: {
	"pk_reduce": "",
	"pk_group": "",
	"pk_org": "",
	...
	"bill_status": 0,
	"pk_recorder": "",
	"bill_date": "2026-06-07 13:21:36",
	"memo": "",
	"creator": "",
	"creationtime": "2026-06-07 13:21:36",
	"modifier": "",
	"modifiedtime": "2026-06-07 13:21:36",
	"auditor": "",
	"audittime": "2026-06-07 13:21:36",
	"check_opinion": "",
	"billmaker": "",
	"billmaketime": "2026-06-07 13:21:36",
	"pk_bill_src": "",
	"bill_type_src": "",
	"transi_type_src": "",
	"bill_code_src": "",
	...
	"body": [
		{
			...
			"net_money": 0,
			"pre_devaluate": 0,
			"begin_date": "2026-06-07 13:21:36",
			"used_month": 0,
			"service_month": 0,
			"pk_addreducestyle": "",
			"pk_reason": "",
			...
			"pk_status_before": "",
			"pk_status_after": "",
			"status_date_before": "2026-06-07 13:21:36",
			"status_date_after": "2026-06-07 13:21:36",
			"stock_out_flag": "",
			"stock_in_flag": "",
			"bill_type_src": "",
			"pk_transitype_src": "",
			...
			"def20": "",
			"purgerevenue": 0,
			"purgerevenue_group": 0,
			"purgerevenue_global": 0,
			"purgefee": 0,
			"purgefee_group": 0,
			"purgefee_global": 0
		}
...
message	string	否	message 示例：操作成功！
data	object	否	data
pk_org	string	否	pk_org 示例：1796566360214994954
pk_org__name	string	否	pk_org__name 示例：wml集团
pk_currency	string	否	pk_currency 示例：1763914111891537950
...
bill_type	string	否	bill_type 示例：4A18
pk_transitype	string	否	pk_transitype 示例：1763914120481474153
pk_transitype__name	string	否	pk_transitype__name 示例：资产处置
postAccountStatus	number
小数位数:0,最大长度:10	否	postAccountStatus 示例：99
transi_type	string	否	transi_type 示例：4A18-01
bill_code	string	否	bill_code 示例：ZCCZ202408160001
bill_date	string	否	bill_date 示例：2024-08-16 00:00:00
pk_fiorg	string	否	pk_fiorg 示例：1796566360214994954
pk_fiorg__name	string	否	pk_fiorg__name 示例：wml集团
pk_recorder	string	否	pk_recorder 示例：1939065523901825027
pk_recorder__name	string	否	pk_recorder__name 示例：yueriy
bill_status	number
...
billmaketime	string	否	billmaketime 示例：2024-08-16 16:28:20
verifystate	number
...
id	string	否	id 示例：2066711634111889416
...
creationtime	string	否	creationtime 示例：2024-08-16 16:28:20
...
pubts	string	否	pubts 示例：2024-08-16 16:28:20
...

{
	...
	"data": {
		...
		"bill_type": "4A18",
		"pk_transitype": "1763914120481474153",
		"pk_transitype__name": "资产处置",
		"postAccountStatus": 99,
		"transi_type": "4A18-01",
		"bill_code": "ZCCZ202408160001",
		"bill_date": "2024-08-16 00:00:00",
		"pk_fiorg": "1796566360214994954",
		"pk_fiorg__name": "wml集团",
		"pk_recorder": "1939065523901825027",
		"pk_recorder__name": "yueriy",
		"bill_status": 0,
		"billmaker": "c92cfebd-4be8-4863-a572-d8b715a0ec26",
		"billmaker__name": "刘龙",
		"billmaketime": "2024-08-16 16:28:20",
		"verifystate": 0,
		"push_status": 0,
		"bodyvos": [
			{
				...
				"purgerevenue_tax_out": 0,
				"notaxpurgerevenue_out": 0,
				"stock_out_flag": false,
				"stock_in_flag": false,
				"receivable_flag": false,
				"payable_flag": false,
				"hasDefaultInit": true,
				"attachmentId": "3dcd5e50-ad05-4eeb-aa38-1bb817a824db",
				"pk_equip__equip_code": "EAM-TEST-2024042400000005",
				"pk_equip": "1982090857015672841",
				"pk_equip__equip_name": "阿斯顿发顺丰",
				"pk_status_before": "PRESET01_0000LJPGZ3RX3YAKG10000",
				"pk_status_before__status_name": "在用",
				"pk_equip__pk_currency_fi": "1763914111891537950",
				"pk_equip__pk_currency_fi__name": "人民币",
				"pk_equip__pk_currency_fi__moneyDigit": "2",
				"pk_equip__pk_costcenter_manage__name": "wml成本中心-0501生效",
				"pk_costcenter_manage": "1894558805035843587",
				"pk_costcenter_manage__name": "wml成本中心-0501生效",
				"pk_equip__pk_ownerorg": "1796566360214994954",
				"pk_equip__pk_ownerorg__name": "wml集团",
				"pk_equip__pk_usedorg": "1796566360214994954",
				"pk_equip__pk_usedorg__name": "wml集团",
				"pk_ownerorg": "1796566360214994954",
				"pk_usedorg": "1796566360214994954",
				"pk_ownerunit_equip": "1796566360214994954",
				"pk_ownerorg_equip": "1796566360214994954",
				"pk_mandept_equip": "1796567202028584962",
				"pk_usedorg_equip": "1796566360214994954",
				"pk_ownerunit_equip__name": "wml集团",
				"pk_ownerorg_equip__name": "wml集团",
				"pk_mandept_equip__name": "部门一",
				"pk_usedorg_equip__name": "wml集团",
				"pk_addreducestyle__name": "出售",
				"pk_addreducestyle": "1763914120473083940",
				"ttt_id": "rowId_762",
				"id": "2066711634111889417",
				"main_id": "2066711634111889416",
				"pk_org": "1796566360214994954",
				"tenant": "0000LJPGZ3RX3YAKG10000",
				"ytenant": "0000LJPGZ3RX3YAKG10000"
			}
		],
		"resubmitCheckKey": "aum_sale_card_add_4284b347-88f9-4fba-b768-5567ea73c5bc",
		"id": "2066711634111889416",
		"sysid": "AUM",
		"creator": "c92cfebd-4be8-4863-a572-d8b715a0ec26",
		"creator__name": "刘龙",
		"creationtime": "2024-08-16 16:28:20",
		"isWfControlled": true,
		"tenant": "0000LJPGZ3RX3YAKG10000",
		"ytenant": "0000LJPGZ3RX3YAKG10000",
		"pubts": "2024-08-16 16:28:20"
	}
}
