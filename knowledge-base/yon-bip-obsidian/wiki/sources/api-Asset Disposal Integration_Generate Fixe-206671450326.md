...
请求地址	/yonbip/am/aumsalecard/submit
请求方式	POST
...
id	string	否	是	资产处置主键 示例：1966025171075072005

## 3. 请求示例

Url: /yonbip/am/aumsalecard/submit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "1966025171075072005"
		}
	]
}
