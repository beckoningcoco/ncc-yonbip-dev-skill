---
title: "资产盘亏集成_生成固定资产减少"
apiId: "2066733461247885320"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/am/inventoryLossIntegrated/save
请求方式	POST
...
saga_gtxid	string	否	否	全局事务id
saga_btxid	string	否	否	子事务id
saga_frozen	number
小数位数:0,最大长度:38	否	否	冻结状态
saga_status	number
小数位数:0,最大长度:38	否	否	Saga事务状态
...
body	object	是	否	资产盘亏明细
pk_loss_b	string	否	否	盘亏单表体主键
pk_group	string	否	否	集团
pk_org	string	否	否	资产组织最新版本
pk_org_v	string	否	否	资产组织
rowno	string	否	否	行号
pk_equip	string	否	否	设备编码
loss_type	string	否	否	盘亏方式
loss_reason	string	否	否	盘亏原因
dealresult	string	否	否	处理结果
check_username	string	否	否	盘点人
inventory_date	date
格式:yyyy-MM-dd HH:mm:ss	否	否	盘点日期
memo	string	否	否	备注
pk_status_before	string	否	否	盘亏前状态
pk_status_after	string	否	否	盘亏后状态
status_date_before	date
格式:yyyy-MM-dd HH:mm:ss	否	否	盘亏前状态日期
status_date_after	date
格式:yyyy-MM-dd HH:mm:ss	否	否	盘亏后状态日期
stock_out_flag	string	否	否	出库标记
pk_warehouse_out	string	否	否	出库仓库
pk_location_before	string	否	否	盘亏前位置
pre_text1	string	否	否	预置字符1
pre_text2	string	否	否	预置字符2
pre_text3	string	否	否	预置字符3
pre_text4	string	否	否	预置字符4
...
Url: /yonbip/am/inventoryLossIntegrated/save?access_token=访问令牌
Body: {
	"pk_loss": "",
	"pk_group": "",
	"pk_org": "",
	...
	"pk_transitype": "",
	"check_code": "",
	"check_date": "2026-06-07 13:22:23",
	"pk_recorder": "",
	"memo": "",
	"creator": "",
	"creationtime": "2026-06-07 13:22:23",
	"modifier": "",
	"modifiedtime": "2026-06-07 13:22:23",
	"auditor": "",
	"audittime": "2026-06-07 13:22:23",
	"check_opinion": "",
	"billmaker": "",
	"billmaketime": "2026-06-07 13:22:23",
	"billtype_src": "",
	"pk_bill_src": "",
	"saga_gtxid": "",
	"saga_btxid": "",
	...
	"body": [
		{
			...
			"dealresult": "",
			"check_username": "",
			"inventory_date": "2026-06-07 13:22:23",
			"memo": "",
			"pk_status_before": "",
			"pk_status_after": "",
			"status_date_before": "2026-06-07 13:22:23",
			"status_date_after": "2026-06-07 13:22:23",
			"stock_out_flag": "",
			"pk_warehouse_out": "",
			"pk_location_before": "",
			"pre_text1": "",
