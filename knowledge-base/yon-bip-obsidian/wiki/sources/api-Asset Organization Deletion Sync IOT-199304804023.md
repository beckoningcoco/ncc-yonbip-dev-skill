...
请求地址	/yonbip/am/sync/aic/equip/delete
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
routingkey	string	否	是	路由键 示例：aic 默认值：aic
equip_name	string	否	是	资产名称 示例：起重机
equip_code	string	否	是	资产编码 示例：202405220001
pk_org	string	否	是	资产组织
...
parent_code	string	否	否	资产组织编码 示例：cc

## 3. 请求示例

Url: /yonbip/am/sync/aic/equip/delete?access_token=访问令牌
Body: {
	"routingkey": "aic",
	"equip_name": "起重机",
	"equip_code": "202405220001",
	"pk_org": "",
	"pk_location": "",
	"spec": "",
	"model": "",
	...
	"pk_used_status": "",
	"pk_priority": "",
	"start_used_date": "2026-06-07 13:20:22",
	"pk_mandept": "",
	"pk_usedept": "",
	"pk_user": "",
	"transi_type_src": "",
