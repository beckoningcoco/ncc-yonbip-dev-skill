...
请求地址	/yonbip/ACC/aumassignapplycard/commit
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	是	是	资产领用申请参数
id	string	否	是	资产领用申请主键

## 3. 请求示例

Url: /yonbip/ACC/aumassignapplycard/commit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": ""
