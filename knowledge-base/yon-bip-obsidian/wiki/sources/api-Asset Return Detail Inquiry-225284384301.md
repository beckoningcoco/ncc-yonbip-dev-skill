...
请求地址	/yonbip/am/semrecordlist/delete
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	是	否	检验记录参数对象
id	string	否	否	检验记录ID 示例：1746769856581074951

## 3. 请求示例

Url: /yonbip/am/semrecordlist/delete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "1746769856581074951"
		}
	]
}
