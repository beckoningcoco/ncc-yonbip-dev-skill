...
请求地址	/yonbip/am/scrapapplycard/submit
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	是	是	资产报废申请对象
id	string	否	是	资产报废申请主键 示例：2002953566174576644

## 3. 请求示例

Url: /yonbip/am/scrapapplycard/submit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "2002953566174576644"
		}
	]
}
