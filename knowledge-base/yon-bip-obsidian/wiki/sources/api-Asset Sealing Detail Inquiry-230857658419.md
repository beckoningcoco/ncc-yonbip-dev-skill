---
title: "资产封存保存"
apiId: "2308576584191705089"
apiPath: "请求方式	POST"
method: "ContentType	application/json"
category: "Asset Sealing"
domain: "GAM"
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Asset Sealing]
...
>  请求方式	POST | Asset Sealing (GAM)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/ACC/freezecard/save
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	否	是	资产封存数据
bill_code	string	否	否	单据编号 示例：ZCFC202507070001
bill_date	string	否	是	单据日期 示例：2025-07-07
bill_status	number
小数位数:0,最大长度:10	否	否	单据状态 示例：0
verifystate	number
小数位数:0,最大长度:10	否	否	审批状态 示例：0
push_status	number
小数位数:0,最大长度:10	否	否	推单状态 示例：0
pk_org	string	否	是	资产组织 示例：2246357514780147713
bill_type	string	否	是	单据类型 示例：4A09
pk_transitype	string	否	否	交易类型 示例：AM_4A09-01
transi_type	string	否	是	交易类型 示例：4A09-01
billmaker	string	否	否	制单人 示例：b5afb217-2474-496d-808e-e2bf2ecfaa69
id	string	否	否	主表主键 示例：2307741908932231171
pubts	string	否	否	时间戳 示例：2025-07-07 11:18:04
...
bizFlow	string	否	否	流程 示例：b0259465-afea-4534-9d05-c950447af2e7
isFlowCoreBill	boolean	否	否	是否流程核心单据 示例：true
billmaketime	string	否	否	制单时间 示例：2025-07-07 10:48:37
modifier	string	否	否	修改人 示例：b5afb217-2474-496d-808e-e2bf2ecfaa69
modifiedtime	string	否	否	修改时间 示例：2025-07-07 11:18:04
creator	string	否	否	创建人 示例：b5afb217-2474-496d-808e-e2bf2ecfaa69
creationtime	string	否	否	创建时间 示例：2025-07-07 10:48:37
bodyvos	object	是	否	表体数据
_status	string	否	是	操作 示例：Update 默认值：Update

## 3. 请求示例

Url: /yonbip/ACC/freezecard/save?access_token=访问令牌
Body: {
	"data": {
		...
		"modifiedtime": "2025-07-07 11:18:04",
