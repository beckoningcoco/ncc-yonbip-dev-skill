---
title: "物料清单撤回"
apiId: "b6948ee0c61941eda40886070732dfbd"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/mfg/bom/batchunsubmit
...
| id | long | 否 | 是 | 单据id 示例：2293848285565184 |

## 3. 请求示例

Url: /yonbip/mfg/bom/batchunsubmit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2293848285565184
...
| successCountAI | long | 否 | 成功数量 示例：2 |
