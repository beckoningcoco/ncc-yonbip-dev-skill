...
请求地址	/yonbip/ctm/cmp/bankdealdetail
...
| accentity_code | string | 否 | 否 | 账户使用组织编码 示例：ZSZB |
| enterpriseBankAccount | string | 否 | 否 | 银行账户ID |
| enterpriseBankAccount_code | string | 否 | 否 | 银行账户编码 |
| currency | string | 否 | 否 | 币种ID |
| currency_code | string | 否 | 否 | 币种名称 |
| open_tranDate_begin | string | 否 | 否 | 交易日期开始日期,格式为:yyyy-MM-dd HH:mm:ss 示例：2022-05-23 |
| open_tranDate_end | string | 否 | 否 | 交易日期结束日期,格式为:yyyy-MM-dd HH:mm:ss 示例：2022-05-23 |
...
Url: /yonbip/ctm/cmp/bankdealdetail?access_token=访问令牌
Body: {
	"pageIndex": 0,
	"pageSize": 0,
	...
	"currency": "",
	"currency_code": "",
	"open_tranDate_begin": "2022-05-23",
	"open_tranDate_end": "2022-05-23",
	"simpleVOs": [
		{
			"field": "pubts",
			"op": "between",
		...
		"recordList": [
			{
				...
				"frzbal": 0,
				"merchant_flag": 1,
				"tranTime": "2022-05-24 10:20:34",
				"tranDate": "2022-05-24 00:00:00",
				"remark": "我是租户级单据模板",
				"balancedate": "2022-05-24 00:00:00",
				"use_name": "我是租户级单据模板",
				"to_acct_no": "6222020200106828615",
				"to_acct_bank": "102100099996",
				"to_acct_name": "曾刚",
				"to_acct_bank_name": "中国工商银行总行清算中心",
				"bankseqno": "22241000010",
				"pubts": "2022-05-24 20:34:29",
				"createDate": "2022-05-24 20:34:29",
				"createTime": "2022-05-24 00:00:00",
				"value_date": "2022-05-24 00:00:00",
				"creator": "曾刚"
			}
		],
		"pageCount": 1,
