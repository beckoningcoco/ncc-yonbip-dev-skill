---
title: "银行类别批量删除结果查询-新集成"
apiId: "2217388175009513472"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Bank Category (MD)
...
请求地址	/yonbip/digitalModel/basedoc/async/bank/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/basedoc/async/bank/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
