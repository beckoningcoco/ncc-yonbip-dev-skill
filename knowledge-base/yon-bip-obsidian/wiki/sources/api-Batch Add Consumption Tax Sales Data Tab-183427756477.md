...
请求地址	/yonbip/tax/yonbip-fi-taxoth/api/excise/sale-collection/batch-add
请求方式	POST
...
projectCode	string	否	否	项目编码 示例：300123

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxoth/api/excise/sale-collection/batch-add?access_token=访问令牌
Body: [{
	"orgCode": "MT0000001",
	"period": "2023-10",
