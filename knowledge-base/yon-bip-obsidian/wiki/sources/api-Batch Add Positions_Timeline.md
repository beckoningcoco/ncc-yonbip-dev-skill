...
请求地址	/yonbip/digitalModel/position/timeline/batchSave
...
| starttime | date |
| 格式:yyyy-MM-dd | 否 | 是 | 生效日期格式 yyyy-mm-dd |
...
Url: /yonbip/digitalModel/position/timeline/batchSave?access_token=访问令牌
Body: {
	"data": [
		{
			"name": {
