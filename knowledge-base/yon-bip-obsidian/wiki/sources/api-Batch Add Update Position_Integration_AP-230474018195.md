---
title: "岗位批量新增更新_集成_API(新集成)"
apiId: "2304740181950332931"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/PFC/position/batchSaveOrUpdateForIntegrationMdd
请求方式	POST
...
objid	string	否	否	objid 示例：objid
...
Url: /yonbip/PFC/position/batchSaveOrUpdateForIntegrationMdd?access_token=访问令牌
Body: {
	"data": [
		{
			"name": {
			...
			"parentid": "2121",
			"freeze": 1,
			"pubts": "2026-06-07 12:44:49",
			"level": 1,
			"sysid": "sysid",
			"duties": "duties",
			"ts": "2026-06-07 12:44:49",
			"memo": {
				"zh_CN": "",
				"en_US": "",
				"zh_TW": ""
			},
			"modifyTime": "2026-06-07 12:44:49",
			"createTime": "2026-06-07 12:44:49",
			"creator": "",
			"modifier": ""
		}
	]
