...
请求地址	/yonbip/digitalModel/basedoc/async/businessperiod/batchDelete
请求方式	POST
...
Url: /yonbip/digitalModel/basedoc/async/businessperiod/batchDelete?access_token=访问令牌
Body: {
	"data": [
		{
