...
请求地址	/yonbip/digitalModel/basedoc/async/exchangerate/batchDelete
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 否 | 请求体 |
| sourceUnique | string | 否 | 是 | 源系统唯一标识 示例：2211575684096589833 |
| id | string | 否 | 是 | 档案ID 示例：2211575684096589833 |

## 3. 请求示例

Url: /yonbip/digitalModel/basedoc/async/exchangerate/batchDelete?access_token=访问令牌
Body: {
	"data": [
		{
