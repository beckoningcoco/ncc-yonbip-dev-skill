---
title: "物料规格批量删除"
apiId: "a1fcdab029834d6fb86857ef474de1b8"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/productspec/batchDelete
...
| id | long | 否 | 是 | 物料规格id 示例：2281487524827392 |
| pubts | string | 否 | 否 | 时间戳 示例：2021-05-31 16:49:08 |

## 3. 请求示例

Url: /yonbip/digitalModel/productspec/batchDelete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2281487524827392,
			"pubts": "2021-05-31 16:49:08"
		}
	]
}
