...
> `ContentType	application/json` 请求方式	POST | 分类: Payment Agreement (MD)
...
请求地址	/yonbip/digitalModel/basedoc/async/payagreement/batchDelete
...
Url: /yonbip/digitalModel/basedoc/async/payagreement/batchDelete?access_token=访问令牌
Body: {
	"data": [
		{
