---
title: "销售发票批量删除"
apiId: "5b3b421850a44e37bc7bc092647e4bb9"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/sd/vouchersaleinvoice/delete
...
| orgId | string | 否 | 否 | 开票组织id(code与orgId可组合删除) 示例：2013831551734016 |
| code | string | 是 | 否 | 发票编号(code与orgId可组合删除) 示例：["SACT20210303000017"] |

## 3. 请求示例

Url: /yonbip/sd/vouchersaleinvoice/delete?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"id": [
