---
title: "行政区划批量删除结果查询-新集成"
apiId: "2282642454968532999"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Administrative Region (MD)
...
请求地址	/yonbip/digitalModel/basedoc/baseregion/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/basedoc/baseregion/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
