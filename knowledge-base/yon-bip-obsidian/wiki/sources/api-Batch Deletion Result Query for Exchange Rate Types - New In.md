---
title: "汇率类型批量删除结果查询-新集成"
apiId: "2217355473128521734"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Exchange Rate Type (MD)
...
请求地址	/yonbip/digitalModel/basedoc/exchangeratetype/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/basedoc/exchangeratetype/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
