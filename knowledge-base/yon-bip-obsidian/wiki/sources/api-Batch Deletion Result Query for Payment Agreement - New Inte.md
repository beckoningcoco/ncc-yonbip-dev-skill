---
title: "收款协议批量删除结果查询-新集成"
apiId: "2217467090741755910"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Collection Agreement (MD)
...
请求地址	/yonbip/digitalModel/basedoc/async/receiveagreement/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/basedoc/async/receiveagreement/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
