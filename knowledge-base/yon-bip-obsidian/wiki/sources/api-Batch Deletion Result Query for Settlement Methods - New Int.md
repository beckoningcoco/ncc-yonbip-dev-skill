---
title: "结算方式批量删除结果查询-新集成"
apiId: "2247910892696502277"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Payment Method (MD)
...
请求地址	/yonbip/digitalModel/coredoc/async/settlemethod/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/coredoc/async/settlemethod/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
