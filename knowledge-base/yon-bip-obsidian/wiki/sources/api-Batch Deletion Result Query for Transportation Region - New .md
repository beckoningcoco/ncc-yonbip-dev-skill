---
title: "运输区域批量删除结果查询-新集成"
apiId: "2247910068062781441"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Transportation Area (MD)
...
请求地址	/yonbip/digitalModel/coredoc/async/shipregion/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/coredoc/async/shipregion/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
