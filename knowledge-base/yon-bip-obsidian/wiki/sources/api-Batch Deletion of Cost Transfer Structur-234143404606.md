...
请求地址	/yonbip/FCC/costcarry/delete
请求方式	POST
...
id	string	否	是	id 示例：2306255248942432256

## 3. 请求示例

Url: /yonbip/FCC/costcarry/delete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "2306255248942432256"
		}
	]
}
