...
请求地址	/yonbip/EFI/FixedAssetsCategoryVO/batchdelete
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| billnum | string | 否 | 是 | 单据编码 示例：fixed_assets_categorytree 默认值：fixed_assets_categorytree |
| data | object | 是 | 是 | 类别信息 |
...
Url: /yonbip/EFI/FixedAssetsCategoryVO/batchdelete?access_token=访问令牌
Body: {
	"billnum": "fixed_assets_categorytree",
	"data": [
		{
