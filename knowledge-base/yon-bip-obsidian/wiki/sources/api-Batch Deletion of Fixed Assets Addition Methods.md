...
请求地址	/yonbip/EFI/AddWay/batchdelete
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| billnum | string | 否 | 是 | 单据编码 示例：at_addwaylist 默认值：at_addwaylist |
| data | object | 是 | 是 | 增加方式信息 |
...
Url: /yonbip/EFI/AddWay/batchdelete?access_token=访问令牌
Body: {
	"billnum": "at_addwaylist",
	"data": [
		{
