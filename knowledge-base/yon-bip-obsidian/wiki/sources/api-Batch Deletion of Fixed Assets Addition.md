...
请求地址	/yonbip/EFI/AdditionBill/batchdelete
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| billnum | string | 否 | 是 | 单据编码 示例：fa_additionbilllist 默认值：fa_additionbilllist |
| data | object | 是 | 是 | 新增信息 |
...
Url: /yonbip/EFI/AdditionBill/batchdelete?access_token=访问令牌
Body: {
	"billnum": "fa_additionbilllist",
	"data": [
		{
