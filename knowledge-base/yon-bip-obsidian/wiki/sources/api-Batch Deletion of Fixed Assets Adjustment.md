...
请求地址	/yonbip/EFI/FixedAssetAdjustment/batchdelete
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| billnum | string | 否 | 是 | 单据编码 示例：fa_fixedassetadjustmentlist 默认值：fa_fixedassetadjustmentlist |
| data | object | 是 | 是 | 调整信息 |
...
Url: /yonbip/EFI/FixedAssetAdjustment/batchdelete?access_token=访问令牌
Body: {
	"billnum": "fa_fixedassetadjustmentlist",
	"data": [
		{
