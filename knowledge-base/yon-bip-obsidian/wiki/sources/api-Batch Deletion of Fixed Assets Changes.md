...
请求地址	/yonbip/EFI/FixedAssetChange/batchdelete
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| billnum | string | 否 | 是 | 单据编码 示例：FI_FA_FixedAssetChange 默认值：FI_FA_FixedAssetChange |
| data | object | 是 | 是 | 变动信息 |
...
Url: /yonbip/EFI/FixedAssetChange/batchdelete?access_token=访问令牌
Body: {
	"billnum": "FI_FA_FixedAssetChange",
	"data": [
		{
