...
请求地址	/yonbip/EFI/FaInventory/batchdelete
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| billnum | string | 否 | 是 | 单据编码 示例：FaInventorylist 默认值：FaInventorylist |
| data | object | 是 | 是 | 盘点信息 |
...
Url: /yonbip/EFI/FaInventory/batchdelete?access_token=访问令牌
Body: {
	"billnum": "FaInventorylist",
	"data": [
		{
