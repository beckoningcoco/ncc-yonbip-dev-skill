...
请求地址	/yonbip/EFI/reclass_bill/batchdelete
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| billnum | string | 否 | 是 | 单据编码 示例：fa_reclassbilllist 默认值：fa_reclassbilllist |
| data | object | 是 | 是 | 重分类信息 |
...
Url: /yonbip/EFI/reclass_bill/batchdelete?access_token=访问令牌
Body: {
	"billnum": "fa_reclassbilllist",
	"data": [
		{
