...
请求地址	/yonbip/EFI/transfer_bill/batchdelete
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| billnum | string | 否 | 是 | 单据编码 示例：fa_transferbilllist 默认值：fa_transferbilllist |
| data | object | 是 | 是 | 转移单信息 |
...
Url: /yonbip/EFI/transfer_bill/batchdelete?access_token=访问令牌
Body: {
	"billnum": "fa_transferbilllist",
	"data": [
		{
