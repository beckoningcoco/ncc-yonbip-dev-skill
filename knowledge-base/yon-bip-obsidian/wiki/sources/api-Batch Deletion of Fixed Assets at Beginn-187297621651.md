...
>  请求方式	POST | Fixed Asset Opening (EFI)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/EFI/InitiationBill/batchdelete
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
billnum	string	否	是	单据编码 示例：fa_initiationbilllist 默认值：fa_initiationbilllist
data	object	是	是	期初信息
...
Url: /yonbip/EFI/InitiationBill/batchdelete?access_token=访问令牌
Body: {
	"billnum": "fa_initiationbilllist",
	"data": [
		{
