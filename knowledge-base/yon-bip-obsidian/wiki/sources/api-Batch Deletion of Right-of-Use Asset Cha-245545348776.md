...
请求地址	/yonbip/FCC/FaLeaseChange/batchdelete
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
billnum	string	否	是	单据编码 示例：FaLeaseChangeList 默认值：FaLeaseChangeList
...
Url: /yonbip/FCC/FaLeaseChange/batchdelete?access_token=访问令牌
Body: {
	"billnum": "FaLeaseChangeList",
	"data": [
		{
