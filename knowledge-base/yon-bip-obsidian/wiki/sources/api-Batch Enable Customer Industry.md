---
title: "客户行业批量启用"
apiId: "2c20dee1946f4d63813556d56087234d"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/customertrade/batchStart
...
| id | long | 否 | 否 | 客户行业id 示例：1876726403437568 |
| code | string | 否 | 否 | 客户行业编码 示例：666 |

## 3. 请求示例

Url: /yonbip/digitalModel/customertrade/batchStart?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1876726403437568,
...
| pubts | string | 否 | 时间戳 示例：2020-10-24 10:39:57 |
| errorDetail | string | 否 | 错误详情 示例：null |
