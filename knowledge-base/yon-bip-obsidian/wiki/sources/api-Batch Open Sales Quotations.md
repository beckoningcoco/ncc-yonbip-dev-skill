...
请求地址	/yonbip/sd/quote/salesquotation/open
...
| id | long | 否 | 是 | 单据id 示例：1541784966159400962 |

## 3. 请求示例

Url: /yonbip/sd/quote/salesquotation/open?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1541784966159400962
		}
	]
}
		...
		"infos": [
			{
				...
				"status": 1,
				"pubts": "2022-09-14 13:49:30"
			}
		],
		"failInfos": [
			{
				"id": 123456789,
				"message": "打开的报价单不存在，请确认！"
			}
		]
	}
}
