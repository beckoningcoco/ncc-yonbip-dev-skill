...
请求地址	/yonbip/digitalModel/productapply/batchsaveformodify
请求方式	POST
...
Url: /yonbip/digitalModel/productapply/batchsaveformodify?access_token=访问令牌
Body: {
	"data": [
		{
			"resubmitCheckKey": "",
			...
			"applyDesc": "备注",
			"productData": {
				"applyRangeOrgCode": "global00",
				"applyRangeOrgId": "666666",
				"code": "0012000372",
				"name": {
					"simplifiedName": "简体",
					"englishName": "英文",
