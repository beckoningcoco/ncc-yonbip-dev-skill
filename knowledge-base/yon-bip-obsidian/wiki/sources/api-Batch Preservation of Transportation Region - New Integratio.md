---
title: "运输区域批量保存-新集成"
apiId: "2174270319738486791"
apiPath: "请求方式	POST"
method: "ContentType	application/json"
category: "Transportation Area"
domain: "MD"
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Transportation Area]
...
> `ContentType	application/json` 请求方式	POST | 分类: Transportation Area (MD)
...
请求地址	/yonbip/digitalModel/shipregion/batchSave
...
| code | string | 否 | 是 | 运输区域编码 示例：1 |
| country | string | 否 | 否 | 国家/地区id（与country___code二选一录入即可，默认id有值时，code字段不生效） 示例：2211575684096589833 |
...
Url: /yonbip/digitalModel/shipregion/batchSave?access_token=访问令牌
Body: {
	"matchRule": "id",
