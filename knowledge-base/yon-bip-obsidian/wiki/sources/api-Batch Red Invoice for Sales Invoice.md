---
title: "销售发票批量红冲"
apiId: "14ffdad47579493d81faafcdbcda4132"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/sd/vouchersaleinvoice/red
...
| orgId | string | 否 | 否 | 开票组织id(code与orgId可组合红冲) 示例：2013831551734016 |
| code | string | 是 | 否 | 发票编号(code与orgId可组合红冲) 示例：["SACT20210303000017"] |

## 3. 请求示例

Url: /yonbip/sd/vouchersaleinvoice/red?access_token=访问令牌
Body: {
	"data": {
		"id": [
			2155419223904768
