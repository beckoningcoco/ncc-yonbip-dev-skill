---
title: "销售发票批量审核"
apiId: "cceb23461302468f84bd3418e934d429"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/sd/vouchersaleinvoice/audit
...
| orgId | string | 否 | 否 | 开票组织id(code与orgId可组合审核) 示例：2013831551734016 |
| code | string | 是 | 否 | 发票编号(code与orgId可组合审核) 示例：["SACT20210303000017"] |

## 3. 请求示例

Url: /yonbip/sd/vouchersaleinvoice/audit?access_token=访问令牌
Body: {
	"data": {
		"id": [
			2155419223904768
