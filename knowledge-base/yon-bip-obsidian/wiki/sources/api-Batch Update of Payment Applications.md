...
请求地址	/yonbip/EFI/paymentApply/batchupdate
...
| id | string | 否 | 否 | 付款申请单主表id (新增时不填，修改时必填) 示例：1576118238809993876 |
...
| _status | string | 否 | 是 | 操作标识 (Update) 示例：Update |

## 3. 请求示例

Url: /yonbip/EFI/paymentApply/batchupdate?access_token=访问令牌
Body: {
	"data": [
		{
