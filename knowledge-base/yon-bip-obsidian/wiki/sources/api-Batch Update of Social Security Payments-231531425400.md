...
请求地址	/yonbip/HCC/insurancePay/updateInsurancePay
请求方式	POST
...
staffId	string	否	否	staffId 示例：string
orgId	string	否	否	orgId 示例：string
insuranceYearMonth	string	否	否	insuranceYearMonth 示例：string
payPersonalPayTotal	string	否	否	payPersonalPayTotal 示例：1000
payCompanyPayTotal	string	否	否	payCompanyPayTotal 示例：5000
memo	string	否	否	memo 示例：string
billDataState	string	否	否	billDataState 示例：string
verifystate	string	否	否	verifystate 示例：0
adminOrgId	string	否	否	adminOrgId 示例：string
lockState	string	否	否	lockState 示例：string
approveState	string	否	否	approveState 示例：string
entrustedStatus	string	否	否	entrustedStatus 示例：1
insurancePayThisMonthDetails	object	是	否	insurancePayThisMonthDetails
id	string	否	否	id 示例：123
mainId	string	否	否	mainId 示例：MAIN1001
adminOrgId	string	否	否	adminOrgId 示例：ORG100
...
payPersonalAdjustmentAmount	string	否	否	payPersonalAdjustmentAmount 示例：0
payCompanyAdjustmentAmount	string	否	否	payCompanyAdjustmentAmount 示例：0
...
Url: /yonbip/HCC/insurancePay/updateInsurancePay?access_token=访问令牌
Body: [{
	"id": "123",
	"staffId": "string",
	"orgId": "string",
	"insuranceYearMonth": "string",
	"payPersonalPayTotal": "1000",
	"payCompanyPayTotal": "5000",
	"memo": "string",
	"billDataState": "string",
	"verifystate": "0",
	"adminOrgId": "string",
	"lockState": "string",
	"approveState": "string",
	"entrustedStatus": "1",
	"insurancePayThisMonthDetails": [
		{
			"id": "123",
			"mainId": "MAIN1001",
			"adminOrgId": "ORG100",
			...
			"lockState": "0",
			"approveState": "1",
			"payPersonalAdjustmentAmount": "0",
			"payCompanyAdjustmentAmount": "0",
