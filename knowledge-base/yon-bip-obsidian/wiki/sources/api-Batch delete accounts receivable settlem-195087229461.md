...
请求地址	/yonbip/EFI/earap/openapi/bill/receivable/batchdelete
请求方式	POST
...
code	string	否	是	单据编号 示例：OARar240327000472

## 3. 请求示例

Url: /yonbip/EFI/earap/openapi/bill/receivable/batchdelete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "1484061404544630789",
			"code": "OARar240327000472"
		}
	]
}
