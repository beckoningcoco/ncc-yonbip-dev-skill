---
title: "批量删除消费税视同销售计算表"
apiId: "1847685155571892226"
apiPath: "请求方式	POST"
...
> `ContentType	application/json` 请求方式	POST | 分类: Consumption Tax Deemed Sales Calculation Sheet (TAX)
...
请求地址	/yonbip/tax/yonbip-fi-taxoth/api/excise/as-sales/batch-del
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| ids | string | 是 | 否 | 数据唯一标识集合 示例：["1847871591520141316","1847867391042125831"] |

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxoth/api/excise/as-sales/batch-del?access_token=访问令牌
Body: {
	"ids": [
		"1847871591520141316",
		"1847867391042125831"
