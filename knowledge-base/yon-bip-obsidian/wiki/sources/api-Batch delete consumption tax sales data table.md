...
请求地址	/yonbip/tax/yonbip-fi-taxoth/api/excise/sale-collection/batch-del
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| ids | string | 是 | 是 | 数据唯一标识集合 示例：["1847871591520141316","1847867391042125831"] |

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxoth/api/excise/sale-collection/batch-del?access_token=访问令牌
Body: {
	"ids": [
		"1847871591520141316",
		"1847867391042125831"
