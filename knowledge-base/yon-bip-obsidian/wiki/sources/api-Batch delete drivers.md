...
请求地址	/yonbip/digitalModel/basedoc/async/driver/batchDelete
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 否 | 请求体 |
| sourceUnique | string | 否 | 是 | 源系统唯一标识 示例：2217349090920366091 |
| id | string | 否 | 是 | 删除记录ID 示例：2217349090920366091 |

## 3. 请求示例

Url: /yonbip/digitalModel/basedoc/async/driver/batchDelete?access_token=访问令牌
Body: {
	"data": [
		{
