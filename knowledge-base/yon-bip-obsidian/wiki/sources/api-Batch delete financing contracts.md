...
请求地址	/yonbip/ctm/financingRegister/open/delete
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| id | number |
| 小数位数:1,最大长度:36 | 否 | 否 | 融资合同id |
| protocolNumber | string | 否 | 否 | 协议号 |

## 3. 请求示例

Url: /yonbip/ctm/financingRegister/open/delete?access_token=访问令牌
Body: [{
	"id": 0,
	"protocolNumber": ""
}]
