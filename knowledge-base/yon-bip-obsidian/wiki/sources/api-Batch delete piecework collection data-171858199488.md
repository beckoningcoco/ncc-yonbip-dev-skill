...
请求地址	/yonbip/mfg/sfc/pieceworkcollect/batchdelete
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	是	是	计件采集数据集
id	long	否	是	计件采集查询数据ID 示例：2745642964029952

## 3. 请求示例

Url: /yonbip/mfg/sfc/pieceworkcollect/batchdelete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2745642964029952
