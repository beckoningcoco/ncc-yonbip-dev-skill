---
title: "计划委托关系批量删除"
apiId: "42e75a359dd84fc3ba9737c97b6cd183"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/planDelegate/batchDelete
请求方式	POST
...
Url: /yonbip/digitalModel/planDelegate/batchDelete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "1295051792765184"
...
successCountAI	string	否	预计成功总数 示例：1
failCountAI	string	否	预计失败总数 示例：0
