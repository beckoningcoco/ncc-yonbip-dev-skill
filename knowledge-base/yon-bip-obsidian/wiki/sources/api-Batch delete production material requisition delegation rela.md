---
title: "生产领料委托关系批量删除"
apiId: "179b593556964fc4be2475fb55b19581"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/pickingDelegate/batchDelete
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 否 | 数据参数 |
| id | string | 否 | 是 | 生产领料委托关系ID 示例：1295051792765184 |

## 3. 请求示例

Url: /yonbip/digitalModel/pickingDelegate/batchDelete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "1295051792765184"
