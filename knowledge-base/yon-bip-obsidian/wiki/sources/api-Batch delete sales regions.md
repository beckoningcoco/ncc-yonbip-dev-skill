---
title: "销售区域批量删除"
apiId: "499275adcb09498491f4039ad27b4f2b"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/salearea/batchdelete
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 是 | 销售区域数据，id与编码必输其一,id和编码同时存在时，以id为准 |
| id | long | 否 | 否 | 销售区域id 示例：2417212255834368 |
| code | string | 否 | 否 | 销售区域编码 示例：20210904 |
| pubts | string | 否 | 否 | 时间戳 示例：2021-09-04 13:55:28 |

## 3. 请求示例

Url: /yonbip/digitalModel/salearea/batchdelete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2417212255834368,
			"code": "20210904",
			"pubts": "2021-09-04 13:55:28"
		}
	]
}
