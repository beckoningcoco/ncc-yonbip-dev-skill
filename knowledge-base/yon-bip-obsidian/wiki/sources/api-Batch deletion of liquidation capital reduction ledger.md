...
请求地址	/yonbip/tax/yonbip-fi-taxoth/api/clearing-reduction-ledger/batchDelete
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| id | string | 否 | 是 | 主键 示例：1 |
| clearingIds | string | 是 | 否 | 被投资企业清算确认金额主键 示例：["1"] |
| reduceIds | string | 是 | 否 | 撤回或减少投资确认金额主键 示例：["1"] |

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxoth/api/clearing-reduction-ledger/batchDelete?access_token=访问令牌
Body: [{
	"id": "1",
	"clearingIds": [
		"1"
