---
title: "品牌批量停用"
apiId: "14ee7be55e4e42459eb65a8236164528"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/brand/batchStop
...
Url: /yonbip/digitalModel/brand/batchStop?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1971429376266496,
...
| stoptime | string | 否 | 停用时间 示例：2020-10-24 16:06:56 |
| stopstatus | boolean | 否 | 是否停用，true：已停用，false：已启用 示例：true |
| tenant | long | 否 | 租户id 示例：1838010622546176 |
| pubts | string | 否 | 时间戳 示例：2020-10-24 16:06:57 |
	...
	"data": [
		{
			"id": 1971429376266496,
			"name": "20210830",
			"stoptime": "2020-10-24 16:06:56",
			"stopstatus": true,
			"tenant": 1838010622546176,
			"pubts": "2020-10-24 16:06:57"
		}
	]
}
