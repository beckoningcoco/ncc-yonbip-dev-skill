---
title: "客户级别批量停用"
apiId: "85a432032b524a028165d6ca5396a30d"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/cuslevel/batchStop
...
| id | long | 否 | 否 | 客户级别id 示例：1971132402487552 |
| code | string | 否 | 否 | 客户级别编码 示例：111 |

## 3. 请求示例

Url: /yonbip/digitalModel/cuslevel/batchStop?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1971132402487552,
