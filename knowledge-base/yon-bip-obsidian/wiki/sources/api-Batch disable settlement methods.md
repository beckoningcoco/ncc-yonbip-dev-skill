---
title: "结算方式批量停用"
apiId: "ebe4a40ba75f4ea3a9de0eb59bbb59e9"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/settlemethod/batchStop
...
| id | long | 否 | 否 | 结算方式id 示例：1973877904281856 |
| code | string | 否 | 否 | 结算方式编码 示例：20210830 |

## 3. 请求示例

Url: /yonbip/digitalModel/settlemethod/batchStop?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1973877904281856,
