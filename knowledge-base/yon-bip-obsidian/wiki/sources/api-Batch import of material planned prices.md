---
title: "材料计划价批量导入"
apiId: "2369495945041674248"
apiPath: "请求方式	POST"
method: "ContentType	application/json"
category: "Planned Material Price"
domain: "CO"
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Planned Material Price]
...
> `ContentType	application/json` 请求方式	POST | 分类: Planned Material Price (CO)
...
请求地址	/yonbip/FCC/eces/materialplanprice/batchSave
...
| accbook | string | 否 | 否 | 账簿id 示例：4 |
| accbookCode | string | 否 | 是 | 账簿编码 示例：0909，id和编码同时存在，优先按id保存 |
...
Url: /yonbip/FCC/eces/materialplanprice/batchSave?access_token=访问令牌
Body: {
	"accentity": "2",
	...
	"accbook": "4",
	"accbookCode": "0909，id和编码同时存在，优先按id保存\t",
	"items": [
		{
			"product": "33",
