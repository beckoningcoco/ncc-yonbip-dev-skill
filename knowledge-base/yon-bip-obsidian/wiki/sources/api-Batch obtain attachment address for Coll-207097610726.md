...
>  请求方式	POST | Collection Refund Note (EFI)
...
请求地址	/yonbip/EFI/arRefund/download/url
请求方式	POST
...
Url: /yonbip/EFI/arRefund/download/url?access_token=访问令牌
Body: {
	"businessIds": [
		"aa",
		"bb"
