...
请求地址	/yonbip/digitalModel/paymentDate/queryBusinessFiles
请求方式	POST
...
Url: /yonbip/digitalModel/paymentDate/queryBusinessFiles?access_token=访问令牌
Body: {
	"businessIds": [
		"1",
		"2"
