...
请求地址	/yonbip/digitalModel/role/saveUserRoles
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| userId | string | 否 | 是 | 用户通用户Id 示例：031bbe2a-5633-4561-96b6-ef5755669f34 |
...
Url: /yonbip/digitalModel/role/saveUserRoles?access_token=访问令牌
Body: [{
...
999	角色Id与角色编码二选一必填	入参中传角色id或者角色编码
