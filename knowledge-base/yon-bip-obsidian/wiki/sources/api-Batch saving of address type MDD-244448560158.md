...
请求地址	/yonbip/HCC/addressType/batchSave
请求方式	POST
...
AddressTypeCountry	object	是	否	适用国家/地区
_status	string	否	是	数据状态（新增：Insert、更新：Update） 示例：Insert

## 3. 请求示例

Url: /yonbip/HCC/addressType/batchSave?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"id": "",
