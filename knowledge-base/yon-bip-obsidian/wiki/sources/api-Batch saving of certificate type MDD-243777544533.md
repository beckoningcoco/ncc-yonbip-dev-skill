...
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Certificate Type]
...
>  请求方式	POST | Certificate Type (CHR)
...
请求地址	/yonbip/HCC/certificatetype/batchSave
请求方式	POST
...
Url: /yonbip/HCC/certificatetype/batchSave?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"id": "",
