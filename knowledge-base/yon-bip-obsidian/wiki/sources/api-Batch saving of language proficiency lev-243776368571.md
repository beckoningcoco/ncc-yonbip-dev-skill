...
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Language Proficiency]
...
>  请求方式	POST | Language Proficiency (CHR)
...
请求地址	/yonbip/HCC/langproflevel/batchSave
请求方式	POST
...
Url: /yonbip/HCC/langproflevel/batchSave?access_token=访问令牌
Body: {
	"data": [
		{
			"resubmitCheckKey": "",
