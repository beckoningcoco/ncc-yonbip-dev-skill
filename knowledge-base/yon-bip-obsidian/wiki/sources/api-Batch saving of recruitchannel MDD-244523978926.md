...
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Recruitment Channel]
...
>  请求方式	POST | Recruitment Channel (CHR)
...
请求地址	/yonbip/HCC/recruitchannel/batchSave
请求方式	POST
...
Url: /yonbip/HCC/recruitchannel/batchSave?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"id": "",
