...
请求地址	/yonbip/FCC/receivable/batchsubmit
请求方式	POST
...
Url: /yonbip/FCC/receivable/batchsubmit?access_token=访问令牌
Body: {
	"data": [
		{
			"resubmitCheckKey": "",
...

{
	...
	"data-async": {
		...
		"infos": [
			{
				"url": "/bill/asyncBatchActionQuery/batchsubmit",
