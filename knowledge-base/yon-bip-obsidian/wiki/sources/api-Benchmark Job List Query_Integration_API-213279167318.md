---
title: "基准职位列表查询_集成_API"
apiId: "2132791673181175815"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/hrcloud/basepost/listForIntegration
请求方式	POST
...
postSequenceId	string	否	否	所属序列 示例：序列编码
effectiveDate	date
格式:yyyy-MM-dd HH:mm:ss	否	否	生效日期 示例：2024-11-13 00:00:00
enableList	number
...
Url: /yonbip/hrcloud/basepost/listForIntegration?access_token=访问令牌
Body: {
	"name": "名称",
	"code": "123",
	"postSequenceId": "序列编码",
