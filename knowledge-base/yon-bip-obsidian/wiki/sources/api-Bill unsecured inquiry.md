---
title: "票据解押查询"
apiId: "2387418646004629509"
apiPath: "请求方式	POST"
method: "ContentType	application/json"
category: "Bill Pledge"
domain: "ctm"
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Bill Pledge]
...
> `ContentType	application/json` 请求方式	POST | 分类: Bill Pledge (ctm)
...
请求地址	/yonbip/FCC/api/impawnBack/detail
...
| unimpawnDateStart | date |
| 格式:yyyy-MM-dd | 否 | 否 | 解质押日期开始 |
| unimpawnDateEnd | date |
| 格式:yyyy-MM-dd | 否 | 否 | 解质押日期结束 |
...
| billStatus | string | 否 | 否 | 单据状态（17:在解押 18:已解押 2:已作废 ） |
| downloadFile | boolean | 否 | 否 | 下载附件 |

## 3. 请求示例

Url: /yonbip/FCC/api/impawnBack/detail?access_token=访问令牌
Body: {
	"id": 0,
	"accentityCode": "",
	"accentityName": "",
	"unimpawnDateStart": "2026-06-07",
	"unimpawnDateEnd": "2026-06-07",
	"noteType": "",
	"noteFlag": 0,
	"noteno": "",
	"billRange": "",
