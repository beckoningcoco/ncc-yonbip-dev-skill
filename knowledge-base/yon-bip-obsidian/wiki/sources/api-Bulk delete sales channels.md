---
title: "销售渠道批量删除"
apiId: "8dd25d19b4ad4dd98b872c86e2fbbf4d"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/customerType/batchdelete
...
| id | long | 否 | 否 | 销售渠道id 示例：2444117470630144 |
| code | string | 否 | 否 | 销售渠道编码 示例：20210923_1 |
| pubts | string | 否 | 否 | 时间戳 示例：2021-09-23 14:04:52 |

## 3. 请求示例

Url: /yonbip/digitalModel/customerType/batchdelete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2444117470630144,
			"code": "20210923_1",
			"pubts": "2021-09-23 14:04:52"
		}
	]
}
