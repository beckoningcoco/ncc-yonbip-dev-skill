...
请求地址	/yonbip/AMP/openapi/busievent/receive
...
| action | string | 否 | 是 | 请求动作 新增：add(事件中心异步) 删除：delete(rpc同步) 更新：update(暂不支持) 示例：add |
...
Url: /yonbip/AMP/openapi/busievent/receive?access_token=访问令牌
Body: {
	"eventInfo": {
