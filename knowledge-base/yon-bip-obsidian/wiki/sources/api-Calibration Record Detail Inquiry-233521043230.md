...
请求地址	/yonbip/am/aumscrapcard/delete
请求方式	POST
...
id	string	否	否	资产报废id 示例：1476611216843472896

## 3. 请求示例

Url: /yonbip/am/aumscrapcard/delete?access_token=访问令牌
Body: {
	"data": [
		{
