...
请求地址	/yonbip/tax/api/etax/redinfo-apply/cancel
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| reqBillNo | string | 否 | 是 | 红字信息表流水号 示例：1232556 |

## 3. 请求示例

Url: /yonbip/tax/api/etax/redinfo-apply/cancel?access_token=访问令牌
Body: {
	"reqBillNo": "1232556"
}
