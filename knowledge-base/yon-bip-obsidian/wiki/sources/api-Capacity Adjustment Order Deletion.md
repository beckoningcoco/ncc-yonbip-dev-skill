...
请求地址	/yonbip/mfg/capacity/adjust/delete
...
| id | number |
| 小数位数:0,最大长度:19 | 否 | 是 | 单据ID 示例：2332656171831552 |

## 3. 请求示例

Url: /yonbip/mfg/capacity/adjust/delete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2332656171831552
