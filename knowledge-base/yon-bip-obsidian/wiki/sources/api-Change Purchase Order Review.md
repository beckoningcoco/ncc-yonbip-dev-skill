...
请求地址	/yonbip/scm/purchaseordermodify/batchaudit
...
| id | string | 否 | 是 | 主表id 示例：2224754591355136 |

## 3. 请求示例

Url: /yonbip/scm/purchaseordermodify/batchaudit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "2224754591355136"
