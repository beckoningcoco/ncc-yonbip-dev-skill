...
请求地址	/yonbip/scm/purchaseordermodify/batchsubmit
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 是 | 采购订单变更[pu.purchaseordermodify.PurchaseOrderModify] |
| id | long | 否 | 是 | 采购订单变更主表id 示例：2282796996055296 |

## 3. 请求示例

Url: /yonbip/scm/purchaseordermodify/batchsubmit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2282796996055296
