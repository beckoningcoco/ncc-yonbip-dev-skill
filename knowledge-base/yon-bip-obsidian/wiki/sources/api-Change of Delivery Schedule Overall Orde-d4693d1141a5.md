---
title: "交货计划整单状态变更"
apiId: "d4693d1141a5421c8d60d204ee4b8724"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/cpu/delplan/updateStatus
请求方式	POST
...
billstatus	string	否	否	整单状态 10-整单打开 19-整单关闭 示例：10
billBodys	object	否	否	表体
delplanNo	string	否	否	交货计划单编号 示例：2021041207

## 3. 请求示例

Url: /yonbip/cpu/delplan/updateStatus?access_token=访问令牌
Body: {
	"billHead": {
		"billNo": "2021041207",
		"billstatus": "10"
