...
请求地址	/yonbip/cpu/synergy/claimDelete
请求方式	POST
...
id	long	否	是	索赔扣款单主键 示例：29668677752629763

## 3. 请求示例

Url: /yonbip/cpu/synergy/claimDelete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 29668677752629763
		}
	]
}
