...
请求地址	/yonbip/mfg/arriveplanconsult/batchclose
请求方式	POST
...
closeDate	date
格式:yyyy-MM-dd	否	否	关闭日期 示例：2025-01-01
closeRemark	string	否	否	关闭说明 示例：关闭说明

## 3. 请求示例

Url: /yonbip/mfg/arriveplanconsult/batchclose?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2373477794877696,
