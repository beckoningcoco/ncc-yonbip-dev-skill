...
请求地址	/yonbip/scm/purchaseorder/warehousingClose
...
Url: /yonbip/scm/purchaseorder/warehousingClose?access_token=访问令牌
Body: {
	"data": [
		{
...
| messages | object | 是 | 消息 示例：["CG000006000578单据入库关闭成功"] |
| infos | object | 是 | 信息 示例：["CG000006000578单据入库关闭成功"] |
| failInfos | object | 是 | 失败信息 示例：["CG000006000578单据入库关闭失败"] |
...

{
	...
	"data": {
		...
		"failCount": 0,
		"messages": [
			"CG000006000578单据入库关闭成功"
		],
		"infos": [
			"CG000006000578单据入库关闭成功"
		],
		"failInfos": [
			"CG000006000578单据入库关闭失败"
		]
	}
}
