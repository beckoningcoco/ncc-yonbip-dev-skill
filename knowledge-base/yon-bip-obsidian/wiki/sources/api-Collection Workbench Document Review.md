...
请求地址	/yonbip/ctm/receivebill/batchaudit
...
| id | long | 否 | 是 | 单据id 示例：12456765585445 |

## 3. 请求示例

Url: /yonbip/ctm/receivebill/batchaudit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 12456765585445
