...
请求地址	/yonbip/EFI/collection/submit
...
Url: /yonbip/EFI/collection/submit?access_token=访问令牌
Body: {
	"data": {
...
| data | object | 否 | 返回数据 |
| id | string | 否 | 收款单表头主键 示例：1483387421116596230 |
...
999	提交失败,当前单据已提交,不允许重复操作!	请输入有效且未提交的单据id
