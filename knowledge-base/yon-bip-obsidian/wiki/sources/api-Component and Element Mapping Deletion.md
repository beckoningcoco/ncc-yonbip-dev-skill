...
请求地址	/yonbip/FCC/yonbip-fi-epub/component/chdefault/bill/batchdelete
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 否 | 数据 |
| id | string | 否 | 是 | id 示例：2341551564972883976 |

## 3. 请求示例

Url: /yonbip/FCC/yonbip-fi-epub/component/chdefault/bill/batchdelete?access_token=访问令牌
Body: {
	"data": [
		{
