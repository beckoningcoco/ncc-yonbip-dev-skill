...
请求地址	/yonbip/ACC/pvmpmconditioncard/detail
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
id	string	否	否	ID 示例：2335471085264830464
code	string	否	否	预防性维护编码 示例：TJPM202508130001

## 3. 请求示例

Url: /yonbip/ACC/pvmpmconditioncard/detail?access_token=访问令牌
Body: {
	"id": "2335471085264830464",
	"code": "TJPM202508130001"
}
...
data	object	否	返回值数据
pk_director	string	否	主管人ID 示例：2117175472615325696
wo_content	string	否	工作内容 示例：工作内容
modifier	string	否	修改人ID 示例：5dd8fa6d-285c-4302-ad63-3b754ef4e649
...
pk_executor__name	string	否	执行人 示例：赵艳玲
billmaker__name	string	否	制单人 示例：白兆辉
pk_psn_group__name	string	否	工作班组 示例：验证班组
modifier__name	string	否	最后修改人 示例：白兆辉
wo_pk_transitype__code	string	否	下游单据交易类型编码 示例：4B36-01
pk_overhaul__code	string	否	检修清单编码 示例：JXQD202411090001
...
pk_overhaul	string	否	检修清单 示例：2129802281330147329
pk_specialty__special_name	string	否	负责专业 示例：专业001
modifiedtime	string	否	修改时间 示例：2025-08-13 19:32:54
pk_psn_group	string	否	工作班组ID 示例：2128204029523132417
ahead_days	number
小数位数:0,最大长度:10	否	提前期（天） 示例：0
initial_date	string	否	开始日期 示例：2025-08-13
periods	number
小数位数:0,最大长度:10	否	周期 示例：1
wo_pk_transitype__name	string	否	下游单据交易类型 示例：工单管理
pubts	string	否	时间戳 示例：2025-08-13 19:32:55
origin_next_start_date	string	否	下一工单目标日期 示例：2025-08-13
billmaketime	string	否	制单时间 示例：2025-08-13 19:30:18
...
pri_clause	string	否	优先级理由 示例：优先级理由
pk_equip	string	否	资产ID 示例：2180370255628468226
wo_pk_transitype	string	否	下游单据交易类型 示例：2086855417276137578
next_start_date	string	否	下一工单目标日期 示例：2025-08-13
pk_priority__cbgColor	string	否	背景颜色 示例：#2992FF
alter_flag	boolean	否	可变计划 示例：false
wo_mode	number
小数位数:0,最大长度:10	否	工作模式 示例：0
transi_type	string	否	交易类型编码 示例：4B76-01
...
pk_executor	string	否	执行人ID 示例：2131255535062745095
persist_flag	boolean	否	已调整 示例：false
...

{
	...
	"data": {
		...
		"pm_result": [
			{
				"pk_meas_items": "PRESET02_0000M0Z8652LF1ZI810000",
				"pk_measuredoc__precision": 2,
				"initial_num": 0,
				"pk_meas_items__name": "用电量",
				"pk_org": "2099319085960527881",
				"pk_measuredoc": 2086854936260771849,
				"pk_measure_point__code": "CLD0001",
				"next_num": 1,
				"id": "2335471085264830465",
				"pk_measuredoc__name": "千瓦时",
				"pubts": "2025-08-13 19:30:19",
				"pk_measure_point": "2335461206835331076",
				"rowno": "1",
				"identifier": "用电量01",
				"origin_alter_flag": false,
				"pk_org__name": "全职能组织",
				"main_id": "2335471085264830464",
				"pk_measure_point__name": "用电量01",
				"alter_flag": false,
				"ahead_num": 0,
				"origin_next_num": 1,
				"gen_rate": 1,
				"persist_flag": false,
				"pk_measure_point__result": 0
			}
		],
		"pk_equip__equip_code": "20-202501160001",
		"pk_transitype": "2086855417276137597",
		...
		"modifiedtime": "2025-08-13 19:32:54",
		"pk_psn_group": "2128204029523132417",
		"ahead_days": 0,
		"initial_date": "2025-08-13",
		"periods": 1,
		"wo_pk_transitype__name": "工单管理",
		"pubts": "2025-08-13 19:32:55",
		"origin_next_start_date": "2025-08-13",
		"billmaketime": "2025-08-13 19:30:18",
		"origin_alter_flag": false,
