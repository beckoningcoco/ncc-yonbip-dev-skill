...
请求地址	/yonbip/FCC/tbb/cube/importData
请求方式	POST
...
content	string	否	是	导入内容（字符串格式）
base64	string	否	是	导入内容是否是base64编码（1表示是，建议使用base64） 默认值：1

## 3. 请求示例

Url: /yonbip/FCC/tbb/cube/importData?access_token=访问令牌
Body: {
	"pk_cube": "",
	"content": "",
	"base64": ""
