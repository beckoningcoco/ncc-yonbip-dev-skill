---
title: "消费税委托加工领用明细-更新"
apiId: "1900596343765204996"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/tax/yonbip-fi-taxoth/api/consignment/sreceive-detail/batch-update
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| records | object | 是 | 是 | 更新领用明细记录 |
| code | string | 否 | 是 | 单据编号ID 示例：174425917296821862 |
...
Url: /yonbip/tax/yonbip-fi-taxoth/api/consignment/sreceive-detail/batch-update?access_token=访问令牌
Body: {
	"records": [
		{
			"code": "174425917296821862",
			"orgCode": "MT0000001",
			"period": "2023-10",
