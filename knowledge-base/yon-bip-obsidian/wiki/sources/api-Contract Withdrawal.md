...
请求地址	/yonbip/znbz/apct/openapi/bill/unsubmit
...
| id | string | 否 | 是 | id 示例：12883271772372 |

## 3. 请求示例

Url: /yonbip/znbz/apct/openapi/bill/unsubmit?access_token=访问令牌
Body: {
	"data": {
		"id": "12883271772372"
	}
