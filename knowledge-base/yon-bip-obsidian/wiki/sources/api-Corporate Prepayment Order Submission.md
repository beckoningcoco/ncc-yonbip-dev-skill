...
请求地址	/yonbip/znbz/rbsm/api/bill/pubprepay/submit
...
Url: /yonbip/znbz/rbsm/api/bill/pubprepay/submit?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
...
| data | object | 否 | 返回数据 |
| chandleorg | string | 否 | 报销人组织.ID 示例：2560211497063168 |
...
| id | long | 否 | id 示例：1513716590373765000 |
| pubts | string | 否 | 更新时间 示例：2022-08-31 12:39:07 |
...
| bustype | string | 否 | 交易类型 示例：2554302900933945 |
| cfinacecostcenter | long | 否 | 费用承担成本中心.ID 示例：2739724343382528 |
| caccountorg | string | 否 | 会计主体.ID 示例：2560211497063168 |
| vnatexchratetype | string | 否 | 组织本币汇率类型.ID 示例：0000KWZR3QO969OC1X0000 |
| pk_billtype | string | 否 | 单据类型（znbzbx_memoapply:通用申请单;znbzbx_busistrip:出差申请单;znbzbx_expensebill:通用报销单;znbzbx_travelexpbill:差旅报销单） 示例：znbzbx_pubprepay |
...

{
	...
	"data": {
		...
		"ibudgetctrltype": 99,
		"id": 1513716590373765000,
		"pubts": "2022-08-31 12:39:07",
		"resubmitCheckKey": "OPENAPI_1519100400575709188_0000KWZR3QO969OC1X0000_wewew",
		"iauditresult": 7,
		"isWfControlled": true,
		"vfinacedeptid": "2560214375846144",
		"bustype": "2554302900933945",
