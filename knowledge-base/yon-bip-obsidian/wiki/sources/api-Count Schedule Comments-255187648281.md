...
请求地址	/yonbip/uspace/schedule/{scheduleId}/comments/count
请求方式	GET
ContentType	
应用场景	开放API
事务和幂等性	无
...
Url: /yonbip/uspace/schedule/schedule001/comments/count?access_token=访问令牌
