---
title: "班组批量删除结果查询-新集成"
apiId: "2217424338637291521"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Crew (MD)
...
请求地址	/yonbip/digitalModel/basedoc/teamdefinition/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/basedoc/teamdefinition/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
