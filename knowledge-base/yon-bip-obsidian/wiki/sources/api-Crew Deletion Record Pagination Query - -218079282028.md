---
title: "班组删除记录分页查询-新集成"
apiId: "2180792820284522504"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/basedoc/teamdefinition/batchQueryDeleteLogs
请求方式	POST
...
ids	string	是	否	主键id集合 示例：["2217416229843369992","2217416229843369993"]

## 3. 请求示例

Url: /yonbip/digitalModel/basedoc/teamdefinition/batchQueryDeleteLogs?access_token=访问令牌
Body: {
	"pageIndex": 1,
	"pageSize": 10,
