...
请求地址	/yonbip/tax/other-tax/api/tax-across-deduction/batch-del
请求方式	POST
...
Url: /yonbip/tax/other-tax/api/tax-across-deduction/batch-del?access_token=访问令牌
Body: {
	"data": [
		""
	]
