...
>  请求方式	POST | Cross-period deduction project account (TAX)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/tax/other-tax/api/tax-across-deduction/batch-edit
请求方式	POST
...
deductionType	string	否	是	跨期扣除类型1：
...
Url: /yonbip/tax/other-tax/api/tax-across-deduction/batch-edit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "",
