---
title: "币种批量删除结果查询-新集成"
apiId: "2217338147230449665"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Currency (MD)
...
请求地址	/yonbip/digitalModel/basedoc/currencytenant/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/basedoc/currencytenant/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
