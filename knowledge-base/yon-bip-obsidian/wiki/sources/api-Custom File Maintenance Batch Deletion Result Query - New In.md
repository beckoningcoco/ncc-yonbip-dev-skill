---
title: "自定义档案维护批量删除结果查询-新集成"
apiId: "2217368856246616070"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: User-defined File Maintenance (MD)
...
请求地址	/yonbip/digitalModel/customerdoc/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/customerdoc/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
