---
title: "自定义档案维护删除记录分页查询-新集成"
apiId: "2198780220628008963"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/customerdoc/batchQueryDeleteLogs
请求方式	POST
...
startTs	date
格式:yyyy-MM-dd HH:mm:ss	否	否	pubts开始时间 示例：2024-11-08 17:15:29
endTs	date
格式:yyyy-MM-dd HH:mm:ss	否	否	pubts结束时间 示例：2024-11-08 17:15:50
ids	string	是	否	主键id集合 示例：["2211575684096589833","2211575684096589834"]

## 3. 请求示例

Url: /yonbip/digitalModel/customerdoc/batchQueryDeleteLogs?access_token=访问令牌
Body: {
	"pageIndex": 1,
	"pageSize": 50,
	"startTs": "2024-11-08 17:15:29",
	"endTs": "2024-11-08 17:15:50",
	"ids": [
		"2211575684096589833",
		"2211575684096589834"
	]
