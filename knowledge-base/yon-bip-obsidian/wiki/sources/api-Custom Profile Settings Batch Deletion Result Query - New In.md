---
title: "自定义档案设置批量删除结果查询-新集成"
apiId: "2217368418159951878"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: User-defined File Definition (MD)
...
请求地址	/yonbip/digitalModel/customerdocdef/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/customerdocdef/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
