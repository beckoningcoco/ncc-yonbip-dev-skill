...
请求地址	/yonbip/sd/rebate/amount/close
请求方式	POST
...
Url: /yonbip/sd/rebate/amount/close?access_token=访问令牌
Body: {
	"data": {
		"id": 0
	}
...
closeDate	string	否	关闭日期 示例：2023-05-23 00:00:00
closeTime	string	否	关闭时间 示例：2023-05-23 11:03:59
closer	string	否	关闭人 示例：测试环境管理员
closerId	long	否	关闭人id 示例：1539560696983846918
	...
	"data": [
		{
			...
			"canUsable": true,
			"closeDate": "2023-05-23 00:00:00",
			"closeTime": "2023-05-23 11:03:59",
			"closer": "测试环境管理员",
			"closerId": 1539560696983846918,
