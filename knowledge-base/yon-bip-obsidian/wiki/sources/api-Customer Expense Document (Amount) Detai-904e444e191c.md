---
title: "客户费用单(金额)详情"
apiId: "904e444e191c4a3880142bd293691262"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/sd/rebate/amount/detail
请求方式	POST
...
Url: /yonbip/sd/rebate/amount/detail?access_token=访问令牌&id=
...
rebateSourceId	string	否	客户费用来源id
rebateSourceId_name	string	否	客户费用来源名称
voucherType	string	否	单据类型
validStartDate	string	否	有效期开始时间
validEndDate	string	否	有效期结束时间
rebateMoney	int	否	客户费用金额
originalPk	string	否	返利币种pk
originalPk_priceDigit	string	否	币种单价精度
originalPk_moneyDigit	string	否	币种金额精度
originalPk_code	string	否	返利币种简称
originalPk_name	string	否	客户费用币种名称
...
define1	string	否	自由自定义项 示例：自定义项字段headItem!*，headItem!为固定值，*为自定义项字段，例如headItem!define1，此字段可以通过客户费用单-金额卡片页面查询源码获取
voucher_rebateProduct	object	是	返利单商品表[voucher.rebate.RebateProduct]
voucher_rebateRecord	object	是	返利单记录表[voucher.rebate.RebateRecord]
...

{
	...
	"data": {
		...
		"modifier": "",
		"modifyTime": "",
		"define1": "自定义项字段headItem!*，headItem!为固定值，*为自定义项字段，例如headItem!define1，此字段可以通过客户费用单-金额卡片页面查询源码获取",
		"voucher_rebateProduct": [
			{
				"id": "",
				"productId": "",
				"productId_code": "",
