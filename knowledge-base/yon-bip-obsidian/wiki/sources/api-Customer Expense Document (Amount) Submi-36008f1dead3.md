---
title: "客户费用单(金额)提交"
apiId: "36008f1dead345f5bc15f6d475cc4b82"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/sd/voucher/amountrebate/batchsubmit
请求方式	POST
...
code	string	否	否	单据编号 (若未填写单据id，此字段必填，若填写单据id，此字段不必填) 示例：UF-3584202106180001
id	long	否	否	单据id（若未填写单据编号，此字段必填，若填写单据编号，此字段不必填） 示例：2306980351447296
rebateCode	string	否	是	单据类型（CASHDISCOUNTS） 示例：CASHDISCOUNTS

## 3. 请求示例

Url: /yonbip/sd/voucher/amountrebate/batchsubmit?access_token=访问令牌
Body: {
	"data": [
		{
