---
title: "客户费用单(商品)提交"
apiId: "7a3c5554fb614009b0d2e7e7d5e43adb"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/sd/voucher/productrebate/batchsubmit
请求方式	POST
...
code	string	否	否	单据编号（若填写单据id，此字段不必填，若未填写单据id，此字段必填） 示例：UF-7760202106190001
id	long	否	否	单据id（若填写单据编码，此字段不必填，若未填写单据编码，此字段必填） 示例：2308075849339136
rebateCode	string	否	是	单据类型（RETURNPRODUCT） 示例：RETURNPRODUCT

## 3. 请求示例

Url: /yonbip/sd/voucher/productrebate/batchsubmit?access_token=访问令牌
Body: {
	"data": [
		{
