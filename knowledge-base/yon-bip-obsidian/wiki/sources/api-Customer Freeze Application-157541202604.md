...
请求地址	/yonbip/crm/cust/dongjiecust
请求方式	POST
...
effectDate	string	否	是	生效时间，在生效类型是未来生效时必须输入未来一个时间点，在立即生效时输入当前时间。 示例：2022-10-26 18:26:07
applyType	long	否	是	申请类型，必须为1，1-冻结 示例：1
...
customerfrozenItemList	object	是	否	冻结申请明细

## 3. 请求示例

Url: /yonbip/crm/cust/dongjiecust?access_token=访问令牌
Body: {
	"data": {
		"code": "2022102600013",
		...
		"_status": "Insert",
		"saveAndAudit": true,
		"customerfrozenItemList": [
			{
				"freezeOrg": "1873789786421985284",
				"frozenCustomer": "1546525948524363779",
				"frozenLink": "1529466853806047257",
				"effectRange": 0,
				"frozenItemReason": "冻结了",
				"_status": "Insert"
			}
		]
	}
...
creatorId	long	否	创建人ID 示例：2603881046393856
creator	string	否	创建人 示例：昵称-李亚苹111
createTime	string	否	创建时间 示例：2022-10-24 16:29:04
createDate	string	否	创建日期 示例：2022-10-24 16:29:04
verifystate	long	否	审核状态；0-开立，1-审批中，2-审核成功，3-审核失败 示例：0
isWfControlled	boolean	否	是否接受审批流控制，true-受控制，false-不受控制 示例：true
id	long	否	冻结申请ID 示例：1575395241312649217
status	long	否	单据状态，该值没有业务含义，可以忽略,0-新增，3-审核中 示例：0
...
customerfrozenItemList	object	是	冻结申请明细
...

{
	...
	"data": {
		...
		"effectType": 0,
		"effectStatus": 0,
		"creatorId": 2603881046393856,
		"creator": "昵称-李亚苹111",
		"createTime": "2022-10-24 16:29:04",
		"createDate": "2022-10-24 16:29:04",
		"verifystate": 0,
		"isWfControlled": true,
		...
		"customerfrozenItemList": [
			{
				"frozenCustomer": 2611257008673024,
				"frozenLink": 1570757406756175891,
				"effectRange": 0,
				"frozenItemReason": "冻结原因",
				"id": 1575395241312649218,
				"customerFrozenApplyId": 1575395241312649217,
...
1002	数据不存在	按照提示代码解决
999	存在已申请但未生效的冻结环节,不可重复申请	更换申请编码或者重新申请
