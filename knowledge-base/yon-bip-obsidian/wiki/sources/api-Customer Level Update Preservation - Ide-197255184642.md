...
>  请求方式	POST | Customer Grade (MD)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/digitalModel/cuslevel/idempotent/update
请求方式	POST
...
Url: /yonbip/digitalModel/cuslevel/idempotent/update?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"id": NaN,
