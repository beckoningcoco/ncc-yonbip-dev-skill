...
请求地址	/yonbip/MCC/customerfrozenapply/submit
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	是	否	客户冻结申请提交参数
systemSource	string	否	是	系统来源 api调用时不能为空，api来源的标识 示例：systemSource 默认值：systemSource
id	string	否	是	客户冻结申请id 示例：1957591891206209600

## 3. 请求示例

Url: /yonbip/MCC/customerfrozenapply/submit?access_token=访问令牌
Body: {
	"data": [
		{
		...
		"infos": [
			{
				...
				"saleArea": 2408777561426886659,
				"effectType": "0",
				"effectStatus": "0",
				"isDeleted": false,
				"createTime": "2026-02-26 10:14:58",
