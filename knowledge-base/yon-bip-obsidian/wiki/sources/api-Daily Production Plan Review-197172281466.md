...
请求地址	/yonbip/mfg/dailyschedule/batchaudit
请求方式	POST
...
id	number
小数位数:0,最大长度:20	否	是	单据id 示例：11111111111

## 3. 请求示例

Url: /yonbip/mfg/dailyschedule/batchaudit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 11111111111
