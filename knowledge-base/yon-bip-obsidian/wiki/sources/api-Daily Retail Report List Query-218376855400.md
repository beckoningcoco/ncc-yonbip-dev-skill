...
请求地址	/yonbip/sd/uretail/dailyreport/list
请求方式	POST
...
code	string	否	否	零售日报号 示例：RL539620250120000009
businesstypeid	string	是	否	业务类型 示例：["1748193698452602890","1748193698452602889"]
simpleVOs	object	是	否	扩展条件查询
field	string	否	否	条件字段 示例：businessDate
...
Url: /yonbip/sd/uretail/dailyreport/list?access_token=访问令牌
Body: {
	"pageIndex": 1,
	"pageSize": 100,
...
小数位数:0,最大长度:10	否	分页开始索引 示例：1
endPageIndex	number
小数位数:0,最大长度:10	否	分页截止索引 示例：1
traceId	string	否	线索id 示例：48d2dabc28a68524
