...
请求地址	/yonbip/uspace/rest/v1/sign/user/data/do
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| accountId | string | 否 | 是 | 所使用用户的用户ID 示例：1804444444444444770 |
| oriData | string | 否 | 是 | 待签名原文，base64编码后的数据 示例：JTdCJTIyYSUyMiUzQSUyMmxhbGFsYSUyMiU3RA== |

## 3. 请求示例

Url: /yonbip/uspace/rest/v1/sign/user/data/do?access_token=访问令牌
Body: {
