---
title: "抵扣认证异步版-统计认证结果"
apiId: "2144017566632771587"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/tax/yonbip-fi-taxit/api/asyncvat/querySubmitStats
...
| batchNo | string | 否 | 否 | 查询流水号: 统计认证提交接口返回的流水号 示例：111111111 |

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxit/api/asyncvat/querySubmitStats?access_token=访问令牌
Body: {
...
| status | string | 否 | 操作结果:1-操作成功 0-操作失败 示例：1 |
| errorMsg | string | 否 | 错误信息 示例：税号不在线请重新登陆！ |
