...
请求地址	/yonbip/tax/input-tax/api/vat/qrrz
...
| password | string | 否 | 是 | 确认签名 示例：123456 |

## 3. 请求示例

Url: /yonbip/tax/input-tax/api/vat/qrrz?access_token=访问令牌
Body: {
