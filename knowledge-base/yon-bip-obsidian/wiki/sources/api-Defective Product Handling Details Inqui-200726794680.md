...
请求地址	/yonbip/QMS_QIT/rejectbill/detail
请求方式	POST
...
id	string	query	否	不良品处理单id，code和id 任一不为空，都有值取id    示例: 1888589127091748873
code	string	query	否	不良品处理单号    示例: BL202312200001

## 3. 请求示例

Url: /yonbip/QMS_QIT/rejectbill/detail?access_token=访问令牌&id=1888589127091748873&code=BL202312200001
...
inspectiontype	string	否	检验类型,来料检验= 001，产品检验=002，在库检验=003，发货检验=004，退货检验= 005，其他检验=006，委外检验=007，工序检验=008，工序委外检验=009，采购入库检验=010 示例：001
