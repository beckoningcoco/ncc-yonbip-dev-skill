...
请求地址	/yonbip/EFI/receivable/delete
请求方式	POST
...
Url: /yonbip/EFI/receivable/delete?access_token=访问令牌
Body: {
	"data": {
...
data	object	否	返回数据
id	string	否	应收结算清单表头主键 示例：1513626559312822275
