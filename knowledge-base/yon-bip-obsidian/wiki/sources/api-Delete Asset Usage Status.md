...
请求地址	/yonbip/am/usagestate/delete
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 否 | 数据 |
| id | string | 否 | 否 | 需要删除的状态的id 示例：1476611216843472896 |

## 3. 请求示例

Url: /yonbip/am/usagestate/delete?access_token=访问令牌
Body: {
	"data": [
		{
...
| 名称 | 类型 | 数组 | 描述 |
| code | string | 否 | http状态码(200:成功，其他：失败) 示例：200 |
