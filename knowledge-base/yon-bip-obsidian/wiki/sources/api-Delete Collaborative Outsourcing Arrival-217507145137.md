...
请求地址	/yonbip/mfg/arriveplan/batchPublishArrivePlan
请求方式	POST
...
id	long	否	否	委外到货计划ID 示例：2373477794877696

## 3. 请求示例

Url: /yonbip/mfg/arriveplan/batchPublishArrivePlan?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2373477794877696
...
failInfos	string	是	有失败数据时返回的信息
