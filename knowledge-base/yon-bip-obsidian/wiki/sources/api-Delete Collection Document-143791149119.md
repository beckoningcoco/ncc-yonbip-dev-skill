...
请求地址	/yonbip/fi/fundcollection/delete
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	是	是	资金收款单数据
id	long	否	是	资金收款单ID 示例：1910272858697216
...
Url: /yonbip/fi/fundcollection/delete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1910272858697216
