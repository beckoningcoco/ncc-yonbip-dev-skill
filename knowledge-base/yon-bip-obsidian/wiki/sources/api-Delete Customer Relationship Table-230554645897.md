...
id	string	否	是	id 示例：2305537250587836425

## 3. 请求示例

Url: /yonbip/MCC/bill/delete?access_token=访问令牌
Body: {
	"data": {
		"id": "2305537250587836425"
	}
}
