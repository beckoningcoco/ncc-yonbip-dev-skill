...
请求地址	/current_yonbip_default_sys/RDC/openapi/ebom/v1/delete
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
id	string	否	否	BOM的ID

## 3. 请求示例

Url: /current_yonbip_default_sys/RDC/openapi/ebom/v1/delete?access_token=访问令牌
Body: {
	"id": ""
}
