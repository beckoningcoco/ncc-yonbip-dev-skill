...
请求地址	/yonbip/tax/yonbip-fi-taxreturn/api/depreciation/collection/del
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| orgCode | string | 否 | 是 | 会计主体code 示例：0324zxh01 |
| fixedAssetsCode | string | 否 | 是 | 资产编码 示例：0400591 |
| buildDate | string | 否 | 是 | 建卡时间（yyyy-MM-dd） 示例：2021-08-01 |

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxreturn/api/depreciation/collection/del?access_token=访问令牌
Body: [{
	"orgCode": "0324zxh01",
