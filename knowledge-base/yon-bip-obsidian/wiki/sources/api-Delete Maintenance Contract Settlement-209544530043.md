...
请求地址	/yonbip/am/ommsettlelist/delete
请求方式	POST
...
id	string	否	是	删除维修合同结算id 示例：1582003555291103242

## 3. 请求示例

Url: /yonbip/am/ommsettlelist/delete?access_token=访问令牌
Body: {
	"data": [
		{
