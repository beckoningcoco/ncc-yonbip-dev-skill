...
请求地址	/yonbip/tax/yonbip-fi-taxgateway/yonbip-fi-taxspec/api/tax-rd-budget/delete
...
Url: /yonbip/tax/yonbip-fi-taxgateway/yonbip-fi-taxspec/api/tax-rd-budget/delete?access_token=访问令牌
Body: {
	"ids": [
		"111"
	]
