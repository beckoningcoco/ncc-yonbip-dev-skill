---
title: "资金付款单删除"
apiId: "c13b6e32575e40be9fdbee272d1ef46e"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/fi/fundpayment/delete
请求方式	POST
...
id	long	否	是	资金付款单ID 示例：1910272858697216

## 3. 请求示例

Url: /yonbip/fi/fundpayment/delete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1910272858697216
