---
title: "销售出库单删除"
apiId: "32ff559157bc4d9aa7e0ca07b05a20e8"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/scm/salesout/delete
...
| id | long | 否 | 否 | 出库单主表主键 示例：2037904727954176 |

## 3. 请求示例

Url: /yonbip/scm/salesout/delete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2037904727954176
...
999	ID为2223311221068032的业务单据不存在，请检查	检查要删除的单据是否存在，id是否正确
