---
title: "采购发票删除"
apiId: "dbbb195cae524fac8635e8d612409fa7"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/scm/purinvoice/delete
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 是 | 请求体 |
| id | long | 否 | 是 | 采购发票主表id 示例：2143815495864576 |

## 3. 请求示例

Url: /yonbip/scm/purinvoice/delete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2143815495864576
