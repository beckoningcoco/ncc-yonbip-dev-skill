...
请求地址	/yonbip/am/simpcspeclist/delete
请求方式	POST
...
id	string	否	是	点检记录主表主键 示例：1503972572269117443

## 3. 请求示例

Url: /yonbip/am/simpcspeclist/delete?access_token=访问令牌
Body: {
	"data": [
		{
