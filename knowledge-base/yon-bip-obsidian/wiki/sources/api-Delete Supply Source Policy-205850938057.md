...
请求地址	/yonbip/cpu/ycGdStrgyList/bill/delete
请求方式	POST
...
名称	类型	数组	必填	描述
data	object	是	否	0
id	string	否	是	货源策略id 示例：3924749968150784
pubts	string	否	否	单据的时间戳，校验单据状态必填

## 3. 请求示例

Url: /yonbip/cpu/ycGdStrgyList/bill/delete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "3924749968150784",
