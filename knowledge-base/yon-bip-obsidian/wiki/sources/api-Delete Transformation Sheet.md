---
title: "形态转换单删除"
apiId: "a1ba1c225bc44bcd8a46153a1caaef96"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/scm/morphologyconversion/batchdelete
...
| id | string | 否 | 是 | 单据id 示例：2173865068008192 |

## 3. 请求示例

Url: /yonbip/scm/morphologyconversion/batchdelete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "2173865068008192"
