...
请求地址	/yycrm.dsfa_visitsummarycard/ACT/visitsummary/delete
请求方式	POST
...
Url: /yycrm.dsfa_visitsummarycard/ACT/visitsummary/delete?access_token=访问令牌
Body: {
	"data": {
		"id": ""
	}
...
data	string	否	调用完成时返回数据 示例：null
