...
请求地址	/yonbip/AMP/fievent/reverse
...
Url: /yonbip/AMP/fievent/reverse?access_token=访问令牌
Body: {
	"fieventInfo": {
...
| message | string | 否 | message 示例：traceId:4338fdd53fe42754 - 102005-财务服务-逆向执行、逆向持久化 |
| fieventInfo | object | 否 | eventInfo |
