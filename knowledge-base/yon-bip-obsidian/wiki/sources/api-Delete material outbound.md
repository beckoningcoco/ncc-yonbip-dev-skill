---
title: "材料出库删除"
apiId: "3e446858322549fb9f9ed5e26411ae43"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/scm/materialout/batchdelete
...
| id | long | 否 | 是 | 主表id 示例：2173830534664704 |

## 3. 请求示例

Url: /yonbip/scm/materialout/batchdelete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2173830534664704
...
"failCountAI": 1	"商品:1850795106062592不存在！"	检查当前租户下是否有该商品
