...
请求地址	/yonbip/am/preCreateEquip/delete
请求方式	POST
...
bill_code	string	否	是	来源单据编号 示例：001

## 3. 请求示例

Url: /yonbip/am/preCreateEquip/delete?access_token=访问令牌
Body: {
	"data": [
		{
			"origin_system": "外系统",
