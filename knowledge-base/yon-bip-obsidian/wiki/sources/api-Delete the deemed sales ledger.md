...
请求地址	/yonbip/tax/yonbip-fi-taxoth/api/tax-deem-sale/batch-delete
...
| id | string | 否 | 是 | 数据唯一标识 示例：2068869013467299849 |

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxoth/api/tax-deem-sale/batch-delete?access_token=访问令牌
Body: {
	"data": [
		{
