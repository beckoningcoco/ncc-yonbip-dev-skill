---
title: "交货计划单行状态变更"
apiId: "1db1989fc30744b0acc703def18fef3a"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/cpu/delplan/updateRowStatus
请求方式	POST
...
billBodys	object	是	是	表体
delplanNo	string	否	否	交货计划主表单据编号 示例：2021041207
lineNum	long	否	否	行号(与保存时候传入的值保持一致) 示例：1
fisactive	string	否	否	行状态：0.激活 1.关闭 示例：0

## 3. 请求示例

Url: /yonbip/cpu/delplan/updateRowStatus?access_token=访问令牌
Body: {
	"billHead": {
		"billNo": "2021041207"
	},
