---
title: "部门启用"
apiId: "c782834b64884e6ea15ca39a6a1798d0"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/admindept/unstop
...
Url: /yonbip/digitalModel/admindept/unstop?access_token=访问令牌
Body: {
	"data": {
		"id": "1878342166270464"
	}
...
| data | object | 否 | 内容 |
| orgtype | long | 否 | 部门类型 1非部门 2部门 示例：2 |
...
| enable | long | 否 | 状态0未启用 1启用 2停用 示例：1 |
| sysid | string | 否 | 系统标识 示例：diwork |
| isEnd | boolean | 否 | 是否末级0否 1是 示例：true |
| yhtTenant | string | 否 | 友互通租户标识 示例：0000KM326ZLK32VJ0L0000 |
