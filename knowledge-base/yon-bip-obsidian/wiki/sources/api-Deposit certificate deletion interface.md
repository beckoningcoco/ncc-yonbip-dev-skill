...
请求地址	/yonbip/EFI/revenue/depositReceipt/batchDelete
...
Url: /yonbip/EFI/revenue/depositReceipt/batchDelete?access_token=访问令牌
Body: {
	"ids": [
		1001,
		1002,
...
| messages | object | 否 | 失败信息体 |
| id | string | 否 | 单据主键 |
| sourceUnique | string | 否 | 唯一标识 |
