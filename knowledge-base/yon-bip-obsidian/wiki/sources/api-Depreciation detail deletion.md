...
请求地址	/yonbip/tax/yonbip-fi-taxreturn/api/depreciation/detail/del
...
| period | string | 否 | 是 | 期间，格式：yyyy-MM 示例：2021-08 |

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxreturn/api/depreciation/detail/del?access_token=访问令牌
Body: {
	"orgCode": "0324zxh01",
