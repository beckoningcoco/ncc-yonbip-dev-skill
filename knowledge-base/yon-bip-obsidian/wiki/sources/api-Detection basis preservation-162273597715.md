...
请求地址	/yonbip/imcs/detectionbasis/save
请求方式	POST
...
name	string	否	是	名称 示例：666
code	string	否	是	编码 示例：666
validitydate	Date	否	否	有效期 示例：2022-09-16
vnote	string	否	否	备注 示例：666
classification	string	否	否	分类 示例：666
version	string	否	否	版本 示例：1
_status	string	否	是	操作标识：Insert为新增，Update为修改 示例：Insert 默认值：Insert

## 3. 请求示例

Url: /yonbip/imcs/detectionbasis/save?access_token=访问令牌
Body: {
	"data": {
		"id": "1487809948921364488",
		"name": "666",
		"code": "666",
		"validitydate": "2022-09-16",
		"vnote": "666",
		"classification": "666",
		"version": "1",
		"_status": "Insert"
