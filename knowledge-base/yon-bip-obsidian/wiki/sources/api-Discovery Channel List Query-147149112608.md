...
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Detection Method]
...
>  请求方式	POST | Detection Method (EQP)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/pes/v1/kms/discovery/list
请求方式	POST
...
id	string	否	否	发现途径主键id 示例：1798530562396416
...
格式:yyyy-MM-dd HH:mm:ss	否	否	单据修改开始时间
modifyTimeEnd	date
格式:yyyy-MM-dd HH:mm:ss	否	否	单据修改结束时间

## 3. 请求示例

Url: /yonbip/pes/v1/kms/discovery/list?access_token=访问令牌
Body: {
	"pageIndex": 1,
	"pageSize": 20,
	"id": "1798530562396416",
	...
	"name": "测试",
	"isEffective": "1",
	"pubtsBegin": "2026-06-07 13:19:15",
	"pubtsEnd": "2026-06-07 13:19:15",
	"createTimeBegin": "2026-06-07 13:19:15",
	"createTimeEnd": "2026-06-07 13:19:15",
	"modifyTimeBegin": "2026-06-07 13:19:15",
	"modifyTimeEnd": "2026-06-07 13:19:15"
}
