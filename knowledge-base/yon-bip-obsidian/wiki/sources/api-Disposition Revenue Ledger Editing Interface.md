...
请求地址	/yonbip/tax/yonbip-fi-taxoth/api/dispose-income-ledger/batch-edit
...
| assetCode | string | 否 | 否 | 资产编码 示例：12312312 |
| projectCode | string | 否 | 否 | 项目编码 示例：1-003459 |
| remarks | string | 否 | 否 | 备注 示例：备注0807 |
| disposelLedgerItemList | object | 是 | 否 | 子表数据 |

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxoth/api/dispose-income-ledger/batch-edit?access_token=访问令牌
Body: {
	"data": [
		{
			"assetCode": "12312312",
