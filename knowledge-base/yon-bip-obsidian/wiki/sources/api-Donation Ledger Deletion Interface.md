...
请求地址	/yonbip/tax/yonbip-fi-taxoth/api/tax-s-donation/batch-del
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | string | 是 | 否 | 传入删除数据的id 示例：["1819341524989800448"] |

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxoth/api/tax-s-donation/batch-del?access_token=访问令牌
Body: {
	"data": [
		"1819341524989800448"
	]
