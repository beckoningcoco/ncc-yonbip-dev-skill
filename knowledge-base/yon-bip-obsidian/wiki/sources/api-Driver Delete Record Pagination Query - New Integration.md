---
title: "司机删除记录分页查询-新集成"
apiId: "2230756973700186121"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/basedoc/driver/batchQueryDeleteLogs
...
| pageSize | number |
| 小数位数:0,最大长度:10 | 否 | 是 | 分页大小 示例：10 默认值：10 |
| startTs | date |
...
Url: /yonbip/digitalModel/basedoc/driver/batchQueryDeleteLogs?access_token=访问令牌
Body: {
	"pageIndex": 1,
	"pageSize": 10,
