---
title: "ERP销售发货单查询（YonBIP_NCC）"
apiId: "1882473462968614920"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/crm/nccloud/api/uapbd/saledelivery/getQuery
请求方式	POST
...
dreceivedate	string	否	否	要求收获日期
pageIndex	int	否	是	页码
pageSize	int	否	是	页大小
totalCount	int	否	是	总条数
isSum	int	否	否	是否查明细

## 3. 请求示例

Url: /yonbip/crm/nccloud/api/uapbd/saledelivery/getQuery?access_token=访问令牌
Body: [{
	"pk_org": "",
	"pk_custclass": "",
	"pk_customer": "",
...
pageIndex	float	否	当前页
pageSize	float	否	每页条数
totalCount	float	否	总条数
