---
title: "经济类型批量删除结果查询-新集成"
apiId: "2217226675649249284"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Company Type Card (MD)
...
请求地址	/yonbip/digitalModel/basedoc/economicstype/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/basedoc/economicstype/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
