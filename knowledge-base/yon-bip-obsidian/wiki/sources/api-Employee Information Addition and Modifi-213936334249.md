...
请求地址	/yonbip/hrcloud/staff/insertverify
请求方式	POST
...
certTypeName	string	否	是	证件类型 传入id或code 示例：0010-3600-41e2-8568-42fbc6c96c9d
...
Url: /yonbip/hrcloud/staff/insertverify?access_token=访问令牌
Body: {
	"data": {
