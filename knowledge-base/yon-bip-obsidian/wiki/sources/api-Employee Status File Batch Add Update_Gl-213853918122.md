---
title: "在职状态档案批量新增更新_全球化_上传下发"
apiId: "2138539181229998088"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/byd/batchSaveOrUpdatePst
请求方式	POST
...
statetype	number
小数位数:0,最大长度:10	否	否	statetype 示例：1
code	string	否	否	code 示例：001
ytenant	string	否	否	ytenant 示例：0000LE3ZNN0XFI0C970000
enable	number
小数位数:0,最大长度:10	否	否	状态 示例：1
name	string	否	否	name 示例：正常在岗
id	string	否	否	id 示例：0000LE3ZNN0XFI0C9700001000000ffp
pubts	string	否	否	时间戳 示例：2023-02-14 16:42:31
dr	number
小数位数:0,最大长度:10	否	否	dr 示例：0
tenant	string	否	否	租户ID 示例：0000LE3ZNN0XFI0C970000
distributionSite	string	否	否	distributionSite 示例：123

## 3. 请求示例

Url: /yonbip/digitalModel/byd/batchSaveOrUpdatePst?access_token=访问令牌
Body: {
	"data": [
		{
			"statetype": 1,
			...
			"enable": 1,
			"name": "正常在岗",
			"id": "0000LE3ZNN0XFI0C9700001000000ffp",
			"pubts": "2023-02-14 16:42:31",
			"dr": 0,
