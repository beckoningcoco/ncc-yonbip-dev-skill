---
title: "残疾人就业保障金计算表-新增"
apiId: "1898241782558228481"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/tax/other-tax/api/disableempsecurity/add
请求方式	POST
...
currentPayableExpense	number
小数位数:2,最大长度:15	否	否	本期应纳费额 示例：-14220.00
currentFeeReduction	number
小数位数:2,最大长度:15	否	否	本期减免费额 示例：100
currentPaid	number
小数位数:2,最大长度:15	否	否	本期已缴费额 示例：1
proportionArrangedLastYear	string	否	否	上年实际安排残疾人就业比例 示例：0.10
currentAmoutShoulRefunded	number
小数位数:2,最大长度:15	否	否	本期应补(退)费额 示例：1.00
...
Url: /yonbip/tax/other-tax/api/disableempsecurity/add?access_token=访问令牌
Body: [{
	"orgCode": "rzs2",
	...
	"currentPayableExpense": -14220,
	"currentFeeReduction": 100,
	"currentPaid": 1,
	"proportionArrangedLastYear": "0.10",
	"currentAmoutShoulRefunded": 1,
