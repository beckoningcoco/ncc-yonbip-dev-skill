---
title: "核算委托关系启用"
apiId: "9af0b38501cb49c8bc36aec9caaa5cb1"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/accountDelegate/unstop
...
| id | string | 否 | 是 | 核算委托关系主键 示例：2342175281172736 |

## 3. 请求示例

Url: /yonbip/digitalModel/accountDelegate/unstop?access_token=访问令牌
Body: {
	"data": {
		"id": "2342175281172736"
	}
