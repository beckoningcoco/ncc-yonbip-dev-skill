---
title: "计划委托关系启用"
apiId: "cfd7b50026ba43a286d343f7234eedaa"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/planDelegate/unstop
...
| id | string | 否 | 是 | 计划委托关系主键 示例：2342175281172736 |

## 3. 请求示例

Url: /yonbip/digitalModel/planDelegate/unstop?access_token=访问令牌
Body: {
	"data": {
		"id": "2342175281172736"
	}
