---
title: "采购委托关系启用"
apiId: "2c98792a094a483fa755cec6caa4dd10"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/purchaseDelegate/unstop
请求方式	POST
...
id	string	否	是	采购委托主键id

## 3. 请求示例

Url: /yonbip/digitalModel/purchaseDelegate/unstop?access_token=访问令牌
Body: {
	"data": {
		"id": ""
	}
...
isDefault	long	否	是否默认 0否 1是 示例：1
enable	long	否	状态 0未启用 1启用 2.停用 示例：1
dr	long	否	删除标识 0-未删除；1-已删除 示例：0
id	string	否	主键 示例：2192414706536704
pubts	string	否	时间戳 示例：2021-07-21 10:34:33
