...
请求地址	/yonbip/FCC/api/endore/detail
...
| 格式:yyyy-MM-dd | 否 | 否 | 背书日期开始 |
| endoreDateEnd | date |
| 格式:yyyy-MM-dd | 否 | 否 | 背书日期结束 |
...
| billStatus | string | 否 | 否 | 单据状态（2:已作废 6:在背书 7:已背书） |
| downloadFile | boolean | 否 | 否 | 下载附件 |

## 3. 请求示例

Url: /yonbip/FCC/api/endore/detail?access_token=访问令牌
Body: {
	"id": 0,
	"accentityCode": "",
	"accentityName": "",
		...
		"recordList": [
			{
				...
				"operator": "",
				"wbs": "",
				"invoiceDate": "2026-06-07 12:10:30",
				"endDate": "2026-06-07 12:10:30",
				"istransfer": true,
				"paybillroles": 0,
				"payerCode": "",
				"payerName": "",
