...
请求地址	/yonbip/uspace/rest/v1/company/common/bindUser
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| companyAppAuthId | string | 否 | 是 | 应用授权ID 示例：18062377246271733 |
| companyId | string | 否 | 是 | 公司ID 示例：1742220970793369605 |
...
| isDefault | int | 否 | 是 | 是否为默认用户：0非默认用户，1默认用户 示例：0 |

## 3. 请求示例

Url: /yonbip/uspace/rest/v1/company/common/bindUser?access_token=访问令牌
Body: {
