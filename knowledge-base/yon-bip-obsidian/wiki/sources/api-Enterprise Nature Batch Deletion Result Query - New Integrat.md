---
title: "企业性质批量删除结果查询-新集成"
apiId: "2217294484592918531"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Enterprise Type (MD)
...
请求地址	/yonbip/digitalModel/basedoc/enterprisenature/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/basedoc/enterprisenature/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
