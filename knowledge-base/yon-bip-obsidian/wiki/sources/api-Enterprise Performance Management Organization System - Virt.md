---
title: "企业绩效组织体系-虚组织更新"
apiId: "2346498010083491844"
apiPath: "请求方式	POST"
...
| id | string | 否 | 是 | id 示例：2346476354854715396 |
| name | object | 否 | 否 | 主体单元名称 |
...
| aggr | string | 否 | 否 | 汇总属性（汇总属性范围：-1/0/1,其中： "-1": "减", "0": "忽略", "1": "加"） 示例：0 默认值：0 |
...
| _status | string | 否 | 是 | 操作状态；修改时状态默认为“Update” 示例：Update 默认值：Update |
| org_epm_systems_id | string | 否 | 是 | 体系id(可从企业绩效组织体系-体系树 中获取) 示例：1760005923670065153 |
| selectDate | Date | 否 | 是 | 操作日期 示例：2023-08-08 |
| enable | string | 否 | 否 | 启用状态(Y:启用；N:停用) 示例：Y 默认值：Y |

## 3. 请求示例

Url: /yonbip/PFC/epmorg/update?access_token=访问令牌
Body: {
	"billnum": "org_epmorgitem",
	"data": {
		"id": "2346476354854715396",
		"name": {
			"zh_CN": "组织名称",
			"en_US": "english",
			"zh_TW": "繁体"
