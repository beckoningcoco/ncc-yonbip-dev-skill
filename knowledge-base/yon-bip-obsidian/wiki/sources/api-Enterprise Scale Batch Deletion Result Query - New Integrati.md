---
title: "企业规模批量删除结果查询-新集成"
apiId: "2217303667232997385"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Size (MD)
...
请求地址	/yonbip/digitalModel/basedoc/companyscale/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/basedoc/companyscale/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
