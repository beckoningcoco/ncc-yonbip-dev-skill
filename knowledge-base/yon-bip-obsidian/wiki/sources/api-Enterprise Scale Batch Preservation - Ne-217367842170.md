...
请求地址	/yonbip/digitalModel/companyscale/batchSave
请求方式	POST
...
id	string	否	否	主键ID 示例：2217297800425111559
code	string	否	是	编码 示例：ddddddd
name	object	否	是	名称，根据租户开通的语种传入
enable	number
小数位数:2,最大长度:11	否	否	启用状态,1 启用 2 停用 示例：1
sourceUnique	string	否	是	来源系统id 示例：2217297800425111559

## 3. 请求示例

Url: /yonbip/digitalModel/companyscale/batchSave?access_token=访问令牌
Body: {
	"matchRule": "id",
	"unmatchedStrategy": "add",
	"data": [
		{
			"id": "2217297800425111559",
			"code": "ddddddd",
			"name": {
				"zh_CN": "简体中文",
			...
			"enable": 1,
			"sourceUnique": "2217297800425111559"
		}
	]
}
...

{
	...
	"data": {
		...
		"infos": [
			{
				"created": true,
				"sourceUnique": "2217297800425111560",
				"targetUnique": "2217297800425111561",
				"id": "2217297800425111562"
			}
		]
	},
