---
title: "企业规模删除记录分页查询-新集成"
apiId: "2180385451197595654"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/basedoc/companyscale/batchQueryDeleteLogs
...
| endTs | date |
| 格式:yyyy-MM-dd HH:mm:ss | 否 | 否 | pubts结束时间 示例：2023-09-18 17:08:46 |
| ids | string | 是 | 否 | 主键id集合 示例：["2217297800425111560","2217297800425111561"] |

## 3. 请求示例

Url: /yonbip/digitalModel/basedoc/companyscale/batchQueryDeleteLogs?access_token=访问令牌
Body: {
	"pageIndex": 1,
	"pageSize": 10,
	"startTs": "2023-09-18 17:08:16",
	"endTs": "2023-09-18 17:08:46",
	"ids": [
		"2217297800425111560",
		"2217297800425111561"
	]
