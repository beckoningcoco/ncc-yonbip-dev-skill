---
title: "企业资金账户停用"
apiId: "df7d9439ffb64dd2ade24ce3c5e94ccd"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/enterbank/disable
...
Url: /yonbip/digitalModel/enterbank/disable?access_token=访问令牌
Body: {
	"data": {
		"id": ""
	}
...
| data | object | 否 | 回执数据 |
| enable | int | 否 | 启用状态，0初始化 1启用 2停用 示例：2 |
