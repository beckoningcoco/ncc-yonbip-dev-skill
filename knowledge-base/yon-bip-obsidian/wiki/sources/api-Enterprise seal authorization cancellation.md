...
请求地址	/yonbip/uspace/rest/v1/seal/company/offAuth
...
| accountId | string | 否 | 否 | 授权用户ID 示例：ed4a02a5-****-****-9854-eea0b9b11575 |

## 3. 请求示例

Url: /yonbip/uspace/rest/v1/seal/company/offAuth?access_token=访问令牌
Body: {
