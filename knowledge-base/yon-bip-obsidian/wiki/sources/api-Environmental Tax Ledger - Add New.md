...
请求地址	/yonbip/tax/yonbip-fi-taxoth/api/ept/collection/add
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| baseId | number |
| 小数位数:0,最大长度:22 | 否 | 否 | 税源明细ID，通过环保税税源查询接口获取，与busiId二者必传其中之一 示例：125298465781527333 |
...
| 小数位数:8,最大长度:21 | 否 | 否 | 计算基数，按期针对大气和水，排污系数计算方式 |
...
Url: /yonbip/tax/yonbip-fi-taxoth/api/ept/collection/add?access_token=访问令牌
Body: [{
