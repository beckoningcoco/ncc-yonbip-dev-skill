---
title: "汇率批量删除结果查询-新集成"
apiId: "2217505676727943169"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Exchange Rate Details (MD)
...
请求地址	/yonbip/digitalModel/basedoc/async/exchangerate/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/basedoc/async/exchangerate/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
