---
title: "汇率类型停用"
apiId: "e7917e8c4c3f4edf982a4e4f93556566"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/exchangeratetype/disable
...
| id | string | 否 | 是 | 主键 示例：2005623803450624 |

## 3. 请求示例

Url: /yonbip/digitalModel/exchangeratetype/disable?access_token=访问令牌
Body: {
	"data": {
		"id": "2005623803450624"
	}
...
| data | object | 否 | 业务数据 |
| enable | long | 否 | 启用状态，0初始化 1启用 2停用 示例：2 |
| id | string | 否 | 主键 示例：2320714022932736 |
| pubts | string | 否 | 时间戳，格式yyyy-MM-dd HH:mm:ss 示例：2021-06-28 14:26:05 |
