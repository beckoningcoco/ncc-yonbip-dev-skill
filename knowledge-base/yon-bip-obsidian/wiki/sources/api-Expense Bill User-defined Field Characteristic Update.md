---
title: "供应链费用单自定义项特征更新"
apiId: "2388758615655710720"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/SCC/api/updateExpenseDefineCharacter
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| datas | object | 是 | 否 | 费用主表 |
| id | string | 否 | 否 | 费用单id，如果只修改表体自定义项特征或备注，此id不传，否则必传 示例：2281153755730176 |
| memo | string | 否 | 否 | 备注 |
| expenseDetails | object | 是 | 否 | 费用子表 |

## 3. 请求示例

Url: /yonbip/SCC/api/updateExpenseDefineCharacter?access_token=访问令牌
Body: {
	"datas": [
		{
			"id": "2281153755730176",
