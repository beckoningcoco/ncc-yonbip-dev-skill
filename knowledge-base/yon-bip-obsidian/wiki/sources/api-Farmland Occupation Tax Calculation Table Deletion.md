...
请求地址	/yonbip/tax/api/farm/land/batch-del
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| sourceIds | string | 是 | 是 | 来源ID 示例：[1,2] |

## 3. 请求示例

Url: /yonbip/tax/api/farm/land/batch-del?access_token=访问令牌
Body: {
	"sourceIds": [
		1,
		2
