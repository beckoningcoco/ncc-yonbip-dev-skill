...
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Failure Category]
...
>  请求方式	POST | Failure Category (EQP)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/pes/v1/kms/category/list
请求方式	POST
...
id	string	否	否	故障分类主键id 示例：1798530562396416
...
格式:yyyy-MM-dd HH:mm:ss	否	否	单据创建开始时间
createTimeEnd	date
格式:yyyy-MM-dd HH:mm:ss	否	否	单据创建结束时间
...
Url: /yonbip/pes/v1/kms/category/list?access_token=访问令牌
Body: {
	"pageIndex": 1,
	"pageSize": 20,
	"id": "1798530562396416",
	...
	"isEffective": "1",
	"orgId": "",
	"pubtsBegin": "2026-06-07 13:19:12",
	"pubtsEnd": "2026-06-07 13:19:12",
	"createTimeBegin": "2026-06-07 13:19:12",
	"createTimeEnd": "2026-06-07 13:19:12",
	"modifyTimeBegin": "2026-06-07 13:19:12",
	"modifyTimeEnd": "2026-06-07 13:19:12"
}
		...
		"recordList": [
			{
				...
				"name": "Amy测试-成品",
				"id": "2313645455331584",
				"productCategoryId": "1344434352134",
				"productCategoryName": "产品分类名称",
				"productId": "1324132341",
				"productName": "产品名称",
				"equipmentType": "123214134",
				"equipmentTypeName": "设备分类名称",
				"parent": "32141254325",
				"parentName": "上级分类名称",
				"isEffective": 1,
				"orgId": "",
