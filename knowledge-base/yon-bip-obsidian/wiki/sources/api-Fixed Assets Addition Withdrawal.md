...
请求地址	/yonbip/EFI/AdditionBill/unsubmit
...
Url: /yonbip/EFI/AdditionBill/unsubmit?access_token=访问令牌
Body: {
	"data": {
...
| cBillNo | string | 否 | 单据编码 示例：fa_additionbill |
| verifyState | number |
| 小数位数:0,最大长度:6 | 否 | 审核状态 0开立态 1审核中 2已审核 3终止态 4驳回到制单 示例：0 |
| _status | number |
| 小数位数:0,最大长度:10 | 否 | 状态 示例：1 |
| pubts | string | 否 | 时间戳 示例：2025-01-02 14:57:11 |
