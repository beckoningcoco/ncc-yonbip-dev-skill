...
> `ContentType	application/json` 请求方式	GET | 分类: Fixed Asset Change (EFI)
...
请求地址	/yonbip/EFI/FixedAssetChange/detail
...
Url: /yonbip/EFI/FixedAssetChange/detail?access_token=访问令牌&id=1701534814432657412
