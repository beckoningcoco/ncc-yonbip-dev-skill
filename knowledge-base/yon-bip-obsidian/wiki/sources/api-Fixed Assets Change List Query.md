...
请求地址	/yonbip/EFI/FixedAssetChange/list
...
| code | string | 否 | 否 | 变动编码 示例：TZ231403 |
...
| open_vouchdate_begin | string | 否 | 否 | 变动日期开始日期(大于等于), 格式为:yyyy-MM-dd HH:mm:ss 示例：2023-04-13 14:59:24 |
| open_vouchdate_end | string | 否 | 否 | 变动日期结束日期(小于等于), 格式为:yyyy-MM-dd HH:mm:ss 示例：2023-04-13 14:59:24 |
...
Url: /yonbip/EFI/FixedAssetChange/list?access_token=访问令牌
Body: {
	"pageSize": 10,
	"pageIndex": 1,
	"verifyState": "1",
