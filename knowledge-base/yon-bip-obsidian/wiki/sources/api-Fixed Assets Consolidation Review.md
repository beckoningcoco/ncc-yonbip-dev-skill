...
请求地址	/yonbip/EFI/FixedAssetMerge/audit
...
| id | string | 否 | 是 | 固定资产合并单id 示例：1483387421116596230 |

## 3. 请求示例

Url: /yonbip/EFI/FixedAssetMerge/audit?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
...
| code | string | 否 | 合并单编码 示例：HB024606 |
