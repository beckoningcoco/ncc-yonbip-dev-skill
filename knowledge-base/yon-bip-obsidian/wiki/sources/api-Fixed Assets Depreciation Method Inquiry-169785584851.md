...
>  请求方式	POST | Depreciation Method (EFI)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/EFI/DepreciationMethod/list
请求方式	POST
...
open_pubts_end	string	否	否	时间戳结束时间(小于等于), 格式为:yyyy-MM-dd HH:mm:s 示例：2023-04-13 14:59:24

## 3. 请求示例

Url: /yonbip/EFI/DepreciationMethod/list?access_token=访问令牌
Body: {
	"pageSize": 10,
	"pageIndex": 1,
	"simple": {
...

{
	...
	"data": {
		...
		"recordList": [
			{
				"id": "1550290015006228492",
				"code": "01",
				"monthDeprAmountFormula": {
					"zh_CN": "单位折旧*当期工作量"
				},
				"name": {
					"zh_CN": "不计提折旧"
				},
				"monthDeprRateFormula": {
					"zh_CN": "期折旧额/(本币原值-减值准备)"
				},
				"pubts": "2022-10-24 17:59:46",
				"description": {
					"zh_CN": "单位折旧=(本币原值-净残值-累计折旧-减值准备)/(工作总量-累计工作量)"
				}
			}
		]
	}
