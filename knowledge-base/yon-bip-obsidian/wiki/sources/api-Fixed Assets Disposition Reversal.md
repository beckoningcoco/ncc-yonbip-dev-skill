...
请求地址	/yonbip/EFI/DisposalBill/unsubmit
...
Url: /yonbip/EFI/DisposalBill/unsubmit?access_token=访问令牌
Body: {
	"data": {
...
| data | object | 否 | 返回数据 |
| id | string | 否 | 固定资产处置表头主键 示例：1483387421116596230 |
...
| metaFullName | string | 否 | 元数据全称 示例：fa.fadisposalbill.DisposalBill |
| fullName | string | 否 | 全称 示例：fa.fadisposalbill.DisposalBill |
