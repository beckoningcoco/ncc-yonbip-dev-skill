...
请求地址	/yonbip/EFI/DisposalBill/audit
...
| id | string | 否 | 是 | 固定资产处置单id 示例：1483387421116596230 |

## 3. 请求示例

Url: /yonbip/EFI/DisposalBill/audit?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
...
| code | string | 否 | 处置单编码 示例：DP024606 |
