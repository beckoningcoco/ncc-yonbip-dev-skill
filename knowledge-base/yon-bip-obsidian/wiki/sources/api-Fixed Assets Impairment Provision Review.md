...
请求地址	/yonbip/EFI/ImpairmentBill/audit
...
| id | string | 否 | 是 | 固定资产减值准备单id 示例：1483387421116596230 |

## 3. 请求示例

Url: /yonbip/EFI/ImpairmentBill/audit?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
...
| code | string | 否 | 减值准备单编码 示例：DIV024606 |
