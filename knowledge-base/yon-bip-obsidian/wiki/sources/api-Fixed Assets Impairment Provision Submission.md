...
请求地址	/yonbip/EFI/ImpairmentBill/submit
...
Url: /yonbip/EFI/ImpairmentBill/submit?access_token=访问令牌
Body: {
	"data": {
...
| verifystate | number |
| 小数位数:0,最大长度:6 | 否 | 审核状态 0开立态 1审核中 2已审核 3终止态 4驳回到制单 示例：1 |
| procinstId | string | 否 | 流程实例id，仅开启审批流时存在 示例：f63b0902-c8e3-11ef-8988-8af7f1c3a660 |
...

{
	...
	"data": {
		...
		"_status": 0,
		"verifystate": 1,
		"procinstId": "f63b0902-c8e3-11ef-8988-8af7f1c3a660"
	}
}
