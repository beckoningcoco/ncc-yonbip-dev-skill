...
请求地址	/yonbip/EFI/ImpairmentBill/unaudit
...
Url: /yonbip/EFI/ImpairmentBill/unaudit?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
...
| code | string | 否 | 减值准备单编码 示例：DIV027115 |
