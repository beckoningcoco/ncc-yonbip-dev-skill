...
请求地址	/yonbip/EFI/FixedAssetImpairmentUnit/list
...
| accentity | string | 否 | 否 | 会计主体id 示例：666666 |
| code | string | 否 | 否 | 减值单元(编码) 示例：02 |
| name | string | 否 | 否 | 减值单元名称(支持模糊查询) 示例：类型1 |
...
Url: /yonbip/EFI/FixedAssetImpairmentUnit/list?access_token=访问令牌
Body: {
	"pageSize": 10,
	"pageIndex": 1,
	"accentity": "666666",
