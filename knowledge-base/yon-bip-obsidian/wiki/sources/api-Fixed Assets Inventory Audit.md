...
请求地址	/yonbip/EFI/FaInventory/audit
...
| id | string | 否 | 是 | 固定资产盘点单id 示例：1483387421116596230 |

## 3. 请求示例

Url: /yonbip/EFI/FaInventory/audit?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
...
| code | string | 否 | 盘点单编码 示例：PD024606 |
