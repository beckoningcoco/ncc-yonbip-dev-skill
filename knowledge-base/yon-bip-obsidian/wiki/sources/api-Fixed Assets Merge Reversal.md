...
请求地址	/yonbip/EFI/FixedAssetMerge/unsubmit
...
Url: /yonbip/EFI/FixedAssetMerge/unsubmit?access_token=访问令牌
Body: {
	"data": {
...
| busiObj | string | 否 | 业务对象 示例：FixedAssetMerge |
| cBillNo | string | 否 | 单据编码 示例：FixedAssetMerge |
| verifyState | number |
| 小数位数:0,最大长度:6 | 否 | 审核状态 0开立态 1审核中 2已审核 3终止态 4驳回到制单 示例：0 |
| pubts | string | 否 | 时间戳 示例：2025-01-02 14:37:06 |
| metaFullName | string | 否 | 元数据全称 示例：EFA.merge.FixedAssetMerge |
| fullName | string | 否 | 全称 示例：EFA.merge.FixedAssetMerge |
...

{
	...
	"data": {
		"id": "1483387421116596230",
		"busiObj": "FixedAssetMerge",
		"cBillNo": "FixedAssetMerge",
		"verifyState": 0,
		"pubts": "2025-01-02 14:37:06",
		"metaFullName": "EFA.merge.FixedAssetMerge",
		"fullName": "EFA.merge.FixedAssetMerge",
