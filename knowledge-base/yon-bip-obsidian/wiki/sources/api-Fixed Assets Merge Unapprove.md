...
请求地址	/yonbip/EFI/FixedAssetMerge/unaudit
...
Url: /yonbip/EFI/FixedAssetMerge/unaudit?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
...
| code | string | 否 | 合并单编码 示例：HB027115 |
