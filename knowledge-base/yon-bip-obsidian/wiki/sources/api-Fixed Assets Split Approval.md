...
| id | string | 否 | 是 | 固定资产拆分单id 示例：1483387421116596230 |

## 3. 请求示例

Url: /yonbip/EFI/FaSplit/audit?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
...
| code | string | 否 | 拆分单编码 示例：CF024606 |
