...
请求地址	/yonbip/EFI/TransferBill/audit
...
| id | string | 否 | 是 | 固定资产转移单id 示例：1483387421116596230 |

## 3. 请求示例

Url: /yonbip/EFI/TransferBill/audit?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
...
| code | string | 否 | 转移单编码 示例：ZY027115 |
