...
请求地址	/yonbip/EFI/FaAllocateIn/audit
...
| id | string | 否 | 是 | 固定资产调入单id 示例：1483387421116596230 |

## 3. 请求示例

Url: /yonbip/EFI/FaAllocateIn/audit?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
...
| code | string | 否 | 调入单编码 示例：ZCDR024606 |
