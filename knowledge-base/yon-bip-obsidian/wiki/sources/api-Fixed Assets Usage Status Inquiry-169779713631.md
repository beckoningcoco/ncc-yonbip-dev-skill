...
请求地址	/yonbip/EFI/Usagestate/list
请求方式	POST
...
Url: /yonbip/EFI/Usagestate/list?access_token=访问令牌
Body: {
	"pageSize": 10,
	"pageIndex": 1,
	"simple": {
...

{
	...
	"data": {
		...
		"recordList": [
			{
				"id": "1550289997826359313",
				"code": "01",
				"isDepreciation": true,
				"name": {
					"zh_CN": "未使用"
				},
				"equipUsageStateId": "PRESET01_0000L8A6ELW126E96Q0",
				"equipUsageStateId_name": "在用",
