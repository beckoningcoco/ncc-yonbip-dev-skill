...
请求地址	/yonbip/ctm/foreignpayment/delete
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	是	是	外汇付款单数据
id	number
小数位数:0,最大长度:20	否	是	外汇付款单ID 示例：1910272858697216

## 3. 请求示例

Url: /yonbip/ctm/foreignpayment/delete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1910272858697216
