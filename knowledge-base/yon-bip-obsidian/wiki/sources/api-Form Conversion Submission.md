...
请求地址	/yonbip/scm/morphologyconversion/batchsubmit
...
| id | number |
| 小数位数:0,最大长度:30 | 否 | 是 | 形态转换单主表id 示例：22827969960554455 |

## 3. 请求示例

Url: /yonbip/scm/morphologyconversion/batchsubmit?access_token=访问令牌
Body: {
	"data": [
		{
