---
title: "资金归集保存接口"
apiId: "2292338249148399622"
apiPath: "请求方式	POST"
method: "ContentType	application/json"
category: "Funds Accumulation"
domain: "ctm"
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Funds Accumulation]
...
> `ContentType	application/json` 请求方式	POST | 分类: Funds Accumulation (ctm)
...
请求地址	/yonbip/2022008454953566212/fdtr/collection/openapi/save
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| collections | object | 是 | 是 | 资金归集单对象列表 |
| sourceSystem | string | 否 | 是 | 上游业务系统，支持编码和名称 示例：3 |
| accentity | string | 否 | 是 | 归集资金组织，支持编码和名称 示例：用友集团或YYJT |
| recCurrency | string | 否 | 是 | 归集币种，支持编码和名称 示例：人民币或CNY |
...
| details | object | 是 | 否 | 资金归集明细 |

## 3. 请求示例

Url: /yonbip/2022008454953566212/fdtr/collection/openapi/save?access_token=访问令牌
Body: {
	"collections": [
		{
			"sourceSystem": "3",
			...
			"details": [
				{
					"payAccentity": "曾式分部或ZSFB",
					"paySettleMode": "银行转账或system_0001",
					"expectSettleDate": "2025-05-30",
					"recAmount": 0,
					"payAccount": "曾式分部或6226033845759225",
					"payDirectConnection": "是",
					"paySupplementary": "否",
					...
					"postScript": "",
					"payExchangerate": 1,
					"payExchangerateOps": 1,
					"recExchangerate": 1,
					"recExchangerateOps": 1,
