...
> `ContentType	application/json` 请求方式	POST | 分类: General Change Request (ZNBZ)
...
请求地址	/yonbip/znbz/rbsm/api/bill/memoapplyalter/list
...
| pk_memoapply | string | 否 | 否 | 通用申请单id 示例：1900464857632210944 |
| pk_memoapply_code | string | 否 | 否 | 通用申请单code 示例：1900464857632210944 |
...
Url: /yonbip/znbz/rbsm/api/bill/memoapplyalter/list?access_token=访问令牌
Body: {
	"pageSize": 20,
	"pageIndex": 1,
	...
	"pk_memoapply_code": "1900464857632210944",
