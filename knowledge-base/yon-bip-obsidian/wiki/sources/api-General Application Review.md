---
title: "通用申请单审核"
apiId: "cd12d05a4c4846dfaf85db4c5ea1a627"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/znbz/rbsm/api/bill/memoapply/audit
...
Url: /yonbip/znbz/rbsm/api/bill/memoapply/audit?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"id": 2365029317071104
...
| data | object | 否 | 返回数据 |
| id | long | 否 | 单据id 示例：2381854424879360 |
