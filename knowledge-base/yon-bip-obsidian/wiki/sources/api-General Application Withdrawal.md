...
请求地址	/yonbip/znbz/rbsm/api/bill/memoapply/unsubmit
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 否 | 否 | 参数信息 |
| resubmitCheckKey | string | 否 | 否 | 保证请求的幂等性,该值由客户端生成,并且必须是全局唯一的，长度不能超过32位。更多信息,请参见«MDD幂等性» |
| id | string | 否 | 否 | 申请单ID 示例：1513588102104350723 |

## 3. 请求示例

Url: /yonbip/znbz/rbsm/api/bill/memoapply/unsubmit?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"id": "1513588102104350723"
	}
}
...
| pubts | string | 否 | 更新时间 示例：2022-08-31 11:20:43 |
...

{
	...
	"data": {
		...
		"resubmitCheckKey": "OPENAPI_1519008703029706756_0000KWZR3QO969OC1X0000_ddssds",
		"ibudgetctrltype": 0,
		"pubts": "2022-08-31 11:20:43",
		"verifystate": 0,
		"status": 0,
		"irejectstatus": 0
	}
