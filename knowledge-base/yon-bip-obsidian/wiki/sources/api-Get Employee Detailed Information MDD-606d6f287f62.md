---
title: "获取员工详细信息MDD"
apiId: "606d6f287f624c04b84e448ee0bb87e4"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/hrcloud/HRCloud/getStaffDetail
请求方式	POST
...
Url: /yonbip/hrcloud/HRCloud/getStaffDetail?access_token=访问令牌
Body: {
	"id": "",
	"loadDataEntityKeys": [
		""
...
isOnlyChild	boolean	否	是否独生子女 示例：true
joinedDate	string	否	入职日期 示例：2022-01-01
documentValidity	string	否	证件有效期 示例：2022-01-01
...
staffLeadershipTrade	object	是	党组/工会信息
staffTrialEvaluation	object	是	试用考核结果
staffDirectiorSupervisor	object	是	董监高信息
staffSocietyEmployment	object	是	社会任职信息
staffHealthSituation	object	是	健康信息
staffPunishment	object	是	惩处信息
staffCadre	object	是	干部任免信息
photo	string	否	照片
age	number
小数位数:0,最大长度:10	否	年龄
religionName	string	否	宗教信仰
workAge	string	否	工龄
birthPlaceName	string	否	出生地
birthPlaceCode	string	否	出生地编码
religionCode	string	否	宗教信仰编码
majorcorpname	string	否	合同主体单位
majorcorpCode	string	否	合同主体单位编码
...
evaluationMessage	object	是	测评信息
...

{
	...
	"data": {
		...
		"majorcorpCode": "",
		"creator": "",
		"createTime": "2026-06-07 12:58:20",
		"modifier": "",
		"modifyTime": "2026-06-07 12:58:20",
		"evaluationMessage": [
			{
				"id": "",
				"staffId": "",
