...
请求地址	/yonbip/HCC/time/report/open-api/report/attendExternal/getAttendMonthRptCommon
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
year	string	否	是	考勤年 示例：2025
month	string	否	是	考勤月 示例：8
pageSize	number
...
Url: /yonbip/HCC/time/report/open-api/report/attendExternal/getAttendMonthRptCommon?access_token=访问令牌
Body: {
	"year": "2025",
	"month": "8",
	"pageSize": 1,
			...
			"content": [
				{
					...
					"deptName": "生产部门",
					"staffConfirmState": 0,
					"sendConfirmTime": "2026-06-07 13:01:18",
					"holidayJsDeduc": 0,
					"weekendJsDeduc": 0,
					"workJsDeduc": 0,
					"alreadyDeduc": 0,
					"0000L6YQ8AVLFUZPXD0000lvtype001": 0,
					"0000L6YQ8AVLFUZPXD0000lvtype001_tz": 2,
					"0000L6YQ8AVLFUZPXD0000lvtype001_reason": ""
				}
			],
			"pageable": {
				"sort": {
