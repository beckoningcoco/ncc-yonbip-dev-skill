---
title: "根据银行对账单ID获取银行交易回单"
apiId: "1665886981000265729"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Account Transaction Receipt (ctm)
...
请求地址	/yonbip/ctm/cmp/bankelectronicreceipt/download
...
| bankBillId | string | query | 是 | 银行对账单ID    示例: 1711759722870210563 |

## 3. 请求示例

Url: /yonbip/ctm/cmp/bankelectronicreceipt/download?access_token=访问令牌&bankBillId=1711759722870210563
...
999	回单未返回	系统不存在对应的交易回单数据，需要确认对账单ID是否正确
