---
title: "根据部门ID分页获取租户下员工信息"
apiId: "3cff60e5-c610-4b42-8d71-e71796fdc4cb"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/uspace/staff/list_by_dept_ids
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
index	int	否	是	页数，以1开始
size	int	否	是	每页显示条数
deptIdList	string	否	是	部门ID(list)
flag	string	否	否	是否只查询已启用的员工（默认查询全部状态，只有传true代表只查询启用的）

## 3. 请求示例

Url: /yonbip/uspace/staff/list_by_dept_ids?access_token=访问令牌
Body: {
	"index": 0,
	"size": 0,
	"deptIdList": "",
