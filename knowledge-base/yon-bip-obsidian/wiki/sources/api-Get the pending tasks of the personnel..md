...
请求地址	/yonbip/digitalModel/openapi/query/ext/tasks
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| processBusinessKeyIds | string | 是 | 是 | businesskey集合 示例：["567aa7a5_2805345304105216","567aa7a5_2790078684336384"] |
| source | string | 否 | 是 | 应用来源(由对应的领域在流程预制，如：RBSM) 示例：developplatform |
| assignee | string | 否 | 是 | 待查询的人员id 示例：49f47a52-37d3-42c4-9b85-16cdc20a3009 |

## 3. 请求示例

Url: /yonbip/digitalModel/openapi/query/ext/tasks?access_token=访问令牌
Body: {
	"processBusinessKeyIds": [
		"567aa7a5_2805345304105216",
		"567aa7a5_2790078684336384"
	],
		...
		"data": [
			{
				"activity": {
					"name": "5",
					"id": "approveUserTask_41dcaa33304dc811732fe851a9972af4",
					"type": "userTask",
					"properties": {
						"useCallbackFunction": "",
				...
				"processInstance": {
					...
					"startParticipant": {
						...
						"pic": "https://cdn.yonyoucloud.com/dev/yht/avatar/style/images/avatar/dfebface-9acc-4b13-bdb2-b11bbbae66e1/original/original.png?v=axpR2T",
						"priority": 50,
						"type": "USER"
					},
					"completed": false,
