---
title: "根据友户通userId获取用户信息"
apiId: "2bac9773-c3fa-437b-89c7-65f25d274e2f"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/uspace/users/list_by_ids
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
userIds	string	是	是	userId用户ID集合(list)

## 3. 请求示例

Url: /yonbip/uspace/users/list_by_ids?access_token=访问令牌
Body: {
	"userIds": [
		""
	]
