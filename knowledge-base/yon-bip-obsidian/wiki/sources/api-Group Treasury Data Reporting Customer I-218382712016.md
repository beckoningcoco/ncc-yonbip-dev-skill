---
title: "集团司库数据上报客商信息查询"
apiId: "2183827120164700168"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/ctm/submit/api/group/merchinfo/query
请求方式	POST
...
名称	类型	数组	必填	描述
dataDate	date
格式:yyyy-MM-dd	否	是	数据日期 示例：2025-10-10
submitType	string	否	是	报送业务名称 填MERCHINFO 示例：MERCHINFO
...
Url: /yonbip/ctm/submit/api/group/merchinfo/query?access_token=访问令牌
Body: {
	"dataDate": "2025-10-10",
