---
title: "集团司库数据上报客商信息明细新增"
apiId: "2184711436750553091"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/ctm/submit/api/group/merchinfo/detail/insert
...
| submitType | string | 否 | 是 | 上报业务数据类型 示例：MERCHINFO 默认值：MERCHINFO |
...
Url: /yonbip/ctm/submit/api/group/merchinfo/detail/insert?access_token=访问令牌
Body: {
	"dataDate": "",
...
| sourceIds | string | 是 | 新增成功的外部数据来源id |
