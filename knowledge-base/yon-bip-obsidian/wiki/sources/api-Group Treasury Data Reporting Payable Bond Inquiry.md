---
title: "集团司库数据上报应付债券查询"
apiId: "2183821785832095751"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/ctm/submit/api/group/paybond/query
...
| submitType | string | 否 | 是 | 报送业务名称 填PAY_BOND 示例：PAY_BOND |
| billStatus | string | 否 | 否 | 单据状态 报送状态 0 初始态1 审批中 2 已审核 3 终止态4驳回 示例：1 |
...
| size | number |
| 小数位数:0,最大长度:10 | 否 | 是 | 每次查询条数 示例：10 |

## 3. 请求示例

Url: /yonbip/ctm/submit/api/group/paybond/query?access_token=访问令牌
Body: {
	"dataDate": "2026-06-07",
	"submitType": "PAY_BOND",
	"billStatus": "1",
