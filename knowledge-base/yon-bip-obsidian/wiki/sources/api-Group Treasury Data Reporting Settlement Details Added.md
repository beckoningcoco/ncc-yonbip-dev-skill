---
title: "集团司库数据上报结算明细新增"
apiId: "2184649975768547333"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/ctm/submit/api/group/settlement/detail/insert
...
Url: /yonbip/ctm/submit/api/group/settlement/detail/insert?access_token=访问令牌
Body: {
	"dataDate": "",
...
| message | string | 否 | 接口返回结果描述 |
| sourceIds | string | 是 | 插入的外部来源id |
