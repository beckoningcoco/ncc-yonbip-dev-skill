---
title: "集团司库数据上报银行账户明细新增"
apiId: "2184078375757283332"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/ctm/submit/api/group/bankaccount/detail/insert
请求方式	POST
...
centralizeFundAccountIdenty	string	否	是	集中资金账户标识 N00：非监控 N01：可监控 N02：可归集
accountStatus	string	否	是	账户状态 T00:存续；T01：注销
accountOpenTime	string	否	是	开户时间
accountCancelTime	string	否	否	销户时间
inoutUnitAccount	string	否	是	是否为内部单位账户 T00：非内部单位账户； T01：内部单位账户；

## 3. 请求示例

Url: /yonbip/ctm/submit/api/group/bankaccount/detail/insert?access_token=访问令牌
Body: {
	"dataDate": "",
