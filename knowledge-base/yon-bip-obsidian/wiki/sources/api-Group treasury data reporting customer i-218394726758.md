---
title: "集团司库数据上报客商信息明细删除"
apiId: "2183947267585605633"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/ctm/submit/api/group/merchinfo/detail/delete
请求方式	POST
...
submitType	string	否	是	数据来源:只能填MERCHINFO 示例：MERCHINFO
sourceIds	string	是	是	待删除的外部数据来源id

## 3. 请求示例

Url: /yonbip/ctm/submit/api/group/merchinfo/detail/delete?access_token=访问令牌
Body: {
	"dataDate": "2026-06-07",
