...
请求地址	/yonbip/qyjx/yonbip-fi-sepmbcdc/execdata/isomeryControl
...
| url | string | 否 | 否 | 单据跳转链接 |

## 3. 请求示例

Url: /yonbip/qyjx/yonbip-fi-sepmbcdc/execdata/isomeryControl?access_token=访问令牌
Body: {
	"busiSysCode": "",
	"requestUniqueId": "",
	"operateFlag": 0,
