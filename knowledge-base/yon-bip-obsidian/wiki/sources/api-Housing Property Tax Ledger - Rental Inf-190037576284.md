---
title: "房产税台账-从租信息-删除(废弃)"
apiId: "1900375762842157063"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/tax/other-tax/api/house-rent/delete
请求方式	POST
...
sbRentStart	date
格式:yyyy-MM-dd	否	是	申报租金所属期起，日期格式：yyyy-MM-dd 示例：2023-01-01
sbRentEnd	date
格式:yyyy-MM-dd	否	是	申报租金所属期止，日期格式：yyyy-MM-dd 示例：2023-01-31
code	string	否	否	房产税源编号（房产编号和房产税源编号不可同时为空，且不能同时填写） 示例：FCST20240808000001

## 3. 请求示例

Url: /yonbip/tax/other-tax/api/house-rent/delete?access_token=访问令牌
Body: {
	"orgCode": "a1234512903b",
	"houseCode": "123123a",
	"sbRentStart": "2023-01-01",
	"sbRentEnd": "2023-01-31",
	"code": "FCST20240808000001"
}
