---
title: "房产税台账-从租信息-删除-第2版"
apiId: "2114165920417447944"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/tax/yonbip-fi-taxoth/api/house-rent/v2/del
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| orgCode | string | 否 | 是 | 税务组织编码 示例：a1234512903b |
...
| sbRentStart | string | 否 | 是 | 申报期起 示例：2023-12 |
| sbRentEnd | string | 否 | 是 | 申报期止 示例：2023-12 |

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxoth/api/house-rent/v2/del?access_token=访问令牌
Body: [{
