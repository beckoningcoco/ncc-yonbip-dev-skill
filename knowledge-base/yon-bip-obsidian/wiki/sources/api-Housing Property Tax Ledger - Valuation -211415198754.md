---
title: "房产税台账-从价信息-新增-第2版"
apiId: "2114151987543539719"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/tax/yonbip-fi-taxoth/api/house-valorem/v2/add
请求方式	POST
...
小数位数:2,最大长度:15	否	是	房产原值 示例：123.22
rentValue	number
小数位数:2,最大长度:15	否	是	出租房产原值 示例：23.22
rentArea	number
小数位数:2,最大长度:15	否	是	出租房产面积 示例：12.22
rateRatio	number
小数位数:0,最大长度:3	否	是	计税比例（%）。最大为100，最小为0示例：传入20，则认为是0.2 示例：2
taxBegin	string	否	是	纳税义务起始时间 示例：2023-12

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxoth/api/house-valorem/v2/add?access_token=访问令牌
Body: [{
	"orgCode": "123123123",
