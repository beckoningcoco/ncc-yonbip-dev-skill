---
title: "房产税源信息-房屋租赁信息-删除"
apiId: "2121591558104416264"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/tax/other-tax/api/house-lease/v1/delete
请求方式	POST
...
code	string	否	否	房产税源编码(房源来源业务id和房产税源编号不可同时为空，且不能同时填写) 示例：C0011
sourceId	string	否	否	租赁信息来源id(租赁信息来源业务id和房屋租赁明细编号不可同时为空，且不能同时填写) 示例：S1001122
houseAccountLeaseCode	string	否	否	房屋租赁明细编号(租赁信息来源业务id和房屋租赁明细编号不可同时为空，且不能同时填写) 示例：HA00011
updateHouseTax	string	否	否	自动生成/更新房产税台账(0-否;1-是) 示例：0 默认值：0

## 3. 请求示例

Url: /yonbip/tax/other-tax/api/house-lease/v1/delete?access_token=访问令牌
Body: {
	"orgCode": "ON0011",
	"lyid": "ly0011",
	"code": "C0011",
