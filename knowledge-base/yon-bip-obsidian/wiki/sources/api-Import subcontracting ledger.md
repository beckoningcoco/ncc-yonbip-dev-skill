...
请求地址	/yonbip/tax/yonbip-fi-taxbuilding/api/subproject/import
...
| supplierNsrsbh | string | 否 | 是 | 分包项目企业税号仅支持8位、9位、11位、12位、15位、16位、17位、18位、19位或20位纳税人识别号 示例：91370600056214307M |
| supplierName | string | 否 | 是 | 分包企业名称 示例：烟台顺丰公司 |

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxbuilding/api/subproject/import?access_token=访问令牌
Body: [{
	"orgCode": "ceshi",
	"projectCode": "0099",
	"projectName": "青岛公司",
