...
请求地址	/yonbip/tax/yonbip-fi-taxoth/api/tax-preferential-policies/batch-delete
请求方式	POST
...
id	string	否	是	数据唯一标识，具有唯一性 示例：2066057235821232136

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxoth/api/tax-preferential-policies/batch-delete?access_token=访问令牌
Body: {
	"data": [
		{
