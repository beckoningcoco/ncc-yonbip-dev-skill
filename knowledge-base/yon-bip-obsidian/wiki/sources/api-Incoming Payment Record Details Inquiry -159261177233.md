...
请求地址	/yonbip/sd/api/upayment/detail
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
id	long	是	否	来款记录id（来款记录id和单号不能同时为空） 示例：[1794313632794279936,1794313632794279936]
code	string	是	否	来款记录单号（来款记录id和单号不能同时为空） 示例：["RECar2208030000606","RECar2208030000606"]

## 3. 请求示例

Url: /yonbip/sd/api/upayment/detail?access_token=访问令牌
Body: {
	"id": [
		1794313632794279936,
		1794313632794279936
