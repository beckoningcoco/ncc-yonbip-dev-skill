...
>  请求方式	GET | Inspection Document (QMS)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/QMS_QIT/inspectorder/detail
请求方式	GET
...
id	string	query	否	检验单id，编码和id 任一不为空，都有值的话取id    示例: 1888589127091748873
code	string	query	否	检验单编码    示例: LLJY202312200001
billnum	string	query	是	检验单类型,来料检验单qms_incominspectorder_card，产品检验单qms_prodinspectorder_card，其他检验单qms_otherinspectorder_card，工序检验单qms_procedureinspectorder_card，在库检验单qms_stockinspectorder_card，发退货检验单qms_deliveryinspectorder_card    示例: qms_incominspectorder_card    默认值: qms_incominspectorder_card

## 3. 请求示例

Url: /yonbip/QMS_QIT/inspectorder/detail?access_token=访问令牌&id=1888589127091748873&code=LLJY202312200001&billnum=qms_incominspectorder_card
				...
				"qms_qit_incominspectorder_resultList": [
					{
						...
						"stockStatusCode": "",
						"inStockBatchCode": "",
						"produceDate": "2026-06-07 13:18:29",
						"validityDate": "2026-06-07 13:18:29",
