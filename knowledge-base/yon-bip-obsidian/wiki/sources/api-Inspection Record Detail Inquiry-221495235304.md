...
请求地址	/yonbip/am/capitalsource/delete
请求方式	POST
...
名称	类型	数组	必填	描述
data	object	是	否	数据
id	string	否	否	资金来源单据ID 示例：1476611216843472896
code	string	否	否	资金来源编码 示例：8394802

## 3. 请求示例

Url: /yonbip/am/capitalsource/delete?access_token=访问令牌
Body: {
	"data": [
		{
