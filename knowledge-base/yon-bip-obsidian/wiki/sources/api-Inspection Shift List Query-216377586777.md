...
2. 列表查询字段包括：资产组织、编码、名称、启用状态、开始日期、结束日期、排班规则、班次、默认班组、自动顺延排班。
...
请求地址	/yonbip/am/routeinspschedulelist/query
请求方式	POST
...
Url: /yonbip/am/routeinspschedulelist/query?access_token=访问令牌
Body: {
	"page": {
		"pageIndex": 1,
		"pageSize": 20
