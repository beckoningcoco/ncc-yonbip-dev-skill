...
请求地址	/yonbip/am/rmmworkorderlist/delete
请求方式	POST
...
id	string	否	是	工单主表主键 示例：1476611216843472896

## 3. 请求示例

Url: /yonbip/am/rmmworkorderlist/delete?access_token=访问令牌
Body: {
	"data": [
		{
