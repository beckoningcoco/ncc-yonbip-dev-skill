...
bustype	string	否	是	库存上报交易类型ID 示例：1841647505310220291
customer	string	否	否	客户ID
customer_name	string	否	否	客户名称 示例：用友西区便利蜂
terminal	string	否	否	终端ID
terminal_name	string	否	否	终端
professionalTime	string	否	否	业务日期
cust	string	否	否	伙伴ID
cust_name	string	否	否	伙伴名称
clientStockInquiryRecordList	object	是	否	库存上报记录详情
_status	string	否	是	保存类型 Insert:新增 Update:更新 示例：Insert

## 3. 请求示例

Url: /yonbip/crm/cusstock/save?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
...
data	object	否	data
code	string	否	进货上报编码 示例：20240805004125
bustype	string	否	交易类型ID 示例：1841647505310220291
...
balanceCount	string	否	总结存数量 示例：11
...
clientStockInquiryDefineCharacter	object	否	clientStockInquiryDefineCharacter
clientStockInquiryRecordList	object	是	clientStockInquiryRecordList
oldProfessionalTime	string	否	上次业务日期 示例：2024-08-05 11:34:50
...

{
	...
	"data": {
		...
		"clientStockInquiryDefineCharacter": {
		...
		"clientStockInquiryRecordList": [
			{
				...
				"clientStockInquiryId": "2215101749293219845",
				"pubts": "2024-08-05 11:34:50",
		...
		"oldProfessionalTime": "2024-08-05 11:34:50",
		"resubmitCheckKey": "_74b48bdf-e461-4efc-87ed-308becc2349e",
