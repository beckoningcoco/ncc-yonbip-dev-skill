---
title: "库存状态/预留调整删除"
apiId: "b7952fb7faff4dabb916612d7259a0e2"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/scm/stockstatuschange/batchdelete
...
| id | long | 否 | 是 | 库存状态调整单主表主键 示例：2037904727954176 |

## 3. 请求示例

Url: /yonbip/scm/stockstatuschange/batchdelete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2037904727954176
