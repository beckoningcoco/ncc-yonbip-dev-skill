...
请求地址	/yonbip/scm/stockstatuschange/list
请求方式	POST
...
changeType	string	否	是	查询库存状态调整列表使用statuschange，查询预留调整时使用reservechange 示例：reservechange
...
outreserveid	string	是	否	来源跟踪线索id
inreserveid	string	是	否	目的跟踪线索id
...
Url: /yonbip/scm/stockstatuschange/list?access_token=访问令牌
Body: {
	"pageIndex": "",
	"changeType": "reservechange",
	"code": "",
	"pageSize": "",
	"warehouse_name": "",
