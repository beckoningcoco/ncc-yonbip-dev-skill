...
请求地址	/yonbip/scm/stockstatuschange/batchsubmit
请求方式	POST
...
id	number
小数位数:-1,最大长度:19	否	是	主表id 示例：1915883316809984

## 3. 请求示例

Url: /yonbip/scm/stockstatuschange/batchsubmit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1915883316809984
