---
title: "盘点差异单审核"
apiId: "26ad4c758dd04772bf3bc72f84e5a3d6"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/scm/storecheckdifference/batchaudit
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 是 | 请求体 |
| id | long | 否 | 是 | 盘点差异单主表id 示例：2292630096614144 |

## 3. 请求示例

Url: /yonbip/scm/storecheckdifference/batchaudit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2292630096614144
