...
请求地址	/yonbip/tax/input-tax/api/invoice-entry/commit
...
| sqrzyt | string | 否 | 是 | 入账用途 01:未入账 02:已入账(企业所得税税前扣除) 03:已入账(企业所得税不扣除) 06:入账撤销 示例：02 |
