---
title: "发布采购订单"
apiId: "a229c81d567d47d9a87f71791f46bb24"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/cpu/puorder/pubOrderToYC
请求方式	POST
...
transactionTypeCode	string	否	否	交易类型code
...
unitCode	string	否	否	计价code 多单位
priceExchRate	BigDecimal	否	否	计价换算率 多单位
purchaseNum	BigDecimal	否	否	采购数量 多单位
purchaseUnitId	string	否	否	采购单位id 多单位
purchaseUnitCode	string	否	否	采购单位code 多单位
purchaseUnitName	string	否	否	采购单位名称 多单位
purchaseExchRate	BigDecimal	否	否	采购换算率 多单位
mainNum	BigDecimal	否	否	主数量 多单位
mainMetrologyId	string	否	否	主数量id 多单位
mainMetrologyCode	string	否	否	主数量code 多单位
mainMetrologyName	string	否	否	主数量名称 多单位

## 3. 请求示例

Url: /yonbip/cpu/puorder/pubOrderToYC?access_token=访问令牌&accountID=
Body: {
	"supplydatas": {
		"pk_supplier": ""
	},
