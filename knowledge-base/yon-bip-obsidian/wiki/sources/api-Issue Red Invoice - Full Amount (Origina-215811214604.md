...
请求地址	/yonbip/tax/invoiceclient-web/api/invoiceApply/red-withjson
请求方式	POST
...
Url: /yonbip/tax/invoiceclient-web/api/invoiceApply/red-withjson?access_token=访问令牌
Body: {
	"data": {
		"autoAudit": true,
		"einvoiceApplyList": [
