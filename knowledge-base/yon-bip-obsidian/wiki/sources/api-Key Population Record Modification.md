...
请求地址	/yonbip/tax/api/special/group/filing/batch-update
...
| certificateNo | string | 否 | 否 | 证件编号 示例：1231 |
...
| terminationTime | string | 否 | 否 | 停止抵扣时间（YYYY-MM） 示例：2024-07 |
...
Url: /yonbip/tax/api/special/group/filing/batch-update?access_token=访问令牌
Body: {
	"records": [
		{
			"sourceId": "1231",
