...
请求地址	/yonbip/tax/other-tax/api/tradeunionfundledger/update
请求方式	POST
...
Url: /yonbip/tax/other-tax/api/tradeunionfundledger/update?access_token=访问令牌
Body: [{
	"orgCode": "rzs2",
	"taxRate": 0.02,
	"totalWages": 1200,
