...
请求地址	/yonbip/am/limrentinbillcard/delete
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	是	否	租入发票对象
id	string	否	是	租入发票主表id 示例：1476611216843472896

## 3. 请求示例

Url: /yonbip/am/limrentinbillcard/delete?access_token=访问令牌
Body: {
	"data": [
		{
