...
pk_org	string	否	是	承租组织id或编码 示例：1993200580185030664
bill_code	string	否	否	合同编码 示例：ZRHT202311270002
contract_code	string	否	是	合同号 示例：00460
contract_name	string	否	是	合同名称 示例：合同名称
signed_date	date
格式:yyyy-MM-dd	否	是	合同签订日期 示例：2024-01-08
plan_effective_date	date
格式:yyyy-MM-dd	否	是	计划生效日期 示例：2024-01-08
plan_end_date	date
格式:yyyy-MM-dd	否	是	计划结束日期 示例：2024-05-08
pk_fiorg	string	否	否	承租会计主体id或编码,不填写则带出承租组织默认的会计主体 示例：1993200580185030664
pk_raorg	string	否	否	承租利润中心id或编码 示例：1993200580185030664
pk_costcenter_in	string	否	否	承租成本中心id或编码 示例：1993200580185030664
customer_out	string	否	是	出租方id或编码 示例：1993200580185030664
pk_jobmngfil	string	否	否	项目id或编码 示例：1993200580185030664
pk_record_dept	string	否	否	经办部门id或编码 示例：1993200580185030664
pk_recorder	string	否	否	经办人id或编码 示例：1993200580185030664
pk_record_date	date
格式:yyyy-MM-dd	否	否	经办日期,默认当天日期 示例：2024-01-08
origcurrtypeid	string	否	否	币种id或编码 示例：1835123930930085895
currrate_type	string	否	否	汇率类型id或编码,默认会获取承租会计主体中的汇率类型 示例：1835123930930085895
currrate_date	date
格式:yyyy-MM-dd	否	否	汇率日期，默认当天日期 示例：2024-01-08
deposit	number
小数位数:8,最大长度:28	否	否	押金 示例：1000
e_contract_code	string	否	否	电子合同模板code 示例：1503953777564581889
contract_process_code	string	否	否	电子合同签署流程code 示例：1519825305218842626
memo	string	否	否	备注 示例：备注
pk_transitype	string	否	是	交易类型id|code 示例：4A3A-01 默认值：4A3A-01
rent_basic	object	是	是	合同基本

## 3. 请求示例

Url: /yonbip/am/rentin/add?access_token=访问令牌
Body: {
	"data": {
		"pk_org": "1993200580185030664",
		...
		"pk_fiorg": "1993200580185030664",
		"pk_raorg": "1993200580185030664",
		"pk_costcenter_in": "1993200580185030664",
		"customer_out": "1993200580185030664",
		"pk_jobmngfil": "1993200580185030664",
		"pk_record_dept": "1993200580185030664",
		"pk_recorder": "1993200580185030664",
		"pk_record_date": "2024-01-08",
		"origcurrtypeid": "1835123930930085895",
		"currrate_type": "1835123930930085895",
		"currrate_date": "2024-01-08",
		"deposit": 1000,
		"e_contract_code": "1503953777564581889",
		"contract_process_code": "1519825305218842626",
		"memo": "备注",
		"pk_transitype": "4A3A-01",
		"rent_basic": [
			{
				"pk_equip__equip_name": "资产名称",
				"pk_category": "1455871008568770563",
				"pk_material": "1455871008568770563",
				...
				"rent_count_style": "0",
				"pk_rent_count_method": "2761480975865089",
				"tax_id": "2761480975865089",
				...
				"num": 1,
				"ofuse_flag": false,
				"ofuse_price_rate": 0.618,
				"renewed_choose_flag": false,
				"buy_choose_flag": false
			}
		]
	}
}
...
currrate_date	date
格式:yyyy-MM-dd	否	汇率日期 示例：2023-11-27
...
creationtime	date
格式:yyyy-MM-dd HH:mm:ss	否	创建时间 示例：2023-11-27 16:34:05
wbs__name	string	否	WBS任务
rent_basic	object	是	合同基本
rent_detailed	object	是	租金明细
rent_calculation	object	否	租金计算明细，自动交接合同才返回
