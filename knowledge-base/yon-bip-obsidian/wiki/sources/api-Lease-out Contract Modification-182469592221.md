...
请求地址	/yonbip/am/rentoutcard/add
请求方式	POST
...
pk_org	string	否	是	出租组织id或编码 示例：1549238289085497348
contract_code	string	否	是	合同号 示例：00460
contract_name	string	否	是	合同名称 示例：00460
plan_effective_date	date
格式:yyyy-MM-dd	否	是	计划生效日期 示例：2023-03-24
signed_date	date
格式:yyyy-MM-dd	否	否	合同签订日期（默认当前日期） 示例：2023-03-24
end_date	date
格式:yyyy-MM-dd	否	是	计划结束日期 示例：2023-04-09
pk_raorg	string	否	否	出租利润中心id或编码 示例：1549985269801811977
pk_mandept	string	否	是	经办部门id或编码 示例：1549985269801811977
pk_recorder	string	否	是	经办人id或编码 示例：1549987150994341890
pk_jobmngfil	string	否	否	项目id或编码 示例：1549985269801811977
pk_transitype	string	否	是	交易类型id或编码 示例：1547236147129223598
contract_way_synergy	string	否	否	协同（true：是，false：否） 示例：true
customer_way	number
小数位数:-1,最大长度:1	否	否	承租对象类型（0：员工，1：客户） 示例：1 默认值：0
customer__name	string	否	是	承租方编码 示例：00000000000001
retail_tenant	string	否	否	散户承租方 示例：散户承租方
pk_org_in	string	否	否	承租组织id或编码 示例：1549232937556246532
origcurrtypeid	string	否	是	币种id或编码 示例：1547236147129221140
currrate	number
小数位数:2,最大长度:10	否	是	汇率 示例：7.25 默认值：1
currrate_type	string	否	否	汇率类型 示例：1
currrate_date	date
格式:yyyy-MM-dd	否	否	汇率日期 示例：2023-04-09
deposit	number
小数位数:2,最大长度:10	否	否	押金 示例：0
e_contract	string	否	否	合同模板id或code 示例：1993200580185030664
contract_process_id	string	否	否	签署流程id或流程 示例：1993200580185030664
memo	string	否	否	备注 示例：备注
rent_basic	object	是	是	合同基本

## 3. 请求示例

Url: /yonbip/am/rentoutcard/add?access_token=访问令牌
Body: {
	"data": {
		...
		"end_date": "2023-04-09",
		"pk_raorg": "1549985269801811977",
		"pk_mandept": "1549985269801811977",
		"pk_recorder": "1549987150994341890",
		"pk_jobmngfil": "1549985269801811977",
		"pk_transitype": "1547236147129223598",
		"contract_way_synergy": "true",
		"customer_way": 1,
		"customer__name": "00000000000001",
		"retail_tenant": "散户承租方",
		...
		"deposit": 0,
		"e_contract": "1993200580185030664",
		"contract_process_id": "1993200580185030664",
		"memo": "备注",
		"rent_basic": [
			{
				...
				"rent_basic_equippack": [
					{
						...
						"pk_rent_object": "123123213213213",
						"memo": "备注",
						"out_flag": true
					}
				]
				...
				"rent_basic_equippack": [
					{
						...
						"main_id": "1687513498448822279",
						"rent_basic_id": "1687513498448822280",
						"pk_equip": "16875134984234242",
						"equip_code": "资产编码",
						"equip_name": "资产名称",
						"pk_category": "1687513498448822242423",
						"pk_category__category_name": "类别名称",
						"pk_used_status": "在用",
						"pubts": "2023-03-24 18:07:08",
						"sub_flag": true,
						"out_flag": true
