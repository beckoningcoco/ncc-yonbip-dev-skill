...
请求地址	/yonbip/ACC/rentoutoperadata/submit
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	是	是	租出运营数据对象
id	string	否	是	租出运营数据对象主键 示例：2318999095537565701
fromApi	boolean	否	否	是否来源于OpenApi 示例：true

## 3. 请求示例

Url: /yonbip/ACC/rentoutoperadata/submit?access_token=访问令牌
Body: {
	"data": [
		{
