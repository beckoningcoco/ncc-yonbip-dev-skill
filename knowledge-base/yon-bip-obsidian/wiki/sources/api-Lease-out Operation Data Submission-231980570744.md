...
请求地址	/yonbip/ACC/rentoutoperadata/commit
请求方式	POST
...
id	string	否	是	资产变动主键 示例：2318999095537565701

## 3. 请求示例

Url: /yonbip/ACC/rentoutoperadata/commit?access_token=访问令牌
Body: {
	"data": [
		{
