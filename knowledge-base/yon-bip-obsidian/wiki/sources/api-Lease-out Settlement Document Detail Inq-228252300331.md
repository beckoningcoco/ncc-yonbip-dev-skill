...
请求地址	/yonbip/am/mimverificationrecordlist/delete
请求方式	POST
...
id	string	否	否	检定记录ID 示例：1607154170807713801

## 3. 请求示例

Url: /yonbip/am/mimverificationrecordlist/delete?access_token=访问令牌
Body: {
	"data": [
		{
