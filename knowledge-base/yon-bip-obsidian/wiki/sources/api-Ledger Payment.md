...
请求地址	/yonbip/tax/api/bill-collections/paid
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| billCode | string | 否 | 是 | 发票代码 示例：12345678 |
| billNum | string | 否 | 是 | 发票号码 示例：1234567812 |
...
Url: /yonbip/tax/api/bill-collections/paid?access_token=访问令牌
Body: {
	"billCode": "12345678",
	"billNum": "1234567812",
	"billType": "invoice"
