...
请求地址	/yonbip/ctm/partnerlist/enable
...
| changeStatus | string | 否 | 是 | 变更后状态 |

## 3. 请求示例

Url: /yonbip/ctm/partnerlist/enable?access_token=访问令牌
Body: {
	"params": [
		{
			"entityCode": "",
...
| changeStatus | string | 否 | 变更后状态 |
| executeResult | string | 否 | 变更结果 |
