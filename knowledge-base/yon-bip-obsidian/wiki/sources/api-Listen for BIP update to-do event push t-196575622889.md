---
title: "监听BIP更新待办事件推送三方系统"
apiId: "1965756228890525697"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/uspace/event/todocenter/updateTodo
请求方式	POST
...
validApp	string	否	否	有效应用
todoTemplateVars	object	否	否	待办模板集合
yyUserId	string	否	否	审批人

## 3. 请求示例

Url: /yonbip/uspace/event/todocenter/updateTodo?access_token=访问令牌
Body: {
	"actionKey": "",
	"value": {
		"cardMessageVO": {
