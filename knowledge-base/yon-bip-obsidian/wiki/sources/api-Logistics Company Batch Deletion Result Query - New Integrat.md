---
title: "物流公司批量删除结果查询-新集成"
apiId: "2247915866268631047"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Shipping Carrier (MD)
...
请求地址	/yonbip/digitalModel/coredoc/async/deliverycorp/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/coredoc/async/deliverycorp/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
