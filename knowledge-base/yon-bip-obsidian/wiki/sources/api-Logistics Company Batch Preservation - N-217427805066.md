...
请求地址	/yonbip/digitalModel/deliverycorp/batchSave
请求方式	POST
...
name	object	否	是	物流公司
corp_code	string	否	是	物流公司代码 示例：fds
request_url	object	否	否	查询接口网址 示例：jkhjk
website	object	否	否	物流公司网址
stopstatus	boolean	否	是	停用状态（true：停用，true：启用） 示例：false
ordernum	number
小数位数:0,最大长度:20	否	是	排序 示例：1

## 3. 请求示例

Url: /yonbip/digitalModel/deliverycorp/batchSave?access_token=访问令牌
Body: {
	"matchRule": "id",
