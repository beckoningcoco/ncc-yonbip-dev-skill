...
请求地址	/yonbip/am/refueloilcard/detail
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
code	string	否	否	润滑单号 示例：RHDH2503310001
id	string	否	否	主键 示例：2235099151277228042

## 3. 请求示例

Url: /yonbip/am/refueloilcard/detail?access_token=访问令牌
Body: {
	"code": "RHDH2503310001",
	"id": "2235099151277228042"
}
...
bill_code	string	否	润滑单号 示例：RHDH2503310001
...
pk_recorder_dept	string	否	经办部门主键 示例：2097854845709975552
pk_recorder_dept__name	string	否	经办部门 示例：部门1
recorder_date	date
...

{
	...
	"data": {
		...
		"pk_org__name": "G公司",
		"bill_code": "RHDH2503310001",
		"bill_status": "0",
		"verifystate": "0",
		"pk_recorder": "2097855747668836356",
		"pk_recorder__name": "郭亚鑫",
		"pk_recorder_dept": "2097854845709975552",
		"pk_recorder_dept__name": "部门1",
		"recorder_date": "2024-10-24",
		"memo": "表头备注",
		...
		"bodyvos": [
			{
				"pk_lubricate": "2121664005503713845",
				"pk_lubricate__bill_code": "RHKP202405150005",
				...
				"pk_user__name": "郭亚鑫",
				"pk_location": "2132042132539047942",
				"pk_location__location_code": "LOC24110001",
				"pk_location__location_name": "测试位置1",
				"lubrication_part": "部位",
				"lubrication_points": 10,
				"plan_oil_time": "2024-10-29",
				"pk_provide_oil": "2097858917335826439",
				"pk_provide_oil__code": "RHY202409270001",
				"pk_provide_oil__name": "98油",
				"pk_provide_oil__oilbrand_code": "98油牌号",
				"pk_lubricantdefine_sub": "2097858917335826439",
				"pk_lubricantdefine_sub__code": "RHY202409270001",
				"pk_lubricantdefine_sub__name": "98油",
				"pk_lubricantdefine_sub__oilbrand_code": "98油牌号",
				"pk_measdoc": "2097858917335826546",
				"pk_measdoc__name": "立方米",
				"standard_oil_volume": "10",
				"pk_oil_dept": "2097854845709975552",
				"pk_oil_dept__name": "部门1",
				"pk_oli_team": "2097878751504236553",
				"pk_oli_team__name": "a班组",
				"pk_oli_principal": "2097855747668836356",
				"pk_oli_principal__name": "郭亚鑫",
				"business_type": 1,
				"exec_flag": "1",
				"act_oil_time": "2025-02-11 15:38:52",
				...
				"act_oil_volume": "10",
				"pk_act_oil_dept": "2097854845709975552",
				"pk_act_oil_dept__name": "部门1",
				"pk_act_oli_team": "2097878751504236553",
				"pk_act_oli_team__name": "a班组",
				"pk_act_oli_principal": "2097855747668836356",
				"pk_act_oli_principal__name": "郭亚鑫",
				"oil_cycle": 1,
				"oil_cycle_unit": "0",
				"next_oil_time": "2025-02-12",
				"memo": "表体备注"
			}
		]
	}
...
返回参数 memo_oli
删除
返回参数 pk_lubricate_planner
删除
返回参数 pk_lubricate_planner__name
