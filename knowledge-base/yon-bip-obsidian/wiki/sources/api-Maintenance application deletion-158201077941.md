...
请求地址	/yonbip/am/rmmworkapplylist/delete
请求方式	POST
...
id	string	否	是	维修申请主表主键 示例：1582003555291103242

## 3. 请求示例

Url: /yonbip/am/rmmworkapplylist/delete?access_token=访问令牌
Body: {
	"data": [
		{
