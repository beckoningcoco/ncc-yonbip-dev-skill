...
>  请求方式	GET | Marketplace Sector Management (SD)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/sd/zone/getShoppingSectorDetail
请求方式	GET
...
id	string	query	否	专区id(id,code必传其一，如果同时传递以id为准)    示例: 2022098743773888513
code	string	query	否	专区编码(id,code必传其一，如果同时传递以id为准)    示例: test234234234

## 3. 请求示例

Url: /yonbip/sd/zone/getShoppingSectorDetail?access_token=访问令牌&id=2022098743773888513&code=test234234234
...
modifyDate	date
格式:yyyy-MM-dd	否	修改日期 示例：2024-06-28 00:00:00
modifyTime	date
...
productCharacter	string	否	专区商品关联订单特征
nameCharacter	string	否	专区名称关联订单特征
vouchdate	date
格式:yyyy-MM-dd HH:mm:ss	否	单据日期 示例：2024-06-17 00:00:00
pubts	string	否	时间戳 示例：2024-06-28 16:27:38
masterOrgKeyField	string	否	主组织字段标识 示例：salesOrgId
transTypeKeyField	string	否	交易类型字段标识 示例：transType
explosiveProZoneProductInfos	object	是	专区商品
