---
title: "生产订单行关闭"
apiId: "ffde6d818fd64940ae17a4ff14aabb98"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/mfg/productionorder/lineclose
请求方式	POST
...
Url: /yonbip/mfg/productionorder/lineclose?access_token=访问令牌
Body: {
	"data": {
		"id": 2211732336611584,
...
code	string	否	成产订单编码 示例：SCDD202106140001
