...
请求地址	/yonbip/MFC/salesforecast/lineclose
请求方式	POST
...
Url: /yonbip/MFC/salesforecast/lineclose?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"id": 2211732336611584,
...
salesForecastDetail	object	是	计划独立需求子表
