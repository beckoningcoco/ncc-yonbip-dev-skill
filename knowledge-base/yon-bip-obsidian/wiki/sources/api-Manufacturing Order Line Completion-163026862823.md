...
请求地址	/yonbip/mfg/productionorder/linefinishWork
请求方式	POST
...
id	long	否	否	生产订单id，id、code不能同时为空 示例：2559021676106240
code	string	否	否	生产订单编码，id、code不能同时为空 示例：SCDD201912250005
productionId	long	否	是	生产订单产品行id 示例：1629411490213658631

## 3. 请求示例

Url: /yonbip/mfg/productionorder/linefinishWork?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2559021676106240,
