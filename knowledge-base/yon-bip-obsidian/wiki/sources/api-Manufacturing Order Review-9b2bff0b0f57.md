---
title: "生产订单审核"
apiId: "9b2bff0b0f574a558645217b40300e63"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/mfg/productionorder/audit
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	否	是	生产订单数据集
id	long	否	否	生产订单Id
code	string	否	否	生产订单编码 示例：SCDD20210621000001

## 3. 请求示例

Url: /yonbip/mfg/productionorder/audit?access_token=访问令牌
Body: {
	"data": {
		"id": 0,
