...
>  9. 接口变更日志 | Marketing Activity (CRM)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/crm/rest/v1/openapi/queryBusinessFiles_activity
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
businessIds	string	是	是	业务标识集合 示例：["2060880477380149249"]

## 3. 请求示例

Url: /yonbip/crm/rest/v1/openapi/queryBusinessFiles_activity?access_token=访问令牌
Body: {
	"businessIds": [
		"2060880477380149249"
	]
