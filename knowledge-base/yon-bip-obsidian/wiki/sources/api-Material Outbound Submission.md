---
title: "材料出库提交"
apiId: "cfcc92e6a1324bfcbb3f715e34051f7f"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/scm/materialout/batchsubmit
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 是 | 请求体 |
| id | long | 否 | 是 | 材料出库单主表id 示例：2282796996055296 |

## 3. 请求示例

Url: /yonbip/scm/materialout/batchsubmit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2282796996055296
		...
		"infos": [
			{
				...
				"barCode": "st_materialout|2762748637384960",
				"factoryFiOrg": "2370726716642816",
				"createTime": "2022-05-06 16:13:15",
				"factoryOrg": "2370726716642816",
				"vouchtype": 0,
				"status": 3,
				"isUpdateCost": true
			}
