...
请求地址	/yonbip/SCC/ycpraybill/batchclose
...
| 小数位数:0,最大长度:20 | 否 | 是 | 关闭原因id(原因档案中原因类型为订单关闭) 示例：1934739297702144 |

## 3. 请求示例

Url: /yonbip/SCC/ycpraybill/batchclose?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2373415451939072,
