...
请求地址	/yonbip/digitalModel/managementclass/idempotent/insert
请求方式	POST
...
Url: /yonbip/digitalModel/managementclass/idempotent/insert?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"code": "code",
