...
请求地址	/yonbip/RDC/openapi/devpart/v1/batchSave
请求方式	POST
...
data	object	是	是	请求数据对象(JSON字符串)
...
Url: /yonbip/RDC/openapi/devpart/v1/batchSave?access_token=访问令牌
Body: {
