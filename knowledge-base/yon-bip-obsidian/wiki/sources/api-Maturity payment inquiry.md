...
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Due Payment]
...
> `ContentType	application/json` 请求方式	POST | 分类: Due Payment (ctm)
...
| 格式:yyyy-MM-dd | 否 | 否 | 兑付日期开始 |
| paymentDateEnd | date |
| 格式:yyyy-MM-dd | 否 | 否 | 兑付日期结束 |
...
| billStatus | string | 否 | 否 | 单据状态(8：在兑付 9：已兑付 10：已部分兑付 2：已作废) |
| downloadFile | boolean | 否 | 否 | 下载附件 |

## 3. 请求示例

Url: /yonbip/FCC/api/expirecash/detail?access_token=访问令牌
Body: {
	"id": 0,
	"accentityCode": "",
	"accentityName": "",
	"paymentDateStart": "2026-06-07",
	"paymentDateEnd": "2026-06-07",
	"noteType": "",
	"noteFlag": 0,
	"noteno": "",
	"billTypeName": "",
		...
		"recordList": [
			{
				...
				"outerpaybankaccount": "",
				"payaccsum": 0,
				"cashAccountIdentCode": "",
				"srcBillId": "",
				"pledgebankaccount": "",
				"outerpledgebankaccount": "",
				"bondorisum": 0,
				"cashMarginIdentCode": "",
				...
				"description": "",
				"agentopennote": true,
				"einnerSecurityPayeeRoles": 0,
				"principalAccentity": "",
				"principalPayAccount": "",
				"principalpayaccsum": 0,
				"innerDeductIdentCode": "",
				"innersecurityaccount": "",
				"innersecurityaccsum": 0,
				"innerMarginIdentCode": "",
				"innerreceiveraccount": "",
				"noteSettlementStatus": 0,
				"offsetNoteno": "",
				"offsetamount": 0,
				"billType": "",
				"billbtype": 0,
