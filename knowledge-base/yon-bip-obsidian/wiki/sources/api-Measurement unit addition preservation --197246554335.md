...
请求地址	/yonbip/digitalModel/unit/idempotent/insert
请求方式	POST
...
name	object	否	是	名称
unitGroupCode	string	否	是	计量单位分组编码 示例：code01
precision	number
...
Url: /yonbip/digitalModel/unit/idempotent/insert?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"code": "code",
