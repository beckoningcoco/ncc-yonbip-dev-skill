---
title: "合并订单查询"
apiId: "e2bbbe76da6347be8212abcbb0b5c604"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/sd/dst/tradeorder/mergequery
请求方式	POST
...
codetype	string	否	是	取值范围为”0”,”1”,”2”,指明code所代表的含义,0:id,1:tid,2:cTradeCode
conditions	object	否	否	可选条件,org和cShopID应该至少传一个,其他条件如果没有则不加
code	string	否	是	id或编码

## 3. 请求示例

Url: /yonbip/sd/dst/tradeorder/mergequery?access_token=访问令牌
Body: {
	"partParam": {
		"codetype": "",
		"conditions": {
...
cExcoPrintStatus	string	否	快递单打印状态，枚举值参考：https://www.showdoc.com.cn/265424688438926?page_id=1999778270293645
...
shipping_type	string	否	物流方式，枚举值参考：https://www.showdoc.com.cn/265424688438926?page_id=1999778270293645
