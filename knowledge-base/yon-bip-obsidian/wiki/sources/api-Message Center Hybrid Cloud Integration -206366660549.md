...
请求地址	/yonbip/uspace/messagecenter/mixcloud/router
请求方式	POST
...
Url: /yonbip/uspace/messagecenter/mixcloud/router?access_token=访问令牌
Body: {
	"header": {
		"msgType": "",
		"privateTenantId": "",
...
data	object	否	数据
flag	number
小数位数:0,最大长度:10	否	消息中心成功标识，0:成功，1失败
