---
title: "建筑业项目涉税信息修改（根据税务组织编码+项目编码）"
apiId: "1760138715485175813"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/tax/yonbip-fi-taxbuilding/api/project/update
...
| isCrossRegion | string | 否 | 是 | 是否跨区涉:0-否，1-是（谨慎修改，修改后将清除原有的预缴数据） 示例：0 |

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxbuilding/api/project/update?access_token=访问令牌
Body: [{
	"orgCode": "ceshi",
	"projectCode": "1111",
	"projectName": "项目名称",
...
| message | string | 否 | 具体返回描述 示例：操作成功 |
