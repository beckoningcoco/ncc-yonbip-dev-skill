...
请求地址	/yonbip/digitalModel/unitgroup/idempotent/insert
请求方式	POST
...
Url: /yonbip/digitalModel/unitgroup/idempotent/insert?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"code": "API1",
