...
>  请求方式	POST | Accounts receivable bad debt loss account (TAX)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/tax/other-tax/api/tax-s-rec-loss/batch-save
请求方式	POST
...
Url: /yonbip/tax/other-tax/api/tax-s-rec-loss/batch-save?access_token=访问令牌
Body: {
	"data": [
		{
			"taxBasics": 0,
