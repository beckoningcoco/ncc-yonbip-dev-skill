...
请求地址	/yonbip/digitalModel/customertype/idempotent/insert
...
| code | string | 否 | 是 | 销售渠道编码 示例：20210922_1 |
| name | object | 否 | 是 | 销售渠道名称 |
| stopStatus | boolean | 否 | 是 | 启用停用状态：false启用，true停用 示例：false |
| comment | string | 否 | 否 | 备注 示例：20210922_1 |

## 3. 请求示例

Url: /yonbip/digitalModel/customertype/idempotent/insert?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"code": "20210922_1",
