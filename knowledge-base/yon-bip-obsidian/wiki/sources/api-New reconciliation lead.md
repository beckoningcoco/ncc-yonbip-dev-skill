...
请求地址	/yonbip/tax/output-tax/api/ot-voucher/save
...
| voucherDate | string | 否 | 是 | 凭证日期(yyyy-MM-dd) 示例：2023-09-01 |
...
Url: /yonbip/tax/output-tax/api/ot-voucher/save?access_token=访问令牌
Body: [{
...
| sourceId | string | 否 | 数据来源标识 示例：123 |
