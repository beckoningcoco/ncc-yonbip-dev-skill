...
| settingDate | string | 否 | 是 | 设置日期(YYYY-MM-DD) |
| type | string | 否 | 是 | 名单类型(10:黑名单 20:灰名单 30:白名单) |
| bankdot | string | 否 | 否 | 机构类型为银行网点时，银行网点不能为空(编码) |

## 3. 请求示例

Url: /yonbip/ctm/blacklist/add?access_token=访问令牌
Body: {
	"accentity": "",
	"orgType": "",
	"bank": "",
