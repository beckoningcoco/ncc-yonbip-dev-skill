---
title: "根据企业流水号获取银行回单"
apiId: "b518e4a6b08a495a8431c2e70e193078"
apiPath: "请求方式	GET"
...
>  请求方式	GET | Payment Workbench (ctm)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/fi/electron/detail
请求方式	GET
...
bankid	string	query	否	账户id

## 3. 请求示例

Url: /yonbip/fi/electron/detail?access_token=访问令牌&bankseq=&bankid=
...
1002	数据不存在	按照提示代码解决
999	回单未返回	这里调用银企连接口48T23，需要查看日志看具体错误原因
