...
请求地址	/yonbip/HCC/pmresult/openapi/queryEmployeePmResult
请求方式	GET
ContentType	
应用场景	开放API
事务和幂等性	无
...
Url: /yonbip/HCC/pmresult/openapi/queryEmployeePmResult?access_token=访问令牌&periodCode=&staffids=
...
data	string	否	响应信息
code	number
小数位数:0,最大长度:10	否	接口返回码，200是成功 示例：200
message	string	否	接口返回信息 示例：操作成功
data	object	否	业务数据
status	number
小数位数:0,最大长度:10	否	业务返回码，0是成功，1是失败 示例：0
...
traceId	string	否	traceId 示例：6da632161c9078d9
