---
title: "生产订单行打开"
apiId: "ad213fc1e1874360bd7d9f22f56a2628"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/mfg/productionorder/lineopen
请求方式	POST
...
id	long	否	否	生产订单Id 示例：2211732336611584
code	string	否	否	生产订单编码 示例：MOSQ201911020003
orderProduct	object	否	是	生产订单产品

## 3. 请求示例

Url: /yonbip/mfg/productionorder/lineopen?access_token=访问令牌
Body: {
	"data": {
		"id": 2211732336611584,
...
id	long	否	生产订单id 示例：2301067198714880
orderProduct	object	是	生产订单产品
verifystate	long	否	是否审批流控制: true-是, false-否 示例：2
code	string	否	生产订单编码 示例：SCDD202106140001
