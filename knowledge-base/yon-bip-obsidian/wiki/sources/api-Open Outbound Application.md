...
请求地址	/yonbip/ST/pickingrequisition/open
...
| id | number |
| 小数位数:0,最大长度:19 | 否 | 是 | 出库申请主表 示例：1915883840213504 |

## 3. 请求示例

Url: /yonbip/ST/pickingrequisition/open?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1915883840213504
...
| sucessCount | number |
| 小数位数:0,最大长度:19 | 否 | 打开成功出库申请单据数量 示例：1 |
| failCount | number |
| 小数位数:0,最大长度:19 | 否 | 打开失败出库申请单据数量 示例：0 |
