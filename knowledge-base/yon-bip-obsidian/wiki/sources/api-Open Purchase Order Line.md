...
请求地址	/yonbip/scm/purchaseorder/lineopen
...
Url: /yonbip/scm/purchaseorder/lineopen?access_token=访问令牌
Body: {
	"data": [
		{
...
| data | object | 否 | 订单数据 |
| id | long | 否 | 主表ID 示例：2550425837654272 |
| purchaseOrders | object | 是 | 订单子表 |
| status | long | 否 | 订单单据状态：0：开立、1：已审核、2：已关闭、3：审核中 示例：1 |
| pubts | string | 否 | 时间戳 示例：2023-04-24 15:04:53 |
