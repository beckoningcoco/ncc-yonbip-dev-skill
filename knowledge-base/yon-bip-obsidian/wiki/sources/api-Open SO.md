---
title: "销售订单打开"
apiId: "ded5e327993d44d3906da56b97e07ff7"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/sd/voucherorder/open
...
| lockIn | string | 否 | 是 | 单据锁状态 true或false 示例：false |
| status | long | 否 | 是 | 单据状态, 0:开立、3:审核中、1:已审核、2:已关闭、 示例：2 |
| code | string | 否 | 是 | 单据编码 示例：UO-2256202010140001 |
| id | long | 否 | 是 | 单据主键 示例：1957434474451200 |

## 3. 请求示例

Url: /yonbip/sd/voucherorder/open?access_token=访问令牌
Body: {
	"data": [
		{
			"lockIn": "false",
...
| orderPrices | object | 否 | orderPrices |
