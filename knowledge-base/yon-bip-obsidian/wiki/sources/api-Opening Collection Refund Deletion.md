...
请求地址	/yonbip/EFI/openingreceivementrefundevent/delete
...
Url: /yonbip/EFI/openingreceivementrefundevent/delete?access_token=访问令牌
Body: {
	"data": {
...
| data | object | 否 | 返回数据 |
| id | string | 否 | 期初收款退款表头主键 示例：1513626559312822275 |
