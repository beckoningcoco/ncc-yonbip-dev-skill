...
> `ContentType	application/json` 请求方式	GET | 分类: Opening Payment (EFI)
...
请求地址	/yonbip/EFI/openingpaymenteventnew/detail
...
Url: /yonbip/EFI/openingpaymenteventnew/detail?access_token=访问令牌&id=1572409517496336389
...
| id | string | 否 | 期初付款事务主表id 示例：1835996685555204096 |
