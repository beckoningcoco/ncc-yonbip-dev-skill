...
请求地址	/yonbip/crm/openapi/imi/imiOperatingProfit/save
请求方式	POST
...
小数位数:1,最大长度:20	否	否	营业利润
param	string	否	否	回传参数

## 3. 请求示例

Url: /yonbip/crm/openapi/imi/imiOperatingProfit/save?access_token=访问令牌
Body: {
	"data": [
		{
			"pk_financeorg": "",
