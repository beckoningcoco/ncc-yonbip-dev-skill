...
请求地址	/yonbip/mfg/procedureplan/saveAndDispatch
请求方式	POST
...
deviceId	long	是	否	设备id，设备Id和设备Code同时存在时优先级Id>Code 示例：[1958606807208190]
deviceCode	string	是	否	设备code,设备Id和设备Code同时存在时优先级Id>Code 示例：["D001"]
shiftId	number
小数位数:0,最大长度:19	否	否	班次id，班次Id和班次Code同时存在时优先级Id>Code 示例：2268369694605443097
...
staffId	long	是	否	员工id，员工Id和员工Code同时存在时优先级Id>Code 示例：[1958606807208192]
staffCode	string	是	否	员工code，员工Id和员工Code同时存在时优先级Id>Code 示例：["S001"]
...
Url: /yonbip/mfg/procedureplan/saveAndDispatch?access_token=访问令牌
Body: {
	"data": [
		{
