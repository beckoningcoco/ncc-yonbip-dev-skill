...
请求地址	/yonbip/ACC/aomoperationloglist/delete
请求方式	POST
...
id	string	否	是	运行日志主表主键 示例：1503972572269117443

## 3. 请求示例

Url: /yonbip/ACC/aomoperationloglist/delete?access_token=访问令牌
Body: {
	"data": [
		{
