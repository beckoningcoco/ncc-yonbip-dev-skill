...
请求地址	/yonbip/am/aomoperationcard/uncommit
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	是	是	运行记录参数项
id	string	否	是	运行记录主键 示例：1743102882322317320

## 3. 请求示例

Url: /yonbip/am/aomoperationcard/uncommit?access_token=访问令牌
Body: {
	"data": [
		{
