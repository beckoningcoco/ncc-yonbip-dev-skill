...
请求地址	/yonbip/mfg/taskreport/workshopinspection
请求方式	POST
...
id	long	否	否	工序任务汇报id，与code二者必输其一 示例：2036615013323023
code	string	否	否	工序任务汇报编码，与ID二者必输其一 示例：SFOP20220418002012
mainQualifiedNum	number
小数位数:2,最大长度:10	否	否	合格数量 示例：4
proceTaskReportDetailList	object	是	否	明细信息

## 3. 请求示例

Url: /yonbip/mfg/taskreport/workshopinspection?access_token=访问令牌
Body: {
	"data": {
		"id": 2036615013323023,
...
outConversionRate	long	否	产出-主计量转换率 示例：1
...
prodConversionRate	long	否	生产-主计量转换率 示例：1
...
cardSourceOutProdId	long	否	流转卡来源单据子表ID
processFlowId	long	否	工序流转卡
