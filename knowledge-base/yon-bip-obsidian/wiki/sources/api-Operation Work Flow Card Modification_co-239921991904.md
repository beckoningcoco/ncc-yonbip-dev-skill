...
请求地址	/yonbip/MFC/procflowcard/revise
请求方式	POST
...
id	long	否	否	工序流转卡id，id和code不能同时为空 示例：2681803919200512
code	string	否	否	工序流转卡code，id和code不能同时为空 示例：SFOC20251107000011
processFlowCardPlan	object	是	否	流转卡工序

## 3. 请求示例

Url: /yonbip/MFC/procflowcard/revise?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"id": 2681803919200512,
		"code": "SFOC20251107000011",
		"processFlowCardPlan": [
			{
				"id": 2325311204081232,
				"sn": 10,
