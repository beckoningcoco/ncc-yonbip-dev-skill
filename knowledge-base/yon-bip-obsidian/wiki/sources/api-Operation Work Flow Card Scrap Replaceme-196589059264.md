...
请求地址	/yonbip/mfg/v1.0/procflowcard/rework
请求方式	POST
...
reworkTransTypeId	long	否	否	补卡交易类型id，id和code不能同时为空 示例：2745876185928528
reworkTransTypeCode	string	否	否	补卡交易类型code，id和code不能同时为空 示例：CC02
reworkDate	Date	否	是	补卡日期，格式：YYYY-MM-DD 示例：2022-04-14
reworkInfoList	object	是	是	拆分信息

## 3. 请求示例

Url: /yonbip/mfg/v1.0/procflowcard/rework?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"id": 1601920727453794310,
		"code": "SFOC20220412000004",
		"reworkTransTypeId": 2745876185928528,
		"reworkTransTypeCode": "CC02",
		"reworkDate": "2022-04-14",
		"reworkInfoList": [
			{
				"sn": 10.1,
				"supNum": 5.1,
