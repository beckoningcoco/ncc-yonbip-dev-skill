...
请求地址	/yonbip/mfg/procflowcard/sep
请求方式	POST
...
id	long	否	否	源流转卡ID 示例：1601920727453794310
code	string	否	否	来源流转卡CODE 示例：SFOC20220412000004
sepTransTypeId	long	否	否	拆卡交易类型id，id和code都不填时，取默认流转卡交易类型 示例：2745876185928528
sepTransTypeCode	string	否	否	拆卡交易类型code，id和code都不填时，取默认流转卡交易类型 示例：CC01
sepDate	Date	否	是	拆卡日期，格式：YYYY-MM-DD 示例：2022-04-14
procFlowCardSuspend	object	是	否	拆分信息

## 3. 请求示例

Url: /yonbip/mfg/procflowcard/sep?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"id": 1601920727453794310,
		"code": "SFOC20220412000004",
		"sepTransTypeId": 2745876185928528,
		"sepTransTypeCode": "CC01",
		"sepDate": "2022-04-14",
		"procFlowCardSuspend": [
			{
				"sep": 5
