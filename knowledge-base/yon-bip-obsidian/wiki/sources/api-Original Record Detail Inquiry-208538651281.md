...
请求地址	/yonbip/QMS_QIT/originalrecord/detail
请求方式	POST
...
id	number
小数位数:0,最大长度:20	query	否	原始记录id，code和id任一不为空，都有值取id    示例: 1888589127091748873
code	string	query	否	原始记录单号，code和id任一不为空，都有值取id    示例: JL202312200001

## 3. 请求示例

Url: /yonbip/QMS_QIT/originalrecord/detail?access_token=访问令牌&id=1888589127091748873&code=JL202312200001
