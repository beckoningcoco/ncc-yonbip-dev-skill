...
请求地址	/yonbip/scm/othinrecord/batchunaudit
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 是 | 其他入库单[st.othinrecord.OthInRecord] |
| id | long | 否 | 是 | 主表id 示例：1915883316809984 |

## 3. 请求示例

Url: /yonbip/scm/othinrecord/batchunaudit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1915883316809984
