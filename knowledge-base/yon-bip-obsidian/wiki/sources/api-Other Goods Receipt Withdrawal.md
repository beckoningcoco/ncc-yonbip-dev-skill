...
请求地址	/yonbip/scm/othinrecord/batchunsubmit
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 是 | 请求体 |
| id | long | 否 | 是 | 其他入库单主表id 示例：2282796996055296 |

## 3. 请求示例

Url: /yonbip/scm/othinrecord/batchunsubmit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2282796996055296
