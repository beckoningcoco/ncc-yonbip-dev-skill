...
请求地址	/yonbip/SCC/pickingrequisition/close
...
| id | number |
| 小数位数:0,最大长度:19 | 否 | 是 | 出库申请主表id 示例：1915883840213504 |

## 3. 请求示例

Url: /yonbip/SCC/pickingrequisition/close?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1915883840213504
