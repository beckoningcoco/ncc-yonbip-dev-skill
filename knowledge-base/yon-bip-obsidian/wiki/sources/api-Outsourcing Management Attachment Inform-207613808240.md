...
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Outsourcing Management]
...
>  请求方式	POST | Outsourcing Management (MF)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/mfg/subcontract/queryBusinessFiles
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
businessIds	string	是	否	业务标识集合 示例：["1234","4321"]

## 3. 请求示例

Url: /yonbip/mfg/subcontract/queryBusinessFiles?access_token=访问令牌
Body: {
	"businessIds": [
		"1234",
		"4321"
