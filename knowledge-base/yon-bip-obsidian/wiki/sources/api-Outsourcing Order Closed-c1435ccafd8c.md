---
title: "委外订单关闭"
apiId: "c1435ccafd8c4066b22ad1fd3bc4dfee"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/mfg/subcontractorder/batchclose
请求方式	POST
...
id	long	否	否	委外订单ID，委外订单ID和委外订单编码不能同时为空，ID和编码同时存在，以ID为准 示例：2373415451939072
code	string	否	否	委外订单号
closeReasonId	long	否	否	关闭原因id(原因档案中原因类型为订单关闭) 示例：1934739297702144

## 3. 请求示例

Url: /yonbip/mfg/subcontractorder/batchclose?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2373415451939072,
