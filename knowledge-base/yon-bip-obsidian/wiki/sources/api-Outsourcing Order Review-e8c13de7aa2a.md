---
title: "委外订单审核"
apiId: "e8c13de7aa2a4930b0821974d6e34275"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/mfg/subcontractorder/batchaudit
请求方式	POST
...
id	long	否	否	委外订单ID，委外订单ID和委外订单编码不能同时为空，ID和编码同时存在，以ID为准 示例：1967600514994432
code	string	否	否	委外订单编码 示例：WWDDJT202108040002

## 3. 请求示例

Url: /yonbip/mfg/subcontractorder/batchaudit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1967600514994432,
