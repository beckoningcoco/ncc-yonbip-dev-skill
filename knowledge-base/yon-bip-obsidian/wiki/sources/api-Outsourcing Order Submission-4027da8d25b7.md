---
title: "委外订单提交"
apiId: "4027da8d25b74af49808ed57bc41ac06"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/mfg/subcontractorder/batchsubmit
请求方式	POST
...
code	string	否	否	委外订单编码，委外订单ID和委外订单编码不能同时为空，ID和编码同时存在，以ID为准 示例：WWDDJT202108040003

## 3. 请求示例

Url: /yonbip/mfg/subcontractorder/batchsubmit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2373477794877696,
			"code": "WWDDJT202108040003"
		}
	]
}
