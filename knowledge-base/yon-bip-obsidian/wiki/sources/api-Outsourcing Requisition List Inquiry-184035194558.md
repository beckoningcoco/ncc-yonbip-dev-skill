...
请求地址	/yonbip/am/rmmhoursfilllist/delete
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	是	是	工时填报请求体
id	string	否	是	工时填报id 示例：1523350193427709953

## 3. 请求示例

Url: /yonbip/am/rmmhoursfilllist/delete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "1523350193427709953"
		}
	]
}
