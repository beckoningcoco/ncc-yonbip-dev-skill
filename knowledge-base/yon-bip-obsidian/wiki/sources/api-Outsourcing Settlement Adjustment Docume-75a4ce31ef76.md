---
title: "委外核销调整单审核"
apiId: "75a4ce31ef764536ace055cfa5a9f471"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/mfg/verificationadjust/batchaudit
请求方式	POST
...
code	string	否	否	核销调整单编码。核销调整单id和核销调整单编码不能同时为空，id和编码同时存在，以id为准 示例：HXTZ202103260019

## 3. 请求示例

Url: /yonbip/mfg/verificationadjust/batchaudit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1967600514994432,
			"code": "HXTZ202103260019"
		}
	]
}
...
messages	string	是	操作失败提示信息 示例：["已审核的数据不允许重复审核"]
