---
title: "委外核销单审核"
apiId: "2776276e6ebc459aa9cd07d7c17a3a2d"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/mfg/verification/batchaudit
请求方式	POST
...
id	long	否	否	委外核销单ID，委外核销单ID和委外核销单编码不能同时为空，ID和编码同时存在，以ID为准 示例：1967600514994432
code	string	否	否	委外核销单编码 示例：WWDDJT202108040002

## 3. 请求示例

Url: /yonbip/mfg/verification/batchaudit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1967600514994432,
