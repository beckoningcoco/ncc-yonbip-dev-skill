...
请求地址	/yonbip/ACC/aumdeployout/uncommit
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	是	否	所有权调出参数
id	string	否	是	所有权调出主键

## 3. 请求示例

Url: /yonbip/ACC/aumdeployout/uncommit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": ""
