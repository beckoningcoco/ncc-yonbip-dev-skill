...
>  请求方式	GET | PLM Modeling Service (PLMMP)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/sjzt/semantic/v1/list
请求方式	GET
...
Url: /yonbip/sjzt/semantic/v1/list?access_token=访问令牌&domain=HR&appCode=HROTD
