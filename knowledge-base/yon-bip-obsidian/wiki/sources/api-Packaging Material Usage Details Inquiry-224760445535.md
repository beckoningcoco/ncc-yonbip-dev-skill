---
title: "包材使用明细查询"
apiId: "2247604455357808640"
apiPath: "请求方式	POST"
method: "ContentType	application/json"
category: "Express Packaging Material Details"
domain: "B2C"
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Express Packaging Material Details]
...
>  请求方式	POST | Express Packaging Material Details (B2C)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/sd/dst/packInventory/packageMaterialInventory
请求方式	POST
...
warehouseId	string	否	否	仓库id,多个仓库使用英文逗号分割 示例：121,122
expressId	string	否	否	物流网点id,多个网点使用英文逗号分割 示例：121,122
materialcode	string	否	否	包材编码 示例：pk1
groupSchemaId	string	否	否	分组id,从包材使用明细报表查询 示例：123213

## 3. 请求示例

Url: /yonbip/sd/dst/packInventory/packageMaterialInventory?access_token=访问令牌
Body: {
	"partParam": {
		"pageIndex": 1,
		"pageSize": 10,
