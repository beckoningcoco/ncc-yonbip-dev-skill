---
title: "伙伴黑白灰名单适用业务删除接口"
apiId: "2004371901892788228"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/ctm/partnerlist/batch/delete
...
| details | object | 是 | 是 | 名单明细 |

## 3. 请求示例

Url: /yonbip/ctm/partnerlist/batch/delete?access_token=访问令牌
Body: {
	"params": [
		{
			"entityCode": "",
