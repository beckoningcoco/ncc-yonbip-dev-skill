...
请求地址	/yonbip/EFI/paymentApply/submit
...
Url: /yonbip/EFI/paymentApply/submit?access_token=访问令牌
Body: {
	"data": {
...
| data | object | 否 | 返回数据 |
| id | string | 否 | 付款申请单表头主键 示例：1483387421116596230 |
