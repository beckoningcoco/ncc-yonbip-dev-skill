---
title: "付款起算批量删除结果查询-新集成"
apiId: "2217499139787718656"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Payment Start Date (MD)
...
请求地址	/yonbip/digitalModel/basedoc/async/paystartbase/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/basedoc/async/paystartbase/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
