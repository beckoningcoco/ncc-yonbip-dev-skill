---
title: "收款起算详情分页查询-新集成"
apiId: "2201582325988327431"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/basedoc/receivestartbase/batchQueryDetail
...
| code | string | 否 | 否 | 编码 示例：basestart |
| name | string | 否 | 否 | 名称 示例：收款起算 |

## 3. 请求示例

Url: /yonbip/digitalModel/basedoc/receivestartbase/batchQueryDetail?access_token=访问令牌
Body: {
	"pageIndex": 1,
	"pageSize": 50,
