...
请求地址	/yonbip/EFI/paymentApply/audit
...
Url: /yonbip/EFI/paymentApply/audit?access_token=访问令牌
Body: {
	"data": {
...
| data | object | 否 | 返回数据 |
| id | string | 否 | 付款申请单表头id 示例：1574553410539094020 |
