...
请求地址	/yonbip/EFI/payment/delete
...
Url: /yonbip/EFI/payment/delete?access_token=访问令牌
Body: {
	"data": {
...
| data | object | 否 | 返回数据 |
| id | string | 否 | 付款单表头主键 示例：1573868724015857670 |
