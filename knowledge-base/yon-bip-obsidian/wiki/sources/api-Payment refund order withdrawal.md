...
请求地址	/yonbip/EFI/apRefund/unsubmit
...
Url: /yonbip/EFI/apRefund/unsubmit?access_token=访问令牌
Body: {
	"data": {
...
| data | object | 否 | 返回数据 |
| id | string | 否 | 付款退款单表头主键 示例：1483387421116596230 |
...
999	当前单据未提交, 不允许撤回!	输入有效且未撤回的单据id
