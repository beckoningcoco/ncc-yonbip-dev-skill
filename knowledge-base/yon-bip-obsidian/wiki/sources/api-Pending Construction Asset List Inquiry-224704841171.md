...
请求地址	/yonbip/am/precreatecard/batchquery
请求方式	POST
...
page	object	否	否	分页
pageIndex	number
小数位数:0,最大长度:10	否	否	页码，默认为1 示例：1 默认值：1
pageSize	number
小数位数:0,最大长度:10	否	否	每页条数，默认为10 示例：10 默认值：10
condition	object	否	否	查询条件
simpleVOs	object	是	否	扩展查询条件

## 3. 请求示例

Url: /yonbip/am/precreatecard/batchquery?access_token=访问令牌
Body: {
	"page": {
		"pageIndex": 1,
		"pageSize": 10
...

{
	...
	"data": {
		...
		"recordList": [
			{
				"pk_org_name": "hxxzuzhi",
				"bill_code": "test0001",
				"pk_org_code": "11",
				"pull_flag": 0,
				"measure_instrument": 0,
				"special_flag": 0,
				"origin_system_bill_type": "测试",
				"creationtime": "2024-12-02 10:14:54",
				"id": "2146673557207253001",
				"origin_system": "测试",
				"fa_flag": 0,
				"serial_num": "2222222",
				"pk_material_code": "217921908012",
				"pk_material_name": "测试物料",
				"pk_material": "2221321",
				"pk_org": "232124214",
				"pk_icorg": "213123213123111",
				"spec": "DSSA2131",
				"model": "modd-001",
				"transi_type": "4A01-01"
			}
