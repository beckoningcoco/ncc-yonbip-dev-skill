---
title: "绩效型预防性维护详情查询"
apiId: "2346295021336002565"
apiPath: "请求方式	POST"
method: "ContentType	application/json"
category: "Performance-based Preventive Maintenance"
domain: "MRO"
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Performance-based Preventive Maintenance]
...
>  请求方式	POST | Performance-based Preventive Maintenance (MRO)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/ACC/pvmpmresultcard/detail
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
id	string	否	否	ID 示例：2336121772810174464
code	string	否	否	预防性维护编码 示例：JXPM202508140001

## 3. 请求示例

Url: /yonbip/ACC/pvmpmresultcard/detail?access_token=访问令牌
Body: {
	"id": "2336121772810174464",
	"code": "JXPM202508140001"
}
...
bill_code	string	否	预防性维护编码 示例：JXPM202508140001
...
pubts	string	否	时间戳 示例：2025-08-14 16:32:49
billmaketime	string	否	制单时间 示例：2025-08-14 16:32:48
...
wo_pk_transitype	string	否	下游单据交易类型ID 示例：2086855417276137578
pk_priority__cbgColor	string	否	背景颜色 示例：#2992FF
wo_mode	number
小数位数:0,最大长度:10	否	工作模式 示例：0
transi_type	string	否	交易类型编码 示例：4B74-01
