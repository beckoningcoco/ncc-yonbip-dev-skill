---
title: "个人借款单审核"
apiId: "80389defac624b0bb76e0e199dda8c25"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/znbz/rbsm/api/bill/loanbill/audit
...
Url: /yonbip/znbz/rbsm/api/bill/loanbill/audit?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"id": 2365029317071104
...
| id | long | 否 | 单据id 示例：2499455696638720 |
...
| auditTime | string | 否 | 审批时间 示例：2021-11-01 16:18:28 |
| auditDate | string | 否 | 审批日期 示例：2021-11-01 00:00:00 |
| status | long | 否 | 单据状态(0:待提交;1:审批完成;2:已关闭;3:审批中) 示例：1 |
| loansettleinfovos | object | 是 | 个人借款单结算信息 |
| pubts | string | 否 | 时间戳 示例：2021-11-01 16:18:30 |
...

{
	...
	"message": "操作成功",
	"data": {
		"resubmitCheckKey": "OPENAPI_80389defac624b0bb76e0e199dda8c25_xtikzjvp_1",
		"id": 2499455696638720,
		"verifystate": 2,
		"auditor": "YonSuite默认用户",
		"auditorId": 1951632934146304,
		"auditTime": "2021-11-01 16:18:28",
		"auditDate": "2021-11-01 00:00:00",
		"status": 1,
		"loansettleinfovos": [
			{
				"vbankaccname": "黄东发",
				"pk_loanbill": 2499455696638720,
				...
				"dnatexchratedate": "2021-11-01 00:00:00",
