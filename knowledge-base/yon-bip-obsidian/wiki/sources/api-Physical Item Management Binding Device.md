...
请求地址	/yonbip/ssc/pdm/postbox/binddevice
...
Url: /yonbip/ssc/pdm/postbox/binddevice?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
...
| managerName | string | 否 | 管理员名称：根据手机号查到的用户名称 示例：用小友 |
...
036-507-020005	操作失败，该设备已被绑定	该设备已被绑定

036-507-020007	操作失败，管理员信息查询失败	根据管理员手机号未查询到当前租户下的用户信息
...
036-507-020017	操作失败，设备编号超出最大允许长度（200）	设备编号超长，限200个字符
