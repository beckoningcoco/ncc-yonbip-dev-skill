...
请求地址	/yonbip/sd/dst/batchpicklot/batchpicklotUpdate
请求方式	POST
...
dataList	object	是	是	更新数据

## 3. 请求示例

Url: /yonbip/sd/dst/batchpicklot/batchpicklotUpdate?access_token=访问令牌
Body: {
	"partParam": {
		"dataList": [
			{
				...
				"pickStatus": "",
				"pickPerson": "",
				"pickTimeStart": "2026-06-07 13:10:37",
				"pickTimeEnd": "2026-06-07 13:10:37"
			}
		]
	}
}
