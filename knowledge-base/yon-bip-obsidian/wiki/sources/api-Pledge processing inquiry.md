...
请求地址	/yonbip/FCC/api/impawn/detail
...
| impawnDateStart | date |
| 格式:yyyy-MM-dd | 否 | 否 | 质押日期开始 |
| impawnDateEnd | date |
| 格式:yyyy-MM-dd | 否 | 否 | 质押日期结束 |
...
| billStatus | string | 否 | 否 | 单据状态（15:在质押 16:已质押 2:已作废） |
| downloadFile | boolean | 否 | 否 | 下载附件 |

## 3. 请求示例

Url: /yonbip/FCC/api/impawn/detail?access_token=访问令牌
Body: {
	"id": 0,
	"accentityCode": "",
	"accentityName": "",
	"impawnDateStart": "2026-06-07",
	"impawnDateEnd": "2026-06-07",
	"noteType": "",
	"noteFlag": 0,
	"noteno": "",
	"billRange": "",
