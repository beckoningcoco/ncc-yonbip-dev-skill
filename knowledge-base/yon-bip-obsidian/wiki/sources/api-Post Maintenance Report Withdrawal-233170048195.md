...
请求地址	/yonbip/ACC/workorderafcard/uncommit
请求方式	POST
...
id	string	否	是	事后汇报主键ID 示例：2331042870907109380

## 3. 请求示例

Url: /yonbip/ACC/workorderafcard/uncommit?access_token=访问令牌
Body: {
	"data": [
		{
