---
title: "预缴计算表（建筑业适用）-不征税发票核销"
apiId: "2303436166320357378"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/tax/yonbip-fi-taxbuilding/api/prepayment/to-write-off
请求方式	POST
...
presentWriteOffAmount	number
小数位数:2,最大长度:15	否	是	不征税本次核销金额 示例：100

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxbuilding/api/prepayment/to-write-off?access_token=访问令牌
Body: {
