---
title: "故障原因保存"
apiId: "2369550577026203648"
apiPath: "请求方式	POST"
method: "ContentType	application/json"
category: "Basic Asset File"
domain: "APS"
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Basic Asset File]
...
>  请求方式	POST | Basic Asset File (APS)
...
请求地址	/yonbip/ACC/ampubfailurereasonlist/save
请求方式	POST
...
名称	类型	数组	必填	描述
data	object	是	否	数据
pk_org	string	否	是	业务单元 示例：1957640999752695828
code	string	否	是	编码 示例：test
name	object	否	是	名称
memo	string	否	否	备注
enablestate	number
小数位数:0,最大长度:10	否	是	启用状态（启用状态 1-未启用 2-已启用 3-已停用） 默认值：2

## 3. 请求示例

Url: /yonbip/ACC/ampubfailurereasonlist/save?access_token=访问令牌
Body: {
	"data": [
		{
			"pk_org": "1957640999752695828",
			"code": "test",
			"name": {
				"zh_TW": "",
				"en_US": "",
...
_entityName	string	否	实体名称 示例：ampub.reason.ReasonVO
...

{
	...
	"data": {
		...
		"_entityName": "ampub.reason.ReasonVO",
