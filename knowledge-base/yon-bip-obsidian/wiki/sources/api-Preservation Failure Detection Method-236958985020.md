---
title: "故障发现途径保存"
apiId: "2369589850207158279"
apiPath: "请求方式	POST"
method: "ContentType	application/json"
category: "Failure Detection Method"
domain: "APS"
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Failure Detection Method]
...
>  请求方式	POST | Failure Detection Method (APS)
...
请求地址	/yonbip/ACC/ampubfailuredetectlist/save
请求方式	POST
...
memo	string	否	否	备注
enablestate	number
小数位数:0,最大长度:10	否	否	启用状态（启用状态 1-未启用 2-已启用 3-已停用） 默认值：2

## 3. 请求示例

Url: /yonbip/ACC/ampubfailuredetectlist/save?access_token=访问令牌
Body: {
	"data": [
		{
			"code": "test",
...
_entityName	string	否	实体名称 示例：ampub.failuredetect.FailureDetectVO
...

{
	...
	"data": {
		...
		"_entityName": "ampub.failuredetect.FailureDetectVO",
		"code": "TEST3",
		"name": {
			"zh_CN": "测试",
			"en_US": "",
