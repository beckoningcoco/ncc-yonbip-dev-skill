...
>  请求方式	POST | Failure Symptoms (APS)
...
请求地址	/yonbip/ACC/ampubfailuresymptomlist/save
请求方式	POST
...
Url: /yonbip/ACC/ampubfailuresymptomlist/save?access_token=访问令牌
Body: {
	"data": [
		{
