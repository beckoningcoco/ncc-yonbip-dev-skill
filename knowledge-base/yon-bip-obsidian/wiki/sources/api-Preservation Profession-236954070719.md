...
请求地址	/yonbip/ACC/ampubcraftlist/save
请求方式	POST
...
Url: /yonbip/ACC/ampubcraftlist/save?access_token=访问令牌
Body: {
	"data": [
		{
			"pk_org": "cc",
...
_entityName	string	否	实体名称 示例：ampub.craft.CraftVO
...

{
	...
	"data": {
		...
		"_entityName": "ampub.craft.CraftVO",
