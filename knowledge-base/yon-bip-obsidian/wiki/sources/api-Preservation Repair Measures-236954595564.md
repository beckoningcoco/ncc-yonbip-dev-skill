---
title: "维修措施保存"
apiId: "2369545955641393155"
apiPath: "请求方式	POST"
method: "ContentType	application/json"
category: "Repair Measures"
domain: "APS"
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Repair Measures]
...
请求地址	/yonbip/ACC/ampubfailuremeasureslist/save
请求方式	POST
...
名称	类型	数组	必填	描述
data	object	是	否	数据
pk_org	string	否	是	业务单元id或编码 示例：cc
...
Url: /yonbip/ACC/ampubfailuremeasureslist/save?access_token=访问令牌
Body: {
	"data": [
		{
			"pk_org": "cc",
...
_entityName	string	否	实体名称 示例：ampub.failuremeasures.FailureMeasuresVO
...

{
	...
	"data": {
		...
		"_entityName": "ampub.failuremeasures.FailureMeasuresVO",
