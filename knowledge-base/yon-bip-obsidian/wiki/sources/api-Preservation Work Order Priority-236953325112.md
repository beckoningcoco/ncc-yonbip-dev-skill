---
title: "工单优先级保存"
apiId: "2369533251128131592"
apiPath: "请求方式	POST"
method: "ContentType	application/json"
category: "Work Order Priority"
domain: "APS"
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Work Order Priority]
...
>  请求方式	POST | Work Order Priority (APS)
...
请求地址	/yonbip/ACC/ampubwoprioritylist/save
请求方式	POST
...
名称	类型	数组	必填	描述
data	object	是	否	数据
code	string	否	是	编码 示例：test
name	object	否	是	名称
memo	string	否	否	备注
cbgColor	string	否	否	背景颜色 示例：#146cc2
cfgColor	string	否	否	字体颜色 示例：#971fb1

## 3. 请求示例

Url: /yonbip/ACC/ampubwoprioritylist/save?access_token=访问令牌
Body: {
	"data": [
		{
			"code": "test",
...
_entityName	string	否	实体名称 示例：ampub.wopriority.Wopriority
code	string	否	编码 示例：TEST3
name	object	否	名称
memo	string	否	备注 示例：备注
enablestate	number
小数位数:0,最大长度:10	否	启用状态（启用状态 1-未启用 2-已启用 3-已停用） 示例：2
cbgColor	string	否	背景颜色 示例：#146cc2
cfgColor	string	否	字体颜色 示例：#971fb1
...

{
	...
	"data": {
		...
		"_entityName": "ampub.wopriority.Wopriority",
		"code": "TEST3",
		"name": {
			"zh_CN": "测试",
			"en_US": "",
