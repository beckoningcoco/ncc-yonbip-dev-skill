---
title: "工序流转卡拆卡（指定序、中间序到底）"
apiId: "1965889183898140678"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/mfg/v1.0/procflowcard/centerAndChooseSep
请求方式	POST
...
id	long	否	否	来源流转卡id 示例：1601920727453794310
code	string	否	否	来源流转卡code 示例：SFOC20220412000004
cenAndChoTransTypeId	long	否	否	拆卡交易类型id，id和code都不填时，取默认流转卡交易类型 示例：2745876185928528
cenAndChoTransTypeCode	string	否	否	拆卡交易类型code，id和code都不填时，取默认流转卡交易类型 示例：CC01
cenAndChoDate	Date	否	是	拆卡日期，格式：YYYY-MM-DD 示例：2022-04-14
splitType	number
小数位数:0,最大长度:1	否	是	拆卡类型，1为中间序到底拆卡（拆分信息的‘工序顺序号’、‘拆分数量’必填），2为指定序拆卡（除‘指定工序至’，其他必填） 示例：1
cenAndChoInfoList	object	是	是	拆分信息

## 3. 请求示例

Url: /yonbip/mfg/v1.0/procflowcard/centerAndChooseSep?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"id": 1601920727453794310,
		"code": "SFOC20220412000004",
		"cenAndChoTransTypeId": 2745876185928528,
		"cenAndChoTransTypeCode": "CC01",
		"cenAndChoDate": "2022-04-14",
		"splitType": 1,
		"cenAndChoInfoList": [
			{
				"sn": 10,
