...
请求地址	/yonbip/imcs/treatmethod/list
请求方式	POST
...
type	string	否	否	类型 示例：01合格，02挑选，03改判，04拒收，05让步接收，06报废，07返工，08返修，09退货

## 3. 请求示例

Url: /yonbip/imcs/treatmethod/list?access_token=访问令牌
Body: {
	"pageIndex": 1,
	"pageSize": 10,
	"name": "9023024034",
			...
			"recordList": [
				{
					...
					"id": "2707446336983552",
					"modifierId": 1504011785325248515,
					"modifier": "张宏明test1",
					"modifyTime": "2022-07-27 15:13:47"
				}
			],
			"pageCount": 0,
			"beginPageIndex": 1,
