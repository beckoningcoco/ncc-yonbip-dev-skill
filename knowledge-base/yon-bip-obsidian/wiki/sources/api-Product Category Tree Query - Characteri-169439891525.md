...
请求地址	/yonbip/digitalModel/presentationclass/newtree
请求方式	POST
...
beganTime	DateTime	否	否	开始时间戳，包含 示例：2023-04-18 18:40
endTime	DateTime	否	否	结束时间戳，不包含 示例：2023-04-18 18:50

## 3. 请求示例

Url: /yonbip/digitalModel/presentationclass/newtree?access_token=访问令牌
Body: {
	"pageIndex": 1,
	"pageSize": 100,
	"name": "名称",
	"code": "code",
	"beganTime": "2023-04-18 18:40",
	"endTime": "2023-04-18 18:50"
}
...
name	object	否	名称
parent	long	否	上级分类id 示例：156624945
parentCode	string	否	上级分类编码 示例：code01
template	long	否	物料模板id 示例：16234649
templateName	string	否	物料模板名称 示例：物料模板
manageClass	long	否	物料分类id 示例：1664823264
manageClassCode	string	否	物料分类编码 示例：code03
...
adImage	string	否	广告图片 示例：www.aa96434.com
image	string	否	分类图片 示例：www.bb994634.com
	...
	"data": [
		{
			...
			"template": 16234649,
			"templateName": "物料模板",
			"manageClass": 1664823264,
			"manageClassCode": "code03",
			"order": 1,
			"stopStatus": true,
			"isRecommend": true,
			"isURecommend": true,
			...
			"adImage": "www.aa96434.com",
			"image": "www.bb994634.com"
		}
	]
}
