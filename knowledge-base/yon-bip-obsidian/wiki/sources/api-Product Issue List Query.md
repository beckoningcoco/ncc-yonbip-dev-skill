---
title: "销售出库列表查询"
apiId: "05a2a46b90984a8ba115d6a2061f8720"
apiPath: "请求方式	POST"
...
| recordCount | long | 否 | 总记录数 示例：26 |
| recordList | object | 是 | 返回数据列表 |
| sumRecordList | object | 是 | 合计信息 |
| pageCount | long | 否 | 总页数 示例：3 |
| beginPageIndex | long | 否 | 开始页页号 示例：1 |
| endPageIndex | long | 否 | 最终页页号 示例：3 |
| pubts | string | 否 | 时间戳 示例：2021-06-02 16:37:29 |
