...
请求地址	/yonbip/scm/salesout/batchsubmit
...
| data | object | 是 | 是 | 请求体 |
| id | number |
| 小数位数:0,最大长度:30 | 否 | 是 | 销售出库单主表id 示例：22827969960554455 |

## 3. 请求示例

Url: /yonbip/scm/salesout/batchsubmit?access_token=访问令牌
Body: {
	"data": [
		{
