---
title: "产品线启用"
apiId: "311b4d311cd04489a2f44f67725e7705"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/productline/unstop
...
| id | long | 否 | 否 | id，产品线编码与产品线id必输其一 示例：1971453504884992 |
| code | string | 否 | 否 | 产品线编码与产品线id必输其一 示例：code |

## 3. 请求示例

Url: /yonbip/digitalModel/productline/unstop?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1971453504884992,
...
| pubts | string | 否 | 时间戳 示例：2020-10-24 16:32:30 |
