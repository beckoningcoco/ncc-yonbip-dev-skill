...
请求地址	/yonbip/scm/storeprorecord/batchunaudit
...
| pubts | string | 否 | 否 | 时间戳字符串（需填写单据的pubts,填写后启用并发控制） 示例：2020-09-15 17:18:44 |

## 3. 请求示例

Url: /yonbip/scm/storeprorecord/batchunaudit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1915883316809984,
			"pubts": "2020-09-15 17:18:44"
		}
	]
}
