...
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Production Order]
...
>  请求方式	POST | Production Order (MF)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/mfg/productionorder/queryBusinessFiles
请求方式	POST
...
Url: /yonbip/mfg/productionorder/queryBusinessFiles?access_token=访问令牌
Body: {
	"businessIds": [
		"123",
		"321"
