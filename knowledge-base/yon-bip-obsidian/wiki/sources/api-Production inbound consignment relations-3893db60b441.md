---
title: "生产入库委托关系停用"
apiId: "3893db60b441472eb668307ac24df971"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/productstorageDelegate/stop
请求方式	POST
...
id	string	否	是	委托关系id 示例：2342204613071104

## 3. 请求示例

Url: /yonbip/digitalModel/productstorageDelegate/stop?access_token=访问令牌
Body: {
	"data": {
		"id": "2342204613071104"
	}
