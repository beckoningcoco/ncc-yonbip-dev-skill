...
请求地址	/yonbip/FCC/ecc/resourceDeclaration/saveProduct
...
| productionOrderCode | string | 否 | 是 | 生产订单编码 |
| orderRowNo | string | 否 | 是 | 生产订单行编码 |
| opSn | string | 否 | 否 | 业务工序顺序号 |
| items | object | 是 | 是 | 手工资源申报明细 |

## 3. 请求示例

Url: /yonbip/FCC/ecc/resourceDeclaration/saveProduct?access_token=访问令牌
Body: {
	"data": [
		{
			"resubmitCheckKey": "",
