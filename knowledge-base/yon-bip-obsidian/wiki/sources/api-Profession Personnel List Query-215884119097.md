---
title: "工种人员列表查询"
apiId: "2158841190973702150"
apiPath: "请求方式	POST"
method: "ContentType	application/json"
category: "Personnel of a Profession"
domain: "APS"
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Personnel of a Profession]
...
>  请求方式	POST | Personnel of a Profession (APS)


## 1. 通过OpenAPI查询按工种维护人员列表；

2. 支持的查询条件及操作符：工种编码、工种名称、人员编码、人员名称（支持比较符：等于、模糊匹配），工种id、人员id（支持批量，用逗号隔开）
3.扩展参数maintain_status为1时查询按工种维护人员列表（查询条件可选择工种编码或工种名称），maintain_status为0时查询按人员维护工种列表（查询条件可选择人员编码或人员名称）。

## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/am/ampubcraftassociationcraftlist/batchquery
请求方式	POST
...
pageSize	number
小数位数:0,最大长度:5	否	是	每页条数，不允许超过最大阈值（默认99999） 示例：2 默认值：20
condition	object	否	否	查询条件
simpleVOs	object	是	否	扩展查询条件

## 3. 请求示例

Url: /yonbip/am/ampubcraftassociationcraftlist/batchquery?access_token=访问令牌
Body: {
	"page": {
		"pageIndex": 1,
		"pageSize": 2
