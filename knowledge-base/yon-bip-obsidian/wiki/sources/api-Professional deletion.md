...
请求地址	/yonbip/am/specialty/delete
...
| special_code | string | 否 | 否 | 专业编码 示例：ZY-0002 |
| pk_org | string | 否 | 否 | 组织ID 示例：187782726178289 |

## 3. 请求示例

Url: /yonbip/am/specialty/delete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "1476611216843472896",
			"special_code": "ZY-0002",
			"pk_org": "187782726178289"
		}
	]
}
