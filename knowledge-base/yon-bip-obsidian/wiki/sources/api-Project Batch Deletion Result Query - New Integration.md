---
title: "项目批量删除结果查询-新集成"
apiId: "2219533674391535619"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Project (MD)
...
请求地址	/yonbip/digitalModel/basedoc/async/project/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/basedoc/async/project/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
