---
title: "项目类别批量删除结果查询-新集成"
apiId: "2219532265642262532"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Project Category (MD)
...
请求地址	/yonbip/digitalModel/basedoc/async/projectClass/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/basedoc/async/projectClass/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
