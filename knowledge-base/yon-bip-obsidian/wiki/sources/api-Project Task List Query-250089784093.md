...
请求地址	/yonbip/RDC/rdpmOpenapi/project/v1/detail
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
id	string	否	是	ID 示例：2432428039251951616

## 3. 请求示例

Url: /yonbip/RDC/rdpmOpenapi/project/v1/detail?access_token=访问令牌
Body: {
