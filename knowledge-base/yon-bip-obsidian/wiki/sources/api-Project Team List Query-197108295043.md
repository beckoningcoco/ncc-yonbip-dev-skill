...
请求地址	/yonbip/hrcloud/projectorgs/bill/list
请求方式	POST
...
code,name	string	否	否	编码/名称 示例：00001
externalData	object	否	否	参数
timelineDate	date
格式:yyyy-MM-dd	否	否	业务日期,时间轴必填 示例：2024-04-19
pubts	string	否	否	时间戳 示例：2020-11-23 16:11:09
parentid	string	否	否	上级组织 示例：1961382981440372743

## 3. 请求示例

Url: /yonbip/hrcloud/projectorgs/bill/list?access_token=访问令牌
Body: {
	"pageIndex": 1,
	"pageSize": 10,
	"code,name": "00001",
	"externalData": {
		"timelineDate": "2024-04-19"
	},
	"pubts": "2020-11-23 16:11:09",
	"parentid": "1961382981440372743"
}
