...
请求地址	/yonbip/tax/yonbip-fi-taxgateway/yonbip-fi-taxspec/api/tax-rd-time/delete
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| ids | string | 是 | 是 | 主键id集合 示例：["111"] |

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxgateway/yonbip-fi-taxspec/api/tax-rd-time/delete?access_token=访问令牌
Body: {
	"ids": [
		"111"
	]
