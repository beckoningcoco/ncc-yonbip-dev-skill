...
请求地址	/yonbip/FCC/ecc/resourceDeclaration/saveProject
请求方式	POST
...
project	string	否	是	项目id
wbsDoc	string	否	是	WBS ID
...
Url: /yonbip/FCC/ecc/resourceDeclaration/saveProject?access_token=访问令牌
Body: {
	"data": [
		{
			"resubmitCheckKey": "",
