...
请求地址	/yonbip/ctm/fm/common/openapi/submit
...
| notSupportBpm | boolean | 否 | 否 | 强制不启用审批流 示例：false 默认值：false |

## 3. 请求示例

Url: /yonbip/ctm/fm/common/openapi/submit?access_token=访问令牌
Body: {
