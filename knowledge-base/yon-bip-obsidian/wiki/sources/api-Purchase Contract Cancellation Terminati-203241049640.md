...
请求地址	/yonbip/cpu/contract/reservetermination
请求方式	POST
...
orgId	string	否	否	采购组织ID和采购合同编码code一起使用 示例：1872976250894024714
code	string	否	否	采购合同编码 示例：CGHT20200202001

## 3. 请求示例

Url: /yonbip/cpu/contract/reservetermination?access_token=访问令牌
Body: {
	"data": {
		"0": "单",
		"1": "据",
