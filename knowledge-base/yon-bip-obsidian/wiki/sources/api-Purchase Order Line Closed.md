...
请求地址	/yonbip/scm/purchaseorder/lineclose
...
| purchaseOrders | object | 是 | 是 | 订单子表数据 |

## 3. 请求示例

Url: /yonbip/scm/purchaseorder/lineclose?access_token=访问令牌
Body: {
	"data": [
		{
...
| status | long | 否 | 订单单据状态：0：开立、1：已审核、2：已关闭、3：审核中 示例：2 |
| purchaseOrders | object | 是 | 订单子表 |
| pubts | string | 否 | 时间戳 示例：2023-04-24 14:03:31 |
		...
		"purchaseOrders": [
			{
				...
				"linecloser": "默认用户",
				"linecloseTime": "2023-04-24 14:03:31"
			}
		],
		"pubts": "2023-04-24 14:03:31"
	}
}
