---
title: "采购订单提交"
apiId: "aae9184be73440e6b9c824292c52541b"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/scm/purchaseorder/batchsubmit
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 是 | 请求体 |
| id | long | 否 | 是 | 采购订单主表id 示例：2282796996055296 |

## 3. 请求示例

Url: /yonbip/scm/purchaseorder/batchsubmit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2282796996055296
...
| messages | string | 是 | 返回信息 示例：["提交成功"] |
