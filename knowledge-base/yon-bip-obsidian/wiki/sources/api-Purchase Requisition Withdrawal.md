---
title: "请购单撤回"
apiId: "64d799e782d640d0a8aa04c7087968da"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/scm/api/upu/batchunsubmit
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 是 | 请求体 |
| id | long | 否 | 是 | 请购单id 示例：2267032477487616 |

## 3. 请求示例

Url: /yonbip/scm/api/upu/batchunsubmit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2267032477487616
