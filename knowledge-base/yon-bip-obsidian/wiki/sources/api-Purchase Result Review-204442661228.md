---
title: "采购合同取消终止同步高级版"
apiId: "2044426612284850177"
apiPath: "请求方式	POST"
method: "ContentType	application/json"
category: "Purchase Result"
domain: "STC"
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Purchase Result]
...
>  请求方式	POST | Purchase Result (STC)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/cpu/cancelTerminate
请求方式	POST
...
modifiedtime	date
格式:yyyy-MM-dd HH:mm:ss	否	否	修改时间ed
creator	string	否	否	创建人
createTime	number
小数位数:2,最大长度:64	否	否	创建时间
...
quotaSupplyMny	number
小数位数:10,最大长度:64	否	否	供应商首次报价总金额
quotaSupplys	number
小数位数:2,最大长度:64	否	否	供应商报价家数
ERPProjectId	string	否	否	Erp项目id
ERPProjectName	string	否	否	erp项目名称
furtureTemplate	string	否	否	确认是否启用期货报价模板
offerType	number
小数位数:2,最大长度:64	否	否	期货报价模板下的报价方式
...
小数位数:10,最大长度:64	否	否	无税总价全额预付
taxlessPartialMoney	number
小数位数:10,最大长度:64	否	否	无税总价部分预付
...
dealPsnId	number
小数位数:2,最大长度:64	否	否	处理人id
dealPsnName	string	否	否	处理人
reqDeptId	number
小数位数:2,最大长度:64	否	否	需求部门id
reqDeptName	string	否	否	需求单位
ts	string	否	否	时间戳ts
supplierId	number
小数位数:2,最大长度:64	否	否	供应商id大
supplierSupName	string	否	否	供应商档案中供应商的名称
purContentTypeId	number
小数位数:2,最大长度:64	否	否	采购内容id
settleTypeId	string	否	否	结算方式Id
currencyId	string	否	是	币种id
currencyCode	string	否	否	币种编码
currencySymbol	string	否	否	币种符号
payAgreementId	number
小数位数:2,最大长度:64	否	否	付款协议ID
modifierId	number
小数位数:2,最大长度:64	否	否	修改人id
reqUapProjectId	string	否	否	平台项目档案id
isAllowAdjustPrice	string	否	否	合同物料是否允许调价
intendPaymentmny	number
小数位数:10,最大长度:64	否	否	累计合同预付付款金额
practicalPaymentmny	number
小数位数:10,最大长度:64	否	否	累计合同预付实付金额
accPayApplyMoney	number
小数位数:10,最大长度:64	否	否	累计合同申请预付款金额
totalMainNum	number
小数位数:10,最大长度:64	否	否	总主数量
totalPurchaseNum	number
小数位数:10,最大长度:64	否	否	总采购数量
supMsgNotifierId	number
小数位数:2,最大长度:64	否	否	供应商消息通知人
...
toProductStatus	number
小数位数:2,最大长度:64	否	否	合同生成商品流程状态
approveEndTime	date
格式:yyyy-MM-dd HH:mm:ss	否	否	审批通过时间
...
格式:yyyy-MM-dd HH:mm:ss	否	否	电子合同生成时间
eContractCreateType	string	否	否	合同生成方式
singleBudgetApplyId	number
小数位数:2,最大长度:64	否	否	单项预算申请单
...
filedPersonId	number
小数位数:2,最大长度:64	否	否	归档人id
filedTime	date
格式:yyyy-MM-dd HH:mm:ss	否	否	归档时间
filedStatus	string	否	否	归档状态
ctTermsData	string	否	否	合同条款数据
verifystate	number
小数位数:2,最大长度:64	否	否	审批状态
returncount	number
小数位数:2,最大长度:64	否	否	退回次数
ytenant	string	否	否	租户id
templateId	number
小数位数:2,最大长度:64	否	否	主模板主键
billTemplateId	number
小数位数:2,最大长度:64	否	否	单据模板主键
vouchdate	date
格式:yyyy-MM-dd HH:mm:ss	否	是	单据日期
status	number
小数位数:2,最大长度:64	否	否	单据状态
...
exchRate	number
小数位数:10,最大长度:64	否	否	汇率
exchRateDate	string	否	否	汇率日期
natMoney	number
小数位数:10,最大长度:64	否	否	本币无税金额
natTaxMoney	number
小数位数:10,最大长度:64	否	否	本币价税合计
pubts	date
格式:yyyy-MM-dd HH:mm:ss	否	否	时间戳pubts
contractPrepayList	object	是	是	预付付款单列表
ytenant	string	否	否	租户id
payPointName	string	否	否	付款起点名称
settleTypeId	number
小数位数:2,最大长度:64	否	否	结算方式id
serialNumber	number
小数位数:2,最大长度:64	否	否	序号
payPeriod	number
小数位数:2,最大长度:64	否	否	付款阶段
payPointAfterDay	number
小数位数:2,最大长度:64	否	否	账期天数
takerOrgName	string	否	否	收票组织name
payRatio	number
小数位数:10,最大长度:64	否	否	付款比例
payTaxMoney	number
小数位数:10,最大长度:64	否	否	付款金额
intendPaymentmny	number
小数位数:10,最大长度:64	否	否	累计付款金额
practicalPaymentmny	number
小数位数:10,最大长度:64	否	否	累计实付金额
advancePay	boolean	否	否	是否预付款
settleTypeName	string	否	否	结算方式name
initialDate	date
格式:yyyy-MM-dd HH:mm:ss	否	否	起算日
dueDate	date
格式:yyyy-MM-dd HH:mm:ss	否	否	到期日
id	number
小数位数:2,最大长度:64	否	否	预付付款单id
contractPaytermId	number
小数位数:2,最大长度:64	否	否	付款协议id
enterpriseId	number
小数位数:2,最大长度:64	否	否	所属租户id
enterpriseName	string	否	否	所属租户名称
payPoint	string	否	否	付款起点
takerOrgId	number
小数位数:2,最大长度:64	否	否	收票组织id
takerOrgCode	string	否	否	收票组织code
settleType	string	否	否	结算方式type
changingAction	string	否	否	变更动作
changingInfo	string	否	否	变更信息
ts	date
格式:yyyy-MM-dd HH:mm:ss	否	否	时间戳ts
natPrice	number
小数位数:10,最大长度:64	否	否	本币无税单价
natTaxPrice	number
小数位数:10,最大长度:64	否	否	本币含税单价
natTaxMoney	number
小数位数:10,最大长度:64	否	否	本币含税金额
natMoney	number
小数位数:10,最大长度:64	否	否	本币无税金额
accPayApplyMoney	number
小数位数:10,最大长度:64	否	否	累计预付付款申请金额
...
dimensionPricingList	object	是	否	价格目录子表
id	string	否	否	物料子表id
materialId	number
小数位数:2,最大长度:64	否	是	采购商物料id
materialName	string	否	否	采购商物料名称
materialClassId	number
小数位数:2,最大长度:64	否	否	采购商物料分类
...
firstBillId	number
小数位数:2,最大长度:64	否	否	来源单据主表id
firstBillBid	number
小数位数:2,最大长度:64	否	否	来源单据子表id
firstBillRowno	number
小数位数:2,最大长度:64	否	否	来源单据行号
reqId	string	否	否	需求
...
reqPlanDeptId	number
小数位数:2,最大长度:64	否	否	需求计划部门id
reqPlanPsnId	number
小数位数:2,最大长度:64	否	否	需求计划员id
...
priceValidateStartdate	number
小数位数:2,最大长度:64	否	否	价格有效期开始日期
...
小数位数:10,最大长度:64	否	否	计价换算率
mainNum	string	否	否	主数量
mainMetrologyId	number
小数位数:2,最大长度:64	否	否	主单位id
mainMetrologyName	string	否	否	主单位名称
mainMetrologyCode	string	否	否	主单位编码
purchaseNum	string	否	是	采购数量
purchaseUnitId	number
小数位数:2,最大长度:64	否	否	采购单位id
purchaseUnitName	string	否	否	采购单位名称
purchaseUnitCode	string	否	否	采购单位编码
purchaseExchRate	number
小数位数:10,最大长度:64	否	否	采购换算率
taxCategoryId	string	否	否	合同税率数目id
gift	boolean	否	否	赠品
formulaId	number
小数位数:2,最大长度:64	否	否	价格公式id
formulaName	string	否	否	价格公式
quotaProportion	number
小数位数:10,最大长度:64	否	否	配额比例
quotaPercentage	number
小数位数:10,最大长度:64	否	否	配额百分比
qualitypriceId	number
小数位数:2,最大长度:64	否	否	优质优价
singleBudgetApplyId	number
小数位数:2,最大长度:64	否	否	单项预算申请单
singleBudgetApplyBid	number
小数位数:2,最大长度:64	否	否	单项预算申请单明细
expenseItemId	number
小数位数:2,最大长度:64	否	否	费用项目
releasedBudgetMny	number
小数位数:10,最大长度:64	否	否	应释放单项预算占用无税金额
releasedBudgetTaxmny	number
小数位数:10,最大长度:64	否	否	应释放单项预算占用金额
payContractId	string	否	否	付款合同
payContractBid	string	否	否	付款合同表体
priceStrategy	number
小数位数:2,最大长度:64	否	否	取价策略id
...
costQuoteGroupId	number
小数位数:2,最大长度:64	否	否	成本项报价组id
ytenant	string	否	否	租户id
natMoney	number
小数位数:10,最大长度:64	否	否	本币无税金额
natTaxMoney	number
...
小数位数:10,最大长度:64	否	否	本币含税单价
natTax	number
小数位数:10,最大长度:64	否	否	本币税额
tax	number
小数位数:10,最大长度:64	否	否	税额
contractId	string	否	否	合同主表id
...
purchaseDigit	number
小数位数:2,最大长度:64	否	否	采购换算精度
purchaseRount	number
小数位数:2,最大长度:64	否	否	采购换算取舍规则
mainDigit	number
小数位数:2,最大长度:64	否	否	主单位换算精度
mainRount	number
小数位数:2,最大长度:64	否	否	主单位取舍规则
unitDigit	number
小数位数:2,最大长度:64	否	否	计价单位精度
unitRount	number
小数位数:2,最大长度:64	否	否	计价单位取舍规则
...
ts	string	否	否	时间戳
outDay	date
格式:yyyy-MM-dd HH:mm:ss	否	否	出账日
...
小数位数:2,最大长度:64	否	否	供应商档案ID
exchRateType_code	string	否	否	汇率类型编码
rowStatus	string	否	否	行状态

## 3. 请求示例

Url: /yonbip/cpu/cancelTerminate?access_token=访问令牌
Header: 
	purOrgId : ""
Body: [{
	"id": "",
	...
	"fbillstatus": "",
	"modifier": "",
	"modifiedtime": "2026-06-07 13:05:51",
	"creator": "",
	"createTime": 0,
	"erpProductVersion": "",
	"money": "",
	...
	"changingCommittedDate": "2026-06-07 13:05:51",
	"changingCommittedReason": "",
	"changingConfirmerName": "",
	"changingConfirmedDate": "2026-06-07 13:05:51",
	...
	"sendErpMsg": "",
	"toProductStatus": 0,
	"approveEndTime": "2026-06-07 13:05:51",
	"internalFileId": "",
	"externalFileId": "",
	"stockStampFileId": "",
	"saleFileId": "",
	...
	"econtractCreateDate": "2026-06-07 13:05:51",
	"eContractCreateType": "",
	...
	"templateId": 0,
	"billTemplateId": 0,
	"vouchdate": "2026-06-07 13:05:51",
	"status": 0,
	"tenant": "",
	"modifyTime": "2026-06-07 13:05:51",
	"natCurrency": "",
	"natCurrency_code": "",
	"natCurrency_name": "",
	"exchRateType_name": "",
	...
	"contractPrepayList": [
		{
			...
			"advancePay": true,
			"settleTypeName": "",
			"initialDate": "2026-06-07 13:05:51",
			"dueDate": "2026-06-07 13:05:51",
			"id": 0,
			"contractPaytermId": 0,
			"enterpriseId": 0,
			"enterpriseName": "",
