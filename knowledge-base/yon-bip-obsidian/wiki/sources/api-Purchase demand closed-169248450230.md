...
Url: /yonbip/cpu/pureq/cancel?access_token=访问令牌
Body: {
	"sourcecode": "",
	"sourcebids": [
		""
...
result	string	否	返回结果信息 示例：success
msg	string	否	返回消息 示例：采购需求关闭成功
status	string	否	返回状态（2：成功，3：失败） 示例：2
