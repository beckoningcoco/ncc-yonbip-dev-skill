---
title: "采购入库弃审"
apiId: "93ed0585a42541e0bc272662fc0c63ef"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/scm/purinrecord/batchunaudit
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 是 | 采购入库单[st.purinrecord.PurInRecord] |
| id | long | 否 | 是 | 主表id 示例：1915883316809984 |

## 3. 请求示例

Url: /yonbip/scm/purinrecord/batchunaudit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1915883316809984
