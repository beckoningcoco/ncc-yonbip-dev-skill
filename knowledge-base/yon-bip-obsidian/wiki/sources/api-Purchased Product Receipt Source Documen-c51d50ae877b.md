---
title: "采购入库来源生单保存"
apiId: "c51d50ae877b440f87549513ab32cd1d"
apiPath: "请求方式	POST"
...
>  请求方式	POST | Purchase Receipt (MM)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/scm/purinrecord/mergeSourceData/save
请求方式	POST
...
bustype	string	否	否	交易类型id，或交易类型code；业务流中未配置交易类型且未设置默认交易类型时必输。
...
Url: /yonbip/scm/purinrecord/mergeSourceData/save?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"mergeSourceData": "",
