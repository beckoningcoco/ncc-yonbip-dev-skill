...
请求地址	/yonbip/imcs/qualitgrade/list
请求方式	POST
...
code	string	否	否	等级组编码 示例：008
name	string	否	否	等级组名称 示例：9023024034
pubts	string	否	否	时间戳，支持最高10位数字的秒级时间戳，默认起始时间戳，如果需要结束时间戳，则用 | 进行分割，如1717038743|1717038999 示例：1717038743|1717038999

## 3. 请求示例

Url: /yonbip/imcs/qualitgrade/list?access_token=访问令牌
Body: {
	"pageIndex": 1,
	"pageSize": 10,
	"code": "008",
