---
title: "根据管理人查询资产卡片"
apiId: "3779b677b9004fc2bc20d9daa044ad2e"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/am/aimEquipCard/getEquipInfoByManage
...
| value1 | string | 是 | 否 | 条件值：条件对应的值 示例：["2643468970497024","2659044463137280","2680865636651520"] |

## 3. 请求示例

Url: /yonbip/am/aimEquipCard/getEquipInfoByManage?access_token=访问令牌
Body: {
	"commonVOs": [
		{
			"itemName": "id",
