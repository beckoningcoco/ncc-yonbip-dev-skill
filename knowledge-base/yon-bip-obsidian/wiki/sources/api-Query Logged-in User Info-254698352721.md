...
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Applications]
...
>  请求方式	POST | Applications (ASSAA)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/ACC/myapplication/query
请求方式	POST
...
Url: /yonbip/ACC/myapplication/query?access_token=访问令牌
Body: {
	"condition": {
		"simpleVOs": [
			{
		...
		"recordList": [
			{
				...
				"pk_user__name": "cs",
				"bill_code": "JYSQ202605140001",
				"bill_status": "3",
				"creationtime": "2026-05-14 14:23:46",
				...
				"auditor": "",
				"auditor__name": "",
				"audittime": "2026-06-07 13:25:30",
				"modifier": "",
				"modifier_name": "",
				"modifiedtime": "2026-06-07 13:25:30",
				"transi_type": "2339906154407657755",
				"id": "2",
				"apply_type": "",
				"fid": "2538667774756519938",
				"transi_type_code": "4A38-01",
				"isWfControlled": "true",
				"bill_type__code": "4A38"
			}
		],
		"pageCount": 1,
		"beginPageIndex": 1,
