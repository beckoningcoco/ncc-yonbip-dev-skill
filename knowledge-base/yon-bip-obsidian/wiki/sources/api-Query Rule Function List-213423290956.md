...
请求地址	/yonbip/hrcloud/bizrule/openApi/ruleFunctionList
请求方式	POST
...
名称	类型	数组	必填	描述
pageIndex	number
小数位数:0,最大长度:10	否	否	页码 默认值：1
pageSize	number
小数位数:0,最大长度:10	否	否	分页大小 默认值：20

## 3. 请求示例

Url: /yonbip/hrcloud/bizrule/openApi/ruleFunctionList?access_token=访问令牌
Body: {
	"pageIndex": 0,
	"pageSize": 0
}
...
小数位数:0,最大长度:10	否	开始页码 示例：0
endPageIndex	number
小数位数:0,最大长度:10	否	结束页码 示例：0
traceId	string	否	traceId 示例：278cf89f45eb4831
