...
请求地址	/yonbip/uspace/server/query/notify/ALARM/list
请求方式	GET
...
Url: /yonbip/uspace/server/query/notify/ALARM/list?access_token=访问令牌&readStatus=UNREAD&pageNo=1&pageSize=10
