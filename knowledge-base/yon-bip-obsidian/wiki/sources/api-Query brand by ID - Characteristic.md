...
> `ContentType	application/json` 请求方式	GET | 分类: Brand (MD)
...
请求地址	/yonbip/digitalModel/brand/newdetail
...
Url: /yonbip/digitalModel/brand/newdetail?access_token=访问令牌&id=123456
