...
请求地址	/yonbip/hrcloud/bizrule/openApi/bizruleList
请求方式	POST
...
Url: /yonbip/hrcloud/bizrule/openApi/bizruleList?access_token=访问令牌
Body: {
	"pageIndex": 1,
	"pageSize": 20
}
...
pageCount	number
小数位数:0,最大长度:10	否	每页数量 示例：0
beginPageIndex	number
小数位数:0,最大长度:10	否	开始页码 示例：0
endPageIndex	number
小数位数:0,最大长度:10	否	结束页码 示例：0
traceId	string	否	traceId 示例：6fd9421556b22277
