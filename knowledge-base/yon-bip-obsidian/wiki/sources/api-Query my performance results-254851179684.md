...
请求地址	/yonbip/HCC/pmresult/openapi/queryPersonalPmResult
请求方式	GET
ContentType	
应用场景	开放API
事务和幂等性	无
...
Url: /yonbip/HCC/pmresult/openapi/queryPersonalPmResult?access_token=访问令牌&periodCode=
...
data	object	否	data
schemeInfoList	object	是	绩效信息列表
status	number
小数位数:0,最大长度:10	否	业务状态码。0：成功，1：失败 示例：0
message	string	否	业务返回信息
traceId	string	否	traceId 示例：2a61dd808b2c4df9
