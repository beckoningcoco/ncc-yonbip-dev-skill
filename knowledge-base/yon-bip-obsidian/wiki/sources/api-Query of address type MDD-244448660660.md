...
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Address Type]
...
请求地址	/yonbip/HCC/addressType/list
请求方式	POST
...
code	string	否	否	编码
name	string	否	否	名称
AddressTypeCountry.countryId	string	是	否	国家/地区ID
enable	string	否	否	启用状态，1启用 0停用 示例：1

## 3. 请求示例

Url: /yonbip/HCC/addressType/list?access_token=访问令牌
Body: {
	"pageSize": 0,
	"pageIndex": 0,
	"code": "",
	"name": "",
	"AddressTypeCountry.countryId": [
		""
	],
	"enable": "1"
}
		...
		"recordList": [
			{
				...
				"AddressTypeCountry": [
					{
						"AddressTypeCountry": "中国大陆",
						"addressTypeId": "HRDIWORK030000000312",
						"id": "2429436319757238274",
