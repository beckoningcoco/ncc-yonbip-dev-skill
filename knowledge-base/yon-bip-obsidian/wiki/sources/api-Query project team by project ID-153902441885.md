...
请求地址	/yonbip/pm/team/deleteTeamMember
请求方式	POST
...
Url: /yonbip/pm/team/deleteTeamMember?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		...
		"teamMembers": [
			{
				"teamMemberId": "1624333799479312389"
			}
		]
	}
}
...
data	string	否	返回数据 示例：删除项目成员成功
