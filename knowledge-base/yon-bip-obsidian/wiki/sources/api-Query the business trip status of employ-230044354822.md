---
title: "查询员工一段时间内的出差情况(多人)"
apiId: "2300443548227469313"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/HCC/time/business/queryalltrip
请求方式	POST
...
approveStatus	string	否	否	单据审批状态（0表示仅展示审批通过的出差单，传1或者不传时，展示审批中以及审批通过的出差单） 示例：0
...
Url: /yonbip/HCC/time/business/queryalltrip?access_token=访问令牌
Body: {
	"staffCodes": [
		"code1",
		"code2"
		...
		"content": [
			{
				...
				"destination": "",
				"remark": "",
				"tripbegintime": "2025-06-26 09:00:00",
				"tripendtime": "2025-06-26 12:00:00",
				"startDayType": 1,
				"endDayType": 1,
