---
title: "查询员工一段时间内的请假情况(多人)"
apiId: "2298795225658163201"
apiPath: "请求方式	POST"
method: "ContentType"
...
请求地址	/yonbip/HCC/time/leave/queryallleavebystaffids
请求方式	POST
ContentType	
应用场景	开放API
事务和幂等性	MDD幂等
...
Body参数
名称	类型	数组	必填	描述
staffIds	string	是	是	员工staffid 示例：["2122","334"]
...
Url: /yonbip/HCC/time/leave/queryallleavebystaffids?access_token=访问令牌
Body: {
	"staffIds": [
		"2122",
		"334"
