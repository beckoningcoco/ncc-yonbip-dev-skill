...
请求地址	/yonbip/HCC/api/mdd/pay/payslip/queryLoginType
请求方式	POST
...
Url: /yonbip/HCC/api/mdd/pay/payslip/queryLoginType?access_token=访问令牌
Header: 
	Digital-Avatar-Id : ""
	Yht-Access-Token : ""
	yht_access_token : ""
...
data	object	否	data
loginType	number
小数位数:0,最大长度:10	否	loginType 0:密码或验证码 1：密码或验证码 2：仅密码 3：仅验证码 4：不需要验证 示例：1
