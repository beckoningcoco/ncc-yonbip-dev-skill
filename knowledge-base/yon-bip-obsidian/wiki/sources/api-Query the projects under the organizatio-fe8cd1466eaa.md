---
title: "按照手机号查询此人负责的项目"
apiId: "fe8cd1466eaa4b5e8830c225e117ec66"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/pm/projectcenter/findInChargedProjects
请求方式	POST
...
includeStatus	string	是	否	选择包含的状态.未启用:UNABLE;启用:ENABLED;停用:STOP;提前立项:ADVANCE;正常立项:NORMAL;执行中:ING;暂停:SUSPEND;业务关闭:BUSINESS_CLOSE;财务关闭:FINANCE_CLOSE; 示例：["ADVANCE"]
...
Url: /yonbip/pm/projectcenter/findInChargedProjects?access_token=访问令牌
Body: {
	"phoneNo": "13466649325",
...
contractId	string	否	销售合同ID 示例：23331251344245
message	string	否	请求状态信息 示例：查询成功
...
1032001990003	您输入的手机号码不合格,请检查	检查手机号是否输入正确
1032001990001	未接收到参数	检查是否填写了参数
1032001990002	手机号不允许为空	检查是否输入了手机号
