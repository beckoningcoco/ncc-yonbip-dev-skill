...
请求地址	/yonbip/digitalModel/open/funcpermission/cleanAll/fastAuth
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| subjectType | string | 否 | 是 | 授权类型(用户:user, 部门:org, 用户身份:userType) 示例：user |
...
Url: /yonbip/digitalModel/open/funcpermission/cleanAll/fastAuth?access_token=访问令牌
Body: {
	"subjectType": "user",
	"serviceIds": [
