...
请求地址	/yonbip/digitalModel/open/funcpermission/fastAuth
...
| isCheckSysEveryone | boolean | 否 | 否 | 校验服务是否是全员应用 true:是，false:否 示例：true 默认值：false |

## 3. 请求示例

Url: /yonbip/digitalModel/open/funcpermission/fastAuth?access_token=访问令牌
Body: {
	"subjectType": "user",
	"serviceIds": [
