---
title: "原因档案批量删除结果查询-新集成"
apiId: "2247914062382366722"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Reason File (MD)
...
请求地址	/yonbip/digitalModel/coredoc/async/reason/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/coredoc/async/reason/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
