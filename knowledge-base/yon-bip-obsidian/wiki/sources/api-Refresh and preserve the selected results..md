...
请求地址	/yonbip/tax/invoiceclient-web/api/vat/etax-sync-gxresult
...
Url: /yonbip/tax/invoiceclient-web/api/vat/etax-sync-gxresult?access_token=访问令牌
Body: {
