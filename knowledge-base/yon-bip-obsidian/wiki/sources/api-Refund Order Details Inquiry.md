---
title: "退款单详情查询"
apiId: "47f587e6502c4102a0b48180cb7c787e"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Refund Note (ZNBZ)
...
请求地址	/yonbip/znbz/rbsm/api/bill/refundbill/detail
...
Url: /yonbip/znbz/rbsm/api/bill/refundbill/detail?access_token=访问令牌&id=&billNo=
...
| bustype_name | string | 否 | 交易类型 示例：退款单 |
| irejectstatus | long | 否 | 驳回状态(0:正常;1:驳回） 示例：0 |
| vcurrency_name | string | 否 | 退款币种 示例：人民币 |
| vcurrency_moneyDigit | long | 否 | 原币币种金额精度 示例：2 |
| id | long | 否 | 单据id 示例：2394808884105472 |
| vattachmentass | string | 否 | 单据附件id 示例：29877ac0c97e4e8a98a449a52bb9de5e |
| isWfControlled | boolean | 否 | 是否审批流控制(true:是;false:不是) 示例：false |
| vcurrency_currTypeSign | string | 否 | 退款币种货币符号 示例：¥ |
| barCode | string | 否 | 条形码 示例：znbzbx_refundbill|2394808884105472 |
| auditorId | long | 否 | 审批人ID 引用：身份信息 User 示例：2185004199465216 |
| caccountorg | string | 否 | 会计主体id 示例：2184854309114112 |
| vnatcurrency | string | 否 | 组织本币id 示例：2183687327011840 |
| auditTime | string | 否 | 审批时间 示例：2021-08-19 18:05:55 |
...
| code | string | 否 | 单据号 示例：0035 |
| vnatexchratetype_digit | long | 否 | 汇率精度 示例：6 |
| ibillmakemethod | long | 否 | 填单方式, ０:PC新增、１:移动新增、２:EXCEL导入、 示例：0 |
| pk_handlepsn_name | string | 否 | 退款经办人 引用：员工(新)StaffNew 示例：王建斌 |
| nreturnmny | BigDecimal | 否 | 本次冲销预付额 示例：10 |
| creatorId | long | 否 | 创建人id 示例：2185004199465216 |
| chandleorg_name | string | 否 | 退款经办人组织 示例：北京天元股份有限公司 |
...
| pubts | string | 否 | 时间戳 示例：2021-08-25 11:13:26 |
| vreason | string | 否 | 退款说明 示例：购买多了 |
...
| nnatreturnmny | BigDecimal | 否 | 本次冲销预付额-本币 示例：10 |
...
| createTime | string | 否 | 创建时间 示例：2021-08-19 18:05:35 |
...

{
	...
	"data": {
		...
		"ReturnBillBVO": [
			{
				...
				"ntotalremainmny": 5000,
				"pk_loanbill_bustype": "2183687370051852",
				...
				"pk_loanbill_code": "0174",
				"chandleorg_name": "北京天元股份有限公司",
				"vcurrency": "2183687327011840",
				"pk_returnbill": 2394808884105472,
				"pk_loanbill_b": 2394804078596353,
		...
		"vcurrency_moneyDigit": 2,
		"id": 2394808884105472,
		"vattachmentass": "29877ac0c97e4e8a98a449a52bb9de5e",
		"isWfControlled": false,
		"vcurrency_currTypeSign": "¥",
		"barCode": "znbzbx_refundbill|2394808884105472",
		"auditorId": 2185004199465216,
		"caccountorg": "2184854309114112",
		"vnatcurrency": "2183687327011840",
		"auditTime": "2021-08-19 18:05:55",
		"nnatexchrate": 1,
		"pk_handlepsn": "2185003811393792",
		...
		"vnatexchratetype_name": "基准汇率",
		"cfinaceorg_name": "北京天元股份有限公司",
		"createTime": "2021-08-19 18:05:35",
		"dnatexchratedate": "2021-08-19 00:00:00",
		"vnatexchratetype": "py7y8nze",
		"vnatcurrency_currTypeSign": "¥",
		"vhandledeptid_name": "筹资部-规划部",
