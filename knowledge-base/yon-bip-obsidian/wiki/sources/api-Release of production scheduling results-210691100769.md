...
请求地址	/yonbip/mfg/schedule/publish
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
demandIds	string	是	是	排产需求ID(批量)

## 3. 请求示例

Url: /yonbip/mfg/schedule/publish?access_token=访问令牌
Body: {
	"demandIds": [
		""
	]
...
errMsg	string	否	失败信息
successCount	string	否	成功条数 示例：10
allCount	string	否	所有条数 示例：10
