---
title: "还款单审核"
apiId: "ea754abfdac245f3832fba52b93264d6"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/znbz/rbsm/api/bill/returnbill/audit
...
Url: /yonbip/znbz/rbsm/api/bill/returnbill/audit?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"id": 2365029317071104
...
| id | long | 否 | 单据id 示例：2423078054695168 |
...
| auditTime | string | 否 | 审批时间 示例：2021-11-01 16:41:15 |
| auditDate | string | 否 | 审批日期 示例：2021-11-01 00:00:00 |
| status | long | 否 | 结算状态,0:待结算、1:结算中、2:结算成功、3:结算止付、4:结算部分成功、5:无需结算、 示例：1 |
| RetSettleInfoVO | object | 是 | 还款单结算信息 |
| pubts | string | 否 | 时间戳 示例：2021-11-01 16:41:15 |
...

{
	...
	"message": "操作成功",
	"data": {
		"resubmitCheckKey": "OPENAPI_ea754abfdac245f3832fba52b93264d6_xtikzjvp_1",
		"id": 2423078054695168,
		"verifystate": 2,
		"auditor": "YonSuite默认用户",
		"auditorId": 1951632934146304,
		"auditTime": "2021-11-01 16:41:15",
		...
		"RetSettleInfoVO": [
			{
				...
				"pk_returnbill": 2423078054695168,
				...
				"nsettleexchrate": 1,
				"pk_handlepsnbank": "2104703005610240",
				"bjournalizing": true,
				...
				"nnatexchrate": 1,
				"pk_handlepsn": "2104701679341824",
				"pk_bankdoc_opp": "2013860238217984",
				"_status": "Update"
			}
		],
		"pubts": "2021-11-01 16:41:15",
		"isettlestatus": 5
	}
}
