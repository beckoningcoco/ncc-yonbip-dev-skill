---
title: "零售销售成本保存"
apiId: "287fb4acd98e481d81fe22c2884b3d6f"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/sd/uretail/salecost/save
请求方式	POST
...
id	string	否	是	零售日报id 示例：1918992680264192
id__pk	string	否	否	异常pk 示例：1001A11000000071MB5V
rmDailyReportDetail	object	是	否	rmDailyReportDetail
key	string	否	否	异常key 示例：id__pk

## 3. 请求示例

Url: /yonbip/sd/uretail/salecost/save?access_token=访问令牌
Body: {
	"data": [
		{
			"_status": "Update",
			"id": "1918992680264192",
			"id__pk": "1001A11000000071MB5V",
			"rmDailyReportDetail": [
				{
					"_status": "Update",
					"fCostPrice": "20.12",
