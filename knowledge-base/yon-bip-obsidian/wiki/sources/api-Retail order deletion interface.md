...
请求地址	/yonbip/EFI/revenue/offLineOrder/batchDelete
...
| is_depositreceipt_deleted | boolean | 否 | 否 | 是否级联删除缴存单，默认是false，传true会自动删除缴存单 默认值：false |

## 3. 请求示例

Url: /yonbip/EFI/revenue/offLineOrder/batchDelete?access_token=访问令牌
Body: {
	"ids": [
		1001,
		1002,
	...
	"is_depositreceipt_deleted": true
}
