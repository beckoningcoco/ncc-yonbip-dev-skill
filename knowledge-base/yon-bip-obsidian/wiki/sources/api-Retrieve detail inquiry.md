---
title: "调出详情查询"
apiId: "3d5a8ff91c404b519a1d7945d91f115c"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Transfer-out Document (MM)
...
请求地址	/yonbip/scm/storeout/detail
...
Url: /yonbip/scm/storeout/detail?access_token=访问令牌&id=
...
| bizType | int | 否 | 自动调拨 (0:手工；1：订单审核自动调出调入；2：调出保存自动调入；5：订单审核自动调出) |
...
| OutStoreLogistics | object | 是 | 物流信息表[st.storeout.OutStoreLogistic] |
