...
请求地址	/yonbip/pm/rest/v1/openapi/queryBusinessFiles
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
businessIds	string	是	是	业务标识集合 示例：["2066536210575130632"]

## 3. 请求示例

Url: /yonbip/pm/rest/v1/openapi/queryBusinessFiles?access_token=访问令牌
Body: {
	"businessIds": [
		"2066536210575130632"
	]
