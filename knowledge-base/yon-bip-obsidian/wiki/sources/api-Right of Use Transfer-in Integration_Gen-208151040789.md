...
请求地址	/yonbip/am/deployusedin/submit
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	是	是	使用权调入对象
id	string	否	是	使用权调入主键 示例：1522112313441131

## 3. 请求示例

Url: /yonbip/am/deployusedin/submit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "1522112313441131"
