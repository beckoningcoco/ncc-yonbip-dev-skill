---
title: "销售订单关闭"
apiId: "902eed7130394d96bef97ba9b620f14d"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/sd/voucherorder/close
...
| status | int | 否 | 否 | 单据当前状态, 0:开立、1:已审核、2:已关闭、3:审核中 示例：1 |
| id | long | 否 | 是 | 销售订单id 示例：1957434474451200 |
| code | string | 否 | 否 | 销售订单code 示例：UO-2256202010140001 |

## 3. 请求示例

Url: /yonbip/sd/voucherorder/close?access_token=访问令牌
Body: {
	"data": [
		{
			"lockIn": false,
