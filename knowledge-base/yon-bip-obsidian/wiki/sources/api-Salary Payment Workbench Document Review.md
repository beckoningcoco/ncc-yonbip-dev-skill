...
> `ContentType	application/json` 请求方式	POST | 分类: 薪资支付工作台 (ctm)
...
请求地址	/yonbip/ctm/salarypaylist/batchaudit
...
| id | long | 否 | 是 | 单据id 示例：15551501741111378016 |

## 3. 请求示例

Url: /yonbip/ctm/salarypaylist/batchaudit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 15551501741111378016
		}
	]
}
...

{
	...
	"data": {
		...
		"failInfos": [
			{
				"id": 2355149882003712,
				"message": "\"当前单据【TA220927000023】已审批，不能进行重复审批！\""
			}
		]
	}
}
