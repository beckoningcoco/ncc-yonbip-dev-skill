---
title: "薪资发放单根据发放单期间查询"
apiId: "1804533438771888135"
apiPath: "请求方式	GET"
method: "ContentType"
category: "Payroll"
domain: "CPSM"
...
请求地址	/yonbip/hrcloud/payfile/query-payfileIds-by-period
请求方式	GET
ContentType	
应用场景	开放API
事务和幂等性	无
...
userId	string	query	是	用户ID必填
payPeriod	string	query	是	发薪期间必填    示例: 2022-01
orgId	string	query	否	组织机构id    示例: 127455878457

## 3. 请求示例

Url: /yonbip/hrcloud/payfile/query-payfileIds-by-period?access_token=访问令牌&userId=&payPeriod=2022-01&orgId=127455878457
