---
title: "销售委托关系启用"
apiId: "ff8a6032eef64173aebd47d61f5b57f1"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/salesDelegate/unstop
...
| id | string | 否 | 是 | 销售委托关系主键 示例：2352290713604352 |

## 3. 请求示例

Url: /yonbip/digitalModel/salesDelegate/unstop?access_token=访问令牌
Body: {
	"data": {
		"id": "2352290713604352"
	}
...
| pubts | string | 否 | 时间戳 示例：2021-07-23 13:32:25 |
