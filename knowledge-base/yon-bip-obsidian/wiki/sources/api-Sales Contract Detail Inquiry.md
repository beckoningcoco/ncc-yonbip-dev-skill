...
> `ContentType` 请求方式	GET | 分类: Sales Contract (SCMSD)
...
Url: /yonbip/sd/sact/detail?access_token=访问令牌&id=
...
Valuation Conversion Rate Denominator
