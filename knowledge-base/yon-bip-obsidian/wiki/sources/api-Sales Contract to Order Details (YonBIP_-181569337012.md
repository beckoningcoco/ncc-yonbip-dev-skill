---
title: "销售合同转订单详情（YonBIP_NC65）"
apiId: "1815693370128859136"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/crm/nc/api/uapbd/salecontractdetail/getQuery
请求方式	POST
...
pageIndex	float	否	否	页码
pageSize	float	否	否	页大小
totalCount	float	否	否	总条数

## 3. 请求示例

Url: /yonbip/crm/nc/api/uapbd/salecontractdetail/getQuery?access_token=访问令牌
Body: [{
	"id": "",
	"isSum": 0,
	"pk_org": "",
