---
title: "销售发票查询（YonBIP_BIPPremium）"
apiId: "2060642630671794182"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/crm/bippremium/api/uapbd/saleinvoicequery/getQuery
请求方式	POST
...
pk_sale_org	string	否	否	销售组织
pk_custclass	string	否	否	客户分类
pk_customer	string	否	否	客户
pk_invoice_cust	string	否	否	开票客户
...
Url: /yonbip/crm/bippremium/api/uapbd/saleinvoicequery/getQuery?access_token=访问令牌
Body: [{
	"pk_org": "",
	"pk_sale_org": "",
	"pk_custclass": "",
