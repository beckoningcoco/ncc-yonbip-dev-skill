---
title: "销售订单执行查询（YonBIP_BIPPremium）"
apiId: "2055363170999468032"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/crm/bippremium/api/uapbd/saleorderexecreport/getQuery
请求方式	POST
...
org_code	string	否	否	销售组织code
ccustomercode	string	否	否	客户code
marbasclass_code	string	否	否	商品分类
cmaterialvcode	string	否	否	商品code
cdeptvid	string	否	否	部门
cemployeeid	string	否	否	业务员
...
Url: /yonbip/crm/bippremium/api/uapbd/saleorderexecreport/getQuery?access_token=访问令牌
Body: [{
	"pk_org": "",
	"pk_custclass": "",
	"ccustomerid": "",
...
cdeptvid	string	否	部门
cemployeeid	string	否	人员
