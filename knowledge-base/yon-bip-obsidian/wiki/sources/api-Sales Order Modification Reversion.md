...
请求地址	/yonbip/SCC/voucherorderchange/delete
...
Url: /yonbip/SCC/voucherorderchange/delete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 666999888777,
...
| ecsuiteuser | string | 否 | 气泡联系人 |
| count | number |
| 小数位数:0,最大长度:28 | 否 | 数据总条数 示例：1 |
| sucessCount | number |
| 小数位数:0,最大长度:28 | 否 | 成功数据条数 示例：1 |
| failCount | number |
| 小数位数:0,最大长度:28 | 否 | 失败数据条数 示例：0 |
