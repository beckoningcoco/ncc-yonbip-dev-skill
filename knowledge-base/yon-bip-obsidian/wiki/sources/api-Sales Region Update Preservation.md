...
请求地址	/yonbip/digitalModel/saleArea/newupdate
...
| parentCode | string | 否 | 否 | 上级分类编码 示例：code02 |
...
Url: /yonbip/digitalModel/saleArea/newupdate?access_token=访问令牌
Body: {
	"id": 123456,
	"code": "code",
	"name": {
