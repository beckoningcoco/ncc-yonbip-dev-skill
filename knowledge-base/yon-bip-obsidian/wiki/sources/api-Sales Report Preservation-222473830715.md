...
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Sales Report]
...
professionalTime	string	否	否	业务日期 示例：2025-04-07
marketCount	string	否	否	总销售数量
marketMoney	string	否	否	总销售金额
...
bustype	string	否	是	销售上报交易类型ID 示例：1841647505310220291
...
clientMarketUpRecordList	object	是	否	销售上报记录详情
_status	string	否	是	保存类型 Insert:新增 Update:更新 示例：Insert

## 3. 请求示例

Url: /yonbip/crm/cussosub/save?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"org": "1733604510595022850",
		"org_name": "集团",
		"professionalTime": "2025-04-07",
		"marketCount": "",
		"marketMoney": "",
		...
		"clientMarketUpRecordList": [
			{
				...
				"marketCount": "0",
				"marketPrice": "0",
				"marketMoney": "2024-08-05 00:00:00",
				"materialClass": "",
				"materialClass_name": "",
				"_status": "Insert"
			}
...
code	string	否	销售上报编码 示例：20240805004125
bustype	string	否	交易类型ID 示例：1884107775339922599
bustype_name	string	否	交易类型名称 示例：客户销售上报
...
marketCount	string	否	总进货数量 示例：11
marketMoney	string	否	总进货金额 示例：11
...
clientMarketUpDefineCharacter	object	否	clientMarketUpDefineCharacter
clientMarketUpRecordList	object	是	clientMarketUpRecordList
		...
		"clientMarketUpRecordList": [
			{
				...
				"clientMarketUpId": "2215101749293219845",
				"pubts": "2024-08-05 11:34:50",
				"tenant": 3304892632636320,
				"ytenant": "0000LI1EO7E96110660000",
				"materialClass": "1884705462972579847",
				"materialClass_name": "家用电器",
				"clientMarketUpRecordDefineCharacter": {
					"id": ""
				}
			}
		],
