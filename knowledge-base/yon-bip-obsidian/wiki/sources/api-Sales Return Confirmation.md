---
title: "销售退货确认"
apiId: "6e3dd3cb3caa4d94aa8b502a10cd7dbb"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/sd/vouchersalereturn/approve
...
| saleReturnStatus | string | 否 | 否 | 确保退货单单据状态是SUBMITSALERETURN（开立） 示例：SUBMITSALERETURN |

## 3. 请求示例

Url: /yonbip/sd/vouchersalereturn/approve?access_token=访问令牌
Body: {
