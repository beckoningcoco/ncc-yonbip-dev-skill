---
title: "销售退货撤回"
apiId: "f4170c441d6241fc8eab357f1f077f12"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/sd/vouchersalereturn/unsubmit
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 是 | 销售退货单 |
| id | long | 否 | 是 | 退货单主表id 示例：2591830206731008 |

## 3. 请求示例

Url: /yonbip/sd/vouchersalereturn/unsubmit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2591830206731008
...
| data | string | 否 | 响应信息 |
| code | string | 否 | 返回码，调用成功时 示例：200 |
