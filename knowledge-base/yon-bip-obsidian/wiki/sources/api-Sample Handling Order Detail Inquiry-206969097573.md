...
请求地址	/yonbip/QMS_QIT/retentionsampleprocess/detail
请求方式	POST
...
id	string	query	否	留样处理单id，code和id 任一不为空，都有值取id    示例: 1888589127091748873
code	string	query	否	留样处理单单号    示例: LYCL202405150001

## 3. 请求示例

Url: /yonbip/QMS_QIT/retentionsampleprocess/detail?access_token=访问令牌&id=1888589127091748873&code=LYCL202405150001
