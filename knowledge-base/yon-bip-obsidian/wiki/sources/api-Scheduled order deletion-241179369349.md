...
请求地址	/yonbip/mfg/planorder/batchOpen
请求方式	POST
...
Url: /yonbip/mfg/planorder/batchOpen?access_token=访问令牌
Body: {
	"data": [
		{
			"resubmitCheckKey": "",
...
messages	string	是	提示语集 示例：["订单号：GEN202412170004,未审核的数据，不可关闭！","订单号：GEN202412170003,未审核的数据，不可关闭！"]
...

{
	...
	"data": {
		...
		"messages": [
			...
			"订单号：GEN202412170003,未审核的数据，不可关闭！"
		],
		"failInfos": [
			{
		...
		"infos": [
			{
				...
				"planProperty": "1",
				"status": "4",
				"modifyTime": "2025-04-09 16:51:05",
				"pubts": "2025-04-09 15:40:07"
			}
		]
	}
}
