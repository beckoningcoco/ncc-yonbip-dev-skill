...
> `ContentType	application/json` 请求方式	GET | 分类: Scrap Document (MM)
...
请求地址	/yonbip/scm/storescrapped/detail
...
Url: /yonbip/scm/storescrapped/detail?access_token=访问令牌&id=
...
| stockStatusChanges | object | 是 | 报废单子表详情 |
