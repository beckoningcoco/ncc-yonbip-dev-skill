...
请求地址	/yonbip/scm/storescrapped/batchunsubmit
...
| id | number |
| 小数位数:0,最大长度:19 | 否 | 是 | 报废单主表id 示例：1915883316809984 |

## 3. 请求示例

Url: /yonbip/scm/storescrapped/batchunsubmit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1915883316809984
