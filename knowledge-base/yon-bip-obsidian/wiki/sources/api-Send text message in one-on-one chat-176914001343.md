...
请求地址	/yonbip/uspace/rest/chat/message/text
请求方式	POST
...
content	string	否	是	文本消息 示例：这是一条测试消息

## 3. 请求示例

Url: /yonbip/uspace/rest/chat/message/text?access_token=访问令牌
Body: {
