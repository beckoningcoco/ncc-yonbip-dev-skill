...
date: 2026-06-07
ingested: 2026-06-07
tags: [YonBIP, OpenAPI, Service Type]
...
>  请求方式	POST | Service Type (EQP)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/MFC/tos/batchquery
请求方式	POST
...
Url: /yonbip/MFC/tos/batchquery?access_token=访问令牌
Body: {
	"page": {
		"pageIndex": 1,
		"pageSize": 20
