---
title: "结算方式对照批量删除结果查询-新集成"
apiId: "2247911708740288517"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Payment Method Mapping (MD)
...
请求地址	/yonbip/digitalModel/coredoc/async/settleMethodContrast/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/coredoc/async/settleMethodContrast/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
