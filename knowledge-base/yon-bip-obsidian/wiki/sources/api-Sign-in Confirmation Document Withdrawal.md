---
title: "签收确认单个撤回"
apiId: "1006fa2d61bf40dbb9502e3729aed985"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/scm/signconfirmation/batchunsubmit
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 是 | 请求体 |
| id | long | 否 | 是 | 签收确认主键 示例：2282796996055296 |

## 3. 请求示例

Url: /yonbip/scm/signconfirmation/batchunsubmit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2282796996055296
