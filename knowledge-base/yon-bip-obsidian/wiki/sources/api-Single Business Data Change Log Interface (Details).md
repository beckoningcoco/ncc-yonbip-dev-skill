---
title: "单条业务数据变更日志接口（详情）"
apiId: "1944243330421882882"
apiPath: "请求方式	GET"
method: "ContentType"
...
请求地址	/yonbip/digitalModel/log-pub/business/rest/historyDetail
...
| ids | string | query | 否 | 用逗号隔开，最多支持10个id，id值为上一个接口返回的id字段 |
| translateFlag | boolean | query | 否 | 默认false（不翻译） |

## 3. 请求示例

Url: /yonbip/digitalModel/log-pub/business/rest/historyDetail?access_token=访问令牌&ids=&translateFlag=
	...
	"data": [
		{
			"data": {
				...
				"busiObjName": "周鹏",
				"newBusiObj": "{\"userAvatorNew\":\"\",\"sysId\":\"diwork\",\"userBigAvatorNew\":\"\",\"userName\":\"周鹏\",\"userId\":\"e43ba3e6-cb93-40e5-8042-e0d35065c0df\",\"tfa\":false,\"userCode\":\"YHT-239-4871705563275552\",\"loginTs\":\"1709263952692\",\"loginLimitAnswer\":\"CLOSE\",\"external\":false,\"userAvator\":\"\",\"userMobileCountrycode\":\"86\",\"userMobile\":\"176****3922\",\"userActivate\":true,\"userSmallAvatorNew\":\"\",\"typeId\":\"3\",\"userEmail\":\"\",\"registerDate\":\"2024-01-18 15:34:35\"}",
				"operCode": "",
				"operationName": "取消管理员",
