---
title: "社保：删除业务办理待减员接口"
apiId: "2155015861171650563"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/hrcloud/insuranceArchive/delStaffReduce
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
ids	string	是	否	待减员主表id，不可同时为空，单独传时，同时删除主子表数据 示例：["1950779385794002950"]
detailIds	string	是	否	待减员子表id

## 3. 请求示例

Url: /yonbip/hrcloud/insuranceArchive/delStaffReduce?access_token=访问令牌
Body: {
	"ids": [
		"1950779385794002950"
	],
