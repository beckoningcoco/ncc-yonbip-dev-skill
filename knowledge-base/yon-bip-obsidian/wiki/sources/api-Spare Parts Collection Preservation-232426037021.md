...
请求地址	/yonbip/am/sppsparepartlist/delete
请求方式	POST
...
id	string	否	是	备件清单id 示例：1607154170807713801

## 3. 请求示例

Url: /yonbip/am/sppsparepartlist/delete?access_token=访问令牌
Body: {
	"data": [
		{
