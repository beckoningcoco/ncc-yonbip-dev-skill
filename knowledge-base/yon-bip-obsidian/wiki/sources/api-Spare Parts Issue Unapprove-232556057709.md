...
请求地址	/yonbip/ACC/sppsparepartrequisitioncard/unsubmit
请求方式	POST
...
id	string	否	否	备件领用主键 示例：2324314813241491461

## 3. 请求示例

Url: /yonbip/ACC/sppsparepartrequisitioncard/unsubmit?access_token=访问令牌
Body: {
	"data": [
		{
