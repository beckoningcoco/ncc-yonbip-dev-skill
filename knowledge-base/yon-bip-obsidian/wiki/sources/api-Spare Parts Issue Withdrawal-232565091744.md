...
请求地址	/yonbip/ACC/sppsparepartrequisitioncard/uncommit
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	是	否	备件领用参数项
id	string	否	否	备件领用主键 示例：2325569003828805633

## 3. 请求示例

Url: /yonbip/ACC/sppsparepartrequisitioncard/uncommit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "2325569003828805633"
		}
	]
}
