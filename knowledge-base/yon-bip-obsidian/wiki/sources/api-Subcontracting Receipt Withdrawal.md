...
请求地址	/yonbip/scm/osminrecord/batchunsubmit
...
| id | number |
| 小数位数:0,最大长度:30 | 否 | 是 | 委外入库单主表id 示例：22827969960554455 |

## 3. 请求示例

Url: /yonbip/scm/osminrecord/batchunsubmit?access_token=访问令牌
Body: {
	"data": [
		{
...
| 小数位数:8,最大长度:29 | 否 | 整单数量 |
| moneysum | number |
| 小数位数:8,最大长度:29 | 否 | 金额 |
| orisum | number |
| 小数位数:8,最大长度:29 | 否 | 含税金额 |
| orimoney | number |
| 小数位数:8,最大长度:29 | 否 | 无税金额 |
| tax | number |
| 小数位数:8,最大长度:29 | 否 | 税额 |
| printCount | number |
| 小数位数:0,最大长度:30 | 否 | 打印次数 |
| custom | string | 否 | 客户id |
| pubts | string | 否 | 时间戳 |
| tplid | string | 否 | 模板id |
| totalPieces | number |
| 小数位数:0,最大长度:30 | 否 | 整单件数 |
