---
title: "委外核销调整取已核销的委外入库单"
apiId: "a7fd0049010d48caa4fd5df5c6594ba5"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/mfg/verificationadjust/receipt/list
请求方式	POST
...
vouchdate	string	否	否	入库日期（区间，格式 2021-03-02|2021-03-02 23:59:59）) 示例：10
code	string	否	否	入库单号
warehouse	long	是	否	入库仓库id
...
Url: /yonbip/mfg/verificationadjust/receipt/list?access_token=访问令牌
Body: {
	"pageIndex": 0,
	"pageSize": 0,
	"osmOrg": [
		...
		"recordList": [
			{
				...
				"detailPubts": "2021-12-22 16:31:28",
				"rowno": 1,
				"purinType": 0,
