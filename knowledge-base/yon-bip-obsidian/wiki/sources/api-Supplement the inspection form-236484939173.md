...
请求地址	/yonbip/MFC/inspectorder/fillIn
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	否	是	主数据对象
resubmitCheckKey	string	否	否	保证请求的幂等性,该值由客户端生成,并且必须是全局唯一的，长度不能超过32位。更多信息,请参见«MDD幂等性»
id	string	否	否	检验单id 示例: 1539608448409796618
code	string	否	否	检验单号：id、code任选一个即可，同时传入id为准 示例: LLJY202301010001
qms_qit_incominspectorder_bList	object	是	否	检验信息

## 3. 请求示例

Url: /yonbip/MFC/inspectorder/fillIn?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"id": "",
		...
		"qms_qit_incominspectorder_bList": [
			{
				...
				"inspectTime": "2026-06-07 13:18:31",
				"note": "",
				"coord": true,
				...
				"qms_qit_incominspectorder_detailresultList": [
					{
						...
						"stockStatusCode": "",
						"inStockBatchCode": "",
						"produceDate": "2026-06-07 13:18:31",
						"validityDate": "2026-06-07 13:18:31",
						"destroySimpleResult": 0,
						"baditemFlag": "",
						"qualityGrade": 0,
						"qualifyGrade": "",
