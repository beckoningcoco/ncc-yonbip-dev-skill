---
title: "供应商退款详情查询"
apiId: "8b66cfc262a245c39c739f07345b4c30"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Accounts Payable (FI)
...
请求地址	/yonbip/fi/refundbill/detail
...
| id | string | query | 是 | 供应商退款单ID |

## 3. 请求示例

Url: /yonbip/fi/refundbill/detail?access_token=访问令牌&id=
