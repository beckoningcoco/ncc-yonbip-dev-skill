...
请求地址	/yonbip/cpu/api/supplyStatusChange/approve
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
id	string	否	是	单据ID 示例：1875154744209047552
approved	boolean	否	是	是否审批通过；通过 true，未通过 false 示例：true 默认值：true

## 3. 请求示例

Url: /yonbip/cpu/api/supplyStatusChange/approve?access_token=访问令牌
Body: {
	"id": "1875154744209047552",
	"approved": true
}
