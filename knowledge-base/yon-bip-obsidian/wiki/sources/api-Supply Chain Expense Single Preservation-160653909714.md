---
title: "供应链费用单单个保存（销售无来源）"
apiId: "1606539097142198277"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/sd/scmmp/expense/saveNoSource
请求方式	POST
...
busitype	string	否	是	交易类型，传id或code 示例：XSFY
...
Url: /yonbip/sd/scmmp/expense/saveNoSource?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
