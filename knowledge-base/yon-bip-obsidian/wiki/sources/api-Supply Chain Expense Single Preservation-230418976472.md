---
title: "供应链费用单单个保存（采购无来源）"
apiId: "2304189764722491392"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/SCC/scmmp/expense/save4ApiPurinrecordNoSource
请求方式	POST
...
busitype	string	否	是	交易类型，传id或code 示例：CGFY
...
Url: /yonbip/SCC/scmmp/expense/save4ApiPurinrecordNoSource?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
