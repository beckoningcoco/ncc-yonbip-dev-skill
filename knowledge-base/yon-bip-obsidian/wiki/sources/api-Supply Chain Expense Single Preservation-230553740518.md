---
title: "供应链费用单单个保存（调入无来源）"
apiId: "2305537405188308993"
apiPath: "请求方式	POST"
...
请求地址	/scmmp.sce_expense/scmmp.sce_expense/scmmp/expense/save4ApiStoreInNoSource
请求方式	POST
...
busitype	string	否	是	交易类型，传id或code 示例：KCFY
orgId	string	否	是	费用发生组织，传id或code 示例：1504710361780584453
...
settlementOrg	string	否	是	费用核算组织，传id或codee 示例：1580586027115347976
...
Url: /scmmp.sce_expense/scmmp.sce_expense/scmmp/expense/save4ApiStoreInNoSource?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"code": "FYD20221101000004",
		"busitype": "KCFY",
		"orgId": "1504710361780584453",
...
busitype_name	string	否	交易类型 示例：入库费用
