---
title: "供应链费用单单个调出来源保存"
apiId: "2305539269204115461"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/SCC/scmmp/expense/saveStoreOut
...
| settlementOrg | string | 否 | 否 | 费用核算组织，传id或codee 示例：1580586027115347976 |
...
Url: /yonbip/SCC/scmmp/expense/saveStoreOut?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		...
		"expenseDetail": [
			{
				"_status": "Insert",
				"source": "ustock.st_storeout",
				"sourceautoid": "1580603773907632129",
				"upcode": "UO-797620221031000001",
				"upcodeno": 10,
				"bCost": true,
...
| sourceType | string | 否 | 来源单据类型，quote_salesquotation:销售报价单，voucher_order:销售订单，st_salesout:销售出库单，sact_salescontract:销售合同 示例：voucher_order |
| exchRateType | string | 否 | 汇率类型 示例：0000L5NBULW8DCKNIA0000 |
| settlementOrg_name | string | 否 | 费用核算组织 示例：JS-全职能 |
...
| businessProperty | string | 否 | 业务属性 示例：{"businessProperty":"1"} |
...
| postAccountStatus | short | 否 | 过账状态，0:不过账，1:过账中，2:过账成功，3:过账失败，99:未过账 示例：99 |
...
| upcode | string | 否 | 来源单据号 示例：UO-797620221031000001 |
| invoicingAgentId | long | 否 | 开票客户id 示例：1580599375874752512 |
...

{
	...
	"data": {
		...
		"exchRateType": "0000L5NBULW8DCKNIA0000",
		"settlementOrg_name": "JS-全职能",
		"status": 0,
		"currency_moneyDigit": 4,
		"code": "FYD20221101000004",
		"businessProperty": "{\"businessProperty\":\"1\"}",
		...
		"upcode": "UO-797620221031000001",
		"invoicingAgentId": 1580599375874752512,
		"headItem": {
