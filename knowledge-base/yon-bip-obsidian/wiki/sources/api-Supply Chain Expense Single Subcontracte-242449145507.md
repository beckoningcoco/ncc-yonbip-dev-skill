---
title: "供应链费用单单个委外来源保存"
apiId: "2424491455072436230"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/SCC/scmmp/expense/saveSubcontracted
请求方式	POST
...
Url: /yonbip/SCC/scmmp/expense/saveSubcontracted?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
...
busitype_name	string	否	交易类型 示例：委外费用
...
sourceType	string	否	来源单据类型，po_subcontract_order:委外订单，st_osminrecord:委外入库 示例：st_osminrecord
