---
title: "同步续签单子至台账"
apiId: "04547ba0bddc4c02b3537531fbf176fa"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/hrcloud/contract/renewal/save
请求方式	POST
...
newworkaddr	string	否	否	工作地点id(香雪没有该字段)
newworkaddrname	string	否	否	工作地点
newmemo	string	否	否	备注
id	string	否	是	OA系统id
code	string	否	否	单据编码(自动编码情况下，可以为空)
extension	string	否	否	扩展字段(json格式自定义项集合)
renewalAttrextItem	object	否	否	自定义项

## 3. 请求示例

Url: /yonbip/hrcloud/contract/renewal/save?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"name": "",
