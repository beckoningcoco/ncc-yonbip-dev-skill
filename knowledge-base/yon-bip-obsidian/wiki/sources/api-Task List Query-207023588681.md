...
pageSize	number
小数位数:-1,最大长度:4	否	是	每页行数 示例：10 默认值：10
code	string	否	否	任务编号 示例：20240826000667
taskTransType	string	否	否	任务类型 示例：1894506741548711944
terminal	string	否	否	终端 示例：1918202754733441029
...
customer	string	否	否	客户 示例：1736253199748169729

## 3. 请求示例

Url: /yonbip/crm/task/list?access_token=访问令牌
Body: {
	"code": "20240826000667",
	"message": "操作成功",
	"data": {
		"recordList": [
			{
				...
				"terminal_longitude": 116.408024,
				"dynamic_name": "测试移交终端02",
				"planTask": false,
				...
				"excutorsContainStaff": false,
				"executorAndExecuteStatus": "郝娟 | 已完成  王天驰 | 已完成  ",
				"executors": [
					"1815673965450887175",
					"1686612861107830786"
				],
				"isExistDownstream": false
			}
		]
	},
	"pageIndex": 1,
	"pageSize": 10,
	"taskTransType": "1894506741548711944",
	"terminal": "1918202754733441029",
	"simpleVOs": [
		{
			"field": "",
			"op": "",
