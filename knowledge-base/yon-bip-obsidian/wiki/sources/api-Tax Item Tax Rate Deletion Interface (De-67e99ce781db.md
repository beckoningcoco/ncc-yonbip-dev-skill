---
title: "税目税率删除接口（废弃）"
apiId: "67e99ce781db417cbe0446d5358f4b8b"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/taxrate/delete
请求方式	POST
...
名称	类型	数组	必填	描述
data	object	是	是	数据
id	string	否	是	主键id 示例：0e5644daee584268bd91c5c49f9e0033

## 3. 请求示例

Url: /yonbip/digitalModel/taxrate/delete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "0e5644daee584268bd91c5c49f9e0033"
		}
	]
}
