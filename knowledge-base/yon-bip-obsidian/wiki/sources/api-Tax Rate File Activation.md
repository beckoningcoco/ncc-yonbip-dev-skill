...
请求地址	/yonbip/tax/yonbip-fi-taxpubdoc/openapi/taxRate/enable
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 否 | 是 | 启用的税率档案 |
| id | long | 否 | 是 | 主键 示例：1577764267860426800 |

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxpubdoc/openapi/taxRate/enable?access_token=访问令牌
Body: {
	"data": {
...
999	traceId:86e5d51632408a12;错误信息:启用税率档案入参不能为空	入参不正确或服务端逻辑异常
