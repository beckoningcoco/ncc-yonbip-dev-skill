...
请求地址	/yonbip/digitalModel/tax/api/rate/query-all
...
Url: /yonbip/digitalModel/tax/api/rate/query-all?access_token=访问令牌
Body: {
	"pageIndex": 1,
	"pageSize": 10,
