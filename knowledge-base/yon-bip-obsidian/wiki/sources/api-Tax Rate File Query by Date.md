...
请求地址	/yonbip/tax/yonbip-fi-taxpubdoc/openapi/taxRate/findByTime
...
| startTime | string | query | 是 | 起始时间(yyyy-MM-dd HH:mm:ss)    示例: 2022-10-26 00:00:00 |
| endTime | string | query | 是 | 结束时间(yyyy-MM-dd HH:mm:ss）    示例: 2022-10-26 00:00:00 |

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxpubdoc/openapi/taxRate/findByTime?access_token=访问令牌&startTime=2022-10-26%2000%3A00%3A00&endTime=2022-10-26%2000%3A00%3A00
...
| taxfree | boolean | 否 | 免税 （是-true，否-false） 示例：false |
| notaxation | boolean | 否 | 不征税 （是-true，否-false） 示例：false |
...
| isGlobal | string | 否 | 是否预置数据（Y-预置，N-非预置） 示例：N |
...
999	Unparseable date: \"2023-02-01\"	入参不正确或服务端逻辑异常
