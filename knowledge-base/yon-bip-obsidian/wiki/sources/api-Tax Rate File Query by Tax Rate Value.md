...
请求地址	/yonbip/tax/yonbip-fi-taxpubdoc/openapi/taxRate/findByTaxRate
...
| taxRate | BigDecimal | query | 是 | 税率值    示例: 0.03 |

## 3. 请求示例

Url: /yonbip/tax/yonbip-fi-taxpubdoc/openapi/taxRate/findByTaxRate?access_token=访问令牌&taxRate=0.03
