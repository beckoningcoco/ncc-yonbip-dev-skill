...
请求地址	/yonbip/EFI/earap/openapi/bill/payment/batchdelete
...
| code | string | 否 | 是 | 单据编号 示例：PAYap240326000736 |

## 3. 请求示例

Url: /yonbip/EFI/earap/openapi/bill/payment/batchdelete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "1484061404544630789",
			"code": "PAYap240326000736"
		}
	]
}
