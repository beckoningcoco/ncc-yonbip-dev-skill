...
请求地址	/yonbip/scm/reservation/delete
...
| id | string | 否 | 否 | id 示例：1591639898531561480 |

## 3. 请求示例

Url: /yonbip/scm/reservation/delete?access_token=访问令牌
Body: {
	"data": [
		{
...
| traceId | string | 否 | traceId 示例：c575e259108b8569 |
