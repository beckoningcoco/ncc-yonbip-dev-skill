...
>  请求方式	POST | Transfer Order (MM)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/scm/transferapply/batchunauditToERP
请求方式	POST
...
Url: /yonbip/scm/transferapply/batchunauditToERP?access_token=访问令牌
Body: {
	"barcode": "",
	"bustype_code": "",
	"outorg": "",
