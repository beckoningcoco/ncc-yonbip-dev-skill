...
请求地址	/yonbip/scm/storetransfer/batchunsubmit
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 是 | 请求体 |
| id | long | 否 | 是 | 转库库单主表id 示例：2282796996055296 |

## 3. 请求示例

Url: /yonbip/scm/storetransfer/batchunsubmit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2282796996055296
		...
		"infos": [
			{
				...
				"barCode": "st_storetransfer|2762748637384960",
				"createTime": "2022-05-06 16:13:15",
				"status": 0,
				"code": "ZK20220506000006"
			}
		],
		"failInfos": [
			{}
