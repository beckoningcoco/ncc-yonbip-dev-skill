---
title: "调拨申请弃审"
apiId: "021849987d1b4971b61da438f25395ec"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/scm/transferreq/batchunaudit
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 否 | 调拨申请列表[st.demandapply.DemandApply] |
| id | long | 否 | 是 | 主表id 示例：1915883316809984 |

## 3. 请求示例

Url: /yonbip/scm/transferreq/batchunaudit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1915883316809984
...
| successCountAI | string | 否 | 成功次数 示例：1 |
| failCount | string | 否 | 失败次数 示例：0 |
| sucessCount | string | 否 | 成功次数 示例：0 |
| infos | object | 是 | 详细信息 |
