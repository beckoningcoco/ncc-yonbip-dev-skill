...
请求地址	/yonbip/scm/transferreq/batchsubmit
...
| data | object | 是 | 是 | 请求体 |
| id | number |
| 小数位数:0,最大长度:30 | 否 | 是 | 调拨申请主表id 示例：2282796996055296 |

## 3. 请求示例

Url: /yonbip/scm/transferreq/batchsubmit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2282796996055296
		...
		"infos": [
			{
				...
				"creator": "名字",
				"inorg": "2370726716642816",
				"outorg": "2370726716642816",
				"isWfControlled": true,
				"outWarehouse": 2353514945827072,
				"demandWarehouse": 2353514945827072,
				"businesstype": "2352475250610689",
				"barCode": "st_transferreq|2762748637384960",
