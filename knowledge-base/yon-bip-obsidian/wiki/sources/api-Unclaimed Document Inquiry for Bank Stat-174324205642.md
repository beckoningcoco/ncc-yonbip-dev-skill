...
请求地址	/yonbip/ctm/cmp/claimCenterListQuery
请求方式	POST
...
accentity_code	string	否	否	账户使用组织编码；只有会计主体id为空时该条件生效 示例：110
...
Url: /yonbip/ctm/cmp/claimCenterListQuery?access_token=访问令牌
Body: {
	"pageIndex": 0,
	"pageSize": 0,
