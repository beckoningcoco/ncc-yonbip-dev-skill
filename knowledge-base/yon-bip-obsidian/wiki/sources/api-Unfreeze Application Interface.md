...
| unfreezereason | string | 否 | 否 | 解冻原因 |
| extend_creator | string | 否 | 否 | 解冻申请创建人 示例：创建人 |

## 3. 请求示例

Url: /yonbip/ctm/cmp/unfreeze?access_token=访问令牌
Body: {
	"bank_seq_no": "",
	"unfreezereason": "",
	"extend_creator": "创建人"
