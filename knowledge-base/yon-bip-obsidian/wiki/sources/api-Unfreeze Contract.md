...
请求地址	/yonbip/znbz/apct/openapi/bill/unfreeze
...
| reason | string | 否 | 否 | 原因 示例：由于XXX,解冻该合同 |
...
Url: /yonbip/znbz/apct/openapi/bill/unfreeze?access_token=访问令牌
Body: {
	"custMap": {
		"reason": "由于XXX,解冻该合同"
	},
...
999	"付款合同查询失败，未找到对应的付款合同"	"付款合同查询失败，未找到对应的付款合同"
