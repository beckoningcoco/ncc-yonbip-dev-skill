---
title: "更新质检信息"
apiId: "81c2cdce314f462793c168adf4f3d7b6"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/imcs/inspectioninfoapi/updateInspectInfo
请求方式	POST
...
check_sourcetrowID	string	否	是	请检单据行id：完工报告行id/到货单行id/工序任务汇报行id 示例：2373711808401665
...
Url: /yonbip/imcs/inspectioninfoapi/updateInspectInfo?access_token=访问令牌
Body: {
	"data": [
		{
			...
			"dataList": [
				{
					...
					"materialCode": "",
					"pk_batchcode": "PCDA0000000020220714000001",
					"workCenterId": "1498147213647806465",
					"workCenterCode": "",
					"orderProcessId": "1498146320294608904",
					"orderProcessCode": "",
					"orderProcessSn": "10"
				}
			]
...
check_sourcetnum	string	否	请检单据号:完工报告/到货单单据号 示例：WGBG20210804000001
