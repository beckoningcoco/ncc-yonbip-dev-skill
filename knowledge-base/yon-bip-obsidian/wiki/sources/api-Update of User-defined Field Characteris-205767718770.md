...
请求地址	/yonbip/cpu/contract/updateContractDefineCharacter
请求方式	POST
...
contractMaterialList	object	是	否	采购合同物料子表信息
contractPayTermList	object	是	否	采购合同付款协议子表

## 3. 请求示例

Url: /yonbip/cpu/contract/updateContractDefineCharacter?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 1879562417295616,
...
请求参数 (8)
新增
返回参数 collaborativeProcesse
新增
返回参数 moneyControlType
新增
返回参数 moneyRatio
更新
返回参数 controlType
合同签订形式枚举描述修改，新增非必填字段金额控制方式和金额超量比例
