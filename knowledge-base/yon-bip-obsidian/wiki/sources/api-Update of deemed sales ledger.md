...
请求地址	/yonbip/tax/yonbip-fi-taxoth/api/tax-deem-sale/batch-update
...
| id | string | 否 | 是 | 数据唯一标识，取自新增接口返回的id字段 示例：2068869013467299849 |
| orgCode | string | 否 | 是 | 组织编码，不支持更新，这里传入的值必须等于旧值 示例：0706 |
...
Url: /yonbip/tax/yonbip-fi-taxoth/api/tax-deem-sale/batch-update?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "2068869013467299849",
			"orgCode": "0706",
			"projectCode": "*****999B-",
			"saleType": "6",
			"busCode": "20240818002",
