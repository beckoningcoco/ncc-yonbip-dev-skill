...
请求地址	/yonbip/tax/api/etax/redinfo-apply/upload
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| reqBillNos | string | 否 | 是 | 红字确认单请求流水号 示例：3123123 |

## 3. 请求示例

Url: /yonbip/tax/api/etax/redinfo-apply/upload?access_token=访问令牌
Body: [{
	"reqBillNos": "3123123"
}]
...
| hjje | number |
| 小数位数:2,最大长度:15 | 否 | 合计金额 示例：-0.88 |
| hjse | number |
| 小数位数:2,最大长度:15 | 否 | 合计税额 示例：-0.12 |
| jshj | number |
| 小数位数:2,最大长度:15 | 否 | 价税合计 示例：-1 |
