...
请求地址	/yonbip/digitalModel/bipauth/open/orgpermission/saveUserOrgPermission
请求方式	POST
...
userType	int	否	否	身份类型（身份类型与身份Id二选一必填）枚举列举：1:普通员工,2:客户管理员,3:客户业务员,4:商家管理员,5:商家业务员,6:外部参会人,7:供应商,11:开发者,30:其他外部人员 示例：1 默认值：1
yxyUserId	string	否	否	身份id（身份类型与身份id二选一必填） 示例：1622811912190820353
resourceId	string	是	否	组织资源Id（组织资源Id与组织资源编码二选一必填，二者同时存在，以Id为准，其中child://组织资源Id表示组织包含下级） 示例：["2451586070583040"]
resourceCode	string	是	否	组织资源编码（组织资源Id与组织资源编码二选一必填，二者同时存在，以Id为准，其中child://组织资源编码表示组织包含下级） 示例：["zz01"]
...
resourceFunction	string	否	否	资源功能类型 例：orgunit :业务单元 示例：orgunit 默认值：orgunit
...
Url: /yonbip/digitalModel/bipauth/open/orgpermission/saveUserOrgPermission?access_token=访问令牌
Body: {
