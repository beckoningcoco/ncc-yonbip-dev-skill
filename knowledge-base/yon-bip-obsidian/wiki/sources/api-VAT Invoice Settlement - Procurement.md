...
请求地址	/yonbip/tax/input-tax/api/purchase-account/settle
...
| invoices | object | 是 | 是 | 发票数组 |
| fpDm | string | 否 | 否 | 发票代码 有发票代码时必填 示例：0110xxxxxxx1 |
| fpHm | string | 否 | 是 | 发票号码 示例：xxxxxxx1 |

## 3. 请求示例

Url: /yonbip/tax/input-tax/api/purchase-account/settle?access_token=访问令牌
Body: {
