---
title: "增值税台账附件查询"
apiId: "f5b3fe0813a24388a9210f2761107b76"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/tax/input-tax/api/reimburseCollection/view-url
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| orgcode | string | 否 | 否 | 税务组织编码（纳税人识别号和税务组织编码至少传入一项） 示例：11223434 |
| nsrsbh | string | 否 | 否 | 纳税人识别号（纳税人识别号和税务组织编码至少传入一项） 示例：101011111111111 |
| invoices | object | 是 | 否 | 发票信息 |
| fpHm | string | 否 | 是 | 发票号码 示例：11111111 |
| fpDm | string | 否 | 是 | 发票代码 示例：111111111111 |

## 3. 请求示例

Url: /yonbip/tax/input-tax/api/reimburseCollection/view-url?access_token=访问令牌
Body: {
	"orgcode": "11223434",
