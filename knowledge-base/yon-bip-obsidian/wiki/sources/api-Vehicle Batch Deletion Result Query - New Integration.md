---
title: "车辆批量删除结果查询-新集成"
apiId: "2229812115250610179"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Vehicle (MD)
...
请求地址	/yonbip/digitalModel/basedoc/async/vehicle/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/basedoc/async/vehicle/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌

## 4. 返回值参数

| 名称 | 类型 | 数组 | 描述 |
| code | string | 否 | 返回值，正确返回200 示例：200 |
