---
title: "车辆删除记录分页查询-新集成"
apiId: "2229817836147048454"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/digitalModel/basedoc/vehicle/batchQueryDeleteLogs
请求方式	POST
...
ids	string	是	否	ids 示例：["2217333697757577223","2217333697757577224"]

## 3. 请求示例

Url: /yonbip/digitalModel/basedoc/vehicle/batchQueryDeleteLogs?access_token=访问令牌
Body: {
	"pageIndex": 1,
	"pageSize": 10,
...

{
	...
	"data": {
		...
		"recordList": [
			{
				"id": "2169657344473432066",
				"pubts": "2025-01-02 09:45:54"
			}
		]
	}
}
