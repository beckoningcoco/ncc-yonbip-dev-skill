...
>  请求方式	GET | Purchase Report (CRM)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/crm/cusposub/getbyid
请求方式	GET
...
id	long	query	是	进货上报主键    示例: 1976835500760629252

## 3. 请求示例

Url: /yonbip/crm/cusposub/getbyid?access_token=访问令牌&id=1976835500760629252
...
sumStockCount	number
小数位数:0,最大长度:10	否	总进货数量 示例：66
dept_code	string	否	部门编码 示例：XG01
bustype_code	string	否	交易类型编码 示例：002
ower	string	否	负责人 示例：1686612861107830786
professionalTime	string	否	单据日期 示例：2024-04-17 00:00:00
code	string	否	单据号 示例：20240417020010
sumStockMoney	number
小数位数:0,最大长度:10	否	总进货金额 示例：1485
...
clientStockUpRecordList	object	是	进货上报子表数据
		...
		"clientStockUpRecordList": [
			{
				...
				"stockUpRecordDefineCharacter__id": "1976835500760629254",
				"stockPrice": 22,
				"measurement": "1686627223449108487",
				"measurement_precision": 4,
				"clientStockUpId": "1976835500760629252",
				"measurement_name": "升",
				"stockMoney": 242,
