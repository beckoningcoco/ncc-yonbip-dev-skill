...
>  请求方式	GET | Sales Report (CRM)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/crm/cussosub/getbyid
请求方式	GET
...
id	long	query	是	销售上报主键    示例: 1976835500760629252

## 3. 请求示例

Url: /yonbip/crm/cussosub/getbyid?access_token=访问令牌&id=1976835500760629252
...
marketCount	number
小数位数:0,最大长度:10	否	总销售数量 示例：66
marketMoney	string	否	总销售金额 示例：66
...
id	string	否	销售上报单据行ID 示例：1976835500760629252
pubts	string	否	时间戳 示例：2024-04-17 14:05:41
clientMarketUpRecordList	object	是	销售上报子表数据
		...
		"clientMarketUpRecordList": [
			{
				...
				"clientMarketUpId": "20240417020010",
				...
				"stock_code": "000002",
				"stockCount": 11,
				"materialClass_name": "qqq",
				"materialClass": "1971643546650279941"
			}
		]
	}
}
