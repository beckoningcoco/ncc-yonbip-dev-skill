...
>  9. 接口变更日志 | Visit Summary (CRM)


## 1. 请求说明

请求域名	动态域名，获取方式详见 获取租户所在数据中心域名
请求地址	/yonbip/crm/rest/v1/openapi/queryBusinessFiles_visitsummary
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
businessIds	string	是	是	业务标识集合 示例：["2039078381559480323"]

## 3. 请求示例

Url: /yonbip/crm/rest/v1/openapi/queryBusinessFiles_visitsummary?access_token=访问令牌
Body: {
	"businessIds": [
		"2039078381559480323"
	]
...

{
	...
	"data": {
		"bussinessId": [
			{
				"fileId": "6565cf9f1xxa4b52490a9958",
...
1002	数据不存在	按照提示代码解决
310071	请求地址[https://bip-daily.yonyoucloud.com/iuap-apcom-file/rest/v1/openapi/queryBusinessFiles],状态码[400],错误消息[null]	调用格式错误
