---
title: "仓库批量删除结果查询-新集成"
apiId: "2247788331490344964"
apiPath: "请求方式	GET"
...
> `ContentType	application/json` 请求方式	GET | 分类: Warehouse (MD)
...
请求地址	/yonbip/digitalModel/coredoc/async/warehouse/batchDelete/getAsyncResult/{jobId}
...
Url: /yonbip/digitalModel/coredoc/async/warehouse/batchDelete/getAsyncResult/{jobId}?access_token=访问令牌
