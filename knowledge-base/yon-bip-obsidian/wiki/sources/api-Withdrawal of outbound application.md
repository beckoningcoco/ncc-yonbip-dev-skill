...
请求地址	/yonbip/scm/pickingrequisition/batchunsubmit
...
| id | number |
| 小数位数:0,最大长度:30 | 否 | 是 | 出库申请单主表id 示例：2282796996055296 |

## 3. 请求示例

Url: /yonbip/scm/pickingrequisition/batchunsubmit?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2282796996055296
