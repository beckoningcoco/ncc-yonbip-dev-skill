...
>  请求方式	POST | Collection Document (EFI)
...
请求地址	/yonbip/EFI/collection/unaudit
请求方式	POST
...
Url: /yonbip/EFI/collection/unaudit?access_token=访问令牌
Body: {
	"data": {
...
data	object	否	返回数据
id	string	否	收款单表头主键 示例：1513906350673362945
...
错误码	错误信息	描述
1002	数据不存在	按照提示代码解决
999	弃审失败,当前单据已弃审, 不允许重复操作!	输入有效且未弃审的单据id
