---
title: "工作中心分类停用"
apiId: "f1479780553143019345dfe9a0c9d804"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/mfg/workcenter-category/stop
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 是 | 工作中心分类数据集 |
| id | long | 否 | 是 | 工作中心分类id 示例：2115741750989056 |

## 3. 请求示例

Url: /yonbip/mfg/workcenter-category/stop?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2115741750989056
		...
		"infos": [
			{
				...
				"name": "44444",
				"id": 2115741750989056,
				"pubts": "2021-07-13 16:17:00",
				"orgId": "1453222427988224",
				"stoptime": "2021-07-13 16:17:00",
				"stopstatus": true,
