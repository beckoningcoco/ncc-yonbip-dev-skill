---
title: "工作中心停用"
apiId: "205ca301ae9848c6816d9136148ee3f1"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/mfg/workcenter/stop
...
| 名称 | 类型 | 数组 | 必填 | 描述 |
| data | object | 是 | 是 | 工作中心数据集 |
| id | long | 否 | 是 | 工作中心id 示例：2332625063727360 |

## 3. 请求示例

Url: /yonbip/mfg/workcenter/stop?access_token=访问令牌
Body: {
	"data": [
		{
			"id": 2332625063727360
		...
		"infos": [
			{
				...
				"stoptime": "2021-07-08 14:53:37",
				"stopstatus": true,
				"tenant": 1292161350684928,
				"pubts": "2021-07-08 14:53:37"
			}
		]
	}
}
