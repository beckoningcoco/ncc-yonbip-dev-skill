...
请求地址	/yonbip/am/ommexworkapplylist/delete
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
data	object	是	是	委外申请参数
id	string	否	是	委外申请主表主键 示例：1581322407753809920

## 3. 请求示例

Url: /yonbip/am/ommexworkapplylist/delete?access_token=访问令牌
Body: {
	"data": [
		{
			"id": "1581322407753809920"
		}
	]
}
