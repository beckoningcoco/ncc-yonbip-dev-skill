...
请求地址	/yonbip/ACC/ampubworktypelist/save
请求方式	POST
...
名称	类型	数组	必填	描述
data	object	是	否	数据
pk_org	string	否	是	维修组织id或编码 示例：cc
...
Url: /yonbip/ACC/ampubworktypelist/save?access_token=访问令牌
Body: {
	"data": [
		{
			"pk_org": "cc",
...
_entityName	string	否	实体名称 示例：ampub.worktype.WorkTypeVO
pk_org	string	否	维修组织 示例：1957640999752695842
...

{
	...
	"data": {
		...
		"_entityName": "ampub.worktype.WorkTypeVO",
