---
title: "工作通知标为已读-订阅集成场景"
apiId: "2043639465058500614"
apiPath: "请求方式	POST"
...
请求地址	/yonbip/uspace/notify/setRead
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
userId	string	否	是	消息接受人的友户通用户id
notifyIds	string	是	否	通知id, 订阅bip工作通知可获取

## 3. 请求示例

Url: /yonbip/uspace/notify/setRead?access_token=访问令牌
Body: {
	"userId": "",
	"notifyIds": [
		""
