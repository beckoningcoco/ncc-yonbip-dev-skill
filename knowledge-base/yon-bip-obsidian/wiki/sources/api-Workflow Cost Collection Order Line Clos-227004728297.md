...
请求地址	/yonbip/mfg/productionorder/costCollect/lineclose
请求方式	POST
...
Url: /yonbip/mfg/productionorder/costCollect/lineclose?access_token=访问令牌
Body: {
	"data": {
		"id": "2211732336611584",
...
verifystate	number
小数位数:0,最大长度:10	否	审批状态：0-开立，1-已提交，2-已审批，-1-驳回 示例：2
code	string	否	单据编码 示例：SCDD202106140001
