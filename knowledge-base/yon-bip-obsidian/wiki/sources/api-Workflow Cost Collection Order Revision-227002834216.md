...
请求地址	/yonbip/mfg/productionorder/costCollect/orderUpdate
请求方式	POST
...
id	number
小数位数:0,最大长度:19	否	是	主键，修改时必填 示例：1957365595279616
remark	string	否	否	备注 示例：XX工厂合同
orderProduct	object	是	否	产品行信息

## 3. 请求示例

Url: /yonbip/mfg/productionorder/costCollect/orderUpdate?access_token=访问令牌
Body: {
	"data": {
		"resubmitCheckKey": "",
		"id": 1957365595279616,
