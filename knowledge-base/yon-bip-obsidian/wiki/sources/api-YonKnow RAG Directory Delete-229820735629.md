...
请求地址	/yonbip/CPC/iuap-aip-ps/intellis/api/catalog/del
请求方式	POST
...
Body参数
名称	类型	数组	必填	描述
domainId	string	否	是	目录ID 示例："1000123011"
ytenantId	string	否	是	租户id，没有传0 示例："0"

## 3. 请求示例

Url: /yonbip/CPC/iuap-aip-ps/intellis/api/catalog/del?access_token=访问令牌
Body: {
	"domainId": "\"1000123011\"",
	"ytenantId": "\"0\""
}
