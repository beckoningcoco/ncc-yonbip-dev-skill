...
请求地址	/yonbip/SCCC/oa-logger/template/recentlyTemplates
请求方式	GET
ContentType	
应用场景	开放API
事务和幂等性	无
...
Url: /yonbip/SCCC/oa-logger/template/recentlyTemplates?access_token=访问令牌&tenantId=
...
data	object	否	数据
recentlyTemplates	object	是	最近模板列表
templates	object	是	模板
newFeature	boolean	否	新特性 示例：false
