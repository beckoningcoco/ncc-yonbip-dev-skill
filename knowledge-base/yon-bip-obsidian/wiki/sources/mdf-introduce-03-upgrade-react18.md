---
title: "React18适配方案"
source: "https://c2.yonyoucloud.com/iuap-yonbuilder-designer/ucf-wh/docs-mdf/mdf/index.html#/introduce/03-upgrade-react18"
section: "介绍"
date: 2026-06-07
ingested: 2026-06-07
tags: [MDF, 前端框架, 介绍]
...
> 来源：https://c2.yonyoucloud.com/iuap-yonbuilder-designer/ucf-wh/docs-mdf/mdf/index.html#/introduce/03-upgrade-react18 | 所属：介绍
...
React原生开发的工程更新引用的React地址，TNS内置了新的版本，需要在html入口文件中引入，引用示例如下：

<script type="text/javascript" src="/iuap-tns/ucf-wh/share/static/react/18.3.1/umd/react.production.min.js"></script>

<script type="text/javascript" src="/iuap-tns/ucf-wh/share/static/react-dom/18.3.1/umd/react-dom.production.min.js"></script>
...
注意：`ReactDOM.render方法可以不用修改，使用第3章节的垫片可以自动适配`
...
`目前还处于开发适配阶段，上线前会提供统一的垫片文件CDN地址`
