---
title: "CN使用MDF过滤区"
source: "https://c2.yonyoucloud.com/iuap-yonbuilder-designer/ucf-wh/docs-mdf/mdf/index.html#/spec/08-cn-use-mdf-filter"
section: "协议"
date: 2026-06-07
ingested: 2026-06-07
tags: [MDF, 前端框架, 协议]
...
> 来源：https://c2.yonyoucloud.com/iuap-yonbuilder-designer/ucf-wh/docs-mdf/mdf/index.html#/spec/08-cn-use-mdf-filter | 所属：协议

# [](#cn使用mdf过滤区)CN使用MDF过滤区
...
![](https://design.yonyoucloud.com/static/ucf/iuap-yonbuilder-designer.docs-mdf-fe/20250116-135007/mdf/static/cn-mdf-guolvqu.b08b3906.png)
...
class xxFilterr extends Component {
 ...
 this.model = new cb.models.ContainerModel({

 params: {

 billNo: "st_purchaseorder",

 cardKey: "st_purchaseorder",
 ...
 dom: document.getElementById('自定义id'),// 获取页面dom容器
