---
title: "日期 DatePicker"
source: "https://c2.yonyoucloud.com/iuap-yonbuilder-designer/ucf-wh/docs-mdf/ynf/index.html#/components/ynf-lib-base--date-picker"
section: "YNF-组件"
date: 2026-06-07
ingested: 2026-06-07
...
> 来源：https://c2.yonyoucloud.com/iuap-yonbuilder-designer/ucf-wh/docs-mdf/ynf/index.html#/components/ynf-lib-base--date-picker | 所属：YNF-组件

# [](#日期-datepicker)日期 DatePicker

输入或选择日期的控件。

import { DatePicker } from "ynf-lib-base"

## [](#何时使用)何时使用

- 当用户需求输入一个日期或者选择一个日期的时候，提升用户输入效率与体验。
...
||日期格式类型||format||'system' | 'YYYY-MM-DD' | 'YYYY-WW' | 'YYYY-MM' | 'YYYY-Q' | 'YYYY'||系统格式 | 年-月-日 | 年-周 | 年-月 | 季度 | 年||system|||
||最小可选日期||minDate||date||最小可选日期||-|||
||最大可选日期||maxDate||date||最大可选日期||-|||
||显示今天日期||showToday||boolean||显示今天日期||false|||
