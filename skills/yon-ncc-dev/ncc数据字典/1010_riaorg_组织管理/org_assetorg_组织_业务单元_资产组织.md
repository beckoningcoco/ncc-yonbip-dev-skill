...
**组织_业务单元_资产组织 (org_assetorg / nc.vo.org.AssetOrgVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3995.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_assetorg | 主键 | pk_assetorg | char(20) | √ | 主键 (UFID) |
...
| 6 | pk_financeorg | 默认财务组织 | pk_financeorg | varchar(20) |  | 组织_业务单元_财务组织 (financeorg) |
