...
**组织结构_预算组织体系 (org_budgetorgstru / nc.vo.corg.BudgetOrgStruVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4020.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_budgetorgstru | 预算组织体系主键 | pk_budgetorgstru | char(20) | √ | 主键 (UFID) |
