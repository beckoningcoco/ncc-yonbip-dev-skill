...
**组织_业务单元_工厂版本信息 (org_factory_v / nc.vo.vorg.FactoryVersionVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4056.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_vid | 版本主键 | pk_vid | char(20) | √ | 主键 (UFID) |
| 2 | pk_factory | 主键 | pk_factory | char(20) | √ | 组织_业务单元_工厂 (factory) |
