...
**组织_业务单元_维修组织版本信息 (org_maintainorg_v / nc.vo.vorg.MaintainOrgVersionVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4095.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_vid | 版本主键 | pk_vid | char(20) | √ | 主键 (UFID) |
| 2 | pk_maintainorg | 维修组织主键 | pk_maintainorg | char(20) | √ | 组织_业务单元_维修组织 (maintainorg) |
...
| 8 | pk_financeorg | 默认财务组织 | pk_financeorg | varchar(20) |  | 组织_业务单元_财务组织 (financeorg) |
