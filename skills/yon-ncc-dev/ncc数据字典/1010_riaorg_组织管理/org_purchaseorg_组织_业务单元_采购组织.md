...
**组织_业务单元_采购组织 (org_purchaseorg / nc.vo.org.PurchaseOrgVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4138.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_purchaseorg | 主键 | pk_purchaseorg | char(20) | √ | 主键 (UFID) |
