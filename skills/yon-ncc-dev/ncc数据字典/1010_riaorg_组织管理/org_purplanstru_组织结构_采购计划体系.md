...
**组织结构_采购计划体系 (org_purplanstru / nc.vo.corg.PurPlanStruVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4140.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_purplanstru | 采购计划体系主键 | pk_purplanstru | char(20) | √ | 主键 (UFID) |
