...
**组织结构_报表合并体系 (org_reportcombinestru / nc.vo.corg.ReportCombineStruVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4150.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_reportcombinestru | 报表合并体系主键 | pk_reportcombinestru | char(20) | √ | 主键 (UFID) |
