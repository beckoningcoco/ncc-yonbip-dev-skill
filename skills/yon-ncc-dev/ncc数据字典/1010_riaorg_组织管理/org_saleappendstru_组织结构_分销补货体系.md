...
**组织结构_分销补货体系 (org_saleappendstru / nc.vo.corg.SaleAppendStruVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4162.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_saleappendstru | 分销补货体系主键 | pk_saleappendstru | char(20) | √ | 主键 (UFID) |
