...
**报表管理体系视图样式 (org_vstl_report / nc.vo.uap.rbac.orgview.ReportGraphStyleVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4205.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_reportgraphstyle | 主键 | pk_reportgraphstyle | char(20) | √ | 主键 (UFID) |
