...
**库存统计体系视图样式 (org_vstl_stockstat / nc.vo.uap.rbac.orgview.StockStatGraphStyleVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4207.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_stockstatgraphstyle | 主键 | pk_stockstatgraphstyle | char(20) | √ | 主键 (UFID) |
