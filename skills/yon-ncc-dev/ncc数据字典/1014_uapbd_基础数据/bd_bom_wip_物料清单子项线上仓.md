...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/379.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbom_wipid | 物料清单线上仓 | cbom_wipid | char(20) | √ | 主键 (UFID) |
...
| 7 | cwipid | 线上仓 | cwipid | varchar(20) |  | 仓库 (stordoc) |
| 8 | nnum | 数量 | nnum | decimal(28, 8) |  | 数值 (UFDouble) |
| 9 | cassmeasureid | 单位 | cassmeasureid | varchar(50) |  | 字符串 (String) |
