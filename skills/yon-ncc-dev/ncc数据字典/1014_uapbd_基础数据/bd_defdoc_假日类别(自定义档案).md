...
**假日类别(自定义档案) (bd_defdoc / nc.vo.bd.defdoc.DefdocVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/491.html
...
| 5 | code | 假日类别编码 | code | varchar(40) | √ | 字符串 (String) |
| 6 | name | 假日类别名称 | name | varchar(200) |  | 多语文本 (MultiLangText) |
| 7 | shortname | 简称 | shortname | varchar(200) |  | 多语文本 (MultiLangText) |
| 8 | mnecode | 助记码 | mnecode | varchar(50) |  | 字符串 (String) |
| 9 | pid | 上级档案 | pid | varchar(20) |  | 假日类别(自定义档案) (Defdoc-BDHS01_0xx) |
