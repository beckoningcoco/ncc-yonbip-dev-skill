...
**医疗执行_医嘱类型(自定义档案) (bd_defdoc / nc.vo.bd.defdoc.DefdocVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/777.html
...
| 9 | pid | 上级档案 | pid | varchar(20) |  | 医疗执行_医嘱类型(自定义档案) (Defdoc-120100) |
