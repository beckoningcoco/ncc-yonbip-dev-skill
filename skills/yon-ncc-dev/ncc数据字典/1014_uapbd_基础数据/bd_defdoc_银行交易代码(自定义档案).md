...
**银行交易代码(自定义档案) (bd_defdoc / nc.vo.bd.defdoc.DefdocVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/493.html
...
| 9 | pid | 上级档案 | pid | varchar(20) |  | 银行交易代码(自定义档案) (Defdoc-SYS006_0xx) |
