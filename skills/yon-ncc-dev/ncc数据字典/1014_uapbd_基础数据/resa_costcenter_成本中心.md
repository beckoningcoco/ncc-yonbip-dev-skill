...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4891.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_costcenter | 成本中心标识 | pk_costcenter | char(20) | √ | 主键 (UFID) |
| 2 | pk_vid | 成本中心版本化主键 | pk_vid | char(20) |  | 主键 (UFID) |
