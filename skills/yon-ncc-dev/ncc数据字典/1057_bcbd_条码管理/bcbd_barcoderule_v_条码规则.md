...
**条码规则 (bcbd_barcoderule_v / nc.vo.bcbd.barcoderule.BarCodeRuleVersionVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/260.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_source | 原始版本 | pk_source | char(20) | √ | 主键 (UFID) |
| 2 | pk_barcoderule | 条码规则主键 | pk_barcoderule | char(20) | √ | 条码规则(多版本) (barcoderule) |
...
| 12 | complement | 补位方式 | complement | int | √ | 补位方式 (complement) |  | 1=左补位; |