...
**任务分类 (iufo_tasksort / nc.vo.iufo.task.TaskSortVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3525.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_tasksort | 任务分类主键 | pk_tasksort | char(20) | √ | 主键 (UFID) |
| 2 | name | 名称 | name | varchar(200) |  | 多语文本 (MultiLangText) |
| 3 | note | 描述 | note | varchar(1024) |  | 备注 (Memo) |
| 4 | pk_parent | 上级分类 | pk_parent | varchar(20) |  | 任务分类 (tasksort) |
