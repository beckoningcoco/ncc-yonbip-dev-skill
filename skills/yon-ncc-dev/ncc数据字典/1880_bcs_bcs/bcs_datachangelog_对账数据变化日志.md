...
**对账数据变化日志 (bcs_datachangelog / nc.vo.bcs.vouch.BCSDataChangeLogVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/271.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_obj | 对账数据变化日志主键 | pk_obj | char(20) | √ | 主键 (UFID) |
