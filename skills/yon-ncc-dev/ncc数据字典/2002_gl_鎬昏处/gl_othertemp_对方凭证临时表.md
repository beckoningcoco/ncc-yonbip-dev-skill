...
**对方凭证临时表 (gl_othertemp / nc.vo.gl.reconcile.othertemp.OtherTempVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2441.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_othertemp | 对方凭证临时表 | pk_othertemp | char(20) | √ | 主键 (UFID) |
| 2 | pk_reconcileoccur | 协同发生pk | pk_reconcileoccur | char(20) |  | 主键 (UFID) |
| 3 | pk_voucher | 本方凭证主键 | pk_voucher | char(20) |  | 主键 (UFID) |
| 4 | pk_selfcorp | 本方单位 | pk_selfcorp | char(4) |  | 主键 (UFID) |
| 5 | pk_othercorp | 对方单位 | pk_othercorp | char(4) |  | 主键 (UFID) |
| 6 | pk_vouchertype | 对方凭证类别主键 | pk_vouchertype | char(20) |  | 主键 (UFID) |
| 7 | voucherno | 对方凭证号 | voucherno | int |  | 整数 (Integer) |
| 8 | prepareddate | 对方制单日期 | prepareddate | char(10) |  | 日期 (UFDate) |
| 9 | pk_prepared | 对方制单人 | pk_prepared | varchar(20) |  | 字符串 (String) |
| 10 | totaldebit | 对方借方合计 | totaldebit | decimal(20, 4) |  | 数值 (UFDouble) |
| 11 | totalcredit | 对方贷方合计 | totalcredit | decimal(20, 4) |  | 数值 (UFDouble) |
| 12 | explanation | 对方摘要 | explanation | varchar(200) |  | 字符串 (String) |
| 13 | othervoucherobj | 对方凭证对象 | othervoucherobj | image |  | BLOB (BLOB) |
