...
**变更历史 (fct_ar_change / nc.vo.fct.ar.entity.CtArChangeVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2174.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_fct_ar_change | 变更历史主键 | pk_fct_ar_change | char(20) | √ | 主键 (UFID) |
| 2 | vchangecode | 版本号 | vchangecode | decimal(28, 8) |  | 数值 (UFDouble) |
| 3 | vchgpsn | 变更人 | vchgpsn | varchar(20) |  | 用户 (user) |
| 4 | vchgdate | 变更时间 | vchgdate | varchar(19) |  | 日期 (UFDate) |
