...
**合同条款 (fct_ar_term / nc.vo.fct.ar.entity.CtArTermVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2178.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_fct_ar_term | 合同条款主键 | pk_fct_ar_term | char(20) | √ | 主键 (UFID) |
