...
**收款合同 (fct_ar / nc.vo.fct.ar.entity.CtArVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2172.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_fct_ar | 收款合同主键 | pk_fct_ar | char(20) | √ | 主键 (UFID) |
...
| 21 | depid_v | 承办部门版本 | depid_v | varchar(20) |  | 组织_部门版本信息 (dept_v) |
