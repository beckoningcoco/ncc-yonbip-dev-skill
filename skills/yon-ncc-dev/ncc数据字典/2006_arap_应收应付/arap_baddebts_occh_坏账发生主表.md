...
**坏账发生主表 (arap_baddebts_occh / nc.vo.arap.baddebts.BaddebtsOcchVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/146.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_baddebts_occh | 坏账发生主表id | pk_baddebts_occh | char(20) | √ | 主键 (UFID) |
| 2 | pk_billtype | 单据类型 | pk_billtype | varchar(0) |  | 单据类型 (BilltypeVO) |
