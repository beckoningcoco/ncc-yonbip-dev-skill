...
**报销核销预提明细 (er_accrued_verify / nc.vo.erm.accruedexpense.AccruedVerifyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1874.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_accrued_verify | 唯一标识 | pk_accrued_verify | char(20) | √ | 主键 (UFID) |
| 2 | pk_accrued_bill | 预提单 | pk_accrued_bill | char(50) |  | 字符串 (String) |
| 3 | pk_accrued_detail | 预提明细行 | pk_accrued_detail | varchar(50) |  | 字符串 (String) |
