...
**报销类型 (er_reimtype / nc.vo.er.reimtype.ReimTypeVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1915.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_reimtype | 报销类型标识 | pk_reimtype | char(20) | √ | 主键 (UFID) |
