...
**盘盈明细 (fa_Profit_b / nc.vo.fa.profit.ProfitBVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2053.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_profit_b | 盘盈明细标识 | pk_profit_b | char(20) | √ | 主键 (UFID) |
...
| 10 | card_num | 数量 | card_num | int |  | 整数 (Integer) |
| 11 | pk_usedept | 使用部门 | pk_usedept | varchar(20) |  | 组织_部门 (dept) |
| 12 | pk_usedept_v | 使用部门版本信息 | pk_usedept_v | varchar(20) |  | 组织_部门版本信息 (dept_v) |
| 13 | pk_mandept | 管理部门 | pk_mandept | varchar(20) |  | 组织_部门 (dept) |
| 14 | pk_mandept_v | 管理部门版本信息 | pk_mandept_v | varchar(20) |  | 组织_部门版本信息 (dept_v) |
| 15 | pk_usingstatus | 使用状况 | pk_usingstatus | varchar(20) |  | 使用状况 (UsingStatusVO) |
| 16 | checkuser_name | 盘点人 | checkuser_name | varchar(100) |  | 字符串 (String) |
| 17 | useperson | 使用人 | useperson | varchar(20) |  | 人员基本信息 (psndoc) |
| 18 | position | 地点 | position | varchar(200) |  | 多语文本 (MultiLangText) |
| 19 | pk_card | 资产卡片 | pk_card | varchar(20) |  | 资产卡片 (asset) |
| 20 | remark | 备注 | remark | varchar(200) |  | 字符串 (String) |
| 21 | pk_ownerorg | 货主管理组织 | pk_ownerorg | varchar(20) |  | 组织 (org) |
| 22 | pk_ownerorg_v | 货主管理组织版本 | pk_ownerorg_v | varchar(20) |  | 组织_版本信息 (org_v) |
| 23 | pk_equiporg | 使用权 | pk_equiporg | varchar(20) |  | 组织 (org) |
| 24 | pk_equiporg_v | 使用权版本 | pk_equiporg_v | varchar(20) |  | 组织_版本信息 (org_v) |
