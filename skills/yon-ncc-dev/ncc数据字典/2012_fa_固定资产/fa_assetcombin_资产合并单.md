...
**资产合并单 (fa_assetcombin / nc.vo.fa.assetcombin.AssetCombinHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1988.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_assetcombin | 资产合并单主键 | pk_assetcombin | char(20) | √ | 主键 (UFID) |
