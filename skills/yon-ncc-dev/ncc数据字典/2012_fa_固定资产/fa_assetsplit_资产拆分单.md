...
**资产拆分单 (fa_assetsplit / nc.vo.fa.assetsplit.AssetSplitHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1993.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_assetsplit | 资产拆分单主键 | pk_assetsplit | char(20) | √ | 主键 (UFID) |
