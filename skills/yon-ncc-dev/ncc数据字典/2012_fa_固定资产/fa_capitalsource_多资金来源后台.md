...
**多资金来源后台 (fa_capitalsource / nc.vo.fa.assetcard.CapitalSourceVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1995.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_capitalsource | 主键 | pk_capitalsource | char(20) | √ | 主键 (UFID) |
