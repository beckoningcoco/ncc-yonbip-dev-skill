...
**费用 (fa_expenseview / nc.vo.fa.asset.ExpenseViewVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2021.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_expense | 主键 | pk_expense | char(20) | √ | 主键 (UFID) |
| 2 | occur_date | 发生日期 | occur_date | char(10) |  | 日期 (UFDate) |
| 3 | pk_costsubj | 收支项目 | pk_costsubj | varchar(20) |  | 收支项目 (inoutbusiclass) |
| 4 | digest | 摘要 | digest | varchar(200) |  | 字符串 (String) |
