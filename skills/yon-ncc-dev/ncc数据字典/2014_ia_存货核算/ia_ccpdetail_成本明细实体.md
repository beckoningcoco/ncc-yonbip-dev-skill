...
**成本明细实体 (ia_ccpdetail / nc.vo.ia.ccpdetail.entity.CcpDetailVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2797.html
...
| 9 | ccostcompid | 成本组件编码 | ccostcompid | varchar(20) |  | 成本组件 (bd_costcomponent) |
...
| 28 | nfactor1 | 成本要素1金额 | nfactor1 | decimal(28, 8) |  | 数值 (UFDouble) |
| 29 | nfactor2 | 成本要素2金额 | nfactor2 | decimal(28, 8) |  | 数值 (UFDouble) |
| 30 | nfactor3 | 成本要素3金额 | nfactor3 | decimal(28, 8) |  | 数值 (UFDouble) |
| 31 | nfactor4 | 成本要素4金额 | nfactor4 | decimal(28, 8) |  | 数值 (UFDouble) |
| 32 | nfactor5 | 成本要素5金额 | nfactor5 | decimal(28, 8) |  | 数值 (UFDouble) |
| 33 | nfactor6 | 成本要素6金额 | nfactor6 | decimal(28, 8) |  | 数值 (UFDouble) |
| 34 | nfactor7 | 成本要素7金额 | nfactor7 | decimal(28, 8) |  | 数值 (UFDouble) |
| 35 | nfactor8 | 成本要素8金额 | nfactor8 | decimal(28, 8) |  | 数值 (UFDouble) |
| 36 | nfactor9 | 成本要素9金额 | nfactor9 | decimal(28, 8) |  | 数值 (UFDouble) |
| 37 | nfactor10 | 成本要素10金额 | nfactor10 | decimal(28, 8) |  | 数值 (UFDouble) |
| 38 | nfactor11 | 成本要素11金额 | nfactor11 | decimal(28, 8) |  | 数值 (UFDouble) |
| 39 | nfactor12 | 成本要素12金额 | nfactor12 | decimal(28, 8) |  | 数值 (UFDouble) |
| 40 | nfactor13 | 成本要素13金额 | nfactor13 | decimal(28, 8) |  | 数值 (UFDouble) |
| 41 | nfactor14 | 成本要素14金额 | nfactor14 | decimal(28, 8) |  | 数值 (UFDouble) |
| 42 | nfactor15 | 成本要素15金额 | nfactor15 | decimal(28, 8) |  | 数值 (UFDouble) |
| 43 | nfactor16 | 成本要素16金额 | nfactor16 | decimal(28, 8) |  | 数值 (UFDouble) |
| 44 | nfactor17 | 成本要素17金额 | nfactor17 | decimal(28, 8) |  | 数值 (UFDouble) |
| 45 | nfactor18 | 成本要素18金额 | nfactor18 | decimal(28, 8) |  | 数值 (UFDouble) |
| 46 | nfactor19 | 成本要素19金额 | nfactor19 | decimal(28, 8) |  | 数值 (UFDouble) |
| 47 | nfactor20 | 成本要素20金额 | nfactor20 | decimal(28, 8) |  | 数值 (UFDouble) |