...
**产成品入库单明细 (ia_i3bill_b / nc.vo.ia.mi3.entity.I3ItemVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2817.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbill_bid | 产成品入库单明细 | cbill_bid | char(20) | √ | 主键 (UFID) |
...
| 22 | approver | 审核人 | approver | varchar(20) |  | 用户 (user) |
| 23 | taudittime | 审核时间 | taudittime | varchar(19) |  | 日期时间 (UFDateTime) |
...
| 26 | ccostcenterid | 成本中心 | ccostcenterid | varchar(20) |  | 成本中心 (resacostcenter) |
| 27 | cprofitcenterid | 利润中心 | cprofitcenterid | varchar(20) |  | 利润中心 (profitcenter) |
| 28 | cprofitcentervid | 利润中心版本 | cprofitcentervid | varchar(20) |  | 利润中心版本 (profitcenterVersion) |
| 29 | cvendorid | 供应商 | cvendorid | varchar(20) |  | 供应商基本信息 (supplier) |
...
| 45 | cicitemid | 库存子表 | cicitemid | varchar(20) |  | 字符串 (String) |
| 46 | pk_group | 所属集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 47 | pk_book | 所属账簿 | pk_book | varchar(20) |  | 账簿_财务核算账簿 (accountingbook) |
| 48 | pk_org | 成本域 | pk_org | varchar(20) |  | 组织_成本域 (costregion) |
| 49 | caccountperiod | 会计期间 | caccountperiod | varchar(7) |  | 字符串 (String) |
| 50 | dbilldate | 单据日期 | dbilldate | char(19) |  | 日期 (UFDate) |
| 51 | ccalcthreadid | 计算线索 | ccalcthreadid | varchar(20) |  | 字符串 (String) |
