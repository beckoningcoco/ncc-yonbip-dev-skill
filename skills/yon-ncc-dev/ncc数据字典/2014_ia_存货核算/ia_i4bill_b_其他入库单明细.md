...
**其他入库单明细 (ia_i4bill_b / nc.vo.ia.mi4.entity.I4ItemVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2819.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbill_bid | 其他入库单明细 | cbill_bid | char(20) | √ | 主键 (UFID) |
...
| 47 | caccountperiod | 会计期间 | caccountperiod | char(7) |  | 字符串 (String) |
