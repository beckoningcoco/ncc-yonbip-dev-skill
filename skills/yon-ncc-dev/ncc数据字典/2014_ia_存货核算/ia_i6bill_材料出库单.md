...
**材料出库单 (ia_i6bill / nc.vo.ia.mi6.entity.I6HeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2822.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbillid | 材料出库单 | cbillid | char(20) | √ | 主键 (UFID) |
...
| 18 | bwithdrawalflag | 是否假退料 | bwithdrawalflag | char(1) |  | 布尔类型 (UFBoolean) |
