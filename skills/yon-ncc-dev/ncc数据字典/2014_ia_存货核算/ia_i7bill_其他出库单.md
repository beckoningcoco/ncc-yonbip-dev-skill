...
**其他出库单 (ia_i7bill / nc.vo.ia.mi7.entity.I7HeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2824.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbillid | 其他出库单 | cbillid | char(20) | √ | 主键 (UFID) |
...
| 11 | cstordocmanid | 库管员主键 | cstordocmanid | varchar(20) |  | 人员基本信息 (psndoc) |
...
| 17 | cpsnid | 领料员 | cpsnid | varchar(20) |  | 人员基本信息 (psndoc) |
| 18 | ncost | 组装成本 | ncost | decimal(28, 8) |  | 数值 (UFDouble) |
...
| 25 | ctrantypeid | 出入库类型 | ctrantypeid | varchar(20) |  | 单据类型 (BilltypeVO) |
| 26 | dmakedate | 制单日期 | dmakedate | char(19) |  | 日期 (UFDate) |
| 27 | fbookflag | 账簿属性 | fbookflag | int |  | 账簿属性 (fbookflag) |  | 1=财务; |