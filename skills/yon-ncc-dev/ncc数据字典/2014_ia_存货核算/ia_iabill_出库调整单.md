...
**出库调整单 (ia_iabill / nc.vo.ia.mia.entity.IAHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2830.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbillid | 出库调整单 | cbillid | char(20) | √ | 主键 (UFID) |
...
| 14 | cbiztypeid | 业务类型 | cbiztypeid | varchar(20) |  | 业务流程 (BusitypeVO) |
| 15 | cpsnid | 业务员 | cpsnid | varchar(20) |  | 人员基本信息 (psndoc) |
| 16 | cotherstockorgid | 对方库存组织主键 | cotherstockorgid | varchar(20) |  | 组织_业务单元_库存组织 (stockorg) |
| 17 | cotherstockorgvid | 对方库存组织版本主键 | cotherstockorgvid | varchar(20) |  | 组织_业务单元_库存组织版本信息 (stockorg_v) |
| 18 | ccustomerid | 开票客户 | ccustomerid | varchar(20) |  | 客户基本信息 (customer) |
| 19 | fintransitflag | 发出商品标志 | fintransitflag | int |  | 发出商品标志 (intransit) |  | -1=非发出商品; |