...
**损益调整单 (ia_igbill / nc.vo.ia.mig.entity.IGHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2841.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbillid | 损益调整单 | cbillid | char(20) | √ | 主键 (UFID) |
...
| 16 | csrcmodulecode | 来源模块编码 | csrcmodulecode | varchar(10) |  | 字符串 (String) |
| 17 | vnote | 备注 | vnote | varchar(181) |  | 字符串 (String) |
| 18 | billmaker | 制单人 | billmaker | varchar(20) |  | 用户 (user) |
| 19 | iprintcount | 打印次数 | iprintcount | int |  | 整数 (Integer) |
| 20 | bsystemflag | 系统单据标志 | bsystemflag | char(1) |  | 布尔类型 (UFBoolean) |
| 21 | bconvertflag | 折算标志 | bconvertflag | char(1) |  | 布尔类型 (UFBoolean) |
| 22 | cvendorid | 供应商 | cvendorid | varchar(20) |  | 供应商基本信息 (supplier) |
| 23 | ctrantypeid | 出入库类型 | ctrantypeid | varchar(20) |  | 单据类型 (BilltypeVO) |
| 24 | dmakedate | 制单日期 | dmakedate | char(19) |  | 日期 (UFDate) |
| 25 | fbookflag | 账簿属性 | fbookflag | int |  | 账簿属性 (fbookflag) |  | 1=财务; |