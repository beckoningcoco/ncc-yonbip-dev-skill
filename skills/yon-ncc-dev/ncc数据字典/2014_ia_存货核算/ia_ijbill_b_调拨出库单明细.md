...
**调拨出库单明细 (ia_ijbill_b / nc.vo.ia.mij.entity.IJItemVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2846.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbill_bid | 调拨出库单明细 | cbill_bid | char(20) | √ | 主键 (UFID) |
