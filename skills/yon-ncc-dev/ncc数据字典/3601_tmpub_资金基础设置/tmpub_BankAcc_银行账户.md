...
**银行账户 (tmpub_BankAcc / nc.vo.tmpub.bd.nonbankfininstitution.BankAccVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5753.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_bankacc_b | 主键 | pk_bankacc_b | char(20) | √ | 主键 (UFID) |
...
| 7 | remark | 详细说明 | remark | varchar(200) |  | 备注 (Memo) |
...
| 11 | pk_srcbillrowid | 来源单据行主键 | pk_srcbillrowid | varchar(50) |  | 字符串 (String) |
| 12 | pk_fsrcbill | 源头单据主键 | pk_fsrcbill | varchar(50) |  | 字符串 (String) |
| 13 | pk_fsrcbilltypeid | 源头单据类型主键 | pk_fsrcbilltypeid | varchar(50) |  | 字符串 (String) |
| 14 | fsrcbilltypecode | 源头单据类型编码 | fsrcbilltypecode | varchar(50) |  | 字符串 (String) |
| 15 | rowno | 行号 | rowno | varchar(50) |  | 字符串 (String) |
| 16 | name | 名称 | name | varchar(200) |  | 多语文本 (MultiLangText) |
| 17 | code | 编码 | code | varchar(200) |  | 字符串 (String) |
| 18 | bankid | 开户行 | bankid | varchar(20) |  | 银行账户 (bankaccount) |
| 19 | default_flag | 默认 | default_flag | char(1) |  | 布尔类型 (UFBoolean) |
| 20 | enabler | 启用人 | enabler | varchar(50) |  | 字符串 (String) |
| 21 | enable_time | 启用时间 | enable_time | char(19) |  | 日期时间 (UFDateTime) |
| 22 | disabler | 停用人 | disabler | varchar(50) |  | 字符串 (String) |
| 23 | disable_time | 停用时间 | disable_time | char(19) |  | 日期时间 (UFDateTime) |
| 24 | enable_state | 启用状态 | enable_state | char(1) |  | 布尔类型 (UFBoolean) |
