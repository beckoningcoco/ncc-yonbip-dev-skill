...
**预处理签字确认日发生表 (cmp_signdaily / nc.vocmp.cmp_signdaily.signdaily)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1583.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_signdaily | 签字确认日发生表主键 | pk_signdaily | char(20) | √ | 主键 (UFID) |
...
| 24 | pk_mngaccount | 管理账户 | pk_mngaccount | varchar(20) |  | 银行账户 (bankaccount) |
| 25 | pk_corp | 公司 | pk_corp | varchar(20) |  | 组织_业务单元_公司 (corp) |
| 26 | unique_code | 唯一编码 | unique_code | varchar(50) |  | 字符串 (String) |
| 27 | unique_value | 唯一值 | unique_value | varchar(150) |  | 字符串 (String) |