...
**预处理签字确认年发生表 (cmp_signyearly / nc.vocmp.cmp_signyearly.signyearly)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1585.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_signyearly | 签字确认年发生表主键 | pk_signyearly | char(20) | √ | 主键 (UFID) |
...
| 21 | pk_mngaccount | 管理账户 | pk_mngaccount | varchar(20) |  | 银行账户 (bankaccount) |
| 22 | pk_corp | 公司 | pk_corp | varchar(20) |  | 组织_业务单元_公司 (corp) |
| 23 | pk_group | 集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 24 | unique_code | 唯一编码 | unique_code | varchar(50) |  | 字符串 (String) |
| 25 | unique_value | 唯一值 | unique_value | varchar(150) |  | 字符串 (String) |