...
**预处理记账日发生表 (cmp_tallydaily / nc.vocmp.cmp_tallydaily.cmp_tallydaily)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1588.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_tallydaily | 记账日发生表主键 | pk_tallydaily | char(20) | √ | 主键 (UFID) |
...
| 7 | billstatus | 单据状态 | billstatus | int |  | 整数 (Integer) |
...
| 12 | gathering | 收款原币发生 | gathering | decimal(28, 8) |  | 数值 (UFDouble) |
...
| 20 | fundformcode | 资金形态 | fundformcode | int |  | 整数 (Integer) |
...
| 25 | pk_corp | 公司 | pk_corp | varchar(20) |  | 组织_业务单元_公司 (corp) |
| 26 | pk_mngaccount | 管理账户 | pk_mngaccount | varchar(20) |  | 银行账户 (bankaccount) |
| 27 | unique_code | 唯一编码 | unique_code | varchar(50) |  | 字符串 (String) |
| 28 | unique_value | 唯一值 | unique_value | varchar(150) |  | 字符串 (String) |