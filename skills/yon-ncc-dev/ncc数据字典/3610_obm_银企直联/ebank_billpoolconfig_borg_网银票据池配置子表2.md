...
**网银票据池配置子表2 (ebank_billpoolconfig_borg / nc.vo.obm.ebankbillpoolconfig.BillPoolConfigBOrgVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1752.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_billpoolconfig_borg | 子表主键2 | pk_billpoolconfig_borg | char(20) | √ | 主键 (UFID) |
| 2 | pk_billpoolconfig | 主表主键 | pk_billpoolconfig | varchar(50) |  | 字符串 (String) |
