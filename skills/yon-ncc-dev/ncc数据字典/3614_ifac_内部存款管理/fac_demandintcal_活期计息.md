...
**活期计息 (fac_demandintcal / nc.vo.fac.ia.DemandIntCalVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2079.html
...
| 14 | pk_settledate | 结息日类型 | pk_settledate | varchar(20) |  | 结息日 (fi_settledate) |
| 15 | settlemode | 结息方式 | settlemode | varchar(50) |  | 计息方式 (IntmodeEnum) |  | 0=分别计息; |