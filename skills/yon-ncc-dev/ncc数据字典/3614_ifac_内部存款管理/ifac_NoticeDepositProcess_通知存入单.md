...
**通知存入单 (ifac_NoticeDepositProcess / nc.vo.ifac.notice.depositprocess.NoticeDepositProcessVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3104.html
...
| 8 | vbillstate | 单据状态 | vbillstate | int |  | 存单单据状态 (DepositProcessBillStateEnum) |  | 1=待提交; |