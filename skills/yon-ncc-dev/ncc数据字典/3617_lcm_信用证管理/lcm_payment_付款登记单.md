...
**付款登记单 (lcm_payment / nc.vo.lcm.open.payment.InvoicePaymentVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3574.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_payment | 主键 | pk_payment | char(20) | √ | 主键 (UFID) |
...
| 6 | pk_billtypecode | 单据类型编号 | pk_billtypecode | varchar(50) |  | 字符串 (String) |
