...
**内部领用办理明细 (cfbm_innerback_b / nc.vo.cfbm.innerback.InnerBackBVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1408.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_innerback_b | 主键 | pk_innerback_b | char(20) | √ | 主键 (UFID) |
...
| 8 | vrowno | 行号 | vrowno | varchar(20) |  | 字符串 (String) |
...
| 12 | olcbillamount | 组织本币金额 | olcbillamount | decimal(28, 8) |  | 金额 (UFMoney) |
| 13 | glcbillamount | 集团本币金额 | glcbillamount | decimal(28, 8) |  | 金额 (UFMoney) |
| 14 | gllcbillamount | 全局本币金额 | gllcbillamount | decimal(28, 8) |  | 金额 (UFMoney) |
