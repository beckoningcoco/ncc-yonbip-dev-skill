...
**清算单明细 (cfbm_reckon_b / nc.vo.cfbm.reckon.ReckonBVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1420.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_reckon_b | 子键 | pk_reckon_b | char(20) | √ | 主键 (UFID) |
