...
**票据调剂明细 (cfbm_redeploy_b / nc.vo.cfbm.redeploy.FbRedeployBVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1425.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_redeploy_b | 主键 | pk_redeploy_b | char(20) | √ | 主键 (UFID) |
...
| 10 | pk_outorg_fbacc | 调出组织票据账户 | pk_outorg_fbacc | varchar(20) |  | 内部账户 (bd_accid) |
| 11 | pk_outorg_inneracc | 调出组织活期账户 | pk_outorg_inneracc | varchar(20) |  | 内部账户 (bd_accid) |
| 12 | pk_outpayorg | 调出清算组织 | pk_outpayorg | varchar(20) |  | 组织_业务单元_财务组织 (financeorg) |
| 13 | pk_outpayorg_v | 调出清算组织版本 | pk_outpayorg_v | varchar(20) |  | 组织_业务单元_财务组织版本信息 (financeorg_v) |
| 14 | pk_outpayorg_inneracc | 调出清算账户 | pk_outpayorg_inneracc | varchar(20) |  | 内部账户 (bd_accid) |
| 15 | billamount | 票据金额 | billamount | decimal(28, 8) |  | 金额 (UFMoney) |
| 16 | olcbillamount | 票据金额组织本币金额 | olcbillamount | decimal(28, 8) |  | 金额 (UFMoney) |
| 17 | glcbillamount | 票据金额集团本币金额 | glcbillamount | decimal(28, 8) |  | 金额 (UFMoney) |
| 18 | gllcbillamount | 票据金额全局本币金额 | gllcbillamount | decimal(28, 8) |  | 金额 (UFMoney) |
...
| 22 | reckonamount | 清算金额 | reckonamount | decimal(28, 8) |  | 金额 (UFMoney) |
| 23 | olcreckonamount | 清算金额组织本币金额 | olcreckonamount | decimal(28, 8) |  | 金额 (UFMoney) |
| 24 | glcreckonamount | 清算金额集团本币金额 | glcreckonamount | decimal(28, 8) |  | 金额 (UFMoney) |
| 25 | gllcreckonamount | 清算金额全局本币金额 | gllcreckonamount | decimal(28, 8) |  | 金额 (UFMoney) |
| 26 | reckoninterest | 清算利息 | reckoninterest | decimal(28, 8) |  | 数值 (UFDouble) |
| 27 | olcreckoninterest | 清算利息组织本币金额 | olcreckoninterest | decimal(28, 8) |  | 金额 (UFMoney) |
| 28 | glcreckoninterest | 清算利息集团本币金额 | glcreckoninterest | decimal(28, 8) |  | 金额 (UFMoney) |
| 29 | gllcreckoninterest | 清算利息全局本币金额 | gllcreckoninterest | decimal(28, 8) |  | 金额 (UFMoney) |
| 30 | baseinfostatus | 票据状态 | baseinfostatus | varchar(50) |  | 字符串 (String) |
| 31 | enddate | 到期日期 | enddate | char(19) |  | 日期 (UFDate) |
