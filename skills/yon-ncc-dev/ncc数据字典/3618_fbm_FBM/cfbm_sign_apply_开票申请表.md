...
**开票申请表 (cfbm_sign_apply / nc.vo.cfbm.signapply.SignApplyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1429.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_sign_apply | 主键 | pk_sign_apply | char(20) | √ | 主键 (UFID) |
