...
**特转收款单回单 (fts_spegather_receipt / nc.vo.fts.spegather.receipt.SpeGatherReceiptVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2324.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_spegather_receipt_h | 特转收款单回单标识 | pk_spegather_receipt_h | char(20) | √ | 主键 (UFID) |
...
| 7 | vbillno | 特转收款回单号 | vbillno | varchar(50) |  | 字符串 (String) |
| 8 | vsourcebillno | 特转收款单号 | vsourcebillno | varchar(50) |  | 字符串 (String) |
