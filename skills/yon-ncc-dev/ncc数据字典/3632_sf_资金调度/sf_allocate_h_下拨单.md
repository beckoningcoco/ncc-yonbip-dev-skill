...
**下拨单 (sf_allocate_h / nc.vo.sf.allocate.AllocateVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5248.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_allocate_h | 下拨单标识 | pk_allocate_h | char(20) | √ | 主键 (UFID) |
...
| 8 | vbillno | 单据编号 | vbillno | varchar(50) |  | 字符串 (String) |
| 9 | busitype | 交易类型 | busitype | int |  | 交易类型 (busitype) |  | 1=集团下拨; |