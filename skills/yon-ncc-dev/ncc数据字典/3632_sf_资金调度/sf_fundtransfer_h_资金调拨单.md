...
**资金调拨单 (sf_fundtransfer_h / nc.vo.sf.fundtransfer.FundTransferVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5268.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_fundtransfer_h | 调拨单标识 | pk_fundtransfer_h | char(20) | √ | 主键 (UFID) |
