...
**还本计划 (icdmc_RepayprcplReceiptPlan / nc.vo.icdmc.icdmc.repayprcplreceipt.RepayprcplReceiptPlanVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3059.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_repayprcplr_p | 主键 | pk_repayprcplr_p | char(20) | √ | 主键 (UFID) |
...
| 11 | repaydate | 还本日期 | repaydate | char(19) |  | 日期 (UFDate) |
