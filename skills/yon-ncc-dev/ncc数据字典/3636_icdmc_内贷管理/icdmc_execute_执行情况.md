...
**执行情况 (icdmc_execute / nc.vo.icdmc.icdmc.contract.ExecuteVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3035.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_execute_b_icdmc | 主键 | pk_execute_b_icdmc | char(20) | √ | 主键 (UFID) |
...
| 22 | olcrepayamount | 组织本币还本金额 | olcrepayamount | decimal(28, 8) |  | 金额 (UFMoney) |
| 23 | glcrepayamount | 集团本币还本金额 | glcrepayamount | decimal(28, 8) |  | 金额 (UFMoney) |
| 24 | gllcrepayamount | 全局本币还本金额 | gllcrepayamount | decimal(28, 8) |  | 金额 (UFMoney) |
| 25 | olcpayinterest | 组织本币付息金额 | olcpayinterest | decimal(28, 8) |  | 金额 (UFMoney) |
| 26 | glcpayinterest | 集团本币付息金额 | glcpayinterest | decimal(28, 8) |  | 金额 (UFMoney) |
| 27 | gllcpayinterest | 全局本币付息金额 | gllcpayinterest | decimal(28, 8) |  | 金额 (UFMoney) |
| 28 | exectmark | 执行情况标识 | exectmark | varchar(50) |  | 字符串 (String) |
| 29 | rate | 利率 | rate | decimal(28, 8) |  | 数值 (UFDouble) |
| 30 | unrepayintstmny | 应付未付利息 | unrepayintstmny | decimal(28, 8) |  | 数值 (UFDouble) |
