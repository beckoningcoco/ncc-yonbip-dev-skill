...
**质押信息 (gpmc_GuaPleInf / nc.vo.gpmc.gpm.contract.GuaPledgeInfoVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2530.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_guapledgeinfo_b | 主键 | pk_guapledgeinfo_b | char(20) | √ | 主键 (UFID) |
...
| 20 | guapropertyid | 质押物id | guapropertyid | varchar(20) |  | 字符串 (String) |
