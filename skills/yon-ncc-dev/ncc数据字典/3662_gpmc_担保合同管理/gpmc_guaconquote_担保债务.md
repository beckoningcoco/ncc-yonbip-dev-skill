...
**担保债务 (gpmc_guaconquote / nc.vo.gpmc.gpm.guacontractquote.GuaContractQuoteVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2519.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_guacontractquote | 主键 | pk_guacontractquote | char(20) | √ | 主键 (UFID) |
...
| 8 | busistatus | 单据状态 | busistatus | int |  | 担保债务单据状态 (GpmcQuoteBillStatusEnum) |  | -1=自由; |