...
**委托贷款放款版本 (cdmc_consignfinancepay_v / nc.vo.cdmc.ccm.consigncreditfinancepay.version.ConsignCreditFinancepayVersionVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1335.html
...
| 7 | contractid | 合同编号 | contractid | varchar(20) |  | 委托贷款合同 (ConsignCreditContractVO) |
...
| 10 | busistatus | 单据状态 | busistatus | int |  | 放款单状态 (ConsignFinancepayBillStatusEnum) |  | -1=待提交; |