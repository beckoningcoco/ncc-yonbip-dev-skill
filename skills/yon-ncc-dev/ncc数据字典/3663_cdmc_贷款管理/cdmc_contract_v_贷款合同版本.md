...
**贷款合同版本 (cdmc_contract_v / nc.vo.cdmc.cdm.contract.version.ContractVersionVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1370.html
...
| 6 | vbillno | 单据编码 | vbillno | varchar(45) |  | 字符串 (String) |
...
| 9 | busistatus | 单据状态 | busistatus | int |  | 合同状态 (ContractStatusEnum) |  | -1=待提交; |