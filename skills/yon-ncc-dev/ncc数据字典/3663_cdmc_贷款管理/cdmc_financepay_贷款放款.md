...
**贷款放款 (cdmc_financepay / nc.vo.cdmc.cdm.financepay.FinancepayVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1372.html
...
| 5 | vbillno | 单据编码 | vbillno | varchar(100) |  | 字符串 (String) |
...
| 8 | busistatus | 单据状态 | busistatus | int |  | 放款单状态 (BillStatusEnum) |  | -1=待提交; |