...
**担保信息 (cdmc_finguarantee / nc.vo.cdmc.cdm.financepay.FinGuaranteeVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1381.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_guarantee_b | 主键 | pk_guarantee_b | char(20) | √ | 主键 (UFID) |
