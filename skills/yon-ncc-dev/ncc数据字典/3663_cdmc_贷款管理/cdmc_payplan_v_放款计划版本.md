...
**放款计划版本 (cdmc_payplan_v / nc.vo.cdmc.cdm.contract.version.PayPlanVersionVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1392.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_version_b | 主键 | pk_version_b | char(20) | √ | 主键 (UFID) |
| 2 | pk_payplan_b | 子表pk | pk_payplan_b | char(20) |  | 主键 (UFID) |
| 3 | payplancode | 放款编码 | payplancode | varchar(50) |  | 字符串 (String) |
| 4 | creditdate | 放款日期 | creditdate | char(19) |  | 日期时间 (UFDateTime) |
| 5 | paymny | 放款金额 | paymny | decimal(28, 8) |  | 数值 (UFDouble) |
| 6 | canpaymny | 可放款金额 | canpaymny | decimal(28, 8) |  | 数值 (UFDouble) |
| 7 | isquoted | 是否被引用 | isquoted | int |  | 整数 (Integer) |
| 8 | olcpayrate | 组织本币汇率 | olcpayrate | decimal(28, 8) |  | 数值 (UFDouble) |
| 9 | glcpayrate | 集团本币汇率 | glcpayrate | decimal(28, 8) |  | 数值 (UFDouble) |
| 10 | gllpayrate | 全局本币汇率 | gllpayrate | decimal(28, 8) |  | 数值 (UFDouble) |
| 11 | olcpaycdtlnamt | 组织本币额度 | olcpaycdtlnamt | decimal(28, 8) |  | 数值 (UFDouble) |
| 12 | glcpaycdtlnamt | 集团本币额度 | glcpaycdtlnamt | decimal(28, 8) |  | 数值 (UFDouble) |
| 13 | gllpaycdtlnamt | 全局本币额度 | gllpaycdtlnamt | decimal(28, 8) |  | 数值 (UFDouble) |
