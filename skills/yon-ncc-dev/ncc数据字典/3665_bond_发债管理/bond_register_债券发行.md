...
**债券发行 (bond_register / nc.vo.bond.bondmanage.register.BondRegisterVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1250.html
...
| 8 | busistatus | 单据状态 | busistatus | varchar(50) |  | 债券发行单据状态 (RegisterBillStatusEnum) |  | 0=待提交; |