...
**贷款放款记录 (batm_payrcpt / nc.vo.batm.cdmvo.PayrcptVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/233.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_payrcpt | 主键 | pk_payrcpt | char(20) | √ | 主键 (UFID) |
| 2 | pk_org | 财务组织 | pk_org | varchar(20) |  | 组织_业务单元_财务组织 (financeorg) |
| 3 | pk_group | 集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 4 | pk_org_v | 财务组织版本 | pk_org_v | varchar(20) |  | 组织_业务单元_财务组织版本信息 (financeorg_v) |
| 5 | billmakedate | 制单日期 | billmakedate | char(19) |  | 日期 (UFDate) |
| 6 | billsrc | 单据来源 | billsrc | varchar(50) |  | 字符串 (String) |
| 7 | pk_contract | 合同编号主键 | pk_contract | varchar(50) |  | 字符串 (String) |
| 8 | paycode | 放款编号 | paycode | varchar(50) |  | 字符串 (String) |
| 9 | contractcode | 合同号 | contractcode | varchar(50) |  | 字符串 (String) |
| 10 | pk_currtype | 币种 | pk_currtype | varchar(50) |  | 字符串 (String) |
| 11 | paydate | 放款日期 | paydate | char(19) |  | 日期 (UFDate) |
| 12 | payamount | 放款金额原币 | payamount | decimal(28, 8) |  | 金额 (UFMoney) |
| 13 | olcpayamount | 放款金额组织本币 | olcpayamount | decimal(28, 8) |  | 金额 (UFMoney) |
| 14 | glcpayamount | 放款金额集团本币 | glcpayamount | decimal(28, 8) |  | 金额 (UFMoney) |
| 15 | gllcpayamount | 放款金额全局本币 | gllcpayamount | decimal(28, 8) |  | 金额 (UFMoney) |
| 16 | vbillstatus | 当前状态 | vbillstatus | int |  | 整数 (Integer) |
