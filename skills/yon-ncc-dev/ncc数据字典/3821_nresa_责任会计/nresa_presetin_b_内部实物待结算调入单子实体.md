...
**内部实物待结算调入单子实体 (nresa_presetin_b / nc.vo.nresa.internalsettlement.prematter.PreSettleInItemVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3885.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbill_bid | 待结算调入单明细 | cbill_bid | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 所属集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 3 | pk_org | 调入利润中心 | pk_org | varchar(20) |  | 利润中心 (profitcenter) |
| 4 | dbilldate | 单据日期 | dbilldate | char(19) |  | 日期 (UFDate) |
| 5 | dbizdate | 业务日期 | dbizdate | char(19) |  | 日期 (UFDate) |
| 6 | crowno | 行号 | crowno | varchar(20) |  | 字符串 (String) |
| 7 | cinventoryid | 物料 | cinventoryid | varchar(20) |  | 物料基本信息 (material_v) |
| 8 | cinventoryvid | 物料编码 | cinventoryvid | varchar(20) |  | 物料基本信息（多版本） (material) |
...
| 15 | cqtunitid | 报价单位 | cqtunitid | varchar(20) |  | 计量单位 (measdoc) |
| 16 | nqtnum | 报价数量 | nqtnum | decimal(28, 8) |  | 数值 (UFDouble) |
| 17 | vqtunitrate | 报价换算率 | vqtunitrate | varchar(60) |  | 字符串 (String) |
| 18 | blargessflag | 赠品 | blargessflag | char(1) |  | 布尔类型 (UFBoolean) |
| 19 | ccalcid | 计算关系 | ccalcid | varchar(20) |  | 字符串 (String) |
| 20 | nsettlenum | 累计已结算主数量 | nsettlenum | decimal(28, 8) |  | 数值 (UFDouble) |
| 21 | bsettleendflag | 结算完成 | bsettleendflag | char(1) |  | 布尔类型 (UFBoolean) |
...
| 27 | vfirsttype | 源头单据类型 | vfirsttype | varchar(20) |  | 单据类型 (BilltypeVO) |
| 28 | vfirsttrantype | 源头交易类型 | vfirsttrantype | varchar(20) |  | 单据类型 (BilltypeVO) |
| 29 | vfirstcode | 源头单据号 | vfirstcode | varchar(40) |  | 字符串 (String) |
| 30 | cfirstid | 源头单据 | cfirstid | char(20) |  | 主键 (UFID) |
| 31 | cfirstbid | 源头单据明细 | cfirstbid | char(20) |  | 主键 (UFID) |
| 32 | vfirstrowno | 源头单据行号 | vfirstrowno | varchar(20) |  | 字符串 (String) |
| 33 | csrcbid | 来源单据明细 | csrcbid | char(20) |  | 主键 (UFID) |
...
| 95 | vfree11 | 自由辅助属性11 | vfree11 | varchar(101) |  | 自由项 (Custom) |
| 96 | vfree12 | 自由辅助属性12 | vfree12 | varchar(101) |  | 自由项 (Custom) |
| 97 | vfree13 | 自由辅助属性13 | vfree13 | varchar(101) |  | 自由项 (Custom) |
| 98 | vfree14 | 自由辅助属性14 | vfree14 | varchar(101) |  | 自由项 (Custom) |
| 99 | vfree15 | 自由辅助属性15 | vfree15 | varchar(101) |  | 自由项 (Custom) |
| 100 | vfree16 | 自由辅助属性16 | vfree16 | varchar(101) |  | 自由项 (Custom) |
| 101 | vfree17 | 自由辅助属性17 | vfree17 | varchar(101) |  | 自由项 (Custom) |
| 102 | vfree18 | 自由辅助属性18 | vfree18 | varchar(101) |  | 自由项 (Custom) |
| 103 | vfree19 | 自由辅助属性19 | vfree19 | varchar(101) |  | 自由项 (Custom) |
| 104 | vfree20 | 自由辅助属性20 | vfree20 | varchar(101) |  | 自由项 (Custom) |