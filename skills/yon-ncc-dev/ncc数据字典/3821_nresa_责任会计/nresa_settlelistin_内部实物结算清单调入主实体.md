...
**内部实物结算清单调入主实体 (nresa_settlelistin / nc.vo.nresa.internalsettlement.matter.SettleListInHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3890.html
...
| 10 | cinstordocid | 调入仓库 | cinstordocid | varchar(20) |  | 仓库 (stordoc) |
| 11 | coutpcid | 调出利润中心 | coutpcid | varchar(20) |  | 利润中心 (profitcenter) |
| 12 | coutpcvid | 调出利润中心版本 | coutpcvid | varchar(20) |  | 利润中心版本 (profitcenterVersion) |
| 13 | coutstockorgid | 调出库存组织 | coutstockorgid | varchar(20) |  | 组织_业务单元_库存组织 (stockorg) |
| 14 | coutstockorgvid | 调出库存组织版本 | coutstockorgvid | varchar(20) |  | 组织_业务单元_库存组织版本信息 (stockorg_v) |
| 15 | coutstordocid | 调出仓库 | coutstordocid | varchar(20) |  | 仓库 (stordoc) |
...
| 20 | cbiztypeid | 业务类型 | cbiztypeid | varchar(50) |  | 字符串 (String) |
