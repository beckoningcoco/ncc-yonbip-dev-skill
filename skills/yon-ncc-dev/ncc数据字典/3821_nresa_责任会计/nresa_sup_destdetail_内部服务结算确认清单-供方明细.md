...
**内部服务结算确认清单-供方明细 (nresa_sup_destdetail / nc.vo.nresa.internalsettlent.service.SupDestDetailVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3901.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_detail | 明细数据主键 | pk_detail | char(20) | √ | 主键 (UFID) |
| 2 | pk_dest | 内部结算确认清单-供方 | pk_dest | varchar(20) |  | 内部服务结算确认清单-供方 (SupDestVO) |
...
| 5 | pk_src_center | 需方利润中心 | pk_src_center | varchar(20) |  | 利润中心 (profitcenter) |
| 6 | pk_src_center_v | 需方利润中心版本 | pk_src_center_v | varchar(20) |  | 利润中心版本 (profitcenterVersion) |
| 7 | pk_src_org | 需方责任组织 | pk_src_org | varchar(20) |  | 组织_业务单元_责任组织 (liabilitycenter) |
| 8 | pk_src_org_v | 需方责任组织版本 | pk_src_org_v | varchar(20) |  | 组织_业务单元_责任组织版本信息 (liabilitycenter_v) |
| 9 | pk_center | 供方利润中心 | pk_center | varchar(20) |  | 利润中心 (profitcenter) |
| 10 | pk_center_v | 供方利润中心版本 | pk_center_v | varchar(20) |  | 利润中心版本 (profitcenterVersion) |
| 11 | pk_dept | 供方入账部门 | pk_dept | varchar(20) |  | 组织_部门 (dept) |
| 12 | pk_costcenter | 供方入账成本中心 | pk_costcenter | varchar(20) |  | 成本中心 (resacostcenter) |
| 13 | pk_accsoa | 供方入账会计科目 | pk_accsoa | varchar(20) |  | 会计科目 (accasoa) |
...
| 22 | glbmoney | 全局比本金额 | glbmoney | decimal(28, 8) |  | 金额 (UFMoney) |
...
| 27 | pk_upbill | 内部服务结算录入清单 | pk_upbill | varchar(20) |  | 内部服务结算录入清单-需方 (DemSrcVO) |
| 28 | pk_upbillitem | 内部服务结算录入清单明细 | pk_upbillitem | varchar(20) |  | 内部服务结算录入清单-需方明细 (DemSrcDetailVO) |
| 29 | bookhv | 账簿本币汇率 | bookhv | decimal(28, 8) |  | 数值 (UFDouble) |
| 30 | orghv | 组织本币汇率 | orghv | decimal(28, 8) |  | 数值 (UFDouble) |
...
| 34 | orgcur | 责任组织币种 | orgcur | varchar(20) |  | 币种 (currtype) |
...
| 38 | orgshceme | 组织汇率方案 | orgshceme | varchar(20) |  | 外币汇率方案 (exratescheme) |
