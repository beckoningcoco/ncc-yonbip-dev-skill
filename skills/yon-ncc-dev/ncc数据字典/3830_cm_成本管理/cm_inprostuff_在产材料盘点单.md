...
**在产材料盘点单 (cm_inprostuff / nc.vo.cm.inprostuff.entity.InproStuffHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1484.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cinprostuffid | 在产材料盘点单 | cinprostuffid | char(20) | √ | 主键 (UFID) |
...
| 10 | isourcetype | 单据类型 | isourcetype | int |  | 来源类型(成本) (CMSourceTypeEnum) | 1 | 1=自制; |