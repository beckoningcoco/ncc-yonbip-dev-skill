...
**完工单 (cm_product / nc.vo.cm.product.entity.ProductHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1493.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cproductid | 完工单 | cproductid | char(20) | √ | 主键 (UFID) |
...
| 10 | isourcetype | 来源类型 | isourcetype | varchar(50) |  | 来源类型(成本) (CMSourceTypeEnum) |  | 1=自制; |