...
**其他出入库消耗单明细 (scaba_iastuff_b / nc.vo.scaba.iastuff.entity.IastuffItemVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5086.html
...
| 16 | bcounted | 是否已计算 | bcounted | char(1) |  | 布尔类型 (UFBoolean) |
