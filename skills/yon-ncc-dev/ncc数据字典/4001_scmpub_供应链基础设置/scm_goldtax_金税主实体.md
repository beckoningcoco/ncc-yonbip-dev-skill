...
**金税主实体 (scm_goldtax / nc.vo.scmpub.goldtax.GoldTaxHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5217.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_goldtax | 金税主实体 | pk_goldtax | char(20) | √ | 主键 (UFID) |
| 2 | code | 单据号 | code | varchar(50) |  | 字符串 (String) |
| 3 | rownum | 商品行数 | rownum | int |  | 整数 (Integer) |
| 4 | customerid | 购方 | customerid | varchar(50) |  | 字符串 (String) |
| 5 | customername | 购方名称 | customername | varchar(50) |  | 字符串 (String) |
| 6 | taxpayerid | 购方税号 | taxpayerid | varchar(50) |  | 字符串 (String) |
| 7 | saleaddr | 购方地址 | saleaddr | varchar(50) |  | 字符串 (String) |
| 8 | salephone | 购方电话 | salephone | varchar(50) |  | 字符串 (String) |
| 9 | account | 购方银行帐号 | account | varchar(50) |  | 字符串 (String) |
| 10 | bankname | 购方银行名称 | bankname | varchar(50) |  | 字符串 (String) |
| 11 | memo | 备注 | memo | varchar(50) |  | 字符串 (String) |
| 12 | checker | 复核人 | checker | varchar(50) |  | 字符串 (String) |
| 13 | payee | 收款人 | payee | varchar(50) |  | 字符串 (String) |
| 14 | rowinvname | 清单行商品名称 | rowinvname | varchar(50) |  | 字符串 (String) |
| 15 | billdate | 单据日期 | billdate | varchar(50) |  | 字符串 (String) |
| 16 | sellaccount | 银行帐号 | sellaccount | varchar(50) |  | 字符串 (String) |
| 17 | taxbillno | 金税票号 | taxbillno | varchar(50) |  | 字符串 (String) |
| 18 | sellcorpname | 销售公司 | sellcorpname | varchar(50) |  | 字符串 (String) |
