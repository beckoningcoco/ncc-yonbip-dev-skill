...
**消耗汇总费用暂估明细 (po_vmifi_fee / nc.vo.pu.m4202.entity.VmiFIFeeVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4644.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_stockps_fee | 消耗汇总费用暂估明细 | pk_stockps_fee | char(20) | √ | 主键 (UFID) |
| 2 | pk_stockps | 消耗汇总财务头 | pk_stockps | char(20) |  | 主键 (UFID) |
