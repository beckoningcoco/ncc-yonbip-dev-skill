...
**库存借入单表头 (ic_borrowin_h / nc.vo.ic.m49.entity.BorrowInHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2888.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cgeneralhid | 库存借入单表头主键 | cgeneralhid | char(20) | √ | 主键 (UFID) |
