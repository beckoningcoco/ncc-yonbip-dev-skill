...
**库存借出单表头 (ic_borrowout_h / nc.vo.ic.m4h.entity.BorrowOutHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2891.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cgeneralhid | 库存借出单表头主键 | cgeneralhid | char(20) | √ | 主键 (UFID) |
...
| 16 | vdiliveraddress | 运输地址 | vdiliveraddress | varchar(20) |  | 主键 (UFID) |
| 17 | cdilivertypeid | 运输方式 | cdilivertypeid | varchar(20) |  | 主键 (UFID) |
| 18 | pk_measware | 计量器具 | pk_measware | varchar(20) |  | 计量器具维护 (pd_meastool) |
| 19 | fbillflag | 单据状态 | fbillflag | int |  | 库存单据状态 (ICBillFlag) | 2 | 1=删除; |