...
**库存借出单单品表 (ic_borrowout_l / nc.vo.ic.m4h.entity.BorrowOutLocationVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2892.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cgenerallid | 库存借出单品表主键 | cgenerallid | char(20) | √ | 主键 (UFID) |
| 2 | cgeneralhid | 普通出库单表头主键 | cgeneralhid | char(20) |  | 主键 (UFID) |
| 3 | pk_group | 集团 | pk_group | varchar(20) |  | 货位 (rack) |
