...
**报废单表头 (ic_discardout_h / nc.vo.ic.m4o.entity.DiscardOutHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2898.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cgeneralhid | 报废单表头主键 | cgeneralhid | char(20) | √ | 主键 (UFID) |
...
| 8 | cwastewarehouseid | 废品仓库 | cwastewarehouseid | varchar(20) |  | 仓库 (stordoc) |
| 9 | vtrantypecode | 报废类型编码 | vtrantypecode | varchar(20) |  | 字符串 (String) |
...
| 14 | fbillflag | 单据状态 | fbillflag | int |  | 库存单据状态 (ICBillFlag) |  | 1=删除; |