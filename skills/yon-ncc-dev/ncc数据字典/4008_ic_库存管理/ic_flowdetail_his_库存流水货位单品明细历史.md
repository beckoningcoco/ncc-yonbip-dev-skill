...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2906.html
...
| 9 | vbarcode | 主条码 | vbarcode | varchar(128) |  | 字符串 (String) |
...
| 22 | dtransdate | 转储日期 | dtransdate | char(19) |  | 日期时间 (UFDateTime) |
| 23 | pk_serialcode | 序列号主键 | pk_serialcode | varchar(20) |  | 序列号档案 (SerialNoVO) |