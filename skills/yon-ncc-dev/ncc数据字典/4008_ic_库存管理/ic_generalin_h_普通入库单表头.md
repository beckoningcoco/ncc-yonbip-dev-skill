...
**普通入库单表头 (ic_generalin_h / nc.vo.ic.m4a.entity.GeneralInHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2908.html
...
| 12 | cothercalbodyvid | 出库库存组织版本 | cothercalbodyvid | varchar(20) |  | 组织_业务单元_库存组织版本信息 (stockorg_v) |
...
| 20 | fbillflag | 单据状态 | fbillflag | int |  | 库存单据状态 (ICBillFlag) | 2 | 1=删除; |