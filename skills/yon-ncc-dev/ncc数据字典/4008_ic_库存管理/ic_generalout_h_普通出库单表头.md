...
**普通出库单表头 (ic_generalout_h / nc.vo.ic.m4i.entity.GeneralOutHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2911.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cgeneralhid | 普通出库单表头主键 | cgeneralhid | char(20) | √ | 主键 (UFID) |
...
| 11 | cothercalbodyoid | 入库库存组织最新版本 | cothercalbodyoid | varchar(20) |  | 组织_业务单元_库存组织 (stockorg) |
| 12 | cothercalbodyvid | 入库库存组织 | cothercalbodyvid | varchar(20) |  | 组织_业务单元_库存组织版本信息 (stockorg_v) |
| 13 | cotherwhid | 入库仓库 | cotherwhid | varchar(20) |  | 仓库 (stordoc) |
...
| 18 | vdiliveraddress | 运输地址 | vdiliveraddress | varchar(20) |  | 地址簿 (address) |
| 19 | cdilivertypeid | 运输方式 | cdilivertypeid | varchar(20) |  | 运输方式 (transporttype) |
| 20 | pk_measware | 计量器具 | pk_measware | varchar(20) |  | 计量器具维护 (pd_meastool) |
