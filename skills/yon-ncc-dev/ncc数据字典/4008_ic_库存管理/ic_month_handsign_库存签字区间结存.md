...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2929.html
...
| 9 | pk_batchcode | 批次档案主键 | pk_batchcode | varchar(20) |  | 批次档案 (BatchcodeVO) |
...
| 23 | nianum | 核算结存主数量 | nianum | decimal(28, 8) |  | 数值 (UFDouble) |
| 24 | niaassistnum | 核算结存数量 | niaassistnum | decimal(28, 8) |  | 数值 (UFDouble) |
| 25 | niagrossnum | 核算结存毛重数量 | niagrossnum | decimal(28, 8) |  | 数值 (UFDouble) |
| 26 | nretnum | 还回主数量 | nretnum | decimal(28, 8) |  | 数值 (UFDouble) |
| 27 | nretassistnum | 还回数量 | nretassistnum | decimal(28, 8) |  | 数值 (UFDouble) |
| 28 | nretgrossnum | 还回毛重 | nretgrossnum | decimal(28, 8) |  | 数值 (UFDouble) |
| 29 | niaretnum | 核算结存还回主数量 | niaretnum | decimal(28, 8) |  | 数值 (UFDouble) |
| 30 | niaretassistnum | 核算结存还回数量 | niaretassistnum | decimal(28, 8) |  | 数值 (UFDouble) |
| 31 | niaretgrossnum | 核算结存还回毛重数量 | niaretgrossnum | decimal(28, 8) |  | 数值 (UFDouble) |
| 32 | cffileid | 特征码 | cffileid | varchar(20) |  | 特征码档案 (bd_ffile) |
| 33 | vfree1 | 物料自由属性1 | vfree1 | varchar(101) |  | 自由项 (Custom) |
| 34 | vfree2 | 物料自由属性2 | vfree2 | varchar(101) |  | 自由项 (Custom) |
| 35 | vfree3 | 物料自由属性3 | vfree3 | varchar(101) |  | 自由项 (Custom) |
| 36 | vfree4 | 物料自由属性4 | vfree4 | varchar(101) |  | 自由项 (Custom) |
| 37 | vfree5 | 物料自由属性5 | vfree5 | varchar(101) |  | 自由项 (Custom) |
| 38 | vfree6 | 物料自由属性6 | vfree6 | varchar(101) |  | 自由项 (Custom) |
| 39 | vfree7 | 物料自由属性7 | vfree7 | varchar(101) |  | 自由项 (Custom) |
| 40 | vfree8 | 物料自由属性8 | vfree8 | varchar(101) |  | 自由项 (Custom) |
| 41 | vfree9 | 物料自由属性9 | vfree9 | varchar(101) |  | 自由项 (Custom) |
| 42 | vfree10 | 物料自由属性10 | vfree10 | varchar(101) |  | 自由项 (Custom) |