...
**期初余额表体 (ic_openbal_b / nc.vo.ic.m40.entity.InitializtionInBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2942.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cgeneralbid | 期初余额表体主键 | cgeneralbid | char(20) | √ | 主键 (UFID) |
...
| 14 | dproducedate | 生产日期 | dproducedate | varchar(19) |  | 日期(结束) (UFDateEnd) |
| 15 | dvalidate | 失效日期 | dvalidate | varchar(19) |  | 日期(结束) (UFDateEnd) |
| 16 | vvendbatchcode | 供应商批次号 | vvendbatchcode | varchar(50) |  | 字符串 (String) |
| 17 | nassistnum | 数量 | nassistnum | decimal(28, 8) |  | 数值 (UFDouble) |
| 18 | nnum | 主数量 | nnum | decimal(28, 8) |  | 数值 (UFDouble) |
| 19 | ncostprice | 单价 | ncostprice | decimal(28, 8) |  | 数值 (UFDouble) |
| 20 | ncostmny | 金额 | ncostmny | decimal(28, 8) |  | 数值 (UFDouble) |
...
| 26 | cvmivenderid | 寄存供应商 | cvmivenderid | varchar(20) |  | 供应商基本信息 (supplier) |
| 27 | ctplcustomerid | 货主客户 | ctplcustomerid | varchar(20) |  | 客户基本信息 (customer) |
| 28 | tchecktime | 检验时间 | tchecktime | varchar(19) |  | 日期时间 (UFDateTime) |
| 29 | bbarcodeclose | 条码关闭 | bbarcodeclose | char(1) |  | 布尔类型 (UFBoolean) |
| 30 | nbarcodenum | 条码主数量 | nbarcodenum | decimal(28, 8) |  | 数值 (UFDouble) |
| 31 | vnotebody | 行备注 | vnotebody | varchar(181) |  | 字符串 (String) |
| 32 | nshouldnum | 应收主数量 | nshouldnum | decimal(28, 8) |  | 数值 (UFDouble) |
| 33 | nshouldassistnum | 应收数量 | nshouldassistnum | decimal(28, 8) |  | 数值 (UFDouble) |
| 34 | ncountnum | 箱数 | ncountnum | decimal(28, 8) |  | 数值 (UFDouble) |
| 35 | pk_packsort | 包装类型 | pk_packsort | varchar(20) |  | 包装箱类型 (PackTypeVO) |
| 36 | pk_measware | 计量器具 | pk_measware | varchar(20) |  | 计量器具维护 (pd_meastool) |
| 37 | ngrossnum | 毛重主数量 | ngrossnum | decimal(28, 8) |  | 数值 (UFDouble) |
| 38 | ntarenum | 皮重主数量 | ntarenum | decimal(28, 8) |  | 数值 (UFDouble) |
| 39 | cbodytranstypecode | 出入库类型 | cbodytranstypecode | varchar(20) |  | 单据类型 (BilltypeVO) |
| 40 | pk_org | 库存组织最新版本 | pk_org | varchar(20) |  | 组织_业务单元_库存组织 (stockorg) |
| 41 | pk_org_v | 库存组织 | pk_org_v | varchar(20) |  | 组织_业务单元_库存组织版本信息 (stockorg_v) |
| 42 | cbodywarehouseid | 库存仓库 | cbodywarehouseid | varchar(20) |  | 仓库 (stordoc) |
| 43 | cliabilityoid | 利润中心版本 | cliabilityoid | varchar(20) |  | 利润中心 (profitcenter) |
| 44 | cliabilityvid | 利润中心 | cliabilityvid | varchar(20) |  | 利润中心版本 (profitcenterVersion) |
| 45 | nweight | 重量 | nweight | decimal(28, 8) |  | 数值 (UFDouble) |
| 46 | nvolume | 体积 | nvolume | decimal(28, 8) |  | 数值 (UFDouble) |
| 47 | npiece | 件数 | npiece | decimal(28, 8) |  | 数值 (UFDouble) |
| 48 | pk_batchcode | 批次主键 | pk_batchcode | varchar(20) |  | 批次档案 (BatchcodeVO) |
| 49 | vserialcode | 序列号 | vserialcode | varchar(128) |  | 字符串 (String) |
| 50 | pk_serialcode | 序列号主键 | pk_serialcode | varchar(20) |  | 序列号档案 (SerialNoVO) |
| 51 | vbillbarcode | 单据条码 | vbillbarcode | varchar(128) |  | 字符串 (String) |
| 52 | cffileid | 特征码 | cffileid | varchar(20) |  | 特征码档案 (bd_ffile) |
