...
**库存借入还回单表头 (ic_returnout_h / nc.vo.ic.m4j.entity.ReturnOutHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2969.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cgeneralhid | 借入还回单表头主键 | cgeneralhid | char(20) | √ | 主键 (UFID) |
...
| 14 | pk_measware | 计量器具 | pk_measware | varchar(20) |  | 计量器具维护 (pd_meastool) |
| 15 | vnote | 备注 | vnote | varchar(200) |  | 字符串 (String) |
