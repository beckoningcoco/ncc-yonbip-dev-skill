...
**费用结算采购入 (to_fori9puin / nc.vo.to.m4552.entity.ForI9PuInHeaderVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5792.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbillid | 费用结算采购入 | cbillid | char(20) | √ | 主键 (UFID) |
