...
**应收运费发票子实体 (dm_arinvoice_b / nc.vo.dm.m4814.entity.ArInvoiceBVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1713.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cinvoice_bid | 应收运费发票字表主键 | cinvoice_bid | char(20) | √ | 主键 (UFID) |
| 2 | dbilldate | 单据日期 | dbilldate | char(19) |  | 日期 (UFDate) |
| 3 | pk_org | 运费财务组织 | pk_org | varchar(20) |  | 组织_业务单元_财务组织 (financeorg) |
