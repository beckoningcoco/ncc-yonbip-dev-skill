...
**应付运费策略定义主实体 (dm_feeplcy / nc.vo.dm.policy.entity.FeePlcyHVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1724.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_feeplcy | 应付运费策略主实体 | pk_feeplcy | char(20) | √ | 主键 (UFID) |
...
| 5 | ccarrierid | 承运商 | ccarrierid | varchar(20) |  | 承运商定义 (dm_carrier) |
| 6 | csendtypeid | 运输方式 | csendtypeid | varchar(20) |  | 运输方式 (transporttype) |
| 7 | vtotalformula | 运费公式 | vtotalformula | varchar(500) |  | 字符串 (String) |
