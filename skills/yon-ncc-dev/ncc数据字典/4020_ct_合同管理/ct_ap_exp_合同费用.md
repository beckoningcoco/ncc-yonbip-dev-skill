...
**合同费用 (ct_ap_exp / nc.vo.ct.ap.entity.CtApExpVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1648.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_ct_ap_exp | 合同费用主键 | pk_ct_ap_exp | char(20) | √ | 主键 (UFID) |
...
| 6 | pk_org | 公司最新版本信息 | pk_org | varchar(20) |  | 组织_业务单元_公司 (corp) |
