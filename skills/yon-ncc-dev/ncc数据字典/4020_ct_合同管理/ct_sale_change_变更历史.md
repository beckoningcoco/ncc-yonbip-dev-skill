...
**变更历史 (ct_sale_change / nc.vo.ct.saledaily.entity.CtSaleChangeVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1676.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_ct_sale_change | 变更历史主键 | pk_ct_sale_change | char(20) | √ | 主键 (UFID) |
| 2 | vchangecode | 版本号 | vchangecode | decimal(28, 8) |  | 数值 (UFDouble) |
| 3 | vchgpsn | 变更人 | vchgpsn | varchar(20) |  | 用户 (user) |
| 4 | vchgdate | 变更日期 | vchgdate | char(19) |  | 日期 (UFDate) |
...
| 10 | pk_org_v | 组织 | pk_org_v | varchar(20) |  | 组织_业务单元_销售组织版本信息 (salesorg_v) |