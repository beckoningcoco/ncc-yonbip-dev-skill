...
**营销费用归集单分摊实体 (me_combine_allot / nc.vo.me.collectorder.entity.CombineAllotVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3608.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_combine_allot | 营销费用归集单分摊实体 | pk_combine_allot | char(20) | √ | 主键 (UFID) |
