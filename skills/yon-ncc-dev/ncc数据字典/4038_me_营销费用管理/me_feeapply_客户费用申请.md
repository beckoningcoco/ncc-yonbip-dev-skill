...
**客户费用申请 (me_feeapply / nc.vo.me.m4641.entity.BillHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3611.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbillid | 客户费用申请 | cbillid | char(20) | √ | 主键 (UFID) |
...
| 5 | ctrantypeid | 客户费用申请类型 | ctrantypeid | varchar(20) |  | 单据类型 (BilltypeVO) |
| 6 | vtrantypecode | 客户费用申请类型编码 | vtrantypecode | varchar(20) |  | 字符串 (String) |
