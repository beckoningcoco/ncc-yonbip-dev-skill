...
**工种附卡 (pam_std_job_type / nc.vo.am.stdjob.StdJobTypeVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4333.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_std_job_type | 工种附卡标识 | pk_std_job_type | char(20) | √ | 主键 (UFID) |
...
| 7 | pk_craft | 工种 | pk_craft | varchar(20) |  | 工种 (craft) |
| 8 | person_num | 人员数量 | person_num | int |  | 整数 (Integer) |
| 9 | normal_hours | 标准工时 | normal_hours | decimal(28, 8) |  | 数值 (UFDouble) |
| 10 | total_craft | 标准成本 | total_craft | decimal(28, 8) |  | 金额 (UFMoney) |
