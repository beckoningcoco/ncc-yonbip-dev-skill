...
**检修路线子表 (pam_inspection_road_b / nc.vo.aim.inspectionroad.InspectionRoadBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4264.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_inspection_road_b | 检修路线表体主键 | pk_inspection_road_b | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 3 | pk_org | 维修最新版本 | pk_org | varchar(20) |  | 组织_业务单元_维修组织 (maintainorg) |
| 4 | pk_org_v | 维修组织 | pk_org_v | varchar(20) |  | 组织_业务单元_维修组织版本信息 (maintainorg_v) |
| 5 | rowno | 行号 | rowno | varchar(30) |  | 字符串 (String) |
| 6 | sequence_num | 序号 | sequence_num | varchar(50) |  | 字符串 (String) |
| 7 | pk_equip | 设备编码 | pk_equip | varchar(20) |  | 设备卡片 (EquipHeadVO) |
| 8 | pk_location | 位置编码 | pk_location | varchar(20) |  | 位置 (location) |
| 9 | pk_std_job | 标准工作包 | pk_std_job | varchar(20) |  | 标准工作包 (StdJobVO) |
| 10 | pk_safety_job | 安全工作包 | pk_safety_job | varchar(20) |  | 安全工作包 (SafetyJobHeadVO) |
