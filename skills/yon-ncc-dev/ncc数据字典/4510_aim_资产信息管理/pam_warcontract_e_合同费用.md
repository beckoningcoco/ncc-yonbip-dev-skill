...
**合同费用 (pam_warcontract_e / nc.vo.aim.warcontract.WarContractExpenseVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4344.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_warcontract_e | 合同费用主键 | pk_warcontract_e | char(20) | √ | 主键 (UFID) |
...
| 7 | expense_org | 费用金额 | expense_org | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
