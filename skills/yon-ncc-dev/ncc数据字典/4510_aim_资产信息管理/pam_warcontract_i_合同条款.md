...
**合同条款 (pam_warcontract_i / nc.vo.aim.warcontract.WarContractItemVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4345.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_warcontract_i | 合同条款主键 | pk_warcontract_i | char(20) | √ | 主键 (UFID) |
...
| 6 | pk_contract_item | 条款编码 | pk_contract_item | varchar(20) |  | 合同条款 (ct_termset) |
| 7 | item_content | 条款内容 | item_content | varchar(1024) |  | 备注 (Memo) |
| 8 | other_info | 其他信息 | other_info | varchar(200) |  | 字符串 (String) |
