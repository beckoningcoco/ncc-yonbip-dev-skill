...
**变动单 (pam_alter / nc.vo.aum.alter.AlterBillHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4214.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_alter | 变动单主键 | pk_alter | char(20) | √ | 主键 (UFID) |
...
| 6 | bill_code | 变动单号 | bill_code | varchar(40) |  | 字符串 (String) |
