...
**领用归还 (pam_assign / nc.vo.aum.assign.restore.ReturnHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4218.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_assign | 主表主键 | pk_assign | char(20) | √ | 主键 (UFID) |
| 2 | bill_code | 领用归还单号 | bill_code | varchar(40) |  | 字符串 (String) |
