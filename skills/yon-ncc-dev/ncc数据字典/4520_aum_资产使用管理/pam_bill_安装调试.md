...
**安装调试 (pam_bill / nc.vo.aum.install.InstallHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4224.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_bill | 业务单主键 | pk_bill | char(20) | √ | 主键 (UFID) |
...
| 8 | bill_code | 安装调试单号 | bill_code | varchar(40) |  | 字符串 (String) |
