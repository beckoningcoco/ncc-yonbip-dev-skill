...
**调拨申请子表 (pam_deploy_apply_b / nc.vo.aum.deploy.apply.DeployApplyBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4243.html
...
| 9 | serial_num | 存货序列号 | serial_num | char(80) |  | 字符串 (String) |
| 10 | pk_warehouse | 仓库 | pk_warehouse | varchar(20) |  | 组织_业务单元_库存组织 (stockorg) |
...
| 33 | src_pk_bill | 来源单据主表主键 | src_pk_bill | varchar(20) |  | 字符串 (String) |
| 34 | src_pk_bill_b | 来源单据子表主键 | src_pk_bill_b | varchar(20) |  | 字符串 (String) |
| 35 | src_bill_type | 来源单据类型 | src_bill_type | varchar(20) |  | 字符串 (String) |
