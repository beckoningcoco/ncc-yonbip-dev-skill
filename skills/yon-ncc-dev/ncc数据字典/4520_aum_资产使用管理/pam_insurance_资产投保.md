...
**资产投保 (pam_insurance / nc.vo.aum.insur.insurance.InsuranceHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4265.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_insurance | 保险单主键 | pk_insurance | char(20) | √ | 主键 (UFID) |
...
| 9 | bill_code | 投保单号 | bill_code | varchar(40) |  | 字符串 (String) |
