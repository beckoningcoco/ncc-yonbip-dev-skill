...
**抵押单表体 (pam_mortgage_b / nc.vo.aum.mortgage.MortgageBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4284.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_mortgage_b | 单据表体ID | pk_mortgage_b | char(20) | √ | 主键 (UFID) |
...
| 7 | mortgage_flag | 抵押标志位 | mortgage_flag | char(1) |  | 布尔类型 (UFBoolean) |
| 8 | money | 抵押金额 | money | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 9 | pk_jobmngfil | 项目 | pk_jobmngfil | varchar(20) |  | 项目 (project) |
| 10 | start_date | 开始日期 | start_date | char(19) |  | 日期(开始) (UFDateBegin) |
| 11 | end_date | 结束日期 | end_date | char(19) |  | 日期(结束) (UFDateEnd) |
| 12 | memo | 备注 | memo | varchar(200) |  | 字符串 (String) |
| 13 | pk_status_before | 变化前状态 | pk_status_before | varchar(20) |  | 设备状态 (StatusVO) |
| 14 | status_date_before | 变化前状态日期 | status_date_before | char(19) |  | 日期 (UFDate) |
| 15 | pk_status_after | 变化后状态 | pk_status_after | varchar(20) |  | 设备状态 (StatusVO) |
| 16 | status_date_after | 变化后状态日期 | status_date_after | char(19) |  | 日期 (UFDate) |
...
| 27 | pk_bill_src | 上游来源单据主键 | pk_bill_src | varchar(20) |  | 字符串 (String) |
