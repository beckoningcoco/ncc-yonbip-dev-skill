...
**资产捐赠 (pam_reduce / nc.vo.aum.donate.DonateHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4309.html
...
| 5 | bill_code | 捐赠单号 | bill_code | varchar(40) |  | 字符串 (String) |
| 6 | bill_type | 单据类型 | bill_type | varchar(20) |  | 字符串 (String) |
