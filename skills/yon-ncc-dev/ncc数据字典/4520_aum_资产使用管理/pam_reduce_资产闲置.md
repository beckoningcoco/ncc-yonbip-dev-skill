...
**资产闲置 (pam_reduce / nc.vo.aum.unused.UnusedHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4307.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_reduce | 闲置单ID | pk_reduce | char(20) | √ | 主键 (UFID) |
...
| 9 | bill_code | 闲置单号 | bill_code | varchar(40) |  | 字符串 (String) |
