...
**合同费用 (alo_contract_e / nc.vo.alo.contract.leasecont.ContractOutExpenseVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/84.html
...
| 5 | pk_contract_ex | 费用编码 | pk_contract_ex | varchar(20) |  | 合同费用定义 (ct_expset) |
| 6 | expense_org | 费用金额 | expense_org | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 7 | expense_group | 费用金额(集团) | expense_group | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 8 | expense_global | 费用金额(全局) | expense_global | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
