...
**合同交易类型扩展 (alo_contract_ext / nc.vo.alo.contract.leasecont.ContractOutExtVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/86.html
...
| 7 | transtypecode | 交易类型编码 | transtypecode | varchar(30) |  | 字符串 (String) |