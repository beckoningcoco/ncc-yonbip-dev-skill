...
**租出单 (alo_lease_out / nc.vo.alo.lease.leaseout.LeaseoutHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/93.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_lease_out | 租出单主键 | pk_lease_out | char(20) | √ | 主键 (UFID) |
...
| 5 | bill_code | 租出单号 | bill_code | varchar(40) |  | 字符串 (String) |
