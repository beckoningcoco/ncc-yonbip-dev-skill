...
**合同变更单 (ali_cont_alter / nc.vo.ali.contract.alter.ContractInAlterHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/40.html
...
| 9 | bill_code | 变更单号 | bill_code | varchar(40) |  | 字符串 (String) |
