...
**评估付款计划 (ali_evaluate_d / nc.vo.ali.used.evaluate.UsedEvaluateCalculationVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/52.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_evaluate_d | 评估付款计划主键 | pk_evaluate_d | char(20) | √ | 主键 (UFID) |
