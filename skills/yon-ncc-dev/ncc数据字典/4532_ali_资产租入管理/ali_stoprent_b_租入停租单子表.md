...
**租入停租单子表 (ali_stoprent_b / nc.vo.ali.lease.offhire.LeaseInStopRentBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/68.html
...
| 12 | start_date | 停租开始日期 | start_date | char(19) |  | 日期(开始) (UFDateBegin) |
| 13 | end_date | 停租结束日期 | end_date | char(19) |  | 日期(开始) (UFDateBegin) |
| 14 | calculate_date | 租金计算日期 | calculate_date | char(19) |  | 日期 (UFDate) |
| 15 | stopday | 停租天数 | stopday | int |  | 整数 (Integer) |
| 16 | price | 日停租单价 | price | decimal(28, 8) |  | 金额 (UFMoney) |
| 17 | stop_reason | 停租原因 | stop_reason | varchar(20) |  | 原因 (reason) |
| 18 | pk_jobmngfil | 项目 | pk_jobmngfil | varchar(20) |  | 项目 (project) |
| 19 | memo | 备注 | memo | varchar(200) |  | 字符串 (String) |
| 20 | src_bill_code | 来源单据号 | src_bill_code | varchar(50) |  | 字符串 (String) |
| 21 | src_pk_bill | 来源单据主表主键 | src_pk_bill | varchar(50) |  | 字符串 (String) |
| 22 | src_pk_bill_b | 来源单据子表主键 | src_pk_bill_b | varchar(50) |  | 字符串 (String) |
| 23 | src_bill_type | 来源单据类型 | src_bill_type | varchar(20) |  | 字符串 (String) |
| 24 | src_trans_type | 来源交易类型 | src_trans_type | varchar(50) |  | 字符串 (String) |
| 25 | coop_pk_bill_b | 协同来源单据子表主键 | coop_pk_bill_b | varchar(20) |  | 字符串 (String) |
| 26 | coop_bill_type | 协同来源单据类型 | coop_bill_type | varchar(20) |  | 字符串 (String) |
| 27 | coop_transi_type | 协同来源交易类型 | coop_transi_type | varchar(20) |  | 字符串 (String) |
| 28 | coop_bill_code | 协同来源单据单据号 | coop_bill_code | varchar(20) |  | 字符串 (String) |
| 29 | stoprent_end_flag | 停租结束 | stoprent_end_flag | char(1) |  | 布尔类型 (UFBoolean) |
