...
**租入停租单 (ali_stoprent / nc.vo.ali.lease.offhire.LeaseInStopRentHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/67.html
...
| 6 | bill_code | 停租单号 | bill_code | varchar(40) |  | 字符串 (String) |
