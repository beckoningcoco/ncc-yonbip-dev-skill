...
**临时租入结算单 (ali_temp_settle / nc.vo.ali.settle.TempSettleHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/69.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_settle | 临时租入结算单主键 | pk_settle | char(20) | √ | 主键 (UFID) |
