...
**租入工作量记录 (ali_workload / nc.vo.ali.lease.workload.LeaseInWorkloadHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/77.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_workload | 工作量记录主键 | pk_workload | char(20) | √ | 主键 (UFID) |
...
| 5 | bill_code | 工作量记录单号 | bill_code | varchar(40) |  | 字符串 (String) |
