...
**设备完好上报 (eom_intactrpt / nc.vo.eom.intactrpt.IntactrptHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1839.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_intactrpt | 设备完好上报主表标识 | pk_intactrpt | char(20) | √ | 主键 (UFID) |
