...
**运行记录 (eom_operation / nc.vo.eom.operation.OperationHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1847.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_operation | 运行记录主键 | pk_operation | char(20) | √ | 主键 (UFID) |
...
| 7 | transi_type | 交易类型 | transi_type | varchar(30) |  | 字符串 (String) |
