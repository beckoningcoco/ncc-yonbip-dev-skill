...
**替代油更换申请 (elm_oilchange / nc.vo.elm.lubrchange.LubrChangeHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1797.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_lubrchange | 替代油更换申请主键 | pk_lubrchange | char(20) | √ | 主键 (UFID) |
