...
**预防性维护工作包 (emm_pm_stdjob / nc.vo.emm.premaintain.PMStdJobVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1814.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_pm_stdjob | 主键 | pk_pm_stdjob | char(20) | √ | 主键 (UFID) |
...
| 6 | pk_std_job | 标准工作包 | pk_std_job | varchar(20) |  | 标准工作包 (StdJobVO) |
| 7 | frequence_num | 频度 | frequence_num | int |  | 整数 (Integer) |
