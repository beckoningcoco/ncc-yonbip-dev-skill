...
**预防性维护作业对象 (emm_pm_workobj / nc.vo.emm.premaintain.PMWorkObjVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1815.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_pm_workobj | 主键 | pk_pm_workobj | char(20) | √ | 主键 (UFID) |
...
| 6 | sequence_num | 对象序号 | sequence_num | int |  | 整数 (Integer) |
