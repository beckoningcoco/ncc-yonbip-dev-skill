...
**隔离单建立子表 (ewm_isolation_create / nc.vo.ewm.isolation.IsolationCreateBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1926.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_iso_create | 隔离单建立子表主键 | pk_iso_create | char(20) | √ | 主键 (UFID) |
