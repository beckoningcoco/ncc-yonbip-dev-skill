...
**追加物料申请 (ewm_supperadd_inv / nc.vo.ewm.supperaddinv.SupperaddInvHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1951.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_supperadd_inv | 追加物料申请主键 | pk_supperadd_inv | char(20) | √ | 主键 (UFID) |
