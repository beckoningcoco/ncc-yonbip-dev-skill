...
**工作申请 (ewm_work_apply / nc.vo.ewm.workapply.WorkApplyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1975.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_work_apply | 工作申请主键 | pk_work_apply | char(20) | √ | 主键 (UFID) |
...
| 9 | bill_code | 申请号 | bill_code | varchar(40) |  | 字符串 (String) |
| 10 | apply_name | 申请名称 | apply_name | varchar(80) |  | 字符串 (String) |
