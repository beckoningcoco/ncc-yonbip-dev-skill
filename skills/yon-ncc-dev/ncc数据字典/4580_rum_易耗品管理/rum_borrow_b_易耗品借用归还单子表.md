...
**易耗品借用归还单子表 (rum_borrow_b / nc.vo.rum.borrow.restore.RestoreBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5014.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_borrow_b | 借用归还单表体主键 | pk_borrow_b | char(20) | √ | 主键 (UFID) |
...
| 10 | pk_usedept_v | 使用部门版本 | pk_usedept_v | varchar(20) |  | 组织_部门版本信息 (dept_v) |
| 11 | pk_user | 使用人 | pk_user | varchar(20) |  | 人员基本信息 (psndoc) |
| 12 | pk_unit | 单位 | pk_unit | varchar(20) |  | 计量单位 (measdoc) |
| 13 | num | 数量 | num | decimal(28, 8) |  | 数值 (UFDouble) |  | [0 , ] |
| 14 | changerate | 换算率 | changerate | varchar(50) |  | 字符串 (String) |
| 15 | pk_main_unit | 主单位 | pk_main_unit | varchar(20) |  | 计量单位 (measdoc) |
| 16 | main_num | 主数量 | main_num | decimal(28, 8) |  | 数值 (UFDouble) |  | [0 , ] |
| 17 | wbs | WBS | wbs | varchar(20) |  | 项目任务 (WBS) |
| 18 | pk_warehouse | 仓库 | pk_warehouse | varchar(20) |  | 仓库 (stordoc) |
| 19 | fact_num | 实收数量 | fact_num | decimal(28, 8) |  | 数值 (UFDouble) |  | [0 , ] |
| 20 | fact_main_num | 实收主数量 | fact_main_num | decimal(28, 8) |  | 数值 (UFDouble) |  | [0 , ] |
| 21 | close_flag | 关闭 | close_flag | char(1) |  | 布尔类型 (UFBoolean) |
| 22 | memo | 备注 | memo | varchar(200) |  | 字符串 (String) |
| 23 | pk_supplier | 供应商 | pk_supplier | varchar(20) |  | 供应商基本信息 (supplier) |
| 24 | pk_producer | 生产厂商 | pk_producer | varchar(20) |  | 生产厂商(自定义档案) (Defdoc-BD006_0xx) |
