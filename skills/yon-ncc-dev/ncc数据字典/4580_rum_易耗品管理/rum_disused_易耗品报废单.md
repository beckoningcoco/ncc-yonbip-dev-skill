...
**易耗品报废单 (rum_disused / nc.vo.rum.disused.DisusedHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5016.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_disused | 报废单主键 | pk_disused | char(20) | √ | 主键 (UFID) |
...
| 5 | bill_code | 报废单号 | bill_code | varchar(40) |  | 字符串 (String) |
