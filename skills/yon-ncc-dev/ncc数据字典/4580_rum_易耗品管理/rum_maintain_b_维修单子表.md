...
**维修单子表 (rum_maintain_b / nc.vo.rum.maintain.MaintainBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5019.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_maintain_b | 维修单表体主键 | pk_maintain_b | char(20) | √ | 主键 (UFID) |
...
| 13 | price | 维修单价 | price | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 14 | maintainmoney_org | 维修金额 | maintainmoney_org | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 15 | maintainmoney_group | 集团本位币维修金额 | maintainmoney_group | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 16 | maintainmoney_global | 全局本位币维修金额 | maintainmoney_global | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
...
| 23 | pk_producer | 生产厂商 | pk_producer | varchar(20) |  | 生产厂商(自定义档案) (Defdoc-BD006_0xx) |
| 24 | nbatchcode | 批次号 | nbatchcode | varchar(40) |  | 字符串 (String) |
| 25 | pk_usedept_v | 使用部门版本 | pk_usedept_v | varchar(20) |  | 组织_部门版本信息 (dept_v) |
