...
**周转材租出赔偿清单 (rom_accept_f / nc.vo.rom.accept.Compensation)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4968.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_accept_f | 赔偿清单子表主键 | pk_accept_f | char(20) | √ | 主键 (UFID) |
...
| 6 | pk_compensationstd | 损坏赔偿标准 | pk_compensationstd | varchar(20) |  | 损坏赔偿标准 (compensationstd) |
| 7 | pk_marbaseclass | 物料分类 | pk_marbaseclass | varchar(20) |  | 物料基本分类 (marbasclass) |
...
| 10 | com_num | 赔偿数量 | com_num | decimal(28, 8) |  | 数值 (UFDouble) |
| 11 | pk_contract_b_src | 来源合同行 | pk_contract_b_src | varchar(20) |  | 字符串 (String) |
| 12 | rowno_src | 赔偿行号 | rowno_src | varchar(30) |  | 字符串 (String) |
| 13 | memo | 备注 | memo | varchar(200) |  | 字符串 (String) |
| 14 | ismaterial_flag | 是否物料 | ismaterial_flag | char(1) |  | 布尔类型 (UFBoolean) |
| 15 | com_price | 损坏赔偿单价 | com_price | decimal(28, 8) |  | 金额 (UFMoney) |
