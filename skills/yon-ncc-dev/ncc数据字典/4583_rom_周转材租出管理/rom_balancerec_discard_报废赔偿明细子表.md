...
**报废赔偿明细子表 (rom_balancerec_discard / nc.vo.rom.balancerec.BalanceRecDiscardVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4976.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_balancerec_discard | 报废赔偿明细子表主键 | pk_balancerec_discard | char(20) | √ | 主键 (UFID) |
...
| 8 | src_bill_code | 租出归还单号 | src_bill_code | varchar(40) |  | 字符串 (String) |
...
| 13 | main_num | 报废主数量 | main_num | decimal(28, 8) |  | 数值 (UFDouble) |
| 14 | pk_rent_unit | 报价单位 | pk_rent_unit | varchar(20) |  | 计量单位 (measdoc) |
| 15 | discard_num | 报废报价数量 | discard_num | decimal(28, 8) |  | 数值 (UFDouble) |
| 16 | rent_changerate | 报价单位换算率 | rent_changerate | varchar(50) |  | 字符串 (String) |
| 17 | pk_currency_origin | 原币 | pk_currency_origin | varchar(20) |  | 币种 (currtype) |
| 18 | discard_price | 报废赔偿单价(原币) | discard_price | decimal(28, 8) |  | 金额 (UFMoney) |
| 19 | discardmoney | 报废赔偿金额(原币) | discardmoney | decimal(28, 8) |  | 金额 (UFMoney) |
| 20 | memo | 备注 | memo | varchar(200) |  | 字符串 (String) |
| 21 | src_pk_bill | 来源单据主键 | src_pk_bill | varchar(20) |  | 字符串 (String) |
| 22 | src_bill_type | 来源单据类型 | src_bill_type | varchar(20) |  | 字符串 (String) |
| 23 | src_transi_type | 来源单据交易类型 | src_transi_type | varchar(20) |  | 字符串 (String) |
| 24 | src_pk_bill_b | 来源单据表体主键 | src_pk_bill_b | varchar(20) |  | 字符串 (String) |
| 25 | src_body_rowno | 来源单据表体行号 | src_body_rowno | varchar(30) |  | 字符串 (String) |
