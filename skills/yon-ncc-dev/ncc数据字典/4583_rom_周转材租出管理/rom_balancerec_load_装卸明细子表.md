...
**装卸明细子表 (rom_balancerec_load / nc.vo.rom.balancerec.BalanceRecLoadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4977.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_balancerec_transport | 装卸明细子表主键 | pk_balancerec_transport | char(20) | √ | 主键 (UFID) |
...
| 12 | num | 数量 | num | decimal(28, 8) |  | 数值 (UFDouble) |
...
| 16 | price | 单价(原币) | price | decimal(28, 8) |  | 金额 (UFMoney) |
| 17 | feemoney | 费用金额(原币) | feemoney | decimal(28, 8) |  | 金额 (UFMoney) |
| 18 | feemoney_org | 费用金额(本币) | feemoney_org | decimal(28, 8) |  | 金额 (UFMoney) |
| 19 | feemoney_group | 费用金额(集团) | feemoney_group | decimal(28, 8) |  | 金额 (UFMoney) |
| 20 | feemoney_global | 费用金额(全局) | feemoney_global | decimal(28, 8) |  | 金额 (UFMoney) |
...
| 24 | src_transi_type | 来源交易类型 | src_transi_type | varchar(20) |  | 字符串 (String) |
