...
**维修明细子表 (rom_balancerec_maintain / nc.vo.rom.balancerec.BalanceRecMaintainVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4979.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_balancerec_maintain | 维修明细子表主键 | pk_balancerec_maintain | char(20) | √ | 主键 (UFID) |
...
| 12 | repair_num | 维修数量 | repair_num | decimal(28, 8) |  | 数值 (UFDouble) |
| 13 | pk_repairstd | 维修标准 | pk_repairstd | varchar(20) |  | 维修标准 (maintainstd) |
| 14 | pk_unit | 单位 | pk_unit | varchar(20) |  | 计量单位 (measdoc) |
| 15 | pk_currency_origin | 原币 | pk_currency_origin | varchar(20) |  | 币种 (currtype) |
| 16 | repair_price | 维修单价(原币) | repair_price | decimal(28, 8) |  | 金额 (UFMoney) |
| 17 | repairmoney | 维修金额(原币) | repairmoney | decimal(28, 8) |  | 金额 (UFMoney) |
