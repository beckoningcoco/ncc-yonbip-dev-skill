...
**租赁明细 (rom_contract_s / nc.vo.rom.contract.ContractRentDetailVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4993.html
...
| 8 | rent_num_out | 已租出报价数量 | rent_num_out | decimal(28, 8) |  | 数值 (UFDouble) |
...
| 17 | pk_contract_base | 来源合同源版主键 | pk_contract_base | varchar(20) |  | 字符串 (String) |
