...
**周转材租出运输装卸费 (rom_delivery_c / nc.vo.rom.delivery.TransportPay)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4996.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_delivery_c | 费用子表主键 | pk_delivery_c | char(20) | √ | 主键 (UFID) |
