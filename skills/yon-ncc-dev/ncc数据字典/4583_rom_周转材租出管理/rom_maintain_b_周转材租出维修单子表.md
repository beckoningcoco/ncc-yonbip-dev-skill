...
**周转材租出维修单子表 (rom_maintain_b / nc.vo.rom.maintain.MaintainBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4998.html
...
| 25 | pk_contract_b_src | 来源合同行 | pk_contract_b_src | varchar(50) |  | 字符串 (String) |
| 26 | rowno_src | 合同行号 | rowno_src | varchar(30) |  | 字符串 (String) |
| 27 | ismaterial_flag | 是否物料 | ismaterial_flag | char(1) |  | 布尔类型 (UFBoolean) |
| 28 | nbatchcode | 批次号 | nbatchcode | varchar(40) |  | 字符串 (String) |
| 29 | maintain_price | 维修单价 | maintain_price | decimal(28, 8) |  | 金额 (UFMoney) |
| 30 | pk_maintainstd | 维修标准 | pk_maintainstd | varchar(20) |  | 维修标准 (maintainstd) |
| 31 | src_pk_bill_b | 来源单据表体主键 | src_pk_bill_b | varchar(50) |  | 字符串 (String) |
