...
**合同租金明细 (rom_rentreceive_d / nc.vo.rom.rentreceive.RentReceiveDetailVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5001.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_rentreceive_d | 应收租金计算子表主键 | pk_rentreceive_d | char(20) | √ | 主键 (UFID) |
...
| 11 | pk_currency_origin | 原币 | pk_currency_origin | varchar(20) |  | 币种 (currtype) |
...
| 19 | rent_num_out | 租出报价数量 | rent_num_out | decimal(28, 8) |  | 数值 (UFDouble) |
...
| 25 | start_date | 起始日期 | start_date | char(19) |  | 日期(开始) (UFDateBegin) |
| 26 | end_date | 终止日期 | end_date | char(19) |  | 日期(结束) (UFDateEnd) |
| 27 | rent_price | 租金单价(原币) | rent_price | decimal(28, 8) |  | 金额 (UFMoney) |
| 28 | day_num | 租出天数 | day_num | int |  | 整数 (Integer) |
| 29 | rent_time | 租出时间 | rent_time | decimal(28, 8) |  | 数值 (UFDouble) |
| 30 | rentmoney | 租金金额(原币) | rentmoney | decimal(28, 8) |  | 金额 (UFMoney) |
| 31 | rentmoney_org | 租金金额(本币) | rentmoney_org | decimal(28, 8) |  | 金额 (UFMoney) |
| 32 | rentmoney_group | 租金金额(集团) | rentmoney_group | decimal(28, 8) |  | 金额 (UFMoney) |
| 33 | rentmoney_global | 租金金额(全局) | rentmoney_global | decimal(28, 8) |  | 金额 (UFMoney) |
| 34 | pk_jobmngfil | 项目 | pk_jobmngfil | varchar(20) |  | 项目 (project) |
| 35 | memo | 备注 | memo | varchar(200) |  | 字符串 (String) |
