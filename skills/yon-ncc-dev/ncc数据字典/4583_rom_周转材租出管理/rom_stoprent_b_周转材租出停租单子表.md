...
**周转材租出停租单子表 (rom_stoprent_b / nc.vo.rom.stoprent.StopRentBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5004.html
...
| 31 | rowno_src | 合同行号 | rowno_src | varchar(30) |  | 字符串 (String) |
| 32 | ismaterial_flag | 是否物料 | ismaterial_flag | char(1) |  | 布尔类型 (UFBoolean) |
