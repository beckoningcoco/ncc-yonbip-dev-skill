...
**周转材租出停租单 (rom_stoprent / nc.vo.rom.stoprent.StopRentHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5003.html
...
| 4 | pk_org_in | 承租组织最新版本 | pk_org_in | varchar(20) |  | 组织_业务单元_库存组织 (stockorg) |
| 5 | pk_org_in_v | 承租组织 | pk_org_in_v | varchar(20) |  | 组织_业务单元_库存组织版本信息 (stockorg_v) |
