...
**报废赔偿明细子表 (rlm_balancepay_discard / nc.vo.rlm.balancepay.BalancePayDiscardVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4924.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_balancepay_discard | 报废赔偿明细子表主键 | pk_balancepay_discard | char(20) | √ | 主键 (UFID) |
...
| 8 | src_bill_code | 退场单号 | src_bill_code | varchar(40) |  | 字符串 (String) |
