...
**装卸明细子表 (rlm_balancepay_load / nc.vo.rlm.balancepay.BalancePayLoadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4925.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_balancepay_load | 装卸明细子表主键 | pk_balancepay_load | char(20) | √ | 主键 (UFID) |
