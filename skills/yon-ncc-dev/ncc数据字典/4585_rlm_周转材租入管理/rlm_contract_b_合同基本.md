...
**合同基本 (rlm_contract_b / nc.vo.rlm.contract.ContractBasicVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4933.html
...
| 19 | rent_price | 租金单价(原币) | rent_price | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 20 | disused_price | 报废赔偿单价(原币) | disused_price | decimal(28, 8) |  | 金额 (UFMoney) |
| 21 | lose_price | 遗失赔偿单价(原币) | lose_price | decimal(28, 8) |  | 金额 (UFMoney) |
| 22 | stoprent_price | 停租单价(原币) | stoprent_price | decimal(28, 8) |  | 金额 (UFMoney) |
| 23 | comp_price | 赔偿单价(原币) | comp_price | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 24 | rent_num_in | 已租入报价数量 | rent_num_in | decimal(28, 8) |  | 数值 (UFDouble) |  | [0 , ] |
| 25 | rent_num_return | 已还回报价数量 | rent_num_return | decimal(28, 8) |  | 数值 (UFDouble) |  | [0 , ] |
| 26 | rent_num_stop | 停租报价数量 | rent_num_stop | decimal(28, 8) |  | 数值 (UFDouble) |  | [0 , ] |
| 27 | rent_num_comp | 赔偿报价数量 | rent_num_comp | decimal(28, 8) |  | 数值 (UFDouble) |  | [0 , ] |
| 28 | rent_num_lost | 遗失报价数量 | rent_num_lost | decimal(28, 8) |  | 数值 (UFDouble) |
| 29 | rent_num_discard | 报废报价数量 | rent_num_discard | decimal(28, 8) |  | 数值 (UFDouble) |
| 30 | adjust_num | 调整报价数量 | adjust_num | decimal(28, 8) |  | 数值 (UFDouble) |
| 31 | pk_jobmngfil | 项目 | pk_jobmngfil | varchar(20) |  | 项目 (project) |
| 32 | memo | 备注 | memo | varchar(200) |  | 字符串 (String) |
| 33 | nbatchcode | 批次号 | nbatchcode | varchar(40) |  | 字符串 (String) |
| 34 | pk_contract_b_src | 协同来源表体主键 | pk_contract_b_src | varchar(20) |  | 字符串 (String) |
| 35 | pk_contract_b_base | 合同基本源版主键 | pk_contract_b_base | varchar(20) |  | 字符串 (String) |
| 36 | pk_contract_b_base_src | 协同来源表体源版主键 | pk_contract_b_base_src | varchar(50) |  | 字符串 (String) |
