...
**合同费用 (rlm_contract_c / nc.vo.rlm.contract.ContractChargementVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4934.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_contract_c | 合同费用主键 | pk_contract_c | char(20) | √ | 主键 (UFID) |
...
| 6 | pk_charge | 费用编码 | pk_charge | varchar(20) |  | 合同费用定义 (ct_expset) |
| 7 | charge_money | 费用金额 | charge_money | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
