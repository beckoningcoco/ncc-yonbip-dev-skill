...
**执行过程 (rlm_contract_p / nc.vo.rlm.contract.ContractProcessVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4939.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_contract_p | 执行过程主键 | pk_contract_p | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 3 | pk_org | 租入组织最新版本 | pk_org | varchar(20) |  | 组织_业务单元_库存组织 (stockorg) |
| 4 | pk_org_v | 租入组织 | pk_org_v | varchar(20) |  | 组织_业务单元_库存组织版本信息 (stockorg_v) |
...
| 8 | execute_reason | 原因 | execute_reason | varchar(80) |  | 字符串 (String) |
