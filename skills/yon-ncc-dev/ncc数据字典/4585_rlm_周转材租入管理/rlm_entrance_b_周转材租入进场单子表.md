...
**周转材租入进场单子表 (rlm_entrance_b / nc.vo.rlm.entrance.EntranceBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4943.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_entrance_b | 进场单子表主键 | pk_entrance_b | char(20) | √ | 主键 (UFID) |
...
| 28 | fact_num | 实收数量 | fact_num | decimal(28, 8) |  | 数值 (UFDouble) |  | [0 , ] |
| 29 | fact_main_num | 实收主数量 | fact_main_num | decimal(28, 8) |  | 数值 (UFDouble) |  | [0 , ] |
| 30 | close_flag | 关闭标志 | close_flag | char(1) |  | 布尔类型 (UFBoolean) |
