...
**周转材租入实际归还 (rlm_exit_c / nc.vo.rlm.exit.ActualRestore)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4947.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_exit_c | 实际归还子表主键 | pk_exit_c | char(20) | √ | 主键 (UFID) |
...
| 13 | num | 归还数量 | num | decimal(28, 8) |  | 数值 (UFDouble) |  | [0 , ] |
| 14 | main_num | 归还主数量 | main_num | decimal(28, 8) |  | 数值 (UFDouble) |  | [0 , ] |
| 15 | changerate | 换算率 | changerate | varchar(50) |  | 字符串 (String) |
| 16 | pk_jobmngfil | 项目 | pk_jobmngfil | varchar(20) |  | 项目 (project) |
| 17 | fact_num | 实发数量 | fact_num | decimal(28, 8) |  | 数值 (UFDouble) |  | [0 , ] |
| 18 | fact_main_num | 实发主数量 | fact_main_num | decimal(28, 8) |  | 数值 (UFDouble) |  | [0 , ] |
| 19 | close_flag | 关闭标志 | close_flag | char(1) |  | 布尔类型 (UFBoolean) |
