...
**周转材租入维修清单 (rlm_exit_e / nc.vo.rlm.exit.Maintain)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4949.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_exit_e | 维修清单子表主键 | pk_exit_e | char(20) | √ | 主键 (UFID) |
...
| 13 | rowno_src | 维修行号 | rowno_src | varchar(30) |  | 字符串 (String) |
| 14 | memo | 备注 | memo | varchar(200) |  | 备注 (Memo) |
| 15 | ismaterial_flag | 是否物料 | ismaterial_flag | char(1) |  | 布尔类型 (UFBoolean) |
| 16 | maintain_price | 维修单价 | maintain_price | decimal(28, 8) |  | 金额 (UFMoney) |
