...
**周转材租入运输装卸费用 (rlm_exit_g / nc.vo.rlm.exit.Pay)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4951.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_exit_g | 费用子表主键 | pk_exit_g | char(20) | √ | 主键 (UFID) |
