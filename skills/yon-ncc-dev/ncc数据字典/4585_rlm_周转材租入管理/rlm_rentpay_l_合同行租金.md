...
**合同行租金 (rlm_rentpay_l / nc.vo.rlm.rentpay.RentPayListVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4957.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_rentpay_l | 合同行租金主键 | pk_rentpay_l | char(20) | √ | 主键 (UFID) |
| 2 | rowno | 行号 | rowno | varchar(30) |  | 字符串 (String) |
| 3 | pk_contract_v | 合同编码 | pk_contract_v | varchar(20) |  | 周转材租入合同 (ContractHeadVO) |
| 4 | pk_contract_base | 租入合同原版主键 | pk_contract_base | varchar(20) |  | 周转材租入合同 (ContractHeadVO) |
| 5 | pk_contract_b_src | 合同行主键 | pk_contract_b_src | varchar(20) |  | 字符串 (String) |
| 6 | pk_contract_b_base_src | 来源合同号原版主键 | pk_contract_b_base_src | varchar(20) |  | 字符串 (String) |
| 7 | pk_group | 集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 8 | pk_org | 承租组织最新版本 | pk_org | varchar(20) |  | 组织_业务单元_库存组织 (stockorg) |
| 9 | pk_org_v | 承租组织 | pk_org_v | varchar(20) |  | 组织_业务单元_库存组织版本信息 (stockorg_v) |
| 10 | rowno_src | 合同行号 | rowno_src | varchar(30) |  | 字符串 (String) |
| 11 | pk_currency_origin | 原币 | pk_currency_origin | varchar(20) |  | 币种 (currtype) |
| 12 | pk_marbaseclass | 物料分类编码 | pk_marbaseclass | varchar(20) |  | 物料基本分类 (marbasclass) |
| 13 | pk_material | 物料最新版本 | pk_material | varchar(20) |  | 物料基本信息 (material_v) |
| 14 | pk_material_v | 物料 | pk_material_v | varchar(20) |  | 物料基本信息（多版本） (material) |
