...
**项目(项目管理)-参与组织 (bd_project_b / nc.vo.pim.project.ProjectBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/933.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_project_b | 项目-参与组织主键 | pk_project_b | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 3 | pk_org | 项目组织 | pk_org | varchar(20) |  | 组织 (org) |
| 4 | pk_org_v | 项目组织版本信息 | pk_org_v | varchar(20) |  | 组织_业务单元_项目组织版本信息 (itemorg_v) |
| 5 | pk_parti_org | 参与组织 | pk_parti_org | varchar(20) |  | 组织 (org) |
| 6 | pk_parti_org_v | 组织编码 | pk_parti_org_v | varchar(20) |  | 组织_版本信息 (org_v) |
