...
**CBS预算明细 (pm_budgetadd_cbs / nc.vo.pbm.budgetadd.BudgetAddCBSBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4409.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_budgetadd_cbs | 主键 | pk_budgetadd_cbs | char(20) | √ | 主键 (UFID) |
...
| 7 | budget_mny | 预算金额 | budget_mny | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
| 8 | pre_stage_mny | 上阶段金额 | pre_stage_mny | decimal(28, 8) |  | 金额 (UFMoney) |
| 9 | tot_add_mny | 累计调整 | tot_add_mny | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
| 10 | exe_mny | 执行金额 | exe_mny | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
| 11 | src_pk_budgetadd | 追加行来源追加单的主键 | src_pk_budgetadd | varchar(20) |  | 字符串 (String) |
| 12 | res_mny | 资源预算 | res_mny | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
| 13 | pre_exe_mny | 预占金额 | pre_exe_mny | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
| 14 | float_mny | 浮动金额 | float_mny | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
| 15 | float_per | 浮动百分比 | float_per | decimal(28, 8) |  | 数值 (UFDouble) | 0 |
| 16 | in_bala_mny | 收入差额 | in_bala_mny | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
| 17 | in_exe_mny | 收入执行金额 | in_exe_mny | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
| 18 | in_tot_add | 累计收入调整 | in_tot_add | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
| 19 | in_budget | 收入预算 | in_budget | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
| 20 | bala_mny | 预算余额 | bala_mny | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
| 21 | memo | 备注 | memo | varchar(300) |  | 字符串 (String) |
| 22 | is_leaf_node | 是否叶子节点 | is_leaf_node | char(1) |  | 布尔类型 (UFBoolean) |
