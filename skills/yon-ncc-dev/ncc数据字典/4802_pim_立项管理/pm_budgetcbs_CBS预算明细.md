...
**CBS预算明细 (pm_budgetcbs / nc.vo.pbm.budget.BudgetCBSBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4412.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_budgetcbs | 主键 | pk_budgetcbs | char(20) | √ | 主键 (UFID) |
...
| 11 | memo | 备注 | memo | varchar(300) |  | 字符串 (String) |
| 12 | src_pk_budgetadd | 追加行来源追加单的主键 | src_pk_budgetadd | varchar(20) |  | 字符串 (String) |
| 13 | res_mny | 资源预算 | res_mny | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
| 14 | pre_exe_mny | 预占金额 | pre_exe_mny | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
| 15 | float_mny | 浮动金额 | float_mny | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
| 16 | float_per | 浮动百分比 | float_per | decimal(28, 8) |  | 数值 (UFDouble) | 0 |
| 17 | in_bala_mny | 收入差额 | in_bala_mny | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
| 18 | in_exe_mny | 收入执行金额 | in_exe_mny | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
| 19 | in_tot_add | 累计收入调整 | in_tot_add | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
| 20 | in_budget | 收入预算 | in_budget | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
| 21 | bala_mny | 预算余额 | bala_mny | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
| 22 | is_leaf_node | 是否末级 | is_leaf_node | char(1) |  | 布尔类型 (UFBoolean) |
