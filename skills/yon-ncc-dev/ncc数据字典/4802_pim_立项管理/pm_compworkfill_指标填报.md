...
**指标填报 (pm_compworkfill / nc.vo.ppm.compworkfill.CompWorkFillHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4425.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_compworkfill | 指标填报主键 | pk_compworkfill | char(20) | √ | 主键 (UFID) |
