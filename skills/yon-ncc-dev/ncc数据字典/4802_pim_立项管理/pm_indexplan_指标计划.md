...
**指标计划 (pm_indexplan / nc.vo.ppm.indexplan.IndexPlanHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4469.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_indexplan | 指标计划主键 | pk_indexplan | char(20) | √ | 主键 (UFID) |
