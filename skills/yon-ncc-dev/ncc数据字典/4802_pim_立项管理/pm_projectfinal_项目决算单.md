...
**项目决算单 (pm_projectfinal / nc.vo.pbm.projectfinal.ProjectFinalHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4510.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_projectfinal | 决算单主键 | pk_projectfinal | char(20) | √ | 主键 (UFID) |
