...
**状态报告单 (pm_statefill / nc.vo.ppm.statefill.StateFillHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4533.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_statefill | 状态报告单主键 | pk_statefill | char(20) | √ | 主键 (UFID) |
