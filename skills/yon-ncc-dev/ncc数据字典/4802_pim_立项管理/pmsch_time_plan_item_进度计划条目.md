...
**进度计划条目 (pmsch_time_plan_item / nc.vo.pmsch.plan.TimePlanItemVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4578.html
...
| 27 | pk_progress | 进度记录 | pk_progress | varchar(20) |  | 计划执行进度条目 (TimeProgressItemVO) |
| 28 | pk_project | 项目 | pk_project | varchar(20) |  | 项目 (project) |
