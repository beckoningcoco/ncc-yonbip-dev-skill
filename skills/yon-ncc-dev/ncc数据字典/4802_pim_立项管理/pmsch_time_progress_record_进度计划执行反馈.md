...
**进度计划执行反馈 (pmsch_time_progress_record / nc.vo.pmsch.plan.progress.TimeProgressRecordVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4583.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_progress_record | 反馈记录主键 | pk_progress_record | char(20) | √ | 主键 (UFID) |
| 2 | pk_plan_item | 计划记录主键 | pk_plan_item | varchar(20) |  | 进度计划条目 (TimePlanItemVO) |
