...
**补充协议 (pcm_contr_supply / nc.vo.pcm.contract.ContrSupplyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4351.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_contr_supply | 协议页签主键 | pk_contr_supply | char(20) | √ | 主键 (UFID) |
...
| 6 | pk_src_alter | 来源补充协议主键 | pk_src_alter | varchar(50) |  | 字符串 (String) |
| 7 | src_code | 补充协议号 | src_code | varchar(50) |  | 字符串 (String) |
| 8 | alter_taxmny | 补充含税金额 | alter_taxmny | decimal(28, 8) |  | 金额 (UFMoney) |
