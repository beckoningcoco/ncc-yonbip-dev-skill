...
**结算单 (pm_contr_bal / nc.vo.pcm.contractbalance.ContractBalanceHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4432.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_contr_bal | 合同结算单主键 | pk_contr_bal | char(20) | √ | 主键 (UFID) |
