...
**付款计划 (pm_expendplan / nc.vo.pcm.expend.ExpendPlanHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4461.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_expendplan | 付款计划主键 | pk_expendplan | char(20) | √ | 主键 (UFID) |
...
| 6 | bill_code | 付款计划编码 | bill_code | varchar(50) |  | 字符串 (String) |
