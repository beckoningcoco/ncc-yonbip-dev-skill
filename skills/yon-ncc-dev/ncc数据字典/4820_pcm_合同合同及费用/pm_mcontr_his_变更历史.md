...
**变更历史 (pm_mcontr_his / nc.vo.pcm.marketcontract.ContrHistoryVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4490.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_mcontr_his | 变更历史主键 | pk_mcontr_his | char(20) | √ | 主键 (UFID) |
| 2 | contr_v | 合同版本号 | contr_v | varchar(20) |  | 字符串 (String) |
