...
**招标结果 (pm_projectbidresult / nc.vo.pcm.projectbidresult.ProjectBidResultHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4505.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_probidresult | 招标结果主键 | pk_probidresult | char(20) | √ | 主键 (UFID) |
