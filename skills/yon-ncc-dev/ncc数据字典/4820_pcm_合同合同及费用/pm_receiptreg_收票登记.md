...
**收票登记 (pm_receiptreg / nc.vo.pcm.receiptregister.ReceiptRegisterHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4521.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_receiptreg | 收票登记主键 | pk_receiptreg | char(20) | √ | 主键 (UFID) |
