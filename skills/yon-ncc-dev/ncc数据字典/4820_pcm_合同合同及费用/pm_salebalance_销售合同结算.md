...
**销售合同结算 (pm_salebalance / nc.vo.pcm.salebalance.SaleBalanceHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4527.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_sale_balance | 销售合同结算主键 | pk_sale_balance | char(20) | √ | 主键 (UFID) |
