...
**企业国有产权变动(增加)原因设置 (ipm_bd_addreason / nc.vo.ipmbd.addreason.EquityAddReasonVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3165.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_addreason | 产权变动增加原因设置主键 | pk_addreason | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 3 | pk_org | 财务组织 | pk_org | varchar(20) |  | 组织_业务单元_财务组织 (financeorg) |
| 4 | pk_org_v | 财务组织版本 | pk_org_v | varchar(20) |  | 组织_业务单元_财务组织版本信息 (financeorg_v) |
| 5 | code | 产权变动(增加)原因编码 | code | varchar(40) | √ | 字符串 (String) |
| 6 | name | 产权变动(增加)原因名称 | name | varchar(200) |  | 多语文本 (MultiLangText) |
