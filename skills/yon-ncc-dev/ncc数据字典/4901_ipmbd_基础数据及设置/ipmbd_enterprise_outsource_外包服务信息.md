...
**外包服务信息 (ipmbd_enterprise_outsource / nc.vo.ipmbd.enterpriseperson.EnterprisePersionOutsourceVo)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3224.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_outsource | 外包服务信息主键 | pk_outsource | char(20) | √ | 主键 (UFID) |
| 2 | vcompanyname | 外包公司名称 | vcompanyname | varchar(100) |  | 字符串 (String) |
| 3 | vbusinesstype | 外包业务类型 | vbusinesstype | varchar(50) |  | 字符串 (String) |
| 4 | vaddr | 办公地址 | vaddr | varchar(200) |  | 字符串 (String) |
| 5 | vpostcode | 邮编 | vpostcode | varchar(50) |  | 字符串 (String) |
| 6 | vcontactname | 联系人姓名 | vcontactname | varchar(50) |  | 字符串 (String) |
| 7 | vphoneone | 联系方式1 | vphoneone | varchar(50) |  | 字符串 (String) |
| 8 | vphonetwo | 联系方式2 | vphonetwo | varchar(50) |  | 字符串 (String) |
| 9 | vmail | 电子邮箱 | vmail | varchar(50) |  | 字符串 (String) |
| 10 | vmemo | 备注说明 | vmemo | varchar(1024) |  | 备注 (Memo) |
