...
**国有资产评估 (ipmbd_nationasserteval / nc.vo.ipmbd.nationasserteval.NationAssertEvalVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3229.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_nationasserteval | 国有资产评估主键 | pk_nationasserteval | char(20) | √ | 主键 (UFID) |
