...
**接收非国有资产评估 (ipmbd_nonasserteval / nc.vo.ipmbd.nonasserteval.NonAssertEvalVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3230.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_nonasserteval | 接收非国有资产评估主键 | pk_nonasserteval | char(20) | √ | 主键 (UFID) |
