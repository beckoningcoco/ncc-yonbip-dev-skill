...
**国有产权转让收入处置方式 (ipmrm_cancel_transferway / nc.vo.ipmrm.cancelequity.CancelTransferWayVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3364.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_cancel_transferway | 国有产权转让收入处置方式主键 | pk_cancel_transferway | char(20) | √ | 主键 (UFID) |
| 2 | crowno | 行号 | crowno | varchar(20) |  | 字符串 (String) |
| 3 | pk_transferways | 项目 | pk_transferways | varchar(20) |  | 国有产权转让收入处置方式设置 (TransferwaysVO) |
