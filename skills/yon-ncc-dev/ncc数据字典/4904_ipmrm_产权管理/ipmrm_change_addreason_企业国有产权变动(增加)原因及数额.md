...
**企业国有产权变动(增加)原因及数额 (ipmrm_change_addreason / nc.vo.ipmrm.changeequity.ChangeAddReasonVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3365.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_change_add | 企业国有产权变动(增加)原因及数额主键 | pk_change_add | char(20) | √ | 主键 (UFID) |
| 2 | pk_addreason | 变动（增加）原因 | pk_addreason | varchar(20) |  | 企业国有产权变动(增加)原因设置 (EquityAddReasonVO) |
| 3 | norigstatecapitalmny | 变动（增加）国家资本 | norigstatecapitalmny | decimal(28, 8) |  | 数值 (UFDouble) |
| 4 | nbasestatecapitalmny | 变动（增加）国家资本组织本币 | nbasestatecapitalmny | decimal(28, 8) |  | 数值 (UFDouble) |
| 5 | ngpstatecapitalmny | 变动（增加）国家资本集团本币 | ngpstatecapitalmny | decimal(28, 8) |  | 数值 (UFDouble) |
| 6 | nallstatecapitalmny | 变动（增加）国家资本全局本币 | nallstatecapitalmny | decimal(28, 8) |  | 数值 (UFDouble) |
| 7 | noriglegalcapitalmny | 变动（增加）国有法人资本 | noriglegalcapitalmny | decimal(28, 8) |  | 数值 (UFDouble) |
| 8 | nbaselegalcapitalmny | 变动（增加）国有法人资本组织本币 | nbaselegalcapitalmny | decimal(28, 8) |  | 数值 (UFDouble) |
| 9 | ngplegalcapitalmny | 变动（增加）国有法人资本集团本币 | ngplegalcapitalmny | decimal(28, 8) |  | 数值 (UFDouble) |
| 10 | nalllegalcapitalmny | 变动（增加）国有法人资本全局本币 | nalllegalcapitalmny | decimal(28, 8) |  | 数值 (UFDouble) |
