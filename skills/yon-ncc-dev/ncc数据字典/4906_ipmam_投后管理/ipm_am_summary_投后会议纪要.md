...
**投后会议纪要 (ipm_am_summary / nc.vo.ipmam.summary.SummaryVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3164.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_summary | 投后会议纪要主键 | pk_summary | char(20) | √ | 主键 (UFID) |
