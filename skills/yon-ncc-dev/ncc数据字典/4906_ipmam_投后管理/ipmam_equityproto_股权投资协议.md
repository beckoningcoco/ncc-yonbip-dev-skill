...
**股权投资协议 (ipmam_equityproto / nc.vo.ipmam.equityproto.EquityProtoVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3208.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_equityproto | 股权投资协议主键 | pk_equityproto | char(20) | √ | 主键 (UFID) |
