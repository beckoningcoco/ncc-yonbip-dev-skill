...
**出资拨付文档信息 (ipmam_fundalloc_docset / nc.vo.ipmam.fundalloc.FundallocDocsetVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3212.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_docset | 出资拨付文档信息主键 | pk_docset | char(20) | √ | 主键 (UFID) |
