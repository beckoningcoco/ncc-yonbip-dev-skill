...
**出资拨付 (ipmam_fundalloc / nc.vo.ipmam.fundalloc.FundallocVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3211.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_fundalloc | 出资拨付主键 | pk_fundalloc | char(20) | √ | 主键 (UFID) |
