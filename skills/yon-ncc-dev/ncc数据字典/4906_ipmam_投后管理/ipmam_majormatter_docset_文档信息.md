...
**文档信息 (ipmam_majormatter_docset / nc.vo.ipmam.majormatter.MajormatterDocSetVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3213.html
...
| 7 | vuploadfilename | 上传文档名称 | vuploadfilename | varchar(2048) |  | 备注 (Memo) |
| 8 | vsuffix | 后缀格式 | vsuffix | varchar(50) |  | 字符串 (String) |
