...
**投资项目后评价 (ipm_pe_posteval / nc.vo.ipmpe.posteval.PostEvalVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3203.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_posteval | 投资项目后评价主键 | pk_posteval | char(20) | √ | 主键 (UFID) |
...
| 8 | vbillcode | 评价报告编号 | vbillcode | varchar(50) |  | 字符串 (String) |
| 9 | vbillname | 评价报告名称 | vbillname | varchar(400) |  | 字符串 (String) |
