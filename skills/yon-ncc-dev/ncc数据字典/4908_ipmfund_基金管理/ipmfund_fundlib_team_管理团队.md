...
**管理团队 (ipmfund_fundlib_team / nc.vo.ipmfund.ipmfundlib.IPMFundLibTeamVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3310.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_team | 管理团队主键 | pk_team | char(20) | √ | 主键 (UFID) |
| 2 | vname | 姓名 | vname | varchar(50) |  | 字符串 (String) |
| 3 | vposition | 职位 | vposition | varchar(50) |  | 字符串 (String) |
| 4 | vcontact | 联系方式 | vcontact | varchar(100) |  | 字符串 (String) |
| 5 | vmajor_realm | 专业领域 | vmajor_realm | varchar(500) |  | 备注 (Memo) |
| 6 | vcurriculum_vitae | 履历 | vcurriculum_vitae | varchar(1024) |  | 备注 (Memo) |
