...
**决策评估指标 (ipmdm_eval_indicators / nc.vo.ipmdm.evalindicators.EvalIndicatorsVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3237.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_eval_indicators | 决策评估指标主键 | pk_eval_indicators | char(20) | √ | 主键 (UFID) |
...
| 5 | code | 指标编码 | code | varchar(50) |  | 字符串 (String) |
| 6 | name | 指标名称 | name | varchar(200) |  | 多语文本 (MultiLangText) |
| 7 | enablestate | 启用标记 | enablestate | char(1) |  | 布尔类型 (UFBoolean) |
| 8 | vmemo | 指标描述 | vmemo | varchar(2048) |  | 备注 (Memo) |
| 9 | pk_parent | 上级指标 | pk_parent | char(20) |  | 主键 (UFID) |
