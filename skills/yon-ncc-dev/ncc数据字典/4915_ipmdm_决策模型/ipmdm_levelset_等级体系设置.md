...
**等级体系设置 (ipmdm_levelset / nc.vo.ipmdm.levelset.LevelSetVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3247.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_levelset | 等级体系设置主键 | pk_levelset | char(20) | √ | 主键 (UFID) |
...
| 5 | code | 等级体系设置编码 | code | varchar(40) |  | 字符串 (String) |
| 6 | name | 等级体系设置名称 | name | varchar(80) |  | 多语文本 (MultiLangText) |
| 7 | enablestate | 启用标记 | enablestate | char(1) |  | 布尔类型 (UFBoolean) |
| 8 | vmemo | 备注 | vmemo | varchar(2048) |  | 备注 (Memo) |
| 9 | vreserve1 | 预留字段1 | vreserve1 | varchar(50) |  | 字符串 (String) |
| 10 | vreserve2 | 预留字段2 | vreserve2 | varchar(50) |  | 字符串 (String) |
| 11 | vreserve3 | 预留字段3 | vreserve3 | varchar(50) |  | 字符串 (String) |
| 12 | vreserve4 | 预留字段4 | vreserve4 | varchar(50) |  | 字符串 (String) |
| 13 | vreserve5 | 预留字段5 | vreserve5 | varchar(50) |  | 字符串 (String) |
| 14 | vreserve6 | 预留字段6 | vreserve6 | varchar(50) |  | 字符串 (String) |
| 15 | vreserve7 | 预留字段7 | vreserve7 | varchar(50) |  | 字符串 (String) |
| 16 | vreserve8 | 预留字段8 | vreserve8 | varchar(50) |  | 字符串 (String) |
| 17 | vreserve9 | 预留字段9 | vreserve9 | varchar(50) |  | 字符串 (String) |
| 18 | vreserve10 | 预留字段10 | vreserve10 | varchar(50) |  | 字符串 (String) |
