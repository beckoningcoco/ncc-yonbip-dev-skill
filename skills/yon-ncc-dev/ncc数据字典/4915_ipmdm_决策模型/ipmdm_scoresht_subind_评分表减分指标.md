...
**评分表减分指标 (ipmdm_scoresht_subind / nc.vo.ipmdm.scoresht.ScoreShtSubindVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3258.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_scoresht_subind | 评分表减分指标主键 | pk_scoresht_subind | char(20) | √ | 主键 (UFID) |
...
| 6 | vmemo | 指标描述 | vmemo | varchar(2048) |  | 备注 (Memo) |
| 7 | nfull_score | 指标满分 | nfull_score | decimal(28, 2) |  | 数值 (UFDouble) |
| 8 | vcoring_criteria | 评分标准 | vcoring_criteria | varchar(2048) |  | 备注 (Memo) |
| 9 | score | 评分 | score | decimal(28, 2) |  | 数值 (UFDouble) | 0.00 |
| 10 | reason | 评分理由 | reason | varchar(2048) |  | 备注 (Memo) |
