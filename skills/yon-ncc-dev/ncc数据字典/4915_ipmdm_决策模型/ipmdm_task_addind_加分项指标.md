...
**加分项指标 (ipmdm_task_addind / nc.vo.ipmdm.task.TaskAddindVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3261.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_task_addind | 加分项主键 | pk_task_addind | char(20) | √ | 主键 (UFID) |
| 2 | pk_indicators | 指标编码 | pk_indicators | varchar(20) |  | 指标项 (IndicatorsVO) |
| 3 | nfull_score | 指标满分 | nfull_score | decimal(28, 8) |  | 数值 (UFDouble) |
| 4 | vcoring_criteria | 评分标准 | vcoring_criteria | varchar(200) |  | 备注 (Memo) |
