...
**其他补充项 (ipmdm_task_ext / nc.vo.ipmdm.task.TaskExtVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3264.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_task_ext | 评分表其它补充主键 | pk_task_ext | char(20) | √ | 主键 (UFID) |
| 2 | name | 名称 | name | varchar(200) |  | 字符串 (String) |
| 3 | eval_content | 评估内容 | eval_content | varchar(2048) |  | 备注 (Memo) |
