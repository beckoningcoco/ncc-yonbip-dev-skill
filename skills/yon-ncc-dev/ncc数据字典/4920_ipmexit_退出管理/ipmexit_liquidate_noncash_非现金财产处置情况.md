...
**非现金财产处置情况 (ipmexit_liquidate_noncash / nc.vo.ipmexit.exitliquidate.ExitLiquidateNoncashVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3276.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_noncash | 非现金处置主键 | pk_noncash | char(20) | √ | 主键 (UFID) |
| 2 | vname | 财产名称 | vname | varchar(100) |  | 字符串 (String) |
| 3 | variety | 财产种类 | variety | varchar(100) |  | 字符串 (String) |
| 4 | vdisposeway | 处置方式 | vdisposeway | varchar(100) |  | 字符串 (String) |
| 5 | norigdisposemny | 处置金额 | norigdisposemny | decimal(28, 8) |  | 数值 (UFDouble) |
| 6 | nbasedisposemny | 处置金额组织本币 | nbasedisposemny | decimal(28, 8) |  | 数值 (UFDouble) |
| 7 | ngpdisposemny | 处置金额集团本币 | ngpdisposemny | decimal(28, 8) |  | 数值 (UFDouble) |
| 8 | nalldisposemny | 处置金额全局本币 | nalldisposemny | decimal(28, 8) |  | 数值 (UFDouble) |
...
| 17 | vreserve9 | 预留字段9 | vreserve9 | varchar(50) |  | 字符串 (String) |
...
| 25 | vfirsttype | 源头单据类型 | vfirsttype | varchar(20) |  | 字符串 (String) |
| 26 | vfirstcode | 源头单据号 | vfirstcode | varchar(50) |  | 字符串 (String) |
| 27 | cfirstid | 源头单据主表主键 | cfirstid | char(20) |  | 主键 (UFID) |
| 28 | cfirstbid | 源头单据表体主键 | cfirstbid | char(20) |  | 主键 (UFID) |
| 29 | vfirstrowno | 源头单据行号 | vfirstrowno | varchar(20) |  | 字符串 (String) |
| 30 | vfirsttrantype | 源头交易类型 | vfirsttrantype | varchar(20) |  | 字符串 (String) |
| 31 | vmemo | 备注 | vmemo | varchar(1024) |  | 字符串 (String) |
