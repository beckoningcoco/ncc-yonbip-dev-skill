...
**物料生产线明细 (pd_wk_prodinv / nc.vo.pd.pd0408.entity.MaterProBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4387.html
...
| 5 | cpdwkid | 工作中心生产档案 | cpdwkid | char(20) | √ | 主键 (UFID) |
...
| 16 | vchangerate | 换算率 | vchangerate | varchar(50) |  | 字符串 (String) |
