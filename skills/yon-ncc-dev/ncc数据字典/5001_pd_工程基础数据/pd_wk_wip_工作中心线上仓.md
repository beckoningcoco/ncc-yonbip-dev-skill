...
**工作中心线上仓 (pd_wk_wip / nc.vo.pd.pd0404.entity.WkWipVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4391.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cwk_wipid | 工作中心线上仓 | cwk_wipid | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 集团 | pk_group | varchar(20) | √ | 组织_集团 (group) |
| 3 | pk_org | 工厂 | pk_org | varchar(20) | √ | 组织_业务单元_工厂 (factory) |
| 4 | pk_org_v | 工厂版本 | pk_org_v | varchar(20) |  | 组织_业务单元_工厂版本信息 (factory_v) |
| 5 | cstordocid | 仓库 | cstordocid | varchar(20) | √ | 仓库 (stordoc) |
| 6 | vrowno | 序号 | vrowno | varchar(50) | √ | 字符串 (String) |  | [0 , ] |
