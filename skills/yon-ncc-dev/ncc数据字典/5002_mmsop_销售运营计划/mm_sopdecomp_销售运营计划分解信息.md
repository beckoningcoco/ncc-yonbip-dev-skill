...
**销售运营计划分解信息 (mm_sopdecomp / nc.vo.mmsop.sop.entity.SOPDecompVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3786.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_sopdecomp | SOP分解信息 | pk_sopdecomp | char(20) | √ | 主键 (UFID) |
