...
**按单反向跟踪处理左树节点 (mm_revottree / nc.vo.mmdp.reverseot.entity.RevOTTreeNodeVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3768.html
...
| 7 | fbilltype | 单据类型 | fbilltype | varchar(50) |  | 单据类型 (RevBillTypeEnum) |  | ONHAND=存量; |