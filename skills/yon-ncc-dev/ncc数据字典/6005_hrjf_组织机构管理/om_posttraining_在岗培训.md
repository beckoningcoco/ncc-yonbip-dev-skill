...
**在岗培训 (om_posttraining / nc.vo.om.post.PostTrainingVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3977.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_post_sub | 在岗培训主键 | pk_post_sub | char(20) | √ | 主键 (UFID) |
...
| 7 | triancont | 培训内容 | triancont | varchar(200) |  | 字符串 (String) |