...
**公司版本信息HR (org_corp_v / nc.vo.om.orginfo.HRCorpVersionVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4031.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_vid | 版本主键 | pk_vid | char(20) | √ | 主键 (UFID) |
| 2 | pk_corp | 公司主键 | pk_corp | varchar(20) | √ | 主键 (UFID) |
...
| 26 | briefintro | 简介 | briefintro | varchar(1000) |  | 字符串 (String) |
...
| 36 | innercode | 编码级次 | innercode | varchar(60) |  | 字符串 (String) |
