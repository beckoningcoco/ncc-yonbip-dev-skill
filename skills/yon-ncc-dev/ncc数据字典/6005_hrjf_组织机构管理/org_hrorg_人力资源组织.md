...
**人力资源组织 (org_hrorg / nc.vo.om.orginfo.HRHROrgVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4079.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_hrorg | 主键 | pk_hrorg | char(20) | √ | 主键 (UFID) |
...
| 6 | pk_fatherorg | 上级人力资源组织 | pk_fatherorg | varchar(20) |  | 组织_业务单元_人力资源组织 (hrorg) |
