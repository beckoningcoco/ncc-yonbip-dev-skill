...
**组织主管HR (org_orgmanager / nc.vo.om.orginfo.HROrgManagerVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4106.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_orgmanager | 组织主管主键 | pk_orgmanager | varchar(50) | √ | 字符串 (String) |
| 2 | pk_org | 组织主键 | pk_org | varchar(20) |  | 组织 (org) |
| 3 | pk_dept | 部门主键 | pk_dept | char(20) |  | 主键 (UFID) |
...
| 8 | viewotherdirector | 查看其它主管 | viewotherdirector | char(1) |  | 布尔类型 (UFBoolean) |
