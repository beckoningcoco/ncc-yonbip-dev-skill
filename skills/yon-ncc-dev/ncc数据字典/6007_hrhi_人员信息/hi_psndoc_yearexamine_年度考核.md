...
**年度考核 (hi_psndoc_yearexamine / nc.vo.hi.psndoc.YearExamineVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2594.html
...
| 7 | examineyear | 考核年度 | examineyear | 0 |  | 字符串 (String) |
| 8 | examineresult | 考核结果 | examineresult | 0 |  | 字符串 (String) |
