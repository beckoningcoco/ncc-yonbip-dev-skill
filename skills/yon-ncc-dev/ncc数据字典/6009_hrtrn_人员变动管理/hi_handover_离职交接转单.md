...
**离职交接转单 (hi_handover / nccloud.dto.hryf.handover.HandoverVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2546.html
...
| 10 | pk_psndoc | 人员信息 | pk_psndoc | varchar(20) |  | 人员基本信息 (bd_psndoc) |
| 11 | pk_psnjob | 任职信息 | pk_psnjob | varchar(20) |  | 工作记录 (hi_psnjob) |
| 12 | pk_psndoc_ctrt | 合同信息 | pk_psndoc_ctrt | varchar(20) |  | 合同信息 (hi_psndoc_ctrt) |