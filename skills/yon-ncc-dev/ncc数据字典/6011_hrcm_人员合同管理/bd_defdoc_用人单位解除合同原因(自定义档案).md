...
**用人单位解除合同原因(自定义档案) (bd_defdoc / nc.vo.bd.defdoc.DefdocVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/524.html
...
| 8 | pid | 上级档案 | pid | varchar(20) |  | 用人单位解除合同原因(自定义档案) (Defdoc-HRCM002_0xx) |
| 9 | memo | 备注 | memo | varchar(200) |  | 字符串 (String) |
| 10 | innercode | 内部编码 | innercode | varchar(50) |  | 字符串 (String) |
| 11 | dataoriginflag | 分布式 | dataoriginflag | int |  | 整数 (Integer) |
| 12 | shortname | 简称 | shortname | varchar(200) |  | 多语文本 (MultiLangText) |
