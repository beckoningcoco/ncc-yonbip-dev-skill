...
**岗位协议 (hrcm_agreement / nc.vo.hrcm.agreement.PostContVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2703.html
...
| 7 | contcode | 岗位协议编号 | contcode | varchar(30) | √ | 字符串 (String) |
