...
**作业平台单据影像显示方式 (ssctp_imagshow / nc.vo.ssctp.dooroad.DRImagShowVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5648.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_imagshow | 唯一标识 | pk_imagshow | char(20) | √ | 主键 (UFID) |
