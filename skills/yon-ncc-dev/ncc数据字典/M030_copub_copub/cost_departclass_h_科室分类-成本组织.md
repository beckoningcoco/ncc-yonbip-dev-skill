...
**科室分类-成本组织 (cost_departclass_h / nc.vo.hrpco.departclassorg.DepartclassorgVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1610.html
...
| 5 | code | 科室分类编号 | code | varchar(50) |  | 字符串 (String) |
| 6 | name | 科室分类名称 | name | varchar(50) |  | 字符串 (String) |
| 7 | maketime | 制单时间 | maketime | char(19) |  | 日期时间 (UFDateTime) |
| 8 | lastmaketime | 最后修改时间 | lastmaketime | char(19) |  | 日期时间 (UFDateTime) |
| 9 | parentcode | 上级分类编码 | parentcode | varchar(20) |  | 科室分类-成本组织 (departclassorgVO) |
| 10 | parentname | 上级分类名称 | parentname | varchar(20) |  | 科室分类-成本组织 (departclassorgVO) |
...
| 16 | father_pk | 上级 | father_pk | varchar(50) |  | 字符串 (String) |
