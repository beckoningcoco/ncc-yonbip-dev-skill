...
**收入分类-集团 (cost_incodeclass_h / nc.vo.hrpco.incodeclassgp.IncodeclassgpVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1615.html
...
| 5 | parentid | 上级分类编码 | parentid | varchar(50) |  | 字符串 (String) |
| 6 | parentname | 上级分类 | parentname | varchar(50) |  | 字符串 (String) |
| 7 | father_pk | 上级 | father_pk | varchar(20) |  | 收入分类-集团 (incodeclassgp) |
| 8 | innercode | 内联码 | innercode | varchar(50) |  | 字符串 (String) |
| 9 | enablestate | 启用状态 | enablestate | char(1) |  | 布尔类型 (UFBoolean) |
| 10 | vmemo | 备注 | vmemo | varchar(50) |  | 字符串 (String) |
| 11 | code | 收入分类编号 | code | varchar(50) |  | 字符串 (String) |
| 12 | name | 收入分类名称 | name | varchar(50) |  | 字符串 (String) |
