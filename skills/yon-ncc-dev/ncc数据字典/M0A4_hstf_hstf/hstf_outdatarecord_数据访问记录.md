...
**数据访问记录 (hstf_outdatarecord / nc.vo.hstf.outstockdata.OutDataRecordVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2781.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_outdatarecord | RID | pk_outdatarecord | char(20) | √ | 主键 (UFID) |
