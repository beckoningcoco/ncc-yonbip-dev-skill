...
**来源客户档案 (hpf_cust / nc.vo.hpf.hpfcust.CustVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2619.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_cust | 主键 | pk_cust | char(20) | √ | 主键 (UFID) |
...
| 7 | code | 客户编码 | code | varchar(50) |  | 字符串 (String) |
| 8 | name | 客户名称 | name | varchar(256) |  | 字符串 (String) |
