...
**业务汇总单据 (hrpco_businesssummary_h / nc.vo.hrpco.cobusinesssummary.BusinessSummaryH)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2753.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_businesssummary | 主键 | pk_businesssummary | char(20) | √ | 主键 (UFID) |
...
| 10 | billid | 单据ID | billid | varchar(50) |  | 字符串 (String) |
