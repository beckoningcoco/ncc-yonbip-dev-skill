...
**医疗计划服务分类控制策略 (bd_uh_hp_srvcate_poli_ctl / com.yonyou.yh.nhis.bd.healthplan.vo.HPSrvCateCtlVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1041.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_hpsrvcatepolictl | 医保计划服务分类控制策略主键 | pk_hpsrvcatepolictl | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 所属集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 3 | pk_org | 所属机构 | pk_org | varchar(20) |  | 组织_业务单元_医卫 (hisorg) |
| 4 | pk_hp | 医保计划 | pk_hp | varchar(20) |  | 医保计划 (healthplan) |
| 5 | pk_hpsrvcate | 医保计划服务分类 | pk_hpsrvcate | char(20) |  | 主键 (UFID) |
| 6 | sortno | 序号 | sortno | int |  | 整数 (Integer) |
| 7 | pk_hpsrvpolictl | 控制分类 | pk_hpsrvpolictl | varchar(20) |  | 医保政策控制类别(自定义档案) (Defdoc-040004) |
