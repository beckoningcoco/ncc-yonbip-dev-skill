...
**打印机参数设置 (uh_ex_med_printer_set / com.yonyou.yh.nhis.sch.med.vo.MedPrinterSetVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6083.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_medprinterset | 打印机参数设置主键 | pk_medprinterset | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 集团 | pk_group | varchar(20) | √ | 组织_集团 (group) |
| 3 | pk_org | 组织 | pk_org | varchar(20) |  | 组织 (org) |
| 4 | pk_org_v | 组织版本 | pk_org_v | varchar(20) |  | 组织_版本信息 (org_v) |
| 5 | pk_param | 参数名称键值 | pk_param | varchar(20) |  | 字符串 (String) |
| 6 | dt_param | 参数名称编码 | dt_param | varchar(50) |  | 字符串 (String) |
| 7 | name_param | 参数名称 | name_param | varchar(100) |  | 字符串 (String) |
| 8 | param_type | 参数类型 | param_type | varchar(20) |  | 字符串 (String) |
| 9 | dept | 科室 | dept | varchar(20) |  | 字符串 (String) |
| 10 | printer | 打印机名称 | printer | varchar(100) |  | 字符串 (String) |
| 11 | printer_ip | 打印机IP地址 | printer_ip | varchar(15) |  | 字符串 (String) |
