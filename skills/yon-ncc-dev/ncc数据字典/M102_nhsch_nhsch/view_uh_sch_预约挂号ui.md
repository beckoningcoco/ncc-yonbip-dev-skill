...
**预约挂号ui (view_uh_sch / com.yonyou.yh.nhis.sch.appt.vo.SchTestVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6313.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_schweek | 主键 | pk_schweek | char(20) | √ | 主键 (UFID) |
| 2 | name_res | 资源名称 | name_res | varchar(50) |  | 字符串 (String) |
| 3 | pk_schres | 资源主键 | pk_schres | varchar(20) |  | 排班资源 (SchResVO) |
| 4 | name_schsrv | 服务名称 | name_schsrv | varchar(50) |  | 字符串 (String) |
| 5 | pk_schsrv | 服务主键 | pk_schsrv | varchar(50) |  | 字符串 (String) |
| 6 | mon | 星期一 | mon | varchar(50) |  | 字符串 (String) |
| 7 | tue | 星期二 | tue | varchar(50) |  | 字符串 (String) |
| 8 | wed | 星期三 | wed | varchar(50) |  | 字符串 (String) |
| 9 | thu | 星期四 | thu | varchar(50) |  | 字符串 (String) |
| 10 | fri | 星期五 | fri | varchar(50) |  | 字符串 (String) |
| 11 | sat | 星期六 | sat | varchar(50) |  | 字符串 (String) |
| 12 | sun | 星期日 | sun | varchar(50) |  | 字符串 (String) |
| 13 | pk_dateslot | 午别主键 | pk_dateslot | varchar(20) |  | 排班_日期分组 (dateslot) |
| 14 | dateslotname | 午别名称 | dateslotname | varchar(50) |  | 字符串 (String) |
