...
**患者卡信息 (uh_pi_card / com.yonyou.yh.nhis.pv.patibanner.vo.PatiBannerCardVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6177.html
...
| 4 | pk_pati | 患者主键 | pk_pati | varchar(20) |  | 患者基本信息 (patibanner) |
...
| 9 | date_begin | 有效开始日期 | date_begin | char(19) |  | 日期时间 (UFDateTime) |
| 10 | date_end | 有效结束日期 | date_end | char(19) |  | 日期时间 (UFDateTime) |
