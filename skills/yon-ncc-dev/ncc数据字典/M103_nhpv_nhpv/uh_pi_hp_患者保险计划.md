...
**患者保险计划 (uh_pi_hp / com.yonyou.yh.nhis.pv.patibanner.vo.PatiBannerHpVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6194.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_patihp | 保险计划主键 | pk_patihp | char(20) | √ | 主键 (UFID) |
| 2 | pk_pati | 患者主键 | pk_pati | varchar(20) |  | 患者基本信息 (patibanner) |
