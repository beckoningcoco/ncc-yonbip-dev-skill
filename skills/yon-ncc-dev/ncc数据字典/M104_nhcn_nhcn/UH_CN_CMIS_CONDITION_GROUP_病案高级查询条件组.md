...
**病案高级查询条件组 (UH_CN_CMIS_CONDITION_GROUP / com.yonyou.yh.nhis.cn.cmis.query.vo.ProQueryConditionGroupVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5958.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_condition_group | 病案高级查询条件组主键 | pk_condition_group | char(50) | √ | 主键 (UFID) |
| 2 | condition_group_name | 条件组名称 | condition_group_name | varchar(50) |  | 字符串 (String) |
