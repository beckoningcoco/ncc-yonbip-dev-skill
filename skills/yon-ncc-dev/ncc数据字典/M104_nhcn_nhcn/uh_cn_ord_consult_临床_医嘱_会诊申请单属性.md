...
**临床_医嘱_会诊申请单属性 (uh_cn_ord_consult / com.yonyou.yh.nhis.cn.ord.v2.vo.CNOrdConsultVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6019.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_ordcon | 会诊属性主键 | pk_ordcon | char(20) | √ | 主键 (UFID) |
...
| 6 | dt_contype | 会诊级别 | dt_contype | varchar(30) |  | 字符串 (String) |
| 7 | pk_contype | 会诊级别主键 | pk_contype | varchar(20) |  | 字符串 (String) |
| 8 | pk_psn_phy | 诊断医生 | pk_psn_phy | varchar(20) |  | 字符串 (String) |
| 9 | name_psn_phy | 诊断医生名称 | name_psn_phy | varchar(50) |  | 字符串 (String) |
| 10 | pk_psn_ns | 会诊护士 | pk_psn_ns | varchar(20) |  | 字符串 (String) |
| 11 | name_psn_ns | 会诊护士名称 | name_psn_ns | varchar(50) |  | 字符串 (String) |
| 12 | pk_org_con | 会诊机构 | pk_org_con | varchar(20) |  | 字符串 (String) |
| 13 | pk_dept_con | 会诊科室 | pk_dept_con | varchar(20) |  | 字符串 (String) |
| 14 | desc_con | 会诊内容 | desc_con | varchar(4000) |  | 字符串 (String) |
| 15 | date_con | 会诊日期 | date_con | char(19) |  | 日期时间 (UFDateTime) |
| 16 | desc_conbl | 病历摘要 | desc_conbl | varchar(4000) |  | 字符串 (String) |
| 17 | target_con | 会诊目的 | target_con | varchar(4000) |  | 字符串 (String) |
| 18 | is_dianming | 是否点名 | is_dianming | varchar(5) |  | 字符串 (String) |
...
| 26 | flag_ns | 护理参加标志 | flag_ns | char(1) |  | 布尔类型 (UFBoolean) |
