...
**医疗执行_部门_检查预约通知 (uh_ex_dept_risappt / com.yonyou.yh.nhis.ex.mt.vo.DeptMTAppRisApptVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6079.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_risappt | 检查预约通知主键 | pk_risappt | char(20) | √ | 主键 (UFID) |
...
| 16 | pk_srv | 检查项目 | pk_srv | varchar(50) |  | 字符串 (String) |
| 17 | code_srv | 检查项目名称 | code_srv | varchar(50) |  | 字符串 (String) |
| 18 | note_exam | 检查注意事项 | note_exam | varchar(500) |  | 字符串 (String) |
...
| 23 | pk_msp | 医技资源 | pk_msp | varchar(20) |  | 医技资源类型(自定义档案) (Defdoc-010600) |
| 24 | date_appt | 预约日期 | date_appt | char(19) |  | 日期 (UFDate) |
| 25 | ticketno | 预约排队号 | ticketno | varchar(50) |  | 字符串 (String) |
| 26 | time_appt | 预约时间 | time_appt | char(8) |  | 时间 (UFTime) |
...
| 30 | name_psn_notice | 通知人员名称 | name_psn_notice | varchar(256) |  | 字符串 (String) |
