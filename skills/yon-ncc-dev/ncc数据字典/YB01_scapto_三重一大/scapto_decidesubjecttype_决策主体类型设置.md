...
**决策主体类型设置 (scapto_decidesubjecttype / nc.vo.scapto.meetingmanage.decidesubjecttype.DecideSubjectTypeVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5120.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_decidesubjecttype | 决策主体类型设置主键 | pk_decidesubjecttype | char(20) | √ | 主键 (UFID) |
...
| 6 | code | 决策主体类型编码 | code | varchar(40) | √ | 字符串 (String) |
| 7 | name | 决策主体类型名称 | name | varchar(200) |  | 多语文本 (MultiLangText) |
| 8 | pk_leadershiptype | 领导班子类型 | pk_leadershiptype | varchar(20) |  | 领导班子类型设置 (LeadershipTypeVO) |
