...
**文档上传设置 (scapto_documentset / nc.vo.scapto.documentset.DocumentSetVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5122.html
...
| 8 | transactiontype | 交易类型 | transactiontype | varchar(20) |  | 交易类型 (transtype) |
