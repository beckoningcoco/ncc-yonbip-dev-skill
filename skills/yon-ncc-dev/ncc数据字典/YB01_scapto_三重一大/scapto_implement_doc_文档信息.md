...
**文档信息 (scapto_implement_doc / nc.vo.scapto.implementmanage.implementreport.ImplementDocVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5132.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_docset | 文档信息主键 | pk_docset | char(20) | √ | 主键 (UFID) |
| 2 | crowno | 行号 | crowno | varchar(20) |  | 字符串 (String) |
| 3 | pk_documentset | 文档上传设置数据 | pk_documentset | varchar(20) |  | 文档上传设置 (DocumentSetVO) |
| 4 | docname | 文档名称 | docname | varchar(400) |  | 字符串 (String) |
| 5 | bisneedupload | 是否必传 | bisneedupload | char(1) |  | 布尔类型 (UFBoolean) |
| 6 | bisupload | 是否上传 | bisupload | char(1) |  | 布尔类型 (UFBoolean) |
| 7 | iupload_count | 已上传数量 | iupload_count | int |  | 整数 (Integer) |
...
| 15 | cfirstid | 源头单据主表主键 | cfirstid | char(20) |  | 主键 (UFID) |
