...
**实施状态设置 (scapto_implementstatus / nc.vo.scapto.implementmanage.implementstatus.ImplementStatusVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5137.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_implementstatus | 实施状态设置主键 | pk_implementstatus | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 3 | pk_org | 组织 | pk_org | varchar(20) |  | 组织_业务单元_公司 (corp) |
| 4 | pk_org_v | 组织版本 | pk_org_v | varchar(20) |  | 组织_业务单元_公司版本信息 (corp_v) |
| 5 | code | 实施状态编码 | code | varchar(40) | √ | 字符串 (String) |
| 6 | name | 实施状态名称 | name | varchar(200) |  | 多语文本 (MultiLangText) |
| 7 | enablestate | 启用状态 | enablestate | char(1) |  | 布尔类型 (UFBoolean) |
| 8 | bispreset | 预置标识 | bispreset | char(1) |  | 布尔类型 (UFBoolean) |
| 9 | memo | 备注 | memo | varchar(200) |  | 多语文本 (MultiLangText) |
...
| 42 | modifier | 最后修改人 | modifier | varchar(20) |  | 用户 (user) |
| 43 | modifiedtime | 最后修改时间 | modifiedtime | char(19) |  | 日期时间 (UFDateTime) |