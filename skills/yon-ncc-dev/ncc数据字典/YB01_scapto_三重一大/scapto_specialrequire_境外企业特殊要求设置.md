...
**境外企业特殊要求设置 (scapto_specialrequire / nc.vo.scapto.specialrequire.SpecialRequireVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5180.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_specialrequire | 境外企业特殊要求设置主键 | pk_specialrequire | char(20) | √ | 主键 (UFID) |
...
| 5 | code | 境外企业特殊要求编码 | code | varchar(40) | √ | 字符串 (String) |
| 6 | name | 境外企业特殊要求名称 | name | varchar(200) |  | 多语文本 (MultiLangText) |
