...
**专项任务设置 (scapto_specialtask / nc.vo.scapto.topicmanage.specialtask.SpecialTaskVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5181.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_specialtask | 专项任务设置主键 | pk_specialtask | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 3 | pk_org | 专项任务所属组织 | pk_org | varchar(20) |  | 组织_业务单元_行政组织 (adminorg) |
| 4 | pk_org_v | 专项任务所属组织版本 | pk_org_v | varchar(20) |  | 组织_业务单元_行政组织版本信息 (adminorg_v) |
| 5 | code | 专项任务编码 | code | varchar(40) |  | 字符串 (String) |
| 6 | name | 专项任务名称 | name | varchar(200) |  | 多语文本 (MultiLangText) |
| 7 | enablestate | 启用状态 | enablestate | char(1) |  | 布尔类型 (UFBoolean) |
| 8 | memo | 备注 | memo | varchar(200) |  | 多语文本 (MultiLangText) |
