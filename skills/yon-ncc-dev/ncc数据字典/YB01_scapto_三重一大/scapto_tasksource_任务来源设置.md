...
**任务来源设置 (scapto_tasksource / nc.vo.scapto.topicmanage.tasksource.TaskSourceVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5192.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_tasksource | 任务来源设置主键 | pk_tasksource | char(20) | √ | 主键 (UFID) |
...
| 5 | code | 任务来源编码 | code | varchar(40) | √ | 字符串 (String) |
| 6 | name | 任务来源名称 | name | varchar(200) |  | 多语文本 (MultiLangText) |
