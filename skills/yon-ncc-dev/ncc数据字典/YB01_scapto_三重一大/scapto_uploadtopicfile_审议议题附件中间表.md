...
**审议议题附件中间表 (scapto_uploadtopicfile / nc.vo.scapto.meetingreport.meetingupload.UploadTopicFileVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5203.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_topicuploadfile | 附件子表标识主键 | pk_topicuploadfile | char(20) | √ | 主键 (UFID) |
