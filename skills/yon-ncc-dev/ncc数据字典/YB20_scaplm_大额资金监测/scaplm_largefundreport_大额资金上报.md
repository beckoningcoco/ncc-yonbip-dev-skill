...
**大额资金上报 (scaplm_largefundreport / nc.vo.scaplm.datareporting.largefundreport.LargeFundReportVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5098.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_largefundreport | 大额资金上报主键 | pk_largefundreport | char(20) | √ | 主键 (UFID) |
...
| 19 | vmemo | 备注 | vmemo | varchar(500) |  | 备注 (Memo) |
