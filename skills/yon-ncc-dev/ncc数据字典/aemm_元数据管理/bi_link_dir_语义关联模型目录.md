...
**语义关联模型目录 (bi_link_dir / nc.vo.bi.metalink.MetaLinkDirVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1198.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | guid | 分类 | guid | char(20) | √ | 主键 (UFID) |
| 2 | pguid | 上级分类 | pguid | varchar(20) |  | 语义关联模型目录 (linkdir) |
| 3 | dirname | 分类名称 | dirname | varchar(200) |  | 多语文本 (MultiLangText) |
