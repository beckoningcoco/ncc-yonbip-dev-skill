...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6488.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_rentsettle | pk_rentsettle | pk_rentsettle | char(20) | √ |  | '~' |
...
| 14 | cooperate_bill | cooperate_bill | cooperate_bill | char(1) |
| 15 | cooperate_flag | cooperate_flag | cooperate_flag | char(1) |
| 16 | coop_pk_bill | coop_pk_bill | coop_pk_bill | varchar2(20) |  |  | '~' |
| 17 | gather_money_global | gather_money_global | gather_money_global | number(28, 8) |
| 18 | gather_money_group | gather_money_group | gather_money_group | number(28, 8) |
| 19 | gather_money_org | gather_money_org | gather_money_org | number(28, 8) |
| 20 | lease_type | lease_type | lease_type | number(38, 0) |
| 21 | memo | memo | memo | varchar2(50) |
| 22 | pk_affirmant | pk_affirmant | pk_affirmant | varchar2(20) |  |  | '~' |
| 23 | pk_currency_local | pk_currency_local | pk_currency_local | varchar2(20) |  |  | '~' |
| 24 | pk_currency_origin | pk_currency_origin | pk_currency_origin | varchar2(20) |  |  | '~' |
| 25 | pk_customer | pk_customer | pk_customer | varchar2(20) |  |  | '~' |
| 26 | pk_fiorg_in | pk_fiorg_in | pk_fiorg_in | varchar2(20) |  |  | '~' |
| 27 | pk_fiorg_in_v | pk_fiorg_in_v | pk_fiorg_in_v | varchar2(20) |  |  | '~' |
| 28 | pk_fiorg_out | pk_fiorg_out | pk_fiorg_out | varchar2(20) |  |  | '~' |
| 29 | pk_fiorg_out_v | pk_fiorg_out_v | pk_fiorg_out_v | varchar2(20) |  |  | '~' |
...
| 35 | pk_org_out | pk_org_out | pk_org_out | varchar2(20) |  |  | '~' |
| 36 | pk_org_out_v | pk_org_out_v | pk_org_out_v | varchar2(20) |  |  | '~' |
| 37 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 38 | pk_raorg_in | pk_raorg_in | pk_raorg_in | varchar2(20) |  |  | '~' |
| 39 | pk_raorg_in_v | pk_raorg_in_v | pk_raorg_in_v | varchar2(20) |  |  | '~' |
| 40 | pk_raorg_out | pk_raorg_out | pk_raorg_out | varchar2(20) |  |  | '~' |
| 41 | pk_raorg_out_v | pk_raorg_out_v | pk_raorg_out_v | varchar2(20) |  |  | '~' |
| 42 | pk_recorder | pk_recorder | pk_recorder | varchar2(20) |  |  | '~' |
| 43 | pk_record_dept | pk_record_dept | pk_record_dept | varchar2(20) |  |  | '~' |
| 44 | pk_record_dept_v | pk_record_dept_v | pk_record_dept_v | varchar2(20) |  |  | '~' |
| 45 | pk_supplier | pk_supplier | pk_supplier | varchar2(20) |  |  | '~' |
| 46 | pk_transitype | pk_transitype | pk_transitype | varchar2(20) |  |  | '~' |
...
| 51 | settle_date | settle_date | settle_date | char(19) |
| 52 | settltmoney_global | settltmoney_global | settltmoney_global | number(28, 8) |
| 53 | settltmoney_group | settltmoney_group | settltmoney_group | number(28, 8) |
| 54 | settltmoney_org | settltmoney_org | settltmoney_org | number(28, 8) |
| 55 | transi_type | transi_type | transi_type | varchar2(30) |
