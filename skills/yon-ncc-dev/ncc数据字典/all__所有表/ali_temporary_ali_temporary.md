...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6495.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_leasein | pk_leasein | pk_leasein | char(20) | √ |
...
| 18 | pk_proj_task | pk_proj_task | pk_proj_task | varchar2(20) |  |  | '~' |
| 19 | pk_recorder | pk_recorder | pk_recorder | varchar2(20) |  |  | '~' |
| 20 | pk_record_dept | pk_record_dept | pk_record_dept | varchar2(20) |  |  | '~' |
| 21 | pk_record_dept_v | pk_record_dept_v | pk_record_dept_v | varchar2(20) |  |  | '~' |
| 22 | pk_supplier | pk_supplier | pk_supplier | varchar2(20) |  |  | '~' |
| 23 | pk_transitype | pk_transitype | pk_transitype | varchar2(20) |  |  | '~' |
| 24 | sum_currency_origin | sum_currency_origin | sum_currency_origin | number(28, 8) |
| 25 | transi_type | transi_type | transi_type | varchar2(30) |
