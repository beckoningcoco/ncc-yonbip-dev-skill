...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6567.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_bdprovisionratio | pk_bdprovisionratio | pk_bdprovisionratio | char(20) | √ |
| 2 | pk_bdprovisionrule | pk_bdprovisionrule | pk_bdprovisionrule | varchar2(20) |  |  | '~' |
