...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6574.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_bdrecovery_ys | pk_bdrecovery_ys | pk_bdrecovery_ys | char(20) | √ |
...
| 9 | pk_recbill | pk_recbill | pk_recbill | varchar2(20) |  |  | '~' |
| 10 | pk_recitem | pk_recitem | pk_recitem | varchar2(20) |  |  | '~' |
