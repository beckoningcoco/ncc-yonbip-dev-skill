...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6955.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_industry | pk_industry | pk_industry | varchar2(20) | √ |
| 2 | code | code | code | varchar2(20) |
| 3 | innercode | innercode | innercode | varchar2(50) |
| 4 | isdefault | isdefault | isdefault | char(1) |
| 5 | issystem | issystem | issystem | varchar2(50) |
...
| 12 | parent_id | parent_id | parent_id | varchar2(20) |  |  | '~' |
