...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6997.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_materialsale | pk_materialsale | pk_materialsale | char(20) | √ |
| 2 | dataoriginflag | dataoriginflag | dataoriginflag | number(38, 0) |  |  | 0 |
| 3 | isappendant | isappendant | isappendant | char(1) |  |  | 'N' |
| 4 | minprice | minprice | minprice | number(20, 10) |  |  | 0.00000000 |
| 5 | pk_group | pk_group | pk_group | char(20) | √ |
| 6 | pk_marsaleclass | pk_marsaleclass | pk_marsaleclass | varchar2(20) |  |  | '~' |
| 7 | pk_material | pk_material | pk_material | char(20) | √ |
| 8 | pk_org | pk_org | pk_org | char(20) | √ |
| 9 | resaleprice | resaleprice | resaleprice | number(20, 8) |
