...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7028.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_priceaccuracy | pk_priceaccuracy | pk_priceaccuracy | char(20) | √ |
| 2 | dataoriginflag | dataoriginflag | dataoriginflag | number(38, 0) |
| 3 | grpunitcurrdigit | grpunitcurrdigit | grpunitcurrdigit | number(38, 0) |
| 4 | grpunitroundtype | grpunitroundtype | grpunitroundtype | number(38, 0) |
