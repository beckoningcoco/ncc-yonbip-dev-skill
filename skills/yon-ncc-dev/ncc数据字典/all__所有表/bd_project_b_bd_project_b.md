...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7034.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_project_b | pk_project_b | pk_project_b | char(20) | √ |
...
| 6 | pk_parti_org | pk_parti_org | pk_parti_org | varchar2(20) |  |  | '~' |
| 7 | pk_parti_org_v | pk_parti_org_v | pk_parti_org_v | varchar2(20) |  |  | '~' |
| 8 | pk_project | pk_project | pk_project | char(20) | √ |
