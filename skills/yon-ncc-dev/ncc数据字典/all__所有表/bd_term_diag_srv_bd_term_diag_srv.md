...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7115.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_diagsrv | pk_diagsrv | pk_diagsrv | char(20) | √ |
| 2 | flag_active | flag_active | flag_active | char(1) |
| 3 | pk_diag | pk_diag | pk_diag | varchar2(50) |
...
| 9 | tblname | tblname | tblname | varchar2(50) |
