...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7124.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_timezone | pk_timezone | pk_timezone | char(20) | √ |
| 2 | code | code | code | varchar2(50) |
| 3 | dataoriginflag | dataoriginflag | dataoriginflag | number(38, 0) |  |  | 0 |
| 4 | description | description | description | varchar2(225) |
...
| 11 | offsetvar | offsetvar | offsetvar | varchar2(50) |
