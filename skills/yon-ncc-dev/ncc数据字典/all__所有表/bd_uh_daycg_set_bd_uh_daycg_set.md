...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7135.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_daycgset | pk_daycgset | pk_daycgset | char(20) | √ |
| 2 | code | code | code | varchar2(30) |
| 3 | eu_daycgsettype | eu_daycgsettype | eu_daycgsettype | varchar2(50) |
| 4 | name | name | name | varchar2(50) |
| 5 | note | note | note | varchar2(256) |
| 6 | pk_dept | pk_dept | pk_dept | varchar2(20) |  |  | '~' |
