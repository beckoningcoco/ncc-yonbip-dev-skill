...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7147.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_hpdise | pk_hpdise | pk_hpdise | char(20) | √ |
| 2 | amt_price | amt_price | amt_price | number(28, 8) |
| 3 | pk_diag | pk_diag | pk_diag | varchar2(20) |  |  | '~' |
| 4 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 5 | pk_hp | pk_hp | pk_hp | varchar2(20) |  |  | '~' |
| 6 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 7 | pk_pvtype | pk_pvtype | pk_pvtype | varchar2(20) |  |  | '~' |
