...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7207.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_pricehp | pk_pricehp | pk_pricehp | char(20) | √ |
| 2 | eu_pricetype | eu_pricetype | eu_pricetype | number(38, 0) |
| 3 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 4 | pk_hp | pk_hp | pk_hp | char(20) |
