...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7355.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_loctrule | pk_loctrule | pk_loctrule | char(20) | √ |
...
| 9 | note | note | note | varchar2(1024) |
| 10 | pk_group | pk_group | pk_group | varchar2(20) | √ |
| 11 | pk_org | pk_org | pk_org | varchar2(20) | √ |
| 12 | postalcode | postalcode | postalcode | varchar2(40) |
| 13 | postalname | postalname | postalname | varchar2(200) |
| 14 | usestate | usestate | usestate | varchar2(20) |
