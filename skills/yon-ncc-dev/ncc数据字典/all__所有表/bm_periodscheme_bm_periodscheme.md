...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7358.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_periodscheme | pk_periodscheme | pk_periodscheme | char(20) | √ |
| 2 | code | code | code | varchar2(50) |
| 3 | name | name | name | varchar2(128) |
| 4 | name2 | name2 | name2 | varchar2(128) |
| 5 | name3 | name3 | name3 | varchar2(128) |
| 6 | name4 | name4 | name4 | varchar2(128) |
| 7 | name5 | name5 | name5 | varchar2(128) |
| 8 | name6 | name6 | name6 | varchar2(128) |
