...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7372.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_bond_exec | pk_bond_exec | pk_bond_exec | char(20) | √ |
...
| 37 | pk_repayplans | pk_repayplans | pk_repayplans | blob |
| 38 | pk_srcbill | pk_srcbill | pk_srcbill | varchar2(50) |
| 39 | pk_srcbilltypeid | pk_srcbilltypeid | pk_srcbilltypeid | varchar2(50) |
| 40 | repayamount | repayamount | repayamount | number(28, 8) |
| 41 | serialno | serialno | serialno | number(38, 0) |
| 42 | summary | summary | summary | varchar2(50) |
| 43 | vbillno | vbillno | vbillno | varchar2(50) |
| 44 | vdef1 | vdef1 | vdef1 | varchar2(101) |
| 45 | vdef2 | vdef2 | vdef2 | varchar2(101) |
| 46 | vdef3 | vdef3 | vdef3 | varchar2(101) |
| 47 | vdef4 | vdef4 | vdef4 | varchar2(101) |
| 48 | vdef5 | vdef5 | vdef5 | varchar2(101) |
| 49 | vdef6 | vdef6 | vdef6 | varchar2(101) |
| 50 | vdef7 | vdef7 | vdef7 | varchar2(101) |
| 51 | vdef8 | vdef8 | vdef8 | varchar2(101) |
| 52 | vdef9 | vdef9 | vdef9 | varchar2(101) |
| 53 | vdef10 | vdef10 | vdef10 | varchar2(101) |
