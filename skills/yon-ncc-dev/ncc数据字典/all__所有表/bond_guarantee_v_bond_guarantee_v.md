...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7375.html
...
| 4 | glcoccupymny | glcoccupymny | glcoccupymny | number(28, 8) |
| 5 | glcrate | glcrate | glcrate | number(28, 8) |
| 6 | gllcoccupymny | gllcoccupymny | gllcoccupymny | number(28, 8) |
| 7 | gllcrate | gllcrate | gllcrate | number(28, 8) |
| 8 | guaranteeid | guaranteeid | guaranteeid | varchar2(20) |  |  | '~' |
| 9 | guaranteeproportion | guaranteeproportion | guaranteeproportion | number(28, 8) |
| 10 | guaranteetype | guaranteetype | guaranteetype | varchar2(50) |
| 11 | localoccupymny | localoccupymny | localoccupymny | number(28, 8) |
| 12 | occupymny | occupymny | occupymny | number(28, 8) |
| 13 | olcrate | olcrate | olcrate | number(28, 8) |
| 14 | originalid | originalid | originalid | varchar2(200) |
| 15 | pk_bondcontract | pk_bondcontract | pk_bondcontract | char(20) | √ |
| 16 | pk_bondguarantee_b | pk_bondguarantee_b | pk_bondguarantee_b | varchar2(50) | √ |
...
| 21 | version | version | version | number(38, 0) |
| 22 | versiondate | versiondate | versiondate | char(19) |
