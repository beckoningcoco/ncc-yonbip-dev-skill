...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7401.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_dimension | pk_dimension | pk_dimension | char(20) | √ |
| 2 | budgettype | budgettype | budgettype | number(38, 0) |
| 3 | code | code | code | varchar2(50) |
| 4 | exeflag | exeflag | exeflag | char(1) |
...
| 11 | pk_accountyear | pk_accountyear | pk_accountyear | varchar2(20) |  |  | '~' |
| 12 | pk_accperiodscheme | pk_accperiodscheme | pk_accperiodscheme | varchar2(20) |  |  | '~' |
| 13 | pk_appmodel | pk_appmodel | pk_appmodel | varchar2(20) |  |  | '~' |
| 14 | pk_cycletables | pk_cycletables | pk_cycletables | varchar2(20) |  |  | '~' |
| 15 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 16 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 17 | pk_tbversion | pk_tbversion | pk_tbversion | varchar2(20) |  |  | '~' |
| 18 | pk_worksheet | pk_worksheet | pk_worksheet | varchar2(20) |  |  | '~' |
| 19 | product | product | product | varchar2(50) |
| 20 | pullflag | pullflag | pullflag | char(1) |
| 21 | reporttype | reporttype | reporttype | number(38, 0) |
| 22 | sourcesys | sourcesys | sourcesys | number(38, 0) |
