...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7672.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | ctranlevelid | ctranlevelid | ctranlevelid | char(20) | √ |
...
| 5 | ilevelstatus | ilevelstatus | ilevelstatus | number(38, 0) |
| 6 | itranstatus | itranstatus | itranstatus | number(38, 0) |
| 7 | nlevel | nlevel | nlevel | number(38, 0) |
