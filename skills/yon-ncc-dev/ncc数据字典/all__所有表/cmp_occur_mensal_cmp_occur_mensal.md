...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7558.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_occur_mensal | pk_occur_mensal | pk_occur_mensal | char(20) | √ |
...
| 19 | pk_global_currtype | pk_global_currtype | pk_global_currtype | varchar2(20) |  |  | '~' |
| 20 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 21 | pk_group_currtype | pk_group_currtype | pk_group_currtype | varchar2(20) |  |  | '~' |
