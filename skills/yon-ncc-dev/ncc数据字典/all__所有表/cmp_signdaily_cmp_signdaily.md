...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7573.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_signdaily | pk_signdaily | pk_signdaily | char(20) | √ |
...
| 26 | unique_code | unique_code | unique_code | varchar2(50) |
| 27 | unique_value | unique_value | unique_value | varchar2(150) |
