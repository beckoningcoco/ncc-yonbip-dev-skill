...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7704.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_sppara | pk_sppara | pk_sppara | char(20) | √ |
...
| 10 | pk_templet | pk_templet | pk_templet | number(38, 0) | √ |
| 11 | pk_unit | pk_unit | pk_unit | varchar2(20) |  |  | '~' |
| 12 | vformula | vformula | vformula | varchar2(200) |
| 13 | vformulacode | vformulacode | vformulacode | varchar2(200) |
| 14 | vformulavalue | vformulavalue | vformulavalue | varchar2(200) |
