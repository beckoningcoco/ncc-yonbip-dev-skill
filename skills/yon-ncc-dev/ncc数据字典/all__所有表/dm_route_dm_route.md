...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7806.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | crouteid | crouteid | crouteid | char(20) | √ |
| 2 | bsealflag | bsealflag | bsealflag | char(1) |
| 3 | ccarrierid | ccarrierid | ccarrierid | varchar2(20) |  |  | '~' |
| 4 | ctrantypeid | ctrantypeid | ctrantypeid | varchar2(20) |  |  | '~' |
| 5 | cvehicleid | cvehicleid | cvehicleid | varchar2(20) |  |  | '~' |
| 6 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 7 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 8 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 9 | vroutecode | vroutecode | vroutecode | varchar2(40) |
| 10 | vroutename | vroutename | vroutename | varchar2(114) |
| 11 | vroutename2 | vroutename2 | vroutename2 | varchar2(114) |
| 12 | vroutename3 | vroutename3 | vroutename3 | varchar2(114) |
| 13 | vroutename4 | vroutename4 | vroutename4 | varchar2(114) |
| 14 | vroutename5 | vroutename5 | vroutename5 | varchar2(114) |
| 15 | vroutename6 | vroutename6 | vroutename6 | varchar2(114) |
