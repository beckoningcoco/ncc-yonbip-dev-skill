...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7864.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_inspection | pk_inspection | pk_inspection | char(20) | √ |
...
| 10 | check_opinion | check_opinion | check_opinion | varchar2(100) |
| 11 | disbug_situation | disbug_situation | disbug_situation | varchar2(200) |
| 12 | inspect_situation | inspect_situation | inspect_situation | varchar2(200) |
...
| 17 | pk_plan_inspector | pk_plan_inspector | pk_plan_inspector | varchar2(20) |  |  | '~' |
| 18 | pk_plan_team | pk_plan_team | pk_plan_team | varchar2(20) |  |  | '~' |
| 19 | pk_prin | pk_prin | pk_prin | varchar2(20) |  |  | '~' |
| 20 | pk_prin_dept | pk_prin_dept | pk_prin_dept | varchar2(20) |  |  | '~' |
| 21 | pk_prin_dept_v | pk_prin_dept_v | pk_prin_dept_v | varchar2(20) |  |  | '~' |
| 22 | pk_route | pk_route | pk_route | varchar2(20) |  |  | '~' |
| 23 | pk_transitype | pk_transitype | pk_transitype | varchar2(20) |  |  | '~' |
| 24 | plan_inspect_date | plan_inspect_date | plan_inspect_date | char(19) |
| 25 | plan_inspect_time | plan_inspect_time | plan_inspect_time | char(8) |
| 26 | src_bill_type | src_bill_type | src_bill_type | varchar2(4) |
| 27 | src_pk_bill | src_pk_bill | src_pk_bill | varchar2(20) |
| 28 | src_pk_transitype | src_pk_transitype | src_pk_transitype | varchar2(20) |  |  | '~' |
| 29 | src_transitype | src_transitype | src_transitype | varchar2(30) |
