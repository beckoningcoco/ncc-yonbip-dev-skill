...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7876.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_pm_stdjob | pk_pm_stdjob | pk_pm_stdjob | char(20) | √ |
| 2 | frequence_num | frequence_num | frequence_num | number(38, 0) |
| 3 | pk_group | pk_group | pk_group | varchar2(20) |
| 4 | pk_org | pk_org | pk_org | varchar2(20) |
| 5 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |
| 6 | pk_pm | pk_pm | pk_pm | char(20) | √ |
| 7 | pk_std_job | pk_std_job | pk_std_job | varchar2(20) |  |  | '~' |
| 8 | rowno | rowno | rowno | varchar2(30) |
