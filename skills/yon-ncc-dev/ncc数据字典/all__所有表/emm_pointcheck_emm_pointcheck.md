...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7878.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_pointcheck | pk_pointcheck | pk_pointcheck | char(20) | √ |
...
| 11 | disbug_status | disbug_status | disbug_status | varchar2(200) |
| 12 | memo | memo | memo | varchar2(200) |
| 13 | pc_circs | pc_circs | pc_circs | varchar2(200) |
| 14 | pc_opinion | pc_opinion | pc_opinion | varchar2(200) |
| 15 | pk_duty | pk_duty | pk_duty | varchar2(20) |  |  | '~' |
...
| 20 | src_type | src_type | src_type | number(38, 0) |
