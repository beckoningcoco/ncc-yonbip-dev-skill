...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7901.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_measure_doc | pk_measure_doc | pk_measure_doc | char(20) | √ |
...
| 16 | src_bill_type | src_bill_type | src_bill_type | varchar2(30) |
| 17 | src_pk_bill | src_pk_bill | src_pk_bill | varchar2(20) |
| 18 | src_pk_transitype | src_pk_transitype | src_pk_transitype | varchar2(20) |  |  | '~' |
| 19 | src_transitype | src_transitype | src_transitype | varchar2(30) |
| 20 | src_type | src_type | src_type | number(38, 0) |  |  | 1 |
