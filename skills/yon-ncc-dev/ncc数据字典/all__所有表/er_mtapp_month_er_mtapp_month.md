...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7983.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_mtapp_month | pk_mtapp_month | pk_mtapp_month | char(20) | √ |
...
| 9 | pk_mtapp_bill | pk_mtapp_bill | pk_mtapp_bill | varchar2(20) | √ |  | '~' |
| 10 | pk_mtapp_detail | pk_mtapp_detail | pk_mtapp_detail | char(20) | √ |
