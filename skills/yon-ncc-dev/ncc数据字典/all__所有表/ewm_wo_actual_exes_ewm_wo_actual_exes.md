...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8038.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_wo_actual_exes | pk_wo_actual_exes | pk_wo_actual_exes | char(20) | √ |
| 2 | exesmoney | exesmoney | exesmoney | number(28, 8) |  |  | 0 |
| 3 | exestype | exestype | exestype | varchar2(200) |
| 4 | memo | memo | memo | varchar2(200) |
| 5 | pk_inoutbusiclass | pk_inoutbusiclass | pk_inoutbusiclass | varchar2(20) |  |  | '~' |
| 6 | pk_wo | pk_wo | pk_wo | char(20) | √ |
| 7 | rowno | rowno | rowno | varchar2(30) |
| 8 | sequence_num | sequence_num | sequence_num | number(38, 0) |
