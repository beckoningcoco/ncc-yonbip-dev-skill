...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8048.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_wo_plan_psn | pk_wo_plan_psn | pk_wo_plan_psn | char(20) | √ |
| 2 | man_hours | man_hours | man_hours | number(28, 8) |  |  | 0 |
| 3 | memo | memo | memo | varchar2(200) |
| 4 | money | money | money | number(28, 8) |  |  | 0 |
| 5 | person_num | person_num | person_num | number(38, 0) |  |  | 1 |
...
| 11 | pk_wo | pk_wo | pk_wo | char(20) | √ |
| 12 | rate | rate | rate | number(28, 8) |  |  | 0 |
