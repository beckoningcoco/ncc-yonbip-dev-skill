...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8170.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_transasset | pk_transasset | pk_transasset | char(20) | √ |
...
| 12 | create_card_style | create_card_style | create_card_style | number(38, 0) |
| 13 | memo | memo | memo | varchar2(200) |
| 14 | pk_construct_unit | pk_construct_unit | pk_construct_unit | varchar2(20) |  |  | '~' |
...
| 21 | pk_recorder | pk_recorder | pk_recorder | varchar2(20) |  |  | '~' |
