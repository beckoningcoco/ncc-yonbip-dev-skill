...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8199.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_expenselistunit_b | pk_expenselistunit_b | pk_expenselistunit_b | char(20) | √ |
...
| 22 | pk_expenselistunit | pk_expenselistunit | pk_expenselistunit | varchar2(20) |
