...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8233.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_fct_ar_change | pk_fct_ar_change | pk_fct_ar_change | char(20) | √ |
...
| 7 | vchgcontent | vchgcontent | vchgcontent | varchar2(260) |
