...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8367.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | id | id | id | char(20) | √ |
| 2 | anatype | anatype | anatype | varchar2(50) |
| 3 | datasource | datasource | datasource | varchar2(50) |
| 4 | modelcode | modelcode | modelcode | varchar2(50) |
...
| 12 | pk_dir | pk_dir | pk_dir | varchar2(20) |  |  | '~' |
| 13 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 14 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 15 | reportcode | reportcode | reportcode | varchar2(50) |
| 16 | reportinfo | reportinfo | reportinfo | blob |
