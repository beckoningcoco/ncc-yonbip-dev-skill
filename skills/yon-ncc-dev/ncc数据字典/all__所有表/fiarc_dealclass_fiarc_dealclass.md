...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8258.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_dealclass | pk_dealclass | pk_dealclass | char(20) | √ |
| 2 | classname | classname | classname | varchar2(60) |
...
| 7 | modulgroup | modulgroup | modulgroup | varchar2(15) |
