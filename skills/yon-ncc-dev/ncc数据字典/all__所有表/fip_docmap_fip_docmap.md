...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8311.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_docmap | pk_docmap | pk_docmap | char(20) | √ |
| 2 | docmapcode | docmapcode | docmapcode | varchar2(50) |
...
| 9 | explanation | explanation | explanation | varchar2(500) |
