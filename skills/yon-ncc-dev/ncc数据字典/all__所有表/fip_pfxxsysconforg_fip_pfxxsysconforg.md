...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8325.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_pfxxsysconfsub | pk_pfxxsysconfsub | pk_pfxxsysconfsub | char(20) | √ |
| 2 | pfxxsysconforg | pfxxsysconforg | pfxxsysconforg | char(20) | √ |
| 3 | pk_financeorg | pk_financeorg | pk_financeorg | varchar2(20) |  |  | '~' |
