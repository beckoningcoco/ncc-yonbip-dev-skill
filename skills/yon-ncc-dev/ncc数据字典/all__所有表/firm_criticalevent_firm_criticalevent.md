...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8357.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_event | pk_event | pk_event | char(20) | √ |
| 2 | content | content | content | varchar2(50) |
| 3 | eventcode | eventcode | eventcode | varchar2(50) |
| 4 | memo | memo | memo | varchar2(200) |
| 5 | pk_firm_sale | pk_firm_sale | pk_firm_sale | char(20) | √ |
