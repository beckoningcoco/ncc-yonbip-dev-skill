...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8392.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_cashpay_receipt_h | pk_cashpay_receipt_h | pk_cashpay_receipt_h | char(20) | √ |
...
| 24 | pk_getfinanceorg | pk_getfinanceorg | pk_getfinanceorg | varchar2(20) |  |  | '~' |
| 25 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 26 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 27 | pk_org_p | pk_org_p | pk_org_p | varchar2(20) |  |  | '~' |
| 28 | pk_org_p_v | pk_org_p_v | pk_org_p_v | varchar2(20) |  |  | '~' |
