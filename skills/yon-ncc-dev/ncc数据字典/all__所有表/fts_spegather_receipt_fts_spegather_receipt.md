...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8409.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_spegather_receipt_h | pk_spegather_receipt_h | pk_spegather_receipt_h | char(20) | √ |
...
| 23 | pk_org_r | pk_org_r | pk_org_r | varchar2(20) |  |  | '~' |
| 24 | pk_org_r_v | pk_org_r_v | pk_org_r_v | varchar2(20) |  |  | '~' |
...
| 30 | pk_srccmpbill | pk_srccmpbill | pk_srccmpbill | char(20) |
