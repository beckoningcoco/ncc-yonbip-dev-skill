...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8416.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_permission_role | pk_permission_role | pk_permission_role | char(20) | √ |
| 2 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 3 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 4 | pk_role | pk_role | pk_role | varchar2(20) |  |  | '~' |
| 5 | role_type | role_type | role_type | number(38, 0) |
