...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8599.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_actrealation | pk_actrealation | pk_actrealation | char(20) | √ |
...
| 14 | gloccuseamt | gloccuseamt | gloccuseamt | number(28, 8) |
| 15 | glreleaseamt | glreleaseamt | glreleaseamt | number(28, 8) |
| 16 | groccuseamt | groccuseamt | groccuseamt | number(28, 8) |
| 17 | grreleaseamt | grreleaseamt | grreleaseamt | number(28, 8) |
| 18 | occuseamt | occuseamt | occuseamt | number(28, 8) |
| 19 | olcbusiamt | olcbusiamt | olcbusiamt | number(28, 8) |
| 20 | olcrate | olcrate | olcrate | number(15, 8) |
| 21 | oloccuseamt | oloccuseamt | oloccuseamt | number(28, 8) |
| 22 | olreleaseamt | olreleaseamt | olreleaseamt | number(28, 8) |
| 23 | onlyclueno | onlyclueno | onlyclueno | varchar2(50) |
| 24 | operation | operation | operation | varchar2(50) |
| 25 | pk_billtypecode | pk_billtypecode | pk_billtypecode | varchar2(50) |
| 26 | pk_billtypeid | pk_billtypeid | pk_billtypeid | varchar2(20) |  |  | '~' |
| 27 | pk_billtypename | pk_billtypename | pk_billtypename | varchar2(50) |
| 28 | pk_busitype | pk_busitype | pk_busitype | varchar2(20) |  |  | '~' |
| 29 | pk_currtype | pk_currtype | pk_currtype | varchar2(20) |  |  | '~' |
| 30 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 31 | pk_guacontract | pk_guacontract | pk_guacontract | varchar2(50) |
| 32 | pk_guacurrtype | pk_guacurrtype | pk_guacurrtype | varchar2(20) |  |  | '~' |
| 33 | pk_olccurr | pk_olccurr | pk_olccurr | varchar2(20) |  |  | '~' |
| 34 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 35 | pk_org_v | pk_org_v | pk_org_v | char(20) |
| 36 | pk_quotaorg | pk_quotaorg | pk_quotaorg | varchar2(20) |  |  | '~' |
| 37 | pk_quotaorg_v | pk_quotaorg_v | pk_quotaorg_v | char(20) |
| 38 | pk_srcbill | pk_srcbill | pk_srcbill | varchar2(20) |
| 39 | pk_srcbill_b | pk_srcbill_b | pk_srcbill_b | varchar2(20) |
| 40 | releaseamt | releaseamt | releaseamt | number(28, 8) |
...
| 46 | sourcesystem | sourcesystem | sourcesystem | varchar2(20) |  |  | '~' |
| 47 | srcmodule | srcmodule | srcmodule | varchar2(50) |
| 48 | updatedir | updatedir | updatedir | varchar2(50) |
