...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8647.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | begindate | begindate | begindate | varchar2(10) |
| 2 | enddate | enddate | enddate | varchar2(10) |
| 3 | engageorg | engageorg | engageorg | varchar2(128) |
| 4 | enspecialty | enspecialty | enspecialty | varchar2(128) |
...
| 9 | remark | remark | remark | varchar2(128) |
