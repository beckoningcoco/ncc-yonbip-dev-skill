...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8707.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_entryconfig | pk_entryconfig | pk_entryconfig | char(20) | √ |
| 2 | bsealflag | bsealflag | bsealflag | char(1) |
| 3 | bsysflag | bsysflag | bsysflag | char(1) |
| 4 | code | code | code | varchar2(50) |
| 5 | datasource | datasource | datasource | varchar2(50) |
| 6 | itype | itype | itype | number(38, 0) |
| 7 | name | name | name | varchar2(50) |
| 8 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 9 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 10 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 11 | vnote | vnote | vnote | varchar2(50) |
...
| 22 | def11 | def11 | def11 | varchar2(100) |
| 23 | def12 | def12 | def12 | varchar2(100) |
| 24 | def13 | def13 | def13 | varchar2(100) |
| 25 | def14 | def14 | def14 | varchar2(100) |
| 26 | def15 | def15 | def15 | varchar2(100) |
| 27 | def16 | def16 | def16 | varchar2(100) |
| 28 | def17 | def17 | def17 | varchar2(100) |
| 29 | def18 | def18 | def18 | varchar2(100) |
| 30 | def19 | def19 | def19 | varchar2(100) |
| 31 | def20 | def20 | def20 | varchar2(100) |
