...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8794.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_cindex_grade | pk_cindex_grade | pk_cindex_grade | char(20) | √ |
| 2 | code | code | code | number(38, 0) | √ |
| 3 | memo | memo | memo | varchar2(1000) |
...
| 10 | pk_cindex | pk_cindex | pk_cindex | varchar2(20) |  |  | '~' |
