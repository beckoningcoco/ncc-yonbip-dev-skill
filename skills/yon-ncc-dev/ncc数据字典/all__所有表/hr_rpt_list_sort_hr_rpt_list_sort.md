...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8837.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_rpt_sort | pk_rpt_sort | pk_rpt_sort | char(20) | √ |
| 2 | fieldcode | fieldcode | fieldcode | varchar2(128) |
| 3 | fieldname | fieldname | fieldname | varchar2(384) |
| 4 | is_asc | is_asc | is_asc | char(1) |
...
| 9 | sortorder | sortorder | sortorder | number(38, 0) |
