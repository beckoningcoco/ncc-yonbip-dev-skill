...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/9167.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_transtypematch | pk_transtypematch | pk_transtypematch | char(20) | √ |
| 2 | billmaker | billmaker | billmaker | varchar2(20) |  |  | '~' |
| 3 | cinventoryclassid | cinventoryclassid | cinventoryclassid | varchar2(20) |  |  | '~' |
| 4 | cinventoryid | cinventoryid | cinventoryid | varchar2(20) |  |  | '~' |
| 5 | cinventoryvid | cinventoryvid | cinventoryvid | varchar2(20) |  |  | '~' |
