...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8993.html
...
| 34 | isversioneffect | isversioneffect | isversioneffect | char(1) |
| 35 | olcappusdcdtlnamt | olcappusdcdtlnamt | olcappusdcdtlnamt | number(28, 8) |
| 36 | olcavailcdtlnamt | olcavailcdtlnamt | olcavailcdtlnamt | number(28, 8) |
| 37 | olccdtlnamt | olccdtlnamt | olccdtlnamt | number(28, 8) |
| 38 | olccurusdcdtlnamt | olccurusdcdtlnamt | olccurusdcdtlnamt | number(28, 8) |
| 39 | olcopnusdcdtlnamt | olcopnusdcdtlnamt | olcopnusdcdtlnamt | number(28, 8) |
| 40 | olcrate | olcrate | olcrate | number(15, 8) |
| 41 | opnusdcdtlnamt | opnusdcdtlnamt | opnusdcdtlnamt | number(28, 8) |
| 42 | periodcount | periodcount | periodcount | number(38, 0) |
| 43 | periodunit | periodunit | periodunit | varchar2(10) |
| 44 | pk_billtypecode | pk_billtypecode | pk_billtypecode | varchar2(20) |
| 45 | pk_billtypeid | pk_billtypeid | pk_billtypeid | varchar2(20) |  |  | '~' |
| 46 | pk_creditorg | pk_creditorg | pk_creditorg | varchar2(20) |  |  | '~' |
| 47 | pk_currtype | pk_currtype | pk_currtype | varchar2(20) |  |  | '~' |
| 48 | pk_debitorg | pk_debitorg | pk_debitorg | varchar2(20) |  |  | '~' |
| 49 | pk_debitorg_v | pk_debitorg_v | pk_debitorg_v | varchar2(20) |  |  | '~' |
| 50 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 51 | pk_incprotocol_i | pk_incprotocol_i | pk_incprotocol_i | varchar2(50) |
| 52 | pk_inheritprotocol | pk_inheritprotocol | pk_inheritprotocol | varchar2(20) |  |  | '~' |
| 53 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 54 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 55 | protocolcode | protocolcode | protocolcode | varchar2(40) |
| 56 | protocolstatus | protocolstatus | protocolstatus | varchar2(15) |
| 57 | remark | remark | remark | varchar2(181) |
| 58 | terminatedate | terminatedate | terminatedate | char(19) |
| 59 | terminatetime | terminatetime | terminatetime | char(19) |
| 60 | terminator | terminator | terminator | varchar2(20) |  |  | '~' |
| 61 | vbillno | vbillno | vbillno | varchar2(40) |
| 62 | vbillstatus | vbillstatus | vbillstatus | number(38, 0) |
| 63 | versionmark | versionmark | versionmark | varchar2(50) |
| 64 | versionno | versionno | versionno | number(38, 0) | √ |
| 65 | versionorigin | versionorigin | versionorigin | varchar2(50) |
| 66 | versiontime | versiontime | versiontime | char(19) |
| 67 | vdef1 | vdef1 | vdef1 | varchar2(101) |
| 68 | vdef2 | vdef2 | vdef2 | varchar2(101) |
| 69 | vdef3 | vdef3 | vdef3 | varchar2(101) |
| 70 | vdef4 | vdef4 | vdef4 | varchar2(101) |
| 71 | vdef5 | vdef5 | vdef5 | varchar2(101) |
| 72 | vdef6 | vdef6 | vdef6 | varchar2(101) |
| 73 | vdef7 | vdef7 | vdef7 | varchar2(101) |
| 74 | vdef8 | vdef8 | vdef8 | varchar2(101) |
| 75 | vdef9 | vdef9 | vdef9 | varchar2(101) |
| 76 | vdef10 | vdef10 | vdef10 | varchar2(101) |
| 77 | vdef11 | vdef11 | vdef11 | varchar2(101) |
| 78 | vdef12 | vdef12 | vdef12 | varchar2(101) |
| 79 | vdef13 | vdef13 | vdef13 | varchar2(101) |
| 80 | vdef14 | vdef14 | vdef14 | varchar2(101) |
| 81 | vdef15 | vdef15 | vdef15 | varchar2(101) |
| 82 | vdef16 | vdef16 | vdef16 | varchar2(101) |
| 83 | vdef17 | vdef17 | vdef17 | varchar2(101) |
| 84 | vdef18 | vdef18 | vdef18 | varchar2(101) |
| 85 | vdef19 | vdef19 | vdef19 | varchar2(101) |
| 86 | vdef20 | vdef20 | vdef20 | varchar2(101) |
