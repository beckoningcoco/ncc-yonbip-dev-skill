...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/9011.html
...
| 106 | pk_innerloanpay | pk_innerloanpay | pk_innerloanpay | varchar2(50) |
| 107 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 108 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 109 | pk_planitem | pk_planitem | pk_planitem | varchar2(20) |  |  | '~' |
| 110 | pk_project | pk_project | pk_project | varchar2(20) |  |  | '~' |
| 111 | pk_rate | pk_rate | pk_rate | varchar2(20) |  |  | '~' |
| 112 | pk_returnmethod | pk_returnmethod | pk_returnmethod | varchar2(20) |  |  | '~' |
| 113 | pk_settledate | pk_settledate | pk_settledate | varchar2(20) |  |  | '~' |
| 114 | pk_srcbill | pk_srcbill | pk_srcbill | varchar2(50) |
| 115 | pk_srcbilltypeid | pk_srcbilltypeid | pk_srcbilltypeid | varchar2(50) |
...
| 126 | settlefailreason | settlefailreason | settlefailreason | varchar2(200) |
| 127 | settleflag | settleflag | settleflag | number(38, 0) |
| 128 | signdata | signdata | signdata | varchar2(200) |
| 129 | signuserid | signuserid | signuserid | varchar2(200) |
| 130 | sourcesystypecode | sourcesystypecode | sourcesystypecode | varchar2(50) |
| 131 | srcbillno | srcbillno | srcbillno | varchar2(20) |  |  | '~' |
| 132 | summary | summary | summary | varchar2(200) |
| 133 | terminatedate | terminatedate | terminatedate | char(19) |
| 134 | terminater | terminater | terminater | varchar2(20) |  |  | '~' |
| 135 | totalintstmny | totalintstmny | totalintstmny | number(28, 8) |
| 136 | tranevent | tranevent | tranevent | varchar2(200) |
| 137 | trantypeid | trantypeid | trantypeid | varchar2(50) |
| 138 | unpaymny | unpaymny | unpaymny | number(28, 8) |
| 139 | unrepayintstmny | unrepayintstmny | unrepayintstmny | number(28, 8) |
| 140 | usecontractrate | usecontractrate | usecontractrate | char(1) |
| 141 | vbillno | vbillno | vbillno | varchar2(50) |
| 142 | vbillstatus | vbillstatus | vbillstatus | number(38, 0) |
| 143 | versioner | versioner | versioner | varchar2(20) |  |  | '~' |
| 144 | versionmark | versionmark | versionmark | varchar2(100) |
| 145 | versionno | versionno | versionno | number(38, 0) |
| 146 | versionorigin | versionorigin | versionorigin | varchar2(50) |
| 147 | versiontime | versiontime | versiontime | char(19) |
| 148 | voucherflag | voucherflag | voucherflag | char(1) |
| 149 | vdef1 | vdef1 | vdef1 | varchar2(101) |
| 150 | vdef2 | vdef2 | vdef2 | varchar2(101) |
| 151 | vdef3 | vdef3 | vdef3 | varchar2(101) |
| 152 | vdef4 | vdef4 | vdef4 | varchar2(101) |
| 153 | vdef5 | vdef5 | vdef5 | varchar2(101) |
| 154 | vdef6 | vdef6 | vdef6 | varchar2(101) |
| 155 | vdef7 | vdef7 | vdef7 | varchar2(101) |
| 156 | vdef8 | vdef8 | vdef8 | varchar2(101) |
| 157 | vdef9 | vdef9 | vdef9 | varchar2(101) |
| 158 | vdef10 | vdef10 | vdef10 | varchar2(101) |
| 159 | vdef11 | vdef11 | vdef11 | varchar2(101) |
| 160 | vdef12 | vdef12 | vdef12 | varchar2(101) |
| 161 | vdef13 | vdef13 | vdef13 | varchar2(101) |
| 162 | vdef14 | vdef14 | vdef14 | varchar2(101) |
| 163 | vdef15 | vdef15 | vdef15 | varchar2(101) |
| 164 | vdef16 | vdef16 | vdef16 | varchar2(101) |
| 165 | vdef17 | vdef17 | vdef17 | varchar2(101) |
| 166 | vdef18 | vdef18 | vdef18 | varchar2(101) |
| 167 | vdef19 | vdef19 | vdef19 | varchar2(101) |
| 168 | vdef20 | vdef20 | vdef20 | varchar2(101) |
| 169 | creationtime | creationtime | creationtime | char(19) |
| 170 | creator | creator | creator | varchar2(20) |  |  | '~' |
| 171 | dr | dr | dr | number(10, 0) |  |  | 0 |
| 172 | modifiedtime | modifiedtime | modifiedtime | char(19) |
| 173 | modifier | modifier | modifier | varchar2(20) |  |  | '~' |
| 174 | ts | ts | ts | char(19) |  |  | to_char(sysdate,'yyyy-mm-dd hh24:mi:ss') |