...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/9210.html
...
| 12 | deposittype | deposittype | deposittype | varchar2(50) |
| 13 | deposityrate | deposityrate | deposityrate | number(15, 8) |
| 14 | depostbalmnt | depostbalmnt | depostbalmnt | number(28, 8) |
| 15 | depostperiod | depostperiod | depostperiod | varchar2(50) |
| 16 | depostsummnt | depostsummnt | depostsummnt | number(28, 8) |
| 17 | enddate | enddate | enddate | char(19) |
| 18 | freezedate | freezedate | freezedate | char(19) |
| 19 | freezer | freezer | freezer | varchar2(20) |  |  | '~' |
| 20 | glcdepositamount | glcdepositamount | glcdepositamount | number(28, 8) |
| 21 | glcrate | glcrate | glcrate | number(15, 8) |
| 22 | gllcdepositamount | gllcdepositamount | gllcdepositamount | number(28, 8) |
| 23 | gllcrate | gllcrate | gllcrate | number(15, 8) |
| 24 | intervalunit | intervalunit | intervalunit | varchar2(50) |
| 25 | isinitial | isinitial | isinitial | char(1) |
| 26 | maxaccuredate | maxaccuredate | maxaccuredate | char(19) |
| 27 | noticeperiod | noticeperiod | noticeperiod | number(38, 0) |
| 28 | olcdepositamount | olcdepositamount | olcdepositamount | number(28, 8) |
| 29 | olcrate | olcrate | olcrate | number(15, 8) |
| 30 | operatedate | operatedate | operatedate | char(19) |
| 31 | oridepositdate | oridepositdate | oridepositdate | char(19) |
| 32 | pk_aiacrate | pk_aiacrate | pk_aiacrate | varchar2(20) |  |  | '~' |
| 33 | pk_billtype | pk_billtype | pk_billtype | varchar2(20) |  |  | '~' |
| 34 | pk_currtype | pk_currtype | pk_currtype | varchar2(20) |  |  | '~' |
| 35 | pk_depositacc | pk_depositacc | pk_depositacc | varchar2(20) |  |  | '~' |
| 36 | pk_depositorg | pk_depositorg | pk_depositorg | varchar2(20) |  |  | '~' |
| 37 | pk_depostrate | pk_depostrate | pk_depostrate | varchar2(20) |  |  | '~' |
...
| 42 | pk_srcbill | pk_srcbill | pk_srcbill | varchar2(20) |
