...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/9478.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_proposal | pk_proposal | pk_proposal | char(20) | √ |
...
| 14 | industrysector | industrysector | industrysector | varchar2(20) |  |  | '~' |
| 15 | investdir | investdir | investdir | number(38, 0) |
| 16 | nallestimatemny | nallestimatemny | nallestimatemny | number(28, 8) |
| 17 | nbaseestimatemny | nbaseestimatemny | nbaseestimatemny | number(28, 8) |
...
| 20 | ngpestimatemny | ngpestimatemny | ngpestimatemny | number(28, 8) |
| 21 | ngroupexchgrate | ngroupexchgrate | ngroupexchgrate | number(28, 8) |
| 22 | norigestimatemny | norigestimatemny | norigestimatemny | number(28, 8) |
| 23 | pk_afterinveststage | pk_afterinveststage | pk_afterinveststage | varchar2(20) |  |  | '~' |
| 24 | pk_apporg | pk_apporg | pk_apporg | varchar2(20) |  |  | '~' |
| 25 | pk_apporg_v | pk_apporg_v | pk_apporg_v | varchar2(20) |  |  | '~' |
...
| 30 | pk_investtype | pk_investtype | pk_investtype | varchar2(20) |  |  | '~' |
| 31 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 32 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 33 | pk_preinveststage | pk_preinveststage | pk_preinveststage | varchar2(20) |  |  | '~' |
| 34 | pk_projectlib | pk_projectlib | pk_projectlib | varchar2(20) |  |  | '~' |
| 35 | pk_psndoc | pk_psndoc | pk_psndoc | varchar2(20) |  |  | '~' |
| 36 | pk_transtype | pk_transtype | pk_transtype | varchar2(20) |  |  | '~' |
| 37 | taudittime | taudittime | taudittime | char(19) |
| 38 | vapprovenote | vapprovenote | vapprovenote | varchar2(1024) |
| 39 | varrangement | varrangement | varrangement | varchar2(3072) |
| 40 | vbenefiteffect | vbenefiteffect | vbenefiteffect | varchar2(3072) |
| 41 | vbillcode | vbillcode | vbillcode | varchar2(50) |
| 42 | vbillname | vbillname | vbillname | varchar2(600) |
| 43 | vdealteam | vdealteam | vdealteam | varchar2(3072) |
| 44 | vfeasibility | vfeasibility | vfeasibility | varchar2(3072) |
...
| 48 | vinvesttype | vinvesttype | vinvesttype | varchar2(50) |
| 49 | vmaincontent | vmaincontent | vmaincontent | varchar2(3072) |
| 50 | vmemo | vmemo | vmemo | varchar2(3072) |
| 51 | vnecessary | vnecessary | vnecessary | varchar2(3072) |
| 52 | vrelativity | vrelativity | vrelativity | varchar2(3072) |
| 53 | vreserve1 | vreserve1 | vreserve1 | varchar2(100) |
| 54 | vreserve2 | vreserve2 | vreserve2 | varchar2(100) |
| 55 | vreserve3 | vreserve3 | vreserve3 | varchar2(100) |
| 56 | vreserve4 | vreserve4 | vreserve4 | varchar2(100) |
| 57 | vreserve5 | vreserve5 | vreserve5 | varchar2(100) |
| 58 | vreserve6 | vreserve6 | vreserve6 | varchar2(100) |
| 59 | vreserve7 | vreserve7 | vreserve7 | varchar2(100) |
| 60 | vreserve8 | vreserve8 | vreserve8 | varchar2(100) |
| 61 | vreserve9 | vreserve9 | vreserve9 | varchar2(100) |
| 62 | vreserve10 | vreserve10 | vreserve10 | varchar2(100) |
| 63 | vreserve11 | vreserve11 | vreserve11 | varchar2(100) |
| 64 | vreserve12 | vreserve12 | vreserve12 | varchar2(100) |
| 65 | vreserve13 | vreserve13 | vreserve13 | varchar2(100) |
| 66 | vreserve14 | vreserve14 | vreserve14 | varchar2(100) |
| 67 | vreserve15 | vreserve15 | vreserve15 | varchar2(100) |
| 68 | vreserve16 | vreserve16 | vreserve16 | varchar2(100) |
| 69 | vreserve17 | vreserve17 | vreserve17 | varchar2(100) |
| 70 | vreserve18 | vreserve18 | vreserve18 | varchar2(100) |
| 71 | vreserve19 | vreserve19 | vreserve19 | varchar2(100) |
| 72 | vreserve20 | vreserve20 | vreserve20 | varchar2(100) |
