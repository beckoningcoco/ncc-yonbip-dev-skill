...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/9280.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_fundtype | pk_fundtype | pk_fundtype | char(20) | √ |
...
| 14 | pk_parent | pk_parent | pk_parent | varchar2(50) |  |  | '~' |
| 15 | vmemo | vmemo | vmemo | varchar2(2048) |
