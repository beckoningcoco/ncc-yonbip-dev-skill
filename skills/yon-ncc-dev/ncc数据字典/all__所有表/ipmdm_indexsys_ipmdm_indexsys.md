...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/9294.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_indexsys | pk_indexsys | pk_indexsys | char(20) | √ |
| 2 | cbilltypecode | cbilltypecode | cbilltypecode | varchar2(20) |
| 3 | enablestate | enablestate | enablestate | char(1) |
| 4 | fstatusflag | fstatusflag | fstatusflag | number(38, 0) |
...
| 12 | ncindustry | ncindustry | ncindustry | varchar2(100) |  |  | '~' |
...
| 17 | projecttype | projecttype | projecttype | varchar2(50) |
...
| 29 | vtrantypecode | vtrantypecode | vtrantypecode | varchar2(20) |
