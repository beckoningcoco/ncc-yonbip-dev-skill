...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/9484.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_accountset | pk_accountset | pk_accountset | char(20) | √ |
| 2 | accountname | accountname | accountname | varchar2(200) |
| 3 | pk_account | pk_account | pk_account | varchar2(20) |
