...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/9502.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_commitsub | pk_commitsub | pk_commitsub | char(20) | √ |
| 2 | code | code | code | varchar2(50) |
| 3 | commitsubssort | commitsubssort | commitsubssort | varchar2(20) |  |  | '~' |
| 4 | keyvalues | keyvalues | keyvalues | varchar2(50) |
