...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/9580.html
...
| 4 | pk_item | pk_item | pk_item | varchar2(32) | √ |  | '~' |
| 5 | pk_report | pk_report | pk_report | varchar2(20) |
| 6 | pk_task | pk_task | pk_task | varchar2(20) | √ |
| 7 | receiptmsg | receiptmsg | receiptmsg | varchar2(400) |
| 8 | receiverid | receiverid | receiverid | varchar2(20) | √ |
| 9 | recentmodtime | recentmodtime | recentmodtime | char(19) |
| 10 | senderid | senderid | senderid | varchar2(20) | √ |
