...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/9636.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_datadicpower | pk_datadicpower | pk_datadicpower | char(20) | √ |
| 2 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 3 | pk_meta_id | pk_meta_id | pk_meta_id | varchar2(50) |
