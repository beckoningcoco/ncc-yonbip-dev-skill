...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/9650.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | keyval | keyval | keyval | varchar2(64) | √ |
| 2 | code | code | code | varchar2(200) |
| 3 | name1 | name1 | name1 | varchar2(300) |
...
| 9 | org_oid | org_oid | org_oid | char(20) |
