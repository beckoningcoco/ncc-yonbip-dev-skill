...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/9660.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_measub | pk_measub | pk_measub | char(20) | √ |
| 2 | code | code | code | varchar2(50) |
| 3 | measubssort | measubssort | measubssort | varchar2(20) |  |  | '~' |
...
| 11 | pk_hbscheme | pk_hbscheme | pk_hbscheme | varchar2(20) |
| 12 | pk_keygroup | pk_keygroup | pk_keygroup | varchar2(20) |  |  | '~' |
| 13 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 14 | rulecontent | rulecontent | rulecontent | blob |
