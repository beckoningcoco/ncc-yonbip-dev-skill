...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/9766.html
...
| 47 | pk_payrcpt | pk_payrcpt | pk_payrcpt | varchar2(50) |
| 48 | pk_planitem | pk_planitem | pk_planitem | varchar2(20) |  |  | '~' |
| 49 | pk_ratecode | pk_ratecode | pk_ratecode | varchar2(20) |  |  | '~' |
| 50 | pk_settledate | pk_settledate | pk_settledate | varchar2(20) |  |  | '~' |
| 51 | pk_srcbill | pk_srcbill | pk_srcbill | char(20) |
| 52 | pk_srcbilltypeid | pk_srcbilltypeid | pk_srcbilltypeid | varchar2(20) |
...
| 56 | submitter | submitter | submitter | varchar2(20) |  |  | '~' |
| 57 | transtype | transtype | transtype | varchar2(10) |
| 58 | vbillno | vbillno | vbillno | varchar2(40) |
| 59 | vbillstatus | vbillstatus | vbillstatus | number(38, 0) |
| 60 | versionno | versionno | versionno | number(38, 0) |
| 61 | versionres | versionres | versionres | varchar2(50) |
| 62 | versiontime | versiontime | versiontime | char(19) |
| 63 | voucherflag | voucherflag | voucherflag | char(1) |
| 64 | vvoucherid | vvoucherid | vvoucherid | varchar2(20) |  |  | '~' |
