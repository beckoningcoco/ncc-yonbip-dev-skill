...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10087.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_ebankpooldownload | pk_ebankpooldownload | pk_ebankpooldownload | char(20) | √ |
...
| 13 | defaultfa | defaultfa | defaultfa | char(1) |
| 14 | emendenum | emendenum | emendenum | number(38, 0) |
| 15 | facode | facode | facode | varchar2(50) |
| 16 | isgroup | isgroup | isgroup | varchar2(50) |
...
| 27 | transtypepk | transtypepk | transtypepk | char(20) |
