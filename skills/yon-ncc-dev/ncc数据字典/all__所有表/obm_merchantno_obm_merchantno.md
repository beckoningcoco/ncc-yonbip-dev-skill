...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10096.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_merchantno | pk_merchantno | pk_merchantno | char(20) | √ |
| 2 | billdate | billdate | billdate | char(19) |
| 3 | code | code | code | varchar2(50) |
| 4 | enablestate | enablestate | enablestate | varchar2(50) |
| 5 | lastmaketime | lastmaketime | lastmaketime | char(19) |
| 6 | maketime | maketime | maketime | char(19) |
| 7 | merchantno | merchantno | merchantno | varchar2(50) |
