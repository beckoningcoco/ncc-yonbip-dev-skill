...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10185.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_costregion | pk_costregion | pk_costregion | char(20) | √ |
...
| 16 | pk_pfcorg | pk_pfcorg | pk_pfcorg | char(20) |  |  | '~' |
...
| 23 | type | type | type | number(38, 0) |  |  | 0 |
