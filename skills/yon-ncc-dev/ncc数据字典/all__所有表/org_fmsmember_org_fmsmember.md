...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10210.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_fmsmember | pk_fmsmember | pk_fmsmember | char(20) | √ |
...
| 8 | pk_fms | pk_fms | pk_fms | char(20) | √ |
| 9 | pk_org | pk_org | pk_org | char(20) | √ |
| 10 | pk_orgvid | pk_orgvid | pk_orgvid | char(20) | √ |
| 11 | pk_svid | pk_svid | pk_svid | varchar2(20) |  |  | '~' |
| 12 | pk_vid | pk_vid | pk_vid | char(20) | √ |
