...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10228.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_itemorg | pk_itemorg | pk_itemorg | char(20) | √ |
...
| 18 | pk_liacenter | pk_liacenter | pk_liacenter | varchar2(20) |  |  | '~' |
| 19 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 20 | pk_vid | pk_vid | pk_vid | varchar2(20) |  |  | '~' |
