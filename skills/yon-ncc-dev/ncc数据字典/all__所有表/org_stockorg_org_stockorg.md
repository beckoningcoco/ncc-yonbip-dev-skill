...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10313.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_stockorg | pk_stockorg | pk_stockorg | char(20) | √ |
...
| 27 | vname | vname | vname | varchar2(300) |
| 28 | vname2 | vname2 | vname2 | varchar2(200) |
| 29 | vname3 | vname3 | vname3 | varchar2(200) |
| 30 | vname4 | vname4 | vname4 | varchar2(200) |
| 31 | vname5 | vname5 | vname5 | varchar2(200) |
| 32 | vname6 | vname6 | vname6 | varchar2(200) |
