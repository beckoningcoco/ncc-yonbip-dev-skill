...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10401.html
...
| 7 | bill_name | bill_name | bill_name | varchar2(50) |
...
| 12 | check_range | check_range | check_range | varchar2(2000) |
| 13 | end_date | end_date | end_date | char(19) |
...
| 19 | range_detail | range_detail | range_detail | blob |
| 20 | start_date | start_date | start_date | char(19) |
