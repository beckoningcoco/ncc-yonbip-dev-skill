...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10417.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_operate_jobmngfil | pk_operate_jobmngfil | pk_operate_jobmngfil | char(20) | √ |
...
| 9 | type | type | type | number(38, 0) |  |  | 1 |
