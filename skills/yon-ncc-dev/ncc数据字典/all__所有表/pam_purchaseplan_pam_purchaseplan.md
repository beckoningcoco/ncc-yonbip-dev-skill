...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10424.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_purchaseplan | pk_purchaseplan | pk_purchaseplan | char(20) | √ |
| 2 | auditor | auditor | auditor | varchar2(20) |  |  | '~' |
| 3 | audittime | audittime | audittime | char(19) |
| 4 | balancerule | balancerule | balancerule | varchar2(500) |
...
| 19 | saga_frozen | saga_frozen | saga_frozen | number(38, 0) |
| 20 | saga_gtxid | saga_gtxid | saga_gtxid | varchar2(64) |
| 21 | saga_status | saga_status | saga_status | number(38, 0) |
| 22 | searchcondition | searchcondition | searchcondition | varchar2(3800) |
