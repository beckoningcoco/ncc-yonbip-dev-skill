...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10432.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_redeploy_out | pk_redeploy_out | pk_redeploy_out | char(20) | √ |
...
| 16 | pk_ownerorg_in | pk_ownerorg_in | pk_ownerorg_in | varchar2(20) |  |  | '~' |
| 17 | pk_ownerorg_in_v | pk_ownerorg_in_v | pk_ownerorg_in_v | varchar2(20) |  |  | '~' |
| 18 | pk_ownerorg_out | pk_ownerorg_out | pk_ownerorg_out | varchar2(20) |  |  | '~' |
| 19 | pk_ownerorg_out_v | pk_ownerorg_out_v | pk_ownerorg_out_v | varchar2(20) |  |  | '~' |
| 20 | pk_ownerunit_in | pk_ownerunit_in | pk_ownerunit_in | varchar2(20) |  |  | '~' |
| 21 | pk_ownerunit_in_v | pk_ownerunit_in_v | pk_ownerunit_in_v | varchar2(20) |  |  | '~' |
| 22 | pk_ownerunit_out | pk_ownerunit_out | pk_ownerunit_out | varchar2(20) |  |  | '~' |
| 23 | pk_ownerunit_out_v | pk_ownerunit_out_v | pk_ownerunit_out_v | varchar2(20) |  |  | '~' |
| 24 | pk_recorder | pk_recorder | pk_recorder | varchar2(20) |  |  | '~' |
| 25 | pk_transitype | pk_transitype | pk_transitype | varchar2(20) |  |  | '~' |
| 26 | pk_usedorg_in | pk_usedorg_in | pk_usedorg_in | varchar2(20) |  |  | '~' |
| 27 | pk_usedorg_in_v | pk_usedorg_in_v | pk_usedorg_in_v | varchar2(20) |  |  | '~' |
| 28 | pk_usedorg_out | pk_usedorg_out | pk_usedorg_out | varchar2(20) |  |  | '~' |
| 29 | pk_usedorg_out_v | pk_usedorg_out_v | pk_usedorg_out_v | varchar2(20) |  |  | '~' |
| 30 | pre_text1 | pre_text1 | pre_text1 | varchar2(128) |
| 31 | pre_text2 | pre_text2 | pre_text2 | varchar2(128) |
| 32 | pre_text3 | pre_text3 | pre_text3 | varchar2(128) |
| 33 | pre_text4 | pre_text4 | pre_text4 | varchar2(128) |
| 34 | pre_text5 | pre_text5 | pre_text5 | varchar2(128) |
| 35 | pre_text6 | pre_text6 | pre_text6 | varchar2(128) |
| 36 | pre_text7 | pre_text7 | pre_text7 | varchar2(128) |
| 37 | pre_text8 | pre_text8 | pre_text8 | varchar2(128) |
| 38 | pre_text9 | pre_text9 | pre_text9 | varchar2(128) |
| 39 | pre_text10 | pre_text10 | pre_text10 | varchar2(128) |
...
| 45 | workflow_status | workflow_status | workflow_status | number(38, 0) |
