...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10434.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_reduce | pk_reduce | pk_reduce | char(20) | √ |
...
| 10 | bill_type | bill_type | bill_type | varchar2(20) |
| 11 | bill_type_src | bill_type_src | bill_type_src | varchar2(4) |
...
| 15 | obj_donated | obj_donated | obj_donated | varchar2(50) |
| 16 | pk_bill_src | pk_bill_src | pk_bill_src | varchar2(20) |
| 17 | pk_currency | pk_currency | pk_currency | varchar2(20) |  |  | '~' |
...
| 29 | pre_text1 | pre_text1 | pre_text1 | varchar2(128) |
| 30 | pre_text2 | pre_text2 | pre_text2 | varchar2(128) |
| 31 | pre_text3 | pre_text3 | pre_text3 | varchar2(128) |
| 32 | pre_text4 | pre_text4 | pre_text4 | varchar2(128) |
| 33 | pre_text5 | pre_text5 | pre_text5 | varchar2(128) |
| 34 | pre_text6 | pre_text6 | pre_text6 | varchar2(128) |
| 35 | pre_text7 | pre_text7 | pre_text7 | varchar2(128) |
| 36 | pre_text8 | pre_text8 | pre_text8 | varchar2(128) |
| 37 | pre_text9 | pre_text9 | pre_text9 | varchar2(128) |
| 38 | pre_text10 | pre_text10 | pre_text10 | varchar2(128) |
| 39 | reason | reason | reason | varchar2(20) |  |  | '~' |
