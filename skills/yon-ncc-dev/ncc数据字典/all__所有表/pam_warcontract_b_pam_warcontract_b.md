...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10465.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_warcontract_b | pk_warcontract_b | pk_warcontract_b | char(20) | √ |
| 2 | charge_global | charge_global | charge_global | number(28, 8) |
| 3 | charge_group | charge_group | charge_group | number(28, 8) |
| 4 | charge_org | charge_org | charge_org | number(28, 8) |
...
| 12 | pk_warcontract | pk_warcontract | pk_warcontract | varchar2(20) |  |  | '~' |
