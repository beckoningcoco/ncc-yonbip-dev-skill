...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10467.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_warcontract_i | pk_warcontract_i | pk_warcontract_i | char(20) | √ |
| 2 | item_content | item_content | item_content | varchar2(1024) |
| 3 | memo | memo | memo | varchar2(200) |
| 4 | other_info | other_info | other_info | varchar2(200) |
| 5 | pk_contract_item | pk_contract_item | pk_contract_item | varchar2(20) |  |  | '~' |
