...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10543.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_budgetbegin | pk_budgetbegin | pk_budgetbegin | char(20) | √ |
...
| 11 | flexible_flag | flexible_flag | flexible_flag | char(1) |
...
| 19 | transi_type | transi_type | transi_type | varchar2(50) |
