...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10594.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_earningplan | pk_earningplan | pk_earningplan | char(20) | √ |
| 2 | actual_mny | actual_mny | actual_mny | number(28, 8) |
...
| 11 | complete_rate | complete_rate | complete_rate | number(28, 8) |
| 12 | making_mode | making_mode | making_mode | number(38, 0) |
| 13 | memo | memo | memo | varchar2(200) |
| 14 | pk_accperiodmonth | pk_accperiodmonth | pk_accperiodmonth | varchar2(20) |  |  | '~' |
| 15 | pk_accperiodscheme | pk_accperiodscheme | pk_accperiodscheme | varchar2(20) |  |  | '~' |
| 16 | pk_dept | pk_dept | pk_dept | varchar2(20) |  |  | '~' |
| 17 | pk_dept_v | pk_dept_v | pk_dept_v | varchar2(20) |  |  | '~' |
| 18 | pk_financeorg | pk_financeorg | pk_financeorg | varchar2(20) |  |  | '~' |
...
| 23 | pk_psndoc | pk_psndoc | pk_psndoc | varchar2(20) |  |  | '~' |
| 24 | pk_transitype | pk_transitype | pk_transitype | varchar2(20) |  |  | '~' |
| 25 | plan_date | plan_date | plan_date | char(19) |
| 26 | plan_mny | plan_mny | plan_mny | number(28, 8) |
