...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10710.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_sumexpendplan | pk_sumexpendplan | pk_sumexpendplan | char(20) | √ |
...
| 9 | check_date | check_date | check_date | char(19) |
| 10 | check_mny | check_mny | check_mny | number(28, 8) |
| 11 | check_opinion | check_opinion | check_opinion | varchar2(200) |
| 12 | memo | memo | memo | varchar2(200) |
| 13 | pk_accperiodmonth | pk_accperiodmonth | pk_accperiodmonth | varchar2(20) |  |  | '~' |
| 14 | pk_accperiodscheme | pk_accperiodscheme | pk_accperiodscheme | varchar2(20) |  |  | '~' |
...
| 24 | plan_mny | plan_mny | plan_mny | number(28, 8) |
| 25 | transi_type | transi_type | transi_type | varchar2(50) |
