...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10986.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_respapp | pk_respapp | pk_respapp | varchar2(20) | √ |
| 2 | appcode | appcode | appcode | varchar2(50) |
| 3 | pk_resp | pk_resp | pk_resp | varchar2(50) |
