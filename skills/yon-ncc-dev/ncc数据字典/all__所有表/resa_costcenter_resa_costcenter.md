...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11147.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_costcenter | pk_costcenter | pk_costcenter | char(20) | √ |
...
| 25 | pk_factory | pk_factory | pk_factory | varchar2(20) |  |  | '~' |
| 26 | pk_father | pk_father | pk_father | varchar2(20) |  |  | '~' |
...
| 30 | pk_principal | pk_principal | pk_principal | varchar2(20) |  |  | '~' |
| 31 | pk_profitcenter | pk_profitcenter | pk_profitcenter | varchar2(20) |  |  | '~' |
| 32 | pk_vid | pk_vid | pk_vid | char(20) |
