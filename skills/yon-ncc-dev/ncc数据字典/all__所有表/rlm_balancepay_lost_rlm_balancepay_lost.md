...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11181.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_balancepay_lost | pk_balancepay_lost | pk_balancepay_lost | char(20) | √ |
| 2 | lostmoney | lostmoney | lostmoney | number(28, 8) |
| 3 | lost_num | lost_num | lost_num | number(28, 8) |
| 4 | lost_price | lost_price | lost_price | number(28, 8) |
