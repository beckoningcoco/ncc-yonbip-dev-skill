...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11190.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_contract_d | pk_contract_d | pk_contract_d | char(20) | √ |
| 2 | damage_price | damage_price | damage_price | number(28, 8) |
| 3 | memo | memo | memo | varchar2(200) |
| 4 | pk_contract | pk_contract | pk_contract | char(20) | √ |
| 5 | pk_damagestd | pk_damagestd | pk_damagestd | varchar2(20) |  |  | '~' |
| 6 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 7 | pk_marbaseclass | pk_marbaseclass | pk_marbaseclass | varchar2(20) |  |  | '~' |
| 8 | pk_material | pk_material | pk_material | varchar2(20) |  |  | '~' |
| 9 | pk_material_v | pk_material_v | pk_material_v | varchar2(20) |  |  | '~' |
