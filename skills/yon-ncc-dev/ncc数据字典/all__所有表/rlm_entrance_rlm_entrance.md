...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11197.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_entrance | pk_entrance | pk_entrance | char(20) | √ |
...
| 11 | bill_type_src_cooperate | bill_type_src_cooperate | bill_type_src_cooperate | varchar2(20) |
...
| 42 | start_flag | start_flag | start_flag | char(1) |
| 43 | transi_type | transi_type | transi_type | varchar2(30) |
| 44 | transi_type_src | transi_type_src | transi_type_src | varchar2(30) |
| 45 | transi_type_src_cooperate | transi_type_src_cooperate | transi_type_src_cooperate | varchar2(30) |
