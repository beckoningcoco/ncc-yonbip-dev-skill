...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11203.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_exit_d | pk_exit_d | pk_exit_d | char(20) | √ |
...
| 7 | pk_exit | pk_exit | pk_exit | char(20) | √ |
| 8 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 9 | pk_marbaseclass | pk_marbaseclass | pk_marbaseclass | varchar2(20) |  |  | '~' |
| 10 | pk_material | pk_material | pk_material | varchar2(20) |  |  | '~' |
| 11 | pk_material_v | pk_material_v | pk_material_v | varchar2(20) |  |  | '~' |
| 12 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 13 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 14 | pk_rent_unit | pk_rent_unit | pk_rent_unit | varchar2(20) |  |  | '~' |
| 15 | rowno | rowno | rowno | varchar2(30) |
| 16 | rowno_src | rowno_src | rowno_src | varchar2(30) |
| 17 | src_body_rowno | src_body_rowno | src_body_rowno | varchar2(30) |
| 18 | src_pk_bill_b | src_pk_bill_b | src_pk_bill_b | varchar2(20) |
| 19 | start_date | start_date | start_date | char(19) |
