...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11205.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_exit_f | pk_exit_f | pk_exit_f | char(20) | √ |
| 2 | com_num | com_num | com_num | number(28, 8) |
| 3 | com_price | com_price | com_price | number(28, 8) |
| 4 | ismaterial_flag | ismaterial_flag | ismaterial_flag | char(1) |
| 5 | memo | memo | memo | varchar2(200) |
| 6 | pk_compensationstd | pk_compensationstd | pk_compensationstd | varchar2(20) |  |  | '~' |
| 7 | pk_contract_b_src | pk_contract_b_src | pk_contract_b_src | varchar2(20) |
| 8 | pk_exit | pk_exit | pk_exit | char(20) | √ |
...
| 15 | pk_rent_unit | pk_rent_unit | pk_rent_unit | varchar2(20) |  |  | '~' |
| 16 | rowno | rowno | rowno | varchar2(30) |
| 17 | rowno_src | rowno_src | rowno_src | varchar2(30) |
