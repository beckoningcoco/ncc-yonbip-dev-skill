...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11209.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_rentpay | pk_rentpay | pk_rentpay | char(20) | √ |
...
| 19 | headts_src_cooperate | headts_src_cooperate | headts_src_cooperate | char(19) |
| 20 | lease_type | lease_type | lease_type | number(38, 0) |
| 21 | memo | memo | memo | varchar2(200) |
| 22 | pk_bill_src_cooperate | pk_bill_src_cooperate | pk_bill_src_cooperate | varchar2(20) |
| 23 | pk_confirmer | pk_confirmer | pk_confirmer | varchar2(20) |  |  | '~' |
...
| 28 | pk_fiorg | pk_fiorg | pk_fiorg | varchar2(20) |  |  | '~' |
| 29 | pk_fiorg_v | pk_fiorg_v | pk_fiorg_v | varchar2(20) |  |  | '~' |
...
| 33 | pk_org_out | pk_org_out | pk_org_out | varchar2(20) |  |  | '~' |
| 34 | pk_org_out_v | pk_org_out_v | pk_org_out_v | varchar2(20) |  |  | '~' |
| 35 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 36 | pk_raorg | pk_raorg | pk_raorg | varchar2(20) |  |  | '~' |
| 37 | pk_raorg_v | pk_raorg_v | pk_raorg_v | varchar2(20) |  |  | '~' |
