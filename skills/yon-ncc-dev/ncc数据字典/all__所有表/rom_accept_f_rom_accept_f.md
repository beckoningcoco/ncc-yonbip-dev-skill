...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11222.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_accept_f | pk_accept_f | pk_accept_f | char(20) | √ |
...
| 6 | pk_accept | pk_accept | pk_accept | char(20) | √ |
| 7 | pk_compensationstd | pk_compensationstd | pk_compensationstd | varchar2(20) |  |  | '~' |
