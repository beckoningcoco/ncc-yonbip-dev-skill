...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11223.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_accept_g | pk_accept_g | pk_accept_g | char(20) | √ |
| 2 | fee_type | fee_type | fee_type | number(38, 0) |
| 3 | ismaterial_flag | ismaterial_flag | ismaterial_flag | char(1) |
| 4 | memo | memo | memo | varchar2(200) |
| 5 | num | num | num | number(28, 8) |
| 6 | pay_money | pay_money | pay_money | number(28, 8) |
| 7 | pay_money_global | pay_money_global | pay_money_global | number(28, 8) |
| 8 | pay_money_group | pay_money_group | pay_money_group | number(28, 8) |
| 9 | pay_money_org | pay_money_org | pay_money_org | number(28, 8) |
| 10 | pk_accept | pk_accept | pk_accept | char(20) | √ |
| 11 | pk_bill_b_src_cooperate | pk_bill_b_src_cooperate | pk_bill_b_src_cooperate | varchar2(20) |
...
| 18 | pk_unit | pk_unit | pk_unit | varchar2(20) |  |  | '~' |
| 19 | price | price | price | number(28, 8) |
...
| 41 | vfree1 | vfree1 | vfree1 | varchar2(101) |
| 42 | vfree2 | vfree2 | vfree2 | varchar2(101) |
| 43 | vfree3 | vfree3 | vfree3 | varchar2(101) |
| 44 | vfree4 | vfree4 | vfree4 | varchar2(101) |
| 45 | vfree5 | vfree5 | vfree5 | varchar2(101) |
| 46 | vfree6 | vfree6 | vfree6 | varchar2(101) |
| 47 | vfree7 | vfree7 | vfree7 | varchar2(101) |
| 48 | vfree8 | vfree8 | vfree8 | varchar2(101) |
| 49 | vfree9 | vfree9 | vfree9 | varchar2(101) |
| 50 | vfree10 | vfree10 | vfree10 | varchar2(101) |
