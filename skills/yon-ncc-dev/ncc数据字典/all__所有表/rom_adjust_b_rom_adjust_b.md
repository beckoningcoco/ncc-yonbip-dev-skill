...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11225.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_adjust_b | pk_adjust_b | pk_adjust_b | char(20) | √ |
| 2 | adjust_money | adjust_money | adjust_money | number(28, 8) |
| 3 | adjust_money_global | adjust_money_global | adjust_money_global | number(28, 8) |
| 4 | adjust_money_group | adjust_money_group | adjust_money_group | number(28, 8) |
| 5 | adjust_money_org | adjust_money_org | adjust_money_org | number(28, 8) |
...
| 9 | pk_adjust | pk_adjust | pk_adjust | char(20) | √ |
| 10 | pk_contract_b_base_src | pk_contract_b_base_src | pk_contract_b_base_src | varchar2(20) |
| 11 | pk_contract_b_src | pk_contract_b_src | pk_contract_b_src | varchar2(20) |
...
| 21 | src_pk_bill_b | src_pk_bill_b | src_pk_bill_b | varchar2(20) |
...
| 43 | vfree1 | vfree1 | vfree1 | varchar2(101) |
| 44 | vfree2 | vfree2 | vfree2 | varchar2(101) |
| 45 | vfree3 | vfree3 | vfree3 | varchar2(101) |
| 46 | vfree4 | vfree4 | vfree4 | varchar2(101) |
| 47 | vfree5 | vfree5 | vfree5 | varchar2(101) |
| 48 | vfree6 | vfree6 | vfree6 | varchar2(101) |
| 49 | vfree7 | vfree7 | vfree7 | varchar2(101) |
| 50 | vfree8 | vfree8 | vfree8 | varchar2(101) |
| 51 | vfree9 | vfree9 | vfree9 | varchar2(101) |
| 52 | vfree10 | vfree10 | vfree10 | varchar2(101) |
