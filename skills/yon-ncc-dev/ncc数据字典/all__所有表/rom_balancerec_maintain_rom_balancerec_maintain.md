...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11233.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_balancerec_maintain | pk_balancerec_maintain | pk_balancerec_maintain | char(20) | √ |
| 2 | memo | memo | memo | varchar2(200) |
| 3 | pk_balancerec | pk_balancerec | pk_balancerec | char(20) | √ |
| 4 | pk_contract_base | pk_contract_base | pk_contract_base | varchar2(20) |  |  | '~' |
| 5 | pk_contract_v | pk_contract_v | pk_contract_v | varchar2(20) |  |  | '~' |
| 6 | pk_currency_origin | pk_currency_origin | pk_currency_origin | varchar2(20) |  |  | '~' |
...
| 13 | pk_repairstd | pk_repairstd | pk_repairstd | varchar2(20) |  |  | '~' |
| 14 | pk_unit | pk_unit | pk_unit | varchar2(20) |  |  | '~' |
| 15 | repairmoney | repairmoney | repairmoney | number(28, 8) |
| 16 | repair_num | repair_num | repair_num | number(28, 8) |
| 17 | repair_price | repair_price | repair_price | number(28, 8) |
