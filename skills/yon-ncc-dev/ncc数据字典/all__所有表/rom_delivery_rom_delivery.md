...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11248.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_delivery | pk_delivery | pk_delivery | char(20) | √ |
...
| 21 | pk_confirmer | pk_confirmer | pk_confirmer | varchar2(20) |  |  | '~' |
| 22 | pk_contract_base | pk_contract_base | pk_contract_base | varchar2(20) |  |  | '~' |
| 23 | pk_contract_v | pk_contract_v | pk_contract_v | varchar2(20) |  |  | '~' |
| 24 | pk_currency | pk_currency | pk_currency | varchar2(20) |  |  | '~' |
...
| 30 | pk_jobmngfil | pk_jobmngfil | pk_jobmngfil | varchar2(20) |  |  | '~' |
| 31 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 32 | pk_org_in | pk_org_in | pk_org_in | varchar2(20) |  |  | '~' |
| 33 | pk_org_in_v | pk_org_in_v | pk_org_in_v | varchar2(20) |  |  | '~' |
...
| 38 | pk_warehouse | pk_warehouse | pk_warehouse | varchar2(20) |  |  | '~' |
