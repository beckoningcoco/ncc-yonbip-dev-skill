...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11252.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_maintain_b | pk_maintain_b | pk_maintain_b | char(20) | √ |
...
| 8 | maintain_price | maintain_price | maintain_price | number(28, 8) |
| 9 | main_num | main_num | main_num | number(28, 8) |
| 10 | memo | memo | memo | varchar2(200) |
| 11 | nbatchcode | nbatchcode | nbatchcode | varchar2(40) |
| 12 | num | num | num | number(28, 8) |
| 13 | pk_contract_b_src | pk_contract_b_src | pk_contract_b_src | varchar2(50) |
| 14 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 15 | pk_jobmngfil | pk_jobmngfil | pk_jobmngfil | varchar2(20) |  |  | '~' |
| 16 | pk_maintain | pk_maintain | pk_maintain | char(20) | √ |
| 17 | pk_maintainstd | pk_maintainstd | pk_maintainstd | varchar2(20) |  |  | '~' |
...
| 31 | rowno_src | rowno_src | rowno_src | varchar2(30) |
| 32 | src_pk_bill_b | src_pk_bill_b | src_pk_bill_b | varchar2(50) |
