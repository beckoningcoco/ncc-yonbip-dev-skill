...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11259.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_add_register | pk_add_register | pk_add_register | char(20) | √ |
| 2 | auditor | auditor | auditor | varchar2(20) |  |  | '~' |
| 3 | audittime | audittime | audittime | char(19) |
| 4 | beginning_flag | beginning_flag | beginning_flag | char(1) |  |  | 'N' |
...
| 17 | pk_register_dept | pk_register_dept | pk_register_dept | varchar2(20) |  |  | '~' |
| 18 | pk_register_dept_v | pk_register_dept_v | pk_register_dept_v | varchar2(20) |  |  | '~' |
| 19 | pk_registrant | pk_registrant | pk_registrant | varchar2(20) |  |  | '~' |
