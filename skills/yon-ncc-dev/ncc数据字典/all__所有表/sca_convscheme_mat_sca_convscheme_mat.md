...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11401.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cmatpriceid | cmatpriceid | cmatpriceid | char(20) | √ |
...
| 5 | priceaddcoefficient | priceaddcoefficient | priceaddcoefficient | number(28, 8) |  |  | 0.00 |
