...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11277.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | ciastuff_bid | ciastuff_bid | ciastuff_bid | char(20) | √ |
| 2 | bcounted | bcounted | bcounted | char(1) |
| 3 | ccustomerid | ccustomerid | ccustomerid | varchar2(20) |  |  | '~' |
| 4 | celementid | celementid | celementid | varchar2(20) |  |  | '~' |
| 5 | ciastuffid | ciastuffid | ciastuffid | char(20) |
...
| 12 | csourcebillid | csourcebillid | csourcebillid | char(20) |
| 13 | cvendorid | cvendorid | cvendorid | varchar2(20) |  |  | '~' |
| 14 | imodifytype | imodifytype | imodifytype | number(38, 0) |
| 15 | nmoney | nmoney | nmoney | number(28, 8) |
| 16 | nnum | nnum | nnum | number(28, 8) |
| 17 | nprice | nprice | nprice | number(28, 8) |
| 18 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 19 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 20 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 21 | vsourcecode | vsourcecode | vsourcecode | varchar2(40) |
...
| 42 | vbfree1 | vbfree1 | vbfree1 | varchar2(101) |
| 43 | vbfree2 | vbfree2 | vbfree2 | varchar2(101) |
| 44 | vbfree3 | vbfree3 | vbfree3 | varchar2(101) |
| 45 | vbfree4 | vbfree4 | vbfree4 | varchar2(101) |
| 46 | vbfree5 | vbfree5 | vbfree5 | varchar2(101) |
| 47 | vbfree6 | vbfree6 | vbfree6 | varchar2(101) |
| 48 | vbfree7 | vbfree7 | vbfree7 | varchar2(101) |
| 49 | vbfree8 | vbfree8 | vbfree8 | varchar2(101) |
| 50 | vbfree9 | vbfree9 | vbfree9 | varchar2(101) |
| 51 | vbfree10 | vbfree10 | vbfree10 | varchar2(101) |
