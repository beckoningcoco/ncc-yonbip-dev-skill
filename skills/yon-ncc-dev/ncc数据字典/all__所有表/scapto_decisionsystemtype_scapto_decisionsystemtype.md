...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11309.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_decisionsystemtype | pk_decisionsystemtype | pk_decisionsystemtype | char(20) | √ |
| 2 | bisdefault | bisdefault | bisdefault | char(1) |
| 3 | bispreset | bispreset | bispreset | char(1) |
| 4 | code | code | code | varchar2(80) | √ |
