...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11323.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_implementstatus | pk_implementstatus | pk_implementstatus | char(20) | √ |
| 2 | bispreset | bispreset | bispreset | char(1) |
| 3 | code | code | code | varchar2(40) | √ |
| 4 | enablestate | enablestate | enablestate | char(1) |
| 5 | memo | memo | memo | varchar2(400) |
| 6 | memo2 | memo2 | memo2 | varchar2(400) |
| 7 | memo3 | memo3 | memo3 | varchar2(400) |
| 8 | memo4 | memo4 | memo4 | varchar2(400) |
| 9 | memo5 | memo5 | memo5 | varchar2(400) |
| 10 | memo6 | memo6 | memo6 | varchar2(400) |
| 11 | name | name | name | varchar2(400) |
| 12 | name2 | name2 | name2 | varchar2(400) |
| 13 | name3 | name3 | name3 | varchar2(400) |
| 14 | name4 | name4 | name4 | varchar2(400) |
| 15 | name5 | name5 | name5 | varchar2(400) |
| 16 | name6 | name6 | name6 | varchar2(400) |
