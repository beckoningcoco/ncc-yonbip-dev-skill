...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11334.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_matterdirectory | pk_matterdirectory | pk_matterdirectory | char(20) | √ |
...
| 19 | pk_matterlistype | pk_matterlistype | pk_matterlistype | varchar2(20) |  |  | '~' |
