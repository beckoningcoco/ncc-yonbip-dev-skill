...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11337.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_matterlistreport | pk_matterlistreport | pk_matterlistreport | char(20) | √ |
...
| 11 | dinvaliddate | dinvaliddate | dinvaliddate | char(19) |
| 12 | dmakedate | dmakedate | dmakedate | char(19) |
| 13 | dvaliddate | dvaliddate | dvaliddate | char(19) |
...
| 29 | vbillcode | vbillcode | vbillcode | varchar2(100) |
| 30 | vbillname | vbillname | vbillname | varchar2(1024) |
| 31 | version | version | version | varchar2(50) |
...
| 56 | vsrccode | vsrccode | vsrccode | varchar2(50) |
| 57 | vsrctrantype | vsrctrantype | vsrctrantype | varchar2(20) |
| 58 | vsrctype | vsrctype | vsrctype | varchar2(20) |
