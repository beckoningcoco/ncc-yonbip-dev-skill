...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11370.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_systemreport | pk_systemreport | pk_systemreport | char(20) | √ |
| 2 | approver | approver | approver | varchar2(20) |  |  | '~' |
| 3 | billmaker | billmaker | billmaker | varchar2(20) |  |  | '~' |
| 4 | bislawverify | bislawverify | bislawverify | char(1) |
...
| 12 | dinvaliddate | dinvaliddate | dinvaliddate | char(19) |
| 13 | dmakedate | dmakedate | dmakedate | char(19) |
| 14 | dvaliddate | dvaliddate | dvaliddate | char(19) |
...
| 20 | pk_decidemeettype | pk_decidemeettype | pk_decidemeettype | varchar2(20) |  |  | '~' |
| 21 | pk_decidesubjecttype | pk_decidesubjecttype | pk_decidesubjecttype | varchar2(20) |  |  | '~' |
| 22 | pk_decisionsystemtype | pk_decisionsystemtype | pk_decisionsystemtype | varchar2(20) |  |  | '~' |
| 23 | pk_dept | pk_dept | pk_dept | varchar2(20) |  |  | '~' |
| 24 | pk_dept_v | pk_dept_v | pk_dept_v | varchar2(20) |  |  | '~' |
| 25 | pk_enterprise | pk_enterprise | pk_enterprise | varchar2(20) |  |  | '~' |
...
| 33 | vbillcode | vbillcode | vbillcode | varchar2(100) | √ |
| 34 | vbillname | vbillname | vbillname | varchar2(2048) |
...
| 38 | vmemo | vmemo | vmemo | varchar2(4000) |
