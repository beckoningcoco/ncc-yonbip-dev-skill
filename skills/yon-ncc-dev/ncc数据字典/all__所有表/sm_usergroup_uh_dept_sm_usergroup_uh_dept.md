...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11651.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_userdept | pk_userdept | pk_userdept | char(20) | √ |
...
| 6 | pk_usergroup | pk_usergroup | pk_usergroup | varchar2(20) |  |  | '~' |
