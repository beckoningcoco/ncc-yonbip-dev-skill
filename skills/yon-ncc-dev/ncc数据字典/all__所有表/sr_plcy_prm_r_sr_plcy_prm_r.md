...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11781.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_plcy_prmtype_r | pk_plcy_prmtype_r | pk_plcy_prmtype_r | char(20) | √ |
...
| 7 | pk_plcy_prmtype | pk_plcy_prmtype | pk_plcy_prmtype | char(20) |
