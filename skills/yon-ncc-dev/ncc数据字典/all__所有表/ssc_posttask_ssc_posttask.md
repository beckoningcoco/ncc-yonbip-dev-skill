...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11959.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_posttask | pk_posttask | pk_posttask | char(20) | √ |
| 2 | orderfield | orderfield | orderfield | varchar2(50) |
| 3 | pk_activetask | pk_activetask | pk_activetask | varchar2(20) |  |  | '~' |
| 4 | pk_busiactivity | pk_busiactivity | pk_busiactivity | varchar2(20) |  |  | '~' |
