...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11799.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_pointclass | pk_pointclass | pk_pointclass | char(20) | √ |
...
| 10 | pk_sscunit | pk_sscunit | pk_sscunit | varchar2(20) | √ |
