...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11889.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_accessoryshow | pk_accessoryshow | pk_accessoryshow | char(20) | √ |
| 2 | billtype_code | billtype_code | billtype_code | varchar2(50) |
| 3 | extendinfo | extendinfo | extendinfo | varchar2(4000) |
| 4 | params | params | params | varchar2(500) |
| 5 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 6 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 7 | pk_ots | pk_ots | pk_ots | varchar2(20) |  |  | '~' |
| 8 | pk_transtype | pk_transtype | pk_transtype | varchar2(20) |  |  | '~' |
| 9 | showtype | showtype | showtype | number(38, 0) |
