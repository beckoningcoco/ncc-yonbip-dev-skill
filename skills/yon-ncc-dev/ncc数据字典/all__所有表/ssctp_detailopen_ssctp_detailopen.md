...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11901.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_detailopen | pk_detailopen | pk_detailopen | char(20) | √ |
| 2 | billtype_code | billtype_code | billtype_code | varchar2(50) |
| 3 | extendinfo | extendinfo | extendinfo | varchar2(4000) |
| 4 | opentype | opentype | opentype | varchar2(20) |
| 5 | params | params | params | varchar2(500) |
