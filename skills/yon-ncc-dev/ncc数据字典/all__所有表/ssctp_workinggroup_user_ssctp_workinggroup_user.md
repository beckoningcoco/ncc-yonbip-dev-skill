...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11931.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_sscworkinggroup | pk_sscworkinggroup | pk_sscworkinggroup | char(20) | √ |
...
| 6 | pk_workinggroup | pk_workinggroup | pk_workinggroup | char(20) |
| 7 | usertype | usertype | usertype | varchar2(20) |
