...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11981.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_obj | pk_obj | pk_obj | char(20) | √ |
| 2 | createddate | createddate | createddate | char(19) |
| 3 | enablestate | enablestate | enablestate | number(38, 0) |
| 4 | issystem | issystem | issystem | char(1) |
| 5 | modifiedby | modifiedby | modifiedby | varchar2(20) |
| 6 | modifieddate | modifieddate | modifieddate | char(19) |
| 7 | objcode | objcode | objcode | varchar2(50) | √ |
| 8 | objname | objname | objname | varchar2(200) | √ |
| 9 | objname2 | objname2 | objname2 | varchar2(200) |
| 10 | objname3 | objname3 | objname3 | varchar2(200) |
| 11 | objname4 | objname4 | objname4 | varchar2(200) |
| 12 | objname5 | objname5 | objname5 | varchar2(200) |
| 13 | objname6 | objname6 | objname6 | varchar2(200) |
| 14 | pk_group | pk_group | pk_group | varchar2(20) |
| 15 | pk_org | pk_org | pk_org | varchar2(20) |
| 16 | pk_parent | pk_parent | pk_parent | varchar2(20) |
| 17 | pk_workbook | pk_workbook | pk_workbook | varchar2(20) |
| 18 | sheetname | sheetname | sheetname | varchar2(100) |
