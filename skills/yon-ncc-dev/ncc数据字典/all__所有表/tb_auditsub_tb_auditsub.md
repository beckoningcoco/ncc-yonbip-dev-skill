...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11983.html
...
| 4 | isordertype | isordertype | isordertype | char(1) |
...
| 15 | periodsum | periodsum | periodsum | number(38, 0) |
| 16 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 17 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 18 | pk_parent | pk_parent | pk_parent | varchar2(20) |  |  | '~' |
| 19 | toloan | toloan | toloan | number(38, 0) |
