...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12004.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_obj | pk_obj | pk_obj | char(20) | √ |
| 2 | createddate | createddate | createddate | char(19) |
| 3 | dataattrtype | dataattrtype | dataattrtype | number(38, 0) |
| 4 | enablestate | enablestate | enablestate | number(38, 0) |  |  | 0 |
| 5 | issystem | issystem | issystem | char(1) |  |  | 'N' |
