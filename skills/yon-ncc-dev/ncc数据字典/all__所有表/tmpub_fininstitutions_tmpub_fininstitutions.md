...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12159.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_fininstitution | pk_fininstitution | pk_fininstitution | char(20) | √ |
| 2 | code | code | code | varchar2(50) |
| 3 | enable_state | enable_state | enable_state | varchar2(50) |
...
| 10 | pk_fininstitutiontype | pk_fininstitutiontype | pk_fininstitutiontype | varchar2(20) |  |  | '~' |
