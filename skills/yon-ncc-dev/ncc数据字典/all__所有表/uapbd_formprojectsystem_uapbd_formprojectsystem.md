...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12327.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_formprojectsystem | pk_formprojectsystem | pk_formprojectsystem | char(20) | √ |
...
| 11 | pk_accsystem | pk_accsystem | pk_accsystem | varchar2(20) | √ |
