...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12376.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_ccinv | pk_ccinv | pk_ccinv | char(20) | √ |
| 2 | code_invpk | code_invpk | code_invpk | varchar2(50) |
| 3 | flag_wf | flag_wf | flag_wf | char(1) |
| 4 | invnos_canc | invnos_canc | invnos_canc | varchar2(4000) |
| 5 | num_begin | num_begin | num_begin | varchar2(30) |
| 6 | num_end | num_end | num_end | varchar2(30) |
| 7 | pk_blcc | pk_blcc | pk_blcc | varchar2(20) |  |  | '~' |
| 8 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 9 | pk_invcate | pk_invcate | pk_invcate | char(20) |
