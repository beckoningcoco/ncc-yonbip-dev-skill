...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12378.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_ccpm | pk_ccpm | pk_ccpm | char(20) | √ |
| 2 | amount | amount | amount | number(14, 2) |
| 3 | amt_return | amt_return | amt_return | number(14, 2) |
| 4 | dt_paymode | dt_paymode | dt_paymode | char(20) |
| 5 | dt_paytype | dt_paytype | dt_paytype | varchar2(50) |
| 6 | pk_blcc | pk_blcc | pk_blcc | varchar2(20) |  |  | '~' |
| 7 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 8 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 9 | pk_paymode | pk_paymode | pk_paymode | varchar2(20) |  |  | '~' |
| 10 | pmcn | pmcn | pmcn | number(38, 0) |
