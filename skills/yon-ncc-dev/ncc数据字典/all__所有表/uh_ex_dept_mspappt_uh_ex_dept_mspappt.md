...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12571.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_mspappt | pk_mspappt | pk_mspappt | char(20) | √ |
...
| 14 | name_psn_notice | name_psn_notice | name_psn_notice | varchar2(50) |
| 15 | note | note | note | varchar2(4000) |
| 16 | note_exam | note_exam | note_exam | varchar2(256) |
...
| 31 | time_appt | time_appt | time_appt | char(19) |
