...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12611.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_tfpd | pk_tfpd | pk_tfpd | char(20) | √ |
| 2 | code_pd | code_pd | code_pd | varchar2(50) |
| 3 | date_canc | date_canc | date_canc | char(19) |
| 4 | date_left | date_left | date_left | char(19) |
| 5 | flag_inc | flag_inc | flag_inc | char(1) |
| 6 | flag_st | flag_st | flag_st | char(1) |
| 7 | name_canc | name_canc | name_canc | varchar2(50) |
| 8 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 9 | pk_measdoc_cur | pk_measdoc_cur | pk_measdoc_cur | varchar2(20) |  |  | '~' |
| 10 | pk_measdoc_md | pk_measdoc_md | pk_measdoc_md | varchar2(20) |  |  | '~' |
| 11 | pk_ord_inc | pk_ord_inc | pk_ord_inc | varchar2(50) |  |  | '~' |
| 12 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 13 | pk_pd | pk_pd | pk_pd | varchar2(20) |  |  | '~' |
| 14 | pk_psn_canc | pk_psn_canc | pk_psn_canc | varchar2(20) |  |  | '~' |
| 15 | pk_tfrec | pk_tfrec | pk_tfrec | varchar2(20) |  |  | '~' |
| 16 | quan | quan | quan | number(28, 8) |
| 17 | quan_exec | quan_exec | quan_exec | number(28, 8) |
| 18 | quan_left | quan_left | quan_left | number(28, 8) |
| 19 | quan_md | quan_md | quan_md | number(14, 2) |
