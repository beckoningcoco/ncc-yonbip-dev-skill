...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12633.html
...
| 7 | hpname | hpname | hpname | varchar2(50) |
| 8 | pk_hp | pk_hp | pk_hp | varchar2(20) |  |  | '~' |
| 9 | pk_signin_person | pk_signin_person | pk_signin_person | varchar2(20) |  |  | '~' |
| 10 | pk_signout_person | pk_signout_person | pk_signout_person | varchar2(20) |  |  | '~' |
| 11 | signin_person_name | signin_person_name | signin_person_name | varchar2(50) |
| 12 | signout_person_name | signout_person_name | signout_person_name | varchar2(50) |
