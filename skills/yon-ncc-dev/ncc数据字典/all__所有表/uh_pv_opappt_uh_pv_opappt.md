...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12759.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_pvopappt | pk_pvopappt | pk_pvopappt | char(20) | √ |
| 2 | code_dept_belong | code_dept_belong | code_dept_belong | char(20) |
| 3 | code_dept_res | code_dept_res | code_dept_res | varchar2(30) |
| 4 | code_phy_res | code_phy_res | code_phy_res | varchar2(30) |
| 5 | code_pv | code_pv | code_pv | varchar2(50) |
| 6 | code_srv | code_srv | code_srv | varchar2(30) |
| 7 | date_pv | date_pv | date_pv | char(19) |
| 8 | eu_apptmode | eu_apptmode | eu_apptmode | number(38, 0) |
| 9 | flag_pv | flag_pv | flag_pv | varchar2(50) |
| 10 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 11 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 12 | pk_schappt | pk_schappt | pk_schappt | varchar2(20) |  |  | '~' |
