...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12802.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_prirule | pk_prirule | pk_prirule | char(20) | √ |
| 2 | code_rule | code_rule | code_rule | varchar2(30) |
| 3 | date_active | date_active | date_active | char(19) |
| 4 | dt_pdtype | dt_pdtype | dt_pdtype | varchar2(20) |
| 5 | flag_active | flag_active | flag_active | varchar2(20) |
