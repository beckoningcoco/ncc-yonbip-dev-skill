...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12796.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_ticketresoth | pk_ticketresoth | pk_ticketresoth | char(20) | √ |
| 2 | dt_resrole | dt_resrole | dt_resrole | varchar2(50) |
| 3 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 4 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 5 | pk_res | pk_res | pk_res | varchar2(20) |  |  | '~' |
| 6 | pk_resrole | pk_resrole | pk_resrole | varchar2(20) |  |  | '~' |
