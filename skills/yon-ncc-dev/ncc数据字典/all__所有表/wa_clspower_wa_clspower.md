...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12861.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_clspower | pk_clspower | pk_clspower | char(20) | √ |
...
| 7 | subject_type | subject_type | subject_type | varchar2(2) | √ |
