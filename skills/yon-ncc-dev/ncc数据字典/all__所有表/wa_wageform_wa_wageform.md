...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12917.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_wa_wageform | pk_wa_wageform | pk_wa_wageform | char(20) | √ |
...
| 10 | ndefaultmny | ndefaultmny | ndefaultmny | number(31, 8) | √ |
| 11 | pk_group | pk_group | pk_group | varchar2(20) | √ |
| 12 | pk_org | pk_org | pk_org | varchar2(20) | √ |
| 13 | vmemo | vmemo | vmemo | varchar2(400) |
