...
**分布式任务实体 (ffw_distributetask / nc.vo.ffw.distributetask.DistributetaskVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2191.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_distributetask | 主键 | pk_distributetask | char(20) | √ | 主键 (UFID) |
