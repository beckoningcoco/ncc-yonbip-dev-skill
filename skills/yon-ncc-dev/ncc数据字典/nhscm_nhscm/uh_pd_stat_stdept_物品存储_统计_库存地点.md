...
**物品存储_统计_库存地点 (uh_pd_stat_stdept / com.yonyou.yh.nhis.scm.uhpd.vo.UhPdStatStdeptVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6159.html
...
| 5 | pk_dept_src | 库存地点_源 | pk_dept_src | varchar(20) |  | 组织_部门 (dept) |
| 6 | pk_dept_dest | 库存部门_目的 | pk_dept_dest | varchar(20) |  | 组织_部门 (dept) |
