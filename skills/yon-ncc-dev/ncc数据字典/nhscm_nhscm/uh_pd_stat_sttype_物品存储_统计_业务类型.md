...
**物品存储_统计_业务类型 (uh_pd_stat_sttype / com.yonyou.yh.nhis.scm.uhpd.vo.UhPdStatSttypeVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6160.html
...
| 4 | dt_sttype | 业务类型 | dt_sttype | varchar(50) |  | 字符串 (String) |
| 5 | yearmonth | 年月 | yearmonth | char(19) |  | 日期 (UFDate) |
| 6 | pk_dept | 库存部门 | pk_dept | varchar(20) |  | 组织_部门 (dept) |
| 7 | pk_pd | 物品 | pk_pd | varchar(20) |  | 物料基本信息（多版本） (material) |
| 8 | amt_i_base | 期间发生数量_入库_基本 | amt_i_base | int |  | 整数 (Integer) |
