...
**组织结构-报表组织体系成员版本信息 (org_reportmanastrumember_v / nc.vo.vorg.ReportManaStruMemberVersionVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4154.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_vid | 成员版本主键 | pk_vid | char(20) | √ | 主键 (UFID) |
| 2 | pk_rmsmember | 报表组织体系成员主键 | pk_rmsmember | char(20) | √ | 组织结构_报表组织体系成员 (reportmanastrumember) |
...
| 6 | pk_fathermember | 上级成员 | pk_fathermember | varchar(20) |  | 组织结构_报表组织体系成员 (reportmanastrumember) |
