...
**关系明细 (bcs_equivalent_body / nc.vo.epm.bcs.equivalent.BCSEquivalentStakeBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/279.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_equivalent_body | 明细主键 | pk_equivalent_body | char(20) | √ | 主键 (UFID) |
...
| 10 | controlinvest | 控制型投资 | controlinvest | varchar(20) |  | 权益投资类型(自定义档案) (Defdoc-BM_INVTYPE) |
...
| 15 | bm_scope | 合并范围 | bm_scope | varchar(50) | √ | 字符串 (String) |
| 16 | equivalentratio | 等效持股比例 | equivalentratio | decimal(28, 8) |  | 数值 (UFDouble) |
| 17 | role | 角色 | role | varchar(50) |  | 字符串 (String) |
| 18 | tradingday_rate | 交易日汇率 | tradingday_rate | decimal(28, 8) |  | 数值 (UFDouble) |
