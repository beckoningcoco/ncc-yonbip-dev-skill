...
**凭证明细 (bcs_vouch_body / nc.vo.bm.vouch.BMVouchBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/289.html
...
| 6 | pk_measure | 合并报表项目 | pk_measure | varchar(20) |  | 字符串 (String) |
...
| 10 | pk_vouchhead | 凭证主键 | pk_vouchhead | varchar(20) |  | 凭证头 (BCSVouchHead) |
| 11 | hbprojectname | 合并报表项目名称 | hbprojectname | varchar(200) |  | 字符串 (String) |
| 12 | pk_formula | 公式PK | pk_formula | varchar(50) |  | 字符串 (String) |
| 13 | balancedebitamount | 差额规则后借方金额 | balancedebitamount | decimal(28, 8) |  | 数值 (UFDouble) |
| 14 | balancecreditamount | 差额规则后贷方金额 | balancecreditamount | decimal(28, 8) |  | 数值 (UFDouble) |