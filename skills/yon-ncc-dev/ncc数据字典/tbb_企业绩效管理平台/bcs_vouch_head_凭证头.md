...
**凭证头 (bcs_vouch_head / nc.vo.bm.vouch.BMVouchHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/290.html
...
| 6 | vouch_type | 凭证类型 | vouch_type | int |  | 凭证类型 (vouchtype) |  | 1=手工录入个别报表调整凭证; |