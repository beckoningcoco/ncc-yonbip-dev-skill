...
**表单 (tb_web_sheet / nc.vo.epm.book.web.WebSheetVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5747.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_sheet | 表单pk(主键) | pk_sheet | char(20) | √ | 主键 (UFID) |
| 2 | pk_workbook | 套表pk | pk_workbook | varchar(20) | √ | 字符串 (String) |
| 3 | sheet_name | 表单名称 | sheet_name | varchar(200) | √ | 字符串 (String) |
| 4 | sort_idx | 排序idx | sort_idx | int | √ | 整数 (Integer) |
| 5 | version | 版本 | version | int | √ | 整数 (Integer) |
