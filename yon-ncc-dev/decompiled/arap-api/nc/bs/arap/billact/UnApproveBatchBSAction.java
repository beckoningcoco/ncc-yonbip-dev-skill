...
public abstract class UnApproveBatchBSAction
extends BillBaseBSAction {
    public AggregatedValueObject[] unapproveVOs(AggregatedValueObject[] pbills) throws BusinessException {
        ...
        SagasUtils.frozenAndAddSaga("unapprove", bills);
        ...
        t1 = System.currentTimeMillis();
        SagasUtils.setCompensateService("unapprove", bills);
    ...
    protected void doAfterFireEvent(AggregatedValueObject[] bills) throws BusinessException {
        EventDispatcher.fireEvent((IBusinessEvent)new BusinessEvent((String)this.tmpMap.get("beanid"), "1022", (Object[])bills));
    }

    protected abstract void doAfterUnApprove(AggregatedValueObject[] var1) throws BusinessException;
    ...
    protected void doBeforeFireEvent(AggregatedValueObject[] bills) throws BusinessException {
        ...
        EventDispatcher.fireEvent((IBusinessEvent)new BusinessEvent((String)this.tmpMap.get("beanid"), "1021", (Object[])bills));
    }

    protected abstract void doBeforeUnApprove(AggregatedValueObject[] var1) throws BusinessException;

    protected abstract AggregatedValueObject[] doUnApprove(AggregatedValueObject[] var1) throws BusinessException;
