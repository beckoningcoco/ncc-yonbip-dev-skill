...
public class AccountIsNullValidator
    ...
    public ValidationFailure validate(Object obj) {
        ...
        for (AggregatedValueObject aggvo : (AggregatedValueObject[])obj) {
            ...
            for (CircularlyAccessibleValueObject vo : this.getChildrenVO()) {
                ...
                if (null == this.getItemAttrValue(vo, "accountid") || ((String)this.getItemAttrValue(vo, "accountid")).trim().length() < 1) {
                    return new ValidationFailure(NCLangRes4VoTransl.getNCLangRes().getStrByID("2006v61020_0", "02006v61020-0060", null, new String[]{String.valueOf(i + 1)}));
                }
                ++i;
            }
        }
