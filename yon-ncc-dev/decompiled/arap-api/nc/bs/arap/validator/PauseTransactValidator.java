...
public class PauseTransactValidator
    ...
    public ValidationFailure validate(Object obj) {
        ...
        for (AggregatedValueObject aggvo : (AggregatedValueObject[])obj) {
            ...
            for (CircularlyAccessibleValueObject vo : this.getChildrenVO()) {
                Object value = this.getItemAttrValue(vo, "pausetransact");
                if (null == value || !((UFBoolean)value).booleanValue()) continue;
                return new ValidationFailure(NCLangRes4VoTransl.getNCLangRes().getStrByID("2006pub_0", "02006pub-0533"));
            }
        }
        return null;
    }
