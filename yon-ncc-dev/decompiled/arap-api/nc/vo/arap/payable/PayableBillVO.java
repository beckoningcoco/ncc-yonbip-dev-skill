...
extends BaseBillVO {
    ...
    private static final String AP_PAYABLEBILL = "ap_payablebill";
    ...
    public static final String ISPUADJUST = "ispuadjust";
    ...
    public PayableBillVO() {
        this.setBillclass("yf");
    }

    public IVOMeta getMetaData() {
        IVOMeta meta = VOMetaFactory.getInstance().getVOMeta("arap.payablebill");
        return meta;
    }
