...
public class ReceivableBillItemVO
extends BaseItemVO {
    ...
    public static final String PK_RECITEM = "pk_recitem";
    ...
    public static final String AR_RECITEM = "ar_recitem";
    ...
    public String getPk_recitem() {
        return this.pk_recitem;
    }

    public void setPk_recitem(String pkRecitem) {
        this.pk_recitem = pkRecitem;
    }
    ...
    public String getParentPK() {
        return this.pk_recbill == null ? (String)this.getAttributeValue(PK_RECBILL) : this.pk_recbill;
    }

    public void setChildrenPK(String pk_recitem) {
        this.pk_recitem = pk_recitem;
    }

    public void setParentPK(String pk_recbill) {
    ...
    public ReceivableBillItemVO() {
        this.setBillclass("ys");
    }

    public IVOMeta getMetaData() {
        IVOMeta meta = VOMetaFactory.getInstance().getVOMeta("arap.recitem");
        return meta;
    }
