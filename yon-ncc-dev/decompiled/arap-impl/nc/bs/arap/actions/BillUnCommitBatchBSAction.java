...
public class BillUnCommitBatchBSAction
extends UpdateBatchBSAction {
    public BillUnCommitBatchBSAction() {
    ...
    public AggregatedValueObject[] updateVOs(AggregatedValueObject[] bills) throws BusinessException {
        ...
        SagasUtils.frozenAndAddSaga("uncommit", bills);
        ...
        t1 = System.currentTimeMillis();
        SagasUtils.setCompensateService("uncommit", bills);
    ...
    protected void doBeforeUpdate(AggregatedValueObject[] bills, AggregatedValueObject[] orginBills) throws BusinessException {
        for (AggregatedValueObject bill : bills) {
            ...
            bill.getParentVO().setAttributeValue("approvestatus", (Object)BillEnumCollection.ApproveStatus.NOSTATE.VALUE);
