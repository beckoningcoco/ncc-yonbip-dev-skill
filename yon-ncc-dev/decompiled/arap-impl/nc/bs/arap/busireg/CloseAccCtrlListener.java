...
import nc.bs.arap.closeacc.CloseAccCtrlBO;
...
public class CloseAccCtrlListener
implements IBusinessListener {
    public void doAction(IBusinessEvent event) throws BusinessException {
        if (!("1001".equals(event.getEventType()) || "1005".equals(event.getEventType()) || "1003".equals(event.getEventType()))) {
            return;
        }
        ...
        new CloseAccCtrlBO().checkIsCloseAcc((AggregatedValueObject)obills[0]);
    }
