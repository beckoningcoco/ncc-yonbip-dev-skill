...
public class OriginOTHERBillValidator
extends AbstractValidator
implements Validator {
    private static final long serialVersionUID = 1L;
    static List<String> top_syscodes = Arrays.asList("3", "4", "16", "19", "7");
    static List<String> special_billtype = Arrays.asList("30", "35", "21", "Z2", "Z3", "Z4", "Z5", "Z1", "4B36", "4A24", "4A18", "4A04", "4A27", "4A49", "4A28", "4A25", "4A23", "4A05", "2201", "5801", "5811", "5720");
    ...
    public ValidationFailure validate(Object obj) {
        ...
        for (AggregatedValueObject aggvo : (AggregatedValueObject[])obj) {
            ...
            if (null == top_billtype || null != top_billtype && special_billtype.contains(top_billtype)) continue;
            ...
            if (((BaseAggVO)aggvo).getIsOtherModuleOriginate().booleanValue() || isflowbill.booleanValue() || srcSyscode.intValue() == BillEnumCollection.FromSystem.AR.VALUE.intValue() || srcSyscode.intValue() == BillEnumCollection.FromSystem.AP.VALUE.intValue() || srcSyscode.intValue() == BillEnumCollection.FromSystem.CMP.VALUE.intValue() || srcSyscode.intValue() == BillEnumCollection.FromSystem.WBJHPT.VALUE.intValue() || srcSyscode.intValue() == BillEnumCollection.FromSystem.XTDJ.VALUE.intValue()) continue;
            ...
            if ("FCT1".equals(top_billtype.toString().trim()) || "FCT2".equals(top_billtype.toString().trim())) continue;
