...
extends N_F0_ACTION {
    ...
    public Object runComClass(PfParameterVO paraVo) throws BusinessException {
        try {
            ...
            Object obj = null;
            this.m_tmpVo = paraVo;
            String actionCode = ArapConstant.EDIT;
            ...
            obj = this.runClass("nc.bs.arap.actions.ReceivableBillEditBatchBSAction", "updateVOs", "&context:nc.vo.pub.AggregatedValueObject[]", paraVo, this.m_keyHas);
            this.doCreditCheck();
            return obj;
        }
        catch (Exception ex) {
