...
public class N_F0_PreCheck_DELETE
implements ICrossServicePrepareFwdBusiCheck {
    public void runComPrepareCheck(PfParameterVO paraVo) throws BusinessException {
        ...
        ((IArapRecBillSagasCheck)NCLocator.getInstance().lookup(IArapRecBillSagasCheck.class)).billDeleteSagasCheck((AggregatedValueObject[])bills);
    }
}
