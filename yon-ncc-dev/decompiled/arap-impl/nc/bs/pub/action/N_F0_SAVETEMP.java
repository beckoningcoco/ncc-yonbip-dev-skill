...
extends AbstractCompiler2 {
    ...
    public Object runComClass(PfParameterVO paraVo) throws BusinessException {
        try {
            ...
            obj = this.runClass("nc.bs.arap.actions.BillTempSaveBatchAction", "insertVOs", "&context:nc.vo.pub.AggregatedValueObject[]", paraVo, this.m_keyHas);
            return obj;
        }
        catch (Exception ex) {
