 ...
 *  nc.vo.arap.prealarm.ArapPayablePrealarmVO
...
import nc.vo.arap.prealarm.ArapPayablePrealarmVO;
...
public class ArapPayablePreAlarmPlugin
extends ArapBasePreAlarmPlugin {
    ...
    protected MemoryResultSet queryAlarmResult(PreAlertContext context) throws BusinessException {
        try {
            return ((IArapPreAlarmCall_RequiresNew)NCLocator.getInstance().lookup(IArapPreAlarmCall_RequiresNew.class)).getPayablePreAlarmResult(context);
        }
    ...
    protected ArapPrealarmDataSource getPrealarmDataSource(MemoryResultSet resultSet) throws SQLException, BusinessException {
        ...
        ArapPayablePrealarmVO recPrealarmVO = null;
        ...
        while (resultSet.next()) {
            ...
            recPrealarmVO = new ArapPayablePrealarmVO();
            i = 0;
            recPrealarmVO.setSupplier(this.getDocNameByPk("720dcc7c-ff19-48f4-b9c5-b90906682f45", row.get(i)));
