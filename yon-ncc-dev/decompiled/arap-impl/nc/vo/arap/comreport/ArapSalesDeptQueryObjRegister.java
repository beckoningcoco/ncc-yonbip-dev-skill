...
public class ArapSalesDeptQueryObjRegister
extends ArapBaseQueryObjRegister {
    private static final long serialVersionUID = 1L;
    public final String QRYOBJ_PK_SODEPT = "qryobj_pk_sodept";

    public ArapSalesDeptQueryObjRegister() {
    ...
    protected void setQueryObjVO(IBean bean, QueryObjVO queryObjVO) {
        ...
        queryObjVO.setQry_objfieldname("so_deptid");
        ...
        queryObjVO.setDsp_objname(NCLangRes4VoTransl.getNCLangRes().getStrByID("arap", "1arap0152"));
        ...
        queryObjVO.setResid("qryobj_pk_sodept");
        queryObjVO.setBillfieldname("so_deptid");
        queryObjVO.setBalfieldname(null);
        queryObjVO.setTallyfieldname(TallyAllVO.getDefaultTableName() + "." + "so_deptid");
    }
}
