...
extends AbstractPrintService {
    public IDataSource[] getDataSources(IPrintInfo info) {
        ...
        AgiotagePrintDetialDatasource apd = new AgiotagePrintDetialDatasource(printinfo.getReportPanelVO());
        dss[0] = apd;
        return dss;
    }
}
