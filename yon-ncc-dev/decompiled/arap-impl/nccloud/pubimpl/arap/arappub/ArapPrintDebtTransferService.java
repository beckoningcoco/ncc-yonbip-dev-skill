...
import nccloud.pubimpl.arap.arappub.ArapDocPrintDebtTransferDatasource;
...
public class ArapPrintDebtTransferService
extends AbstractPrintService {
    public IDataSource[] getDataSources(IPrintInfo info) {
        ...
        ArapDocPrintDebtTransferDatasource ds = new ArapDocPrintDebtTransferDatasource(pkBills, printinfo.getBillType());
        dss[0] = ds;
        return dss;
    }
