...
import nccloud.pubimpl.arap.arappub.ArapDocPrintVerifyMainDatasource;
...
public class ArapPrintVerifyService
extends AbstractPrintService {
    public IDataSource[] getDataSources(IPrintInfo info) {
        ...
        ArapDocPrintVerifyMainDatasource ds = new ArapDocPrintVerifyMainDatasource(pkBills, printinfo.getBillType());
        dss[0] = ds;
        return dss;
    }
