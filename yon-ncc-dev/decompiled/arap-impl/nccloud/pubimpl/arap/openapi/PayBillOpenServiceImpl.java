 ...
 *  nccloud.pubitf.arap.openapi.IPayBillOpenService
 */
...
import nccloud.pubitf.arap.openapi.IPayBillOpenService;

public class PayBillOpenServiceImpl
extends BillOpenServiceImpl
implements IPayBillOpenService {
    @Override
    protected void setHeadInfo(BaseBillVO headvo) throws BusinessException {
        headvo.setPk_billtype("F3");
        headvo.setBillclass("fk");
