 ...
 *  nccloud.pubitf.arap.openapi.IReceiveableVerifyFaOpenService
 */
...
import nccloud.pubitf.arap.openapi.IReceiveableVerifyFaOpenService;

public class ReceiveableVerifyFaOpenServiceImpl
implements IReceiveableVerifyFaOpenService {
    ...
    public Map<String, String> saveFa(VerifyfaVO favo) throws BusinessException {
        ...
        if (!StringUtils.isEmpty((CharSequence)(nameStr = favo.getName()))) {
            favo.setName(nameStr + "+UPP20080305-000019");
        }
        ((IFaControlPrivate)NCLocator.getInstance().lookup(IFaControlPrivate.class)).inserFa(favo);
