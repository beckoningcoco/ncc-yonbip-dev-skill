...
extends TypeAdapter<java.util.Date> {
    ...
    DefaultDateTypeAdapter(Class<? extends java.util.Date> dateType, int style) {
        ...
        if (JavaVersion.isJava9OrLater()) {
            this.dateFormats.add(PreJava9DateFormatProvider.getUSDateFormat((int)style));
        }
    }
    ...
    public DefaultDateTypeAdapter(Class<? extends java.util.Date> dateType, int dateStyle, int timeStyle) {
        ...
        if (JavaVersion.isJava9OrLater()) {
            this.dateFormats.add(PreJava9DateFormatProvider.getUSDateTimeFormat((int)dateStyle, (int)timeStyle));
        }
    }
    ...
    private java.util.Date deserializeToDate(String s) {
        ...
        synchronized (list) {
            ...
            try {
                return ISO8601Utils.parse((String)s, (ParsePosition)new ParsePosition(0));
            }
            catch (ParseException e) {
                throw new JsonSyntaxException(s, (Throwable)e);
            }
        }
    }
