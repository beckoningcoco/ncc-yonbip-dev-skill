...
public class TypeToken<T> {
    ...
    public boolean isAssignableFrom(Type from) {
        ...
        if (this.type instanceof GenericArrayType) {
            return this.rawType.isAssignableFrom(.Gson.Types.getRawType((Type)from)) && TypeToken.isAssignableFrom(from, (GenericArrayType)this.type);
        }
    ...
    private static boolean isAssignableFrom(Type from, ParameterizedType to, Map<String, Type> typeVarMap) {
        ...
        if (ptype != null) {
            ...
            TypeVariable<Class<T>>[] tParams = clazz.getTypeParameters();
    ...
    public final boolean equals(Object o) {
        return o instanceof TypeToken && .Gson.Types.equals((Type)this.type, (Type)((TypeToken)o).type);
    }
    ...
    public static TypeToken<?> getParameterized(Type rawType, Type ... typeArguments) {
        return new TypeToken(.Gson.Types.newParameterizedTypeWithOwner(null, (Type)rawType, (Type[])typeArguments));
    }

    public static TypeToken<?> getArray(Type componentType) {
        return new TypeToken(.Gson.Types.arrayOf((Type)componentType));
    }
}
