...
public class CustcategoryIPassTreeRequest
extends UPCPager
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CustcategoryIPassTreeRequest)) {
            return false;
        }
        CustcategoryIPassTreeRequest other = (CustcategoryIPassTreeRequest)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof CustcategoryIPassTreeRequest;
    }
    ...
    public String toString() {
        return "CustcategoryIPassTreeRequest(name=" + this.getName() + ", code=" + this.getCode() + ", beginTime=" + this.getBeginTime() + ", endTime=" + this.getEndTime() + ")";
    }
}
