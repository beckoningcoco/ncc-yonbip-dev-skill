...
import com.yonyoucloud.iuap.upc.dataauth.DmDeptWithSubAuthRule;
...
@Component
public class DmDeptWithSubCustomerAuthRule
extends DPBaseRule {
    @Autowired
    private DmDeptWithSubAuthRule dmDeptWithSubAuthRule;

    @Override
    protected Set<String> getCustomValues(CustomAuthContent content, String personId) throws Exception {
        Set<String> deptSet = this.dmDeptWithSubAuthRule.getCustomValues(content, personId);
        if (!deptSet.isEmpty()) {
