...
import com.yonyoucloud.iuap.upc.dataauth.DmPtDeptWithSubAuthRule;
...
@Component
public class DmPtDeptWithSubCustomerAuthRule
extends DPBaseRule {
    @Autowired
    private DmPtDeptWithSubAuthRule dmPtDeptWithSubAuthRule;

    @Override
    protected Set<String> getCustomValues(CustomAuthContent content, String personId) throws Exception {
        Set<String> deptSet = this.dmPtDeptWithSubAuthRule.getCustomValues(content, personId);
        if (!deptSet.isEmpty()) {
