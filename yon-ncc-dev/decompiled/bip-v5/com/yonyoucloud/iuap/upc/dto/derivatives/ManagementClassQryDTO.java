...
public class ManagementClassQryDTO
extends BaseQueryVO
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ManagementClassQryDTO)) {
            return false;
        }
        ManagementClassQryDTO other = (ManagementClassQryDTO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ManagementClassQryDTO;
    }
    ...
    public String toString() {
        return "ManagementClassQryDTO(id=" + this.getId() + ", code=" + this.getCode() + ", name=" + this.getName() + ", parent=" + this.getParent() + ", orgId=" + this.getOrgId() + ", orgCode=" + this.getOrgCode() + ", beganTime=" + this.getBeganTime() + ")";
    }
}
