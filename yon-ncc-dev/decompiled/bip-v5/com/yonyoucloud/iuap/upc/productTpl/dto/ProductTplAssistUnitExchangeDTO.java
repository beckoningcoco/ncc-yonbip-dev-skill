...
public class ProductTplAssistUnitExchangeDTO {
    ...
    public String toString() {
        return "ProductTplAssistUnitExchangeDTO(unitExchangeType=" + this.getUnitExchangeType() + ", assistUnitCount=" + this.getAssistUnitCount() + ", assistUnit=" + this.getAssistUnit() + ", assistUnitName=" + this.getAssistUnitName() + ", mainUnitCount=" + this.getMainUnitCount() + ", order=" + this.getOrder() + ")";
    }
}
