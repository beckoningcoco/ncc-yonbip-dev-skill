...
public class SkuPropCTCharacterDTO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SkuPropCTCharacterDTO)) {
            return false;
        }
        SkuPropCTCharacterDTO other = (SkuPropCTCharacterDTO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SkuPropCTCharacterDTO;
    }
    ...
    public String toString() {
        return "SkuPropCTCharacterDTO(characteristics=" + this.getCharacteristics() + ", characteristicsType=" + this.getCharacteristicsType() + ", characteristicsName=" + this.getCharacteristicsName() + ", characterCode=" + this.getCharacterCode() + ", dataType=" + this.getDataType() + ", iOrder=" + this.getIOrder() + ", characterName=" + this.getCharacterName() + ")";
    }
}
