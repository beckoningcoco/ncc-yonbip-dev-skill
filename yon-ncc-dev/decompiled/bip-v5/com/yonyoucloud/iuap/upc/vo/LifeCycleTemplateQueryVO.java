...
public class LifeCycleTemplateQueryVO {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LifeCycleTemplateQueryVO)) {
            return false;
        }
        LifeCycleTemplateQueryVO other = (LifeCycleTemplateQueryVO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LifeCycleTemplateQueryVO;
    }
    ...
    public String toString() {
        return "LifeCycleTemplateQueryVO(id=" + this.getId() + ", idList=" + this.getIdList() + ", code=" + this.getCode() + ", codeList=" + this.getCodeList() + ", systemFlag=" + this.getSystemFlag() + ")";
    }
}
