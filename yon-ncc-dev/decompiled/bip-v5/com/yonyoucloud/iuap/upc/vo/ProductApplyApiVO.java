...
import com.yonyoucloud.iuap.upc.vo.ProductOpenApiVO;
import java.io.Serializable;
import java.util.Date;
import java.util.Map;

@JsonInclude(value=JsonInclude.Include.NON_NULL)
public class ProductApplyApiVO
...
implements Serializable {
    ...
    private ProductOpenApiVO productData;
    private String code;
    private String name;
    ...
    public ProductOpenApiVO getProductData() {
    ...
    public void setProductData(ProductOpenApiVO productData) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProductApplyApiVO)) {
            return false;
        }
        ProductApplyApiVO other = (ProductApplyApiVO)o;
        ...
        ProductOpenApiVO this$productData = this.getProductData();
        ProductOpenApiVO other$productData = other.getProductData();
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ProductApplyApiVO;
    }
    ...
    public int hashCode() {
        ...
        ProductOpenApiVO $productData = this.getProductData();
