...
@Component(value="filterAreaClassRule")
public class FilterAreaClassRule
extends AbstractCommonRule {
    public RuleExecuteResult execute(BillContext billContext, Map<String, Object> paramMap) throws Exception {
        ...
        FilterVO treeFilterVO = billDataDto.getTreeCondition();
        treeFilterVO = (FilterVO)UiMetaDaoHelper.appendCondition((Object)treeFilterVO, (String)"stopstatus", (String)"eq", (Object)0);
