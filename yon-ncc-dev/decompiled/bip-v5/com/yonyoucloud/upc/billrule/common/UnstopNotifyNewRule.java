...
@Component(value="unstopNotifyNewRule")
public class UnstopNotifyNewRule
extends AbstractCommonRule {
    private static final Logger log = LoggerFactory.getLogger(UnstopNotifyNewRule.class);
    @Autowired
    ...
    public RuleExecuteResult execute(BillContext billContext, Map<String, Object> map) throws Exception {
        ...
        if (clss != null && clss.size() > 0) {
            ...
            String eventType = EventType.find(billnum, "unstop", null).toString();
            businessObject.put("id", ((BizObject)clss.get(0)).get("id"));
            try {
                this.eventService2.sendEvent("YXYBASEDOC", eventType, businessObject);
            }
            catch (Exception e) {
                log.error(InternationalUtils.getMessageWithDefault((String)"UID:P_COREDOC-BE_179F628604080214", (String)"\u542f\u7528\u65f6\u53d1\u9001\u4e8b\u4ef6\u5931\u8d25") + e.getMessage(), (Throwable)e);
            }
        }
        return new RuleExecuteResult();
    }
