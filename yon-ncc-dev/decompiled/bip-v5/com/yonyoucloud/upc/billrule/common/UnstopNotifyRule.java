...
@Component(value="unstopNotifyRule")
public class UnstopNotifyRule
extends AbstractCommonRule {
    private static final Logger log = LoggerFactory.getLogger(UnstopNotifyRule.class);
    @Autowired
    ...
    public RuleExecuteResult execute(BillContext billContext, Map<String, Object> map) throws Exception {
        ...
        if ("aa_merchant".equals(billContext.getBillnum()) || "aa_merchantlist".equals(billContext.getBillnum()) || "voucher_agentrelationlist".equals(billContext.getBillnum()) || "voucher_aa_agentrelationlist".equals(billContext.getBillnum())) {
            for (BizObject cls : clss) {
                ...
                if (!"unstop".equals(billContext.getAction()) && !"enable".equals(billContext.getAction())) continue;
                businessObject.put("fullname", billContext.getFullname());
                try {
                    this.eventService2.sendEvent("YXYBASEDOC", "UNSTOP_NOTIFY", businessObject);
                }
                catch (Exception e) {
                    log.error(InternationalUtils.getMessageWithDefault((String)"UID:P_COREDOC-BE_179F628604080C4E", (String)"\u53d1\u9001\u4e8b\u4ef6\u5931\u8d25") + e.getMessage(), (Throwable)e);
                }
            }
