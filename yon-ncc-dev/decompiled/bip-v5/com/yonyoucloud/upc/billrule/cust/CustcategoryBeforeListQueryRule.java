...
@Component(value="custcategoryBeforeListQueryRule")
public class CustcategoryBeforeListQueryRule
extends AbstractCommonRule {
    ...
    public RuleExecuteResult execute(BillContext billContext, Map<String, Object> paramMap) throws Exception {
        ...
        if ("aa_custcategorylist".equals(billContext.getBillnum()) && this.pubOptionService.getOrgGlobalShare("aa.custcategory.CustCategory").booleanValue() && (billDataDto = (BillDataDto)this.getParam(paramMap)) != null && billDataDto.getCondition() != null && (vos = billDataDto.getCondition().getCommonVOs()) != null) {
            ArrayList<FilterCommonVO> newVOs = new ArrayList<FilterCommonVO>();
            for (FilterCommonVO vo : vos) {
                if ("custCategoryApplyRanges_orgId".equalsIgnoreCase(vo.getItemName())) continue;
                newVOs.add(vo);
            }
