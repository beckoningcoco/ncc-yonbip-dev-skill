...
@Component(value="merchantDisableRule")
public class MerchantDisableRule
            ...
            try {
                for (BizObject bill : bills) {
                    ...
                    if ((bill.get("isCreator") == null || Boolean.valueOf(bill.get("isCreator").toString()).booleanValue()) && channelOperateCenter != null && defaultOpen.equals(channelOperateCenter.toString())) {
                        this.merchantService.incrUnionKeyCheckLicense(bill, false);
                        ++checkLicenseSum;
                    }
                    ...
                    this.merchantGroupService.disableMerchantApplyRangeGroup(merchantId, merchantApplyRangeId);
                }
            }
            catch (Exception e) {
                for (int j = 0; j < checkLicenseSum; ++j) {
                    ...
                    this.merchantService.decrUnionKeyCheckLicense((BizObject)bills.get(j), false);
                }
