...
@Component(value="merchantRefManagementEventBean")
public class MerchantRefManagementEventBean
implements IRefEvent {
    ...
    public void beforeGridData(RefEntity refEntity, Map<String, Object> map) {
        this.merchantCommonRefQueryService.merchantRefManagementCondition(refEntity, map);
    }
