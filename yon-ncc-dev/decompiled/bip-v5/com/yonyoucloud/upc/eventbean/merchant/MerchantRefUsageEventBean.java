...
@Component(value="merchantRefUsageEventBean")
public class MerchantRefUsageEventBean
implements IRefEvent {
    ...
    public void beforeGridData(RefEntity refEntity, Map<String, Object> map) {
        this.merchantCommonRefQueryService.merchantRefUsageCondition(refEntity, map);
    }
