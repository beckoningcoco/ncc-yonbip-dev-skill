...
@Component(value="merchantSaleAreaDeleteRefEventBean")
public class MerchantSaleAreaDeleteRefEventBean
implements IRefEvent {
    ...
    public void beforeGridData(RefEntity refEntity, Map<String, Object> map) {
        this.merchantCommonRefQueryService.merchantSaleAreaCondition(refEntity, map);
    }
