...
public class KafkaMQSkuProducer
implements IMQProducer {
    private static final Logger log = LoggerFactory.getLogger(KafkaMQSkuProducer.class);
    @Autowired
    ...
    public void registerTask(AsyncTask task) {
        try {
            this.sendMessage(this.kafkaTopicService.getSkuSyncTopic(), gson.toJson((Object)task));
        }
        catch (Exception e) {
            log.error(InternationalUtils.getMessageWithDefault((String)"UID:P_COREDOC-BE_179F6286040809BA", (String)"\u53d1\u9001\u6570\u636e\u51fa\u9519") + e.getMessage(), (Throwable)e);
            throw e;
        }
    }
