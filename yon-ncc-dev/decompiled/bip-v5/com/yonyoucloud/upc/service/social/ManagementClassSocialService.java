...
@Component(value="distributehandlerpc.cls.ManagementClass")
public class ManagementClassSocialService
        ...
        if (!CollectionUtils.isEmpty((Collection)distributes)) {
            ...
            distributes.forEach(data -> {
                ...
                if (isSingleOrg != null && defaultOpenApp.equals(isSingleOrg.toString())) {
                    List result = (List)RobotExecutors.runAs((String)desYTenantId, () -> this.iServiceIsolateService.findMainOrgPermission(AppContext.getCurrentUser().getYhtUserId(), "pc_managementclass", AppContext.getCurrentUser().getYhtTenantId()));
                ...
                if (existData != null) {
                    ...
                    SocialUntil.setManagementClassApplyRange((ManagementClass)data);
                }
