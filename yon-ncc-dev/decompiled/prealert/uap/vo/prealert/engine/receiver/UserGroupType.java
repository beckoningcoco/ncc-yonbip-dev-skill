...
extends AbstractNCReceiverType {
    ...
    public String getName() {
        return NCLangRes4VoTransl.getNCLangRes().getStrByID("prealertnc", "UserGroupType-000");
    }
    ...
    public String[] getActualReceiver(String pk_receiver) throws BusinessException {
        ...
        UserVO[] uvos = srv.queryUsersRelateInUserGroupsForAlert(new String[]{pk_receiver}, true);
        if (uvos != null) {
