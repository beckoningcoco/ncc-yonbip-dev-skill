...
**组织结构_业务汇报关系 (org_busireportstru / nc.vo.corg.BusiReportStruVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4022.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_busireportstru | 业务汇报关系主键 | pk_busireportstru | char(20) | √ | 主键 (UFID) |
