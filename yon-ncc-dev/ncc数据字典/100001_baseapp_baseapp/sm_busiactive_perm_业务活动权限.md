...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5289.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_busiactive_perm | 主键 | pk_busiactive_perm | char(20) | √ | 主键 (UFID) |
...
| 6 | subjecttype | 主体类型 | subjecttype | int |  | 业务活动主体 (busiactivepermenum) |  | 0=功能节点; |