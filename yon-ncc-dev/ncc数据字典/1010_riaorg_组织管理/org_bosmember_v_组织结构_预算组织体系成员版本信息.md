...
**组织结构_预算组织体系成员版本信息 (org_bosmember_v / nc.vo.vorg.BudgetOrgStruMemberVersionVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4014.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_vid | 成员版本主键 | pk_vid | char(20) | √ | 主键 (UFID) |
| 2 | pk_bosmember | 预算组织体系成员主键 | pk_bosmember | char(0) | √ | 组织结构_预算组织体系成员 (budgetorgstrumember) |
