...
**组织结构_资金管理体系版本信息 (org_fms_v / nc.vo.vorg.FundManaSystemVersionVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4065.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_vid | 版本主键 | pk_vid | char(20) | √ | 主键 (UFID) |
| 2 | pk_fundmanasystem | 资金管理体系主键 | pk_fundmanasystem | char(0) | √ | 组织结构_资金管理体系 (fundmanasystem) |
