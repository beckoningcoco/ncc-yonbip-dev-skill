...
**医疗记录格式类型(自定义档案) (bd_defdoc / nc.vo.bd.defdoc.DefdocVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/639.html
...
| 9 | pid | 上级档案 | pid | varchar(20) |  | 医疗记录格式类型(自定义档案) (Defdoc-060310) |
