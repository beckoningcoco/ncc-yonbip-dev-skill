...
**发票类型(自定义档案) (bd_defdoc / nc.vo.bd.defdoc.DefdocVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/563.html
...
| 9 | pid | 上级档案 | pid | varchar(20) |  | 发票类型(自定义档案) (Defdoc-ER_00001) |
