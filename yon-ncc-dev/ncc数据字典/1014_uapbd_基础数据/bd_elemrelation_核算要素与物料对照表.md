...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/810.html
...
| 7 | marbasclassid | 物料基本分类 | marbasclassid | varchar(20) |  | 物料基本分类 (marbasclass) |
...
| 10 | cmaterialvid | 物料版本 | cmaterialvid | varchar(20) |  | 物料基本信息 (material_v) |
| 11 | cenabletime | 有效时间 | cenabletime | varchar(50) |  | 字符串 (String) |
| 12 | modifier | 修改人 | modifier | varchar(20) |  | 用户 (user) |
| 13 | modifiedtime | 修改时间 | modifiedtime | varchar(19) |  | 日期时间 (UFDateTime) |
