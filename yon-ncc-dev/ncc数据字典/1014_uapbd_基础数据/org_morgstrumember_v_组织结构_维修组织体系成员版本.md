...
**组织结构_维修组织体系成员版本 (org_morgstrumember_v / nc.vo.ambd.morgstru.MaintainOrgStruMemberVersionVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4102.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_vid | 成员版本主键 | pk_vid | char(20) | √ | 主键 (UFID) |
| 2 | pk_morgstrumember | 维修组织体系成员主键 | pk_morgstrumember | varchar(20) |  | 组织结构_维修组织体系成员 (maintainorgstrumember) |
| 3 | pk_morgstru | 维修组织体系主键 | pk_morgstru | varchar(20) |  | 组织结构_维修组织体系 (maintainorgstru) |
| 4 | pk_org | 对应组织 | pk_org | varchar(20) |  | 组织 (org) |
| 5 | pk_fatherorg | 上级组织 | pk_fatherorg | varchar(20) |  | 组织 (org) |
| 6 | pk_fathermember | 上级成员 | pk_fathermember | varchar(20) |  | 组织结构_维修组织体系成员版本 (maintainorgstrumember_v) |
| 7 | innercode | 内部编码 | innercode | varchar(50) |  | 字符串 (String) |
| 8 | virtualorg | 虚组织 | virtualorg | char(1) |  | 布尔类型 (UFBoolean) |
| 9 | pk_entityorg | 对应实体组织 | pk_entityorg | varchar(20) |  | 组织_业务单元_维修组织 (maintainorg) |
| 10 | plan_flag | 编制计划 | plan_flag | char(1) |  | 布尔类型 (UFBoolean) |
| 11 | pk_user | 负责用户 | pk_user | varchar(20) |  | 用户 (user) |
| 12 | pk_role | 负责角色 | pk_role | varchar(20) |  | 角色 (Role) |
