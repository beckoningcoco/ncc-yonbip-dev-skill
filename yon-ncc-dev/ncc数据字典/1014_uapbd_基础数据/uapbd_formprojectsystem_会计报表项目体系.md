...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5856.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_formprojectsystem | 会计报表项目体系主键 | pk_formprojectsystem | char(20) | √ | 主键 (UFID) |
...
| 9 | pk_accchart | 科目表 | pk_accchart | varchar(20) | √ | 科目表 (accchart) |
