...
**已完成报账单 (sscrp_bill_done / nc.vo.sscrp.rpbill.RPBillVODone)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5607.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_bill | 主键 | pk_bill | char(20) | √ | 主键 (UFID) |
| 2 | busiid | 来源单据主键 | busiid | varchar(50) |  | 字符串 (String) |
