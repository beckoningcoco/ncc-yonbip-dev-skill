...
**报账单明细 (sscrp_detail / nc.vo.sscrp.rpbill.RPDetailVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5613.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_detail | 主键 | pk_detail | varchar(50) | √ | 主键 (UFID) |
| 2 | pk_bill | 报账单主键 | pk_bill | char(20) |  | 主键 (UFID) |
