...
**组织_业务单元_物流组织 (org_trafficorg / nc.vo.org.TrafficOrgVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4181.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_trafficorg | 主键 | pk_trafficorg | char(20) | √ | 主键 (UFID) |
