...
**语义模型 (bi_smart_def / nc.vo.smart.SmartDefVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1209.html
...
| 6 | dsname | 数据源 | dsname | varchar(36) |  | 数据源 (datasource) |
