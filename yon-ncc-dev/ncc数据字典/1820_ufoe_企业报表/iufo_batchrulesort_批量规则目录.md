...
**批量规则目录 (iufo_batchrulesort / nc.vo.iufo.batchrule.BatchRuleSortVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3399.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_batchrulesort | 目录主键 | pk_batchrulesort | char(20) | √ | 主键 (UFID) |
| 2 | name | 目录名称 | name | varchar(50) |  | 字符串 (String) |
| 3 | pk_parent | 父目录 | pk_parent | varchar(20) |  | 批量规则目录 (batchrulesort) |
