...
**指标订阅规则分类 (iufo_measubscribesort / nc.vo.iufo.measubscribe.MeaSubscribeSortVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3479.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_measubssort | 分类主键 | pk_measubssort | char(20) | √ | 主键 (UFID) |
| 2 | name | 分类名称 | name | varchar(50) |  | 字符串 (String) |
| 3 | pk_parent | 上级分类 | pk_parent | varchar(20) |  | 指标订阅规则分类 (measubscribesort) |
