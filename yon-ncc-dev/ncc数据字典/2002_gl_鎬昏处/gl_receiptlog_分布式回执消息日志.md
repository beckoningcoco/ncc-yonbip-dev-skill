...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2450.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_receiptlog | 回执消息主键 | pk_receiptlog | char(20) | √ | 主键 (UFID) |
...
| 7 | transdata | 传输资源 | transdata | varchar(1) |  | 传输资源 (transtype) |  | 1=期初凭证; |