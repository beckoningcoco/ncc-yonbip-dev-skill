...
**合同大事记 (fct_ap_memora / nc.vo.fct.ap.entity.CtApMemoraVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2169.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_fct_ap_memora | 大事记主键 | pk_fct_ap_memora | char(20) | √ | 主键 (UFID) |
