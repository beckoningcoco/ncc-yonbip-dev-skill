...
**收款计划 (fct_ar_plan / nc.vo.fct.ar.entity.CtArPlanVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2177.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_fct_ar_plan | 收款计划主键 | pk_fct_ar_plan | char(20) | √ | 主键 (UFID) |
...
| 7 | pk_incomeperiod | 起效依据 | pk_incomeperiod | varchar(20) |  | 收款时点 (incomeperiod) |
...
| 15 | balancemoney | 累计原币收款金额 | balancemoney | decimal(28, 8) |  | 数值 (UFDouble) |
| 16 | receivetype | 预收款 | receivetype | char(1) |  | 布尔类型 (UFBoolean) |
| 17 | moneytype | 质保金 | moneytype | char(1) |  | 布尔类型 (UFBoolean) |
| 18 | reymontype | 收款类型 | reymontype | varchar(20) |  | 收付款类型 (recpaytype) |
...
| 21 | norikpmny | 累计原币开票金额 | norikpmny | decimal(28, 8) |  | 数值 (UFDouble) |
| 22 | balancemoneyorg | 累计本币收款金额 | balancemoneyorg | decimal(28, 8) |  | 数值 (UFDouble) |
| 23 | unconfpaymentori | 未确认原币收款金额 | unconfpaymentori | decimal(28, 8) |  | 数值 (UFDouble) |
| 24 | unconfpaymentorg | 未确认本币收款金额 | unconfpaymentorg | decimal(28, 8) |  | 数值 (UFDouble) |
