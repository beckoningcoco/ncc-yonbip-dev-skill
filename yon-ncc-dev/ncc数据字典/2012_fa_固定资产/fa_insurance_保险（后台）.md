...
**保险（后台） (fa_insurance / nc.vo.fa.assetcard.InsuranceVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2028.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_insurance | 主键 | pk_insurance | char(20) | √ | 主键 (UFID) |
| 2 | bill_code | 保险单号 | bill_code | varchar(40) |  | 字符串 (String) |
| 3 | corp | 保险公司 | corp | varchar(20) |  | 组织_业务单元_公司 (corp) |
| 4 | type | 保险类型 | type | varchar(40) |  | 字符串 (String) |
