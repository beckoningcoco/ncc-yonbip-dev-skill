...
**租金 (fa_rentview / nc.vo.fa.asset.RentViewVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2060.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_rent | 主键 | pk_rent | char(20) | √ | 主键 (UFID) |
| 2 | undertaker | 承租方 | undertaker | varchar(80) |  | 字符串 (String) |
| 3 | area | 出租面积 | area | decimal(28, 8) |  | 数值 (UFDouble) |
| 4 | term_date | 合同期限 | term_date | char(19) |  | 日期 (UFDate) |
| 5 | rent_date | 规定交租日 | rent_date | char(19) |  | 日期 (UFDate) |
| 6 | month_rent | 月租金 | month_rent | decimal(28, 8) |  | 金额 (UFMoney) |
| 7 | total_rent | 租金总额 | total_rent | decimal(28, 8) |  | 金额 (UFMoney) |
| 8 | fact_date | 实际交租日 | fact_date | char(19) |  | 日期 (UFDate) |
| 9 | reside_period | 租金所属期间 | reside_period | varchar(80) |  | 字符串 (String) |
