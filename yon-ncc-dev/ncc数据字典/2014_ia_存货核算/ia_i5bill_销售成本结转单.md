...
**销售成本结转单 (ia_i5bill / nc.vo.ia.mi5.entity.I5HeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2820.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbillid | 销售成本结转单 | cbillid | char(20) | √ | 主键 (UFID) |
...
| 15 | ccustomerid | 开票客户 | ccustomerid | varchar(20) |  | 客户基本信息 (customer) |
| 16 | fintransitflag | 发出商品标志 | fintransitflag | int |  | 发出商品标志 (intransit) |  | -1=非发出商品; |