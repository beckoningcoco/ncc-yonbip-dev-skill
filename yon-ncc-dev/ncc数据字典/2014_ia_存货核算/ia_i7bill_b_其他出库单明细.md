...
**其他出库单明细 (ia_i7bill_b / nc.vo.ia.mi7.entity.I7ItemVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2825.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbill_bid | 其他出库单明细 | cbill_bid | char(20) | √ | 主键 (UFID) |
...
| 29 | cworkcenterid | 工作中心 | cworkcenterid | varchar(20) |  | 工作中心 (bd_wk) |
| 30 | ccostcenterid | 成本中心 | ccostcenterid | varchar(20) |  | 成本中心 (resacostcenter) |
| 31 | cprofitcenterid | 利润中心 | cprofitcenterid | varchar(20) |  | 利润中心 (profitcenter) |
| 32 | cprofitcentervid | 利润中心版本 | cprofitcentervid | varchar(20) |  | 利润中心版本 (profitcenterVersion) |
...
| 40 | cfirstid | 源头单据主键 | cfirstid | varchar(20) |  | 字符串 (String) |
| 41 | cfirstbid | 源头单据分录主键 | cfirstbid | varchar(20) |  | 字符串 (String) |
...
| 48 | csrcbid | 来源单据分录主键 | csrcbid | varchar(20) |  | 字符串 (String) |
