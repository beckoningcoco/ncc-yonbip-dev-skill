...
**报废单明细 (ia_i8bill_b / nc.vo.ia.mi8.entity.I8ItemVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2827.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbill_bid | 报废单明细 | cbill_bid | char(20) | √ | 主键 (UFID) |
...
| 28 | cworkcenterid | 工作中心 | cworkcenterid | varchar(20) |  | 工作中心 (bd_wk) |
| 29 | ccostcenterid | 成本中心 | ccostcenterid | varchar(20) |  | 成本中心 (resacostcenter) |
...
| 52 | caccountperiod | 会计期间 | caccountperiod | char(7) |  | 主键 (UFID) |
