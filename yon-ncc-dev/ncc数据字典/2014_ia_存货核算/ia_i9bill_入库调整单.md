...
**入库调整单 (ia_i9bill / nc.vo.ia.mi9.entity.I9HeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2828.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbillid | 入库调整单 | cbillid | char(20) | √ | 主键 (UFID) |
...
| 15 | cotherstockorgvid | 对方库存组织最新版本 | cotherstockorgvid | varchar(20) |  | 组织_业务单元_库存组织 (stockorg) |
| 16 | cotherstockorgid | 对方库存组织 | cotherstockorgid | varchar(20) |  | 组织_业务单元_库存组织版本信息 (stockorg_v) |
...
| 25 | cotherstordocid | 对方仓库主键 | cotherstordocid | varchar(20) |  | 仓库 (stordoc) |
| 26 | ctrantypeid | 出入库类型 | ctrantypeid | varchar(20) |  | 单据类型 (BilltypeVO) |
| 27 | bestimateflag | 暂估标记 | bestimateflag | char(1) |  | 布尔类型 (UFBoolean) |
