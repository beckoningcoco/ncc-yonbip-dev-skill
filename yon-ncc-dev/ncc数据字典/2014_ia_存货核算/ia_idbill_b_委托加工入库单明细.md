...
**委托加工入库单明细 (ia_idbill_b / nc.vo.ia.mid.entity.IDItemVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2836.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbill_bid | 委托加工入库单明细 | cbill_bid | char(20) | √ | 主键 (UFID) |
...
| 31 | vfirsttrantype | 源头交易类型 | vfirsttrantype | varchar(20) |  | 单据类型 (BilltypeVO) |
| 32 | vfirstcode | 源头单据号 | vfirstcode | varchar(40) |  | 字符串 (String) |
| 33 | cfirstid | 源头单据 | cfirstid | varchar(20) |  | 字符串 (String) |
| 34 | cfirstbid | 源头单据分录 | cfirstbid | varchar(20) |  | 字符串 (String) |
| 35 | vfirstrowno | 源头单据行号 | vfirstrowno | varchar(20) |  | 字符串 (String) |
| 36 | vsrctype | 来源单据类型 | vsrctype | varchar(20) |  | 单据类型 (BilltypeVO) |
| 37 | vsrctrantype | 来源交易类型 | vsrctrantype | varchar(20) |  | 单据类型 (BilltypeVO) |
| 38 | vsrccode | 来源单据号 | vsrccode | varchar(40) |  | 字符串 (String) |
| 39 | csrcid | 来源单据 | csrcid | varchar(20) |  | 字符串 (String) |
| 40 | vsrcrowno | 来源单据行号 | vsrcrowno | varchar(20) |  | 字符串 (String) |
| 41 | csrcbid | 来源单据分录 | csrcbid | varchar(20) |  | 字符串 (String) |
| 42 | cicitemid | 库存子表 | cicitemid | varchar(20) |  | 字符串 (String) |
| 43 | pk_group | 所属集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 44 | pk_book | 所属账簿 | pk_book | varchar(20) |  | 账簿_核算账簿 (accbook) |
| 45 | pk_org | 成本域 | pk_org | varchar(20) |  | 组织_成本域 (costregion) |
| 46 | caccountperiod | 会计期间 | caccountperiod | varchar(50) |  | 字符串 (String) |
| 47 | dbilldate | 单据日期 | dbilldate | char(19) |  | 日期 (UFDate) |
| 48 | ccalcthreadid | 计算线索 | ccalcthreadid | varchar(20) |  | 字符串 (String) |
| 49 | ccalcid | 计算关系 | ccalcid | varchar(20) |  | 字符串 (String) |
| 50 | fcalcbizflag | 计算关系的业务类型 | fcalcbizflag | int |  | 计算业务类型 (calcbiztype) |  | 1=普通计算类型; |