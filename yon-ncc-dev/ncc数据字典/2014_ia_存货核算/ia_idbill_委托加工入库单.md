...
**委托加工入库单 (ia_idbill / nc.vo.ia.mid.entity.IDHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2835.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbillid | 委托加工入库单 | cbillid | char(20) | √ | 主键 (UFID) |
...
| 16 | cbiztypeid | 业务类型 | cbiztypeid | varchar(20) |  | 业务流程 (BusitypeVO) |
| 17 | bestimateflag | 暂估标志 | bestimateflag | char(1) |  | 布尔类型 (UFBoolean) |
