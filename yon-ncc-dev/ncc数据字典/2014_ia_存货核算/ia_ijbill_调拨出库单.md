...
**调拨出库单 (ia_ijbill / nc.vo.ia.mij.entity.IJHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2845.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbillid | 调拨出库单 | cbillid | char(20) | √ | 主键 (UFID) |
...
| 15 | cotherstockorgid | 调入库存组织 | cotherstockorgid | varchar(20) |  | 组织_业务单元_库存组织 (stockorg) |
| 16 | cotherstockorgvid | 调入库存组织最新版本 | cotherstockorgvid | varchar(20) |  | 组织_业务单元_库存组织版本信息 (stockorg_v) |
