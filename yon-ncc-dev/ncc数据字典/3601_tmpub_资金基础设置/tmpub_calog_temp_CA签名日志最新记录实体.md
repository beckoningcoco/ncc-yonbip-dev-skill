...
**CA签名日志最新记录实体 (tmpub_calog_temp / nc.vo.tmpub.security.log.CaLogTmpVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5755.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_calogtmp | 标识 | pk_calogtmp | char(20) | √ | 主键 (UFID) |
| 2 | billtype | 单据类型或者交易类型 | billtype | varchar(20) |  | 字符串 (String) |
...
| 12 | islast | 是否最新 | islast | char(1) |  | 布尔类型 (UFBoolean) |
| 13 | vuserdef1 | 自定义项1 | vuserdef1 | varchar(100) |  | 字符串 (String) |
| 14 | vuserdef2 | 自定义项2 | vuserdef2 | varchar(100) |  | 字符串 (String) |
| 15 | vuserdef3 | 自定义项3 | vuserdef3 | varchar(100) |  | 字符串 (String) |