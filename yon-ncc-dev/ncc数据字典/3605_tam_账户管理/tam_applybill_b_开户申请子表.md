...
**开户申请子表 (tam_applybill_b / nc.vo.tam.account.apply.ApplyBillSubVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5677.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_applychild | 开户申请子表主键 | pk_applychild | char(20) | √ | 主键 (UFID) |
