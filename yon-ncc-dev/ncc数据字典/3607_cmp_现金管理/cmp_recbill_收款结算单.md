...
**收款结算单 (cmp_recbill / nc.vo.cmp.bill.RecBillVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1576.html
...
| 7 | trade_type | 收款交易类型编码 | trade_type | varchar(50) |  | 字符串 (String) |
