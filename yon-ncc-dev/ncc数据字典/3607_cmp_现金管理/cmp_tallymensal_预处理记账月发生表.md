...
**预处理记账月发生表 (cmp_tallymensal / nc.vocmp.tallymensal)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1589.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_tallymensal | 记账月发生表主键 | pk_tallymensal | char(20) | √ | 主键 (UFID) |
...
| 5 | fundformcode | 资金形态 | fundformcode | int |  | 整数 (Integer) |
