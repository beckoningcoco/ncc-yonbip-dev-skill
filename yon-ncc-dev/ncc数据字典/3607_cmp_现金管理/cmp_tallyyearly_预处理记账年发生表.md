...
**预处理记账年发生表 (cmp_tallyyearly / nc.vocmp.cmp_tallyyearly.cmp_tallyyearly)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1590.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_tallyyearly | 记账年发生表主键 | pk_tallyyearly | varchar(20) | √ | 字符串 (String) |
