...
**票据池下载设置表体 (obm_ebankbillpooldownload_b / nc.vo.obm.ebankbillpooldownload.EbankbillpooldownloadBVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3918.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_ebankpooldownload_b | 主键 | pk_ebankpooldownload_b | char(20) | √ | 主键 (UFID) |
| 2 | pk_banktype | 银行类别 | pk_banktype | varchar(20) |  | 银行类别 (banktype) |
| 3 | pk_currtype | 币种 | pk_currtype | varchar(20) |  | 币种 (currtype) |
| 4 | rowno | 行号 | rowno | varchar(50) |  | 字符串 (String) |
| 5 | xzrc | 下载入池 | xzrc | char(1) |  | 布尔类型 (UFBoolean) |
| 6 | xztq | 下载提取 | xztq | char(1) |  | 布尔类型 (UFBoolean) |
| 7 | xzbs | 下载背书 | xzbs | char(1) |  | 布尔类型 (UFBoolean) |
| 8 | xzzy | 下载质押及解除质押 | xzzy | char(1) |  | 布尔类型 (UFBoolean) |
| 9 | xzts | 下载托收 | xzts | char(1) |  | 布尔类型 (UFBoolean) |
| 10 | xztx | 下载贴现 | xztx | char(1) |  | 布尔类型 (UFBoolean) |
| 11 | xzhd | 下载回单 | xzhd | char(1) |  | 布尔类型 (UFBoolean) |
| 12 | xzed | 下载票据池额度 | xzed | char(1) |  | 布尔类型 (UFBoolean) |
