...
**计划明细(批量model) (ps_plandetail / nc.vo.ps.plan.PlandetailBatchVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4686.html
...
| 11 | applydate | 申请付款日期 | applydate | char(19) |  | 日期(结束) (UFDateEnd) |
| 12 | pk_applyperiod | 申请付款期间 | pk_applyperiod | varchar(20) |  | 计划期间 (period) |
| 13 | pk_fundtype | 资金类型 | pk_fundtype | varchar(20) |  | 资金类型(自定义档案) (Defdoc-BD005_0xx) |
| 14 | pk_planperiod | 计划付款期间 | pk_planperiod | varchar(20) |  | 计划期间 (period) |
| 15 | isprepay | 是否预付 | isprepay | char(1) |  | 布尔类型 (UFBoolean) |
| 16 | isqualitymy | 是否质保金 | isqualitymy | char(1) |  | 布尔类型 (UFBoolean) |
