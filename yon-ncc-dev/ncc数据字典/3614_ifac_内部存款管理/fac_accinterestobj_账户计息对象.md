...
**账户计息对象 (fac_accinterestobj / nc.vo.fac.interestobj.AccInterestObjVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2074.html
...
| 11 | ratecode | 利率编码 | ratecode | varchar(20) |  | 利率编码 (fi_ratecode) |
| 12 | intmode | 计息方式 | intmode | varchar(50) |  | 计息方式 (IntmodeEnum) |  | 0=分别计息; |