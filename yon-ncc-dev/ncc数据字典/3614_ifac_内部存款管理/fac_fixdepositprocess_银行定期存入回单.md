...
**银行定期存入回单 (fac_fixdepositprocess / nc.vo.fac.fixdepositprocess.FixDepositProcessVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2089.html
...
| 8 | billstate | 单据状态 | billstate | int |  | 银行存款单据状态 (BankBillStatus) |  | 1=已记账; |