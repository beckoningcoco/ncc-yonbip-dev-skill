...
**积数调整子实体 (ifac_jstz_b / nc.vo.ifac.aggregate.JsAdjustmentBVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3099.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_aggregateadj_b | 积数调整子实体标识 | pk_aggregateadj_b | char(20) | √ | 主键 (UFID) |
| 2 | pk_aggregateadj_h | 积数调整主实体 | pk_aggregateadj_h | varchar(20) |  | 积数调整 (ifac_aggregateadj_h) |
