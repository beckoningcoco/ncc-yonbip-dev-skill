...
**开证修改 (lcm_openmodify / nc.vo.lcm.open.modify.OpenModifyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3569.html
...
| 6 | vbillstatus | 审批状态 | vbillstatus | int |  | 信用证单据状态 (LCBillStatus) |  | -1=自由态; |