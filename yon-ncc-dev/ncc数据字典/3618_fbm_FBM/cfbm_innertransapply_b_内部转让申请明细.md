...
**内部转让申请明细 (cfbm_innertransapply_b / nc.vo.cfbm.innertransapply.InnerTransApplyBVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1418.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_innertransapply_b | 单据明细主键 | pk_innertransapply_b | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 3 | pk_org | 财务组织 | pk_org | varchar(20) |  | 组织_业务单元_财务组织 (financeorg) |
| 4 | pk_org_v | 财务组织版本 | pk_org_v | varchar(20) |  | 组织_业务单元_财务组织版本信息 (financeorg_v) |
| 5 | pk_register | 票据编号 | pk_register | varchar(20) |  | 票据登记 (fbm_register) |
| 6 | fbmbillno | 票据编号 | fbmbillno | varchar(50) |  | 字符串 (String) |
| 7 | fbmbilltype | 票据类型 | fbmbilltype | varchar(20) |  | 票据类型 (notetype) |
...
| 16 | vrowno | 行号 | vrowno | varchar(50) |  | 字符串 (String) |
...
| 20 | billamount | 票据金额 | billamount | decimal(28, 8) |  | 金额 (UFMoney) |
| 21 | olcbillamount | 票据金额组织本币金额 | olcbillamount | decimal(28, 8) |  | 金额 (UFMoney) |
| 22 | glcbillamount | 票据金额集团本币金额 | glcbillamount | decimal(28, 8) |  | 金额 (UFMoney) |
| 23 | gllcbillamount | 票据金额全局本币金额 | gllcbillamount | decimal(28, 8) |  | 金额 (UFMoney) |
