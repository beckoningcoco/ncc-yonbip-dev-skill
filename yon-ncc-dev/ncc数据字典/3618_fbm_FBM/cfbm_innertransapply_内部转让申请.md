...
**内部转让申请 (cfbm_innertransapply / nc.vo.cfbm.innertransapply.InnerTransApplyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1417.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_innertransapply | 主键 | pk_innertransapply | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 3 | pk_org | 财务组织 | pk_org | varchar(20) |  | 组织_业务单元_财务组织 (financeorg) |
| 4 | pk_org_v | 财务组织版本 | pk_org_v | varchar(20) |  | 组织_业务单元_财务组织版本信息 (financeorg_v) |
| 5 | innerdiscountflag | 内部贴现 | innerdiscountflag | char(1) |  | 布尔类型 (UFBoolean) |
...
| 12 | pk_srcbill | 来源单据 | pk_srcbill | char(20) |  | 主键 (UFID) |
| 13 | pk_billtypecode | 单据类型 | pk_billtypecode | varchar(50) |  | 字符串 (String) |
| 14 | pk_billtypeid | 单据类型主键 | pk_billtypeid | char(20) |  | 主键 (UFID) |
| 15 | vbillno | 单据编号 | vbillno | varchar(50) |  | 字符串 (String) |
| 16 | busistatus | 单据状态 | busistatus | int |  | 单据状态 (BillStatusEnum) |  | -1=待审批; |