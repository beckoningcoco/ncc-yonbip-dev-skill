...
**票据调剂回单 (cfbm_redeployback / nc.vo.cfbm.redeployback.FbRedeployBackVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1426.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_redeployback | 主键 | pk_redeployback | char(20) | √ | 主键 (UFID) |
