...
**票据付款 (fbm_accept / nc.vo.fbm.accept.AcceptVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2108.html
...
| 4 | fbmbillno | 票据编号隐藏项 | fbmbillno | varchar(50) |  | 字符串 (String) |
