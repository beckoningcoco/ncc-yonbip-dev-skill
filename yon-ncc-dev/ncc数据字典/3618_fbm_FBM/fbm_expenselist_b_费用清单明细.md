...
**费用清单明细 (fbm_expenselist_b / nc.vo.pfbm.expenselist.ExpenselistBVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2132.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_expenselist_b | 主键 | pk_expenselist_b | char(20) | √ | 主键 (UFID) |
| 2 | pk_expenselist | 主表主键 | pk_expenselist | varchar(20) |  | 字符串 (String) |
...
| 18 | billmoney | 票据金额 | billmoney | decimal(28, 4) |  | 金额 (UFMoney) |
...
| 27 | olcsumbillamount | 组织本币金额 | olcsumbillamount | decimal(28, 4) |  | 金额 (UFMoney) |
| 28 | glcsumbillamount | 集团本币金额 | glcsumbillamount | decimal(28, 4) |  | 金额 (UFMoney) |
