...
**内部借款合同 (icdmc_debitcontract / nc.vo.icdmc.icdmc.debitcontract.DebitContractVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3029.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_debitcontract_icdmc | 主键 | pk_debitcontract_icdmc | char(20) | √ | 主键 (UFID) |
...
| 8 | pk_financorg | 借款单位 | pk_financorg | varchar(20) |  | 组织 (org) |
| 9 | transacttype | 融资品种 | transacttype | varchar(20) |  | 投融资品种 (FinVarietyVO) |
| 10 | pk_loanorg | 贷款单位 | pk_loanorg | varchar(20) |  | 组织_业务单元_资金组织 (fundorg) |
