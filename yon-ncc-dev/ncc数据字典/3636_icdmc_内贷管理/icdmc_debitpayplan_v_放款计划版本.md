...
**放款计划版本 (icdmc_debitpayplan_v / nc.vo.icdmc.icdmc.debitcontract.version.DebitPayPlanVersionVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3034.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_version_b | 主键 | pk_version_b | char(20) | √ | 主键 (UFID) |
| 2 | pk_debit_payplan_b_icdmc | 放款计划主键 | pk_debit_payplan_b_icdmc | char(20) | √ | 主键 (UFID) |
...
| 6 | olcloanmoney | 组织放款金额 | olcloanmoney | decimal(28, 8) |  | 数值 (UFDouble) |
| 7 | glcloanmoney | 集团放款金额 | glcloanmoney | decimal(28, 8) |  | 数值 (UFDouble) |
| 8 | gllloanmoney | 全局放款金额 | gllloanmoney | decimal(28, 8) |  | 数值 (UFDouble) |
