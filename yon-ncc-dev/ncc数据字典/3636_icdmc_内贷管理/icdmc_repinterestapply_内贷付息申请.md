...
**内贷付息申请 (icdmc_repinterestapply / nc.vo.icdmc.icdmc.repayintstapply.RepayIntstApplyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3061.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_repayintsticdmcapply | 内贷付息主键 | pk_repayintsticdmcapply | char(20) | √ | 主键 (UFID) |
...
| 8 | pk_innerloanpay | 放款单号 | pk_innerloanpay | varchar(20) |  | 内贷放款 (FinancepayVO) |
| 9 | loancode | 放款单编号ID | loancode | varchar(20) |  | 内贷放款 (FinancepayVO) |
| 10 | pk_debitunit | 借款单位 | pk_debitunit | varchar(20) |  | 组织 (org) |
| 11 | financorgid | 贷款单位 | financorgid | varchar(20) |  | 组织_业务单元_资金组织 (fundorg) |
| 12 | contractmny | 合同金额 | contractmny | decimal(28, 8) |  | 数值 (UFDouble) |
...
| 33 | loanunitid | 单位付息账户 | loanunitid | varchar(20) |  | 银行账户子户 (bankaccsub) |
| 34 | loanaccount | 付息入账账户 | loanaccount | varchar(20) |  | 银行账户子户 (bankaccsub) |
