...
**担保信息 (icdmc_repprcpl_grt / nc.vo.icdmc.icdmc.repayprcpl.RepayPrcplGrtVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3063.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_repprcpl_grt_c | 主键 | pk_repprcpl_grt_c | char(20) | √ | 主键 (UFID) |
| 2 | pk_grtcontract | 担保合同 | pk_grtcontract | varchar(20) |  | 担保合同 (GuaContractVO) |
| 3 | releasegrtmny | 释放担保金额 | releasegrtmny | decimal(28, 8) |  | 金额 (UFMoney) |
| 4 | releasegrtolcmny | 释放担保组织本币 | releasegrtolcmny | decimal(28, 8) |  | 金额 (UFMoney) |
| 5 | releasegrtglcmny | 释放担保集团本币 | releasegrtglcmny | decimal(28, 8) |  | 金额 (UFMoney) |
| 6 | releasegrtgllcmny | 释放担保全局本币 | releasegrtgllcmny | decimal(28, 8) |  | 金额 (UFMoney) |
| 7 | pk_grtcurrtype | 担保币种 | pk_grtcurrtype | varchar(20) |  | 币种 (currtype) |
| 8 | grtratio | 担保比例 | grtratio | decimal(28, 8) |  | 数值 (UFDouble) |
| 9 | contractstartdate | 合同开始日期 | contractstartdate | char(19) |  | 日期 (UFDate) |
| 10 | contractenddate | 合同结束日期 | contractenddate | char(19) |  | 日期 (UFDate) |
