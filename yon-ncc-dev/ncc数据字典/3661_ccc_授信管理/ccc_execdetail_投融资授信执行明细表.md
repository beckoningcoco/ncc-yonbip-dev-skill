...
**投融资授信执行明细表 (ccc_execdetail / nc.vo.ccc.execdetail.ExecDetailVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1313.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_execdetail | 执行明细主键 | pk_execdetail | char(20) | √ | 主键 (UFID) |
| 2 | vbillno | 单据编号 | vbillno | varchar(100) |  | 字符串 (String) |
