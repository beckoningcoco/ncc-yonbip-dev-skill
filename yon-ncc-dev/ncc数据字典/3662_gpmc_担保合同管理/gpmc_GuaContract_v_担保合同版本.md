...
**担保合同版本 (gpmc_GuaContract_v / nc.vo.gpmc.gpm.contract.ContractVersionVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2523.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_version | 版本pk | pk_version | char(20) | √ | 主键 (UFID) |
| 2 | pk_guacontract | 主键 | pk_guacontract | varchar(20) |  | 字符串 (String) |
