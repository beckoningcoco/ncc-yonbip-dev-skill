...
**利息清单 (cdmc_Interestlist / nc.vo.cdmc.cdm.interestlist.InterestlistVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1388.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_interestlist | 主键 | pk_interestlist | char(20) | √ | 主键 (UFID) |
...
| 5 | profitcenter | 利润中心 | profitcenter | varchar(20) |  | 组织_业务单元_责任组织 (liabilitycenter) |
| 6 | glcrepprcremain | 集团未还本金本币金额 | glcrepprcremain | decimal(28, 8) |  | 金额 (UFMoney) |
| 7 | iadate | 结息日 | iadate | varchar(20) |  | 结息日 (fi_settledate) |
| 8 | settledate | 结息日期 | settledate | char(19) |  | 日期时间 (UFDateTime) |
...
| 16 | iabilltype | 清单类型 | iabilltype | int |  | 清单类型 (IabilltypeEnum) |  | 1=计息清单; |