...
**委托借款申请 (cdmc_consignapply / nc.vo.cdmc.ccm.consigndebitapply.ConsignDebitApplyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1327.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_apply | 委托借款申请主键 | pk_apply | char(20) | √ | 主键 (UFID) |
