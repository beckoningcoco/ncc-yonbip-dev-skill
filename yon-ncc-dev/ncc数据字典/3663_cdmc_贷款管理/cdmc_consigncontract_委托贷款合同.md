...
**委托贷款合同 (cdmc_consigncontract / nc.vo.cdmc.ccm.consigncreditcontract.ConsignCreditContractVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1330.html
...
| 5 | vbillno | 合同编号 | vbillno | varchar(100) |  | 字符串 (String) |
