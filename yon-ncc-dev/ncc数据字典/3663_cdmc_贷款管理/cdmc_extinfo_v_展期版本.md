...
**展期版本 (cdmc_extinfo_v / nc.vo.cdmc.cdm.financepay.version.ExtInfoVersionVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1371.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_version_b | 主键 | pk_version_b | char(20) | √ | 主键 (UFID) |
| 2 | pk_extinfo_b | 子表pk | pk_extinfo_b | char(20) |  | 主键 (UFID) |
...
| 9 | extbegindate | 展期开始日期 | extbegindate | char(19) |  | 日期时间 (UFDateTime) |
| 10 | extenddate | 展期结束日期 | extenddate | char(19) |  | 日期时间 (UFDateTime) |
