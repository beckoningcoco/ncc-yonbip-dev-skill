...
**贷款放款版本 (cdmc_financepay_v / nc.vo.cdmc.cdm.financepay.version.FinancepayVersionVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1374.html
...
| 6 | vbillno | 单据编码 | vbillno | varchar(100) |  | 字符串 (String) |
...
| 9 | busistatus | 单据状态 | busistatus | int |  | 放款单状态 (BillStatusEnum) |  | -1=待提交; |