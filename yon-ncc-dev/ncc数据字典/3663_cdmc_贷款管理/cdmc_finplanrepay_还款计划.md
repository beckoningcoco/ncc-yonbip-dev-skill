...
**还款计划 (cdmc_finplanrepay / nc.vo.cdmc.cdm.financepay.PlanRepayVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1383.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_planrepay_b | 主键 | pk_planrepay_b | char(20) | √ | 主键 (UFID) |
| 2 | rowno | 行号 | rowno | varchar(50) |  | 字符串 (String) |
| 3 | planrepaycode | 还款计划编码 | planrepaycode | varchar(50) |  | 字符串 (String) |
| 4 | planrepaydate | 计划还款日期 | planrepaydate | char(19) |  | 日期时间 (UFDateTime) |
