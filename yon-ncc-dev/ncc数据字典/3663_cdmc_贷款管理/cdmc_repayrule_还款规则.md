...
**还款规则 (cdmc_repayrule / nc.vo.cdmc.cdm.contract.RepayRuleVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1395.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_repayrule_b | 主键 | pk_repayrule_b | char(20) | √ | 主键 (UFID) |
| 2 | rulecode | 还款编码 | rulecode | varchar(50) |  | 字符串 (String) |
| 3 | repaydate | 还款日期 | repaydate | char(19) |  | 日期时间 (UFDateTime) |
| 4 | repaymny | 还本金额 | repaymny | decimal(28, 8) |  | 金额 (UFMoney) |
| 5 | isquoted | 是否被引用 | isquoted | char(1) |  | 布尔类型 (UFBoolean) |
...
| 9 | repayolmny | 还本本币金额 | repayolmny | decimal(28, 8) |  | 金额 (UFMoney) |
| 10 | repayglmny | 还本集团本币金额 | repayglmny | decimal(28, 8) |  | 金额 (UFMoney) |
| 11 | repaygllmny | 还本全局本币金额 | repaygllmny | decimal(28, 8) |  | 金额 (UFMoney) |
| 12 | occupyflag | 占用标志 | occupyflag | int |  | 整数 (Integer) |
| 13 | occupymny | 占用金额 | occupymny | decimal(28, 8) |  | 金额 (UFMoney) |
| 14 | occupyolmny | 占用本币金额 | occupyolmny | decimal(28, 8) |  | 金额 (UFMoney) |
| 15 | occupyglmny | 占用集团本币金额 | occupyglmny | decimal(28, 8) |  | 金额 (UFMoney) |
| 16 | occupygllmny | 占用全局本币金额 | occupygllmny | decimal(28, 8) |  | 金额 (UFMoney) |
