...
**内部服务结算确认清单-需方 (nresa_dem_dest / nc.vo.nresa.internalsettlent.service.DemDestVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3841.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_dest | 主键 | pk_dest | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 3 | pk_org | 需方责任组织 | pk_org | varchar(20) |  | 组织_业务单元_责任组织 (liabilitycenter) |
| 4 | pk_org_v | 需方责任组织版本 | pk_org_v | varchar(20) |  | 组织_业务单元_责任组织版本信息 (liabilitycenter_v) |
