...
**作业统计单 (cm_actnum / nc.vo.cm.activitynum.entity.ActivityNumHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1436.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cactnumid | 作业统计单 | cactnumid | char(20) | √ | 主键 (UFID) |
