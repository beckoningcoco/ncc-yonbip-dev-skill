...
**逐层还原比率 (cm_layratiodef / nc.vo.cm.layratiodef.entity.LayRatioDefHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1488.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | clayratiodefid | 逐层还原比率 | clayratiodefid | char(20) | √ | 主键 (UFID) |
...
| 6 | cperiod | 会计期间 | cperiod | varchar(50) |  | 字符串 (String) |
| 7 | dbusinessdate | 业务日期 | dbusinessdate | char(19) |  | 日期 (UFDate) |
| 8 | cmaterialid | 产品最新版本 | cmaterialid | varchar(20) |  | 物料基本信息 (material_v) |
| 9 | cmaterialvid | 产品 | cmaterialvid | varchar(20) |  | 物料基本信息（多版本） (material) |
