...
**标准成本维护明细页签 (sca_matprice_detail / nc.vo.sca.matprice.entity.MatpriceDetailVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5057.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_matprice_detail | 标准成本明细主键 | pk_matprice_detail | char(20) | √ | 主键 (UFID) |
...
| 10 | ccosttypeid | 成本类型 | ccosttypeid | varchar(20) |  | 成本类型 (mapub_costtype) |
| 11 | cactivityid | 作业 | cactivityid | varchar(20) |  | 作业档案 (bd_activity) |
...
| 21 | materialhashkey | 物料哈希值 | materialhashkey | int |  | 整数 (Integer) |
| 22 | materialinfo | 物料信息 | materialinfo | varchar(1450) |  | 字符串 (String) |
...
| 25 | pricesource | 取价来源 | pricesource | int |  | 价格来源 (StdProdPriceSourceEnum) |  | 1=上层卷积; |