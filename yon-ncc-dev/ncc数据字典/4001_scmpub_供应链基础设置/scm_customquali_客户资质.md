...
**客户资质 (scm_customquali / nc.vo.scmpub.customquali.CustomQualiHVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5213.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_customquali | 主键 | pk_customquali | char(20) | √ | 主键 (UFID) |
...
| 7 | name_custom | 客户名称 | name_custom | varchar(50) |  | 字符串 (String) |
