...
**供应商资质子表 (scm_supplierquali_b / nc.vo.scmpub.supplierquali.SupplierQualiBVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5230.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_supplierquali_b | 主键 | pk_supplierquali_b | char(20) | √ | 主键 (UFID) |
