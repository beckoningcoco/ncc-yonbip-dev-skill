...
**设备入库单货位单品表 (ic_assetin_l / nc.vo.ic.m4401.entity.AssetInLocationVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2874.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cgenerallid | 设备入库单货位单品表主键 | cgenerallid | char(20) | √ | 主键 (UFID) |
...
| 15 | cgeneralhid | 资产入库单表头主键 | cgeneralhid | char(20) | √ | 主键 (UFID) |
