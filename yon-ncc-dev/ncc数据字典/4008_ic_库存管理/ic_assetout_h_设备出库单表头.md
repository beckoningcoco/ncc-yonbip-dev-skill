...
**设备出库单表头 (ic_assetout_h / nc.vo.ic.m4451.entity.AssetOutHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2876.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cgeneralhid | 设备出库单表头主键 | cgeneralhid | char(20) | √ | 主键 (UFID) |
...
| 11 | cothercalbodyoid | 入库库存最新组织版本 | cothercalbodyoid | varchar(20) |  | 组织_业务单元_库存组织 (stockorg) |
