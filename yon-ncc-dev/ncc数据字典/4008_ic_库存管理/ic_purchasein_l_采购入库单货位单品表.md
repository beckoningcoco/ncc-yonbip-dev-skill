...
**采购入库单货位单品表 (ic_purchasein_l / nc.vo.ic.m45.entity.PurchaseInLocationVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2959.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cgenerallid | 采购入库单货位单品表主键 | cgenerallid | char(20) | √ | 主键 (UFID) |
...
| 10 | nnum | 入库主数量 | nnum | decimal(28, 8) |  | 数值 (UFDouble) |
| 11 | nassistnum | 入库数量 | nassistnum | decimal(28, 8) |  | 数值 (UFDouble) |
| 12 | ngrossnum | 毛重主数量 | ngrossnum | decimal(28, 8) |  | 数值 (UFDouble) |
...
| 15 | cgeneralhid | 入库单表头主键 | cgeneralhid | varchar(20) |  | 主键 (UFID) |
