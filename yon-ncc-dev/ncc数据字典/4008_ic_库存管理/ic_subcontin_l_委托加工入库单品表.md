...
**委托加工入库单品表 (ic_subcontin_l / nc.vo.ic.m47.entity.SubcontInLocationVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2984.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cgenerallid | 委托加工入库单货位单品表ID | cgenerallid | char(20) | √ | 主键 (UFID) |
| 2 | cgeneralhid | 委托加工入库表头ID | cgeneralhid | char(20) |  | 主键 (UFID) |
| 3 | pk_group | 集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 4 | corpoid | 公司 | corpoid | varchar(20) |  | 组织_业务单元_公司 (corp) |
| 5 | corpvid | 公司版本 | corpvid | varchar(20) |  | 组织_业务单元_公司版本信息 (corp_v) |
