...
**库存形态转换单品表 (ic_transform_l / nc.vo.ic.m4n.entity.TransformLocationVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2991.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cspeciallid | 调整单货位单品表主键 | cspeciallid | char(20) | √ | 主键 (UFID) |
| 2 | cspecialhid | 调整单表头主键 | cspecialhid | char(20) |  | 主键 (UFID) |
