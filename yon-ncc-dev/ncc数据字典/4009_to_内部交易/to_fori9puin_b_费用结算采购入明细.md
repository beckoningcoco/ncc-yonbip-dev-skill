...
**费用结算采购入明细 (to_fori9puin_b / nc.vo.to.m4552.entity.ForI9PuInItemVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5793.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbill_bid | 费用结算采购入明细 | cbill_bid | char(20) | √ | 主键 (UFID) |
| 2 | crowno | 行号 | crowno | varchar(20) |  | 字符串 (String) |
| 3 | cinventoryid | 物料主键 | cinventoryid | char(20) |  | 主键 (UFID) |
| 4 | cinventoryvid | 物料版本主键 | cinventoryvid | char(20) |  | 主键 (UFID) |
...
| 9 | cadjustbillitemid | 调整单据分录主键 | cadjustbillitemid | char(20) |  | 主键 (UFID) |
| 10 | cadjustbillid | 调整单据主键 | cadjustbillid | char(20) |  | 主键 (UFID) |
...
| 31 | cprofitcenterid | 利润中心主键 | cprofitcenterid | char(20) |  | 主键 (UFID) |
| 32 | cprofitcentervid | 利润中心版本主键 | cprofitcentervid | char(20) |  | 主键 (UFID) |
...
| 39 | cfirstid | 源头单据主键 | cfirstid | char(20) |  | 主键 (UFID) |
| 40 | cfirstbid | 源头单据分录主键 | cfirstbid | char(20) |  | 主键 (UFID) |
