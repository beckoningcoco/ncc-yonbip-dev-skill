...
**合同基本 (ct_ap_b / nc.vo.ct.ap.entity.CtApBVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1645.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_ct_ap_b | 合同基本主键 | pk_ct_ap_b | char(20) | √ | 主键 (UFID) |
...
| 32 | pk_financeorg | 财务组织最新版本 | pk_financeorg | varchar(20) |  | 组织_业务单元_财务组织 (financeorg) |
| 33 | pk_financeorg_v | 财务组织 | pk_financeorg_v | varchar(20) |  | 组织_业务单元_财务组织版本信息 (financeorg_v) |
...
| 46 | norigtaxmny | 价税合计 | norigtaxmny | decimal(28, 8) |  | 数值 (UFDouble) |
| 47 | norigtax | 原币税额 | norigtax | decimal(28, 8) |  | 数值 (UFDouble) |
| 48 | nmny | 本币无税金额 | nmny | decimal(28, 8) |  | 数值 (UFDouble) |
| 49 | ntaxmny | 本币价税合计 | ntaxmny | decimal(28, 8) |  | 数值 (UFDouble) |
| 50 | ntax | 税额 | ntax | decimal(28, 8) |  | 数值 (UFDouble) |
| 51 | noritotalgpmny | 累计付款金额 | noritotalgpmny | decimal(28, 8) |  | 数值 (UFDouble) |
...
| 59 | noricopegpmny | 累计应付金额 | noricopegpmny | decimal(28, 8) |  | 数值 (UFDouble) |
