...
**变更历史 (ct_ar_change / nc.vo.ct.ar.entity.CtArChangeVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1653.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_ct_ar_change | 变更历史主键 | pk_ct_ar_change | char(20) | √ | 主键 (UFID) |
