...
**价格调整单 (prm_adjustprice / nc.vo.price.adjustprice.entity.AdjustPriceHVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4651.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_adjustprice | 价格调整单主键 | pk_adjustprice | char(20) | √ | 主键 (UFID) |
