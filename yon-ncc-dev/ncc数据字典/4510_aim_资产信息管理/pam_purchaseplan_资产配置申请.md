...
**资产配置申请 (pam_purchaseplan / nc.vo.aim.purchaseplan.PurchaseplanHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4292.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_purchaseplan | 资产配置申请单主键 | pk_purchaseplan | char(20) | √ | 主键 (UFID) |
