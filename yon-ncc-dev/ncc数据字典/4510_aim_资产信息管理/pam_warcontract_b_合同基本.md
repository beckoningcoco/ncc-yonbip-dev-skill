...
**合同基本 (pam_warcontract_b / nc.vo.aim.warcontract.WarContractBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4343.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_warcontract_b | 合同基本主键 | pk_warcontract_b | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 3 | pk_org | 组织最新版本 | pk_org | varchar(20) |  | 组织_业务单元_资产组织 (assetorg) |
| 4 | pk_org_v | 组织 | pk_org_v | varchar(20) |  | 组织_业务单元_资产组织版本信息 (assetorg_v) |
| 5 | rowno | 行号 | rowno | varchar(30) |  | 字符串 (String) |
| 6 | pk_equip | 设备编码 | pk_equip | varchar(20) | √ | 设备卡片 (EquipHeadVO) |
| 7 | start_date | 保修开始日期 | start_date | char(19) |  | 日期(开始) (UFDateBegin) |
| 8 | end_date | 保修截止日期 | end_date | char(19) |  | 日期(结束) (UFDateEnd) |
| 9 | charge_org | 收费金额 | charge_org | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 10 | charge_group | 收费金额（集团） | charge_group | decimal(28, 8) |  | 金额 (UFMoney) |
| 11 | charge_global | 收费金额（全局） | charge_global | decimal(28, 8) |  | 金额 (UFMoney) |
| 12 | pk_project | 项目 | pk_project | varchar(20) |  | 项目 (project) |
| 13 | memo | 备注 | memo | varchar(200) |  | 字符串 (String) |
| 14 | pk_warcontract | 保修合同主表主键 | pk_warcontract | varchar(20) |  | 保修合同 (WarContractHeadVO) |
