...
**执行过程 (pam_warcontract_p / nc.vo.aim.warcontract.WarContractProcessVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4346.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_warcontract_p | 执行过程主键 | pk_warcontract_p | char(20) | √ | 主键 (UFID) |
...
| 9 | execute_desc | 原因 | execute_desc | varchar(50) |  | 字符串 (String) |
