...
**变更历史 (pam_warcontract_v / nc.vo.aim.warcontract.WarContractVersionVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4348.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_warcontract_v | 变更历史主键 | pk_warcontract_v | char(20) | √ | 主键 (UFID) |
...
| 6 | con_version | 合同版本号 | con_version | varchar(50) |  | 字符串 (String) |
| 7 | pk_changer | 变更人 | pk_changer | varchar(20) |  | 用户 (user) |
| 8 | change_date | 变更日期 | change_date | char(19) |  | 日期 (UFDate) |
| 9 | change_reason | 变更原因 | change_reason | varchar(50) |  | 字符串 (String) |
