...
**变动子表 (pam_alter_b / nc.vo.aum.alter.AlterBillBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4216.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_alter_b | 子表主键 | pk_alter_b | char(20) | √ | 主键 (UFID) |
...
| 7 | pk_reason | 变动原因 | pk_reason | varchar(20) |  | 原因 (reason) |
| 8 | deal_result | 处理结果 | deal_result | varchar(200) |  | 字符串 (String) |
| 9 | memo | 备注 | memo | varchar(200) |  | 字符串 (String) |
| 10 | pk_jobmngfil | 项目 | pk_jobmngfil | varchar(20) |  | 项目 (project) |
