...
**领用申请子表 (pam_assign_apply_b / nc.vo.aum.assign.apply.AssignApplyBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4221.html
...
| 8 | serial_num | 存货序列号 | serial_num | varchar(80) |  | 字符串 (String) |
...
| 13 | quantity | 数量 | quantity | int |  | 整数 (Integer) |
| 14 | close_flag | 关闭 | close_flag | char(1) |  | 布尔类型 (UFBoolean) |
| 15 | expect_start_date | 要求使用日期 | expect_start_date | char(19) |  | 日期(开始) (UFDateBegin) |
| 16 | expect_end_date | 计划归还日期 | expect_end_date | char(19) |  | 日期(结束) (UFDateEnd) |
| 17 | start_date | 领用日期 | start_date | char(19) |  | 日期 (UFDate) |
| 18 | end_date | 实际归还日期 | end_date | char(19) |  | 日期 (UFDate) |
...
| 29 | memo | 技术要求 | memo | varchar(200) |  | 字符串 (String) |
| 30 | equip_name | 设备名称 | equip_name | varchar(600) |  | 多语文本 (MultiLangText) |
| 31 | pk_equip | 设备 | pk_equip | varchar(20) |  | 设备卡片 (EquipHeadVO) |
| 32 | pk_jobmngfil | 项目 | pk_jobmngfil | varchar(20) |  | 项目 (project) |
| 33 | bill_type_src | 来源单据类型 | bill_type_src | varchar(4) |  | 字符串 (String) |
| 34 | pk_bill_b_src | 来源单据主键 | pk_bill_b_src | varchar(20) |  | 字符串 (String) |
| 35 | src_pk_bill_b | 来源单据子表主键 | src_pk_bill_b | varchar(20) |  | 字符串 (String) |
| 36 | src_transi_type | 来源交易类型 | src_transi_type | varchar(20) |  | 字符串 (String) |
| 37 | src_bill_code | 来源单据号 | src_bill_code | varchar(20) |  | 字符串 (String) |
| 38 | assign_quantity | 领用数量 | assign_quantity | int |  | 整数 (Integer) |
