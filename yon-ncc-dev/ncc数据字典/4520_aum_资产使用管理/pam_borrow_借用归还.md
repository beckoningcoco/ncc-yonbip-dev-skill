...
**借用归还 (pam_borrow / nc.vo.aum.borrow.restore.ReturnHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4226.html
...
| 5 | bill_code | 借用归还单号 | bill_code | varchar(40) |  | 字符串 (String) |
