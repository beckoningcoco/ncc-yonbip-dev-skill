...
**差异调整 (pam_diffalter / nc.vo.aum.diffalter.DiffAlterHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4244.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_diffalter | 差异调整主键 | pk_diffalter | char(20) | √ | 主键 (UFID) |
...
| 5 | bill_code | 差异调整单号 | bill_code | varchar(40) |  | 字符串 (String) |
