...
**使用权调入 (pam_redeploy_in / nc.vo.aum.deploy.usedin.DeployUsedInHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4298.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_redeploy_in | 使用权调入主表主键 | pk_redeploy_in | char(20) | √ | 主键 (UFID) |
