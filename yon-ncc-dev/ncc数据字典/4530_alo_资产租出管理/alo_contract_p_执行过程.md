...
**执行过程 (alo_contract_p / nc.vo.alo.contract.leasecont.ContractOutProcessVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/88.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_warcontract_p | 合同执行过程主键 | pk_warcontract_p | char(20) | √ | 主键 (UFID) |
...
| 6 | execute_flow | 执行流程 | execute_flow | varchar(50) |  | 字符串 (String) |
| 7 | pk_executor | 执行人 | pk_executor | varchar(20) |  | 用户 (user) |
| 8 | execute_date | 执行日期 | execute_date | char(19) |  | 日期 (UFDate) |
| 9 | execute_desc | 原因 | execute_desc | varchar(200) |  | 字符串 (String) |
