...
**结算单 (alo_rent_settle / nc.vo.alo.rent.settle.RentOutSettleHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/98.html
...
| 9 | bill_code | 结算单号 | bill_code | varchar(40) |  | 字符串 (String) |
| 10 | settle_date | 结算日期 | settle_date | char(19) |  | 日期(结束) (UFDateEnd) |
