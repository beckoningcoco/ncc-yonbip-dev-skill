...
**租出归还单 (alo_restore / nc.vo.alo.lease.restore.LeaseRestoreHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/100.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_lease_restore | 租出归还主键 | pk_lease_restore | char(20) | √ | 主键 (UFID) |
