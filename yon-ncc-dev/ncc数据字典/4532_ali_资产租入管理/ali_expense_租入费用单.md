...
**租入费用单 (ali_expense / nc.vo.ali.rent.expense.LeaseInExpenseHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/53.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_expense | 租入费用单主键 | pk_expense | char(20) | √ | 主键 (UFID) |
