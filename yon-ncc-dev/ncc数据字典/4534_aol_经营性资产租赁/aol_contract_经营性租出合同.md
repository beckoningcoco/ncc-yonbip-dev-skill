...
**经营性租出合同 (aol_contract / nc.vo.aol.contract.leasecont.ContractOutHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/112.html
...
| 3 | pk_contract_oid | 合同最新版本 | pk_contract_oid | varchar(20) |  | 字符串 (String) |
...
| 10 | bill_status | 合同状态 | bill_status | varchar(50) |  | 租出合同状态 (COBillStatusConst) |  | 0=自由态; |