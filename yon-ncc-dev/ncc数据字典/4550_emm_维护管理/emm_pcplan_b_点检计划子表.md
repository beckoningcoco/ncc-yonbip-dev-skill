...
**点检计划子表 (emm_pcplan_b / nc.vo.emm.pcplan.PCPlanBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1807.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_pcplan_b | 子表PK | pk_pcplan_b | char(20) | √ | 主键 (UFID) |
...
| 11 | pc_state | 点检状态 | pc_state | int |  | 点检状态 (PCstatenum) |  | 1=运行或停运; |