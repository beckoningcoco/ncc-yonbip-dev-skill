...
**点检计划 (emm_pcplan / nc.vo.emm.pcplan.PCPlanHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1806.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_pcplan | 主表PK | pk_pcplan | char(20) | √ | 主键 (UFID) |
...
| 6 | plan_name | 计划名称 | plan_name | varchar(80) |  | 多语文本 (MultiLangText) |
