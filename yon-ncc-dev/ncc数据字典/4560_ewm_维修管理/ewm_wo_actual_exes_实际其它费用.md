...
**实际其它费用 (ewm_wo_actual_exes / nc.vo.ewm.workorder.WOActualOtherExesVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1959.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_wo_actual_exes | 主键 | pk_wo_actual_exes | char(20) | √ | 主键 (UFID) |
...
| 6 | exesmoney | 实际费用 | exesmoney | decimal(28, 8) |  | 金额 (UFMoney) | 0 |
