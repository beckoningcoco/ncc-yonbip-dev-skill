...
**计划工具 (ewm_wo_plan_tool / nc.vo.ewm.workorder.WOPlanToolVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1970.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_wo_plan_tool | 工单计划工具主键 | pk_wo_plan_tool | char(20) | √ | 主键 (UFID) |
...
| 6 | man_hours | 标准工时(小时) | man_hours | decimal(28, 8) |  | 数值 (UFDouble) | 0 | [0 , ] |
| 7 | rate | 标准费率 | rate | decimal(28, 8) |  | 金额 (UFMoney) | 0 | [0 , ] |
| 8 | money | 标准成本 | money | decimal(28, 8) |  | 金额 (UFMoney) | 0 | [0 , ] |
