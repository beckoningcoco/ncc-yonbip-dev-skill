...
**易耗品领用单 (rum_assign / nc.vo.rum.assign.AssignHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5008.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_assign | 领用单主键 | pk_assign | char(20) | √ | 主键 (UFID) |
...
| 5 | bill_code | 领用单号 | bill_code | varchar(40) |  | 字符串 (String) |
