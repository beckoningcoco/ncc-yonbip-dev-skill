...
**易耗品借用归还单 (rum_borrow / nc.vo.rum.borrow.restore.RestoreHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5012.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_borrow | 借用归还单主键 | pk_borrow | char(20) | √ | 主键 (UFID) |
