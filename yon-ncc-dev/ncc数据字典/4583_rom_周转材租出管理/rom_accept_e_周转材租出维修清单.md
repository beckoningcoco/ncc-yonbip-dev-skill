...
**周转材租出维修清单 (rom_accept_e / nc.vo.rom.accept.Maintain)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4967.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_accept_e | 维修清单子表主键 | pk_accept_e | char(20) | √ | 主键 (UFID) |
...
| 6 | pk_maintainstd | 维修标准 | pk_maintainstd | varchar(20) |  | 维修标准 (maintainstd) |
...
| 10 | maintain_num | 维修数量 | maintain_num | decimal(28, 8) |  | 数值 (UFDouble) |
| 11 | pk_contract_b_src | 来源合同行 | pk_contract_b_src | varchar(20) |  | 字符串 (String) |
| 12 | rowno_src | 维修行号 | rowno_src | varchar(30) |  | 字符串 (String) |
| 13 | memo | 备注 | memo | varchar(200) |  | 字符串 (String) |
| 14 | ismaterial_flag | 是否物料 | ismaterial_flag | char(1) |  | 布尔类型 (UFBoolean) |
| 15 | maintain_price | 维修单价 | maintain_price | decimal(28, 8) |  | 金额 (UFMoney) |
