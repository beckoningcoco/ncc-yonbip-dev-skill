...
**周转材租出运输装卸费用 (rom_accept_g / nc.vo.rom.accept.Pay)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4969.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_accept_g | 费用子表主键 | pk_accept_g | char(20) | √ | 主键 (UFID) |
...
| 11 | price | 单价（原币） | price | decimal(28, 8) |  | 金额 (UFMoney) |
