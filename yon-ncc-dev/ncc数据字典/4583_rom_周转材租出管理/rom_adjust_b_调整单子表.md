...
**调整单子表 (rom_adjust_b / nc.vo.rom.adjust.AdjustBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4971.html
...
| 11 | adjust_price | 单价(原币) | adjust_price | decimal(28, 8) |  | 金额 (UFMoney) |
| 12 | adjust_money | 调整金额(原币) | adjust_money | decimal(28, 8) |  | 金额 (UFMoney) |
| 13 | adjust_money_org | 调整金额 | adjust_money_org | decimal(28, 8) |  | 金额 (UFMoney) |
| 14 | adjust_money_group | 调整金额(集团) | adjust_money_group | decimal(28, 8) |  | 金额 (UFMoney) |
| 15 | adjust_money_global | 调整金额(全局) | adjust_money_global | decimal(28, 8) |  | 金额 (UFMoney) |
...
| 19 | src_pk_bill_b | 来源单据表体主键 | src_pk_bill_b | varchar(20) |  | 字符串 (String) |
| 20 | pk_contract_b_base_src | 来源合同行原版主键 | pk_contract_b_base_src | varchar(20) |  | 字符串 (String) |
| 21 | rowno_src | 合同行号 | rowno_src | varchar(30) |  | 字符串 (String) |
