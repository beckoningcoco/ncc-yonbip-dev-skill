...
**租赁结算单子表 (rom_balancerec_b / nc.vo.rom.balancerec.BalanceRecBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4974.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_balancerec_b | 租赁结算单子表主键 | pk_balancerec_b | char(20) | √ | 主键 (UFID) |
...
| 11 | gathmoney | 本期收款(原币) | gathmoney | decimal(28, 8) |  | 金额 (UFMoney) |
| 12 | gathmoney_org | 本期收款(本币) | gathmoney_org | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 13 | gathmoney_group | 本期收款(集团) | gathmoney_group | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 14 | gathmoney_global | 本期收款(全局) | gathmoney_global | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
...
| 59 | othermoney | 其他应收(原币) | othermoney | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 60 | othermoney_org | 其他应收(本币) | othermoney_org | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 61 | othermoney_group | 其他应收(集团) | othermoney_group | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 62 | othermoney_global | 其他应收(全局) | othermoney_global | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 63 | aggmoney | 应收合计(原币) | aggmoney | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 64 | aggmoney_org | 应收合计(本币) | aggmoney_org | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 65 | aggmoney_group | 应收合计(集团) | aggmoney_group | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 66 | aggmoney_global | 应收合计(全局) | aggmoney_global | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
