...
**损坏赔偿明细子表 (rom_balancerec_damage / nc.vo.rom.balancerec.BalanceRecDamageVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4975.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_balancerec_damage | 损害赔偿明细子表主键 | pk_balancerec_damage | char(20) | √ | 主键 (UFID) |
...
| 12 | damage_num | 损坏数量 | damage_num | decimal(28, 8) |  | 数值 (UFDouble) |
| 13 | pk_damagestd | 损坏赔偿标准 | pk_damagestd | varchar(20) |  | 损坏赔偿标准 (compensationstd) |
| 14 | pk_unit | 单位 | pk_unit | varchar(20) |  | 计量单位 (measdoc) |
| 15 | pk_currency_origin | 原币 | pk_currency_origin | varchar(20) |  | 币种 (currtype) |
| 16 | damage_price | 损坏赔偿单价(原币) | damage_price | decimal(28, 8) |  | 金额 (UFMoney) |
| 17 | damagemoney | 损坏赔偿金额(原币) | damagemoney | decimal(28, 8) |  | 金额 (UFMoney) |
| 18 | memo | 备注 | memo | varchar(200) |  | 字符串 (String) |
| 19 | src_pk_bill | 来源单据主键 | src_pk_bill | varchar(20) |  | 字符串 (String) |
| 20 | src_bill_type | 来源单据类型 | src_bill_type | varchar(20) |  | 字符串 (String) |
| 21 | src_transi_type | 来源单据交易类型 | src_transi_type | varchar(20) |  | 字符串 (String) |
| 22 | src_pk_bill_b | 来源单据表体主键 | src_pk_bill_b | varchar(20) |  | 字符串 (String) |
| 23 | src_body_rowno | 来源单据表体行号 | src_body_rowno | varchar(30) |  | 字符串 (String) |
