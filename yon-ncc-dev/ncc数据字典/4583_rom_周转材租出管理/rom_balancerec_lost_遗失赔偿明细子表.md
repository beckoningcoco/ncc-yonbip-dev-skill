...
**遗失赔偿明细子表 (rom_balancerec_lost / nc.vo.rom.balancerec.BalanceRecLostVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4978.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_balancerec_lost | 遗失赔偿明细子表主键 | pk_balancerec_lost | char(20) | √ | 主键 (UFID) |
...
| 13 | main_num | 遗失主数量 | main_num | decimal(28, 8) |  | 数值 (UFDouble) |
| 14 | pk_rent_unit | 报价单位 | pk_rent_unit | varchar(20) |  | 计量单位 (measdoc) |
| 15 | lost_num | 遗失报价数量 | lost_num | decimal(28, 8) |  | 数值 (UFDouble) |
...
| 18 | lost_price | 遗失赔偿单价(原币) | lost_price | decimal(28, 8) |  | 金额 (UFMoney) |
| 19 | lostmoney | 遗失赔偿金额(原币) | lostmoney | decimal(28, 8) |  | 金额 (UFMoney) |
