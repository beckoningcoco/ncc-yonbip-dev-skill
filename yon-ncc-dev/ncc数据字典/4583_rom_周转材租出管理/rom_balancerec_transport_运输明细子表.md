...
**运输明细子表 (rom_balancerec_transport / nc.vo.rom.balancerec.BalanceRecTransportVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4981.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_balancerec_transport | 运输明细子表主键 | pk_balancerec_transport | char(20) | √ | 主键 (UFID) |
