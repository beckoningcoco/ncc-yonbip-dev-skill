...
**租赁结算单 (rom_balancerec / nc.vo.rom.balancerec.BalanceRecHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4972.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_balancerec | 租赁结算单主键 | pk_balancerec | char(20) | √ | 主键 (UFID) |
