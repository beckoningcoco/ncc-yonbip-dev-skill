...
**周转材租出赔偿单子表 (rom_compen_b / nc.vo.rom.compensation.CompensationBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4982.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_compensation_b | 赔偿单子表主键 | pk_compensation_b | char(20) | √ | 主键 (UFID) |
...
| 14 | num | 赔偿数量 | num | decimal(28, 8) |  | 数值 (UFDouble) |  | [0 , ] |
| 15 | main_num | 赔偿主数量 | main_num | decimal(28, 8) |  | 数值 (UFDouble) |  | [0 , ] |
| 16 | rent_num | 赔偿报价数量 | rent_num | decimal(28, 8) |  | 数值 (UFDouble) |  | [0 , ] |
| 17 | changerate | 换算率 | changerate | varchar(50) |  | 字符串 (String) |
| 18 | rent_changerate | 报价单位换算率 | rent_changerate | varchar(50) |  | 字符串 (String) |
| 19 | end_date | 止租日 | end_date | char(19) |  | 日期(开始) (UFDateBegin) |
| 20 | day_num | 停租天数 | day_num | int |  | 整数 (Integer) |
| 21 | comp_price | 赔偿单价(原币) | comp_price | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 22 | comp_money | 赔偿金额(原币) | comp_money | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 23 | comp_money_org | 赔偿金额(本币) | comp_money_org | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 24 | comp_money_group | 赔偿金额(集团) | comp_money_group | decimal(28, 8) |  | 金额 (UFMoney) |
| 25 | comp_money_global | 赔偿金额(全局) | comp_money_global | decimal(28, 8) |  | 金额 (UFMoney) |
| 26 | pk_jobmngfil | 项目 | pk_jobmngfil | varchar(20) |  | 项目 (project) |
| 27 | memo | 备注 | memo | varchar(200) |  | 字符串 (String) |
| 28 | pk_contract_b_src | 来源合同行 | pk_contract_b_src | varchar(50) |  | 字符串 (String) |
| 29 | rowno_src | 合同行号 | rowno_src | varchar(30) |  | 字符串 (String) |
| 30 | ismaterial_flag | 是否物料 | ismaterial_flag | char(1) |  | 布尔类型 (UFBoolean) |
| 31 | pk_reason | 赔偿原因 | pk_reason | varchar(20) |  | 原因 (reason) |
| 32 | nbatchcode | 批次号 | nbatchcode | varchar(40) |  | 字符串 (String) |
