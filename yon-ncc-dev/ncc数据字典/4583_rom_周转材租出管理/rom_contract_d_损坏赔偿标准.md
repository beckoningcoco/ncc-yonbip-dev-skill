...
**损坏赔偿标准 (rom_contract_d / nc.vo.rom.contract.ContractDamageCompenStdVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4987.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_contract_d | 损坏赔偿标准主键 | pk_contract_d | char(20) | √ | 主键 (UFID) |
...
| 9 | pk_damagestd | 损坏赔偿标准 | pk_damagestd | varchar(20) |  | 损坏赔偿标准 (compensationstd) |
| 10 | damage_price | 损坏赔偿单价(原币) | damage_price | decimal(28, 8) |  | 金额 (UFMoney) |
