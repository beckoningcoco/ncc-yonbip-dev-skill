...
**调整单子表 (rlm_adjust_b / nc.vo.rlm.adjust.AdjustBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4919.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_adjust_b | 调整单子表主键 | pk_adjust_b | char(20) | √ | 主键 (UFID) |
...
| 11 | adjust_price | 单价(原币) | adjust_price | decimal(28, 8) |  | 数值 (UFDouble) |
| 12 | adjust_money | 调整金额(原币) | adjust_money | decimal(28, 8) |  | 数值 (UFDouble) |
| 13 | adjust_money_org | 调整金额 | adjust_money_org | decimal(28, 8) |  | 数值 (UFDouble) |
| 14 | adjust_money_group | 调整金额(集团) | adjust_money_group | decimal(28, 8) |  | 数值 (UFDouble) |
| 15 | adjust_money_global | 调整金额(全局) | adjust_money_global | decimal(28, 8) |  | 数值 (UFDouble) |
| 16 | start_date | 计租日 | start_date | char(19) |  | 日期(开始) (UFDateBegin) |
| 17 | memo | 备注 | memo | varchar(50) |  | 字符串 (String) |
| 18 | pk_contract_b_src | 来源合同行 | pk_contract_b_src | varchar(20) |  | 字符串 (String) |
| 19 | pk_contract_b_base_src | 来源合同行原版主键 | pk_contract_b_base_src | varchar(20) |  | 字符串 (String) |
| 20 | src_pk_bill_b | 来源单据表体主键 | src_pk_bill_b | varchar(20) |  | 字符串 (String) |
| 21 | pk_bill_b_src_cooperate | 协同来源单据表体主键 | pk_bill_b_src_cooperate | varchar(20) |  | 字符串 (String) |
| 22 | rowno_src | 合同行号 | rowno_src | varchar(30) |  | 字符串 (String) |
