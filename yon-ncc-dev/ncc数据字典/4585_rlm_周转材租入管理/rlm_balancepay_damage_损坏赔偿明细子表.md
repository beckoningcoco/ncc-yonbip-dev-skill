...
**损坏赔偿明细子表 (rlm_balancepay_damage / nc.vo.rlm.balancepay.BalancePayDamageVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4923.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_balancepay_damage | 损坏赔偿明细子表主键 | pk_balancepay_damage | char(20) | √ | 主键 (UFID) |
