...
**租赁结算单停租租金明细子表 (rlm_balancepay_s / nc.vo.rlm.balancepay.BalancePayStopRentVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4928.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_balancepay_s | 停租租金明细子表主键 | pk_balancepay_s | char(20) | √ | 主键 (UFID) |
...
| 10 | pk_marbaseclass | 物料分类 | pk_marbaseclass | varchar(20) |  | 物料基本分类 (marbasclass) |
| 11 | pk_material_v | 物料 | pk_material_v | varchar(20) | √ | 物料基本信息（多版本） (material) |
| 12 | pk_material | 物料最新版本 | pk_material | varchar(20) | √ | 物料基本信息 (material_v) |
| 13 | pk_contract_b_src | 合同行主键 | pk_contract_b_src | varchar(20) |  | 字符串 (String) |
| 14 | pk_stoprent | 停租单主键 | pk_stoprent | varchar(20) |  | 周转材租入停租单 (StopRentHeadVO) |
| 15 | bill_code_stoprent | 停租单号 | bill_code_stoprent | varchar(40) |  | 字符串 (String) |
| 16 | pk_stoprent_b_src | 停租单行主键 | pk_stoprent_b_src | varchar(20) |  | 周转材租入停租单子表 (StopRentBodyVO) |
| 17 | pk_rent_unit | 报价单位 | pk_rent_unit | varchar(20) |  | 计量单位 (measdoc) |
| 18 | rent_num | 停租报价数量 | rent_num | decimal(28, 8) |  | 数值 (UFDouble) |  | [0 , ] |
| 19 | start_date | 起始日期 | start_date | char(19) |  | 日期(开始) (UFDateBegin) |
| 20 | end_date | 终止日期 | end_date | char(19) |  | 日期(结束) (UFDateEnd) |
| 21 | rent_price | 停租单价(原币) | rent_price | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 22 | rent_price_org | 停租单价(本币) | rent_price_org | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 23 | day_num | 停租天数 | day_num | int |  | 整数 (Integer) |
| 24 | stopmoney | 停租租金(原币) | stopmoney | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 25 | stopmoney_org | 停租租金(本币) | stopmoney_org | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 26 | stopmoney_group | 停租租金(集团) | stopmoney_group | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 27 | stopmoney_global | 停租租金(全局) | stopmoney_global | decimal(28, 8) |  | 金额 (UFMoney) |  | [0 , ] |
| 28 | rowno_stoprent | 停租单行号 | rowno_stoprent | varchar(30) |  | 字符串 (String) |
| 29 | rowno_src | 合同行号 | rowno_src | varchar(30) |  | 字符串 (String) |
