...
**合同条款 (rlm_contract_e / nc.vo.rlm.contract.ContractItemVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4936.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_contract_e | 合同条款主键 | pk_contract_e | char(20) | √ | 主键 (UFID) |
...
| 6 | pk_item | 条款编码 | pk_item | varchar(20) |  | 合同条款 (ct_termset) |
| 7 | item_content | 条款内容 | item_content | varchar(996) |  | 备注 (Memo) |
| 8 | other_info | 其他信息 | other_info | varchar(80) |  | 字符串 (String) |
