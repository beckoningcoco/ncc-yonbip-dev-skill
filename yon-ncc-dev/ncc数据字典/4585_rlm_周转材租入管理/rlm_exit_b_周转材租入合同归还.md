...
**周转材租入合同归还 (rlm_exit_b / nc.vo.rlm.exit.ContractRestore)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4946.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_exit_b | 合同归还子表主键 | pk_exit_b | char(20) | √ | 主键 (UFID) |
