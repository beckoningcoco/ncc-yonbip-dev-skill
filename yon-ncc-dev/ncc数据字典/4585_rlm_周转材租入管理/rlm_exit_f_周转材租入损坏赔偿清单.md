...
**周转材租入损坏赔偿清单 (rlm_exit_f / nc.vo.rlm.exit.Compensation)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4950.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_exit_f | 赔偿清单子表主键 | pk_exit_f | char(20) | √ | 主键 (UFID) |
