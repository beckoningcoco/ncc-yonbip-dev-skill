...
**项目类型(项目管理) (bd_projectclass / nc.vo.pmbd.projecttype.ProjectTypeHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/935.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_projectclass | 项目类型主键 | pk_projectclass | char(20) | √ | 主键 (UFID) |
