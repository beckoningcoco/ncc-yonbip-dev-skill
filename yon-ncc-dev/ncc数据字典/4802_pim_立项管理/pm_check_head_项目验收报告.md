...
**项目验收报告 (pm_check_head / nc.vo.ppm.projectcheck.ProjectCheckHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4415.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_pro_check | 项目验收报告主键 | pk_pro_check | char(20) | √ | 主键 (UFID) |
