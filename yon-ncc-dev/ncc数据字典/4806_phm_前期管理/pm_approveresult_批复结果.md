...
**批复结果 (pm_approveresult / nc.vo.phm.approveresult.ApproveResultHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4404.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_approveresult | 批复结果主键 | pk_approveresult | char(20) | √ | 主键 (UFID) |
