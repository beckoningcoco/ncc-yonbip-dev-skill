...
**补充协议 (pm_contract_alter / nc.vo.pcm.marketcontract.ContractAlterVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4444.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_contract_alter | 补充协议主键 | pk_contract_alter | char(20) | √ | 主键 (UFID) |
...
| 5 | bill_code | 补充协议号 | bill_code | varchar(50) |  | 字符串 (String) |
| 6 | alter_mny | 补充无税额 | alter_mny | decimal(28, 8) |  | 金额 (UFMoney) |
| 7 | alter_taxmny | 补充含税额 | alter_taxmny | decimal(28, 8) |  | 金额 (UFMoney) |
| 8 | alter_tax | 补充税额 | alter_tax | decimal(28, 8) |  | 金额 (UFMoney) |
