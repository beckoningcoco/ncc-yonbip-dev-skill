...
**合同变更 (pm_discontralter / nc.vo.pcm.discontr.DiscontrAlterVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4450.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_alter | 合同变更主键 | pk_alter | char(20) | √ | 主键 (UFID) |
| 2 | rowno | 行号 | rowno | varchar(20) |  | 字符串 (String) |
| 3 | contr_version | 合同版本号 | contr_version | int |  | 整数 (Integer) |
| 4 | pk_alt_per | 变更人 | pk_alt_per | varchar(20) |  | 用户 (user) |
| 5 | alt_date | 变更日期 | alt_date | char(19) |  | 日期 (UFDate) |
| 6 | alt_reason | 变更原因 | alt_reason | varchar(200) |  | 字符串 (String) |
