...
**收款计划 (pm_earningplan / nc.vo.pcm.earningplan.EarningPlanHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4454.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_earningplan | 收款计划主键 | pk_earningplan | char(20) | √ | 主键 (UFID) |
...
| 6 | bill_code | 单据编码 | bill_code | varchar(50) |  | 字符串 (String) |
