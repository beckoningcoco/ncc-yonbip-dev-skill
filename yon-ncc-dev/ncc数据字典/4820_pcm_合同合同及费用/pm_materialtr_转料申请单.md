...
**转料申请单 (pm_materialtr / nc.vo.pcm.materialtransf.MaterialTransfHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4483.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_materialtr | 转料申请单主键 | pk_materialtr | char(20) | √ | 主键 (UFID) |
