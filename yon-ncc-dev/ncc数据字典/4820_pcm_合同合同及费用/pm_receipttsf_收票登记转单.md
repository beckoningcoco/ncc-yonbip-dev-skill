...
**收票登记转单 (pm_receipttsf / nc.vo.pcm.receiptregister.ReceiptTransferHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4523.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_receipttsf | 收票登记转单主键 | pk_receipttsf | char(20) | √ | 主键 (UFID) |
