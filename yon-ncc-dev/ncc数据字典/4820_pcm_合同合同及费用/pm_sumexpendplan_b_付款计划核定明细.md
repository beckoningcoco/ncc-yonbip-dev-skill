...
**付款计划核定明细 (pm_sumexpendplan_b / nc.vo.pcm.sumexpend.SumExpendPlanBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4536.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_sumexpendplan_b | 付款计划核定子表主键 | pk_sumexpendplan_b | char(20) | √ | 主键 (UFID) |
...
| 5 | pk_dept | 编制部门最新版本 | pk_dept | varchar(20) |  | 组织_部门 (dept) |
| 6 | pk_dept_v | 编制部门 | pk_dept_v | varchar(20) |  | 组织_部门版本信息 (dept_v) |
| 7 | pk_expendplan | 付款计划 | pk_expendplan | varchar(20) |  | 付款计划 (ExpendPlanHeadVO) |
| 8 | plan_mny | 本期计划付款额 | plan_mny | decimal(28, 8) |  | 金额 (UFMoney) |
| 9 | check_mny | 本期核定额 | check_mny | decimal(28, 8) |  | 金额 (UFMoney) |
