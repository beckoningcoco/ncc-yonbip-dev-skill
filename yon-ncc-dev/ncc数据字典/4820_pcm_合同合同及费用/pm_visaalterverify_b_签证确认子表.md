...
**签证确认子表 (pm_visaalterverify_b / nc.vo.pcm.alterverify.AlterVerifyBodyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4553.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_alterverify_b | 签证确认表体主键 | pk_alterverify_b | char(20) | √ | 主键 (UFID) |
...
| 5 | pk_alter_b | 来源行号 | pk_alter_b | varchar(20) |  | 签证申请子表 (AlterBodyVO) |
...
| 9 | pk_material_v | 物料 | pk_material_v | varchar(20) |  | 物料基本信息（多版本） (material) |
| 10 | pk_measdoc | 单位 | pk_measdoc | varchar(20) |  | 计量单位 (measdoc) |
| 11 | nnum | 数量 | nnum | decimal(28, 8) |  | 金额 (UFMoney) |
| 12 | mny | 无税金额 | mny | decimal(28, 8) |  | 金额 (UFMoney) |
| 13 | taxmny | 含税金额 | taxmny | decimal(28, 8) |  | 金额 (UFMoney) |
| 14 | veri_price | 无税单价 | veri_price | decimal(28, 8) |  | 金额 (UFMoney) |
| 15 | pk_taxcode | 税码 | pk_taxcode | varchar(20) |  | 增值税税码税率 (taxcode) |
| 16 | taxrate | 税率 | taxrate | decimal(28, 8) |  | 数值 (UFDouble) |
| 17 | veri_taxprice | 含税单价 | veri_taxprice | decimal(28, 8) |  | 金额 (UFMoney) |
| 18 | veri_mny | 无税确认金额 | veri_mny | decimal(28, 8) |  | 金额 (UFMoney) |
| 19 | tax | 税额 | tax | decimal(28, 8) |  | 金额 (UFMoney) |
| 20 | veri_taxmny | 含税确认金额 | veri_taxmny | decimal(28, 8) |  | 金额 (UFMoney) |
| 21 | nosubtaxrate | 不可抵扣率 | nosubtaxrate | decimal(28, 8) |  | 数值 (UFDouble) |
| 22 | nosubtaxmny | 不可抵扣额 | nosubtaxmny | decimal(28, 8) |  | 金额 (UFMoney) |
| 23 | calcostmny | 计成本金额 | calcostmny | decimal(28, 8) |  | 金额 (UFMoney) |
| 24 | invoice_mny | 已票金额 | invoice_mny | decimal(28, 8) |  | 金额 (UFMoney) |
| 25 | verified_flag | 核销完成 | verified_flag | varchar(1) |  | 布尔类型 (UFBoolean) |
...
| 29 | service_prc_ratio | 服务价格系数 | service_prc_ratio | decimal(28, 8) |  | 数值 (UFDouble) |
| 30 | writeoff_taxmny | 红冲含税额 | writeoff_taxmny | decimal(28, 8) |  | 金额 (UFMoney) |
| 31 | writeoff_mny | 红冲无税额 | writeoff_mny | decimal(28, 8) |  | 金额 (UFMoney) |
| 32 | writeoff_tax | 红冲税额 | writeoff_tax | decimal(28, 8) |  | 金额 (UFMoney) |
