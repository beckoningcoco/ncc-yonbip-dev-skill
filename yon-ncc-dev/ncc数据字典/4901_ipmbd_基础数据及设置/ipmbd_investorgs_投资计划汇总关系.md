...
**投资计划汇总关系 (ipmbd_investorgs / nc.vo.ipmbd.investorgs.InvestorgsVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3227.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_investorgs | 投资体系主键 | pk_investorgs | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 3 | pk_org | 财务组织 | pk_org | varchar(20) |  | 组织_业务单元_财务组织 (financeorg) |
| 4 | pk_org_v | 财务组织版本 | pk_org_v | varchar(20) |  | 组织_业务单元_财务组织版本信息 (financeorg_v) |
| 5 | pk_fatherinvestorg | 上级投资组织 | pk_fatherinvestorg | varchar(20) |  | 投资计划汇总关系 (InvestorgsVO) |
| 6 | pk_entityorg | 对应组织 | pk_entityorg | varchar(20) |  | 组织_业务单元_财务组织 (financeorg) |
| 7 | pk_fatherorg | 对应组织上级组织 | pk_fatherorg | varchar(20) |  | 组织_业务单元_财务组织 (financeorg) |
| 8 | code | 编码 | code | varchar(50) |  | 字符串 (String) |
| 9 | name | 名称 | name | varchar(200) |  | 多语文本 (MultiLangText) |
| 10 | sortid | 排列顺序 | sortid | int |  | 整数 (Integer) |
| 11 | bislastversion | 是否最新版本 | bislastversion | char(1) |  | 布尔类型 (UFBoolean) |
| 12 | vno | 版本号 | vno | int |  | 整数 (Integer) |
| 13 | enablestate | 启用状态 | enablestate | char(1) |  | 布尔类型 (UFBoolean) |
