...
**资金来源 (ipm_pb_projectapply_b / nc.vo.ipmpb.projectapply.ProjectApplyBVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3200.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_projectapply_b | 资金来源子表主键 | pk_projectapply_b | char(20) | √ | 主键 (UFID) |
