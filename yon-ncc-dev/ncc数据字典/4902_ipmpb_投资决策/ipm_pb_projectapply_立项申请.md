...
**立项申请 (ipm_pb_projectapply / nc.vo.ipmpb.projectapply.ProjectApplyVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3199.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_projectapply | 立项申请主键 | pk_projectapply | char(20) | √ | 主键 (UFID) |
...
| 10 | vprojectname | 项目名称 | vprojectname | varchar(400) |  | 字符串 (String) |
