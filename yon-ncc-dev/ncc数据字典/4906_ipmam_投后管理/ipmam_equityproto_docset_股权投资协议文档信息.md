...
**股权投资协议文档信息 (ipmam_equityproto_docset / nc.vo.ipmam.equityproto.EquityProtoDocsetVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3209.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_docset | 股权投资协议文档信息主键 | pk_docset | char(20) | √ | 主键 (UFID) |
...
| 6 | vuploadfilename | 上传文档名称 | vuploadfilename | varchar(2048) |  | 备注 (Memo) |
| 7 | vsuffix | 后缀格式 | vsuffix | varchar(50) |  | 字符串 (String) |
| 8 | iupload_count | 已上传数量 | iupload_count | int |  | 整数 (Integer) |
