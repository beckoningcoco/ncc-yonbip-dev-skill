...
**文档信息 (ipmfund_investagree_docset / nc.vo.ipmfund.investagreement.InvestAgreementDocSetVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3317.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_docset | 文档信息 | pk_docset | char(20) | √ | 主键 (UFID) |
...
| 7 | vuploadfilename | 上传文档名称 | vuploadfilename | varchar(1024) |  | 备注 (Memo) |
