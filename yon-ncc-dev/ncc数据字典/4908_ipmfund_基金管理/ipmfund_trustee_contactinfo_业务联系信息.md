...
**业务联系信息 (ipmfund_trustee_contactinfo / nc.vo.ipmfund.trusteeshipprotocol.BusinessContactInfoVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3344.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_busicontactinfo | 业务联系信息主键 | pk_busicontactinfo | char(20) | √ | 主键 (UFID) |
| 2 | crowno | 行号 | crowno | varchar(20) |  | 字符串 (String) |
| 3 | vname | 姓名 | vname | varchar(400) |  | 字符串 (String) |
| 4 | vcontacttelone | 联系电话1 | vcontacttelone | varchar(50) |  | 字符串 (String) |
| 5 | vcontactteltow | 联系电话2 | vcontactteltow | varchar(50) |  | 字符串 (String) |
| 6 | vduty | 职务 | vduty | varchar(50) |  | 字符串 (String) |
| 7 | vemailaddress | 电子邮箱 | vemailaddress | varchar(50) |  | 字符串 (String) |
| 8 | vmemo | 备注 | vmemo | varchar(1024) |  | 备注 (Memo) |
| 9 | vsrctype | 来源单据类型 | vsrctype | varchar(20) |  | 字符串 (String) |
| 10 | vsrccode | 来源单据号 | vsrccode | varchar(50) |  | 字符串 (String) |
| 11 | csrcid | 来源单据主表主键 | csrcid | char(20) |  | 主键 (UFID) |
| 12 | csrcbid | 来源单据表体主键 | csrcbid | char(20) |  | 主键 (UFID) |
| 13 | vsrcrowno | 来源单据行号 | vsrcrowno | varchar(20) |  | 字符串 (String) |
| 14 | vsrctrantype | 来源交易类型 | vsrctrantype | varchar(20) |  | 字符串 (String) |
| 15 | vfirsttype | 源头单据类型 | vfirsttype | varchar(20) |  | 字符串 (String) |
| 16 | vfirstcode | 源头单据号 | vfirstcode | varchar(50) |  | 字符串 (String) |
| 17 | cfirstid | 源头单据主表主键 | cfirstid | char(20) |  | 主键 (UFID) |
| 18 | cfirstbid | 源头单据表体主键 | cfirstbid | char(20) |  | 主键 (UFID) |
| 19 | vfirstrowno | 源头单据行号 | vfirstrowno | varchar(20) |  | 字符串 (String) |
| 20 | vfirsttrantype | 源头交易类型 | vfirsttrantype | varchar(20) |  | 字符串 (String) |
