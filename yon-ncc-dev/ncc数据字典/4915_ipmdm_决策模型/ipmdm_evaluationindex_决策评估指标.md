...
**决策评估指标 (ipmdm_evaluationindex / nc.vo.ipmdm.evaluation.EvaluationIndexVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3239.html
...
| 10 | vmemo | 指标描述 | vmemo | varchar(200) |  | 备注 (Memo) |
...
| 24 | bedit | 是否可以编辑 | bedit | char(1) |  | 布尔类型 (UFBoolean) |
