...
**文档信息 (ipmdm_scoresht_docset / nc.vo.ipmdm.scoresht.ScoreShtDocSetVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3254.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_documentset | 文档名称-用于档案引用 | pk_documentset | varchar(20) |  | 文档设置 (DocumentSetVO) |
| 2 | docname | 文档名称 | docname | varchar(400) |  | 字符串 (String) |
| 3 | bisneedupload | 是否必传 | bisneedupload | char(1) |  | 布尔类型 (UFBoolean) |
| 4 | bisupload | 是否上传 | bisupload | char(1) |  | 布尔类型 (UFBoolean) |
| 5 | vuploadfilename | 上传文档名称 | vuploadfilename | varchar(2048) |  | 备注 (Memo) |
| 6 | vsuffix | 后缀格式 | vsuffix | varchar(50) |  | 字符串 (String) |
