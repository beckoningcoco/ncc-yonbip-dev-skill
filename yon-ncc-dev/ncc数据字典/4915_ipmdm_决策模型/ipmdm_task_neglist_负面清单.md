...
**负面清单 (ipmdm_task_neglist / nc.vo.ipmdm.task.TaskNeglistVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3266.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_task_neglist | 负面清单主键 | pk_task_neglist | char(20) | √ | 主键 (UFID) |
