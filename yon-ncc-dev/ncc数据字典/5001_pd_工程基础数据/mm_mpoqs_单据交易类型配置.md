...
**单据交易类型配置 (mm_mpoqs / nc.vo.pd.mpobjqryscheme.entity.MpoqsHeadVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/3700.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_mpoqs | 主键 | pk_mpoqs | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 3 | pk_org | 计划组织 | pk_org | varchar(20) |  | 组织 (org) |
| 4 | pk_org_v | 计划组织多版本 | pk_org_v | varchar(20) |  | 组织_版本信息 (org_v) |
| 5 | vprojectcode | 方案编码 | vprojectcode | varchar(50) |  | 字符串 (String) |
| 6 | vprojectname | 方案名称 | vprojectname | varchar(200) |  | 多语文本 (MultiLangText) |
