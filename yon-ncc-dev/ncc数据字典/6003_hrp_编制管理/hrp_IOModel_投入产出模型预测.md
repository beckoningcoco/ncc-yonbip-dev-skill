...
**投入产出模型预测 (hrp_IOModel / nc.vo.hrp.forecast.IOModelVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2740.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_iomodel | 预测模型主键 | pk_iomodel | char(20) | √ | 主键 (UFID) |
...
| 5 | iomodel_year | 年度 | iomodel_year | varchar(4) | √ | 字符串 (String) |
