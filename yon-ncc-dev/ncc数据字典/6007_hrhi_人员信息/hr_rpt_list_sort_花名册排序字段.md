...
**花名册排序字段 (hr_rpt_list_sort / nc.vo.hi.repdef.RptListSortVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2698.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_rpt_sort | 主键 | pk_rpt_sort | char(20) | √ | 主键 (UFID) |
...
| 6 | sortorder | 排序序号 | sortorder | int |  | 整数 (Integer) |
| 7 | is_asc | 是否升序 | is_asc | char(1) |  | 布尔类型 (UFBoolean) |
