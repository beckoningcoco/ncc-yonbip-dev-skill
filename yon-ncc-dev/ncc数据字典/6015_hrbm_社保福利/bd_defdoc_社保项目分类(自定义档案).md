...
**社保项目分类(自定义档案) (bd_defdoc / nc.vo.bd.defdoc.DefdocVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/507.html
...
| 5 | code | 档案编码 | code | varchar(50) |  | 字符串 (String) |
...
| 9 | pid | 上级档案 | pid | varchar(20) |  | 社保项目分类(自定义档案) (Defdoc-HRBM002_0xx) |
