...
**单位月度预算项目预算额 (hrp_budget_amount / nc.vo.hrp.budgetmgt.BudgetAmountVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2724.html
...
| 7 | publish_state | 发布状态 | publish_state | int |  | 发布状态 (PublishState) |  | 0=未发布; |