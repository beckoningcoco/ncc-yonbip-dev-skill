...
**已评价单据结果 (sscsfm_evaluated / nc.vo.sscsfm.sfmpub.EvaluatedVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5621.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_evaluated | 唯一标识 | pk_evaluated | char(20) | √ | 主键 (UFID) |
| 2 | pk_rule | 评价规则主键 | pk_rule | varchar(20) |  | 字符串 (String) |
...
| 15 | auto_evaluated | 是否自动评价 | auto_evaluated | char(1) |  | 布尔类型 (UFBoolean) |
| 16 | result | 评价结果 | result | char(1) |  | 评价结果 (evaluation_result_enum) |  | 1=非常不满意; |