...
**57分摊级次 (hpf_splitlevel / nc.vo.hpf.splitlevel.SplitlevelVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2646.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_splitlevel | 主键 | pk_splitlevel | char(20) | √ | 主键 (UFID) |
| 2 | code | 分摊级次编码 | code | varchar(50) |  | 字符串 (String) |
| 3 | name | 分摊级次名称 | name | varchar(50) |  | 字符串 (String) |
