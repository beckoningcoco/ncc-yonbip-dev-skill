...
**中间库住院预交金 (hstf_mid_hosp_prepay / nc.vo.hpf.hospprepay.Midhospprepay)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/2775.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_mid_hosp_prepay | 主键 | pk_mid_hosp_prepay | char(20) | √ | 主键 (UFID) |
...
| 6 | vpatientname | 病人名称 | vpatientname | varchar(50) |  | 字符串 (String) |
...
| 11 | nmny | 金额 | nmny | decimal(28, 8) |  | 数值 (UFDouble) |
| 12 | vnote | 备注 | vnote | varchar(50) |  | 字符串 (String) |
| 13 | billscode | 票据号 | billscode | varchar(50) |  | 字符串 (String) |
| 14 | billstype | 票据类型 | billstype | varchar(50) |  | 字符串 (String) |
| 15 | hospitalnumber | 住院次数 | hospitalnumber | int |  | 整数 (Integer) |
| 16 | vincomeclass | 收入分类 | vincomeclass | varchar(50) |  | 字符串 (String) |
| 17 | acceptrefund | 收退 | acceptrefund | varchar(50) |  | 字符串 (String) |
| 18 | admitted | 入院科室 | admitted | varchar(50) |  | 字符串 (String) |
| 19 | admittedname | 入院科室名称 | admittedname | varchar(50) |  | 字符串 (String) |
