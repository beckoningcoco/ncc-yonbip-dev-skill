...
**患者基本信息 (uh_pi / com.yonyou.yh.nhis.pi.pati.vo.PatiVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6166.html
...
| 18 | pk_edu | 学历编码 | pk_edu | varchar(20) |  | 学历(自定义档案) (Defdoc-010302) |
| 19 | pk_country | 国籍编码 | pk_country | varchar(20) |  | 国籍(自定义档案) (Defdoc-000009) |
| 20 | pk_nation | 民族编码 | pk_nation | varchar(20) |  | 民族HIS(自定义档案) (Defdoc-000003) |
| 21 | teleno | 电话号码 | teleno | varchar(50) |  | 字符串 (String) |
| 22 | mobileno | 移动电话 | mobileno | varchar(50) |  | 字符串 (String) |
| 23 | email | 邮箱 | email | varchar(50) |  | 字符串 (String) |
| 24 | pk_region | 区域编码 | pk_region | varchar(20) |  | 行政区划(自定义档案) (Defdoc-010102) |
| 25 | unit_work | 工作单位 | unit_work | varchar(256) |  | 字符串 (String) |
| 26 | pk_patilog | 患者登录信息 | pk_patilog | char(20) |  | 居民信息_登录信息 (patilogin) |
| 27 | enablestate | 启用状态 | enablestate | int |  | 启用状态 (enablestate) |  | 1=未启用; |