...
**医嘱项目医疗服务类型 (bd_uh_auto_ex_srvtype / com.yonyou.nhis.bd.pub2.autoexsrv.vo.UhAutoExSrvVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1016.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_autoexsrvtype | 自动上账类型主键 | pk_autoexsrvtype | char(20) | √ | 主键 (UFID) |
