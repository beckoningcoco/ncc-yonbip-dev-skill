...
**优惠类型下服务 (bd_uh_disc_srv / nc.vo.nhbd.price.patidisc.DiscUHSrvVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1027.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_discsrv | 主键 | pk_discsrv | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 集团 | pk_group | varchar(20) | √ | 组织_集团 (group) |
| 3 | pk_org | 组织 | pk_org | varchar(20) |  | 组织 (org) |
| 4 | pk_org_v | 组织版本 | pk_org_v | varchar(20) |  | 组织_版本信息 (org_v) |
| 5 | pk_srv | 服务编码 | pk_srv | varchar(20) |  | 医疗服务收费项目字典 (bduhitem) |
| 6 | name | 服务名称 | name | varchar(50) |  | 字符串 (String) |
| 7 | ratio | 自付比例 | ratio | decimal(28, 8) |  | 数值 (UFDouble) |
| 8 | date_begin | 开始日期 | date_begin | char(19) |  | 日期时间 (UFDateTime) |
| 9 | date_end | 结束日期 | date_end | char(19) |  | 日期时间 (UFDateTime) |
