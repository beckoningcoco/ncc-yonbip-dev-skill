...
**医疗计划服务分类限制策略 (bd_uh_hp_srvcate_poli_limit / com.yonyou.yh.nhis.bd.healthplan.vo.HPSrvCateLimitVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1042.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_hpsrvcatepolilimit | 医保计划服务分类限制策略主键 | pk_hpsrvcatepolilimit | char(20) | √ | 主键 (UFID) |
...
| 12 | ampstr_date | 金额限制范式_期间 | ampstr_date | varchar(200) |  | 备注 (Memo) |
