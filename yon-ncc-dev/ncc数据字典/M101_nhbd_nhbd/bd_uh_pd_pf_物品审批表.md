...
**物品审批表 (bd_uh_pd_pf / com.yonyou.yh.nhis.bd.uhpdwf.vo.UHPdPfVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1072.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_pd_pf | 主键 | pk_pd_pf | char(20) | √ | 主键 (UFID) |
...
| 9 | pk_targetorg | 物品所属组织 | pk_targetorg | varchar(20) |  | 组织_业务单元_医卫 (hisorg) |
| 10 | billstatus | 单据状态 | billstatus | int |  | 单据状态 (BillstatusEnum) |  | 0=审批未通过; |