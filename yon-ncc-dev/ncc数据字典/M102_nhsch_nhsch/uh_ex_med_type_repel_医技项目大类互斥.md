...
**医技项目大类互斥 (uh_ex_med_type_repel / com.yonyou.yh.nhis.sch.med.vo.MedTypeRepelVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6084.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_medtyperepel | 医技大类互斥主键 | pk_medtyperepel | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 集团 | pk_group | varchar(20) | √ | 组织_集团 (group) |
| 3 | pk_org | 组织 | pk_org | varchar(20) |  | 组织 (org) |
| 4 | pk_org_v | 组织版本 | pk_org_v | varchar(20) |  | 组织_版本信息 (org_v) |
| 5 | pk_srvtype1 | 项目大类1 | pk_srvtype1 | varchar(50) |  | 字符串 (String) |
| 6 | name_srvtype1 | 项目大类1名称 | name_srvtype1 | varchar(50) |  | 字符串 (String) |
| 7 | pk_srvtype2 | 项目大类2 | pk_srvtype2 | varchar(50) |  | 字符串 (String) |
| 8 | name_srvtype2 | 项目大类2名称 | name_srvtype2 | varchar(50) |  | 字符串 (String) |
| 9 | interval_cycle | 间隔周期 | interval_cycle | int |  | 整数 (Integer) |
| 10 | interval_unite | 间隔单位 | interval_unite | varchar(50) |  | 字符串 (String) |
| 11 | notice_msg | 提示内容 | notice_msg | varchar(200) |  | 字符串 (String) |
