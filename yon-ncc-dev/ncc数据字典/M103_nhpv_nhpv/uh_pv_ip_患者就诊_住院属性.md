...
**患者就诊_住院属性 (uh_pv_ip / com.yonyou.yh.nhis.pv.pvbanner.vo.PvBannerIpVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6235.html
...
| 6 | pk_srv_nurse | 护理等级 | pk_srv_nurse | varchar(20) |  | 医疗服务字典 (uhsrv) |
...
| 28 | eu_emr_status | 病案转归状态 | eu_emr_status | int |  | 整数 (Integer) |
| 29 | flag_qa | 终末质控标志 | flag_qa | char(1) |  | 布尔类型 (UFBoolean) |
| 30 | flag_nur_qa | 护理终末质控标志 | flag_nur_qa | char(1) |  | 布尔类型 (UFBoolean) |
| 31 | times_ip | 住院次数 | times_ip | int |  | 整数 (Integer) |
| 32 | pk_mc | 医联体 | pk_mc | varchar(50) |  | 字符串 (String) |
| 33 | pk_pv | 就诊_主键 | pk_pv | char(20) | √ | 主键 (UFID) |
| 34 | drgs_code | 药品编码 | drgs_code | varchar(100) |  | 字符串 (String) |
| 35 | drgs_name | 药品名称 | drgs_name | varchar(200) |  | 字符串 (String) |
