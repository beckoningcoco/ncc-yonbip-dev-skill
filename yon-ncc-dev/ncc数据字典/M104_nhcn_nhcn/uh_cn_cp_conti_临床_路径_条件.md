...
**临床_路径_条件 (uh_cn_cp_conti / com.yonyou.yh.nhis.cn.cp.vo.CNCPathCondVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5964.html
...
| 4 | pk_cp | 临床路径 | pk_cp | varchar(20) |  | 临床_路径 (cncpath) |
...
| 11 | dt_op | 运算关系编码 | dt_op | char(20) |  | 主键 (UFID) |
