...
**临床_路径_文档 (uh_cn_cp_ecd / com.yonyou.yh.nhis.cn.cp.vo.CNCPathEcdVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5966.html
...
| 4 | pk_cp | 路径编码 | pk_cp | varchar(20) |  | 临床_路径 (cncpath) |
| 5 | pk_cppha | 路径阶段 | pk_cppha | varchar(20) |  | 临床_路径_阶段 (cncpathphase) |
| 6 | sortno | 序号 | sortno | int |  | 整数 (Integer) |
| 7 | flag_ecdorcate | 文书或文书分类标志 | flag_ecdorcate | char(1) |  | 布尔类型 (UFBoolean) |
| 8 | pk_ecdcate | 临床文书分类 | pk_ecdcate | varchar(50) |  | 字符串 (String) |
