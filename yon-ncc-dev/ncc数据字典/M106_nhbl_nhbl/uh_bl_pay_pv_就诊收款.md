...
**就诊收款 (uh_bl_pay_pv / com.yonyou.yh.nhis.bl.pay.vo.BLPayPvVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5947.html
...
| 7 | pk_pati | 患者编码 | pk_pati | varchar(20) |  | 患者基本信息 (pati) |
| 8 | pk_pv | 就诊 | pk_pv | varchar(20) |  | 患者就诊 (PatiVisitVO) |
| 9 | eu_direct | 收退方向 | eu_direct | int |  | 交退款方向 (PayDirectEnum) |  | 1=交款; |