...
**单位类型设置 (scapto_bd_unittype / nc.vo.scapto.bd.unittype.UnitTypeVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5112.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_unittype | 单位类型设置主键 | pk_unittype | char(20) | √ | 主键 (UFID) |
...
| 5 | code | 单位类型编码 | code | varchar(40) | √ | 字符串 (String) |
| 6 | name | 单位类型名称 | name | varchar(200) |  | 多语文本 (MultiLangText) |
| 7 | bisprecut | 预置标识 | bisprecut | char(1) |  | 布尔类型 (UFBoolean) |
