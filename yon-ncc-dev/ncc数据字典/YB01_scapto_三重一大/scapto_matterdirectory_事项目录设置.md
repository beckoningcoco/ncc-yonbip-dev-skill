...
**事项目录设置 (scapto_matterdirectory / nc.vo.scapto.mattermanage.matterdirectory.MatterDirectoryVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5148.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_matterdirectory | 事项目录设置主键 | pk_matterdirectory | char(20) | √ | 主键 (UFID) |
...
| 5 | crowno | 显示顺序号 | crowno | int |  | 整数 (Integer) |
| 6 | code | 事项目录编码 | code | varchar(40) | √ | 字符串 (String) |
| 7 | name | 事项目录名称 | name | varchar(200) |  | 多语文本 (MultiLangText) |
| 8 | pk_matterlistype | 所属事项分类 | pk_matterlistype | varchar(20) |  | 事项目录类型设置 (MatterlistTypeVO) |
