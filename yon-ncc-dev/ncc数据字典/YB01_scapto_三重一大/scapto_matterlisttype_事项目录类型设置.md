...
**事项目录类型设置 (scapto_matterlisttype / nc.vo.scapto.mattermanage.matterlisttype.MatterlistTypeVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5154.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_matterlisttype | 事项目录类型设置主键 | pk_matterlisttype | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 3 | pk_org | 组织 | pk_org | varchar(20) |  | 组织_业务单元_公司 (corp) |
| 4 | pk_org_v | 组织版本 | pk_org_v | varchar(20) |  | 组织_业务单元_公司版本信息 (corp_v) |
| 5 | showorder | 显示顺序号 | showorder | int |  | 整数 (Integer) |
| 6 | code | 事项目录分类编码 | code | varchar(40) | √ | 字符串 (String) |
| 7 | name | 事项目录分类名称 | name | varchar(200) |  | 多语文本 (MultiLangText) |
| 8 | pk_parent | 上级事项分类 | pk_parent | varchar(20) |  | 事项目录类型设置 (MatterlistTypeVO) |
| 9 | enablestate | 启用状态 | enablestate | char(1) |  | 布尔类型 (UFBoolean) |
| 10 | bispreset | 预置标识 | bispreset | char(1) |  | 布尔类型 (UFBoolean) |
| 11 | bisdefault | 是否默认值 | bisdefault | char(1) |  | 布尔类型 (UFBoolean) |
| 12 | innercode | 内部编码 | innercode | varchar(60) |  | 字符串 (String) |
| 13 | memo | 备注 | memo | varchar(200) |  | 多语文本 (MultiLangText) |
...
| 46 | modifier | 最后修改人 | modifier | varchar(20) |  | 用户 (user) |
| 47 | modifiedtime | 最后修改时间 | modifiedtime | char(19) |  | 日期时间 (UFDateTime) |