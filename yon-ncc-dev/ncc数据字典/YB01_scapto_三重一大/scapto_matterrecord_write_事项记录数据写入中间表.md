...
**事项记录数据写入中间表 (scapto_matterrecord_write / nc.vo.scapto.matterlistreport.write.MatterrecordWriteVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5155.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_recordwrite | 事项记录数据写入中间表主键 | pk_recordwrite | char(20) | √ | 主键 (UFID) |
...
| 13 | pk_matterrecord | 事项记录主键 | pk_matterrecord | varchar(20) |  | 字符串 (String) |
...
| 19 | list_id | 事项清单标识 | list_id | varchar(50) | √ | 字符串 (String) |