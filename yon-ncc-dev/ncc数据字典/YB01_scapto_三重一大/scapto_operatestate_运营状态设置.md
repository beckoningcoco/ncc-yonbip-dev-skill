...
**运营状态设置 (scapto_operatestate / nc.vo.scapto.operatestate.OperateStateVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5177.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_operatestate | 运营状态设置主键 | pk_operatestate | char(20) | √ | 主键 (UFID) |
...
| 5 | code | 运营状态编码 | code | varchar(40) | √ | 字符串 (String) |
| 6 | name | 运营状态名称 | name | varchar(200) |  | 多语文本 (MultiLangText) |
