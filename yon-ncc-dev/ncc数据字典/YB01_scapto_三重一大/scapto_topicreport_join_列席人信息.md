...
**列席人信息 (scapto_topicreport_join / nc.vo.scapto.topicmanage.topicreport.TopicReportJoinVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5201.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_topicreport_join | 列席人信息主键 | pk_topicreport_join | char(20) | √ | 主键 (UFID) |
