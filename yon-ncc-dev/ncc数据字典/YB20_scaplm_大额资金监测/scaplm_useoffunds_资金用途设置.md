...
**资金用途设置 (scaplm_useoffunds / nc.vo.scaplm.useoffunds.UseOfFundsVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5101.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_useoffunds | 资金用途设置主键 | pk_useoffunds | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 集团 | pk_group | varchar(20) |  | 组织_集团 (group) |
| 3 | pk_org | 组织 | pk_org | varchar(20) |  | 组织_业务单元_公司 (corp) |
| 4 | pk_org_v | 组织版本 | pk_org_v | varchar(20) |  | 组织_业务单元_公司版本信息 (corp_v) |
| 5 | code | 资金用途编码 | code | varchar(40) | √ | 字符串 (String) |
| 6 | name | 资金用途名称 | name | varchar(200) |  | 多语文本 (MultiLangText) |
