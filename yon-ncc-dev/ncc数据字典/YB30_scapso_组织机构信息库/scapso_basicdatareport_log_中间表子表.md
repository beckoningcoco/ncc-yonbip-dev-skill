...
**中间表子表 (scapso_basicdatareport_log / nc.vo.scapso.middletable.BasicDataReportLogVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5104.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_basicdatareport_log | 主键 | pk_basicdatareport_log | char(20) | √ | 主键 (UFID) |
| 2 | upload_time | 上传时间 | upload_time | varchar(23) |  | 字符串 (String) |
| 3 | upload_flag | 上传标识 | upload_flag | varchar(19) |  | 字符串 (String) |
| 4 | return_code | 返回标识 | return_code | varchar(2) |  | 字符串 (String) |
| 5 | return_msg | 返回内容 | return_msg | varchar(254) |  | 字符串 (String) |
