...
**数据仓库元数据分类 (bi_md_dir / nc.vo.bi.meta.MetaDir)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/1200.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | guid | 分类 | guid | char(20) | √ | 主键 (UFID) |
| 2 | pguid | 上级分类 | pguid | varchar(20) |  | 数据仓库元数据分类 (metadir) |
