...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6510.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_contract_i | pk_contract_i | pk_contract_i | char(20) | √ |
| 2 | item_content | item_content | item_content | varchar2(996) |
| 3 | memo | memo | memo | varchar2(200) |
| 4 | other_info | other_info | other_info | varchar2(200) |
| 5 | pk_contract | pk_contract | pk_contract | char(20) | √ |
| 6 | pk_contract_item | pk_contract_item | pk_contract_item | varchar2(20) |  |  | '~' |
| 7 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 8 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 9 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 10 | row_no | row_no | row_no | varchar2(50) |
