...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6514.html
...
| 4 | affirm_opinion | affirm_opinion | affirm_opinion | varchar2(50) |
...
| 16 | cooperate_bill | cooperate_bill | cooperate_bill | char(1) |
| 17 | cooperate_flag | cooperate_flag | cooperate_flag | char(1) |
| 18 | coop_pk_bill | coop_pk_bill | coop_pk_bill | varchar2(50) |
| 19 | lease_type | lease_type | lease_type | number(38, 0) |
| 20 | memo | memo | memo | varchar2(200) |
| 21 | origin_rate | origin_rate | origin_rate | number(28, 8) |
| 22 | pk_affirmant | pk_affirmant | pk_affirmant | varchar2(20) |  |  | '~' |
| 23 | pk_contract | pk_contract | pk_contract | varchar2(20) |  |  | '~' |
| 24 | pk_currency_local | pk_currency_local | pk_currency_local | varchar2(20) |  |  | '~' |
| 25 | pk_currency_origin | pk_currency_origin | pk_currency_origin | varchar2(20) |  |  | '~' |
| 26 | pk_customer | pk_customer | pk_customer | varchar2(20) |  |  | '~' |
| 27 | pk_fiorg_in | pk_fiorg_in | pk_fiorg_in | varchar2(20) |  |  | '~' |
| 28 | pk_fiorg_in_v | pk_fiorg_in_v | pk_fiorg_in_v | varchar2(20) |  |  | '~' |
| 29 | pk_fiorg_out | pk_fiorg_out | pk_fiorg_out | varchar2(20) |  |  | '~' |
| 30 | pk_fiorg_out_v | pk_fiorg_out_v | pk_fiorg_out_v | varchar2(20) |  |  | '~' |
| 31 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 32 | pk_jobmngfil | pk_jobmngfil | pk_jobmngfil | varchar2(20) |  |  | '~' |
| 33 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 34 | pk_org_in | pk_org_in | pk_org_in | varchar2(20) |  |  | '~' |
| 35 | pk_org_in_v | pk_org_in_v | pk_org_in_v | varchar2(20) |  |  | '~' |
| 36 | pk_org_out | pk_org_out | pk_org_out | varchar2(20) |  |  | '~' |
| 37 | pk_org_out_v | pk_org_out_v | pk_org_out_v | varchar2(20) |  |  | '~' |
| 38 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 39 | pk_raorg_in | pk_raorg_in | pk_raorg_in | varchar2(20) |  |  | '~' |
| 40 | pk_raorg_in_v | pk_raorg_in_v | pk_raorg_in_v | varchar2(20) |  |  | '~' |
| 41 | pk_raorg_out | pk_raorg_out | pk_raorg_out | varchar2(20) |  |  | '~' |
| 42 | pk_raorg_out_v | pk_raorg_out_v | pk_raorg_out_v | varchar2(20) |  |  | '~' |
| 43 | pk_recorder | pk_recorder | pk_recorder | varchar2(20) |  |  | '~' |
| 44 | pk_record_dept | pk_record_dept | pk_record_dept | varchar2(20) |  |  | '~' |
| 45 | pk_record_dept_v | pk_record_dept_v | pk_record_dept_v | varchar2(20) |  |  | '~' |
| 46 | pk_rent_settle | pk_rent_settle | pk_rent_settle | varchar2(20) |
| 47 | pk_supplier | pk_supplier | pk_supplier | varchar2(20) |  |  | '~' |
| 48 | pk_transitype | pk_transitype | pk_transitype | varchar2(20) |  |  | '~' |
...
| 53 | settle_date | settle_date | settle_date | char(19) |
| 54 | settle_flag | settle_flag | settle_flag | char(1) |
| 55 | transi_type | transi_type | transi_type | varchar2(50) |
