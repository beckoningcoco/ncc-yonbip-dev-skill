...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6711.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_accassitem | pk_accassitem | pk_accassitem | char(20) | √ |
...
| 6 | inputlength | inputlength | inputlength | number(38, 0) |
...
| 15 | refnodename | refnodename | refnodename | varchar2(75) |
| 16 | txbillitem | txbillitem | txbillitem | varchar2(50) |
