...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6715.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_accctrlrule | pk_accctrlrule | pk_accctrlrule | char(20) | √ |
| 2 | allowallsubuse | allowallsubuse | allowallsubuse | char(1) |
...
| 6 | isallinherit | isallinherit | isallinherit | char(1) |  |  | 'N' |
...
| 13 | pk_accchart | pk_accchart | pk_accchart | char(20) | √ |
