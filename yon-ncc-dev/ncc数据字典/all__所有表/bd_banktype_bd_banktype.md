...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6762.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_banktype | pk_banktype | pk_banktype | char(20) | √ |
| 2 | code | code | code | varchar2(40) | √ |
| 3 | combinecode | combinecode | combinecode | varchar2(20) |
| 4 | dataoriginflag | dataoriginflag | dataoriginflag | number(38, 0) |
| 5 | ispredata | ispredata | ispredata | char(1) |
