...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6781.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cbom_replaceid | cbom_replaceid | cbom_replaceid | varchar2(50) | √ |
| 2 | cbom_bid | cbom_bid | cbom_bid | char(20) | √ |
| 3 | ccustomerid | ccustomerid | ccustomerid | varchar2(20) |  |  | '~' |
| 4 | cproductorid | cproductorid | cproductorid | varchar2(20) |  |  | '~' |
| 5 | cprojectid | cprojectid | cprojectid | varchar2(20) |  |  | '~' |
| 6 | creplmaterialoid | creplmaterialoid | creplmaterialoid | varchar2(20) |  |  | '~' |
| 7 | creplmaterialvid | creplmaterialvid | creplmaterialvid | varchar2(20) |  |  | '~' |
| 8 | cvendorid | cvendorid | cvendorid | varchar2(20) |  |  | '~' |
| 9 | ireplorder | ireplorder | ireplorder | number(38, 0) |
| 10 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 11 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 12 | pk_org_v | pk_org_v | pk_org_v | varchar2(50) |
| 13 | vnote | vnote | vnote | varchar2(200) |
| 14 | vpackversion | vpackversion | vpackversion | varchar2(20) |  |  | '~' |
| 15 | vprodversion | vprodversion | vprodversion | varchar2(20) |  |  | '~' |
| 16 | vreplaceindex | vreplaceindex | vreplaceindex | varchar2(50) |
| 17 | vrowno | vrowno | vrowno | varchar2(50) |
