...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6944.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_goodscode | pk_goodscode | pk_goodscode | char(20) | √ |
...
| 11 | pk_customunit | pk_customunit | pk_customunit | varchar2(20) |  |  | '~' |
| 12 | pk_customunitwo | pk_customunitwo | pk_customunitwo | varchar2(20) |  |  | '~' |
