...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6954.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_incoterm | pk_incoterm | pk_incoterm | char(20) | √ |
...
| 5 | factoryship | factoryship | factoryship | char(1) | √ |
| 6 | isinclufare | isinclufare | isinclufare | char(1) |  |  | 'N' |
| 7 | isincluprem | isincluprem | isincluprem | char(1) |  |  | 'N' |
