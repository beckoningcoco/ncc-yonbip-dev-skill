...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6979.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_marsaleclass | pk_marsaleclass | pk_marsaleclass | char(20) | √ |
...
| 12 | pk_father | pk_father | pk_father | varchar2(20) |  |  | '~' |
