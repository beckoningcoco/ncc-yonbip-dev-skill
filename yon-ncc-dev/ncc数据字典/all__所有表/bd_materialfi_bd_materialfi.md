...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6987.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_materialfi | pk_materialfi | pk_materialfi | char(20) | √ |
| 2 | costprice | costprice | costprice | number(20, 8) |
| 3 | dataoriginflag | dataoriginflag | dataoriginflag | number(38, 0) |  |  | 0 |
| 4 | expaybacktax | expaybacktax | expaybacktax | number(15, 8) |  |  | 0.00000000 |
| 5 | materialvaluemgt | materialvaluemgt | materialvaluemgt | number(38, 0) | √ |  | 1 |
| 6 | pk_group | pk_group | pk_group | char(20) | √ |
| 7 | pk_material | pk_material | pk_material | char(20) | √ |
| 8 | pk_org | pk_org | pk_org | char(20) | √ |
| 9 | pk_taxitems | pk_taxitems | pk_taxitems | varchar2(20) |  |  | '~' |
| 10 | planprice | planprice | planprice | number(20, 8) |
