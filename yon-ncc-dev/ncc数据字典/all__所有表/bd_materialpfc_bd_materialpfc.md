...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/6989.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_materialpfc | pk_materialpfc | pk_materialpfc | char(20) | √ |
| 2 | asstservice | asstservice | asstservice | char(1) |
| 3 | clsfuturemar | clsfuturemar | clsfuturemar | char(1) |
| 4 | dataoriginflag | dataoriginflag | dataoriginflag | number(38, 0) |
| 5 | pk_group | pk_group | pk_group | varchar2(20) | √ |  | '~' |
| 6 | pk_marcostcls | pk_marcostcls | pk_marcostcls | varchar2(20) |  |  | '~' |
| 7 | pk_material | pk_material | pk_material | varchar2(20) | √ |  | '~' |
| 8 | pk_org | pk_org | pk_org | varchar2(20) | √ |  | '~' |
| 9 | transfermar | transfermar | transfermar | char(1) |
