...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7070.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_shifttype | pk_shifttype | pk_shifttype | char(20) | √ |
...
| 5 | iscapadjust | iscapadjust | iscapadjust | char(1) |
...
| 14 | remark | remark | remark | varchar2(512) |
