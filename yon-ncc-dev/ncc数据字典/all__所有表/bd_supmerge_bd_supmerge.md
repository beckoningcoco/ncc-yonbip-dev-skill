...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7080.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_supmerge | pk_supmerge | pk_supmerge | char(20) | √ |
...
| 9 | sourcesupplier | sourcesupplier | sourcesupplier | blob |
| 10 | source_code | source_code | source_code | varchar2(40) |
