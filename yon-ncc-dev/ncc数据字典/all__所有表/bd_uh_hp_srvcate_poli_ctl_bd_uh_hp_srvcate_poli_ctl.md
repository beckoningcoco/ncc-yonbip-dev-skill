...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7155.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_hpsrvcatepolictl | pk_hpsrvcatepolictl | pk_hpsrvcatepolictl | char(20) | √ |
| 2 | code | code | code | varchar2(50) |
| 3 | ctldesc | ctldesc | ctldesc | varchar2(200) |
| 4 | date_begin | date_begin | date_begin | char(19) |
| 5 | date_end | date_end | date_end | char(19) |
| 6 | dt_hpsrvpolictl | dt_hpsrvpolictl | dt_hpsrvpolictl | varchar2(50) |
...
| 14 | pk_hp | pk_hp | pk_hp | varchar2(20) |  |  | '~' |
| 15 | pk_hpsrvcate | pk_hpsrvcate | pk_hpsrvcate | char(20) |
| 16 | pk_hpsrvpolictl | pk_hpsrvpolictl | pk_hpsrvpolictl | varchar2(20) |  |  | '~' |
