...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7194.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_phchro | pk_phchro | pk_phchro | char(20) | √ |
| 2 | dt_chro | dt_chro | dt_chro | varchar2(50) |
| 3 | pk_chro | pk_chro | pk_chro | varchar2(20) |  |  | '~' |
| 4 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 5 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 6 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 7 | pk_ph | pk_ph | pk_ph | varchar2(20) |  |  | '~' |
