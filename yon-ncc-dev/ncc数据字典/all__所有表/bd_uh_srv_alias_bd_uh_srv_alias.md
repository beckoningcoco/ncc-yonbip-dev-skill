...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7224.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_srvalias | pk_srvalias | pk_srvalias | char(20) | √ |
| 2 | alias | alias | alias | varchar2(50) |
| 3 | eu_mnetype | eu_mnetype | eu_mnetype | varchar2(50) |
