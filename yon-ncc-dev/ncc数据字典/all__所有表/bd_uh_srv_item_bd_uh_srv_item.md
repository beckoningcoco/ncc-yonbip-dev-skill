...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7234.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_srvitem | pk_srvitem | pk_srvitem | char(20) | √ |
| 2 | eu_type | eu_type | eu_type | number(38, 0) |
| 3 | flag_def | flag_def | flag_def | char(1) |
| 4 | pk_group | pk_group | pk_group | varchar2(20) |
| 5 | pk_item | pk_item | pk_item | char(20) |
| 6 | pk_org | pk_org | pk_org | varchar2(20) |
| 7 | pk_srv | pk_srv | pk_srv | varchar2(20) |  |  | '~' |
| 8 | quan | quan | quan | number(28, 8) | √ |
