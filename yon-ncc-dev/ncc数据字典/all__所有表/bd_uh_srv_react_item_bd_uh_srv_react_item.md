...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7241.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_srvreactitem | pk_srvreactitem | pk_srvreactitem | char(20) | √ |
| 2 | crowno | crowno | crowno | varchar2(50) |
| 3 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 4 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 5 | pk_srv | pk_srv | pk_srv | char(20) |
| 6 | pk_srvreact | pk_srvreact | pk_srvreact | char(20) |
