...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7300.html
...
| 8 | moduleid | moduleid | moduleid | varchar2(300) |
| 9 | note | note | note | varchar2(300) |
| 10 | pguid | pguid | pguid | varchar2(20) |  |  | '~' |
| 11 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 12 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 13 | sysinit | sysinit | sysinit | varchar2(50) |
