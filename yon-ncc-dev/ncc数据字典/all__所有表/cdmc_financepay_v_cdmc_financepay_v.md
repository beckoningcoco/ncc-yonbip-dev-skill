...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7474.html
...
| 112 | pk_financepay | pk_financepay | pk_financepay | varchar2(50) |
| 113 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 114 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 115 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 116 | pk_planitem | pk_planitem | pk_planitem | varchar2(20) |  |  | '~' |
| 117 | pk_project | pk_project | pk_project | varchar2(20) |  |  | '~' |
| 118 | pk_rate | pk_rate | pk_rate | varchar2(20) |  |  | '~' |
| 119 | pk_returnmethod | pk_returnmethod | pk_returnmethod | varchar2(20) |  |  | '~' |
| 120 | pk_settledate | pk_settledate | pk_settledate | varchar2(20) |  |  | '~' |
| 121 | pk_srcbill | pk_srcbill | pk_srcbill | varchar2(50) |
| 122 | pk_srcbilltypeid | pk_srcbilltypeid | pk_srcbilltypeid | varchar2(50) |
...
| 138 | settlefailreason | settlefailreason | settlefailreason | varchar2(200) |
| 139 | settleflag | settleflag | settleflag | number(38, 0) |
| 140 | signdata | signdata | signdata | varchar2(200) |
| 141 | signuserid | signuserid | signuserid | varchar2(200) |
| 142 | sourcesystypecode | sourcesystypecode | sourcesystypecode | varchar2(50) |
| 143 | srcbillno | srcbillno | srcbillno | varchar2(50) |
| 144 | summary | summary | summary | varchar2(200) |
| 145 | terminatedate | terminatedate | terminatedate | char(19) |
| 146 | terminater | terminater | terminater | varchar2(20) |  |  | '~' |
| 147 | totalintstmny | totalintstmny | totalintstmny | number(28, 8) |
| 148 | tranevent | tranevent | tranevent | varchar2(200) |
| 149 | trantypeid | trantypeid | trantypeid | varchar2(50) |
| 150 | unloanmny | unloanmny | unloanmny | number(28, 8) |
| 151 | unpaymny | unpaymny | unpaymny | number(28, 8) |
| 152 | unrepayintstmny | unrepayintstmny | unrepayintstmny | number(28, 8) |
| 153 | usecontractrate | usecontractrate | usecontractrate | char(1) |
| 154 | vbillno | vbillno | vbillno | varchar2(100) |
| 155 | vbillstatus | vbillstatus | vbillstatus | number(38, 0) |
| 156 | versioner | versioner | versioner | varchar2(20) |  |  | '~' |
| 157 | versionmark | versionmark | versionmark | varchar2(100) |
| 158 | versionno | versionno | versionno | number(38, 0) |
| 159 | versionorigin | versionorigin | versionorigin | varchar2(50) |
| 160 | versiontime | versiontime | versiontime | char(19) |
| 161 | vocjxrule | vocjxrule | vocjxrule | varchar2(50) |
| 162 | voucherflag | voucherflag | voucherflag | char(1) |
| 163 | vdef1 | vdef1 | vdef1 | varchar2(101) |
| 164 | vdef2 | vdef2 | vdef2 | varchar2(101) |
| 165 | vdef3 | vdef3 | vdef3 | varchar2(101) |
| 166 | vdef4 | vdef4 | vdef4 | varchar2(101) |
| 167 | vdef5 | vdef5 | vdef5 | varchar2(101) |
| 168 | vdef6 | vdef6 | vdef6 | varchar2(101) |
| 169 | vdef7 | vdef7 | vdef7 | varchar2(101) |
| 170 | vdef8 | vdef8 | vdef8 | varchar2(101) |
| 171 | vdef10 | vdef10 | vdef10 | varchar2(101) |
| 172 | vdef11 | vdef11 | vdef11 | varchar2(101) |
| 173 | vdef12 | vdef12 | vdef12 | varchar2(101) |
| 174 | vdef13 | vdef13 | vdef13 | varchar2(101) |
| 175 | vdef14 | vdef14 | vdef14 | varchar2(101) |
| 176 | vdef15 | vdef15 | vdef15 | varchar2(101) |
| 177 | vdef16 | vdef16 | vdef16 | varchar2(101) |
| 178 | vdef17 | vdef17 | vdef17 | varchar2(101) |
| 179 | vdef18 | vdef18 | vdef18 | varchar2(101) |
| 180 | vdef19 | vdef19 | vdef19 | varchar2(101) |
| 181 | vdef20 | vdef20 | vdef20 | varchar2(101) |
| 182 | creationtime | creationtime | creationtime | char(19) |
| 183 | creator | creator | creator | varchar2(20) |  |  | '~' |
| 184 | dr | dr | dr | number(10, 0) |  |  | 0 |
| 185 | modifiedtime | modifiedtime | modifiedtime | char(19) |
| 186 | modifier | modifier | modifier | varchar2(20) |  |  | '~' |
| 187 | ts | ts | ts | char(19) |  |  | to_char(sysdate,'yyyy-mm-dd hh24:mi:ss') |