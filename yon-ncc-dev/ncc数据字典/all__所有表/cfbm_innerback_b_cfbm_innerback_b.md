...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7509.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_innerback_b | pk_innerback_b | pk_innerback_b | char(20) | √ |
...
| 12 | pk_innerback | pk_innerback | pk_innerback | char(20) | √ |
...
| 16 | vrowno | vrowno | vrowno | varchar2(20) |
