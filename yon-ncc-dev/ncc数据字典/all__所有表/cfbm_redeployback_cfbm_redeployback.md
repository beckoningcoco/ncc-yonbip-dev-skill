...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7524.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_redeployback | pk_redeployback | pk_redeployback | char(20) | √ |
...
| 9 | disableflag | disableflag | disableflag | char(1) |
| 10 | glcrate | glcrate | glcrate | number(28, 8) |
| 11 | glcsumbillamount | glcsumbillamount | glcsumbillamount | number(28, 8) |
| 12 | glcsumreckonamount | glcsumreckonamount | glcsumreckonamount | number(28, 8) |
| 13 | glcsumreckoninterest | glcsumreckoninterest | glcsumreckoninterest | number(28, 8) |
| 14 | gllcrate | gllcrate | gllcrate | number(28, 8) |
| 15 | gllcsumbillamount | gllcsumbillamount | gllcsumbillamount | number(28, 8) |
| 16 | gllcsumreckonamount | gllcsumreckonamount | gllcsumreckonamount | number(28, 8) |
| 17 | gllcsumreckoninterest | gllcsumreckoninterest | gllcsumreckoninterest | number(28, 8) |
...
| 22 | outputflag | outputflag | outputflag | char(1) |
...
| 26 | pk_fundplan | pk_fundplan | pk_fundplan | varchar2(20) |  |  | '~' |
| 27 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 28 | pk_inorg | pk_inorg | pk_inorg | varchar2(20) |  |  | '~' |
| 29 | pk_inorg_fbacc | pk_inorg_fbacc | pk_inorg_fbacc | varchar2(20) |  |  | '~' |
| 30 | pk_inorg_inneracc | pk_inorg_inneracc | pk_inorg_inneracc | varchar2(20) |  |  | '~' |
| 31 | pk_inorg_v | pk_inorg_v | pk_inorg_v | varchar2(20) |  |  | '~' |
| 32 | pk_inpayorg | pk_inpayorg | pk_inpayorg | varchar2(20) |  |  | '~' |
| 33 | pk_inpayorg_inneracc | pk_inpayorg_inneracc | pk_inpayorg_inneracc | varchar2(20) |  |  | '~' |
| 34 | pk_inpayorg_v | pk_inpayorg_v | pk_inpayorg_v | varchar2(20) |  |  | '~' |
| 35 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 36 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 37 | pk_parent | pk_parent | pk_parent | varchar2(50) |
| 38 | pk_redeployorg | pk_redeployorg | pk_redeployorg | varchar2(20) |  |  | '~' |
| 39 | pk_redeployorg_v | pk_redeployorg_v | pk_redeployorg_v | varchar2(20) |  |  | '~' |
...
| 47 | sumbillamount | sumbillamount | sumbillamount | number(28, 8) |
| 48 | sumreckonamount | sumreckonamount | sumreckonamount | number(28, 8) |
