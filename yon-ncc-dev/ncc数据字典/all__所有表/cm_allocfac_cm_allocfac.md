...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7595.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | callocfacid | callocfacid | callocfacid | char(20) | √ |
| 2 | ialloctype | ialloctype | ialloctype | number(38, 0) |
| 3 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 4 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 5 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 6 | vcode | vcode | vcode | varchar2(50) |
