...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7608.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | ccosttranseqid | ccosttranseqid | ccosttranseqid | char(20) | √ |
| 2 | cperiod | cperiod | cperiod | varchar2(20) |  |  | '~' |
| 3 | nseq | nseq | nseq | number(38, 0) |
| 4 | pk_factory | pk_factory | pk_factory | varchar2(20) |  |  | '~' |
| 5 | pk_factory_v | pk_factory_v | pk_factory_v | varchar2(20) |  |  | '~' |
