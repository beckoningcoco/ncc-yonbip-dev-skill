...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7610.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cctrevertlevelid | cctrevertlevelid | cctrevertlevelid | char(20) | √ |
...
| 5 | irevertstatus | irevertstatus | irevertstatus | number(38, 0) |
| 6 | nlevel | nlevel | nlevel | number(38, 0) |
