...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7632.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cinprostuffid | cinprostuffid | cinprostuffid | char(20) | √ |
...
| 7 | cpricebaseid | cpricebaseid | cpricebaseid | varchar2(20) |  |  | '~' |
| 8 | dbusinessdate | dbusinessdate | dbusinessdate | char(19) |
| 9 | ipricetype | ipricetype | ipricetype | number(38, 0) |  |  | 2 |
