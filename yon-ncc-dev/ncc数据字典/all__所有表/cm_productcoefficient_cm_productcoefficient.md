...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7647.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cmcoefficientid | cmcoefficientid | cmcoefficientid | char(20) | √ |
| 2 | billno | billno | billno | varchar2(50) |
| 3 | cbomid | cbomid | cbomid | varchar2(20) |  |  | '~' |
| 4 | cmaterialid | cmaterialid | cmaterialid | varchar2(20) |  |  | '~' |
| 5 | cmaterialvid | cmaterialvid | cmaterialvid | varchar2(20) | √ |  | '~' |
| 6 | crtid | crtid | crtid | varchar2(20) |  |  | '~' |
| 7 | fstatusflag | fstatusflag | fstatusflag | number(38, 0) |
