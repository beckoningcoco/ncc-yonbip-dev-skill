...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7668.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cstuffshift_bid | cstuffshift_bid | cstuffshift_bid | char(20) | √ |
...
| 5 | cdiffcenterid | cdiffcenterid | cdiffcenterid | varchar2(20) |  |  | '~' |
| 6 | cdiffdeptid | cdiffdeptid | cdiffdeptid | varchar2(20) |  |  | '~' |
| 7 | cdifffactoryid | cdifffactoryid | cdifffactoryid | varchar2(20) |  |  | '~' |
| 8 | cdifffactoryid_v | cdifffactoryid_v | cdifffactoryid_v | varchar2(20) |  |  | '~' |
| 9 | cperiod | cperiod | cperiod | varchar2(50) |
| 10 | csourcebillid | csourcebillid | csourcebillid | char(20) |
| 11 | csourcebill_bid | csourcebill_bid | csourcebill_bid | char(20) |
| 12 | cstuffshiftid | cstuffshiftid | cstuffshiftid | char(20) |
| 13 | isfzfw | isfzfw | isfzfw | char(1) |  |  | 'N' |
| 14 | istatus | istatus | istatus | number(38, 0) |  |  | 1 |
| 15 | nnum | nnum | nnum | number(20, 8) |
| 16 | pk_factory | pk_factory | pk_factory | varchar2(20) |  |  | '~' |
| 17 | pk_factory_v | pk_factory_v | pk_factory_v | varchar2(20) |  |  | '~' |
| 18 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 19 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 20 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 21 | vnote | vnote | vnote | varchar2(50) |
