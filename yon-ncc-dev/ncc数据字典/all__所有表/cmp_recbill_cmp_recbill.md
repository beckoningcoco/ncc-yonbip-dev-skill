...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7567.html
...
| 7 | audit_accounting_year | audit_accounting_year | audit_accounting_year | varchar2(4) |
...
| 14 | bill_accounting_period | bill_accounting_period | bill_accounting_period | varchar2(2) |
| 15 | bill_accounting_year | bill_accounting_year | bill_accounting_year | varchar2(4) |
...
| 20 | consignagreement | consignagreement | consignagreement | varchar2(20) |  |  | '~' |
| 21 | costcenter | costcenter | costcenter | varchar2(20) |  |  | '~' |
| 22 | creditorreference | creditorreference | creditorreference | varchar2(200) |
| 23 | customername | customername | customername | varchar2(300) |
...
| 32 | endapprover | endapprover | endapprover | varchar2(20) |  |  | '~' |
| 33 | expectdealdate | expectdealdate | expectdealdate | char(19) |
| 34 | globallocal | globallocal | globallocal | number(28, 8) |
| 35 | globalrate | globalrate | globalrate | number(15, 8) |
| 36 | grouplocal | grouplocal | grouplocal | number(28, 8) |
| 37 | grouprate | grouprate | grouprate | number(15, 8) |
| 38 | invoiceno | invoiceno | invoiceno | varchar2(140) |
| 39 | isfromindependent | isfromindependent | isfromindependent | char(1) |
| 40 | isnetready | isnetready | isnetready | char(1) |
| 41 | isreded | isreded | isreded | char(1) |
| 42 | isrefused | isrefused | isrefused | char(1) |
| 43 | is_cf | is_cf | is_cf | char(1) |
| 44 | jz_date | jz_date | jz_date | char(19) |
| 45 | local_money | local_money | local_money | number(28, 8) |
| 46 | memo | memo | memo | varchar2(272) |
| 47 | mon_account | mon_account | mon_account | varchar2(20) |  |  | '~' |
| 48 | note_no | note_no | note_no | varchar2(20) |  |  | '~' |
| 49 | objecttype | objecttype | objecttype | number(38, 0) |
| 50 | officialprint_date | officialprint_date | officialprint_date | char(19) |
| 51 | paydate | paydate | paydate | char(19) |
| 52 | payman | payman | payman | varchar2(20) |  |  | '~' |
| 53 | payreason | payreason | payreason | varchar2(50) |
...
| 67 | pk_jobobjpha | pk_jobobjpha | pk_jobobjpha | varchar2(20) |  |  | '~' |
...
| 80 | reversalreason | reversalreason | reversalreason | varchar2(50) |
| 81 | saga_btxid | saga_btxid | saga_btxid | varchar2(64) |
| 82 | saga_frozen | saga_frozen | saga_frozen | number(38, 0) |
| 83 | saga_gtxid | saga_gtxid | saga_gtxid | varchar2(64) |
| 84 | saga_status | saga_status | saga_status | number(38, 0) |
| 85 | savedate | savedate | savedate | char(19) |
| 86 | sddreversaldate | sddreversaldate | sddreversaldate | char(19) |
| 87 | sddreversaler | sddreversaler | sddreversaler | varchar2(20) |  |  | '~' |
...
| 94 | up_billtype | up_billtype | up_billtype | varchar2(20) |  |  | '~' |
| 95 | up_tradetype | up_tradetype | up_tradetype | varchar2(20) |  |  | '~' |
