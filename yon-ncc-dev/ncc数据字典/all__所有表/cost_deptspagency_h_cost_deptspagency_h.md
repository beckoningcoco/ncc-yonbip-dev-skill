...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7691.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_deptspagency_h | pk_deptspagency_h | pk_deptspagency_h | char(20) | √ |
...
| 19 | pk_codept | pk_codept | pk_codept | varchar2(20) |  |  | '~' |
...
| 27 | vmemo | vmemo | vmemo | varchar2(50) |
