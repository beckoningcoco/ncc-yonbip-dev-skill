...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7707.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_glpingtai | pk_glpingtai | pk_glpingtai | char(20) | √ |
| 2 | code | code | code | varchar2(20) |  |  | '~' |
| 3 | isdefault | isdefault | isdefault | char(1) |
| 4 | name | name | name | varchar2(50) |
| 5 | pk_codepart | pk_codepart | pk_codepart | varchar2(20) |  |  | '~' |
