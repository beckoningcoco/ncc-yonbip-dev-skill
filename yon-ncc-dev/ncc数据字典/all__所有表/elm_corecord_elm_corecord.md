...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7855.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_chgoilrecord | pk_chgoilrecord | pk_chgoilrecord | char(20) | √ |
...
| 11 | lubr_memo | lubr_memo | lubr_memo | varchar2(200) |
| 12 | lubr_situation | lubr_situation | lubr_situation | varchar2(50) |
...
| 17 | transi_type | transi_type | transi_type | varchar2(50) |
