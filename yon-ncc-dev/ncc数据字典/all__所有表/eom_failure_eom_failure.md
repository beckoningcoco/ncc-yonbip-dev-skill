...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7894.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_failure | pk_failure | pk_failure | char(20) | √ |
...
| 16 | pk_summarizer | pk_summarizer | pk_summarizer | varchar2(20) |  |  | '~' |
| 17 | pk_transitype | pk_transitype | pk_transitype | varchar2(20) |  |  | '~' |
| 18 | recorder_date | recorder_date | recorder_date | char(19) |
