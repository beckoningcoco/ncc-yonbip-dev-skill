...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/7899.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_intactrpt | pk_intactrpt | pk_intactrpt | char(20) | √ |
...
| 15 | pk_reporter | pk_reporter | pk_reporter | varchar2(20) |  |  | '~' |
| 16 | pk_transitype | pk_transitype | pk_transitype | varchar2(20) |  |  | '~' |
| 17 | transi_type | transi_type | transi_type | varchar2(30) |
