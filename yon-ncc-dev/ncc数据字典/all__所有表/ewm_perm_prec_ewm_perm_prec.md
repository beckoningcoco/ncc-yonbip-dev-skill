...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8021.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_perm_prec | pk_perm_prec | pk_perm_prec | char(20) | √ |
| 2 | exe_flag | exe_flag | exe_flag | char(1) |
| 3 | exe_status | exe_status | exe_status | varchar2(200) |
| 4 | memo | memo | memo | varchar2(200) |
| 5 | operatestep | operatestep | operatestep | varchar2(200) |
| 6 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 7 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 8 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 9 | pk_permit | pk_permit | pk_permit | char(20) | √ |
| 10 | pk_permprecauttype | pk_permprecauttype | pk_permprecauttype | varchar2(20) |  |  | '~' |
