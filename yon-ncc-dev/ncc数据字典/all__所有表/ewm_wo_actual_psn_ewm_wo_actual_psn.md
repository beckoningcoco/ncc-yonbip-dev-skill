...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8040.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_wo_actual_psn | pk_wo_actual_psn | pk_wo_actual_psn | char(20) | √ |
| 2 | man_hours | man_hours | man_hours | number(28, 8) |  |  | 0 |
| 3 | memo | memo | memo | varchar2(200) |
| 4 | money | money | money | number(28, 8) |  |  | 0 |
| 5 | pk_group | pk_group | pk_group | varchar2(20) |
| 6 | pk_job_type | pk_job_type | pk_job_type | varchar2(20) |  |  | '~' |
| 7 | pk_org | pk_org | pk_org | varchar2(20) |
| 8 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |
| 9 | pk_psndoc | pk_psndoc | pk_psndoc | varchar2(20) |  |  | '~' |
| 10 | pk_wo | pk_wo | pk_wo | char(20) | √ |
| 11 | rate | rate | rate | number(28, 8) |  |  | 0 |
| 12 | rowno | rowno | rowno | varchar2(20) |
| 13 | sequence_num | sequence_num | sequence_num | number(38, 0) |
