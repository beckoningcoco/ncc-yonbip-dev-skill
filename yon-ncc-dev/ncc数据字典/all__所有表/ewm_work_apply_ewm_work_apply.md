...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8036.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_work_apply | pk_work_apply | pk_work_apply | char(20) | √ |
| 2 | apply_clause | apply_clause | apply_clause | varchar2(80) |
| 3 | apply_date | apply_date | apply_date | char(19) |
| 4 | apply_name | apply_name | apply_name | varchar2(80) |
...
| 13 | check_opinion | check_opinion | check_opinion | varchar2(80) |
| 14 | memo | memo | memo | varchar2(200) |
| 15 | pk_applyer | pk_applyer | pk_applyer | varchar2(20) |  |  | '~' |
| 16 | pk_apply_dept | pk_apply_dept | pk_apply_dept | varchar2(20) |  |  | '~' |
| 17 | pk_apply_dept_v | pk_apply_dept_v | pk_apply_dept_v | varchar2(20) |  |  | '~' |
