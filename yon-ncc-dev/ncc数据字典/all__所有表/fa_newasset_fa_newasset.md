...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8152.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_newasset | pk_newasset | pk_newasset | char(20) | √ |
...
| 7 | bill_status | bill_status | bill_status | number(38, 0) |  |  | 0 |
| 8 | bill_type | bill_type | bill_type | varchar2(4) |
| 9 | business_date | business_date | business_date | char(19) |
| 10 | check_opinion | check_opinion | check_opinion | varchar2(1024) |
| 11 | controlrule | controlrule | controlrule | varchar2(80) |
| 12 | pk_applydapt | pk_applydapt | pk_applydapt | varchar2(20) |  |  | '~' |
| 13 | pk_applydapt_v | pk_applydapt_v | pk_applydapt_v | varchar2(20) |  |  | '~' |
| 14 | pk_applyorg | pk_applyorg | pk_applyorg | varchar2(20) |  |  | '~' |
| 15 | pk_applyorg_v | pk_applyorg_v | pk_applyorg_v | varchar2(20) |  |  | '~' |
| 16 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 17 | pk_image | pk_image | pk_image | varchar2(30) |
| 18 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 19 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 20 | pk_proposer | pk_proposer | pk_proposer | varchar2(20) |  |  | '~' |
| 21 | pk_raorg | pk_raorg | pk_raorg | varchar2(20) |  |  | '~' |
| 22 | pk_raorg_v | pk_raorg_v | pk_raorg_v | varchar2(20) |  |  | '~' |
| 23 | pk_transactor | pk_transactor | pk_transactor | varchar2(20) |  |  | '~' |
| 24 | pk_transitype | pk_transitype | pk_transitype | varchar2(20) |  |  | '~' |
| 25 | reason | reason | reason | varchar2(200) |
| 26 | saga_btxid | saga_btxid | saga_btxid | varchar2(64) |
| 27 | saga_frozen | saga_frozen | saga_frozen | number(38, 0) |  |  | 0 |
| 28 | saga_gtxid | saga_gtxid | saga_gtxid | varchar2(64) |
| 29 | saga_status | saga_status | saga_status | number(38, 0) |  |  | 0 |
