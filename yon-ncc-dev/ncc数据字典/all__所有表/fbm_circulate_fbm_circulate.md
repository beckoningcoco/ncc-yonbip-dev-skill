...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8186.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_circulate | pk_circulate | pk_circulate | char(20) | √ |
| 2 | billmoney | billmoney | billmoney | number(28, 8) |
| 3 | fbmbillno | fbmbillno | fbmbillno | varchar2(50) |
| 4 | payunit | payunit | payunit | varchar2(181) |  |  | '~' |
| 5 | payunitor | payunitor | payunitor | varchar2(20) |  |  | '~' |
| 6 | pk_curr | pk_curr | pk_curr | varchar2(20) |  |  | '~' |
| 7 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 8 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 9 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 10 | pk_register | pk_register | pk_register | varchar2(20) |  |  | '~' |
| 11 | receiveunit | receiveunit | receiveunit | varchar2(181) |  |  | '~' |
| 12 | receiveunitor | receiveunitor | receiveunitor | varchar2(20) |  |  | '~' |
