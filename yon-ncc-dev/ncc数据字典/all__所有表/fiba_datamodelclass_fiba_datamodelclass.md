...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8262.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_modelclass | pk_modelclass | pk_modelclass | char(20) | √ |
| 2 | ispreset | ispreset | ispreset | char(1) |
| 3 | name | name | name | varchar2(50) |
| 4 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 5 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 6 | pk_parent | pk_parent | pk_parent | varchar2(20) |
| 7 | sequence | sequence | sequence | varchar2(50) |
