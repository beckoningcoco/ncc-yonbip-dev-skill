...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8410.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_spepay_b | pk_spepay_b | pk_spepay_b | char(20) | √ |
...
| 19 | pk_getfinanceorg | pk_getfinanceorg | pk_getfinanceorg | varchar2(20) |  |  | '~' |
| 20 | pk_getfinanceorg_v | pk_getfinanceorg_v | pk_getfinanceorg_v | varchar2(20) |  |  | '~' |
...
| 25 | pk_sourcebillid | pk_sourcebillid | pk_sourcebillid | varchar2(20) |  |  | '~' |
| 26 | pk_sourcebillrowid | pk_sourcebillrowid | pk_sourcebillrowid | varchar2(20) |  |  | '~' |
| 27 | pk_spepay_h | pk_spepay_h | pk_spepay_h | varchar2(20) |  |  | '~' |
