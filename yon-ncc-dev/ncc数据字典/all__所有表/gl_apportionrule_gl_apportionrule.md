...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8432.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_apportionrule | pk_apportionrule | pk_apportionrule | char(20) | √ |
| 2 | apportiontype | apportiontype | apportiontype | varchar2(2) | √ |
...
| 10 | pk_accountingbook | pk_accountingbook | pk_accountingbook | varchar2(20) |  |  | '~' |
