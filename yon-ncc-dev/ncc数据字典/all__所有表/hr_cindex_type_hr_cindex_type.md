...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8795.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_cindex_type | pk_cindex_type | pk_cindex_type | char(20) | √ |
| 2 | code | code | code | varchar2(20) | √ |
| 3 | memo | memo | memo | varchar2(1500) |
...
| 10 | pk_fathertype | pk_fathertype | pk_fathertype | varchar2(20) |  |  | '~' |
