...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/8870.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | accessmothed | accessmothed | accessmothed | number(38, 0) |
| 2 | accesspath | accesspath | accesspath | varchar2(1000) |
| 3 | code | code | code | varchar2(50) | √ |
| 4 | implclass | implclass | implclass | varchar2(300) |
| 5 | name | name | name | varchar2(50) |
| 6 | otherparam | otherparam | otherparam | varchar2(2000) |
| 7 | password | password | password | varchar2(50) |
| 8 | pathparam | pathparam | pathparam | varchar2(300) |
| 9 | pk_group | pk_group | pk_group | varchar2(20) | √ |
| 10 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 11 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 12 | pk_tfdataset | pk_tfdataset | pk_tfdataset | char(20) | √ |
| 13 | remark | remark | remark | varchar2(300) |
| 14 | systemcode | systemcode | systemcode | varchar2(50) | √ |
| 15 | tftype | tftype | tftype | number(38, 0) | √ |
| 16 | usercode | usercode | usercode | varchar2(50) |
| 17 | username | username | username | varchar2(50) |
