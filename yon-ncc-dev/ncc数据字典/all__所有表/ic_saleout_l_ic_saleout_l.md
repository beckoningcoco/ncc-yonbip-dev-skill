...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/9137.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | cgeneralbid | cgeneralbid | cgeneralbid | char(20) | √ |
| 2 | cgeneralhid | cgeneralhid | cgeneralhid | char(20) | √ |
| 3 | cgenerallid | cgenerallid | cgenerallid | char(20) | √ |
| 4 | clocationid | clocationid | clocationid | varchar2(20) |  |  | '~' |
| 5 | corpoid | corpoid | corpoid | varchar2(20) |  |  | '~' |
| 6 | corpvid | corpvid | corpvid | varchar2(50) |
