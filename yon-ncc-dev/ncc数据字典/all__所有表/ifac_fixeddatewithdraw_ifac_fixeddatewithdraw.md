...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/9200.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_fixeddatewithdraw | pk_fixeddatewithdraw | pk_fixeddatewithdraw | char(20) | √ |
...
| 13 | depositinterval | depositinterval | depositinterval | number(38, 0) |
| 14 | depositorgname | depositorgname | depositorgname | varchar2(200) |
| 15 | depostbalmnt | depostbalmnt | depostbalmnt | number(28, 8) |
| 16 | enddate | enddate | enddate | char(19) |
| 17 | glcinterest | glcinterest | glcinterest | number(28, 8) |
| 18 | glcrate | glcrate | glcrate | number(28, 8) |
| 19 | glcwithdrawmnt | glcwithdrawmnt | glcwithdrawmnt | number(28, 8) |
| 20 | gllcinterest | gllcinterest | gllcinterest | number(28, 8) |
| 21 | gllcrate | gllcrate | gllcrate | number(28, 8) |
| 22 | gllcwithdrawmnt | gllcwithdrawmnt | gllcwithdrawmnt | number(28, 8) |
| 23 | interest | interest | interest | number(28, 8) |
| 24 | intervalunit | intervalunit | intervalunit | varchar2(50) |
| 25 | olcinterest | olcinterest | olcinterest | number(28, 8) |
| 26 | olcrate | olcrate | olcrate | number(28, 8) |
| 27 | olcwithdrawmnt | olcwithdrawmnt | olcwithdrawmnt | number(28, 8) |
| 28 | operatedate | operatedate | operatedate | char(19) |
| 29 | pk_aiacrate | pk_aiacrate | pk_aiacrate | varchar2(20) |  |  | '~' |
...
| 33 | pk_depositacc | pk_depositacc | pk_depositacc | varchar2(20) |  |  | '~' |
| 34 | pk_depositorg | pk_depositorg | pk_depositorg | varchar2(20) |  |  | '~' |
| 35 | pk_depositreceipt | pk_depositreceipt | pk_depositreceipt | varchar2(20) |  |  | '~' |
| 36 | pk_depostrate | pk_depostrate | pk_depostrate | varchar2(20) |  |  | '~' |
| 37 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 38 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 39 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 40 | pk_profitcenter | pk_profitcenter | pk_profitcenter | varchar2(20) |  |  | '~' |
| 41 | pk_settleacc | pk_settleacc | pk_settleacc | varchar2(20) |  |  | '~' |
| 42 | pk_srcbill | pk_srcbill | pk_srcbill | varchar2(50) |  |  | '~' |
| 43 | pk_srcbilltype | pk_srcbilltype | pk_srcbilltype | varchar2(20) |  |  | '~' |
| 44 | pk_varieties | pk_varieties | pk_varieties | varchar2(20) |  |  | '~' |
| 45 | redeposittype | redeposittype | redeposittype | varchar2(50) |
| 46 | remark | remark | remark | varchar2(181) |
| 47 | returndate | returndate | returndate | char(19) |
| 48 | returner | returner | returner | varchar2(20) |  |  | '~' |
| 49 | returntime | returntime | returntime | char(19) |
...
| 54 | srcbillcode | srcbillcode | srcbillcode | varchar2(20) |
| 55 | srcbilltypecode | srcbilltypecode | srcbilltypecode | varchar2(50) |
| 56 | submitdate | submitdate | submitdate | char(19) |
| 57 | submiter | submiter | submiter | varchar2(20) |  |  | '~' |
| 58 | submittime | submittime | submittime | char(19) |
| 59 | totalamount | totalamount | totalamount | number(28, 8) |
| 60 | vbillcode | vbillcode | vbillcode | varchar2(20) |
| 61 | vbillstate | vbillstate | vbillstate | number(38, 0) |
| 62 | voucherflag | voucherflag | voucherflag | char(1) |
| 63 | withdrawamount | withdrawamount | withdrawamount | number(28, 8) |
| 64 | withdrawdate | withdrawdate | withdrawdate | char(19) |
