...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/9449.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_enterprise | pk_enterprise | pk_enterprise | char(20) | √ |
| 2 | bissum | bissum | bissum | char(1) |
| 3 | code | code | code | varchar2(60) | √ |
...
| 15 | supportsum | supportsum | supportsum | char(1) |
