...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/9609.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_dxrela_sort | pk_dxrela_sort | pk_dxrela_sort | char(20) | √ |
| 2 | account | account | account | varchar2(1024) |
...
| 11 | parent_id | parent_id | parent_id | varchar2(20) |  |  | '~' |
