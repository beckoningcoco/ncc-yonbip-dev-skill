...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/9905.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_motrantype | pk_motrantype | pk_motrantype | char(20) | √ |
...
| 8 | fmooperationmode | fmooperationmode | fmooperationmode | number(38, 0) |
...
| 12 | vtrantypecode | vtrantypecode | vtrantypecode | varchar2(50) |
