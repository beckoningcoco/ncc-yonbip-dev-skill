...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/9951.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | creqpickmid | creqpickmid | creqpickmid | char(20) | √ |
| 2 | auditor | auditor | auditor | varchar2(20) |  |  | '~' |
| 3 | billmaker | billmaker | billmaker | varchar2(20) |  |  | '~' |
| 4 | crequesttype | crequesttype | crequesttype | varchar2(20) |  |  | '~' |
| 5 | dmakedate | dmakedate | dmakedate | char(19) |
| 6 | drequestdate | drequestdate | drequestdate | char(19) |
...
| 41 | modifiedtime | modifiedtime | modifiedtime | varchar2(19) |
