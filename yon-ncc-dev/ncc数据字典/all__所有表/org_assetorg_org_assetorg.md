...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10155.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_assetorg | pk_assetorg | pk_assetorg | char(20) | √ |
...
| 13 | pk_financeorg | pk_financeorg | pk_financeorg | varchar2(20) |  |  | '~' |
| 14 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 15 | pk_liacenter | pk_liacenter | pk_liacenter | varchar2(20) |  |  | '~' |
...
| 26 | vno | vno | vno | varchar2(50) |
| 27 | vstartdate | vstartdate | vstartdate | char(19) |
