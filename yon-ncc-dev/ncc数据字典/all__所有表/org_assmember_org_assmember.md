...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10158.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | idx | idx | idx | number(38, 0) |
| 2 | innercode | innercode | innercode | varchar2(200) |
| 3 | pk_ass | pk_ass | pk_ass | varchar2(20) |
| 4 | pk_assmember | pk_assmember | pk_assmember | char(20) |
