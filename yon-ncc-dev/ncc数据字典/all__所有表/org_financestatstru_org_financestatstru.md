...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10206.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | code | code | code | varchar2(40) |
| 2 | enablestate | enablestate | enablestate | number(38, 0) |
| 3 | isdefault | isdefault | isdefault | char(1) |
| 4 | memo | memo | memo | varchar2(200) |
| 5 | mnecode | mnecode | mnecode | varchar2(75) |
...
| 12 | pk_financestatstru | pk_financestatstru | pk_financestatstru | char(20) |
