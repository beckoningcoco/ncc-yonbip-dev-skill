...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10442.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_route_road_b | pk_route_road_b | pk_route_road_b | char(20) | √ |
| 2 | memo | memo | memo | varchar2(200) |
| 3 | pk_equip | pk_equip | pk_equip | varchar2(20) |  |  | '~' |
...
| 8 | pk_route_road | pk_route_road | pk_route_road | char(20) | √ |
| 9 | pk_standard | pk_standard | pk_standard | varchar2(20) |  |  | '~' |
