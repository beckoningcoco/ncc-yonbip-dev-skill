...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10534.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_approveresult | pk_approveresult | pk_approveresult | char(20) | √ |
| 2 | approve_date | approve_date | approve_date | char(19) |
| 3 | approve_opinion | approve_opinion | approve_opinion | varchar2(200) |
| 4 | approve_result | approve_result | approve_result | number(38, 0) |
...
| 21 | pk_psndoc | pk_psndoc | pk_psndoc | varchar2(20) |  |  | '~' |
