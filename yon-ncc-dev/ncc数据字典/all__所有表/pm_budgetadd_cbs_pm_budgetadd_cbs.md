...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10542.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_budgetadd_cbs | pk_budgetadd_cbs | pk_budgetadd_cbs | char(20) | √ |
...
| 11 | is_leaf_node | is_leaf_node | is_leaf_node | char(1) |
| 12 | memo | memo | memo | varchar2(300) |
| 13 | pk_budgetadd | pk_budgetadd | pk_budgetadd | char(20) | √ |
