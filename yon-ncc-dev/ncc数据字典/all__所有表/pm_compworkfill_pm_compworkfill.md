...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10560.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_compworkfill | pk_compworkfill | pk_compworkfill | char(20) | √ |
...
| 11 | evolve_state | evolve_state | evolve_state | varchar2(50) |
| 12 | finish_progress | finish_progress | finish_progress | varchar2(28) |
| 13 | finish_work_date | finish_work_date | finish_work_date | char(19) |
| 14 | memo | memo | memo | varchar2(200) |
| 15 | old_report_date | old_report_date | old_report_date | char(19) |
| 16 | old_report_state | old_report_state | old_report_state | varchar2(20) |  |  | '~' |
| 17 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 18 | pk_indexplan | pk_indexplan | pk_indexplan | varchar2(20) |  |  | '~' |
...
| 23 | pk_report_state | pk_report_state | pk_report_state | varchar2(20) |  |  | '~' |
| 24 | pk_transitype | pk_transitype | pk_transitype | varchar2(20) |  |  | '~' |
| 25 | report_date | report_date | report_date | char(19) |
| 26 | report_dept | report_dept | report_dept | varchar2(20) |  |  | '~' |
| 27 | report_dept_v | report_dept_v | report_dept_v | varchar2(20) |  |  | '~' |
| 28 | report_person | report_person | report_person | varchar2(20) |  |  | '~' |
| 29 | start_work_date | start_work_date | start_work_date | char(19) |
