...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10589.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_discontrexepro | pk_discontrexepro | pk_discontrexepro | char(20) | √ |
| 2 | exe_date | exe_date | exe_date | char(19) |
| 3 | exe_flow | exe_flow | exe_flow | varchar2(40) |
| 4 | pk_discontr | pk_discontr | pk_discontr | char(20) | √ |
