...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10590.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_discontritems | pk_discontritems | pk_discontritems | char(20) | √ |
| 2 | memo | memo | memo | varchar2(200) |
| 3 | other_info | other_info | other_info | varchar2(200) |
| 4 | pk_ct_termset | pk_ct_termset | pk_ct_termset | varchar2(20) |  |  | '~' |
| 5 | pk_discontr | pk_discontr | pk_discontr | char(20) | √ |
| 6 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 7 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 8 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 9 | rowno | rowno | rowno | varchar2(20) |
| 10 | vtermcontent | vtermcontent | vtermcontent | varchar2(200) |
