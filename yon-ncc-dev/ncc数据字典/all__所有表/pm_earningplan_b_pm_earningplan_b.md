...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10595.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_earningplan_b | pk_earningplan_b | pk_earningplan_b | char(20) | √ |
| 2 | actual_mny | actual_mny | actual_mny | number(28, 8) |
| 3 | actual_mny_curr | actual_mny_curr | actual_mny_curr | number(28, 8) |
| 4 | complete_rate | complete_rate | complete_rate | number(28, 8) |
| 5 | contr_taxmny | contr_taxmny | contr_taxmny | number(28, 8) |
| 6 | memo | memo | memo | varchar2(200) |
| 7 | pk_contr | pk_contr | pk_contr | varchar2(20) |  |  | '~' |
| 8 | pk_customer | pk_customer | pk_customer | varchar2(20) |  |  | '~' |
| 9 | pk_earningplan | pk_earningplan | pk_earningplan | char(20) | √ |
| 10 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 11 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 12 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 13 | pk_project | pk_project | pk_project | varchar2(20) |  |  | '~' |
| 14 | plan_mny | plan_mny | plan_mny | number(28, 8) |
