...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10603.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_expendplan | pk_expendplan | pk_expendplan | char(20) | √ |
| 2 | assignstatus | assignstatus | assignstatus | number(38, 0) |
...
| 10 | check_date | check_date | check_date | char(19) |
| 11 | check_mny | check_mny | check_mny | number(28, 8) |
| 12 | check_opinion | check_opinion | check_opinion | varchar2(200) |
| 13 | making_mode | making_mode | making_mode | number(38, 0) |
| 14 | memo | memo | memo | varchar2(200) |
| 15 | pk_accperiodmonth | pk_accperiodmonth | pk_accperiodmonth | varchar2(20) |  |  | '~' |
| 16 | pk_accperiodscheme | pk_accperiodscheme | pk_accperiodscheme | varchar2(20) |  |  | '~' |
| 17 | pk_dept | pk_dept | pk_dept | varchar2(20) |  |  | '~' |
| 18 | pk_dept_v | pk_dept_v | pk_dept_v | varchar2(20) |  |  | '~' |
| 19 | pk_financeorg | pk_financeorg | pk_financeorg | varchar2(20) |  |  | '~' |
| 20 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 21 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 22 | pk_org_v | pk_org_v | pk_org_v | varchar2(20) |  |  | '~' |
| 23 | pk_project | pk_project | pk_project | varchar2(20) |  |  | '~' |
| 24 | pk_psndoc | pk_psndoc | pk_psndoc | varchar2(20) |  |  | '~' |
| 25 | pk_transitype | pk_transitype | pk_transitype | varchar2(20) |  |  | '~' |
| 26 | plan_date | plan_date | plan_date | char(19) |
| 27 | plan_mny | plan_mny | plan_mny | number(28, 8) |
| 28 | transi_type | transi_type | transi_type | varchar2(50) |
