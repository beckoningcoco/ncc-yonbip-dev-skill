...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/10809.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_adjdiscount | pk_adjdiscount | pk_adjdiscount | char(20) | √ |
| 2 | approver | approver | approver | varchar2(20) |  |  | '~' |
| 3 | badjustdiscount | badjustdiscount | badjustdiscount | char(1) |
| 4 | billmaker | billmaker | billmaker | varchar2(20) |  |  | '~' |
| 5 | ctrantypeid | ctrantypeid | ctrantypeid | varchar2(20) |
| 6 | dadjustpricedate | dadjustpricedate | dadjustpricedate | char(19) |
...
| 11 | pk_bgtask | pk_bgtask | pk_bgtask | varchar2(20) |
| 12 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 13 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 14 | pk_tariffdef | pk_tariffdef | pk_tariffdef | varchar2(20) |  |  | '~' |
| 15 | taudittime | taudittime | taudittime | char(19) |
| 16 | vadjustpriceno | vadjustpriceno | vadjustpriceno | varchar2(50) |
