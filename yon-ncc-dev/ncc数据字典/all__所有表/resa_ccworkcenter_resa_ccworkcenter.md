...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11144.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_ccworkcenter | pk_ccworkcenter | pk_ccworkcenter | char(20) | √ |
| 2 | dataoriginflag | dataoriginflag | dataoriginflag | number(38, 0) |
| 3 | pk_costcenter | pk_costcenter | pk_costcenter | char(20) | √ |
| 4 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 5 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 6 | pk_workcenter | pk_workcenter | pk_workcenter | varchar2(20) |  |  | '~' |
