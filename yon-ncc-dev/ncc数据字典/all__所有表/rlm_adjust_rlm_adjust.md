...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11173.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_adjust | pk_adjust | pk_adjust | char(20) | √ |
...
| 10 | bill_type_src | bill_type_src | bill_type_src | varchar2(20) |
...
| 23 | pk_bill_src | pk_bill_src | pk_bill_src | varchar2(20) |
| 24 | pk_bill_src_cooperate | pk_bill_src_cooperate | pk_bill_src_cooperate | varchar2(20) |
| 25 | pk_confirmer | pk_confirmer | pk_confirmer | varchar2(20) |  |  | '~' |
| 26 | pk_contract_base | pk_contract_base | pk_contract_base | varchar2(20) |  |  | '~' |
| 27 | pk_contract_v | pk_contract_v | pk_contract_v | varchar2(20) |  |  | '~' |
| 28 | pk_currency | pk_currency | pk_currency | varchar2(20) |  |  | '~' |
| 29 | pk_currency_origin | pk_currency_origin | pk_currency_origin | varchar2(20) |  |  | '~' |
| 30 | pk_customer | pk_customer | pk_customer | varchar2(20) |  |  | '~' |
| 31 | pk_dept | pk_dept | pk_dept | varchar2(20) |  |  | '~' |
| 32 | pk_dept_v | pk_dept_v | pk_dept_v | varchar2(20) |  |  | '~' |
...
| 39 | pk_recorder | pk_recorder | pk_recorder | varchar2(20) |  |  | '~' |
| 40 | pk_supplier | pk_supplier | pk_supplier | varchar2(20) |  |  | '~' |
| 41 | pk_transitype | pk_transitype | pk_transitype | varchar2(20) |  |  | '~' |
| 42 | transi_type | transi_type | transi_type | varchar2(30) |
| 43 | transi_type_src | transi_type_src | transi_type_src | varchar2(30) |
| 44 | transi_type_src_cooperate | transi_type_src_cooperate | transi_type_src_cooperate | varchar2(30) |
