...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11211.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_rentpay_d | pk_rentpay_d | pk_rentpay_d | char(20) | √ |
...
| 18 | pk_rentpay | pk_rentpay | pk_rentpay | char(20) | √ |
...
| 34 | rowno_src | rowno_src | rowno_src | varchar2(20) |
| 35 | start_date | start_date | start_date | char(19) |
