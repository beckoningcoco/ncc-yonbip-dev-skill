...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11244.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_contract_h | pk_contract_h | pk_contract_h | char(20) | √ |
| 2 | change_date | change_date | change_date | char(19) |
| 3 | change_reason | change_reason | change_reason | varchar2(80) |
| 4 | contract_verion | contract_verion | contract_verion | number(28, 8) |
| 5 | memo | memo | memo | varchar2(200) |
| 6 | pk_changer | pk_changer | pk_changer | varchar2(20) |  |  | '~' |
| 7 | pk_contract | pk_contract | pk_contract | char(20) | √ |
