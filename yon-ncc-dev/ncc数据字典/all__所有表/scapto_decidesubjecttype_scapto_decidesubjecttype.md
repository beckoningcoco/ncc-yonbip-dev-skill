...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11307.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_decidesubjecttype | pk_decidesubjecttype | pk_decidesubjecttype | char(20) | √ |
| 2 | bispreset | bispreset | bispreset | char(1) |
| 3 | code | code | code | varchar2(80) | √ |
| 4 | crowno | crowno | crowno | number(38, 0) |
| 5 | enablestate | enablestate | enablestate | char(1) |
| 6 | memo | memo | memo | varchar2(400) |
| 7 | memo2 | memo2 | memo2 | varchar2(400) |
| 8 | memo3 | memo3 | memo3 | varchar2(400) |
| 9 | memo4 | memo4 | memo4 | varchar2(400) |
| 10 | memo5 | memo5 | memo5 | varchar2(400) |
| 11 | memo6 | memo6 | memo6 | varchar2(400) |
| 12 | name | name | name | varchar2(400) |
| 13 | name2 | name2 | name2 | varchar2(400) |
| 14 | name3 | name3 | name3 | varchar2(400) |
| 15 | name4 | name4 | name4 | varchar2(400) |
| 16 | name5 | name5 | name5 | varchar2(400) |
| 17 | name6 | name6 | name6 | varchar2(400) |
| 18 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 19 | pk_leadershiptype | pk_leadershiptype | pk_leadershiptype | varchar2(20) |  |  | '~' |
