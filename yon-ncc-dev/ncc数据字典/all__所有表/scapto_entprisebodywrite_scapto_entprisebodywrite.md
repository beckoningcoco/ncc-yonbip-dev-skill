...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11318.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_entprisebodywrite | pk_entprisebodywrite | pk_entprisebodywrite | char(20) | √ |
...
| 15 | parent_id | parent_id | parent_id | varchar2(50) | √ |
| 16 | pk_enterprise_mainbody | pk_enterprise_mainbody | pk_enterprise_mainbody | varchar2(20) |
| 17 | rate | rate | rate | number(28, 8) |
| 18 | record_id | record_id | record_id | varchar2(50) | √ |
| 19 | regulation_count | regulation_count | regulation_count | number(38, 0) |
| 20 | remark | remark | remark | varchar2(500) |
| 21 | structure_code | structure_code | structure_code | varchar2(200) |
| 22 | subject_count | subject_count | subject_count | number(38, 0) |
| 23 | upload_flag | upload_flag | upload_flag | varchar2(50) |
| 24 | upload_time | upload_time | upload_time | char(19) |
