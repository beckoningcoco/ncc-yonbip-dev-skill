...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11446.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | enablestatus | enablestatus | enablestatus | number(38, 0) |
| 2 | pk_custom | pk_custom | pk_custom | varchar2(20) |  |  | '~' |
| 3 | pk_custquaorg | pk_custquaorg | pk_custquaorg | char(20) | √ |
