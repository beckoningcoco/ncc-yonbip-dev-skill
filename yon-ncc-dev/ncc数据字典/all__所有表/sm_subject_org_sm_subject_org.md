...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11637.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_subject_org | pk_subject_org | pk_subject_org | char(20) | √ |
| 2 | isrule | isrule | isrule | varchar2(20) |
| 3 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 4 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 5 | rulepar | rulepar | rulepar | varchar2(200) |
