...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11657.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_user_defaultpwd | pk_user_defaultpwd | pk_user_defaultpwd | char(20) | √ |
| 2 | defaultpwd | defaultpwd | defaultpwd | varchar2(50) |
