...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11689.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | ccreditauditid | ccreditauditid | ccreditauditid | char(20) | √ |
| 2 | approver | approver | approver | varchar2(20) |  |  | '~' |
| 3 | billmaker | billmaker | billmaker | varchar2(20) |  |  | '~' |
| 4 | capplydeptid | capplydeptid | capplydeptid | varchar2(20) |  |  | '~' |
| 5 | capplyerid | capplyerid | capplyerid | varchar2(20) |  |  | '~' |
| 6 | ctrantypeid | ctrantypeid | ctrantypeid | varchar2(20) |
| 7 | dauditdate | dauditdate | dauditdate | varchar2(19) |
