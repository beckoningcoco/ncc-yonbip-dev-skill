...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11903.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_eventlistener | pk_eventlistener | pk_eventlistener | char(20) | √ |
| 2 | eventtype | eventtype | eventtype | varchar2(20) |
| 3 | extendinfo | extendinfo | extendinfo | varchar2(500) |
