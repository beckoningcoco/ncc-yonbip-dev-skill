...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/11917.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_priority | pk_priority | pk_priority | char(20) | √ |
| 2 | code | code | code | varchar2(50) |
| 3 | formula | formula | formula | varchar2(2000) |
| 4 | formulashow | formulashow | formulashow | varchar2(2000) |
...
| 11 | ordernum | ordernum | ordernum | number(38, 0) |
| 12 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 13 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 14 | pk_sscunit | pk_sscunit | pk_sscunit | varchar2(20) |  |  | '~' |
| 15 | pk_workinggroup | pk_workinggroup | pk_workinggroup | varchar2(50) |
| 16 | upgraderule | upgraderule | upgraderule | varchar2(50) |
| 17 | upgraderulenum | upgraderulenum | upgraderulenum | number(38, 0) |
