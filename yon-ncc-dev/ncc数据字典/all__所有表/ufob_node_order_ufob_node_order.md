...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12332.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_order | pk_order | pk_order | char(20) | √ |
| 2 | isenable | isenable | isenable | char(1) |
| 3 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 4 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 5 | pk_report | pk_report | pk_report | char(20) |
| 6 | pk_schema | pk_schema | pk_schema | char(20) |
| 7 | seq | seq | seq | number(38, 0) |
