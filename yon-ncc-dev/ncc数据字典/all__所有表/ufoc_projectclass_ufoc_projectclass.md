...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12355.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_projectclass | pk_projectclass | pk_projectclass | char(20) | √ |
...
| 14 | parent_id | parent_id | parent_id | varchar2(20) |  |  | '~' |
