...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12377.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_blccinvcanc | pk_blccinvcanc | pk_blccinvcanc | char(20) | √ |
| 2 | date_canc | date_canc | date_canc | char(19) |
| 3 | invno_canc | invno_canc | invno_canc | varchar2(4000) |
| 4 | note_canc | note_canc | note_canc | varchar2(256) |
| 5 | pk_blcc | pk_blcc | pk_blcc | varchar2(20) |  |  | '~' |
| 6 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 7 | pk_invcate | pk_invcate | pk_invcate | char(20) |
