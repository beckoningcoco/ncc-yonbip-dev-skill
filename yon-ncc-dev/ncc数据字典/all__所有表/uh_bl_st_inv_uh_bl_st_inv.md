...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12416.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_stinv | pk_stinv | pk_stinv | char(20) | √ |
| 2 | code_hp | code_hp | code_hp | varchar2(30) |
| 3 | flag_use | flag_use | flag_use | char(1) |
| 4 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 5 | pk_inv | pk_inv | pk_inv | varchar2(20) |  |  | '~' |
