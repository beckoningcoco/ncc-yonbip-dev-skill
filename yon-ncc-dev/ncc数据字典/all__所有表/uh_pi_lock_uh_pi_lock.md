...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12716.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_patilock | pk_patilock | pk_patilock | char(20) | √ |
| 2 | dt_locktype | dt_locktype | dt_locktype | varchar2(50) |
| 3 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 4 | pk_locktype | pk_locktype | pk_locktype | varchar2(20) |  |  | '~' |
