...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12789.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_schsrvdt | pk_schsrvdt | pk_schsrvdt | char(20) | √ |
| 2 | minute_per | minute_per | minute_per | number(38, 0) |
| 3 | note | note | note | varchar2(4000) |
| 4 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 5 | pk_org | pk_org | pk_org | varchar2(50) |  |  | '~' |
| 6 | pk_schsrv | pk_schsrv | pk_schsrv | varchar2(50) |  |  | '~' |
