...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12791.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_schsrvpool | pk_schsrvpool | pk_schsrvpool | char(20) | √ |
| 2 | code_pool | code_pool | code_pool | varchar2(30) |
| 3 | name_pool | name_pool | name_pool | varchar2(50) |
| 4 | name_pool2 | name_pool2 | name_pool2 | varchar2(50) |
| 5 | name_pool3 | name_pool3 | name_pool3 | varchar2(50) |
| 6 | name_pool4 | name_pool4 | name_pool4 | varchar2(50) |
| 7 | name_pool5 | name_pool5 | name_pool5 | varchar2(50) |
| 8 | name_pool6 | name_pool6 | name_pool6 | varchar2(50) |
| 9 | note | note | note | varchar2(4000) |
| 10 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 11 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 12 | pk_schsrv | pk_schsrv | pk_schsrv | varchar2(20) |  |  | '~' |
