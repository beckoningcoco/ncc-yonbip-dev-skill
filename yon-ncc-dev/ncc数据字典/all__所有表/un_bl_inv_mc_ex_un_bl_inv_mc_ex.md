...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12828.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_mth_exec | pk_mth_exec | pk_mth_exec | char(20) | √ |
| 2 | date_ex | date_ex | date_ex | char(19) |
| 3 | flag_mc | flag_mc | flag_mc | char(1) |
| 4 | pk_accperiodmonth | pk_accperiodmonth | pk_accperiodmonth | varchar2(20) |  |  | '~' |
