...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/12846.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_test_schweek | pk_test_schweek | pk_test_schweek | char(20) | √ |
| 2 | dateslotname | dateslotname | dateslotname | varchar2(50) |
| 3 | fri | fri | fri | varchar2(50) |
| 4 | mon | mon | mon | varchar2(50) |
| 5 | pk_dateslot | pk_dateslot | pk_dateslot | varchar2(20) |  |  | '~' |
| 6 | pk_schres | pk_schres | pk_schres | varchar2(20) |  |  | '~' |
| 7 | pk_schsrv | pk_schsrv | pk_schsrv | varchar2(50) |  |  | '~' |
| 8 | resname | resname | resname | varchar2(50) |
| 9 | sat | sat | sat | varchar2(50) |
| 10 | srvname | srvname | srvname | varchar2(50) |
| 11 | sun | sun | sun | varchar2(50) |
| 12 | thu | thu | thu | varchar2(50) |
| 13 | tue | tue | tue | varchar2(50) |
| 14 | wed | wed | wed | varchar2(50) |
