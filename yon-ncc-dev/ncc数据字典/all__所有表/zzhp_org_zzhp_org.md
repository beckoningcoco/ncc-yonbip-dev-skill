...
> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/13055.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_hporg | pk_hporg | pk_hporg | char(20) | √ |
| 2 | code | code | code | varchar2(30) |
| 3 | name | name | name | varchar2(50) |
| 4 | note | note | note | varchar2(256) |
| 5 | pk_group | pk_group | pk_group | varchar2(20) |  |  | '~' |
| 6 | pk_org | pk_org | pk_org | varchar2(20) |  |  | '~' |
| 7 | pk_org_hp | pk_org_hp | pk_org_hp | varchar2(20) |  |  | '~' |
| 8 | pk_payer | pk_payer | pk_payer | varchar2(20) |  |  | '~' |
