...
**组织结构_财务统计体系 (org_financestatstru / nc.vo.corg.FinanceStatStruVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/4060.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_financestatstru | 财务统计体系主键 | pk_financestatstru | char(20) | √ | 主键 (UFID) |
