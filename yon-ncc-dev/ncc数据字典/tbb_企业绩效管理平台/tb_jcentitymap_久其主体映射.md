...
**久其主体映射 (tb_jcentitymap / nc.vo.oba.vo.JCEntityMapVO)**

> https://community.yonyou.com/datadict/datadict-2105yiliao/ddc/5723.html

| 序号 | 属性编码 | 属性名称 | 字段编码 | 字段类型 | 是否必输 | 引用模型 | 默认值 | 取值范围/枚举 |
|------|------|------|------|------|------|------|------|------|
| 1 | pk_obj | 主键 | pk_obj | char(20) | √ | 主键 (UFID) |
| 2 | pk_group | 集团 | pk_group | varchar(20) |  | 字符串 (String) |
| 3 | jcentityname | 久其企业名称 | jcentityname | varchar(200) |  | 字符串 (String) |
| 4 | jcecntitycode | 久其企业编码 | jcecntitycode | varchar(100) |  | 字符串 (String) |
| 5 | pk_jcentity | 久其企业PK | pk_jcentity | varchar(50) |  | 字符串 (String) |
| 6 | nccentityname | 业务单元名称 | nccentityname | varchar(200) |  | 字符串 (String) |
| 7 | nccecntitycode | 业务单元编码 | nccecntitycode | varchar(100) |  | 字符串 (String) |
| 8 | pk_nccentity | 业务单元pk | pk_nccentity | varchar(20) |  | 字符串 (String) |
