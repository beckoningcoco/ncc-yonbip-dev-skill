...
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProductAlbums)) {
            return false;
        }
        ProductAlbums other = (ProductAlbums)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ProductAlbums;
    }
    ...
    public String toString() {
        return "ProductAlbums(folder=" + this.getFolder() + ", productId=" + this.getProductId() + ", sort=" + this.getSort() + ", type=" + this.getType() + ", size=" + this.getSize() + ", imgName=" + this.getImgName() + ", id=" + this.getId() + ", _status=" + this.get_status() + ")";
    }
}
