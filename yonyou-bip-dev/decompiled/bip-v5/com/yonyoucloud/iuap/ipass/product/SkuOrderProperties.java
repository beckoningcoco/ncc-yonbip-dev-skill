...
public class SkuOrderProperties
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SkuOrderProperties)) {
            return false;
        }
        SkuOrderProperties other = (SkuOrderProperties)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof SkuOrderProperties;
    }
    ...
    public String toString() {
        return "SkuOrderProperties(id=" + this.getId() + ", productId=" + this.getProductId() + ", skuId=" + this.getSkuId() + ", productApplyRangeId=" + this.getProductApplyRangeId() + ", skuPropertyTypeId=" + this.getSkuPropertyTypeId() + ", skuPropertyTypeId_showItem=" + this.getSkuPropertyTypeId_showItem() + ", skuPropertyTypeId_alias=" + this.getSkuPropertyTypeId_alias() + ", skuPropertyTypeId_type=" + this.getSkuPropertyTypeId_type() + ", skuPropertyTypeId_userdefMode=" + this.getSkuPropertyTypeId_userdefMode() + ", isShow=" + this.getIsShow() + ", isRequired=" + this.getIsRequired() + ", iLimitNum=" + this.getILimitNum() + ", iOrder=" + this.getIOrder() + ", _status=" + this.get_status() + ")";
    }
}
