...
public interface IProductDerivativeService {
    public Pager tagByPage(TagQryDTO var1) throws Exception;

    public Pager brandByPage(BrandQryDTO var1) throws Exception;
    ...
    public Pager listProductSpecItemByPage(ProductSpecItemQryDTO var1) throws Exception;
