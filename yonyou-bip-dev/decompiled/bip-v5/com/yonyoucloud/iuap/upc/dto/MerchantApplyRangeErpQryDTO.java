...
public class MerchantApplyRangeErpQryDTO
extends UPCPager
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MerchantApplyRangeErpQryDTO)) {
            return false;
        }
        MerchantApplyRangeErpQryDTO other = (MerchantApplyRangeErpQryDTO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MerchantApplyRangeErpQryDTO;
    }
    ...
    public String toString() {
        return "MerchantApplyRangeErpQryDTO(funcTypeList=" + this.getFuncTypeList() + ", merchantId=" + this.getMerchantId() + ", showGlobal=" + this.getShowGlobal() + ", pubts=" + this.getPubts() + ", existPotential=" + this.getExistPotential() + ")";
    }
}
