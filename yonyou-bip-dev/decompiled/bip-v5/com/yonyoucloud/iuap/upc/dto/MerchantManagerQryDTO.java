...
public class MerchantManagerQryDTO
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MerchantManagerQryDTO)) {
            return false;
        }
        MerchantManagerQryDTO other = (MerchantManagerQryDTO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MerchantManagerQryDTO;
    }
    ...
    public String toString() {
        return "MerchantManagerQryDTO(fields=" + Arrays.deepToString(this.getFields()) + ", yhtUserId=" + this.getYhtUserId() + ")";
    }
}
