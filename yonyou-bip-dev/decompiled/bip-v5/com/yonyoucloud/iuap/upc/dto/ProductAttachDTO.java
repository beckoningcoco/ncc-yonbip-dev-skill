...
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ProductAttachDTO)) {
            return false;
        }
        ProductAttachDTO other = (ProductAttachDTO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ProductAttachDTO;
    }
    ...
    public String toString() {
        return "ProductAttachDTO(productId=" + this.getProductId() + ", folder=" + this.getFolder() + ", fileName=" + this.getFileName() + ", sort=" + this.getSort() + ", type=" + this.getType() + ", size=" + this.getSize() + ")";
    }
}
