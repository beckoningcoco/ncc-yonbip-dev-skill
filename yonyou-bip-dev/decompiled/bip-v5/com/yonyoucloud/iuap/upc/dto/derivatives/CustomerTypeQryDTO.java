...
public class CustomerTypeQryDTO
extends BaseQueryVO
implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CustomerTypeQryDTO)) {
            return false;
        }
        CustomerTypeQryDTO other = (CustomerTypeQryDTO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof CustomerTypeQryDTO;
    }
    ...
    public String toString() {
        return "CustomerTypeQryDTO(id=" + this.getId() + ", code=" + this.getCode() + ", name=" + this.getName() + ", beganTime=" + this.getBeganTime() + ")";
    }
}
