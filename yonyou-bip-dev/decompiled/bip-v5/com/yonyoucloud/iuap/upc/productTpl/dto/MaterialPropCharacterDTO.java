...
public class MaterialPropCharacterDTO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MaterialPropCharacterDTO)) {
            return false;
        }
        MaterialPropCharacterDTO other = (MaterialPropCharacterDTO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MaterialPropCharacterDTO;
    }
    ...
    public String toString() {
        return "MaterialPropCharacterDTO(characteristics=" + this.getCharacteristics() + ", characteristicsType=" + this.getCharacteristicsType() + ", characteristicsName=" + this.getCharacteristicsName() + ", characterCode=" + this.getCharacterCode() + ", dataType=" + this.getDataType() + ", iOrder=" + this.getIOrder() + ", webShow=" + this.getWebShow() + ", characterName=" + this.getCharacterName() + ")";
    }
}
