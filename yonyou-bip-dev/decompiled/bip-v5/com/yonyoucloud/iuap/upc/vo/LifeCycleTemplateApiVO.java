...
import com.yonyoucloud.iuap.upc.vo.LifeCycleDetailVO;
import com.yonyoucloud.iuap.upc.vo.MultilingualVO;
import java.util.List;

@JsonInclude(value=JsonInclude.Include.NON_NULL)
public class LifeCycleTemplateApiVO {
    private String id;
    private String code;
    @Deprecated
    ...
    private List<LifeCycleDetailVO> lifeCycleDetail;
    ...
    public List<LifeCycleDetailVO> getLifeCycleDetail() {
    ...
    public void setLifeCycleDetail(List<LifeCycleDetailVO> lifeCycleDetail) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LifeCycleTemplateApiVO)) {
            return false;
        }
        LifeCycleTemplateApiVO other = (LifeCycleTemplateApiVO)o;
        ...
        List<LifeCycleDetailVO> this$lifeCycleDetail = this.getLifeCycleDetail();
        List<LifeCycleDetailVO> other$lifeCycleDetail = other.getLifeCycleDetail();
        if (this$lifeCycleDetail == null ? other$lifeCycleDetail != null : !((Object)this$lifeCycleDetail).equals(other$lifeCycleDetail)) {
            return false;
        }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LifeCycleTemplateApiVO;
    }
    ...
    public int hashCode() {
        ...
        List<LifeCycleDetailVO> $lifeCycleDetail = this.getLifeCycleDetail();
        result = result * 59 + ($lifeCycleDetail == null ? 43 : ((Object)$lifeCycleDetail).hashCode());
    ...
    public String toString() {
        return "LifeCycleTemplateApiVO(id=" + this.getId() + ", code=" + this.getCode() + ", name=" + this.getName() + ", name_multiLangText=" + this.getName_multiLangText() + ", systemFlag=" + this.getSystemFlag() + ", stopstatus=" + this.getStopstatus() + ", lifeCycleDetail=" + this.getLifeCycleDetail() + ", entityStatus=" + this.getEntityStatus() + ")";
    }
}
