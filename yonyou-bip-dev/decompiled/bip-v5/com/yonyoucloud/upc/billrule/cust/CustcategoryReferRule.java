...
@Component(value="custcategoryReferRule")
public class CustcategoryReferRule
extends AbstractCommonRule {
    ...
    public RuleExecuteResult execute(BillContext billContext, Map<String, Object> paramMap) throws Exception {
        ...
        if ("aa_custcategory".equals(billnum)) {
            gridFilter.appendCondition(ConditionOperator.and, new SimpleFilterVO[]{new SimpleFilterVO("level", "lt", (Object)5)});
            if (bizObject != null && bizObject.getId() != null) {
                gridFilter.appendCondition(ConditionOperator.and, new SimpleFilterVO[]{new SimpleFilterVO("id", "nin", ProductClsUtils.getInstance().getNodeWithChildren(Long.parseLong(bizObject.get("id").toString()), "aa.custcategory.CustCategory"))});
            }
        }
        if (!MerchantUtils.getAllowSelectNonLeafNodes()) {
            ...
            TreeApplyRangeUtils.getInstance().getCustCategoryFilter(orgId, gridFilter);
        } else {
