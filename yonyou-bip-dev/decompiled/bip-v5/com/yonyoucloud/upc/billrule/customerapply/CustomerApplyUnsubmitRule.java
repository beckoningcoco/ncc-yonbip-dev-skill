...
@Component(value="customerApplyUnsubmitRule")
public class CustomerApplyUnsubmitRule
extends AbstractCommonRule {
    public RuleExecuteResult execute(BillContext billContext, Map<String, Object> map) throws Exception {
        ...
        for (BizObject bio : bills) {
            ...
            if (null == apply.get("status") || !"1".equals(apply.get("status").toString())) continue;
            throw new CoreDocBusinessException(CoreExtrateBusinessErrorEnum.ERROR_ENUM_000_527_800094);
        }
