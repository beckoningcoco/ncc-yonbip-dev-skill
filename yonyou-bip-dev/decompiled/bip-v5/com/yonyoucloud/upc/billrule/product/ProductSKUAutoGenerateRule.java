 ...
 *  com.yonyou.ucf.mdd.ext.trans.itf.ISagaRule
...
@Component(value="productSKUAutoGenerateRule")
public class ProductSKUAutoGenerateRule
extends AbstractCommonRule
implements ISagaRule {
    ...
    private static String AUTOSKU_CANCEL_KEY = "AUTOSKU_CANCEL_KEY";

    public RuleExecuteResult execute(BillContext billContext, Map<String, Object> paramMap) throws Exception {
        BillDataDto billDataDto = (BillDataDto)this.getParam(paramMap);
        if (null == billContext || billDataDto == null) {
            throw new CoreDocBusinessException(CoreDocBusinessErrorEnum.PRODUCT_BILL_PARAM_IS_NULL);
        }
    ...
    private void generateSKUs(List<Map> data, String productIdItem, String skuIdItem, Long transactionId, Map<String, Object> cancelData) throws Exception {
