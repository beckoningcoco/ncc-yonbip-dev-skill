...
@Component(value="saleareaBeforeListQueryRule")
public class SaleareaBeforeListQueryRule
extends AbstractCommonRule {
    ...
    public RuleExecuteResult execute(BillContext billContext, Map<String, Object> paramMap) throws Exception {
        ...
        if ("aa_salearealist".equals(billContext.getBillnum()) && this.pubOptionService.getOrgGlobalShare("aa.salearea.SaleArea").booleanValue() && (billDataDto = (BillDataDto)this.getParam(paramMap)) != null && billDataDto.getCondition() != null && (vos = billDataDto.getCondition().getCommonVOs()) != null) {
            ArrayList<FilterCommonVO> newVOs = new ArrayList<FilterCommonVO>();
            for (FilterCommonVO vo : vos) {
                if ("saleAreaApplyRange_orgId".equalsIgnoreCase(vo.getItemName())) continue;
                newVOs.add(vo);
            }
