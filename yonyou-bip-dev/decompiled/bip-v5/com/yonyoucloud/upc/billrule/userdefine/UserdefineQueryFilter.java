...
@Component(value="userdefineQueryFilter")
public class UserdefineQueryFilter
extends AbstractCommonRule {
    public RuleExecuteResult execute(BillContext billContext, Map<String, Object> map) throws Exception {
        ...
        if (billNum.equals(UserDefClassEnum.PRODUCTSPEC.getListbillnum())) {
            params.put("classId", UserDefClassEnum.PRODUCTSPEC.getClassIdValue());
        } else if (billNum.equals(UserDefClassEnum.PRODUCTARCHIVE.getListbillnum())) {
            params.put("classId", UserDefClassEnum.PRODUCTARCHIVE.getClassIdValue());
        } else if (billNum.equals(UserDefClassEnum.PRODUCTSKU.getListbillnum())) {
            params.put("classId", UserDefClassEnum.PRODUCTSKU.getClassIdValue());
        } else if (billNum.equals(UserDefClassEnum.PRODUCTORDER.getListbillnum())) {
            params.put("classId", UserDefClassEnum.PRODUCTORDER.getClassIdValue());
        } else if (billNum.equals(UserDefClassEnum.PRODUCTBRAND.getListbillnum())) {
            params.put("classId", UserDefClassEnum.PRODUCTBRAND.getClassIdValue());
        } else if (billNum.equals(UserDefClassEnum.PRODUCTVENDOR.getListbillnum())) {
            params.put("classId", UserDefClassEnum.PRODUCTVENDOR.getClassIdValue());
        } else if (billNum.equals(UserDefClassEnum.PRODUCTBATCHNO.getListbillnum())) {
            params.put("classId", UserDefClassEnum.PRODUCTBATCHNO.getClassIdValue());
        } else if (billNum.equals(UserDefClassEnum.AACUSTOMERPRO.getListbillnum())) {
            params.put("classId", UserDefClassEnum.AACUSTOMERPRO.getClassIdValue());
        }
