...
@Component(value="merchantAddRangeEventBean")
public class MerchantAddRangeEventBean
implements IRefEvent {
    ...
    public void beforeGridData(RefEntity refEntity, Map<String, Object> map) {
        this.merchantCommonRefQueryService.merchantAddRangeCondition(refEntity, map);
    }
