...
@Component(value="merchantAddRangeExtRefDataHandler")
public class MerchantAddRangeExtRefDataHandler
...
implements IExtRefDataHandler {
    ...
    public Pager getGridData(BillContext billContext, RefEntity refEntity, Map<String, Object> map) throws Exception {
        this.merchantCommonRefQueryService.setMerchantAddRangeRefExt(billContext, refEntity, map);
