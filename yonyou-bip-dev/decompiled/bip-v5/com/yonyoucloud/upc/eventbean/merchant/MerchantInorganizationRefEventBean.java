...
@Component(value="merchantInorganizationRefEventBean")
public class MerchantInorganizationRefEventBean
implements IRefEvent {
    ...
    public void beforeGridData(RefEntity refEntity, Map<String, Object> refpara) {
        this.merchantCommonRefQueryService.merchantInorganizationRefCondition(refEntity, refpara);
    }
