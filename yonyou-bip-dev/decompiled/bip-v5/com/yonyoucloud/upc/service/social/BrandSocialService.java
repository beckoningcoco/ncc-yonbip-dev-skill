...
@Component(value="distributehandlerpc.brand.Brand")
public class BrandSocialService
extends AbstractDistributeHandler {
    Logger logger = LoggerFactory.getLogger(BrandSocialService.class);
    @Autowired
    ...
    public Map handler(SocialDistributeParam socialDistributeParam) throws Exception {
        ...
        Runnable runnable = () -> {
            ...
            try {
                ...
                this.logger.error("\u54c1\u724c\u4f01\u4e1a\u7fa4\u4e0b\u53d1\u5f02\u5e38", (Object)e.getMessage(), (Object)e);
                throw new CoreDocBusinessException(CoreDocBusinessErrorEnum.BRAND_SOCIAL_ERROR);
            }
